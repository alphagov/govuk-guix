   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0my3gbqx7dg9jy7qs2i57ns1n4415ispmhfh9cblcxy7dwlf6g75")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xiknc6p677v45ngvjb0xidd3rfr2zr4skl60hqxbvhsqmxafil3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ahdcngy3kk0s7vfs7cb6biy794mcvihbbrzv1sjvlb8pnmc927f")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1844")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c1x0sz98rdb5w8d6gadqbrrpi9wd7q07aajv2wfaxzdhp8lvc74")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3608")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "097851b7vhdr2wk6wv998ps59ws1ax1vzdcdw7ja8gjhfwzxw5m8")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wj3prl1rgd8n52zw7y6d51w2rzwiva1sdjx70p6piz937137px0")))
   (package
     (name "info-frontend")
     (version "release_540")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18mms5r1hdcykrk3iax1h8lbl3dc94vvxll3ii00h7xvyhsqcl9g")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public router-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j23qjknyn8was64x3h6lyw1qvk7mx17glni4qslgcxp3v99772c")))
   (package
     (name "router-api")
     (version "release_311")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lvzj6rwp1ch74a6l0kl5w0qnr1lm6a87yq5cw3pkjij6vqwa2q9")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "08yd8cyfm6vkkz71srycfff08l9qrd88smpy83awpbykzk7dj5h1")))
   (package
     (name "search-api")
     (version "release_2577")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b1y4q0zvamq4n0kr139x09sh4d7zfy5w6q8m55ahv36hfjkhsza")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4872")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w6jlcl1mjldgak26hpvjy98b1sznl2c0nizsd18k84k5crfv811")))
     (build-system rails-build-system)
