   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qpv0x5d0mjy5fq3c0mphimm04zrjj8g7qm7yhm0a40l7a68ych4")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ijhdbp4f9qsy7z8f4z9xfkz97mmq465rcnpqdl41b2368qms5kp")))
   (package
     (name "smart-answers")
     (version "release_4581")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06ir53ygj8i1zwf0mw7gf0jmhc0zpakm6zbmylxnmf65pbsq17ii")))
     (build-system rails-build-system)
