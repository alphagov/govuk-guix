  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0f58gh8nv87j94hpdfql6nn2xfbrxdv980r6cnrzizrz8fszvck7")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00p0b0790hbprp6gbk18mjzf5ghg43xadl0scsifz47q8p2s953b")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12802")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d13liaqsj94ysgp64g8cvrpkm34297xi3h2v7bkvp4dwvwzy1pr")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
