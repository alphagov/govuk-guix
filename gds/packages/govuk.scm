...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rh5408qz3mz44lmhw22n5k4lp7rs0wj23xnq5lqqd4qv4nbf5fq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xnmp3m3lb218djbf6bsjqd59nl50q8qdfg97i1jv0f2vq29vv4n")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "1a70m85ia6qilm26aalawzqvm9l3jj1l1rjyk88zkaac0xl9rq2g")))
   (package
     (name "content-store")
     (version "release_811")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11j23p5rga22yl6by8wb31qp7142bza2avlz0yslfmxjll2d97p5")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0r7hi0ajv6hzg1qigr9jh9ysi5h7q8kqlzpi769q0npjsma5g70k")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0afapw6qsd8hcrkjzrg857sy8lbwbmwq89v221zxm81ypynjacqs")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
