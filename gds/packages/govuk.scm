   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h86z4flvx43za8mlnr1mfwb10jy3id242bfwm340f3gl0s864xi")))
     (build-system rails-build-system)
     (arguments
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gwylcy6m9afsyhaq2k718giq3q8qgr9mkpzsd0iw00kfdjkbi2q")))
   (package
     (name "imminence")
     (version "release_473")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gpnjmh9jxay9sxvhrpbkldj8psi2ka3x99k2w1mvi2c9n8ln0gr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "1iix2izchpkncm6kn43nbyn43kz51xw02hnm6dd14iqkbvrrpxkk")))
   (package
     (name "maslow")
     (version "release_360")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y8kwkangy0zq9hikq1wc1yl2wmb127qz7sw3zjncn3xkh4z1xgs")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "142q8nfna6z7dp4hhrq93jbmgvyv8vpmwb69zf2igkak8ph4xj5m")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bsm7iykcy6qk2ihnsvgkwa0yfk3fxf22dy6881j56598hx6ndip")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yrai3vk2mdw2v33g8hk8fp7mh5kgbwmkcnl7b3q3ihc5jd0s8sx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wd5scyfaz48hjp0yv9a1i4vmcahrlss2km6v9fq1hswfalicwsh"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k8y5x7ankqi2774s8kigp757hiawkbgjdqpnapvacb610bd9ws4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k7wnzgx8kbxcwx0y758bhmlp8rkz0jbnvdwdb0qq8xrz05l2na8")))
   (package
     (name "static")
     (version "release_3025")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kj8hz5hsdxzrnzx9ksvpl64yrvfvxzdjwf22i8z2xdaf8bkdr7s")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
