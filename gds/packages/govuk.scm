   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h6r80qxyw1y7d7x8q2hag4f0arvj679fam77zn6kk2qbhswrbha")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public router-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "18gh0nx7lv0i2klickmqcd3kh73wdxdmdfnhh53rx6wz52w08dpr")))
   (package
     (name "router-api")
     (version "release_127")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "162n9y0xsn21lsh2jssky0s9y7d46mf39ici1wgbzhd2cpmr9j0x")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
