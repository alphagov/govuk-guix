   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "007lcp8xjarcsrm1i90crrrqvhw75diqp5143hn2m22fa3bkzidy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2813")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10q3n6j7yc28v919grl6sc7xg42jpsjr0wdidwrwa05ipyxdg9kz")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13323")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08kzsj8mfgdnxx3x6agwxjrdkvpqn438w3f0qgkcg4kyqvgpqlkm")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
