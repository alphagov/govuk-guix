   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04dwh1fa11ln6rkhf48ljhiypxp51yy84dc0xkzpmdw5hssy3x9h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3678")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m1l7vkn85k1323kalrff68034ik3k504jd7zrbmiifk8iwknr7v")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12888")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09l90vsgxzxqjvnw4ckp70ysn2s5ljd6p8nb0w7r97c52q44m9bg")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
