   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m0khkh38ffiz2dxg9xczwi7w22pn6cqidw2bfkadll0c47d2xpg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wdfcxpcgqy76165i6pkp774p0gkzn1j9ksdpllfdmm98qhy4q4z")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3767")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "040p3417bdmhjvnsillhdsvhqsy6n42bnp3c9x31b5jmjva2jam1")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2699")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bppa9r9l9rhk456bnwb2rvxzdydh1w2pfq5vl11a2q0m89yxfaf")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "15br8qdhzfvwvbac94lrsgr06vcr2d3gjk74s9qndhrp21jw47kk")))
   (package
     (name "whitehall")
     (version "release_13054")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06q887vv5cznsc3f5gw8m9h4v1i3fs0l4nl4v2af0506hxzw5x1b")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
