   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01p27sw6jcfyqb5rfih9724sxl03wgmsh2md30ssdb5al2kz2cnr")))
     (build-system rails-build-system)
     (arguments
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ppa2v8z23q7k9y94wdsg6g8dz4ms9l079csr55ki1fb6h4wk6r8")))
   (package
     (name "search-api")
     (version "release_2476")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03ggxn1pdlzjw049k9f7jcf6f7pj6bxg5hc75p5hzjlf0qvgj1fz")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
