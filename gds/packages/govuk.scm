...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "04y3h3vnvda5q4w4vly74wph4ipi6vzm2rpi2z6pvz3akgq43lzw")))
   (package
     (name "collections")
     (version "release_743")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vd4h4ah05sv3mjb84j74r3m9r4q457m7qr401qlv0zyqnrk9h53")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nx5vvbg7qfc58l2c897lmhz19rmhnqzw99adnd4j52vgcnjyxd9")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wd782qsqq5dwsl6xwh4xsapc1ic5nk075j1c9rn6hpci59acb1f")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wj8rfxr4p4ng04g0fw1dzn04cm3j9z1lxsbaxqynmd9drcwjwhj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1nbhxx4q23ddq48s95xlm1pxcpbjizav7w54sk6z13d6q48yl606")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "047hz3rky1y32bg8fxy2li9s4sdgdby59snsh70axrc5y1aa3nma")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4148")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07s4kl6kwk8p9lqgwq6pkjd46lbpghhs64xdz2xgz0pljlha3hc1")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13824")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hwwfk77rqj6f2yi1hxy4ym00j2x0wqk3sd30w74acvzsqnz9nds")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
