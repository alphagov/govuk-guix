...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0szfgmibyzxh2c1qnzvcsbqbzc6a90cibn533fam0sz6857rblvz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0768mz824y7i3hnxfwfgpl47inmxph5bar4y4j1dg1ks064xaj5y")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "09zrba6bxvib0iqprgi2acbja3ww84vwmkv5q0ycls4xv8nkbnqy")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01i5f8cbldqbnf9qix8mp0ky17rm374rms2p1n0w8xq4gnx7cqfw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "146s3d6brab61vlxxylyvzpcvq1sh8hdbrr41ahpzbakpgilyxny")))
   (package
     (name "whitehall")
     (version "release_14477")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fayj6klkpgsx6kk7g0av5wn0khhrw7110m3cf9pn498dgzr9nqs")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
