...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nnhql33nzaa2aa9kx7qcsgcq8swpkagparh6i2gna6g80knlpzd")))
   (package
     (name "collections")
     (version "release_510")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17fnypzjml7zkd5nwsndhynadjwvps3zwigvmr763i7v3ghyjdpd")))
     (build-system rails-build-system)
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lysxqayh00zzfhwd0yf88mz734gk585z2ljxgj1b45p59rzmzg4")))
   (package
     (name "contacts-admin")
     (version "release_444")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08c4spd5jv137x0pgm461md46x51bkkfyb9jj1jk5xi2f89hskip")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "096f96b7l96px7zz55navha1hvzyzpnjg3syvx3c11afysvz1xwy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14k76254r2xkhbpjnmqvbpzrmhfwgqmvpjj6dga43wd1apq69ivf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "054y02afwr99nah9brf2hzzqsh3zsmmjlfba805ms18wqhkjf8sk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05qcvyisx4qhvblk1648id6g4mmbl694a62xvk6qf90k7f4355xy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gch896q3jjf3i11q4w909n07ina7qy5xgqixj857lrmc81nxwrr")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sgmgappnsln7slhn010xvdawqlipfzvlcsmccjafip3578pjg3j")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0aprw7wjp8mi45jsjf0cm9pqzpm30m6qrxbjmhq42fq3my8g3qkk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h4pr6ln1867q3lqlvig3wz4hh9lffyx87fsnfjdwgzrd9zxfvq2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kni8xidkx9scc5yfb189x187icwqizr5g5c0113n45zfiibznqf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wdndy42xbxn1qqvvabk2idnll95jcnjbclwf6pidrnjlq6kdi4r")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public policy-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n42jwyjma25sl3i7yimjhwd4g3hwm1jhw70r3vi60b5il9fv354")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rzq2vlxyapcpl721d2kysj9lpaj7qmsgjf68rzblz7hj6jj6vs1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08y1srcdf392g51w59k22qzs01dsrr0ip52azy9q4gv921pm0x0k")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kpp4a3ans7hkr8i03h0wp11z47canf1sc0vpnsikp79jhhq7rdc")))
   (package
     (name "search-admin")
     (version "release_170")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hcjz31k3wi2py4zgdkn4zmql3465dam6gjh9gblrhd84nbjbvcm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2859")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q41qxhf1a2vakyhjwfy4jjggvklycc020kmypy2z04nrf468miq")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0psvh5ba4wsnk21na2816040kpck4zqmpl9yy9h6ki28wj80j47z")))
   (package
     (name "whitehall")
     (version "release_13437")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12083c3k7yk2y3f9ypsdqipa71c5xvrjkvis9h854k36cl8inkx2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
