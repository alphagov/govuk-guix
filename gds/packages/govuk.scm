   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17g3c8jzg4k2rm0siwkhndc3b4r85d4iwamdm2n9fw5dnica8bkb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p9jv3p3xz3qck1qqf6f6n61lmqcy7zs6i5lbmmvrs4m816ri5f6")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1ga9wix20mx2q2ly1sd1gldblaq42j5ngqp7bg0aad6fisl5nb3c")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
