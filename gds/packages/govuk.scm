...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ipg435vwshd3j5igww5w6byqyxfk4chjrjqfnhiii17bx1lx7dx")))
   (package
     (name "calculators")
     (version "release_380")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xir7q651nm0gmq2frb0rncasxbxnpcghhfx2hwgq4hb7mnm1nyj")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g265jyd8ipwg6934lmb8kfswwjv3m0nb9l1za0hz8gnp4wvvmzs")))
   (package
     (name "collections")
     (version "release_705")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05f6bik50bd5dgppcsyvxfxjfz8jz3aik2sb6hn0vy89f2jaas9w")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x0kjcl9x35i931z0vgsv7nc63kwabf357kyy8skb2zqv0kjv966")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "185pv67i5j351s1l32jc9wq1g0i5ynx40y4f7gl2jmx2xbwn2y3v")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y2ixqv7p0w9s5a3226svyv9lild0mnq48272yhl8xa2v4i00n4p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "16ygigfq9f5pz0jbjhykgq6kkgxgx2sarfgdh5aij8s100zlqykl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h7ns1glcg6fanqdkg7y69s1p98nl84bsvlz9rd4n8vp68jyming")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bfcnak2zzj7s732sf9n1kxa5rv5xjl69gv7w0z23dfhn3rxdx0f")))
   (package
     (name "content-tagger")
     (version "release_861")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sdkpq1x9968vhmhvi6pmbysr82b91sfpc01j208z6mpd5hhb2pw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1n3zffv9smba8y6l6c1yfdjxb1ji16cvknpzl3wx5g2ifscn82pv")))
   (package
     (name "feedback")
     (version "release_518")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yxhm53h0b8l7kyganccy1asw265f8s4fqyiaji6xin8684s2f6v")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06i40qg5r056hw8gpn2rgji0a2p15jfl03yvkkm4hs2z4nm8jlls")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0slrmv19gpvchngfhfhms0947v4q2w7f3nsrhxmbd1bpg2nfr7am")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zlmb59yalb1r01l48ivz70favlbf2pqiv9nkyllcgk0xzwkkscn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xadx4fd7bh9jkiwzsnr4n6cws295gk1vdc7bv83dpnam3md88xd")))
   (package
     (name "licence-finder")
     (version "release_467")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18la9lm2jkdqvqrz8kafpm8m0fwmzigrq81dlnrgk973v1jkdg0h")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "13x1rlzpg96340cf5v2iflika4x0b26qyvrw8ayv7kpwqqkx9awx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lvzak4aqybi5r48gzlhk5m87may6qkm87afysv275hcv92biaqv")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g8204bipx22g7zk9dd3idk7b970j4qzszimbizg6g9wi4al7yqw")))
   (package
     (name "smart-answers")
     (version "release_4105")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d1hmjc4891k6ylgnmr33xnqyw6if9bdc6pwapkra1nnk7gv8dr3")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zn0cy8845jganil1q43599ppd9cddw33bbd4lyi9c9d5rfmq6pi")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vh8li9jq3yrbbspx413w7lfvnfnr2q8904k399kxgxcks4d9k70")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pqm5gbnxfz2ygwjp47d7883m7164r528mvs0515c5g6afm59jf8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06dwv7vhx3v4wsbk23qsjq7b00l1yvm1kwpzvh174a5k4n3mz0lh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "162ca0r6gnz0lj58ygf43bfxgnc7qxc1cfb9yzscick28x79sk5m")))
   (package
     (name "whitehall")
     (version "release_13728")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16slxpq81ppgl5pq8jskk4xbr2gwsra16abj6cmk50ig9q3cwasn")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
