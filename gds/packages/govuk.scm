   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ir6bvm2ns59w2pqmmra2rpffqy28iadmaka4w6jkk06hk5kix6b")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1v6j55bp8y402nk3cx0m3c2rx1cbl29ly8xmy0qj470n3lsvbcdc")))
   (package
     (name "whitehall")
     (version "release_13934")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "062xxmbv94mpwgk0arlird8r2kg4qpls6j8aw33xfl9kpcygmfb8")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
