...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4863")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ksw5rywqm306yinbcmzgfpp3jc8bhqirsag8g2mr2x1lrpj6892")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14842")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11p7bhd7mak0yy82qyvvj3j2hk6d1j2aimka03n1410m5kzjhsa0")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
