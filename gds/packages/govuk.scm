...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jk4qbyi27bdsbwk2ayq9hy63pb9q1k7cc4016vbhawf669v8x5m")))
   (package
     (name "asset-manager")
     (version "release_202")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w6sf1vwjga8hv492vpsflhmc0z077zjma9c4hfm92jz3wrlakd5")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yg810njpp1h3019ncg3fnlbppb8p741d4ac6m9nabkkbac0j04d")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z1ncnmvs68kyp4hcms2vyfqr2k8p4j8xya02lpqrzmrz08jccls")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
