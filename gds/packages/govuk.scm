   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04bc90lmllly5mdqi2p9srdyfcz2g4mk0jbl5iy6rlcdilsxk3xf")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wc3vnj20z9yz0nln1c8lmbbdcl8spcqsz10bhk6bsjqm5fy09iv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lv3akqr3g4vi6l1k4m4jgk2ar09qmv8g1s0sy52dmg2808iqh8d")))
     (build-system rails-build-system)
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0shk5mq71riw4awcq4pfqcddcda70vhsm46kqqgzbzcsgqkwkagk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01qj7fzy3w97822yz6br9c1fasm2lhxikpv7zfrm39lj14x9inld")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0r7mxwqr73q7vvbcka6c223qkcc8gw6i6001y9c0dd091i9wx5gg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jl5vpg1nisg9bkxzxcjg1dknkqsm910xwbgkfw19w0xy95lx0xg")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hjx4p9f06pwfyw4whyqlh16ri1jlmvbddc3cnam9a3z8rx55s20")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nps08cvafjv5vj6a6mcp0nc4vs5vrvyw1j8kl8pw25qnn3ysbg9")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3158")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "087zs8wsa5v5idg3bbyzvp2kvs4qdxxs3bfb5fngwvh6k0p93xbi")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1i1m2ah62k1d6mp5jll0x3rdcvnyhrd5bxzlfpz50zwzq4gx44p3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0srz0481hxwsgvnafjcdhcczwqm3wikyqbv6ij9ggbqkiq3nxg0g")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1ysqmz2pn1ch831s6ammhgvixqi34ipr29mhs43jl2xlnlyz0m8j")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bf5w1bilkw0x72y8d858dz1yg462dnsmwjhwx3n8wgza5f264df")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08801pxj7riq0f4lf5ff1yc8yiychsdrz3wilyg291zzk3q2xiqx")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2040")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ccgci6gp2j26vxhw2khwkw0b8995f1k9q3mihjb9vzhkhqlik6x")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4350")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d1w617ab208gcr462sl76kvcq0397nv9k0iq4haj687dd17k69x")))
     (build-system rails-build-system)
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "05ryqfkncbw7322i8ir4lm4z1j0yp8v54rz18vq17vr79hvpf4l4")))
   (package
     (name "transition")
     (version "release_928")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sawhclj71ipxmclh7ac0wxwyjqk7by79vjpcjz8ccx0y5jhi4ir")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wfc1s4dhz1jfdc6br19ms5l2z73jm0cc7dd4vbdf7nqlmh7bx3f")))
   (package
     (name "whitehall")
     (version "release_14079")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "197vv8mjmwwp7z92xwh2gl42p9dlpmhgyqs67cjshlb8bxm1p2xp")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
