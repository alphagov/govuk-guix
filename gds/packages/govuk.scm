...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ivcz24kyc59b0y0j7r2ai3l6rj2f5nv4hlvvyd6g0knf6div404")))
   (package
     (name "asset-manager")
     (version "release_253")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "186xn1n34lnaw0dl8bhkqgvxiyx3iyz3kab88980ma64jjidalj9")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jaarhh25wi41n2nkb0dzad7c0kc9mmqzvgz9nann554f4dyqsgs")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04r8nv5kd4b0z86rdaha79f05x8pkfan76vl2bqlxj55rv4l6ndv")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "00r70ka56y2nj3c72qqlcnmcfkxahc03z3ayc7sm7d4flbq7xqw7")))
   (package
     (name "whitehall")
     (version "release_13286")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dh1ppqgkj53cs7srdix3q8j9ypg8b54a3qs9ny53lh3f8kp0rx8")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
