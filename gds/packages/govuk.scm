...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18wzw3rmammyp710pccx2z7nak0gmh2ysm92scry7n695qwjijxs")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ykmpxs4m4a6lgknjjmd3zxxcg5pvyfs7ckjymvlgydl5zn23sw7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hn1724w7219w77gv2bzwp26pxvl72cmq7dh7dimndvn9rnka883")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03rfb7b11nf5rciy838c63zw9mxa0vclflaf6mgjm9ab3qp5mxis")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
