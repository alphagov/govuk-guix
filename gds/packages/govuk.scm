...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "093rpnr5cb7l4dbc6v1jas4ymr5qq0rkh86anmrwggi8rmawwgmk")))
   (package
     (name "calculators")
     (version "release_684")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fs4kahcz3iycisppqm0rznql3miv8iw0ybkvzvs1xhc92p566r9")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "07lgfrs11cghfmv366x62dpqjisydmlx7hfma8qxgvhnh0i78vrf")))
   (package
     (name "calendars")
     (version "release_910")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qg809ak9cy3ar4m3wmdr9322rppsgx429mv152xnz315vicj0zx")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "05d4rhh1wy37m7kpayvzi6c0kjhrby62bazv1hml14g3gbqnql7i")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02bwhxwg0r6qpq7cgbyaxdpk2fdpk6zv7nadzwq9sgsmcf53943c")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n17pclfi6sxvbs13mfvr8dc557285av64cnghff5vhsifg9my3h")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09s92kzh2k3zfzz6hx2vi4y1glkijyn6fy85f3zzka59vm4cwzbs")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0va6gqq4zy1h5yiyp35020lc520a0qyqqw4gdm9nn29bdnmcvh5l")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "158sdanpg6n5hvvlw4hzmh73cbcg7jwpzv5y61kpmrff4hpnvmbn")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ni1gn4rc8snxvf7cfzg4jdw2k60b6bamkm35y4dshyrdgm1dk39")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jliark08fg4dnxki45zwish3gvsv02i6xjnr30i3ipqbfkwi5gv")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0asqayq1a89k0xsg976c8fczv9vdb18fq6g1mh228p69b15h3qz4")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mw5waj5flgd0dh48inlv72ic0chncv121qrwkknbgrwml7gcq39")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pbkvhlw0h2ap25bf0hgppcssrljjkb5bln31crw86ji29n50d77")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qsn6sxghb4pl70zb1wjvidzhhsp2kbnjy43arc7bf84kwqbbvk3")))
   (package
     (name "feedback")
     (version "release_837")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pkddz3mkr2gn7fwh1b5flnc2s7insalvhvl90vmdy0a8s2gqp1r")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g91aizcirpnvyfq4gvmx7zasgvnzflx7vzirmnpf0sfkr69alqk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02knzyzxd30vphz34nagnspzcrm322qnigf9yjlhh92h6kd3zxhd")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1w4j19g09q3lcyzm379a7pq4vah9pp15qnd7cdyldk02pf17h1i7")))
   (package
     (name "frontend")
     (version "release_3517")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zm40dls8lv5napajp203vc6szcffrs3wbjzp5ls37vrhf1as2xa")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d74sbyqc5170xn0zs5bqjjbllmcigc9241v8rmqbp35vbixiqh6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x0q54xvm2bkjapyj54j81hddq38fc1n6fyrwvhchx3hwkbbfy44")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1iwdwnxp2v84l9459qgqnwdbchizykgah7qyjyl0fynh4vr5a7bj")))
   (package
     (name "licence-finder")
     (version "release_735")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h7a27mlnvpv1356jw7vnyjpdkrfb46ys8ixizmvxg8icmx06jj1")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "03zcrl3i0iaq3accww10y5hln2skfqp4ln6jcdid7mvma767lk07")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x32544g56bfwdz85xld0gjj9h42agjar6af44cvxhb9yvmsdphn")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gsnx54dbz1ghlyghfxdcshf26x7wacgdwjlpbi464qij2bcfn6b")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lj4c9vz62f1brds5gczpq4ng5k1d9iisaq1rg2y46h0shsj5p0h")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mlmg1rzcz53jx3n2cp4q858k0pfz4n3kzllgzvbjsmw8q3y6ivc")))
   (package
     (name "search-api")
     (version "release_2510")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f5sirbmqxvajij9nvq6r4xmk27a57gsrhpqv4745pl61ml70d49")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "15dbc6jmrprmyvapnwffx0hlnn7a9wkv3f9kw13gi4f9x5lm9r1b")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kj9gsr4jrzykj76xpxfvhhy2160l78cmdxh0q55yblxqyr2gxl4")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "17wdyqiglg1sxldqr0gvs6251pzmb5mjz2fjyw0xkfkngqz3vmd1")))
   (package
     (name "signon")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bsshmwnch1v1dn5r6mp6ja31qjggsjbw57i94hr5mawpmb757cq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zxam46364s85xl705k0r8dxp2i7dnya5lb5q4plc1fmnk7arrda")))
   (package
     (name "smart-answers")
     (version "release_4669")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sa7v5b99bjfx55giss5pmw2whwyi41awpndmsp8dmh5w8rswsc3")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "05miigpx7c3ji8ng6wpbgisdmiay5c1makv4kdb3zvh19c2gjqsp")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mwhadhp3hy7p6my0ymzw2brj6yv89ynwb5v5dj92q7ch807q53r")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1y0nhb5wg9z328zzaq12g9jmw9rsf7inzpjx7yd6h5hs9dzx3mvh")))
   (package
     (name "whitehall")
     (version "release_14691")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qlm6wgd2d2d5zj49d5jbinw23j865545qqdzbbqr201lqgxllz1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
