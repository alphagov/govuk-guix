   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mhc133ry9hpyl1xkq22w75ckbsw4hcph6z67swx421k99yj2w73")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16c6k5czm41i66kpwks2dmq9hlg33na1g3wavasnj6h2r5rixgpq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sqim61hmikpbbppljnp5m7jjps3clkq43kpp1qqvi01m1b5rrkq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0y6kr27s0jc9vr3qkc9ap1pc9w3ani7yp57rhv4dry83z2fp07xm")))
   (package
     (name "licence-finder")
     (version "release_293")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i4k7gf19alz0v6csnqchn53n81f10r0il4hfw3synzjb6hs7vjf")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ndj62kgmd19zlw10qa6yx5in12mx55dqk5n65yyqhvmvg3mbgfd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2713")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1438khk3wx5pc937zpjq08gkks2xq09qj8fxk87284qm6gad5j5d")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
