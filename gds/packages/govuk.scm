   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02rv332pa3x1d9g7qq2sh29zf9a09h28xxhzf26h20la7370gc5h")))
     (build-system rails-build-system)
     (arguments
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4629")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s69kdhnikp98gp62jvi1w7jv1821xnfsp6rg5hjn1wf41fg8kw2")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0an5jvd679fri9vqplll1lyzk1ikvsasxam6p7lb1hqabgb6xnlx")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
