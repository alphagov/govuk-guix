...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1i3s02ks13qr1dfcvbz99cf3hc4wd0igpwc69zn67ln7rpfxjv6c")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ppkqjfjgbdwyaapq05xqqz0i2a43nx0bfhxvzpxbgk6hphcpmhy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jcnr1sq49m95jhg5awyzaiziv6wvqq9skr5i3blk1iwhzpir57j"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jb3lgjavagyf3rflwn4f037r0sgvy4ic2vjx1mn6rngg9dxmf9h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
