   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12sx8cvvqaq17z2skqv4i8cqa0dcg8b08yh9m7mcyv0b7ihf1y2g")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h2k3rz02hpnhyqvqqai48f3g5gq7zr115276gbp5frsspx2g0jf")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12959")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06nvlvxz6v0d8mpzaqrpzbv382xmil2fmkal2z54fx5p8f5ajrdh")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
