   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x3p82dxgdgpjv23j1gxabv0lc94nrr37vwkbqfyyi0812dr1vd8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gzxfp65p5xai4lpjbypm463kqhn2hrk5qn9ilgwkrs67lf204ds")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13249")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f4zkqig60scq1nvy7vz084j414dw4aaf3d2pkasaxy8z1zd3p2w")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
