   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bqp3642amfwlys1h7141k14mss1pkvlsf19i5957clr2xc4xbds")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j673kkw1gvhz4d35263nvzic8qfvsc313n8l00blhp5r4ag7b76")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qbjcq6ml4izp2l2q881r42jp931s9rlyw6nal6l8m55h93qbv6c")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05bxc98hl6qmw2cgsghi739wl5a1w0p9ilr5hg8f9m4rm5xfa3nw")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4140")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p9kfg2g176qpv89n4vlhz0p26dq3ksh0mxbmgisg7jh9q6azrk0")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dgb2nx3nzpx56z0jpv4fwx4qhb8d55m0g5b2m679yif2p1m9msc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
