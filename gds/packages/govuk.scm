...
(define-public content-publisher
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1770")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f2hn713gf9llkniad4m1amgilg1ccqcam8qjzx2sia61b5n8ji8")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pvx3dw153gd20sq9d6ky6lm92h7ywrpx5mdfvhl099aqv4jv84j")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "1i6sxmqy9z8bhsrhfh2a6kxygd7piha212kr86mrm265g379ig31")))
   (package
     (name "release")
     (version "release_609")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01rgsanbpz959r7iibh3vfq0kiqgvc2crzk8gaa1bq63gv8rcbki")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1is048qldphggszbbn5jd0zra889d4z4i2xslfxi41hml957h616")))
   (package
     (name "whitehall")
     (version "release_14697")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02iyqhxfk95k5jfpb7qsn7n453vf18fs3yjgjjcj763imi1vb31p")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
