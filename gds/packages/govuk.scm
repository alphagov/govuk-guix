...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j0df1py1kifvv9b8r1dpfdgfynyb27nl0jvxqlgw7zl7aclkibh")))
   (package
     (name "calculators")
     (version "release_557")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18yzify0ag0mrpqvkc7f9azzb88mjxmi6y7csmv3nhpqqkyscp35")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "065sszr5l4j0s3zagnkzh773lzqd6c17p6m3franfpdkrqrkn439")))
   (package
     (name "calendars")
     (version "release_798")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00x1jlz3hjrgjg79zfw0vwrkrbb7ip14hmkmrw2b7wfxp6c21lfi")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "06c9vvfp4idqkhfb0fnpj7x7wdkczrh5rjx2bp4krg1kv8pb8827")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wmih67225qrznvnwdxclx1rrk68idplmyi27makl0i0yc4vphbf")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09412jjvzrlkvgn4583v3ca5b5qnp0zfbwchp308kdanshnnykkk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dixcd1g69xf7ikhkh9h3gwa6ylafh2g1164jgyw6w8x9jsfz30r")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qgdn3x83mm06k805cqkra1l4imb2jn25dh8n4s42lpgwi345aw4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vagifdm9r7fib5pzr9lrs4icyapx7azqq6ykys2rxip61hswyji")))
   (package
     (name "feedback")
     (version "release_744")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05x2r3zwx8160ys870qs6i7d9sp2h540w86314fcdr8qd1rq522j")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18qb0kfmia2zrs66d9aslxha44d2qskz1p8mzpkbcci9g75p0l61")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11frg9jdk16wmcs80cinl8qy8m2887b9i9q99hd5ca2kv4zfg7vv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yl1nmx1c08f205h5y9rxj4yynrm8vcqykk5sfkd23hsv2xh17c0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gav14q1g64nz1dn0kb0z8d91xkl5f9m4vzcz82fwq083yq9cpyv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "11azfch2z07siska34k3717zcy3g4vhl7cp4hw237nysn947v463")))
   (package
     (name "info-frontend")
     (version "release_418")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pj2y5j00ina06njkk7m1a3w41qrffavr7z2lb5kbjqhlxmzd7s9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "17khyybrlgabdw22p08k970jjlq4ig5ra1xjz9vwah5hgmwblacc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q5cmp0l4529xkws9slfvdx06sx644zpmv609gmijnl2kj6djkqy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0iggfgfn3b7gff5z1in5id8lc0r5r1jyagaifdpwi676d6gv3p6w")))
   (package
     (name "smart-answers")
     (version "release_4466")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f350a1bja6a71q82j8ah9l2g6wv0nn2cyqgiyzy4zy0cmd7rhrn")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "17yl8j32i47p1hk7hkln45sg4sdn9msxrqw2j3xr42gyn32fbg8a")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w7zphwvhapv90ivwsry4z12kgk43q8d4f810hqsp83p7x1mfggp")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1v1wsbywm8cf21144ws0p4y7yh57h5h07ifvlbdqd62qxhggfqff")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gcc8bzbps748wn6v8gwbslgvxxl4z4v7xmc3fwfq99c601jlf2s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "03gf1396gj3py1vx0hrv3lnajv4vmjxhkaxrharz4fzahkk53fl8")))
   (package
     (name "whitehall")
     (version "release_14291")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n9nn5x50qc83n8iw18g3hvd69wz9v6i38rkdh3bdk31bqdmpim3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
