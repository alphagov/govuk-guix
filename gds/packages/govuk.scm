...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1abq3czrlgl2kiy94k2x02w0z1mnjlb1kkzf3aa7nxqhwywd2y4z")))
   (package
     (name "collections")
     (version "release_856")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01ai2kxvj8whvvpl8mkij3q5755jskzc3kw9yhcry497xm0rl1cb")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06wgcxh2sq20p6w9awy68y14kmapbmd15xhps16grn7c71387mlq")))
     (build-system rails-build-system)
     (arguments
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nn5kcc57lzhk8xrcrpx3i8mxn26knzaw6f27jc5k80jvazb0r0h")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w51a6y428bqap36sc2n9ssaw87xgakbijf0hcmyxs7bscsndvwn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public rummager
  (package-with-bundler
   ...
   (package
     (name "rummager")
     (version "release_1984")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06f8d5ssrd9r20mwmcf5yfd39mbih58gwjv7v3jxp4jh8r2v5hsf")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_3086")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lxvjp092c18vf8zvjpbwmyx80qsbb4b8a6y71s30f8ky1kii95v")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
