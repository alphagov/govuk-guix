   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pvmc4rlfvx1lwzmks413dqaxn9y57pwhj1lqm7wgkv57iy1q5i2")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hkpz2lbrfnzcnv3mbzj28n3ffbxdvmjl1aavpjc9nnk1z82i17b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cc06vb6bgfcmh1f5yvkl30fci96wdva6y3lvnlj9k7pb6rsk51k")))
   (package
     (name "content-tagger")
     (version "release_612")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "006amz5b3izd560js89anpznad3rlvmkzg2npgyqh0w3j1bydwai")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zkdxqdsrn4ykq7ppnlnvxjzxz1kc35vwsjm6j681lv3s4rshykp")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "186w2dgqrb7q3w4f42d0s3i5gw54x6p1dbkkfc6x2s3x7z283aal")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d9fm2srn1d2x5k8rci9vz968idrp8whhh08pi4yikn502n03jqc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "05s6nnlfrqzmadfcdpyj6h0l9myvpb24mhhxnaglfs3wpih0lsj4")))
   (package
     (name "feedback")
     (version "release_343")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bg0nsg70zy3xk43d129n4069yxnmfl24il96w0blnf684m710kc")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wm7bvh2d1xbsnh46wras1brdwxrw91xfgwi4jmym5654iygkw78")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "16mdq2pp73p9m091ihl3v84ln8562gynn4r3lzsvcfl0hm8k5hxm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a4yd573649hdwy9dqa4pyw97gncywn1nhs6f97m305zcyhjsp9v")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0rqgcinq1n0by56dvaihrpqmc5bpa5rjvhfq6l84k99mpw9hr72n")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "10vhp37kzf78vxmkaydl4n2yxyxjz721smhbqq6q6m61lfyn6lpp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hmbhl8v20b86035rbly65dx35cjnk38hsh192anyk8mm67gv6dn")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public policy-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0552a798xbc0nk08bdvnwh2z1pdc2crrks7q9mahsxlj67w6jkl0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z3ahnsd3p5wy5m6fw6ys0whr0bfwqfl73znv4lycnjsr488l5l4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nyfyn4vgdhs2h3kwr7aj1yk6f29jzizf76yrx0kl23vb89m8bi4")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q6q2b81s0bbhplw6z2g65n2csw121p1fdvfqfkp2y35r3hlix5k")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1982ivqqg869yc3pj752n3rzaks9cx8s8wps1g3d2ag1zpah4z9v")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13127")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xnqlvjpiicvyxhl9kacdq830baskswavas2ynplmjsxn45qms79")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
