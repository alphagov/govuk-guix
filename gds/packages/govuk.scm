...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bicx6hr4jp2sxnby9rfmbj0b1185s4cmw1mvf6bz2hw8ch6r4gb")))
   (package
     (name "contacts-admin")
     (version "release_746")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b59whybqw417s5xjl014n0ghmdrlcsxfj390y9s8jy0l638jyn5")))
     (build-system rails-build-system)
     (inputs
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fs8kmadx8jbghzfx5xbc4v1s00wv1x1jwr9cbcvz0kdrl5lv84w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zlzr47jfjv232q9qzyfpnq3y58s0c5jlchag45hq5s6w4g6nfva")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
