...
(define-public content-publisher
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1507")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h1a4ccsn5vvppiipfkhiyaspbaskd2jqrzqa1ghabg3fdw9xk7c")))
     (build-system rails-build-system)
     (arguments
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2399")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hbqp0fqqar7ddy9p34591v5c5nn1dcdiglcvy29rp2kv0ckw8sf")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "17cycfqz17gj817bd83d238lg73zfxgkwq6wx3j2zsim4wdn3naj")))
   (package
     (name "whitehall")
     (version "release_14470")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dwpma2k36qrhhi9yn62rwbblw0vjvvyr242h5a72rcx5q9zvr8x")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
