   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fvw92vcfk9hzbf45zjh3xj8hivv88dnmfvk5a9cwck2v73gimxw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0srddsrhhnw0xqf9cpywrwvdpnxyb7hcl2fbgc32krw9rg2ykc01")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a7iwrmdg203b56i2pc8fcldp1qniklx3c4vn180iq0k9mvr4dn0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z9nd85hbpw2hhsg4ar2qnzn4f534hrfsk5nk1wk4q99gknf7i5r")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17zf3sbj9yfx4x2s5my0zvfc6lflqsyp2jgvgj723xjcfq8sbmpr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yfa4ig35yrcmx726sivk4b9yb8ll3skcc8ncwcmmbldj49zrg4k")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0z1v3zp4h06dk2yy7xqmngflly8q56gw41sd1v8nx61ssr2ikjwr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09am0iab1bkhd65h5nxsk98p64fkra5vb9g72q0yah0sd0l2vp5p")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13309")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lfkbhm79hgh98m4c1vkzkmahp9x7ycqhxzza4kmshn7j4330kzp")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
