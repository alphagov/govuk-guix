   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "062y97a0gls57kxjp7fmkpd2wrya2wxxfyr3zyh1mw6r6wjyf5xm")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04jr7sicnh4fi878fdki593hrvkb9clmkdfdz6zxlsbnq5ky7050")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gcygc25m8glvgqy3qhfn3kq6f623j0m9hhi80caka4415wwfi7i")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qcyk2hnlvgylz7v4vdqm3x7lzn7gdvj1yph7i549cd8v9499zzf")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06dfx5xsh6sa6q5x5z7n58wymxzg2higc7b1fya5mmg5jznvla9s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1476cbm4xlx7mgv9iyg21sv888l40zx4gly6y25g2nffmac2i5v2")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13129")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hbcaqqlg97fkmfxn4f4wh9iq84z8xxnankdjxlfgpyvmy8xqdv1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
