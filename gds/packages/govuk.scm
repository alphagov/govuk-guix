...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ff2fhd9gxill3zbh21spa2qz2gvfc2rslk21cbcwldjjp3nb770")))
   (package
     (name "contacts-admin")
     (version "release_369")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ir783cq5d3q2zf9mpm62h7sm1f2vhlcgnifn0xdsy84y4wavbaf")))
     (build-system rails-build-system)
     (inputs
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ygpm2707y6j64j96pg3rvm99m2pfgby3ckdpwlniw6k07dwvqpv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1insfhd3aa0wzv2x6q96amlhlpi8dvgsmjxzhrvayjkk93s75nk4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "00yy2zkp49bp4ccrbrvazrgkn2awwh3vg2yv5qwkw1kg5pcc2ln0")))
   (package
     (name "info-frontend")
     (version "release_92")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rc2q1kajizmkkcgvdz88a6ayxb43hm96hg06nzjjyprwmixrpa8")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ggsi5br8166xy0hp7i00cxlzsdndm28iwsh3w3p9pa995y7da6a")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bfc6m2pvavyhi7in8jzz83f77whyp0b1wjxi2788jkxxnsdp590")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "1z6grkv47v82kx7pmk0b25rjlmgczw1lkhbp48m064f55w154691")))
   (package
     (name "maslow")
     (version "release_220")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fvgwf4i14s6yvz2vyninp51c7x29kwmh5lbl4p0zgz202bipjd6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cv0hd08lw8d2yfgm8i2089nyazds443lqg0a76r5s1sp8wbrbw2")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v17sdqp9k69p64swphd9y4c3npxdqxbnybjddqb8rnr8ldzb8hb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "06p4shmbmb0n0z2127xpcrl8spy0vir9lig44hsiai11gahk2rh6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ycb3dj63ryssyzws1kaq1pzm78pyq96rh5zgb7i9gzi1bd1xmw2")))
     (build-system rails-build-system)
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gqj91jzgghzp0hc5db71p0yllvg7kqxk1cblnjg5gnja50q114d"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0069iaziy3dlk0wadxhj0806k6k3z3716rh1zzw6aah4m59ybsgn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "04149lzd54w67ylx1jvqh3zfm08m1p6haqsvhhwmmj4475n1msjj")))
   (package
     (name "support")
     (version "release_614")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g7q8yk4vixfahpfx3kk0wimmlizxk6kmfns8j5hnl5296a9a3p0")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mmz56pfbh19w7rklx72pjliw2gjyn0h26l3s8qq6sl7hfqa5mj6")))
   (package
     (name "whitehall")
     (version "release_13164")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dbi7cgh7a3rml0qnikij6jpppb4z8icpxf8kmy4qjr0vq3y9by9")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
