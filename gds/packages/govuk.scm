...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ky315zs9cygjga89l2pqd7zafshhy49nvbld0v7vidmfaaav4wn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "167h9vc4aq6ddhahaynx2r0pg4qpgm3xfshdzq9xpscc43a9j6sw")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "05l8iq9h4i53602jkmj8jaca5km3kq6f7cc213dqqqqk9npilwqa")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18s4g7x60yqlf89c4jf0i2py8d9avbsh4p3by2pvjqw4qqq1084h")))
     (build-system rails-build-system)
     (arguments
