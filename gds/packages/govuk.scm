...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1myaqzfmx07gm53a2bp91x7b44lpyra1qiq81j35z4wgpyldv8zk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nc7bpjqjb8qk30j9m0z52s2sz2sczavi9zbyx4miz7sx51da7ay")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ch9lcwyhlm8ymcb4l3hwjw38f5i49arzidkrsdxlq6xzlypczjm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15hs2981sqbghnb7wfyd6xph5859hf4nadcw6dq39prpp5442nc9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
