   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17m8bzb0p79v72ah3dk4d580xxkhl573nqdkkf0xf7fl5aslig4h")))
...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "13g8w3sy36p6cqhiqkwzav4bvdmdsr3d7il83hxqnpxizswd5yk2")))
   (package
     (name "calculators")
     (version "release_742")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q1c556bhvxg5pr31kzpkd83zsjr0zsq6r58ln1kn5j6vbwg6m0z")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hvfwd4qggifrilki5dcv5k5ijxg6v9vjr0x8rsiy8vpi2zlff0f")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "10fvsa88lbwrvacpp2lz480wid9wa8z81y73w86c29hbj2xsa60p")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1405d0z1rpaw5gdaq0fg6l9hglwi47hcj6hbpi55cwhw1pglx875")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ca56w6v7c88ppjbmgadgdqxwka0nsykaa8d398gms0y2w9vbs6y")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pd2kglhpvqa3b2jvizy0zsxcc0jkrlcm1szsj1r00gh9jipdvd5")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "11nwqfdcq4il1dhaq5qkk39ybm2fiz5vyw2jcm1wjzib8glhf5yb")))
   (package
     (name "content-store")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08lzcj5zkkicwrqwwnppyzc2szfjnwpm4nr6dyb8i35p5mpvysfn")))
     (build-system rails-build-system)
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1i1zy6i7wq9yv9qn6az8r5nm2yqh73c80k9c2rrv2acf8vs3qi6m")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fnl596an7rlaw28gdb68cf2bnmf42jaj7p964hxk2i5y92gakwa")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "12fkf8xb16w6iwjihf27hsj01jx8drz78mrkhdq073fr917m5hzf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12dpnp5j668ar3bq1jzcgwpr4nrh7gz4yycy16fqigdj57vhjxc4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "11q283nyx5di0nf4wfygzviaphnqy81h0w8678xqmw4v56karvc5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dbhy0rciabqq32blckcbi6fs64vf2xz25ad17718i7mzlm17hj6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3610")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m5r2b2cv8k5xkijv0dxkhbqmii053gh8cmcfrv8pmhgxkq0xpdz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05icg26hl40864g1g7hqr5yvfxqx142bjm82vbvba4rsw8zcszv6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1h8sg01k3ar5hm243lawswkicscmpdpwp5kz7l0l4009ni8sivaa")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b1sb2wka0q4d1jklq9sxnd6zvj40pjc1lbdz4z00i8sz32xp0l3")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sd55dsaqglpcjr8ax9az77xngx7vsjy68q3yli8wpxhgpnqyzfi")))
   (package
     (name "licence-finder")
     (version "release_792")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sg05crs0s9zsnpyc50a4mlbhx7hlpg2ra1px8ps76fq28mawdvp")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lhsgd40fyj2s93n8w9iiqhz4vzfg7d58phk1cdgfbzx9bzx77sw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1aw8q8dm7pg0vmfj2lby84ygx6digqh7gk7j1irqkd9vcbsbn4kv")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "121kk8i771fl567r2vr2870bbnq80fg9szlzmf4q6b512zip4x5i")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "19p6305cc2sq683jl0c3fivvzhsaysjqy4w087qfg81ibayfaqqr")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "11xwk637rcgz5m7v6zgvi63s3bhwldd3slvxaww3ihqk5i5s9ahj")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public router-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "18260qgrja751v4045z7k0iyhk7ilfldkdvlnslhd71vsnhhh0zv")))
   (package
     (name "router-api")
     (version "release_312")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x6l20p7wsj4nx76xv5bxg1zqn1jc1q29n9vdyc2zwy0lahblbc2")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j99n3y36xkinikvxbibriv0pjz8ij3skvmpsq9jd85vr0fjkf9k")))
   (package
     (name "search-admin")
     (version "release_412")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y25112x0rqrrr9450xn83zbsaf82f975w5wp32x178raq3wn15x")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "01542pccaa0njarc9gw5k1z55h5jv2k5zz9k9hxbv3x3a42fm0fr")))
   (package
     (name "search-api")
     (version "release_2580")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02cqyc5xp2nxzf2klkfhfbjfqmnid7a2skdlb8ym1lr15l8vpjp5")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rhxlljn88rr281cj2ss3nfvs3s9ma7l6cg44kvvpkcxw0wrkrkf")))
   (package
     (name "smart-answers")
     (version "release_4873")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k2crvh9xm04mcb9xkwx3hbl164c0795b1szdndayar57w4kfmkz")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hscim9xkpla3wdyfk58mlgfp3iz2ls9jb63fal5wbxjzn17cw2c")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14b0clkkbrzip1fdh4b80ms7bl4zimbm66pm3hx31i7cda1pyjfd")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14847")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m29qzhyymrm5m84jc72fsns4i5iiqi8zrimnxyn9s1yz5lwifi3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
