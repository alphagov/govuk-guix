   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "082snnhx4vjkmqxy6khlfvwri91zidls942wi9rcdxck2057099b")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jjs6ys979d3wsmdl5kiackfrg6aarmnjk14jsj4sgml1kaqczxd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3688")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0znvlbjn3j2pvzbh30kgz15x20lk63cxnnaw37mapsdihg15xb2a")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12898")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w5plgwbv5zgqnym84pxd9988aj7289d6c1x02jnizd4nins2bpn")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
