   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w9szrjm2vvyy74isfnpcfjfpdxbbqmvmxikwpcpk6v0fkggipil")))
...
(define-public bouncer
  (package-with-bundler
   (bundle-package
    (hash (base32 "18qr25n0av0n58x5d2b13g6kd4jijbkwx6s82dzgs97cvf8clj92")))
   (package
     (name "bouncer")
     (version "release_216")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cw59cckngp9zrwih0xqn5830qv3kccaxrk9nx9n1x8xp0maph96")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hsvi08h06ra14b9m5xhpkiv62prp6wcz458pzyj0a8h97glx1x1")))
     (build-system rails-build-system)
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xngn3fyklzdpykvk60p9r0x4l3bhd9wnsmdfkshwybv360qnm0n")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15wyhz6spqzd87rw5nwqynnhgrk11cwvdbpc9sak2y7xajn1rcyg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15aa18m328mxzrjy76j9kpvwb9gw4khnmmn9sng6dvif1v16j8bd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0df2dyw4b5vbxai6ab0bsii4cc3hx38zjg4jjnkz5bm3lj78l5pj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zb9ixx2qzwca62cp42gkgyvzv8249scawpj852dy85ycmd6xvgb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04m7cm2d0kp1bgxqcwfllpzrf1ccypch7cy4wdncv77f48whv0pi")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y48sla0n9r1hhbwx0bn4v4xcz0azqj9rxqdx501bq2zxvgn5qwr")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a2ycgln9ylbzjvirwhm478ydr7kvbc70sq33f0b4jiql375srzy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "159xlf5mdsp9ssvc0p7r78bk5vjk463gpldmx4qcr12kb9gb1dv5")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ydg3fp13f65vgy3m7xhnngqk1qhkjrm24fj1vg08y83dj5z6xnw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17ikkcyhka16q7js2ll0qjpgr53k6zzjmq5j5nsils93ss4bwn8m")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i0mh721x9j8czf14vnwd9zgkcc602w26vlbfg78vggk6a1c0jnp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j1z8kbyi4srr9ljs012n3gkxc77yd6440a4dk2rydq9nlf41p4j")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0ngvppyc2c8cnfjb4k35l5h15swzyq3a9vicbbjzniriqwj53pps")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "191s1wnw427iqlgy5l8b3lgv7739ljlsyv8qficncqhjbxfapvmj")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xl0f8vxlvibcrwcm2wdbs1nvbvhvaxihvi9kgjlh1fg8f70c3qh")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2737")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1schmfb71sv3lzlczm160b63mag3rkdsjvjjc0xn4cw3fabq7vqa")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qzgj77lsax5ldr9adpws979gzbqiafc1k9kfl4051kx2777mkfk")))
   (package
     (name "transition")
     (version "release_802")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08ki8vrzscx31xz33s0zrs55vhnlqmxf1b12hw4rjjqba4wrwjbd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06vwj4fim6104s4lsld9v3aiy09rv5bs31ryg8cb9z4l0lq0m1gr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13134")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "079mb5sx6yhj2m4rm5nd5dkdmasymsa6fajf2gs5h0844bfcsm5z")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
