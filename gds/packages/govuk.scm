   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cjaffnbkxav760j704gwlq675i4vris7fw6yhn3pmjb61w988s8")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dz3mv4y8c9p58jxdxi8alxd7q62bafhnajagxpmfsq90m3wcha4")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1n0x8j1i92a9y25fy34d8784w65mr2zf67n4h80xmi535ap6bjsw")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12865")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nn456883kbwhks0zqc4r2nm8y1phynmwf8di2vyq9wby8szmfi3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
