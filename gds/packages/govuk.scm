...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g216rzqfihlilq0dm1af1z2a5qk5m5ah7gm9yf1zc5y6gg33ivr")))
   (package
     (name "calendars")
     (version "release_851")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iab8wdg2xm137lc7jdrprmsaissmy2fy6viy9imw5pc2a7yzsk2")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kvqq8zf2zgvjjdzgr6qisk1kh34b5cl46dza0cp32gnsqfbpzgq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pnhqczrkvsdk5jb7rmxgcj1ljp9gzy20dj9ql9my0sm1rbwwv3w")))
     (build-system rails-build-system)
     (arguments
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0y6lzgpdzkj7kf60mgkhjri5ycgs71fahxxjfx2gs5m3542fpzw5")))
   (package
     (name "feedback")
     (version "release_790")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pdnmmd7sgqapvgva0l8mqa7vfwmwh1dmgizhw5nyfxka1bcl8xg")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dw6xg2c46r1ngiyd1qhc4vzh1qh6xj64ns3djii8wgw74xwfc4m")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04crr0i08y25vfbrwha60p1mlw7rmpaz7qw5mfy923q0aszhlxqm")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j5k6jw9fmpwr2ww3xs1sc1hmg04mpp0q24n5h5112xhr7xs3hb1")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "126xw42d3alimgibqlxa4x6psaqhdyy5mbjwxpf0fj0nnjq4jd1c")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rffk84y9c8mzyh6cid305q8j5211c6n5k05iiv6kabg98qrkdjq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "00whyddwvl6mn7nsvg62z178hs5fzbbzdbgg9pggma1mdgk2j9kk"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13fyxcck7ylp0mkh8n5i9rlmy001idnp4d9almj55lx5y1kwymi3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vc77x9sbkcrpcp0ajqmjv8kayd1hf79vx5j845v4cckkr5hznpb")))
   (package
     (name "smart-answers")
     (version "release_4551")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0249mrzr00k7m2dhgbqhp61lb15hib04ncqjl6qzryqvqdsiqlbr")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lpx7hnr95d9dm8bls2n81bzj2lwczazv32iz2bsm1qhsxx3fz7g")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k6yybxv2d3r9jkbn2zg90aqnz5xjp713smbhsfpx1b95qaz81yh")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1frq4jvh8k3dxwwxxjw247x77xh6p0rnk9pyxgc4amvgi059dzgz")))
   (package
     (name "support")
     (version "release_928")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "031snx4xvj0gwik303v54iihqd7fvl759g3ljgxhi29k7098zavc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ls08fwgbkzccikcskpn4dpc0z3fzl8qlri57ha4fimkbrbvpkv3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pgyy453q7jdyad50585g3vqn1b23ica8az3pr6yzbq4v2j2263q")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zvk56k0y924kbdif1c6iq5swadlksxlyk5rkjl1csq8l0nildld")))
   (package
     (name "whitehall")
     (version "release_14434")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g9pdi1r0skmgx57q9r5pbr6k4s539i8absr5fwb8z92hpqzypqq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
