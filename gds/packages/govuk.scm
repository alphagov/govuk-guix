...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g5d7jh3pdzivyyidljcmjjlfc1ay7lwis4vaw05rbp8i3wy918m")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0caf747jvz65ar6x572fd05wb8lgkps4qxbjq68c3q22y536i5hr")))
     (build-system rails-build-system)
     (arguments
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0iw7rmfvaf7w72k5yx3rajc0cablivzh4wymf8r33xpwpsslk8af")))
   (package
     (name "info-frontend")
     (version "release_539")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ansspw002c9vm9p6mnh86khzsqryh72ad9v9152pw4d8l8435py")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1bjgnjp6cp786cjvgxmb35zvnmxy2m639n8wjjaas1bdgx09vlnk")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
