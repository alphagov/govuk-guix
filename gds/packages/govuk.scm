   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vngjgzbyczsc47290ggs4njv1bkwzfbkcig80041yy17fymywkp")))
     (build-system rails-build-system)
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wd7d55p5ndbi30g0dywc7w6jdwvxaxfsyw1lj6477b6hx54ki7y")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m6kjr7hzjpasvkyfl6d0lanha8ipqdaykzxpfiz97rl25asrkhw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2041")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w8lx0zcgz7pi7zjjwxl79fxx4as6li7kq35j1yd9l4x1wnsab0s")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
