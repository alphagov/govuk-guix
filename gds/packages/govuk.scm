...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rxqhz84k7wk3pqw7xxkbr0wbn055r4428712xdc04dip1zhc11z")))
   (package
     (name "collections")
     (version "release_698")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "172vr81j5d5ssklbr4q110l7h8q2pfjcr1a53cp57rv084qcf2ly")))
     (build-system rails-build-system)
     (arguments
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "14w8h6dls7v8392939857vmlkm02x55nzhvz7nqgliv73ggawi45")))
   (package
     (name "licence-finder")
     (version "release_457")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fylvccxb5rg68xp2z5w0w6380851x3yyp8wpvxg929brm563wg6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "00dpfccbs64k807fdrm5m306bg4vb8pmhd8fd2q3xb8iwkn1b94z")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fl8f1x442l39k1kmf57wxb98g3dji0g0a75g70a0ps10kr3vw4x")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "17j9ydlvz094bj39ni6i5l1rgbzb68nz9c7vxpx8sagyghxc00bi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "106pgp6l94rbvcqviyg9iqpsmpd114cn1401i910w37xrxnbrdmz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sdsds6kv93kkllwps60fxbfaj52m9b11pw4nng3d1q8wgfzvjvh"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hkd74j9y9wi2ddipf6vyy5bc4a4pjdz9pssl9ywih897c9r6fmg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
