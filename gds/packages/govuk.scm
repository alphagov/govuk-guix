   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nry8i380bx74gpvbk3ll0w36svfgz8415xgh3shiflzml6ayvyc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qf85sp7bbwl3jcss2bnvshxdb2nls0nhpk0ywzcxmzyhnj2svf7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "16zhdbyvd46vy7x2sxrnirl7hkc360y1i58z6m2p88ms08ax1w7n")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qxjjmw8zgp22mzcpi76zlfbqjf1h3l9lcnh6v5q6ralcxzz75qg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mdggp2rbpfjpmdddddmw5c7jmj2i9z663420i6clspmphc6c9wj")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12999")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lk2a8l5z0g73bfgr0zyjdacv8p3k2wpbrv89z370l147virmp6f")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
