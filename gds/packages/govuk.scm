   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01bi9cx51ywbzw59ksdmnwxj2zhynjsifwmfwwv6vzc6qgphlc88")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dxv35v9bgmmm5i36ib74dwvxgddivr8g8r3yw8c531rpal6g6sm")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12922")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pqv1ffc3kf0v0arajy607xvhfqncy8bpnbdipfmhmy9b7nfmycj")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
