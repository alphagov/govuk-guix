   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qmdp24lzd20268z4v59al57xax81k1wkm3n2bvanzyjyfydlxc4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0aj1y4m62qvzy28y77dyfrzkknajad0wafcmardmg3nlwnq4cxp3")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "16dc1kqhldj7ynxgnsdjbpz8lf00a5w5z2hz8s3imy564cl9sziq")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
