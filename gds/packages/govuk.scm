...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dqavprn7n9dhv8yb5j48z628z6abagwawmlam25l9d57hh4n5mc")))
   (package
     (name "asset-manager")
     (version "release_115")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15lp9sc434a5cj895cdl1k9xc38vbhrwa6m4cha7xiz9aamvn8qp")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sbkxb49m1q8hbc11w1z5h4f1srsx16a5ssnqmqdwmiqnz9k8pfr")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s67a10ck1hawyddpakvpdkb670p6arn1yjhpllfba3ypm9a0vli")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00m80zqsqszdch06kqglgrfx93lmwn6gac91x6khim9nq26j9inh")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hyf7qmkqxnqc0k4lbbhfy8z7q4xri0jnmm5r2z4iggr09yfnad2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0zbj6zhvk57hnc5ncgqc1bgh8p3crlqnsavkyq9af1s8nns5lw2c")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "15h9d3f2pv23fbwifhpkini6a5dl7c9irgw9kcr9224sz9q0kf94")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mmrjnjqqyf3vyp0b8w530n0s1gnfhxvy1gkph80b8skc8p3gjj4")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0764p45adm5mw3f2fbi3f89gs3phah1vjfxj0hzn50yficjhlz96")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3713")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r3scrm8alb6mm1zkp5zbydci3clf1swr31srfv7yjypdiwa4gdx")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2644")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wjw3b0qgj0clar0gbrm9x42ivrcn2s609pixjib8j331c8ssxnb")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12943")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ilzhd7c6jv4lb6jihwyqh9hn63rwwbv520qwswiayq0lsxpbwl2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
