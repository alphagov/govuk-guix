   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bsfx2r8pp2sm6ghp31zjfacgmj30np11cdn2c63gnlpinh2m0sr")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1snvnf0gp854ng9vsia79sk13a4ffg2ixaqbxmzf75r5f36cppqa")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jl3047q3c8vd8ag0lqh6syavhavhjy914m6bb89zb7pp7fhk1rq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a28bm6bcdlzrv3myf4fad831favy27xjsyf901mb60z6lgcbvvf")))
   (package
     (name "search-api")
     (version "release_2477")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0357pjwfwpa95dn7k2zpphk2fnjp2y4d2p5rzmwj31q66954wyx3")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
