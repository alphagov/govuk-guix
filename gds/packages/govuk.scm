   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "004wid21syv5anafzscc5vkhv764i1nbgqr2z3121fq7jc5wmc0q")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0iksda27dpaxy6xpb9hf02a0c88gjivm5bwp03zfllvwb0r2qhhh")))
   (package
     (name "release")
     (version "release_360")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y4j68bl0jq2y5kjzr5yq7kbsis834imhdcdffc7dj9h5chgmgjm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
