   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "049fld18ng3k47d9ynvnr6x1iwnbiiv749csfb8khqr7y527h4nw")))
     (build-system rails-build-system)
     (arguments
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pysrmj5vhph2cdmkxhc976789fn72193flyaakh7hbws17yh8kl")))
   (package
     (name "licence-finder")
     (version "release_714")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kxhkajaikxgf93layyjdd6i2axjxf50rwnyjjwb1dbz1az595xz")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
