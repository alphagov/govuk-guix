...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jbrk3n7aa4dc98amgky3q4b91f7sxv1miy0asq9nccn86q4cgff")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02kg429ywb47l6dvbrv57swxwrmxb5s2q0j1phh1g63rbip1z3pn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12911")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x3b2xh5726x5bf412hd40vg4781k60iswga20wfhsldjff33nw7")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
