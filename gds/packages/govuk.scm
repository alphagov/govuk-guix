   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17mkd9qcc6nzc3s3851731agpxzcq2arbnqib2arjzgc30bh1yp1")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jds0swdypq3v279spr91pfczz4lwj2q84cclsnrw2hp6siy9q32")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13893")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z2qrzf1qb93qilczh3chfa5c9nzsab2svsa0y69fwa3clgpzx2s")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
