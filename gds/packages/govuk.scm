   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1kdbf1g9jlnzk3byrh7jdwdjk2qcjhqxp66iqhnyz33rgjw057a9")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3666")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m52qgpckfw31n197x6pr3x0123j1ycqn6k8pzcyicqy1mn5134j")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2614")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "039qsx3ik370yrhgdx9vr2xdys2zpfc3qh5cw17pkai4pg4qjfx6")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
