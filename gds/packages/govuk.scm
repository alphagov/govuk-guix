...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ax6a00v4ggafmv7jv7nzm2xxwcd4rh0c26b800smbqmdciy88sc")))
   (package
     (name "content-store")
     (version "release_801")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18hif7ndf76r91k5mk16367ghdf41kmhv4kvyszwvblrviqhmf1m")))
     (build-system rails-build-system)
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "12mr57ds3lkb8ps3xw7m5df8dlh4s31n8bixqs03n6s3y3hnvcr8")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0diqq3daw1iz54vrsxd61qkz1vil524zmz8llr5xlxsmamrgrbzg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rh5b3m7vmiypdg6aj79f1ifpg1bd49smjy95s2b058mv4fgsz70")))
   (package
     (name "release")
     (version "release_371")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lxqf751n5gfha9h9q2d1sqwldwq0h5bj82zgg7k6mvhdqd6cnv7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vb4i3bg3iyq91d5p16mpnpjkx41cs7xckakyb6ad2ymyih5w8dr")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wjx91rbk9fb3rm1zpqaf85b8hj7lz6hry368y6c7i45pgmi8jy9")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1arjiijrgg8smnsh2sfig9x5vg7v2zcdgqaad6yz72573wc24q4x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "063sxziigf8y5x5l6941s9f586fqbc66jn667pkd1ymfyrlqp11r")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10cl50l95brs9xsp9g8wp1jswbqj7j7lz0q5mw3bjzy9gq00wjwg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "10cjgjkdwl619k1if5cz6z20s1k1gxfg7w5m99rmb26xlzmnnia5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03nd0i9vhyl23a5xs9sb33sc8g70p7vqlsyf3clmx5w01z6plbzf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13791")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k8f7ylg45mnlzcxl9hbxgcy49axjh8c5ndvc24l9syp9pg83dm1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
