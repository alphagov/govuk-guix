   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "183ibvz8bfh8fdpl4xmkgngxc87r0nxkpjanlrr7fk541dsdbxfb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3833")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12v1s9yzsl4q03j75xc50rgw02w194vlafq4vlassqhagp6b4qkf")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13218")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wm824gqdabc2kndk0k7skkrmmq3fr2v61gx4qkj4cgl6vvr3z7k")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
