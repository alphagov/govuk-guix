...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g125z6vpsgz3il83ssbgxzl1q4hqn64w7vdm89a214f7d3g16rb")))
   (package
     (name "contacts-admin")
     (version "release_425")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "157xrmdc6c3vrawd98pjgd37qvfszaxyh65bmjqzq9378j2qm7jl")))
     (build-system rails-build-system)
     (inputs
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "110gnxyjghg3wg1dfs8w1m7ng857pdvijmvk7jgw1k27aqqpvgw6")))
   (package
     (name "info-frontend")
     (version "release_134")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yrhnm2fknv3a74gd2fa38qwxgf4b1iwdqpgqxrh16ymfnsamlwr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1144kimw8ah9i3kdg7x2hi4k3c2879z28dggp22xjinmdw7cf8wi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k25b03xkx5kd199w59dqagqlkfkqjqfsn9s8gxld5snwg2mjqjm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0iac0phazs6klxy7g558f9myhcrwl836lfz5msr4k85pa9ijwv93")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14r1md0c0pn0ssr0lnv1mszc7s7ijh25xs93ggl020yb8cjynwaf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "02cwgdx41j9f7mvamdbqh941m09yy6309baxb87p865jmkjnqvvg")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fkavs24k0rhbm9wv7gwxj4n4ayg9hn8y4n9byg8n92dj0i849hg")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
