   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "159pqx7ji24lfyxbkmx388b4vf6igg4s6q1kz1difq8af9dfpwha")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10m8vmkdnylrkby9zxj6hcx46ivh4bpy6rgbpicbm3h6pm1i297a")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g7mxbwbzkqd0c530w9mzzxsi4icy9iacvb5jx66a6xycdphjign")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4480")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11419d88y6fsnlh6lryjs73f3201gyg3bxwfr82snxrpr4dsvyra")))
     (build-system rails-build-system)
