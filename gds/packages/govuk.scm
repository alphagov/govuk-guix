   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d37lna4cqsrqamm5d48nhcx1cxs0v88spmqa90z9ra611icd41n")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wn8d908lc3id09qjsrw25qkyq1cy23nhwrwl9d82vyijka8ya23")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mf0xsq01drd1a8z4dzzz09g01fzhmv57pi8s9w083z65lixrja0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13266")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10cc9lakkzh3rqc1w8mrs0xi6mmy8870ap388qlcy537xgnk74rq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
