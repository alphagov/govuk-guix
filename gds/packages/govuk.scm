   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "037lg1apkq3y0yb11myvds453bmkgn9srxamp6655sd0nc37kwn3")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y36igc6llf00fbv5ibl06innng20njw5633m74n1xbagfwn9yr1")))
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dyjynbmz82rfjarljcyva03bsadrsqzmsaj6gbranwx1cf675s1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xybxmzsj9vgg1qi09knm68biwcl66fn0yvgjw97sapd7j414z6p")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
