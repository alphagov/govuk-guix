   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1frjzxrmy2sk022lcj0ibd3b9d2i4zvn34khcz2pn2avwvipxrdz")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qb164yc4acf3m3v3n7f4gkxfzy70nsfc0vilgx3ffng8iykkk74")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ji6yzv4rw5bdzh2c8ni0b9kph56rfd0imrdi7v41295w8340kv2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13wk7hkzyd5mw5vs3h8yzaw7v2pa0sfcfgbxxwlpgp4p6nsgk0wx")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pvagy1dm70lc41l84mq0cnisibawx2i0dszkkjby3p5qda4w7ca")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vrdwrqdj5fcmfvw33nd3n3vmpx27c3i2xkmdz37qd5kws1751yk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c63fhgbdm6iwj7rc1pf5bja48xshj54ha4gwc7gqfzlpnk89ldb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0qhdk7v99k5vm4fv7vwsbidljww2jzxv8y2k92bh6lh6i2jk83af")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ddqkq28127ahsfb0ay5f1lqrmwmj2289gzbxn3znvi3pxf3dg89")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3716")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05zvgbw1ng0mqbfm8cfx2z5sb6jqvijcyv091czhrdmv7y8dlmg4")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12947")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xjgmnhizaijjq7sqihhhafixwy0xqj70g7dk16adsvny44mba14")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
