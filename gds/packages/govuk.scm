   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m8gad5khz23xi6abc2g8y0d7qbbda7i06icwg4m5dip3yqhq5ff")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2740")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ihbx00b2vb9sciqc1dnvangnws6ykrimxyqg1nr6y6qnaars4nj")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pwscj6l4dfgdb116ciph9mzmlizlicp6jabiwfpwwvxs99vcs0d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nq0h5m2w1jvksxgzlmcfgmlbw9j50i54gbz9x0674ni8ysg07im")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
