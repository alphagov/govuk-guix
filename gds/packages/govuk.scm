...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fpyi8l2by6aw31xnf6px9l7h4wwr4nl5awgxapli0kjyx1qjlbi")))
   (package
     (name "calculators")
     (version "release_211")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pd935f2l0vcmgx64jmhhy2fsl444smd4yx4m3ybylg7k2vd8mpg")))
     (build-system rails-build-system)
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "1aq2vb93ggipss175jmcrrw17kjgmwx5qhdwrr63373zxki7z44h")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vdcxvh26r706gs0nrz3yc5pfxym4gz3i72agxd137wqy9sic440")))
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pvf5wik3xfkq71m4m6cac4w1as3x5kywl4ahwwcpfgzr625pn1a")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0618x9b4pr371akn4l99xdz8zpwnkkxqwi3w2cb75sb9nkzvgy6g")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00bkkgi5scdagl69wdihhz9wrs4lm3chpbn4ajaylv9sqg2xm0sl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nwfzgcckjsh2j2zl6a3srpqz0av8jmg4wpaaidbdgmmwcpl8yjv")))
   (package
     (name "maslow")
     (version "release_209")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03rafm1sl5iz4jslp17pnhr60251bwwcrf33w70symxr0gm84k4p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1w7y9cjs45fnci45cqry8xnwrjvkfjm92sp8qgq66ffvl7xbkxcq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zs7c1v9fp8s90p9nyc1cyp41hiwmdbchw3asgqk02zks61sgml6")))
     (build-system rails-build-system)
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gf8i8wkdrh27zkkxprb3di2minzfr2sxv42a3s5dnxiz77fdgcm")))
   (package
     (name "support")
     (version "release_605")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p4a6b2yp636275kbvisb8bqgl0ksvsm9c43hrgi9j4pb52f83qw")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "00571gjs3wv500y4b0xypcjyl7jgfrpcybmv89q6z4lizchjai83")))
   (package
     (name "support-api")
     (version "release_140")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pb30m7fbhlqg28g2h05kalax90pb4sf16aiq69bjaby79n8h9dp")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (inputs
      `(;; hostname is needed by the redis-lock gem
