...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "17yqsizqqqq888d11gnm955z2i94gfk1d99g3qqkj80kc69fqhgy")))
   (package
     (name "feedback")
     (version "release_646")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nyk2anhj99abghi096ajh3y45kf7vg56rl3xf0fnrg5ijz61ids")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fvrxlbwxx4qw8bm2qidj63khz405xlzrpcv52yrzfimc7v89sfa")))
   (package
     (name "licence-finder")
     (version "release_568")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05808g9ndw2rbgpchhnr5nk77lrbxbfkwfhc96rzvg9hixs4sri6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j7pzb1pdib8m1ri92x9hkafplsxlj2m9rgsragj0x5cvc4k9p0l")))
   (package
     (name "transition")
     (version "release_905")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v8iy05vzmahd4mkw2kn9fhzdpp131mcbhafbf2bq4r71k7n10mq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
