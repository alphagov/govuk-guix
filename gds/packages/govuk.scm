   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vw7w4dgx8y8k0jshj10yj07p7nj2jbgj595qwl09hd55dckqfgv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ib0f9x7xi256xqsyrhyd37birggb8k45aajifjp5l25pa63bq80")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hz78mj2pm4mw9jzs5ypkkmc0fpvf1rknij0v0s3kr3x0z6hbflf")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
