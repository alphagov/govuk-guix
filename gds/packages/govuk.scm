...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ywizjdsfpqh6yy0smr0nl0c4n7hgbb01bz4y0sl48q053qw6cj2")))
   (package
     (name "calendars")
     (version "release_602")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17ca6vr4grq0km2nwwr9xp7vzkzkmbb58d4ipp6dxsy7mpp1dfdj")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1b1ak3kbvl7qp9sqi63vvqyrgpg110rqyi407ln83a9frd121wzy")))
   (package
     (name "collections")
     (version "release_714")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0acp5b1wmfmhf345fjjj8ghzf49mzbn1yrm7pczw4b5chipks6iz")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bagk7cgkczasxliqvk8rm5qn31b1b7l0sgjcaqayy9v5kj2bmk3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "05q9w2b64b01xxcnjhaa6gq3k9rqyg4gfp0ygn6220frh5ms8589")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xqjxiacs9jzvskvb4va92zfgnak8jikpck6k9bb7kgffq9zk46s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bh600kd1z1z1bk2v1lqa4q99l11shfgadfx1334a7h9a6raa3yh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ynbrpblb06dwqp1vc4kfgdc3rcrl7kdca0b8nwj9hipwiwzx8bl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r4ad66465vsp72ms129pb4s8bwff8m59p14h8kknwrb0pcmvx1a")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "101pwa7pwdj9970qncw469979203xkf1kxv3q285a3r4fid4qwf3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zvg3wmshpn1bycs4k41pqnhbkfv8hcaj7qmb7x6qy0rz06f9nb7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wwplz0j906pv66hfx0x7qwp93michx3n224mvahjwlj8iqqndkc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12p5n1lgcnnj8p53p9g83p69mb4dq1aqlv654mf9514k2i78gyzh")))
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xbjhm5h6mnn75n0b6bsq810g3yqkcn6wgc7ll42iajyq3rqvkyy")))
   (package
     (name "feedback")
     (version "release_525")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "066rax434b4x4fhcq27qnf2n1ishmc1ckqxak8lq3qfasfnhplnm")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0c97hwkjlcbw6y137kclbgdkwibap7ly11czkgjvff6k1cfraq41")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j6ld1x98dcmz5prn37v78w6n2j6k84x3nsk6k6ildyp6mm2l36x")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a91fp53mvfgajq10xzahgrnh4w1xl34dqcp8xk6vxpqw3qrig8s")))
   (package
     (name "frontend")
     (version "release_2993")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lznwccfcps6vqg008vkkfrlyvlabpl38gpz95kiqsdhvwakkhcc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "09fhad82p883iv56drnjhz0b2aibdybnma4p51s7bz3ky5y9sdp2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wh6p5zchyq53hj2gw0wldcwm8naxmg9r88p4rfvxhki5n69l1wp")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ik1xyrpbs25z4is2fiq770hgz69lhhf4017h48fz7d4ysglfk58")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jgrckymy4pbdqlxvmp1nwsy1qzzl8qba5jir4a91wnpnw769av6")))
   (package
     (name "info-frontend")
     (version "release_236")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p3fsi22lrs8rnwkf63n4b2xj03d6znr2qfg0h8p3121l29hbs8x")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fh3rw4f4fcrg5vfqp7s6b167jg2b9bij5f2pi7p288myciq56w5")))
   (package
     (name "licence-finder")
     (version "release_474")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cz1wj2r83lrqqxrl5q5v4h6z92kffffgr6gzdb7shn4v1icb4ka")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nf210iiv7m2s4grckl93h2z0kxg5h4gksf1klddvmlh7ygq692w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0viw9qb4yqfb0fjlnj3w4nslvkgwxxx62qdi700khnaw633fml7b")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "09ya5r1gc9y9w52bwyph8wa4xp9dhxbczy4m19rycs13hp1y6y37")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05i53mq98lqkbvijwbg94asa9azjapsbj4lwfxyx7y6v4sn03jdr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "002vv1053fw5qxp4fmmkxyd1gmmax4b926kim31h8qpdnspk4wiy")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1wgk3m96dzapdaafz5zfpf0zw5i0z3ip9javx1w8sxjscmr8i87v")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0aszwqsl5zi6r3lzzn9iz9ippaxby4w1rksah2pc01vqgyfa946g")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q4cm8jvk8b1qh6997gp117k1pdyjmvp9h04jcwii1ljvj5bfdbd")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zskvvk1v3v19pfb9ic6iqwk11ckai13lxsmf3327rlqrfg0zq6s")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00b1shgdp88dffaczwfyx0lh995j629sabqj0k3kfzx7vfwnqc9h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nwzq8a0m4lv0b9rbyjkv1wkznlrsvmbgkkha09s6rajw6l33z6c"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zzlj86z1mnm0n30dli2pmbxk92msi8ph0pg1akm8z20rrj4dqb4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "11xmac7xq2ph0mrzag22nbvl5w2vksn1pmyzwrfy1lrx7ncd96qj")))
   (package
     (name "smart-answers")
     (version "release_4113")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "127q9hcfx648rka5kypin7x4wyx8zml13l8smfrh83564zk3b5y6")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1saxxc7a2fv4vpnsidk88y1maxmql0bpn3jy4sf3f44qmpwqfnrw")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "169ps2vscrcjy8rx9pbvv2ycrpk286b9fl4fpipdzz2s5swa807w")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n9jlnpzn5hx6rgd4f5y5ngkil29513a6nxfdhv1sl1318w7mmci")))
   (package
     (name "support")
     (version "release_730")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ggiw1y8r2wz2mgkcs7fp333sxbp3nchkjhczrbbabncr81m3rhv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "05v9hhpfy0wbyvkv3l0wzsdl6cfkv3visxhkk9i7z5nq0gg18v3v")))
   (package
     (name "whitehall")
     (version "release_13741")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01dhjkp8fy7lm3bzxwa4jpa1wz37xkp5zy07jd4h378bb1klh0jr")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
