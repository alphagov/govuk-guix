...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hgckm74zimqdgr1dc4clhq4xb9j9smsj4f9p7mhrbkf4dsh6x6a")))
   (package
     (name "info-frontend")
     (version "release_515")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z5drjf1mfhrjpbpiprngh9av8xw1g127rdvrpdpx6pzk4yfrysv")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1akdadxiyhp0m1vpslsmv87n13y8hy00ak2arc46pwwlbix39l5l")))
   (package
     (name "licence-finder")
     (version "release_758")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cjic0v78r9xv0qsxpz3h08z9mllrvj7w9z7pc15ijhy33dyj9l9")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s328mgla1fcviw9xg47w4llzhl7gchl6vm36hc6mvdqsh9mp25f"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08p103vc5svxg9vvavsn65cvj251fc1my2krl85jq0y9ykyi703h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
