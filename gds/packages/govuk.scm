...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m186vw5s6k1ld5srgxrg5v7sildbv0saa8c38grqj6mlkg5d7jf")))
   (package
     (name "feedback")
     (version "release_838")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18rmgpq82b5h5nwv1yy4kb7sr2f5d2g4rhjipqlcagrwwgag682y")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wi2mjrim4mgw2685qvp7x0il47v683aqxvcics74ww1qpizkcqs")))
   (package
     (name "transition")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cbijs320gqi7a4k9wd862rznizhia4snxxqz52ppl50zn6gkc9l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
