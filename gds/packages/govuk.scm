...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fxvscsvn5591kj8asl3zzmwzv61ymasqrkisi6na4j32wai080c")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "004j5qx21spbfx6a41fpw3y34dmazw43nqzxg3gyyx1r793rz9i7")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4834")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08y6ri2j95y2la6lajmhfg06ia390asjqf3sirmxc8xzslblncfk")))
     (build-system rails-build-system)
