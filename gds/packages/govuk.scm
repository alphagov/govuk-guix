   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qhf77zasixr96nk9z6x6x2pwy5yvmfv59xrm6cjn7gxw8kd7ais")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ww97inlvw1bsffj2bv8g3cpf9b7fahv6mrqi1cdfq1kyw8wnqld")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license license:expat)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xaprqkknq2pn9q5mpybsj1vap1998qlixa2wxp6mc9iza0ndspx")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0ilcnv7zsdm3xanggbksg6yhg95042vdr4dn0zxnyidrzbfli5m6")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
