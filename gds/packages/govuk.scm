...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "02s3izy8xhbi2hqjxfx8dhxlcqf12vliahhb6xbx1jgyfkicvgpx")))
   (package
     (name "feedback")
     (version "release_885")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d2bavnzb5inasyg49hx698vawgbrc6z9z99gcyswx9gmirphlpj")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1c6i9f3ij6i3096pb8fmm1jlb7r908nphlvrw9jx4vrgc3f2ybka")))
   (package
     (name "support")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0npjy92r6qg8wsycdr4big1i6jgpydgkckmmhw5d72hpb3liwj63")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
