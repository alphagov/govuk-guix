   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d4ymqmsz2d9r8i5h3c2qgpp4y3nm23a9khj03j6w03a8dj6nw8n")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "07rj69z7si1kj7ncdwskp279m9z8dnxgggfn8if2p4hk2maw9cb5")))
   (package
     (name "whitehall")
     (version "release_13348")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13q4b5lmkl2ki2rndqcsf1rwzqwycj9knjbycpw5xfnsq4yahpwc")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
