...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "14a13jbwv5yk5hf6cnnxi1c9599bw4hkxic8ip5vwvl63cw35y57")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1db6nm5gz54kgyx7fjslz1rq7bcjmgji3w13w7pa3k8vznv7j7y3")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "04ibn20hdzfy0j7wib8ix2zhalpqpnsr92fllf2s11anlcmm29gy")))
   (package
     (name "licence-finder")
     (version "release_604")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vzlf5z0mybqid36yh970k7a9c2zczmqcsf5lh1s0jmqsqia2gpa")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
