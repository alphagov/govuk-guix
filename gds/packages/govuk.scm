...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "02wlvb1qb2yrmwga6f7b1mw6is2hz26l8z160lkb0jww63rsvmck")))
   (package
     (name "asset-manager")
     (version "release_390")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x3z4nmmdkvkim47yc8p358fpmnyi7s9x7hfwkv92w5qzqbl161v")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l246bi5xd81bdinbmdf7znn6ac43881gryz69nc2l43ik55z34l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1na0q22mw59af8v5cj8gyljngf7svzal33s1d2rhg0ah6g8n0qgw")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k28ci7dm1109ddlrk5ml9ihi2z5019r3wrl3ba98dpgykak1sz9")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
