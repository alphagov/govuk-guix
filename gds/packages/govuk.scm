...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ksv51j9ncinb9q00dghfil1jw1xmjffrdqp7101j8kmzz8cw29k")))
   (package
     (name "calendars")
     (version "release_682")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l26gcszh2nv33xfnz4mb0hmdsk8sgrgis840if81f19mvpx79kp")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h9g045i1q5kia4f9kf7ffrhisc90hm7cvi617arjsq4s68px8hx")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
