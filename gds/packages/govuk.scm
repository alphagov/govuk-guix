...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h8ccq79gwf07lmx6s6yx43a261k6j285rzksswcrdc4zic4r0nv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hm4lh172gy0bzzzrpzj170f5kh85y552mxhsm455r1p0f9ld25v")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0s82g2l3nsnm40479l1m8y6nxsw1cyycmiidr4arz9y6l7g6j7jj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fmqvki50ra4xvm96nqnb123l656gvqv2vw9rild1wfm8ghbdm52")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13205")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16bfj6mmv3ndbnmnpgid7l6a6kfwzsbcrrkl99d5ddm6x39vv8qz")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
