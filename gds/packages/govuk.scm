   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h8qdbcycmkzik9lf4lwqsv2cb1k3x5w17b9vqdsrwnnrn738h3s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10z2njf6p1m7mgsxhg2i62v89n4fab9yyag707lgvmb8sbkriljv")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "018dl04nk1q0cjb5bwyikc1sws97kmc0das53ygpqrkgr2g21l7y")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ncdiyxxj52bnyw2irsj408cnkn41zafvg7qlwxzwr3qdd2ki4cz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04vzj6nmfmxxz4yqdxd4ddrn4fxcm5g36xvkmr0nkss8mg28d8q0")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2756")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fr2k117dxb9jmzm1aqjabg25y3vpxy2nms9kb9cly2x7gsn1j5c")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06m5rzrf9r7wkvxl65z6b3vk89fn9796kg8dxhr2wyb2r3sxy9ll")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15lv581vws09shpc7kygx704smp677n8fllpnvab20qk028mgszc")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sphpxs6dz353y9la4ahaaj7phpjcsba1jyc0x72ifl1h7j33yka")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h55sk08m1vxbvq4a3lhdy4j03n3yvb5s96qgmbq28hr2w2j3f7h")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "04xhrabk756fpz84n4r92rsficn5pngyjhcliy3vfp2xigdzpwck")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k4qjzikd7295g86wnn51bkq93sr941c6jjnwv79xdigf6kdyb8d")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06fggi3qs5v9xb2kdji4f897w0gwnf18hr2syls6nwzdr8fkr2lp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3782")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nrxsnavq7wwchhjbd8v4h193m7mghhbby3l4mazzy4jca21smij")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jnrwbk9gqkfilqh1p4d4w1d97yldkg2syfi2h3fbyjw852jl779")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fqf9plq61h09vwciyfj1x0n48gf6nfzg0gk0ikld9rksna1hc75")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13074")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lm61lshfcyfymbmppkclchcfvhks52wkwwjjn6sv35ckixcfnz0")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
