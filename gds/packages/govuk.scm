   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z8j8aj49yf7p980b4ban4fbf4h2idkrjfq67p50ddlw5akgfvqc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "05mz41bldg8z5k0yk2nkp7cwyb4b4f440x2q7x0b7wcwb5dg77il")))
   (package
     (name "smart-answers")
     (version "release_4309")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12c2wnc0ca0l72in7hks8ambj5qcciqzg3i8gn5vnmzj2x2g2s1f")))
     (build-system rails-build-system)
