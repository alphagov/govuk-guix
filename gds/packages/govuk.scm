...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "08xmda8fb8bvs451bawgxkwxf6s1ydh99zvs7051651ryvsialsm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02id9mb6jdjgs3yrmd91hi457r5fhyl4357h0q0as6lr782d0z1v")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "152c9swycvsm06sd53c8ynm0llahjj9l94qmwv1syy54szs12lz7")))
   (package
     (name "maslow")
     (version "release_374")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rr279gy45kpa2qc2yf64svkdc2z0zz7ipa4zzl61cq5ycpbxcbj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
