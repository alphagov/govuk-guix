...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1svmnj6459hfk45b5k0dkdrijcw2vwx94cahhr5ipn4mpv4whvyz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jbh1rn9mc0wk80plj3w50cnqdgqrqw395w6q6gg2x1hs0jv2r2b")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a6l41lnvcxmyw9blvy8r362zb9nfapccn0synfzc4lzg59g86m0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ra9g606cqwj3w1w9bg3mri5kiqfbvyp087dy4zbf45aicidcrz6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c0xspvc5zc2qlh7iv87w4bizy0xamhx8j3kkgm4sm9i4a1qv4r1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05028r38j58pjaf11dq369xpnssbbz9ck210vwnnxwxpvwi925kc")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "15650sf0qgwsz54y7sh7s10isjvjfbih28n0i3i0g0l4xr7637z2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "024czrg745893anyqpc98wr9jzay8gzn91ad7iab2ccpmyv1amsd")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0bc969v79ch51r75acw96c76f682g93321gpj0hqy1yywxdjxca6")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
