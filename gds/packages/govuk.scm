   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m9a5x9ghsg51sfvf7afvmclwxcq81sjdg4w98g9n4mdxfj42kpm")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y23z7apamcmz1psv9mmqbn3av8d3lzgl7v5izxvcqk4vs4g8bgv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "106khzlah3sqqii2a6p1gd7af82zmyid49mlf05km0ianxjsm5p2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
