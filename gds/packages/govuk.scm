   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vn4mdj7yx4lll6hby5sfk41v0hx6spm4pw5lm3y35vrmzr9ksc2")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kfy45nprw2yi75gb930g3a8nnb99bv4l2ia3fjbwj845ls46hf7")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0npcz7aadrv89mxlin7xl48zjr5v8rqnjf6513aprpmiz3b432rs")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s6wcqhj945w65523vnvd8nxgz7wcklkcmzvhn2h63ng87jjxy63")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1brsg6jlaym6p9g2yc9c5aw3jmy6ahk5kqjh8jxcxm5gbmfglh76")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w55rw660i1pcsj2bammc2a6c60pfy93zr7vwy0yashyld10xvcj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1drvnz6w9fh6zswhi7pjacjjbmy5m59xjlyqhqxvk86xraf5ppxx")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sigxscr6663ldj6w2dpmir48dx55nzvj5gx3xbdschcn3c9kgjy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cak0sgpc8kyx3ryf81vkyp8hshfn3nl77nkq6qksl23czl4cshk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13148")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q1m53jcjwgg8lmwfz8kzixargfamxpg2jkswc703yyv84q8qcfy")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
