   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17y4h238dl0p8gv6ig14l7adkqzxira71jikr2c31kjm6d7rg59m")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f4w2ki92hinkvhmxy3qj3lc0gw0kqaln3bv1a4crgx8yvwds1nx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "143v9rvpgml9h1alp44hvqrc9af8vgva4dk0q5n1gmqacnywgpqk")))
   (package
     (name "content-tagger")
     (version "release_651")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nwgk6lqgx8zx1ylszmnxgivxgd18vdqkgywkcjankm0bxjqxl5p")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bxmzggk78n7qkpz5y3n7yikcby19bfkwl3jsvgvrpzmpxwqfnka")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a2q7f05a7m4wpc7idx14jfy3wf2ia00yyc18b6jkb7s24iizaip")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "18lbhssc12qgdwsz5awp8vhqbsm3bmdsma4l1w429wnb874yycay")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0p9vkyjlwiwqs7c1zq3z7yl1bq7mhymic6ghwn7vslp4aglyvqxd")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kfwwjd426nywjm7dgfwkdcxcsfdsaad6ngni6m587p27x083yyy")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fwck5da1mc1h6zqkq5x77c43ryxjrynr4hvpmqhfmzbfq067s1f")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2751")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cgdw2aqbnx7bbs6nywpifgafswh1ndji5hva641hxgq5xdii42g")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0315agryd2qj73yk8yn6fzxq6maqlqp3fyvw2hf23n3948rmr771")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pf9bv5dplwqpysn4iqlnbs1hx1jadwbfqxcb1sjnhw1cf7053i1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rza50mb1p9g9ymh3dmrv7vfzkmx7dnxr0lnjwcjy87n3x41kh1p")))
   (package
     (name "whitehall")
     (version "release_13171")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xhkgbh181ghfw6xz8jkhhllparkls8m9yrr34sj7wyd254shgwc")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
