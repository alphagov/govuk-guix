   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jcad8g5pik2ks5ajqm6kh6fjfh3plp1rydkr6gr39zikdldil99")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v3v4fvz0s9il9l3yd4g0v4nfwxvkx3mfaylf8mj1mgnz0hy0fs9")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fdn6vi4dyq264jpvdklia22ycpnz12dh8r7la79p1ib6zn0iswm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hvkji1nr63npjy2v8hh7avzwji4zwa4xz5vgrwfyfradw7d3i3q")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14902")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y7m9j6xvw8jg8ikq1qywxfpvzpjf3hsizx9jxs63h5rkw3zwpgm")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
