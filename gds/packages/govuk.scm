   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c95822q8qgl4yqjha4ifvsrn3213j0dpachvfrxqqjgjxyh42af")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jnjfmlzbmamv3jjz1njr8hdd2a30rqxvlrnbnsm6ci7amasmvvw")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03v28ghjr65im5yk8mf2ip2v57yp6i2hpjbnxg5zsk7pa2akzqg2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l55bcdv5djas75f3wd4za8mrcxx29r17zrmxznisyc44p77bf14")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k0vmdjknms80nxcyik3rmv3mgqdsbi5hkq07kw5zf1grfjm8wsf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3856")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r8573r1mqdbixri3wvkbmfnaak05mjh0p9mnd8fkjffjaxw3llm")))
     (build-system rails-build-system)
