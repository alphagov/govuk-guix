   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0144402hbbbbavzjmblm3p1xallsyh6pqbx4nks4zmwn21rhwgw3")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yap3acddww82hs791x02hr0x4sjk4hd11j2z4jj02i38ij4pv96")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0afy1qiblxsyhsz0p20lvwx3p92l7vp7np6d4jk0zy5zyj3g4493")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01mvp3js7yirhx8w78y1f0lv300mphzgxr6iqzipj2nx4iibpnha")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ilyri1z7l9by58fz66k7q4pf7f9397clbd64m2sqsk7zv0k6il7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yv76v40yvnn4l16q45s647r36rrfb3hnw956jv2y8dgvz8fpqx6")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
