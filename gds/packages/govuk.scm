...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l3sic55j4f708w5wg9jisvvldr89r234yz9w2956rmlmp7584ck")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ksi5ihdzjvv6ppnn3gjgjr2lp27w6ljcx121wyn69xdwqv9kz7g")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19sbxlfvr51cfi4imjd2v0khp1z3zcrkj9ldsz0g143x55kimjni")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r0g46mlbgiw88sh2yxyr6hj3cw8jc6fdijvylas1f1cbrr7pq9b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h10ajcbfpry6f7z61791b35y6b9jr93fd29miwp1n94cphbl9vd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17xhznyw9z0h7zmp1lxpcf81m88n3s6zn9y38sbwhpznjb3n00wf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1m6rhcism8add5ldjhbrxhrv69hy6c3w98kdkrxfsn5crk6vqab6")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d8fb2hl8xh8i4h3a30h62mqfacwpza41jh25m4zfj594znsdckk")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3634")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rh86hny7cw14mb3qqc2lfz4qdb80308b5qpvz23g8vpgzx7m482")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ashkxkbg4di79917kmxx4bm8jnqy9809l9rd45b98gp6l5hfc0m")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "06bvbkw085xj8yvm38hdh1gvqfly1rv3g2pwsxawsrg7m7bcqksf")))
   (package
     (name "whitehall")
     (version "release_12849")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kaajfbc60k7ksq7gj7a4x51lgba0l502cv9lfq3f2fxhsk26mm1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
