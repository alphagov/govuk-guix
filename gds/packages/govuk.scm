...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "10mh5p7bww5spnljjar571qf0bf49fp8fh65bwyza18y929lnx2x")))
   (package
     (name "asset-manager")
     (version "release_301")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kfhwz0a7wazjfk31yy1snf6q06xpfj4zbjmrlfpqk5ymx15c92k")))
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lp05w68da4fv0kwmk71r484wbhlhrnll0nn44qpq1sy37h3fzsd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11wqf7rjxyy9d5kjcf5xzg2zpfaa0jdwwc7l94wrmcdal8k56b2i")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "01lfp2x1wl6q4kbrw2v3dqrf8qdmdnv7cn37mnpp4nc66zjpinfr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v4syq1dphjg9dbbifvwpr6zvc9rz0sjwgsx37n88r8w14c60990")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "03nl1x1vv9ax460vkns3mjfi95n5v7hlv2yczrjzdrv8sj3qx82x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pv06qr0y6xdvm3r0cs8dvij4fmv7qf2pivydf26k9lk0d89jw3h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bkha33dh5prlcba861nzjd2r3ki1g4yfalh012x2v3jcp97h0v4")))
   (package
     (name "content-tagger")
     (version "release_825")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15p4fs2lgbrmqdzf52ymcbdc3gm4pv32vbv93brxrrcgaagxvvrk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "11riaqbvylj3wk3zxmr1f511b4b0niyzqrsj4wcs0mdclzndilsi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13l94dr7nyp8rrdv6qi24yzi82wsmvhm0lwj6yhgzimjzjhrlw3p")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public link-checker-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xff4zq5z8mr9amznvhag9d60n6n8f8smcvxmlmiq9w685f3m4ly")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vn7snbf741h8wrsjsyzkbf7ki4z047i4sh8i3k207snzg020s94")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lb7ffhglygns13pm371gl00hm7fvwf9byg77w12myxljik26zww")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13wd9fzz9h5mf242qvcs63bm520yx4a0ai42br54rp1xpdq8zq3p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "00n84rdvmzj47j5n03ndnc8p7yw8cyvi6qnf1gvn7ljm82yx5i87")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1czbwmrriav99kb9jwx9ykvj1ya273y39ia9phiicmad18bnndyb")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "172qqi36amnwcy7dwb2mkq4wpr7pyyxdrwl669l7qw1c2hr3z2bv"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c4ahvmdw8nphpb55n2qx7r39wdxrv0sr6r2xq6aw2hr2z3z9flg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pbk05d4n87vxr0fy9kv8rgwzfcfn0mymdp6xnpdc8p93dw40h79"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xv3x2bkniydrx25lagd2dqxvrmrvfz8998azr9wcaxd7nap6skf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nackls5zc7ljapn5avyzpdigffi6r3v8pb85f5bmq3vv8hfpkdm")))
   (package
     (name "support-api")
     (version "release_204")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0slr2hb4cxfgbhxjl91qy8lvxdksz8cax34s47g7089j54z5pf1f")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dvzkmpafs2pbahvkz5h8kf6rn2hlsssrkvviq47kr3g154izvjv")))
   (package
     (name "whitehall")
     (version "release_13601")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nxppqm82gp5nsyiman66c5rmigyjqna0xdlj0acdg9pvqlyxf63")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
