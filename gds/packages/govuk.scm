...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g3qr59mnb3my6cyb5l1sbpram6slvqj58q9102bpbq3w2yhj0lk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iv5gcyap2b6393hkpinihcps1ppixk8bl13pgkhdxda5021frjq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mw1gi64wb5ryxrv81aqrzi6d48kzf4nxixwgr2n7p1pfkall0nj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b109wys9n3yx5ikwsaw7mcjzpwpvvc879civ3dyywzbkkq2zwkl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mlfm1f46lmci2casy4i52nv8a1s94781014f5h6mx934kd0wqg2")))
   (package
     (name "content-tagger")
     (version "release_744")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xlwzhx1lsjawrxdx3rvwcj38cag60kwpm4d4d7x8mig54rz5m4k")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16lqd0ahps5kvr8gfzsc3x847zv3siw6nfc0i9p7kiqcfjksipqi")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fl8i51yh1gjlcsj9cgps9mv3v89qcj26y31i234gk4fl9f0z30h")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kqqw9a9gqv0mdgjzccwi5w0199254hrsxhjv01nk3x06iafv8s5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2849")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pmdkf4rcyfbp1v58gph5l335zplrw680p3101024gmgh3nkab4z")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0s7ggkz1n6iv1maw9f1h1z6r8hlra2iafvw5mczsw8gbf0ba39in")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y7v8qin4yknzlb3dk4sg0nmn7c747g0jlj730bgxk5iyl3zj22p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "070ay4kq1449cjk994wkxckqy934pm0p5fw5s26dkvh0n380s45j")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0qfllgp4683pzxs5h34y20hiwi06pjxpj5sfbmnj9h8sl4pskjv9")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hlmy51r5sn6acy12zw83anr54vgahprdx6f5qmm3d2b1iy3yhjq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qw6wcc1p88bqpzmlx2yqmi9lkmab2l6gmnica909rhwlqk3fcq1")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1an9kprar3sqdf1jr0b15n3y9vm1p44v47g522lwl3dxn0riiypr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12ihw7djns6jp02r0im68kl716v60df13b8rpwqzdm2m8bvbr067")))
     (build-system rails-build-system)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sn338dpnfds2cjzlghir671glh1gbj5nhhlv5bjmrpq6yiirwmp")))
   (package
     (name "smart-answers")
     (version "release_3890")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zf8012r842w0m120xq3yv2wr0vad5za31jirc1b595v26h93aq8")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06z5a91czmcic8jijrl0nm8f53ifzgd3azd22brlghmzchaxv61q")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13345")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00vvh7jisf7rdg1fknw2i0crah3gkcgnpaci721lmsfbkrxn7zrz")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
