   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ikcasgc2w5i6ccc3yzfzy863plsd1rkxw8b4aag1ypqq019biv4")))
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "05ipm9jggagx112prgcgq3pi26ynp990prjywcr8g4g428dlmrjc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hpblcpxnqj3vqdz25qsyl13yz9yfw3d702cv2fsqsifym570fqg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3704")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r0l3q28misiax5rivy3f6mmz27hjfhb9xkl4hj12fpajq94v7yw")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
