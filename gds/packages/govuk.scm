   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xrrpfg7s7jc7scx267rk8c189m6kcw3sykcajyb79mh3x8wh5wq")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kq98fwgmn9za39lk5rwnvfrkl9a7mh5iwkfc7bmlfj6slisa68z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0iamp1pjayp20pryrsgnrw14v7547d2fhcjbyx4w5lvrl1493hm8")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_2306")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xnyk4hrlm97q7ci5clnfkc0zb3jjahghshbgv00m3m2d1p9frg4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14771")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yq14264ppdcsaggy1chcnz66cycfwz1kjxjc5wmlqlvfz9wmgc0")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
