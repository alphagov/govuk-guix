   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1aw8wpanl85xjdndgnkaj052knvw3ag6m6kp4xsgmpf3726cxf6v")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cl0950zcdcfkh4nn4gvgcqvk1xl4jlmc3k7r9hssmbgd0h4bakw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sazwmbq8yhw16xhl33yq4d6b8arz7q1r1c33li7pm2i1alnr0vp")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dg5rwbzcj9j5bx0waddp3b14qjn60j2zs1k5rdrr6xnlaj28x49")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k5an1ak5amlg323s0igycrw9fvgdc0idb8xz8gjl2wx2bm3mpm7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1km4gpcdw87m8vdqmqg9yfnvjlh45xi8jjpl0wr2a6vcj7fdbd3h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1yqip2v0gwv974la8109swz827cmd679dvvk10dpnb81b7i6zz8p")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wscc4hlhfzp6fdba2ny5shpjlak1x2pb7v3sinirbv0jkpr9mz4")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3672")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16133ya9lafi1yfci8z4339jkmzn8gw4inff7hj6z29c36qn4n9l")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2617")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05rbzpnm8mkv0m4fdh2i7sgv0cydx6kylhcs00pfsg4znj2b754h")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03qm6g1g7217w3wj0xvl5vq1p2gf46cdx52zabgnhkcs3a0jwxpy")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12878")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zbpy3r95gj6qzwii3prqng9wjzx2ym5fps70363p89c0vphylb1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
