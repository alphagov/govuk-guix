...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yc9f85nf6hsgnys05ji7wpn06lsxidbk51y3gl36kqp9qjw8a43")))
   (package
     (name "calendars")
     (version "release_539")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09mgip5n2a44cjp2gcykn50f09s16ax8p6q98ddvw8z6qz37qwsc")))
     (build-system rails-build-system)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3997")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bigc938lzpk63303hggakzghngik8hrx9jr1kql9mrx3z1w9jsb")))
     (build-system rails-build-system)
