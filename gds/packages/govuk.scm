   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jbfxxdm78cf0fnx8njr0yhzxbnq4a2489g991jqzc69q66cjqbw")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ar72fs65nb6ka4m0w1m77aaq6hcx7xx99w1izxka9khrj8vswrp")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yan9v5vi8qnhj6x4rpx748kf9yq0807166dbgnrd6j6fj0rli3k")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "065n67bkyv2k62wwzxlcb16s0jmwblr73kmlfpl917yn1l1vgnwc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1scx30zd4q50x25gl0qk4z8i904swjyj1q0v943dxcirfm8zd8zq")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2736")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0iiydahivvv30k8c4y5grqs1hpkvx0dwffd0dm3d8yg9k56051h9")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14gl5pil8vnf5596fqy9ss29c43547fp6mv7bqpamnd0i6b50m6w")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13058")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "188s5kjvc0dix6vxzx19g9q2glvaigwykrsrisbjcjyxf3pn96mj")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
