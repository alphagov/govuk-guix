   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17ihl7w7w8i2f0qvzqcj74vv020ninikpvp6l0hszjgc8lkd6rsl")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sibinhqcbw19d1ffd2cc5maa9dljsksksr4d3wd3bimqbqvsy7d")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wi01bvl8mb2wpsxrmf5gix95y9cg3f9970q176ls13hqg4ylsdv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0phql38x2zhawmdz08zybdkxrg8w795nw0xkb9a28qd4zshrqkza")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3820")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mw4nhkcp2r2fbpjd07cjkv0483g7fidm964ij6dbxv6vp2cms0b")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13191")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0shs5drnx4ys6rlmlk5d9amsynj1a0509vzqb66bds4cqb6vp80a")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
