...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f6l83kfw8wqxj4q64mrzpmhfc5j81l50a3pfq4j143p7b78lyag")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gi1zpc62dcbwr2hhbknx56jjw352mz5dcg388y0xkyfaj8vfrlz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ihdf2jz1rcjp6q5ivxf71vxqyr4zrasng98i4hzq3kkk98f8wkq")))
   (package
     (name "licence-finder")
     (version "release_495")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02nkz9rpcqvmva4j0z77higdwp9rar1bhwf0ji2x7rxl06bnbqrs")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
