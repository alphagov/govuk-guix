...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "130fyh8xxcs16ndc4sh5gannx93fa47m96b6l65pzzlj1lgbyj58")))
   (package
     (name "collections")
     (version "release_664")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "050ng867d1nzd2y0znrim68rby2n261gp727rfqky7qn7n89q648")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0126rfcgqwq1gv3a6mvslcl12q4i16g86dbm2q7f68730i21ag9m")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qlvqcxxdbjn9ngw0qr1hqz0a9xa8xpfl53fp76163fxqmvv77nq")))
   (package
     (name "frontend")
     (version "release_2946")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08a8a2d66f6p1q3krvc52bj5hi925frzlgiysm18slmgxcnri4i9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vs5wwlcdr6xzxsg1x2r35y35645w5635wr8b03wm3p80lqpyviz")))
     (build-system rails-build-system)
     (arguments
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "02rzswa8djr9k5cxbmmjwrz7divbzcm37nprfv5qvhlzwxzxj8xj")))
   (package
     (name "info-frontend")
     (version "release_199")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j592a1fg82gvf4p1rynnwax119iix1d9syrmaafgd34czlmc57s")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0f1wgi4qcl1pm843v96c4i3qjlx7i52xxds0x8pb5ig38jmz9f9d")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
