   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06mw7mh5h0mfpz2b39nzayhm04qznpzj8rwdhnw2qw46pyi2l81h")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jfjbmsyiv1lfy1wgp24h62hw0x8wgzi15bsk02dqf1cym6gfb9k")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wzqw7np8k8x6c16kdn7zh4r08ad9kfg78q7bfvvg30q383fbhj8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0718l144wakpj543czrgjpv63sg24psp7kvankvnpyqlyfy01hz7")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05cly40p6jiqr9f4lzry6gs7bwr66c4v2x37zhs5qcc5h05yqby4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "108z2x138yzqrj339n7lxixyiga9ii28qb2axa4abcz3478ygqpa")))
   (package
     (name "feedback")
     (version "release_377")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03051wc90jp48hxbrcj2rc9p0vlajbl3a10p53k1vjpzbfaijm7p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "08kh20ih9bf39vp8q0cabm5d1y13qc2px0zmhqach77nsdri5zqc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yrzf1ikakw5h9why7p6pims87gqixal0zjybl2akc0nf093d4d2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
