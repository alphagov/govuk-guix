...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mii2xph6l64s0i8rmnq8dmbj6cxc4kjf5xclrs9ji126lyry4rl")))
   (package
     (name "calendars")
     (version "release_505")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xwi55a8mlmfk1haig9nl37wykjvrbcicqp289w7pgas3jnvi7bl")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0scsf98rpbiys11sgfdiw6zkivwj3hfs93s5rmiv6hy85fpqmk2w")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nxi5qg6hyi9i4029p0cfak16g4yqmg9l8dw65nk83fv92b7k7cz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "16xv2r388wcb54vq567qazg72k2r8b657mdrb19ni69ymcwivv9i")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pjwxccjr06mgl81s7apj2rz8xjjplnn59x8hslbl19l6znxfvix")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j4041i6k06wsjz71araz5d4x05l9zyjfr9x9clp8rwjnc2059kd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i3rcjzslc7ww9i2mp59rglx6v1nabg38am37cfbiwqx29mw4jds")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vl0q98hlhf0gh93y352dda6109cir2g8gw9ax499k8n6p5nz9wa")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f3jmx7v6c945yv4v0sqz21wi0r5g0fgnpknbr550a8xcfr946l3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ganxzfxik1zckgkycxqx3wd6sf3rw0k6wjc9g9v3drpf65dhbjx")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0if76m54vnbpbksl1j3sh5nwr12y9yjrkgivw8pxqxkv6g4qdd4k")))
   (package
     (name "smart-answers")
     (version "release_3933")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11rmflwvjwhh3gmmmz6pz03ysawvh2ykncc0mlxva41b3hds87l6")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "03778akaj2ffk2q851zgklb2cwbcsb9s4jd3c79wwsdwqrvqsg3h")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z1s0wkzy2r62zh05v1jwydb08h1fmypa2f4adc32xk2zcbqcdr7")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0z2nbc7j99s82srkpfslf4xmdy914s3clvk9v2gvrykzk9hj5iza")))
   (package
     (name "whitehall")
     (version "release_13411")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b0bg831mwdnaybbxpv963k281znb226v3x1ppalmydf67qq4gyb")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
