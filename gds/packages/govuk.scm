   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18n3ly9r72y39nmyw3acp8sqwahjkjpxky0db3j7a97mn28wjdbp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0b8667xx9q41kyx12ampdh0wpgssbws661q1vxghmsbwdn44iilb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j04nm5p9dwib2x39y657j2vmbcy8ghmr4xm21ns528x8g3iifgh")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rwjmj3r0vh8caz1wmvizazh3siz0phc6xcz734zr30w8r2s5003")))
   (package
     (name "feedback")
     (version "release_742")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05szzx2ipapdr8wk807khld318rvkdnrg2vd8f90f79862ksw9il")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13hy1gaa3di8kif4x9gc8m5banxxb5g29rhj9qr8q1xkh8al7m05")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mg14764fnd7z80bq63f22b19r724h0mrrmzz9dp5990zk26qykm")))
   (package
     (name "info-frontend")
     (version "release_417")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zymsq24sfy31b5g0d9zlc7mc4ibkrzwxg1mvj866p52sf9fj53g")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ddqg0q0bdy60657zhbi0p0sz4za79qpjaqg7b3xra8xk4szmxqv"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07kfmbwks64v3dgqgxv0napj4kmgir4wmqlwz6x67dwdns8sgn0r")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
