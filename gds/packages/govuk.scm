   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "031w7zzazyrr0m8fdgz42wx8isyh7ncjqm75mrw3l4ypw57987fk")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hlm07qmcq0ha8y7rfx87wgpi5hyx8vr39mka0pb5pwrr843blls")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4215")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1snrszpmhfvmhpcqgds5pjzcdn4cg4g2fpd4qlfxqyljs88y09qh")))
     (build-system rails-build-system)
