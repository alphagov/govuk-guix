   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n6apjd8s6n14smy19kwkrr1a5nfl1s7yp2f3bzv9cr9yzfzq84b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c87rzlm3jy0kws4n8dm7rn92laa1gr0s42sk7czmfaws1qbx6s9")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18kjdk7z98saymj9j6n08g18byfqjc9laq34fd87apf9p5cw3mqm")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "05546fdjkkcg55jnmzjlab18dqfp71xwp1ns07n9h1hbldm7c11r")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a465fp0pycsmd72yjbi3ffngh53l8rl7zgcgnv4ny42y12n8gi2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p3xalgh6cz2lgi14vxxvq1xjksg4ay2pmn37l1bp1flk6q9n0v6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "127llagvfnms0ngfm91cwy8p8m26sgzvixx0n3lkal37snyh26rj")))
   (package
     (name "smart-answers")
     (version "release_3884")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jyr0ap9dibhnj88sff21zx7hvxjnv2vbbiqcadnvxinkad5w8kd")))
     (build-system rails-build-system)
