   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "022h0q6rdyarkhqfj6kz8gc2yv5nl4gsx2hg88ii1n1aqxxakivh")))
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gy40yxra0qlwbpk7zxv2gwc1nn4xvhl4hlcsijn7adlny8vvy6i")))
   (package
     (name "content-tagger")
     (version "release_606")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11s1qp1a9yldwk7j0js4qy37ky9l4863pc7xry1dj5vla330vysz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b04i6dplv5cz93zyklbg943byl66q86zy0br32cx52hbdn6r3bi")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "07azg3a16igkm7l9wr6w1ml21p4wvc5pidi2mnpsxfdi1jqlgr4f")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zahpys5bfxpfzzz36qdi29awy1rr53kjiv184g03mvahjy0s7gj")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public policy-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jmmxyszw4z5qac1zkai760pl1x4ahyxbvqncmwk5cg559crfr8n")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "117ffh06mzlg5j55m96yl6m5xap7krqy4hax30a1x2y1944bif4q")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13119")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09dy2wbjmafp6n2z6nxjnrpv9l20g2hwc2i12lpd8wlhsydqhpzp")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
