   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x958l8n7qw0v11jw0y4cwvzdiq9qma0k3fkqqlh7i09fpfz5my8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0drk9nkjf3b2rmvcw01bcrsyxfw4prw62nwrc4azj0jl8cqn01zg")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3715")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0adb7sv8rfjb1lrdaacs6mzigp0r6x4qmyxf4hmcyl9j15gbrlxz")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12945")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09cphrn4b71y9ffjkx7lg3kh49k57jsdr3di5vldzy7b2ml673mh")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
