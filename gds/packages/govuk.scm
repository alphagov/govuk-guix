...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0044j0li5h7629cac9pviqgwpbxad7042kk2qir3ifgbx1x2zb02")))
   (package
     (name "collections")
     (version "release_750")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rlzha4yylxxj1zkn9n2m3p5yab3yp5p3hbcpdpvb36vacy5m0dh")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rfyk8rssv2xnr0s5r9l73dmmnc56v75b8ddjjf4cjhhbjhh6xzd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1374yp92xyyrnfwzs5d7hy6ybrm2qxyk33y041rgpmfv712wljmm")))
     (build-system rails-build-system)
