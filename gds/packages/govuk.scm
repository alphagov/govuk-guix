...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18fh6mk066i66mzcpj6v7w4xhzd22ab388dfpjsvh47n3r52jsc3")))
   (package
     (name "finder-frontend")
     (version "release_1842")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fg9717hvyqgmr2db0hwf338i3s78widz5m47y2qqm6d17pg0bkq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2576")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cpannvxjazkh7ysv9dv88hxqi50x0vmsnx78gjpssn93fgh1b3w")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "043gan0g7d3m0x808iskm2l2jdbrm075hrmwa5wn7xhinhzm5sp0")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
