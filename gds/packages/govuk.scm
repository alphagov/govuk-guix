...
(define-public authenticating-proxy
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xhmbsvh0z9sfdg1p8xra1hzxk18xiliqqr4zp4sk7kjz0iwh8gz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sf1pgf9dgmp22q0c144yjy8dy9hvqn57iq5i92fgqbblcp85j27")))
     (build-system rails-build-system)
     (arguments
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nrf5c8i7ba53zk1n16vxnkz581k5b2kzpqyyg41d2ld1kj7xq5r")))
   (package
     (name "contacts-admin")
     (version "release_366")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19hlrb8wj52x63dln4jrsrv2xikw97cy4x6gvhvx9gyg8kj43sfd")))
     (build-system rails-build-system)
     (inputs
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m92pwzmdfv7awn0xhhx6zy079424wjyhzv3948ha809648rd7c2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ilf6ads86r4g4i1b2xzadm79m9868w6f8br66majbvydgcwip41")))
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h90q5pwldbh5sh5pvnirf6abcs7ghvf07ixsv0sbayfm07qzqzn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mjii0j9n3znxy9sqr1pws3gax78586qbqvl2cgf7mfh5227pjps")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "18dfld4rc38klj3iq3ic34405l2qcgygs18a0d57qamqqh6hssv8")))
   (package
     (name "search-admin")
     (version "release_117")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sl27aq7sj9942fgzbnxckvjkmzbgma1if3sn1bjb4kq5w9ncxik")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0f1zxl201b6rlna8idd9171jfqvqshbpiq19g25zlc98669y216s")))
   (package
     (name "whitehall")
     (version "release_13161")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xcy87crhrgvc0bgwpidjga9nlqp9kmckf2pgbk7fxx8jc412gra")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
