...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zzga8q0mia95lcx9dzqmb04w8y5c7g47l2m38kpvqk64l4wvn70")))
   (package
     (name "feedback")
     (version "release_362")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0in6sa0byrjcmkw0m0whvhdzp44l2dkqgl38cf0ghr4fmpzp12kv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "03dzpqricridcczs4x61jy4x2yh5capan6wx07l6wbqg9xjvbb42")))
   (package
     (name "imminence")
     (version "release_338")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0416ghik0pkhnf4sm56xaf8vfbk9156kfjqc443dkr0vmwjvsd9c")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3845")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01rp29c01z9xz2334w1375874p1hdr1hp9f4a0yjbd5qv534f5lp")))
     (build-system rails-build-system)
