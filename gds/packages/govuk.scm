   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14fncda5c798vyhhzh5v9xpp093qhnny8azqz3anbfb9jc96z2kh")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "16msq5nz44axbi4wil378iv3x1bn0ip3hpw2hsniglw0frrph1bz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0634mrnil0b6p0hdnij4cmdk0kn2iny5p6c5kbq2apnpfx7d2i6z")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mgcxv1j76p1g8lvglgcd8cf7dnnvpw6clxgp9m32gaa2l3qb05j")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rbsnwcnsd02cjqc1wm8r8qjxfmdr0h889a7f0pa3dp741hai35g")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02izb457hra91ipqi5dzjg8hvq30inmkhynymp972p2q2lsjmnn8")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q3lpxjj6ssla4q5nzppwii5vkiw4wq7zccm70mpm0vz7wj4yg6r")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1aqb9qzybfpb9hsfvpri16xy8iw493dxh6fxlr6q1gz3zgjsla0a")))
   (package
     (name "info-frontend")
     (version "release_455")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h20p202gkg6zngc3zv9xffwdxx21g9cxrfhn0452sh5ksfq7kkn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1big5pvzk79gygyxg1b57iafp76nazlw8fnja4bp60h054jr3svw")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1jh3fza66grbs3p9jyhb47b70iji5s912kxlraz9hv6v9vd9icaj")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2358")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19s43wyrjj1kaf278dwjsciydas2k34as18xhdps5n3q0wl1qd4m")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0y25750vid0j4bz0hmp2qc8ylg6z49lq3ilrjj92pjdkzx8q1id9")))
   (package
     (name "smart-answers")
     (version "release_4549")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yarj91vv7qspwd06p8d6fsrmmjyii00zxb6pl7l2fvzhg5kf185")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k8q4wwi5xvwqy19hmxf9dlb44qvfgpvwazn9rafln39z29lcymz")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0160k2763rlzl8m5lmb8dpwz731p2g9vswjcmb5abqc33asc9nsg")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14432")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11lxpr0pdax972ic5xbdxva30l79cv71i91zw2swrzmy1yidhmrc")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
