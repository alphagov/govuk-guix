   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0756m4qwas726xjd312v0y5qri8clr24id4avnf4yvycfsrphw4k")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03pvx3616gx6bnk5x6v369fa8c52x6hp4h6hbbds9jlwv471lrdm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4207")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kqs16gw6cdbzsl4l5r5v4gcqnzyshpgypwl291lyvw2ldqkdcsd")))
     (build-system rails-build-system)
