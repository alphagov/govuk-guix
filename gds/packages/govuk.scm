   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lsrjxiqckzkkf8rg2xzajs3vb186pi93pyisnfzn8manmklhivg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p496gn1wbgmpk30iml1y5qpvwhxh8idsgw5vbj9jg4yda2dz2qx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b9lvbzc54bxw5wgcfki096vl3fgcf80lcxif5y8mv3iqwbjydaa")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lz55v8zw79k691a5k4bdfqyzhpp9zykvw0r4j4hgnbc70p25ch3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nsf9dd3nrpw1cfj32msj5v5yniv0m9a34a3lbs8wg9fv9iymjlx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c4hbc4fx2a1l2q6vc7c9xp0cr3jbijdanvpghyll993c9lmh290")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
