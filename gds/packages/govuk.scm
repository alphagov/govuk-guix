   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14sx2zjqj5sb0bgcqmk81wnq07yg46i0ah32b4hsar6qv21hgawa")))
     (build-system rails-build-system)
     (arguments
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ak0vw3a7klqja0xn5ax6dkj93vs454bkkv6d2l6651smb22wrdg")))
   (package
     (name "release")
     (version "release_587")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wmgmxpd6sihs3nmcdvr1klavc0yhbhrkpr5fa6rf2yy6x1wvqwq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yvdl606xcbyknn5wskv2l5vrcrhbvwxyz9gi856wn07ngmmasnl"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vka4wycrh97pm88swh23drdg5k7xm6g7cwjln96fclh3xfzywys")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jzypzkp2ky2icaarcnkngrjc4n42z710f8q3r2pajhb7m18301c")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
