...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vlzrkd3n8kyfw3nv1qwwgm0rbprp09r8m8bc4r4z4sja45qf2r2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a339dzs2pnjgvk1zgwm0ilmk31x67810pr7xkw67bvnby6rrq1z")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13274")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f8wxg7vdi12sa41rk2lp21ga1j0d186j68dbxafmg4mgjcaiick")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
