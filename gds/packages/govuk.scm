...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hha5r95xsdzms0idbdqwydibn6kwv8wply1nmxr9v3icb8sc8ws")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d3g929ivs772n3q8krnd95s1bws751xwdfkf4f06m1v8blkagd4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sazq1r0sszwy7z85jym75va9c3j3ksfvpgwcgiwwb55a3p06q23")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m45p251yha2jj13yd1ym6lj3wrssr8qhcbhqjwg9ah2vs7gwd76")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
