   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01q8jng768r399shlaij9jamaskpk8qq3ib0l9dyam9d3jdmyls9")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b6m7xfspy02rn6qzd0q07djcz6wnv1y3vajrslxkcdllx447d0a")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2646")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11lchqjm6frzy20nif3ybwdk2hwn2k1bwbg5a316z0zmzz0r8s8q")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
