   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01v576xnbibx25zy44gdswdg3z8sfpkmxh3rxlwi0yshhj84ha55")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2553")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gba4d2qnhp46jsk5qk9cbswifgpjn385l8kcsl2xcsbn9i0h2ch")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12731")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "087h8jwlzw9q056s9ygippw61a4lrpi0ylx9zfgsaa5l9nypfpxv")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
