...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "1iggs5k3y3d40ss9v0dcaan3bsn1r5hiwjwg2ba457idax7i3qzp")))
   (package
     (name "release")
     (version "release_597")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m590wn7j6ij91hmrlkh1nb93nc4hjcm7gp1qkn8kqgshs06dj34")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2492")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fl7936vf3cp6wfgj8pjy7dx3ghmfx3hwvwzzhr0f74yszi9rm7b")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4639")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06y8wahc6y7rf7bsw237sn3df0b0m7b3dy1nlacab6iki184n2x9")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zb72jyli5a5lad4ikd99my1l75w1z782p4802l8yg0w9270axim")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
