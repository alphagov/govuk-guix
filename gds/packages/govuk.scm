...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zsmfn5svy5pp9x3wxqwym3i3ixrh0ckvmb3cdvax76sxshl63kz")))
   (package
     (name "collections")
     (version "release_582")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01hmkq28ja5w9b7yj3hjvcynl9nj5mgmvn8ggk2vd8q2n70zcym0")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rgvj9qm98b2pmx72c3vq8c3akfp5l3ffikdlgivrcwhspdhr4jl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yalznwqq4s9mg7zp4xc08g3hsdrfp3wzka478ydh1zjiy8cgamd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11cp24mq877h6p58dlz7gl21n823hfjn9smk07ccdjgi023pshzi")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "14jgxvqf0ayg0n5c49gxxy68kipg2nw8biig3bkiwasc87f9fmjj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kwi3lyvvzxddywb5isxxjd24g4wl6pcgin29z3py8rbd35fyf0n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x559vifdrjmlr1lscp2i5xjkjc2570cark1wxfmnd53xhylrgg2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10hm146js5lkcrbnfr169xx3x70gcjqcrniamcfjd8s0477m695n")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hjvydn9jvklbgn1bhp0islb2kfnjdi2b2znsnylrwj9jmg2mcxj")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18rbc3mvh5230c47i8ki18ypb7rhsbbrx1f0y3hn4vyppm2mqvi0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "149y72ifl56zvdnlyidlzxdl1hvf8s0kq3h5vkxc6rg5q3qmcacc")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0phm0jykd3rw925a01glgvrf7dcz7yxadpjc4bfirhwvaqwdaiy2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4003")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h358n0iivrcpagq43w8shrb2l9nwrv09dg0g1wfij13p1x53lhc")))
     (build-system rails-build-system)
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zglb0r5w4xsvx71a4h3jl0mqxd8nqnrxl0d1ml5nvq20n5ga6mq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10bckvd1w55z6zvab2g7ijmp7n837132c7j0mxvh5rag3bf8vmra")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13550")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nvv5hcwx43df3lka4q787dkwfrsqybiwwn7hri42n0w5w6z8yjb")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
