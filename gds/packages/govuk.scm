...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dj69c4arrbn52cn5rv6llzfylw0kww1llzkhalzgjysq095fhnl")))
   (package
     (name "calendars")
     (version "release_483")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l4lp4byh9q4mw764avr8ljfa0f0qfxm0idcild9shgs4w359nzm")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mb81cx21yd95x3nmgyah82vq7b59a3cmgid2f6pnrf32hsyinhl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bdslr91v1brdm3x6qfalizfhxr72jq32478jlnhl8bz8bdgf03c")))
   (package
     (name "feedback")
     (version "release_387")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r6msjw6kz8bmv0c8fjz4dirh7ca8q68f61427xyr187yrvpmlyd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cssap8kmyr30sx94qr1d7mb68v5354434a9dpbxgrks2l8758ci")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qx7yhy2w7zpwkkqrz78y7fwr8zxh3ljw88lqbfqbwqgyyivdnji")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "13xpziy8mf5ylgh9dgnn0w44ys5bqksaalk8wr3vgkwyh2m3f7yc")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "183a3jj13gf3444124fiqixjbn805rk5jxwxwpp764iwg9xps57m")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yqzddq1r9z60m1y35596n2605brpnm7nl44f862rqj1hf88yk88")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03ndi7sj1d3axa9ig41d06szjm657ppwv1pgzhpavmy7q6bkxybk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "01crl7pf7b562qdlvsngdsv6vpdw3v13hq5hgjrkkqwgjyyslb0j")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13a09wk288bs4178fl9gvj3i2jvx6ndfk9z634271317hw21s0hy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vkw313ddy45hf9m97jblp4wwqqaxwvg5vgqnffpjkz4f8fl2him")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c86n9z799rx1vl9bim1j8lmsr03s6vhinnngqrf381dm7kdbza8")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
