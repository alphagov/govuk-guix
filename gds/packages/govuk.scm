   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0whs3qr75bvj7nd2ijb3zv1k1dgjnrn9c4f8cwmv0bd1bk9fi3j4")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y9agxk7xsqjjazy5iimyrvi8s0ryizrzxy3pdyhjpq4d795yfly")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lj52zqncyj6sz3xbyl8laqysagrwc7gmqvz7x341vlh6mk73kv5")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
