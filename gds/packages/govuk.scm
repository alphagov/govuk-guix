   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z8kp2arx6pssir8jqsfkh6sg4sw2gaandn7bj9ccwaa6lcqr62v")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19hkxk2mmc6grj83plhlx1fgccfcv11dhkg22myxcds1l5hfcp4p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xhs2pjkiaaz3dasf5k5jdy38zwpgzp59lmhx4nbp2q14zy25fv2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04akcj1gqsb7xs2hqsm60n1k933jzgq8fkkkv73klnw09bn3g0ah")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0va0vpqggxbl9qns9087kb9iaybqkvdcfkbdlpjlkxb8f50v7f69")))
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "15m5wm2pa7pc0wzd5b7pfmf7jam3a409k80xqhjmi6h6iw6rc7h7")))
   (package
     (name "feedback")
     (version "release_309")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10qi7381s5m6i7yw90ih4zc99wfix62r4z3hlckd8c7sbr7ds1if")))
     (build-system rails-build-system)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "197if2fzg9i2wc0wyryzik5ysc9nfk2fp6yavbhrskwzy731rq9w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rpdg8mdzck8fns0qwkbgxxr4apnpckpmb28c8yb3r6s7pwbcs53")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0349hrvbbmk10fvbd8n9l6887x0q8x0j01wm49z2w9lrhdn9g4g5")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mry7xjxq0bjvbxm6pbvlm58fsjab8akz14zzhhch0iqq4ma6nig")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f0vc9rnszdyv8szyk3xs7c2ql8qp19qhm2lmkn1hyk5c5jv15gp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p33adp4zkdkx3fdnch4rxdqvcqkbjgyjz1pbgm1k7jz5vd534ml")))
   (package
     (name "static")
     (version "release_2678")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nhpxg1zc0bylk9br7yx7b7m86ipbm4cb2np12bnfb2smbgnm4sj")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13006")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "153pny0z194y5dcxhf35rsx0jdn9324g0y8ykmn21zh0wpgzmw3d")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
