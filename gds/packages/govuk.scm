   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d4lrg0jzapb932syxjb9phiqpqpcdkqk0cymir0v33fkyj206yi")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gi96b8apj0d50iyx41rm2wbv86g1m10pxvin5mjpjaw79d10k4w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kk4qd3rjj8290bxpidpks66gbj9jsixz0spx203n2da77da07yg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vh5ldvgi0yp4krx29l3jcjbdjb4vbx7swg43dqli4wl2rgm94vc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0898b7k7qf8sc9yag6z4g0kh6yjql0z1d2vv5216cq037sdjymg4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1idsd7vvbkg4vjgxqykp1djshkp3yl523byc7kjx0kcdvl979ycs")))
   (package
     (name "content-tagger")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gahfixx73ik3df0yhw2xnhmn4f7p7cbdhx1mg477bqavcd9qajj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1c75im24mjih2d02pxnlcrpzq0wqw4w5pggkbfkpphl5z1zcpynz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02p8640r5id1h16pa2dshp8kahyv4ixfmhsfic9dcnp345wr57xm")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16n48m21hfi2zz4x8hvywpf7ib34nzl0cg0399laz7h1zn3ii44d")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gvas88rcxyp5nnirqcvh7c9cq24lmfhvsf5zvhmvgd0kqk0730h")))
   (package
     (name "transition")
     (version "release_994")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hfz5dsa9zr3b6nlyz36hn5yvvmkps1h1yxli4g0ap28wx4bwlh9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
