   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06piy5fbyifx870nvil3jxfldhwcpssgyp91y3drcx43py3rz7m5")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1a571s9g4ai1lwcscl2v57i4k2g8x4jpb3an2qkx4b46w352vj06")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0szasmr3cfc3d4x8h1j1gbx0badzyfmwh1h81rvvx4qm6dm49p2k")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vqv387pbd3b6zafpwz9xdnvshxd4vr4vwlrkqgbah7gpdd7mxm7")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14657")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yi6bgidzwl76v30sq64zncqr1wipibaqnd9944w761jwiyhx40a")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
