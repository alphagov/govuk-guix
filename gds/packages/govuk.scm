   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02a4iin3jaypkza3n41mikvydlx02mqyn34pzlb09x31dig0w4d4")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3770")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n5cf0431cxw6fw0amd29hi5wd1fkx484iw75m52ncwd9jrl4p5v")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13063")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k9zzz08gqldz3izw3gsy12zzwggpsxpkhk3z264q5fx3crrfjfj")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
