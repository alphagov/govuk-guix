...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r8rs7f332dlph1kpmihhv07f1xyx5q9xqn4idcxxhqfy9kkmk6s")))
   (package
     (name "calculators")
     (version "release_259")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04ailmfbb9siwqdcfxlja7fh55bj5yr6pjbbj6r4mi3p2a94fl65")))
     (build-system rails-build-system)
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g7dmk7s0xgiicznhzkyryybdiri8g1qx5qa0ygbbp9306zpbbpj")))
   (package
     (name "contacts-admin")
     (version "release_419")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xmbgwnahn2k2j4wy2flxzfcrv492admf9s8sb4265gv8lp7lclm")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y76yw78zs9crksnk7ksc25p09r1h8326dsvw88h9qydsgmsqfsv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sk8j72kd4p6ir62m0z1383g4xyrxd0b44vwzhipgn7ap5m9aysd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "197dlb4kqki32z88aqc0a6wdyk9hgg0hvb3saa2gn31q9i42nz10")))
   (package
     (name "feedback")
     (version "release_391")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0np1hyb7ck57wy6436aaqsc4inb6zi5lbwj0ws9x9pfggq9i90xv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k1y7l3m03492rcv3prwfsmm05386ivs2csa5rbz8agbcfb1hmml")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19xzqh6bcyl6rnirg3fcgzbz53hwa8qf2yx9nilimymm3qg9csrh")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xf9z9k5hw564rwrb88fnsi0kqwqhg1ckly79lk3v8kjmz6xhz3y")))
   (package
     (name "info-frontend")
     (version "release_129")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dy7b5sk2yqv2fkgfn5frx706w3nc1j3g47j6p6l14d7x74q5fmv")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yn9fznx2vpp2f17xbkzj6lyh0cp03an0sa5ffqan25858w589n8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13bydjay9glpcch5xphgbzr2w2dmckg3hlgp8qy1gw87rgnd7f1s")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dlr4irbickhxv96l2w39vnakkcv4vq7ggzh75pj67l936y0abn2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s9pgkkwcpl5walr41iaagqkbnwqsf5v6vw4g7djipi0819vggvs")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "06v5w3f7bpfxa6yjd0c4bg90ghj4dpg227dmh4yzqq2sxg9d2zgp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "004gwg42mjsv6xj1vdpz65l7vpsh5zya952fxjmrhw227m4y5x42")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qaraw0yg1q2x5p1a72vvhaq16x77ss23y9k971ivq8pchsrdv9f")))
   (package
     (name "publisher")
     (version "release_1930")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11yx2ac3ygrmfhycw4cllp3h0qgaqvs2w0q6ifnn43pp5wdc5kic")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "043y798id5djsgqfb7bm77l2awqq2haxiar7d2isladkmhzsnx09")))
   (package
     (name "release")
     (version "release_275")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fqn63wfa8fd9kg7hxj771zdr0r2z4l3bhx0j021j7yk1j7f5fvz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dzxaj838jb5zr2nqf0yd5q6zqcavin4w48m8ds25smqfa2bjvd2")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "145k3psgfbmq4wgjr2v369hz8vnm0752b2cbg4r96330z5wimmb2")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "05ki82rjpsgwpvqrjszzp2i317nv8hizz1nfn89yg29yp5zkxg3i")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "064xcjjax8vlw8p19agbhchdv9v0xn3gmybq301zlvzzkcai90jl")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1w0dxkcr8wcwfh461f2n4vi0sfxlgs8w1gb1ikxbvhic60is9m0l")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zh6v1i123yvrglyp2pvg52b51n3df8r3w98j4n59w1gsbfzxh67")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "07yzflymdpj0fs4rh30wakxkbrcy8ww236d4mqszpndyv4f95yr9"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zaj3z3vpjjxkm0fkamww8cxm9hv6xlqp6i1220flbg4vd7nqaf0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1914nzb4ma1wkdwvs6a08zzb0d2lmlk473nm602k7qnvc7jxsikz")))
   (package
     (name "static")
     (version "release_2825")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a8bindm61rf99rwsabblng377fca7swzl4996qdxwfgxxjl6bz0")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qx4jg7ay99c5hr7x4m2iyxx7g1q0y8i2nkpkiw81p8d5g2flyrc")))
   (package
     (name "support-api")
     (version "release_174")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cw6fvmw1qlxlvml4hgdq5lkjk3gisb0nfz4z7y5v89awf05kx9x")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
