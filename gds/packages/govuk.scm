   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03wrpz6wyn6vpdr2wgx9rgmzlvm76ls183wbypmj2aicwmskp017")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f6diha5mzsiwdz94fffxdqgsj3z12k686fi8i541cbjlz5bkygv")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g4iivckrdi5dam6pyp5bb5vmp67p5ccrngcy2yi6jj37bm506cc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l863y48788jb0y8xgj14f52b8l0bypy1ncx8n9vy8qjx55afccv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
