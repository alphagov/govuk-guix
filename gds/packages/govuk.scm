   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f24w7gcnb9wriyfpym0588cp6wp0hqrk34myzd7hn0384p7dw26")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "18mfjax03n9dp64npw032w87xdsd42i9b8aiw8xdwvjrqryflmd6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yikk8pkslp9zx019paxxa6v7z8ldz6apxfbrd2b3azan5llabhi")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02wia0bla3hjhixx5gqc6n9lfy4vbk1gvpdgzzsjkya0cr9i7dnh")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w4bamrpr3fs3b1x74hv7jzjvzah47jk3i2b6jaxrn6rfdjmngrz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
