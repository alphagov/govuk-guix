...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3951")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0di9yj40w2jgggfz7csskzgswx23cfrjm65s9c6xbsn8b2kxrz9s")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13448")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0aj37n110183bqh475cfiv932x1b4pgs1jkqhsj1bglxdyb0ff2p")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
