   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yk0paw2rv6rhz0bnv3vv4id61h1ppagqz8g833636mxzscsn96q")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0slqbqq85f2i5jqf2dlh3zyjh9ax87dlkv8ykgkh8q0b62mqm25y")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02i1v07i29m43dp7f1gsi647yp671yn9c5g18y8k2y9c41kifhs7")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "046znp16vfd1a0wr35zvwv140dmbaqhx607wrm3qymh9myn3dkpk")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
