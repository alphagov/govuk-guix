   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08l5a7f6n0idxp92whnzqyb53hdllivqyrz9my4jy924m036l0wh")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fc83b3r30d1n6p46x30cnwbl7761wv39pjjdlx87lda361h3d4c")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14489")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15bxc6vq2akspg2h8g5pdpg5kldp45w0ps174vczpwba8jxgxnpf")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
