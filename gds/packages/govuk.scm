   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dri4895vq9i1h0fc3xn0phb325v6bfh9z39bmf1cwnwv2qrhjfh")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1dmg56spxxyb7nvwhax39czr882zfym1f77d7f3anb81cksqakn9")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z3xdw433f93422f36k22xbj6yyfb4y6zbpq7djh6d8pvs8836ry")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15q0b3d40l2hzbi3mqlgv6yk3xnwlr7rlcjnzks9glynqqah1ssq")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12981")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0482k29vx8rfb3b2pk17lvla61sfgcwmj17l5agd07r4aj7pa015")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
