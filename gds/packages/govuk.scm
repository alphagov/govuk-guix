...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kcabh073m6sisvcaizv74xcdna8w5djiy6xs0wwcnbsrynhspn8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pw0xg2qvrk84wapiq164cwwrf733c383dzvb3cim6kk75ixa9zb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14692")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cyflmczl9sbpr0xnz5js6kf4n32i91lnv581877hp083rywdlk2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
