   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0anjmjjinsyfg82hj1zfvqlq62sf11dy4xkzhy7gr5yadc6p30kb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01yszr3x4k4x5jfh6gp6d7avjh9k270cv366kxs89xrw6hjsgp8w")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13117")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "197grd90c52qf9mzdmc3p7xy6n1wp38mf0hwjwmknjm30bclai1b")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
