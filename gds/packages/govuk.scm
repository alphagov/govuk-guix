   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d3lb1446vq95kj6p0h4qr8krbf8646gcyrzgsk1qslrkvacv982")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "02hnw4vvx9wd9v5faa2yw3m6z5p2kdmjcqyg4p4z97710gl8x83w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11z4k6qqwigaas2fwj6gmn9hs5g7gfzcdshyjvmbc3f9yw0fibgv")))
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0g7hsdkkjvd0nsvrf0iml24yqcj8rgf65b0gc9gkwzysw5w4mimn")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h0qr0r5dwb7m6whfqj7prmlay79pkhr831jziwmb5qv9ra5cjzr")))
   (package
     (name "licence-finder")
     (version "release_322")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18jsqj89x4zl3yllpczkq8ai20m56g5l34icwyqrmv5b05ay1a1k")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "162x2qhlin5q8mq6jmjp5yl2djsxl0hgdyld3qjbxwvf3gj8p45n")))
   (package
     (name "maslow")
     (version "release_234")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hya8ib57syxa6yf6q7pzvrs504yxk2mjmzhh9f0pkkn24hw6gbw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ykah6l46r52a0hrd2zsdlz4yq3l9sycn431nvq24bfn8zgd9s9k"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b0ipq8y3j1wixx4nblxm07rb88cq1p19a2nfbwja1saxj5zwnpb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
