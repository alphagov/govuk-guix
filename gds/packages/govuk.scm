...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m1z9chamdcw1i8fx0gm9va8g64p77xvld4dr4rwjd9qqljy1j8s")))
   (package
     (name "collections")
     (version "release_644")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11742fjqazi2v9g8yc33ng7kdqmx7m22pbv284xl28ax9gkcgpin")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1aah9kbfv8if5abaxlrhpq5377l6f2wbnai87r841q87bb3wzgnz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v8xxzvyxfihlbb3j953q9a4vsm2s4r343z2mvvmaz79r56ah1d3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09nkrqfbk6mb6j8m20bmvhms7xkacyvx1b7r9z3wp5vpmkc4ncjw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
