...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "18i40dvdmbfxvh07n35xfxbb69ks6vx62br0slygqi3g0w87gh1a")))
   (package
     (name "collections")
     (version "release_723")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a6fzgsnm6lrc9lzyfx9ysml1n4xdx5f82camcpmlap16xlrzr3x")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pz013ydy79s7wyc9kqz3sxq5zap9s3pyyccx6w1m2447nf2ajkm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18kpf796rw0zddl65ihxc5y85b0184bxllimcjnwbyizcmcbs5ka")))
   (package
     (name "frontend")
     (version "release_2998")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dfpsykh4cy0mgkg3j04yzfq73i17j0fwhkpzh7x4pck3mwx2nsi")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13749")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f85kj1yb2cc3ab276hc8yqrprrm5jp6kwjf38q1gs7s50iign5z")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
