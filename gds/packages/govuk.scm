   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qjslsrj0ivpskc5lm93mqkw0v1nl5f5dqkhcn4nk7q6sg2qnhmr")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4819")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0azqfqai8kzjamw48azc0hk3vqk7b1nxzsprjrsl6q4m57xs98zb")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14826")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "096c7j0dbf740rp5hc6f4cxpyncmjzvb0ff372ypdm3mxqdp74fy")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
