...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mdwjvhsk30d39pq6kpvk9832n22w5dbmbfjahg3xzjwvkmknybc")))
   (package
     (name "calendars")
     (version "release_481")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cxp5f2vj0bn9b71s1688xl52lb5xmv6x7byyvg73srbmjdhpi04")))
     (build-system rails-build-system)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mpay3hh4w4gshm6fsi80rcyd392p9hy2vn8527ib5nj845sr8zd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r3hh6n5x4wpqh9s1qv3sn110iyhrwawb8cm5v7z944735683ckz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0clbr362rxfn8rqxxz09m53hsg690k4z8ypgxfsnzk0j768y9bxa")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05ibz7mkjsbjkz6sg4j62c888gb0kmkgwy0vimsq9sk4996vkcy9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g5sdgpl7wf82jad4f1w6abm8hhaba631zdhx7h69l46ksjkjq0q")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dsq92divzqi6ylxcnydjkl5nh7l5k9dsb8par7bds6cdhvjbjlj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "18alxkrhqs46j7kwvpbvcf0xfakrncw3xzgn88y9vq3qwdgrvfry")))
   (package
     (name "maslow")
     (version "release_255")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08y75xkpclchacd468pj8r8hcx6wvcyrr84hpqbsphn45wjncsjc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1b1jlcgkqx6k5zqnvayp0m8nyxjvk8s6qrx7i9n9jhxhx2mhhivf")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "19y6w9ivhxrg40pl72j49lf7z5y99xsy79gh23hyrx2ilq52gs72")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "01iha51k7a82l52qbb0iqfbw3gc07s05x534055v7m7v1py3fxbr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mq2z99h5bkr4gsx754q50f65c00wyjs2zfdc5gidrv1anr296hh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
