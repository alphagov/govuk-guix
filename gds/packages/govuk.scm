...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jbqw6flb0z506lqk8wdn4immkz4gm2zkpcnmcyka8maqgw29k66")))
   (package
     (name "collections")
     (version "release_919")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s5c0fqap6cw1f00wrvx5ppx1jr500l0dr66g98ylzgabpa7pixj")))
     (build-system rails-build-system)
     (arguments
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qwznpis7pch6j2jg0nmpy10dg1c7171r22v0ad2pwjqbd55flm5")))
   (package
     (name "feedback")
     (version "release_685")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14d8ccnrcc0vflbxc7193pjknpywsb7lq9pha55zm31i93wfl5vd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "02vjfxc7a24fgrj6alpzjy2n7k5f9afpdrcqxnhcj29bh43wsbd8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s9z2my92wyszi40gg04nbkzagf41ril821ggq26xd6pbx2vak4d")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nf8ri52afq6ai6q8zqzlvzj3bira1fkjz3ql11v4jcpyibm1sij")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19hj3s6c0872zk5864l7lkmr0sf66kzhjiaaxg42q8ialgajvxxc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r07mzilkaq8yx5pwrvkwv9w7zw5yzcjlv6ijnzzgyplnqsmn4iw")))
   (package
     (name "publisher")
     (version "release_2145")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "003qjqax4i2n7pznlk83zq6lr82qnlc9dbfnczpds88582yrvppv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hcc44n8pd9qd0ww3ggq29yn6disq8vqfyywircpka6w3xavdvc6")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
