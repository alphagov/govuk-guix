   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11r8zs3pmjlgkhraq3gq43i3sa3dxicnzrmipjq0wczjyahrdakq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02ffl4yky9r0l848jr7xj4dwmx4z9qpi4fnzm7k35sk6zz6lrjx2")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12776")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00knrkymwj2a57p8kf4di4y78qwcg26p6nh074fgilijg95sarf7")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
