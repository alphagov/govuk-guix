...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0grg9lmhijda3cpv5p5ymvly6dnir4ydkwn2f965nv0whvmf0fs5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "082nvkx8nqc0i2w57yxn2l59mnz1aq27qdwl7lz9m64gnzi9wf8l")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pjvpfzs95fhca9pdwc3p0nswvhprag7r5qxcic5y9fym3jaia5a")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "055pifvb9cmdv0wh5pziznxd3gihzpcxv8pcrbnkk2nqzxh5v909")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
