   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03w0n3pyjyrx5r0vcf5sr4wq9b7czkjrlf0506ik4nbr2w7n305v")))
     (build-system rails-build-system)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0fz3n2zij0zzhji1i8nrq9lmkj8y66aznzm95lbazrg7pgl13jhq")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xsqwxjcbkaqbbwig0w5jfnmlaqvlpxc2qi7zl25y5gbfwq0qfa5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13527")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0s62kmkr3ybs3l35s96z6r43z6sjba6z1jahw8hhhwrsx88rfk40")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
