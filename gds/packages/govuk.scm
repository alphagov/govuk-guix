   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qi725bba4x1m6nkny365fabkw48qvbzg3sg5qhrkvqbglsrj2m6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jz9qq8dxyfzih2g6nk6ain207s7kygsn86kjai5n118fpsxw8jf")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "165iq5xa87r9f3kjs3h48lz5vnnv113xvj7z0zg73b708py21853")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h1y4sqns5398f03zk89spsd4ifqf42fn4210x7xk4llszqchx7p")))
   (package
     (name "maslow")
     (version "release_323")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rjgin3zcds7an5savq4qx92bbm6dyxiphprlw4550sn77b6hfc4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "13zyh36vqzf9v5hqyr0m2n1i65l5jxnmmysjxhdfkaw2pfj8dhb9")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w2682frd86qm8gx5ppm5isnhmbps0n8g7cgspm8vc0449mlns43")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
