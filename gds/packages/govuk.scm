...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ij85yg4f6fz42fjy99cxq82s1jwkv7mh679q6nhhh6naj3vs51s")))
   (package
     (name "calendars")
     (version "release_577")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0glmc1dp23a25cblq54yhka0iz9qnck77z31mg7xrgw9l060caad")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p5nlcyxm8nr2yavw5b1aj16sh7ri6lzy5c394s4vcf42wwa7hc0")))
   (package
     (name "collections")
     (version "release_685")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11wma83sq7dgcibhvzgzjddzq087jpn3pgzqcldpxzsdp92za928")))
     (build-system rails-build-system)
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p4l416pxyyw98qvfzi4srf8lhmhn138160f8by8ghblcz17r4ds")))
   (package
     (name "contacts-admin")
     (version "release_490")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q7m2w2y3i8aki5p54kjsawf0bn33raxgjnh3xrgvx3yxvq688cn")))
     (build-system rails-build-system)
     (inputs
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1v06x7yk3hmfn88g7yifqm6g6ilkm4nn5c8p3w9xhwnxk6h2in41")))
   (package
     (name "feedback")
     (version "release_498")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17almh92ir32b1kayizis5k52ylm6g499qxdaysszlsf3xi3qlap")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "002vm7vja5sigzgdiip50gzyaihmw9pi6xykrifz5949mcrcid15")))
   (package
     (name "imminence")
     (version "release_431")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yhk242qnh9pnxnza42yl185f2d4yz7l7sfr0fa75fd2wplwabcf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fqz9s5yilgbrvmis8kxqhrqvmdfa8fkja29brp80drsnzsnfxmw")))
   (package
     (name "maslow")
     (version "release_320")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k22h70yhbramajm21nibifjacwn9jk0c157qcbbjrhjx2l14jv6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rnfyj4r1qh5lv0pvg9z8y4gh1663p3105yq6wdwzy86vl9rz87g")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s99ma7k4n85s9jj7iz5zs230zqjrh7qqfad0k6iavi20x7zmg3n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "16wx635ibdnxzrkz3jvwhvm3qac04p20hk52bbak7fa3mqrvhl3k")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zipnw73p2f93w2qxiz5v0ka9hmrwhwk66bkl0k1caw1s4mibbl0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v2kkhhsig0fwx1kgyzfsvgq6nxsag452ki9lzi2n5bgh0n8cy0x"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ccjcyfc9hbglwjazz1jr2csv4phhak3bdhb90rg360rizp01aj5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "04ikgy6fhbrza7w8pf2gs0j8jrfgd5c1dnpwlcvkqfk686skk1ln")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gd6awf5br5pj8xb7ryip36qkcjq920hn744px7j1kp5gdvy5z1l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
