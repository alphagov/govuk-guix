   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j9kf81xgaffpwngb9lrxvfbwxackkfzhmsm19sjxlfan7hcdjfz")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0yr8p04rl972m5fzdd7ffx26j4vmzksw3879lb9c844kvfzdi91i")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "00vrxyf0s5r6qqd5ch8vm58hv157bkpir76skjav20d3icm6byrp")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jxa2sz76vnabp05sv9fg8cdsc94a7fbbxbk06q4djb64n6q9ybs")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2649")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11hjkypbqmzl8qybcn8x3p333n25vk276is52dw2qrf29x4673q4")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
