   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b2dz1d744ahapy4dv753bf1x0gn1cwx1slbmrhcgfq4rxb2n45s")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0552dg4j7kim5f2qd02chkn0glb7d5y81a437yjfvzdk56qz4qfl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13826")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hbhf29hj85pxd8da3rlvan3k2z91df066da92i62jw1x1m8mjlq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
