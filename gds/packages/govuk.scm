...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "041k88n50lrysvlcfw070qrmy14v8c7dap24xfd1whq1krylp3mi"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mrgy181pw54hzlpxbfmr406n9n4sswfk3g8aym155wdf17fgarz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4128")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sd1v45g5hq5z0sxgm4mkw07cdpag78a1rg5jcqka3klvvdc13n4")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13773")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yrswjyrm5dxj8mq9wsrdbkadsskxbx02jlmf3ks59h1s2prgk52")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
