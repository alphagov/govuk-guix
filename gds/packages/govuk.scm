   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qj3kxcld2lsxzspscrvchpp2ybpahdy9nwrb0q6dxzgxbjs2vs1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cdwivm0bphrx51nvlgsbbkkjcwllkbjl8mzb5cqd9kqlq9ry8gw")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12931")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g47gjw1wcxksngp129bqhabrdra71362shiql0xfpwwfxzvgi4s")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
