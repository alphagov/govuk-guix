   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p8v1z20z2kr589n3kbc54n4m20dp6jh0s9glpj59mvijx195vfk")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mb9awcsgab1h0rk379rg1g19ch46619liw78wdcvkmd80q4bnfn")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1habbchj3w8y718a8x94bfbw8c4cl6kh74949zk138lvj6h1yb0n")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
