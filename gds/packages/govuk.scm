   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h8zkzzk9h4q2h7vfbvcvlv4cva255ndi6bxrvwg86gdvlkkjg23")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "068c018bq89zjfb0impinya0vg2wcxq0ipwp3vin5aak3xskbkiy")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16j6w5lcy6d5i9vsxfch5h9cadss9b6a15n0kzl2mvbpq4pmn3ds")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
