   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04qs68civzxby02dfkhkd6dxzqlyfslj021ar6wbvs8l2vlggbzm")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1839")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hkhqbl1ygzh7i9znnni468i5kbhkmggv63bnhcs54ksxl7aw6xd")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z357li89qf0jk1ra48aqzd4wwxqqhmyy2ymd0ijky5m5dw1638p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
