...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3626")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zqmppnfszq3k0zmyd1da6zvj1bgz3a77s7h8iph9j246w9ndmgz")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12844")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n1hfdb4zv7nys645ya83klap9bwarni6hqxv2f5mzqddyhhib3a")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
