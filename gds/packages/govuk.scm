...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bz5bpzzh6mj0sxadvzbam91bhm7038naj0nwwybkqbsmy0507zz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k3ca52hrrh9mfzf6848mvdphbfkbh6832lwyxkjn41x664dl6j9")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1479r4gshd17rm5zggigmawk438mjicylrdjx2zx7lci4nhvssj2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
