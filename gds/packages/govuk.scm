...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4112")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17wr0aviavgyprkk2sax4882sjxy0pyrdnkrzyvrfiw9jvy6k3rd")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qr5vxs75az2hmdzyfvj3mpyvfmd9rc09zk0v7xg5i6p5p5ybhlf")))
   (package
     (name "whitehall")
     (version "release_13738")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "084kkh9jrs7lmf3wcqzms1ynk9fzy9zhx8a5lfsivrm7qb8kdi3n")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
