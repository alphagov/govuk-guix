   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sg58prxxpm7jydfak0mkxysjiw83m87608a432ir1gx5ksdxagn")))
     (build-system rails-build-system)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "04q08zwg7p2dn39jj5gff8bccz1hb28g200lm94lq1y23izkg2ni")))
   (package
     (name "feedback")
     (version "release_325")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14nxw8wvqvqbsb2mhyp7jx5ggkq6bc87mqa8r8dgc5d95gm3867j")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05smi01ycpfmv7khmcsl9yz7h33xn6pp8yknsjbslzzzr3hxbxhh")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j47b5dzn8g6qw392wak36xf9mq8kflr0xpqp16szxqr880l0pxj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a7wfhyq9784dp2sy2qz8b4any09bcrz7l5f8w8shcs38nwzcwrq")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
