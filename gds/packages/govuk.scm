   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x60qwzkl30zx8mrjjb1zf4zzf8z1dh8jpjysqf6nsn96a3d81n6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dbixfw32wpqz35p5ww9s23pq73lbxcdv1gy78mb03m6zy93n0vs")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kgyv0xk0p1wbaj8qsprydasng4cvrf9hs5svr94nviqs4v79sp9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ydwk257fgw89s79vcnk799hdz4nb2xm1s6j7n2lbprkzlqx3jmy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hjlffnbfnkwdl46xgw90avyxshsly35qqv87ffwjc3nzybbj858")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0c0b080qkmycrs8lb3973rhvm1rx27fh0pxx2x00iy4801cwj9hn")))
   (package
     (name "info-frontend")
     (version "release_262")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v8bgsn2lj1c02gj71jxi9abm0g5y39qnj3rjdq2dkgckf2d70h3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f6pbcy939h3513k9jnbh2isa9jglz6lwbc3xbxi94d1apccf40h")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nr9khpggp3v60yfhd1wbh13x1j89f1biasvb06s2kw5arsapxc8")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dr8swjzrjan02f7frg8z6swnqwgs7325kj2l9fw312ncwiblpyv")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0zg6qm9sdyq2wfa7hfiq5kpc5gvzmfnxabrx2vf22wha5ql8461l")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ykh6aki0g0i4h0vwhbjy1cw2bh8xrzbj82v772svkxyskh9i7i5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zg921p8cdp2mfwkn6b65v4p131sc96mz392i8r1gwz82wmlsdwp")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a2cv4zh7wq8bg2x8m8q5ckzhqvb762w8a5h30yamz39izrlvajy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0538qvfimj5rcmxyqs34b38p4brykhi0qnm41akqkg7sw0x271z3")))
   (package
     (name "whitehall")
     (version "release_13836")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14qn4pnzyir3wgklvsbm9jwlch715cmnihjrv9g3wr5vawsypfq1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
