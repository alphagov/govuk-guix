...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cs6d11ra21ll5cskla40kwzfi28jsxsv67494vf0n9131ph9gdd")))
   (package
     (name "static")
     (version "release_2853")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yhxwmjqj3pgz65gm3qaijhl95qrvch0s5iv1gsbvvjfyk2bqfmc")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vj43rk1zapmhjwynnvmg3vl1aq6vrpasc40dw6fgmfq0qk47gbg")))
   (package
     (name "whitehall")
     (version "release_13412")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vls7wj6n0qia4ik8i27zc9gfmx6nv93xcxl5kh5q64b56q9w6qg")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
