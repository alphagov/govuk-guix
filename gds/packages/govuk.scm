...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x9b7lflcc9jv79mxv3cd7kflbzmhckxc9amvyqsbsxjrlj6v5s9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z5kcd7sl4lx1sknz4v0qqfp0w225xk98z26s26asja5q888lv9y")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1469qkj4k6dbh8avwk6rinn8j0chnqkjnwkv9qbgwb17x2phkigc")))
   (package
     (name "whitehall")
     (version "release_13777")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04a8yjzfkwlg4mzibmvxiiwfn07nv9s4krilkcaa6lvh7y27mf0l")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
