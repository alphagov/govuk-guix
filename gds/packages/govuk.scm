   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dzjw97996sn2121fx4d1rq3a1cdyivfk46bwml55vn65lrn51c1")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06hpcych244ai1c7sgns0327pz5rzyir8g3vxsd02rq235ssiwwd")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d8ml9jzc3yfp9420lhygrgsnpimk34kg5b27s9xr9mnhdib5f35")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bjch2wpk11pdnb121n3jb32676y88lcxhnvcjjxx33a6pkj42g2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vgwg0ssxd570kijg1qqgi0w5g3dbhpyvcmwngdny7ba9237qcxw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xa9hzkyba1x2i32b5cdz70720k1izb3lz5m6470sai5i8alaglm")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "19fajg6a4za95fhiqfp833lnw4sc7dplghcbry47m0y29nq031lf")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "069skhmqhkjkc82ya9s0mn6k45z98vykqsss3bplzw0q9q32ngk9")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kis934yndihc1xk3i350vgblmk364wv5zp37zjwmngm1xfrl9xf")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13880")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a54lb5y80cwaysk4wv3k40w4qgkf2xmaw6v7dff7hx6lfpvw1p7")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
