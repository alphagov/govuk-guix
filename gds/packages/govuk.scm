...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zz8i3gkqlhwd3d22s41vcgfdxzrjssic7vil5gx6qdfh95903wv")))
   (package
     (name "calculators")
     (version "release_673")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fn61p1z6kalxs4xjza60l3azhyl241scjnbnf37vpwj8xyygh54")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16h8y2sfz3l93vfbagf9bx8d13ibdgw5lq76ifcc2zvd7gk8iyj6")))
     (build-system rails-build-system)
     (arguments
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "05d9b6qlj41v7xlx1c2s88sw9rv4m0x27hm32mhfqs38l18p2xy1")))
   (package
     (name "contacts-admin")
     (version "release_704")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qkkz12a8vwdyfh8h7xxf5ywkfagjxxljj8ylgjh0w32bb94nlzr")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vxcdnh04h73vacm2b5a5461paa54dhrg35p32ac1m55zcjr6qkq")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dmhwl54axa34bjzp6bbdijb5aiz4pai0wwn5b2l34qqsihfhj5s")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "04nzngjb6a0fllrl6xbicanrybbggaqb0xg1khrdpyy2zhxj7bki")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kn02hg7f1rawir286isyzinx9x3p8v61g1m1kd3lbn7kj752b04")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "044yc595z97r77lv2dix74qdagsvcxsf4zb56vcc1y237cx878az")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x37jkdjc37d3xrmjybbh6piwsjxrkgy632scd3vqm4767mjp1cs")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hrdj2aax7iwl2s8fjxmpnyllcifc4b3ycc2arbchl357l5b19aa")))
   (package
     (name "smart-answers")
     (version "release_4630")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03x8384hc6p9arh9akx78kf02m738cg2188gyg683qnhbmaxsmpd")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b9hq0w952gmbwj1gv1c2arspx4pzr3847b4zcmlqa6wdz5cwlkk")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xjr6nazxdb2wkm500klhkc60hsydnml09rwd8hvlgzdy9pcggsx")))
   (package
     (name "support-api")
     (version "release_401")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kk1rdw7rjdgfjqgkz72hm1z5c32r650pasqyzq1d90byhl592k5")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "15k2wbsg052jpz9gn3ksrk9y41gxp5prl331ki6bw7f6m01mz1xz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rzb2y4b9rlcm76vsd12xxlb1ailx9gl8n9wy12y7m63fy0m1rr0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14656")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "145wa3skg1ibngiz3wdm857n13yawmrahm5ysg40wm9j4j0q38m3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
