   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bq7hqggx4yifnjnlr00lrmysjqrkpcv1204ngc199mva0y5974m")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00ndgcng7pap51iaj29b3zgvdq4pga7p3kqjyiqx9k486wwxaix3")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02fjaw1f1pgcynvq31z1y4gn55w782z7r18xwhc25ndsbyfwj8y6")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13099")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dyxm9p2mxj9j5sm1g00lrdkykjd3k0zc43ffqvi5b6a03gw8lrr")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
