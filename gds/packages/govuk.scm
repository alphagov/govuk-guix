   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09kcn80cimijahla1kid3477x4c5p54drwbn3swjc1f1sgcqwjkr")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a0421zl1dfcd5n0jc94h1gph94jm1qbb3vmc0084kyira4bfpla")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "117zj60m5b6j3cyp7102c3jccm1mhb78gia0ckkjmmzb6zvvcx2v")))
   (package
     (name "smart-answers")
     (version "release_4773")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kl1mb6lirjp7jf35dfghk5yrrlqy05bra6ll84yxcdqd7b94l82")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s7l2sy6ljwpssibdvimgrwpw1430cn1g85r3d9d9r2779z5a9j4")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14764")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "033kp94sqsx986g0sarcq612w3w2ijvh2h24zpma5sagfnrpm7dh")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
