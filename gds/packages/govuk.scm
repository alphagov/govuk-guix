...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bf5jhv8bgf834zavj6y7iwj0chi2610i0afzj54zg5hjbsvrcnj")))
   (package
     (name "smart-answers")
     (version "release_4153")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06fpyiwy5zinyxqnxbavd81gqwwz6z7h3iiq1wflbyr4ri2m6q0r")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13829")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gb04gbbcrcyw9z23j2295lqqf9ra3vvyfzmbp75gsz6y7cx7653")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
