   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d0p4pi1m3mpw94pry0769y2jrbqsnfrs927syacif01x90ydkdj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zqg54r9j4c1bxw9n98jx46qff7n7mcbw6jmw62l7pj9q5xgy5kd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "00w9rm41spczjif7s4f7vn1wj641qksa49hxp9im2qrz83fzg2iv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13bfanv98qggm7bi1zsdjbdzv42bcdsg018ivlkk83m9ci7vinbx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lf5plfygwbpfrsny45g7vspdacnbnk6s0pwf6nfa21filvwf5nj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3776")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p301dvlcf53aq87c7bs74npngfzlqfhh5pb3r4l0bmnli8rk4ha")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2707")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rjqx587g9gsl38hp3577lcv9qdw0bz1kayblqkxcx1sfdh839sh")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
