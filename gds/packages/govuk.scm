...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d15s6ndn8bifnk0x4xylcp7b8xwyvdac30nm8bpscnw5dsqbmfj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08nznsn6399gx55y9brlnm2b64vvbh0rgdjrgcix8y5j87l8f4dc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lhzbrmpkih564dcfxrdmmgq04rn3axnsqhn2ynsy1g4zsz001wc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c0bicajnd69nw3bfk1iaa1i0ylilcp31i2208yzmxmwhrxhkq79")))
     (build-system rails-build-system)
     (arguments
