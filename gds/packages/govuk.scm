   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bhsdwdgzjpbgbp94xqr18hgdis816g0wly4ji3as9wdiyyc20i2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04lflbgyq5swl31jx532dqhypz2j37ygir3b4f2cm0p2y8qcayar")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license license:expat)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2938")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19lnqz6qx3p2dh1hgkxry084ib8al5yvjp0v54ic5a8vas79s42f")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
