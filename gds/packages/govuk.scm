   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d13cpas77hyc2blmpmia03vdhk9hnli6q2yj85a91mxzy6yw90g")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3586")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0644606dwkd2fggqr73n27spp7xswyf4idbdfrg8ccq3y0r219v7")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zpyw7l8p9rn05si0p802d75y6gligdslsazhyi1vadi24lcjajc")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12778")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vnfxg07m1kk0rayncdr3jn89vj6qd5xnn7jyyh9r4d2djzhlirq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
