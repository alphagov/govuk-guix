...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2199")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bwwmp7dr5g9ypz1xacgj98x7f6acblfyk008qckba1r6l3lghrh")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4463")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11qhysazarjlcmp4nbw9cl9nbd042lvbzx148k4k7v92i5ffll05")))
     (build-system rails-build-system)
