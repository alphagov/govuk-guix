   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zfnmr9m3bbzsnr1n9qndrf77dhlk38jlpg6lnqk81ca6xfhcz49")))
     (build-system rails-build-system)
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "030w9xf1pfpxbzzbzmzxn2s0s8p3ws0li56mwqbml9m2pw7sdr1y")))
   (package
     (name "contacts-admin")
     (version "release_683")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15pzrizq885kf8mdmqp4m01j5ajn1fmgzm6lrbv5l4bngd9g3gbx")))
     (build-system rails-build-system)
     (inputs
