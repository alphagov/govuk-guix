...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x771i621vn5ch6niwrw6gqbf7g36p1chixj1lf66c3pwvig7w5n")))
   (package
     (name "collections")
     (version "release_894")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "096f5lbkb1qzl8gvcjqjc30glkhcwfpi6fldr90z3ddc73ql54s9")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1c9297bwyvg1xqrk2zvb8v6j1vbymsv64n0jawqyg2c62s8l2jmk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xahsm3797w2i87q40rhqc15q1rrzscaj2h8nas5yk9035y28bd1")))
     (build-system rails-build-system)
     (arguments
