   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g2sxxpqcjsgkf4944x90kz909iyr16rrpihawqwxxw2kx16ph5p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0knx1h0rclbb6b139y6rmqx1886c23jlhyfq7p73k624628gwqkw")))
   (package
     (name "maslow")
     (version "release_436")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cn1q1myq255c6178ssbjrhb9a5g57j8wm1ca6pprax24cfb8cv8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
