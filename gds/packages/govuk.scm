   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16zld34v40j5j9n0v2gvarm91ihfpr3dkxsxyr85zyd5pizbyal9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jdiw91cxa7q494yilriyccwpc24lhwapimk31q0v8r5g55gdsa2")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gmqv2706kr0q7nz3v4xr7l5mfsp74863zpllzfdlkg17gd9vmlf")))
   (package
     (name "whitehall")
     (version "release_12836")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fsji9019nq5j74jwqja6qg1r6vibllzgj7d8bz63m7hkk9n8qxw")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
