   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zxj315bd5vwfcmwg9fk35k1s24dh1aya7cdb3ymd4zd97lq0b9r")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f5k2y7hlxks8mcz22mxzxlflsvzg8gn2qjybm02fwpxa5vf1ipn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "11xn3qybmsdv46fv60s5i1aigflpxrfv9ibc7pgg1n2fh0lk8x7s")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mbh5090n8ks8zxg4g29pr0pdkdv6p15079c483wx8di7afaqzhw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1v482wr49djfqbi2simy4nn006gv4vx4lkyxgdc810iqgrfj5zkz")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1aavihml0v8ss60pnyirikjidknimkphcps4hgyy3i19mxa1y136")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0029aw3hqbc907zbgbvvs00kq0pni3wd6di2asygkxd7vf6r04pj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m5wmqzg6zsw8wjyy23q522zw5583fqlp63gjjap0amnygsf2syj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13441")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xifvi5il4b6lwr3d62n446fzfczrhddksq9fjm5pmwbv5q2z1ly")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
