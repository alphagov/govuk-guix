...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "08dcgjgjmxxwgissscnb9bmwi1zcfw4145hpzkd9gvscqryh93zb")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f9zl5ppynsmsscdkfvx175qcbda76rw4jzmj3f2mqsnzpikbgjr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j56hlwipn8iimqrml1j6drxlysvfdlph2as6cn828zfmdk4q726")))
   (package
     (name "maslow")
     (version "release_337")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00kphb83rljm0iy7sirbw364lcwyhbapm5drmq3bgwpag2vqfn0f")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
