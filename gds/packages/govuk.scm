   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1pyrvczqc0wplv11rgydaqxrkwc3kzr59g6xm69jwrcjsjm47ccq")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fhh22ppm3qrndfqkfa8m802kiws2nyl505vhng6y36j9ddqsbm5")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_3273")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x4pjfvc0w8lyvs57ni4ym3pf2nms85zim4xdsr9dc6w7lxxxvba")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14297")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j5s8wfdiblij1zzlx1l9aa8a2kvxbrly8bxfp07hs7qr22a0gdd")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
