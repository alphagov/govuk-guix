   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wmnzc73188j71x1kq3y2acyi91a569iywbhq6ygli57jyfad7c9")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w2h6cglrw3i3rjc7dwny6wljy07cn5k6dj2asmx6szikr40hdyi")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ykrql5f66294jj4zg9d4wwmx2nrq5b1kksgcdhc2gr7nmyk4vil")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13496")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b67s31cc0cbrbb3lmgn0b427fssi1kbkq0x95j1mhad990i8lql")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
