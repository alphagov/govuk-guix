...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "06cyc6f8lygpfys6pkrj0dbz3a5dc5dv1m65njwgjdj61s5m7819")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v6a98sl9n55vskydbsbn541dlwr21gg6x7c1gag4vz5vr83d56i")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lc5jqkvmgx36pmrz4j6v1hi7jawhv327m9vnsnjb15b9453w497")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x60r1js3w6l83sf7913xnlxn5xbclsddpn027vrrxmk7d7p6fqn")))
   (package
     (name "whitehall")
     (version "release_13765")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "148czj1vlmdv92a5wkd4alcr9hwzgfcd592li1ayl75kk44axpxz")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
