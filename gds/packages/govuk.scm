...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bl3rfr5pi892nf3mpx3j8xpqz6acmgnjaixg6l7xh1jqq6amlr0")))
   (package
     (name "calculators")
     (version "release_376")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0axgc5qr57lq1bym4fz6smk3wq1g08zyq2k12rgdq0vkbajn3mq7")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gchv3qjy1wwjyszdbdj7xcyzdrqfr3iw0w93izacil589dw9whs")))
   (package
     (name "calendars")
     (version "release_591")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i7f92cdjrqwsxyagw6ajjkamsdmsdlavhjr3kzsb518hg2vh25l")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "16fy4mf2fycpp4gcnhv0zrbdqd3q73cprdij7zpnn818bf9w81n0")))
   (package
     (name "collections")
     (version "release_703")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0llk0qj11v4z2z3592v55agnk08ha477sxzd9r52smkjqq2d0b3g")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ycqngraqzn6dnbk2pppd8ky2jkpdvyfzhh0adzdk92l5vi2dhbg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gfrzq6srndaj2100sjap53s889j9hy6rd3yc0v2vy8mwx6wly48")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0222yqs5hwgzbw19x7y735yx6i4jq80jfadlww64dxrrzxnf4wap")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ir2lvcffl9jb5pamqfkdm9mz4513hx036zqd3mnn00cd8ggxq73")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c5ry8v22zvplnz2g5p1c4vj7g48znn2kbyr46d88974wyzb8ks1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05n5qjivy699mqmnk76mjdbmigiylxlscapblmz2k4bd02m00s8m")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06pb1zn391nqbnhkn53rg7727j424x6cif9a8px7a54fpagpsn7c")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fk99vl20wsh710mjwd5ys1nacaj41f7hpgh1r3avdqkzb48vy3j")))
   (package
     (name "feedback")
     (version "release_516")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04k7s6nyh6jmjkxybc17b8py441p91kw0cq1kax07yf94p0q12sp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fhkplyf1yzshjpzzvw522amma2dwz657il37x5bx5c8j4v9ag4g")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kqb238jr85vyx6y717hn0pgj8ibjxgx4a09jm1sa9a01cf8dagf")))
   (package
     (name "frontend")
     (version "release_2983")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10r4svn4rj9g8hk7jlhm1hwrns9p4padlpckyfb7b9vqkqwczpyj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "104hms168kkwax6sn9yr3pqnam3akznrp3ikp42mcs8mfp2l188d")))
   (package
     (name "info-frontend")
     (version "release_226")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1avpyjddryzg3aawv290kmlgv5d9s33myw3jxck06yrpavrpxsqk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g4jp904hrd1fz1fcsaqs48phm0pajjqiqgdic2a3z99q4zsqi3l")))
   (package
     (name "licence-finder")
     (version "release_464")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17bwiiycf2r8lhhki6k8p1vsjdscyjkhgshdyhib35jzsc01sirn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "14irqzp8y6zmdwh6f42kpjify4z9ky712hkk1ab8h8jpvisz7gs6")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11bvf783hhawm89fxzlb79x36rbqsi6k8y29d0i609874l2jip9b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hnj93id6b0fng9nf7wdvvv2900yw6i7xqxqglx2ldic874gr5b1")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0m9vn49f3ld3zxpfcpk4i9ww92j1762fw9iq5yclabi3sxlg3pn9")))
   (package
     (name "smart-answers")
     (version "release_4101")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0886sfhx5pgkgqqz6pgcivwfynv6w6iyim5ksp57hnj70vmk1s2l")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2970")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0whbg1nvyskmbyqwyk5jpg1hv1spwjb8291nx5hhhb309695v4rw")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wq2ssqrkgjd97va06sbb879xri0asvsdy3r4kasxcrabb3m3cbh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03m1qbdz38hk413pbxb9pppvxsbxkbffzhms1al3zg11k6yr9az8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13720")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pbpq0pzm0bs7flaxs5332a9q6ds4jqb6h6g5n94xzqgq47md5f1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
