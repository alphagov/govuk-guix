   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fqkwvj0jxj06jy0gfh52wvxkcf4d7m9qy65qv4kjxkyq2jsbl7k")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r8pqrkyqrln78wzfv2j22xym2bdd5q0z99mhj61l8l4k0bcpmk1")))
   (package
     (name "search-api")
     (version "release_2557")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b4i02xzf3pawqnh48w2mii0xk47kjwl7ykynh9hiq4ly14n7syr")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f
        #:phases
