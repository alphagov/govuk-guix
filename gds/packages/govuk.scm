...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h7kc898rjra7pzrr4qgsfh9wnhpav9bi1dbiagk4zd6hmjj0bzn")))
   (package
     (name "collections")
     (version "release_395")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f9kn3zb68nhkjbvy0jffswc797jiq9q4q6yx8xhhip6pdq1cs8w")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hcg1kxarw5fw35bs9vn4nxqrdw54hzd3wnpmdaaly4s9kkrwp9a")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19d9la5j5805fpa58l1bqx6hvm9006m9wq09iiz6j45n01k575hz")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
