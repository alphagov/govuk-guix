...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "05113nlzy016f8kz768c049xnvvzciw6jq6xnb8w9qlnjrvmgbi7")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01flb6517acc87s4blnssp94mh9bsjd25ssnpxxbcvkmxa4jrlyg")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "17yjxj612yhwi66c9fy38g29a76ism1vqv398bjc2pqwvm86ahy8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "172yh2qax6i0m8d7ywsdj6sd0cjn8kkzsflhsssxjbyz0jzxx3lz")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p1wbki7qy5wscx3n8x8zcxb6v8gzn8shhxw1bfsffqdwramilwh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yf4rmdrk2knmkm9iqhsj75wz577p4sq7r3hwspb01y3k36mk0d1")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "00418pwhin07qsw0alvc306m7bx81smrw48kqy4q45k082i77wh3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cvd3akcjlac7vhlhhjm5djhli72d61mk0vqaq56xjgghhv7193m")))
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "00wi7hmp8n9dyhayd2ykn76hb4g1xlc7plz3lixrsngjhgq1zrr2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sm9py4bka22nsbw6vbzxgqna2niy73183qw7yp1z28nbpclc3wq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "08hidivhvy9zrivqhmhj0sr4kcc2l42jjn1fzxncrdsgviqp9ipm")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i0qki60kslf8h55bgqdpk5pv1jmjgd83ij9f60g38p6dsyj0d2g")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yy655hhixqdz1ly8afqzh7qfpnmldml2m3p1i7g2cj3v0y34zwn")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j0bkgn91a226rcg7sy8rih33kdi51n4yas9lrmzk9mdfnfpznyx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10a1dmv5q1i15dsyq13il9vd40kr61y1vc7w51z1pzndf1zqrkmz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xq7vk9g9blajv5plqg7ihdx2ch3dqax4na369qyjbwxg30cjrpw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00qb7lp84bxkjcxbipqnp2h0ngl870x3fp981s9vn62cjahbh4s6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n842ydayk8y223clg24mzzwl8aml69n6xd3n01zlj8r28r8fx2f")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i90mnmhz83gfglii2jzc55cz7l3vdj2mn2h7mc33wkj9zrjx7nb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xdd0hxl7fx6nm23nj96d32cgc96jrlgbclwmg4x2rl22aiyr93z")))
   (package
     (name "smart-answers")
     (version "release_4770")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1llypq43p9nq8pvanz5zjjm6y92rxgjd4qyrmmh8mgfhzqq8cwib")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "16jsvbf7m85xm8pcrs2nxp02l9prfz09x2g4251kmxbvs765yxw9")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13bd9y1zksa05apfk3x2awdaqgaaj33yjn10777jqhnpdgx786jd")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
