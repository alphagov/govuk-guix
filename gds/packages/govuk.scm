   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vcp8ss4qx611g1vqpyn4hqhvg51vlhp16sp0iprscr9bdsr32cw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z2xg1jsg3z1yynzv8xdgxs49g3f44db5xdjy127pr8ff3391043")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bbv8nhgamcszyv7zk4rpq4zh0g96z0966wp5pxgfycbwxnm3p7b")))
   (package
     (name "whitehall")
     (version "release_13683")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d3j5vbwigi8bg7y49db45fnz1p2bsifqxx97shymgqgj7bdp2g3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
