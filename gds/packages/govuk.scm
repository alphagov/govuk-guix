   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xwhzq525dg55xk0klywa06sd6y62fszxg5mp6by1gcgyk6kdhiv")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04qzvnw9vy3ylpy5ma18a16mya6smwfkgfs2a11fzx8az5alcp3k")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a08s21ii7dh6m047ph9qgklf4in703qj34c4vk9rrdi8avfwyn3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xp58nq1yg2df8z39l63nzn8y39sib8i0kbxnhj5ji8jdv302g0f")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "053miid37zdvb88amymwbjyflsky9pvfabmfvrirxlh6kscgyg4c")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mklhm0y7n58llsa660hb7yqjicj9zxid0hsnsjqikh0in9gj3gd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
