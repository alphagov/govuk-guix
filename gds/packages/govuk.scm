...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "02fc3li8qq31yk2s131ypyb5w5lvv66sya23harpgzr1yqb5w4wj")))
   (package
     (name "calendars")
     (version "release_911")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ri0iz49l339rq3483pnizhr7imjd4m6h1vwy7gfz4vgvrb6mxkm")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dglvvrajhyw1vxxs03my48wj81j89zgma8hdcyz21q8d4lz97y9")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02nh4q2wcxzr74n5170n8wkf0jgnl3x34m5363snmrr8b5xpwr0l")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public link-checker-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lgxvwpj8kjhhyspa4yvfzz9b6yym85prkxkjvjk16wh6bqlghdd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z10gdhrlf0w9xpgayppjhynxj5248wvg3c7xncry3xj96312pxd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f))
     (synopsis "")
...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_2274")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13adg7bl1j8p3i4ixiz2cyy9bimj5mkpbgqwi093228l4jrgzj5c")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4674")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "106rn6s5bf3130f6xkm85smvk1mn5kyj6fh95zxj2iwr1ibx4a6q")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14694")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "004qiawx03hwbz4vz03cd97ajf2zbv035wxdx4z4q5h5ql4y118f")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
