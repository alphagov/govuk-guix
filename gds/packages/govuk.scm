   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m5cr032xk1nw0bvlafrl5v6xib7ydsy24p097lqpbg4r0hh4i8x")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "19asd0a4nmn3bj1n95k9pms3wyild4ppdq77dgjpi2wb3p87mhia")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "07iil3blmfmhzkklk675jz5cv7s5xfc2xc61by619jyrrkffybfq")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13666")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kfvxdr6yzd00axxng8w2x35fr6fqr2b8bd9yr70vfn55qvwg6j2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
