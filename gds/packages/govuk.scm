   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j4byrh3fyr438zzgsrgb6b3p6bmp9dnh3bvbph3i41yksdnm8lc")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yl6b1xm0qq92iklmsmadp7h2nidcj3xskgikxj2nv5bimqk9naj")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hmcrbv62y49p8k0zb7xp7g79qld3cv929iya3xnzmra3ambnvk9")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public rummager
  (package-with-bundler
   ...
   (package
     (name "rummager")
     (version "release_1985")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z28qhnfb0xadc06p20rcfrckl4dc9far63iyipfgsw6ikqjgz4f")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4293")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12zjmyibgwk5gqhf6bmw93rwj2s3gg31c79whsg194r8gpxkrgqd")))
     (build-system rails-build-system)
