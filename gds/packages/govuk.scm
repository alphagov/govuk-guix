...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "04gj6xg2b08bxi8d34wd2ps41m6gkgxplkv7fg3lv6w292wfzpba")))
   (package
     (name "calculators")
     (version "release_740")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y12f6d5yd683g84bnxc08mgimpv49q5x8g94ypcmb5dd82p4mbq")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ds5rplggpq8pf09bp1cfcankzxr9bk6fb6xf4pr22l23jac7iwz")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f18lyfjrlihlw3k39s1nmzf6l443qnciqizdvw1jayd2507x0v5")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16mbbrl7qhlskvcjmlgbriqswhcji8r01cpv64flkfhg01j29r85")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q5pgycia6vjz4rz9hqgiqm01h3x7gff7hjx8by4cql3wwxgd523")))
   (package
     (name "licence-finder")
     (version "release_790")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16lsyd3aj32l68120ng98kmr41crcjljppl040q6i43c4cc78p54")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mz0clz8x9p5h0lf76sq3apbhz1yib3iry6jb225dpg3rz0qc7s5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ar0pbns50xls01nrbd2g52zfqna9hb7d3yghjsadd8d2npfram5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qa6hnh2h2sw00lx79wd2h28n1i239lr1v8kszkjpv2k5qs3j2g5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mgvgjsx1c1irfmzhi8r4gp2gc4dym7njyih5j1r9rs1i3cjxn7b")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "10asm8b7xz89bh9a0ylk9z6m5qn9rp8d9jsn52gy616zgw7z2hx5")))
   (package
     (name "smart-answers")
     (version "release_4842")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xcc84b2lkpy4ma7r3yrvrf1jz2k9gg71q9dj3ng10j7rgaqwz10")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gf2rzbk8a896pl5fcg7f4v2387850pj85pc8nwi6sya9lvw88kq")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01bz92rb9vrfy8xssg1x74sk5l17bskkg2gkf4ayx4lr27qgif75")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pfwwj81fdsgcsgbhxlacrydiwpnfmzmb6hzljic0nqckmszn8vf")))
   (package
     (name "whitehall")
     (version "release_14838")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0spxlgp7m4x2rr53m0jvqxq78qiq8hf26n1yrzj71vd6wmwnadsz")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
