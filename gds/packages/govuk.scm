   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fwfbw493kgy038hgpznjbhz2wmkzy6jirpmdbn32va51sm8mj5w")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1064grxk64a2cn9qj7kk3wnsvzlrn9g2ig0l9cgpgyq4z1qyq6yq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "093p0i4wndalxzrzg17v9l1ijsqfflrknqga45km2gpzdrak1d6x")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zcfmyrq3b9xmpjmds2sahbbinnhql1424zb1i7qa9mqa2fw3cll")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hrlflgk0l9ppkv6630majdf4xz4s582ias4igynvzkamxndjidr")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13078")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q3mszyglyk6rlygkw4d90fqhdga78hhzw5zdfhlc8d4a1g8l7p1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
