   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00v26vsab2cds3cigm4lhs6wfb9g6wm4cmq0fvfacagvhwx1q5bx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17z2ikqs2f3vx3fpi1dyds616dx195h38g5xzy1wm02gxmd9x91w")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "11y81442cvfhw2vywnjhrs89i364404gkcqhb2z2qjrjffbw95jb")))
   (package
     (name "static")
     (version "release_2567")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l3l8f5slgrmabc7kshds9z73j544frzpnnxfa1fanz2nxabask8")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12744")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11a5zva6k4x51lg4wacjia4kad8fakn3r7kspmmdcgwdspmwpz4d")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
