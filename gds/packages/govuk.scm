   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rrsaci3nv66ijnfbz51g81r2cpnhxmgmlankhl19n7x1i54ljkl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cncj1szv5s8w53kafljzk92jpm1wvyrnj8na70ni3i02l4xz3hy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cpimpb6p6cb7drzf0pbf6cdnmq111r9mff0dav7nlg6pa51slni")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14jy0sfd090ba7xf0i6rc1i371vw1s4pk3mh725gwz6899m093vp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13810")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05sd80kvghc439m6cv15fsk0rwvr5naga54g48vimhzc9yqm1xf7")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
