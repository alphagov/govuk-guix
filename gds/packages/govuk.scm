   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16rdz062w40iz1f8c82vvz7vwagw316z2qlh5c8px357vva16f7j")))
     (build-system rails-build-system)
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v6p22l6sj9pk5522j7rq121ba200nhdz75cbicxr76szv5q5azs")))
   (package
     (name "release")
     (version "release_379")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k5hk4dna8wd5iylpxky3z3z0vzyvy40kw2zg4jfqzxflgarivgr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
