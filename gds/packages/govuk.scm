   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mny6m5ggmqzrgp63z7ws2w2hj5qhcls0q1v0gr4a2k8lmy6r8n5")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x8agjzz14k4bax2199bb1iq1lrdcc992fv7v1q55ds7lkwiylx2")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0spr5fgf1da2pwb0mmqpz2vvsw9p2m4fq4265dr7a3z65m8dnn3f")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01vp3fwa9qrg3pb8vbp2mzr9v0j481g3phh2ia4fjiaq5i5qrlf0")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zvpbh49556bnxf7pwwnnfddsvlik7yj0frffcr8nalc4787x93l")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1flhcgnh6nq0v4sn9mapxz1ik0y48r5g8r1ai8ypyg4qralmcwy1")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "197r6sn24kqpd7hrzkrvyafii69n92s8cisxkn20idr4fq72nyfy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k02w171dx4h6kax44gp9g08mxgg78gw31h7jkvxx6rbycz57dnn")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_3022")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18qhbxzxnpnrg4sxx814xf2qszqv9vp22ljcpga4p71plz95dx0j")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13891")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k6z6b38zys702dz3wbpif57fmbx7yxr66pkziclcm8034rxhgf7")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
