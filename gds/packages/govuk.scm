...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "08rxrj38y0skikysjvag0c1njs2zdhlh27lmy4vp9n1vxlh4mw9a")))
   (package
     (name "info-frontend")
     (version "release_514")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pmypn6i3l0kf6shgrmng65wd8vlmixv9c9r6fyrh3da7axy078i")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ngybdnjfz43yi35k6pg9xq4pg8rmszcmmbfgi3nfcc745whlqpm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nxlri4p9xkqsv5c9r8dfx9cx1l5lkd0gnwjlnad4yv5lvyahy1l")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "08f9mimbcaxy72g7vj1rlx5317fv15qj3vddy1l7hwvksz028bvf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11y3242y48n4icf5n0y2da8bsfscq6czv9mvv93gh4l7zmsw7lgi")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pdzvv06dpi6ax84hg7qz1bgb76rlfhlbjspal840wcbcilvz41r")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06xsxknkq5yksih1km3z8bwg6xvwqr5plh67la48lb03cdlhnmm6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
