...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "18y8zz6jfss9ryd08jvxqlki8ccshizqsgs4qv2dpnqc9ffqlr51")))
   (package
     (name "licence-finder")
     (version "release_778")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r2qnbz8qxp42mmqmr9niz2aag62wwj3pfizc7svf3j2wiqmhpa9")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "07isfirsnw47ahabgs8dbnix3zic0cpwgg57nglxizy7hv666v9h")))
   (package
     (name "smart-answers")
     (version "release_4799")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04g0rkxhqmkaf7plk7n603pcqbg6cgys2kanpxh27ywsdb3mwjij")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14808")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03f374gxg07ajp4bkx60im1klm8qgnvrkpviwna7zz3mga22nd6v")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
