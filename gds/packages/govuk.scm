   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pcwgnlk4xz4b1q66i2lbc9d2ipzaxyn3d9sqcrjmgzib6ivn0y3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qg5n90kqk9ssb1n4230z58qdr6lb9mrk4b46b3w3ahf416pwkpk")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ih7s7jwanmsmsjmcbn8adp1jihbi6k89cgjm2ck3abbr5kh21xf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "18abvilhq3x5xcbrmy9j3ms99h5y1ph8nz7y6i705w3kb2dd6pad")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rv7s1bs3wwm70a6ln6nr4xrs0dibcap6ii96cza2yf6qzk6dck9")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12847")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dgmdcv95fi8n2f9ykc06z5rf6hnk6dhj55x69jv6haxxd0w8lcf")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
