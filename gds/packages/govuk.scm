...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "00w33cmkrk89k0dp7vswhh01d6nfp93c6vlmsfznfxfk9jglsz3q")))
   (package
     (name "content-store")
     (version "release_961")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sx0aaggh6x36a1420g1ch0viz06fl8imb3257n74qw16si7mj7s")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1dss7p3wgn0a6x47dk0wxzlj9srv9fmcj7z08h682s43nf46kikv")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l3zlc4487yjk06vyqrfr97ra9dgmsmqi67w8p8mjc56c5w7pwrd")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
