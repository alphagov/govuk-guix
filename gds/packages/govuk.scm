   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z7zpp0h8sy832ifphd1n122rmx1qx2g4zby5f03h98q03ff0gc4")))
     (build-system rails-build-system)
     (arguments
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1wg1va4fpbk2r223380f35cpcbkmbf1a83ipyqn7lnqpnzsby99x")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f13mcm111p1s7h54sy4n367457h7l6jrn4dgnvs61qcbl4ik3zs")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vbgafixiyk8pw9knvlzhi8gzdrd0bf12ir0yxk7wp6z658a6clq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qzcmnf2jms33s25z8hpkq9mf6qkg637my7wjya3mbd830l687x4")))
   (package
     (name "smart-answers")
     (version "release_4374")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ah7fg2hagjjas4q92ccjq5m2ywdhnp3zvhg9a0lfcrqdc57kw27")))
     (build-system rails-build-system)
