   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zcwcvb90kqjsfrhyhwnswkz95a3ycw84b5lcagq3avpffv28w4i")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1mlas3crq3dxki6r53sn4mmm0lyaj0kaddqr0gxliy01d200x9l1")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05c9b5f8kr3l5ppp71m8j90ynksjxn2a79mj9pklbll3n51bv73w")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13105")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03aaqwawbldffy9m9j37cyx2bxvvdyxai4kv7mhkibggwvqc3h9q")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
