...
(define-public authenticating-proxy
  (package-with-bundler
   (bundle-package
    (hash (base32 "0b2sxlnr4bbvnfzk13xbnxiz6f9w41ynhrfki4a16nqry0lmrina")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r1bwa8llbwqz1wvaqz7h5395fzmngyxvdfm3q80rd01m62nlylg")))
     (build-system rails-build-system)
     (arguments
...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "10w8cnixj24a3vcdy5yy8qnz87rnykbd4xp32iv7cn7skvnqvmc3")))
   (package
     (name "calculators")
     (version "release_624")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yl5jbl5f1paqvcqs6y5svqva60bdagksmzv2sn2zchsal2yc4s7")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1v6vsgfkpcvr8qllv4djdjs3fz0wsrwyig1ifvwhnxs014bp1mig")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cplidalzn00g02164g2m9p01hp49xxn2gryjn812fhz55jfwjfh")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q7gz0v7zxfsinfkp2asdygg50qn4azc23bcxq7qgjgzakv0932a")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bijffiml828ys9rpw45h4a3pbrdawhkz6zvxs8in07x2sypmq9d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hk72np8zbyyapmf82h4qn59cj5fqyh9f20knnp2zfhc4gzhgjz5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "060h6n5y5spqmwrp7yna5nqscvq1dfik5cdcplkw79l4rphhrhzx")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "04fwl2hpz711jwdlyn6ginvmw56mc5a0y7awl5my2j0wmb9aj6bi")))
   (package
     (name "content-store")
     (version "release_960")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1aw3734rc0sagccl3rd2ih7fb8gxbvpb3yh811b2wg7dllgzvdkf")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ya70r6syq2a5jszb782bpfdxgn06pxcw0vmc03sxhrs1l3gbw8r")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0w2gpraczyiwyki00m3gg7aazzq5b6ap06sw43l12pl5a3laifsa")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pya8zw63ln6hack2mjbr24yz909i9ca15wq17dhk0wv32g0kj6q")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ly3xs8c2xpbwax3y8ll39h05ldv3lrzf2abqqz5d79anrn8a4k4")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gm374dry287yn917w2xka4xws6v3gblb6zzb4vprgmp7m02bx7j")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hv0gd00l43h7ns8n7987izb0gq0hnq8rfyvlbsh5ynlsymdi10s")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16xhg8jjlnwmkha72ywyf9lf1y7gkvxkiyf48hf56hp55x8fpl81")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0w0wjr7qln3fs579i5wx5rr7wyk3ladmi6jsp49lhxm7pl93yci3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x66ykcbbkfxmk0bmv4bsb1hwhb3dxkw49nx5fwjq91pvxdjy7by")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mkgk9551cwiy3l4f9gbvvp8xrw3qh3r5zgabn3ww9qhxzaxdgwr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dxm21ix8a2dyr1v7q3d70rbpp5vv6hf45ccg1pcdrwxqcc4asxz")))
   (package
     (name "publishing-api")
     (version "release_1580")
     (source
      (github-archive
       #:repository "publishing-api"
       #:commit-ish version
       #:hash (base32 "0n6n6nfq7x6xzgx6s98vx0g3a91bynaw7saah1ms15y3abm7fvms")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2400")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j58xjgg0gw7cv7gsh3930xa9x6sx3hdp613hzrpknx6k5bglwp6")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bjqynx4xzciq4y7fwciw8p5vbd0ghb8qsr70sbmvw48k2i2wdgr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "080cqyb5jw1nkkdrq9zig3fnffg4q06ak7cj4gs844l3v27xfanf")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kp127lm4lbfhmgda2mjq9f03ynb71fl8mdc3m5d88svkrqnj3g4")))
   (package
     (name "smart-answers")
     (version "release_4564")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pw2hdabm3az79r5yc0wnv6ls14k6yd7xpa297xz8b3s5frrgpw7")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qnb80hxp5q7n2rfrpi80kag2xw0c2z1aw6zcf0csyp1mqxnvpv1")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l2c94a4x6kanhg50ssk0bkr3m8hlx5679hq6r26r9s0wzkdb859")))
   (package
     (name "whitehall")
     (version "release_14486")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vps2ln48v305ik929jxv0l6shgsfpac1wzvwy3mimr3d3p9vrrd")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
