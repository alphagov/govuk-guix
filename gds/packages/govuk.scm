   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hx0mdpy2c72pq3qcwcrnlxhi2m1w1ly0gnz1zrxgl7r7pfv5sd5")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0frv3d1srhx8k2b05svprmyp6v8q9amgrcx8xdsyxniw1iqdvq62")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bfyg4zsi1ragh5d537fg22gby8lprcsjb173x2lik1piwlmn4bp")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1652a6hh3q8vddf3rrqjwk0mm40yzjwgsw8m00i778qf3hnv1qz9")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f8zvk88q44p9lvww5q0axd1fv8ny1nca7hq2gp3sdrs0rsrsm9p")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
