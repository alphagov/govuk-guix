   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1achb178c93d0c7kf3kqd6lfllhjdrc7qkx7c34ccckz2q6hm8f9")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d7gkh4hx8hlfvzd3chqnkv524acqvn6d2ihq0pkz1kblfa3bfs1")))
   (package
     (name "whitehall")
     (version "release_13905")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02j0dr1rj932h2fwbizqmbcqa89bfacz572gvyax72r4r1im5g76")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
