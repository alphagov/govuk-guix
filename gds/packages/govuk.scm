...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0029sxcpqcqg9v50xxy0kvd90hg9sypmnvfskrc17ibgpamzprgi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q9h7rxkjx8lgn1l5g6s4w8yrji45d5i6mf1hayxj15f1xf7k1c3")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public rummager
  (package-with-bundler
   ...
   (package
     (name "rummager")
     (version "release_1917")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vc0x7dbz0kwiwgg7b9sgdsxw0cz5p7bkhs91xym285qz2pwmq64")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13941")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nwz5cwhqm7djvxc8c28vrac1sdj9a5gxz4g77b0yd3wxbbzab6i")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
