   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "184rwijcn7xfqahwj3j2crjb84vr0fmdrf3z641pk5v3yx37lkhr")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h28is43da8hps43q84gxx74s5k5sw1z854av5sw1ysd5s70cbkw")))
   (package
     (name "search-admin")
     (version "release_159")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fi7jvmv6rxvrhlk11vh8ikma8spqgx93i7x5n5qm91zd3yvb36a")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "04g07mg1x5rhjarfxhkmnck5yhsqw96w2sjma2lil8n032m16srr"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pc3hshb2qkd699jilh304g7drzwcsx9wc3xrnwna4avjwp412w9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "09pyd970mbpgcw1azj8fja2w1rkd65xcla87vdmqcpiawwamjls6")))
   (package
     (name "support")
     (version "release_659")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16dnwfck0xcjjl6bkbw7fya6v33ypqz9zzvqxv1nn0f0zc3l35am")))
     (build-system rails-build-system)
     (arguments
