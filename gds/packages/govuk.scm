...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0njr7yvdrz33q2j7sbksjalw1brhsflrpsr1k8k17rcr0g1cv6wb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n7lm7y3l2r8dp7g24fbac1dii8k0y39x7mqhavhvay30qdimgah")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "12h9sllxfxvlbfkqm3mvsrz53zk6bdjpvyc69yhx796isn9avj5q")))
   (package
     (name "feedback")
     (version "release_478")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rxkpd1r2p0zqr7ygcv20wrcrn3llvz6wg4y5kymmrz8mb7m78yh")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sjbi4gyjw67dbn3ckg42yqiiizda3fcxh00lp3kqk7kr3s17rns")))
   (package
     (name "frontend")
     (version "release_2942")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jqnpfq01hqr5z1wlrv9q8nbl13772hnzflir8r5sbjpjms3phwk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4039")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18yxbz6a0m2bpw33k53kiz6pyhpmn0hk51jfnj2iswc2y0qlkja4")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13629")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x1af6lal4j2hk8sg307qdwn1xy5cdrsvl1fdc2g64ddvq6v5xzg")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
