...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rcyzqy8sj5x9v0v9441cqzmj0frih9w7xdci6z7dc1awhxp9mbc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kc6npq6s57kc8g6g22iykm4hjajvjkv4x687n7i3yg7vlpw04ak")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "04kww0zv5y7fg7n4w2z1ynl0dqldrn6x9sxiyyb0wqpgrflzbfax")))
   (package
     (name "frontend")
     (version "release_2954")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05djz53c83qf6x4w2q5197x83ci6mcaiskgfik6bmgcvzzb6adil")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "14qsinkisclprdq438z010fhy1g9y5023ry7v40dahrsrcjgwzwx")))
   (package
     (name "static")
     (version "release_2937")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08h9zywgaw8j511v12ncig5x75j9z9i2cjvi96fzwxgki0zi8mq2")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
