...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ggl7xjrwd6hxc5k3y181i3zk73bxfdgdsvjyc0y354is95rmx9j")))
   (package
     (name "calendars")
     (version "release_535")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "108zywk2mgl8nx3g8q3y9ahjjxhs332wrdyf7idvq3j43x8czf60")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13511")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10l7fxkvy07l37b2aa36i0svrk209mwzllckb1qixys49fm9mdbw")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
