   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zgn6jf90f5h6c8v9rq1gs7fmay8f4rrmxvdxmb16nk7d847v56h")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ija1g162vvidq8dw1dr20zly50w209axvv2h9fv270fys8wlhlg")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1snjwnxgncrzifk7n9pamkjayl30yjygmwm20c3kdmnrkzswk7zl")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pwvyzi2wdjmnaj4s341vaa2nzk8s75h3rx4jjh6j7nm2zcnw7np")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vv5ljf57mgddh12q58c50nji991jkbv79m3s6rl3siv1d9i75wy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0aqqfhzzkx4jipk6d9gl6z4s9cp7s7fsshgzq12mr4gcgsh77cpn")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zn8njv9460d6piy7qkjvbc7gqpgif4y0cjjvrswp8rd1b7ljhfr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rxkivfxjd02yc2csiigbdrz3pmzczn5x4x57hm79bcqq8vf4hgi")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14770")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "141crfzn8chnz2ipd0akblsk8xa4cbvjc3rhky134bkqcr5653ra")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
