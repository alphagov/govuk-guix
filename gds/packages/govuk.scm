   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12d7sv37zs2az1cc941fshi5wzrf6j5d0187mq52rav4gaf8nhbl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0929yzpj3x7n1zfd4dcpqa6nc1490mi15bxxn0krkz42imfm68i3")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13467")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cnhy6a2vsm9dxkp0lr6y5vjl9q3fa49yklia23zrzc2cazjsl6s")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
