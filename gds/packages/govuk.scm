...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m3sj1is7hyp9ckjq2grhjk7bir8izp2rfs13gib8k9il2ngssi6")))
   (package
     (name "calculators")
     (version "release_661")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0il2vgbklh7l1qbppv43v19g7201jqba4i9401q7bzkjzf2wccqw")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pryr6rrbd93hj3xij42pm4xad6nza2vyqyrc6fwhjly9hblkrvz")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jq2l054lwh8xl1gqx4xjavrmrrqgczrdjfzzazm2nldrr66x7bb")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05qwc3h460b9y75gs80b8x9sv5af4kd9i352g92maxk8mf6rbw2a")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vz6vxk5i1gy0fq4b7hpxy5cykn51i98cl4n997g5ikf59gbgz5b")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nl42dgcx2aylkvlg4ldgjjg1ncz79kpkva7s77i3ivqdijb1kfb")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mrmw7jimslnw6zb7znp3mfkx7xyhw4fpgnzm01agdpp5gs9381d")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m1sykrn6vzim6rds7chnq06iv8gwggrwl1ms5grgkaaab5nv05p")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nprw0ys54xys85dq5xrcmg4g2cg0dh6imp65ixi3avrh6vcg9ld")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08ma8qq1hr43zl1cq4sm93c74n6v7xgx4i3qd4vzdcx9h609qrmd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jp9sv3amx5x7miplvi4qlhh9halsq0av36jg4qrvlw85wrgfwal")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07awg8l0hg13hs8yyqvcckrg69y3sqvai3kkwgqk6svrzs5dv01i")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s53vwzcpi5kcn9p4ac4wgrp0s794441cmmxqgnz658db86chaav")))
   (package
     (name "feedback")
     (version "release_820")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rg0q8arylrbbgllba42va7gvpyx3khv1238yvkp1acrf4hwrc03")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gq0fr415l37a657brqyzp98jqb7g5paighzamfbkvzlp9h10n9w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00ig50b313348fycrqmfg4k3qbg96acmj3mpnj58s2cnwcy3qig5")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18ikf7c2d8ay1mz9vbsjkcmnqpi2yldqcs4dacv1n81sah487zlc")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1afllsqjb3ibn3vcw99g2gajcs31msipixkl0pc1mgpg1nzys5rg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cpk511p8ahd0rvbi46ari4dm68kjr2nnf1q344l4awfsax5awkh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mv55pk16j21l8q0xplydsvzy4qxrwh65s3m33vggwmxx9rq7x12")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jnwljy1qpb7i570wsyvmvq59dmn39byk70h0yjnmd8mb577glkg")))
   (package
     (name "info-frontend")
     (version "release_489")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04ny1hd2hb711dm6d43yxfnfmr1nv8jcwnr0sklv0f5b1bvgpl5j")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qdqg7bh06ah9irmzz4yd9mk5n474rrdvypasn7h8dbgln4jll4b")))
   (package
     (name "licence-finder")
     (version "release_715")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l61b73ggynl38bp0kjblfvqykh3h9g6j239vb45idxyqk0p8hpa")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a4h8ij0zndwjqdijmjlpr8k57bgg1mhs177g5rmvjm63vs409kv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14mcad1vjmq3zn77rlk7q863gp5azxb8rjgp6l1vmxfbisjac0dg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "1y6nqsax4pcg9ixjfga2ylpql8sb0c99c318qr8y7biij6hqbj87")))
   (package
     (name "release")
     (version "release_585")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pnwiz5z4ph7im6df8k9wq0qhx2yf644s1py5mf9904x7f8dgnsc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "04y816vkw9wkh33ml4zyzc602rvsvjkjdsz8q9kd5vc8xxwar77g")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n48cwf788dz48nvnybsgds109vjzwza6qiv1xpaf732k0gjdc08")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ygmfrlkc6l3n52pmih9xmqlhpnzrs2fbgw1n49qk65jzdqidzhm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03ln4kclky5gpb4kwx3cd4zg8jl3lcv0rplvchyp7rzrn4dq9nvx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vslivgwbfdv8p0jppcxqa50b3j33xnjscn6liiyf2xrc859x8pb")))
   (package
     (name "signon")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vivw8znlbm8g428vwqhksshy223c4hb0zig94zj563sla0nf87i")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x6h1k69b2qljg693p28s5slnbn7bgjzzg3f0z8r2b3jnlgbsdwj")))
   (package
     (name "smart-answers")
     (version "release_4607")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nwnx00nhdz0mfldrj1s0mhancs9i8ny298ivwnf086ryanx5hyf")))
     (build-system rails-build-system)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ildc2l70x6kf4cqrnzx55hkkn87p2bcha3yf0v4j8sq0b8iwy00"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19h8sagzv0y0vkpa5f5jbfjmwsf76bhdbbwa7x7zpbyn369v4dha")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "15yyk6hyyq9dlhbzrjai0fmk63qvzr9mvd962h64yyv46d3mv17x")))
   (package
     (name "transition")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06s0r9fw0sbw1xygk1llyvy6mgwsap8j2zycbxcjn5d7l573zvhb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "063i549nb6zfcy7c1bqjppyz549wg0j94abzgiryc28fwia6cy35")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qm5h0x9ifjjcmrl5lhgyqqrq9q536glpl0p3671h4v4bkx3a7wv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "09n43blw43q615xbqsnq2m1i9g436qr74pkgjmx4xddk43m9nlb1")))
   (package
     (name "whitehall")
     (version "release_14623")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1046him93ccq9vcmb4h0v12ih5y5033rj3gp4dmwzpg0wjymgb34")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
