...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h630nj5v8c2z22pmhpx1vq1x8nkap32lbbdabnvg8cqclkq2das")))
   (package
     (name "calculators")
     (version "release_320")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b70i41rdyqrjssa9mq4sc36mwvaakd813ijg8cjx5r940s55n14")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ga89bssngjzs9wkijsw8rnh8wphjw2pgq7kggp3q21m7kqh5gl9")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iz9ax0l0zdxrrskh62vrqk7rnaalsb0plwx1nlggpjwfsdlr147")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "05yqyj4bmjlcjp4sszzry5hq5vxqcq2af47cr90lvw0cc0ay016l")))
   (package
     (name "smart-answers")
     (version "release_4000")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xsp5lzpdfl2svgs6sx41fp8n0rl0sq7g2ki6aw610b893v2mc0d")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ai5ijwdbhf9bll37g9dv6xgr0yrlf785lcw8cibz9rycyxlpkj8")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13542")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wsf8ypg8839108iz9c9jn51nrm78p7cd5xl3y8p4min92rpcxd9")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
