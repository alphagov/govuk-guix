   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s85ci6q7clhgccnjhdjxxh0d09qiivczid7l82dzvjkkq98rfc0")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h2mq410jg2i1fwcxfjx2rb43l2c08g304gjbs7hdkfgl7v6d07i")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "06chls2z8xnphdg6hkmxca9wndzpbryqvabq20myvadyrfp1jvm1")))
   (package
     (name "collections")
     (version "release_517")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hslqcvmhlsaadqh3irc0x653dw0cadg7hqpynpg9y203qzn1s34")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bb3gi23cayi86ijwmq65pkkkgx6n2wz8vdp8871rqrh104753w3")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ryj8z824r1hp759kcnm8sncs7yqc9l4lf10riaxic90ay3g7wj5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n3zvcnmj7476fz2f76qdxx8mdi5bjf87sliz26jzrjc6d56mvdj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2886")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ncylxi7i99g4x4rkzr9kpyqqr1wpwlmc0r0raqljbyzq06iwy67")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0izb8wg02acmqkp2a2nc3a5ws11gg9db48kyswa0dr4xryklfjgg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "08jl3jpiw3dq3ybpcv53na68p4qshi44i9hccbxgvydwvzib6l0z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sar1blj09f7kcfr8xnplhmi9lj65bxhn63ljdlxv54zgszir11j")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
