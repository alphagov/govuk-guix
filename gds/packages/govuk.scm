...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1llzq3aw85gn0x75xn7mrpvq54l8h5ax3k6zgzdcx6yhddxbrdf8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c9kvz6vhmcf2d1z2g9faa5xxbda96zsigfa1l03x58vd9p77l02")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qd0xfksapg7rr7p8qz9hvqg2jljmn50pllk72hkx54dwjrs16j6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lj9zp77dbw9gzzdjcnp37hr2m4l6az0k0wl0jd680mi4c52s6in")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
