...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1any1gq3q3iy603haakskl127gvx5lh42rrnarjz1i1kx8w7jish")))
   (package
     (name "calendars")
     (version "release_581")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zmyz49hmi7kwa2h531zcdl35ifb1h20ganm7w68k3z517mncc8i")))
     (build-system rails-build-system)
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "08yr0a2plgsigy8x4x90dlg961ynzv746f12v9387m7r0hfpyzri")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09riw730j9l2h55aizzksj1wbki5w5frwg3n982bzsci9pifab2s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "01wxbpkgpy37mbjjvfp0cr9ajfjvgdj7c6mbzlagxmv0i2g7x9l2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yvynljinrkpi1w0ifx7ra8yxd3wnrc68l9f1x43m4a5mgcnxdip")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fl28g7wly52l0msnxzi3a5ysmamgzbhpxr3qxwrkjpgmsa1fhgs")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1682ns0zajsq17z1vr1pjjrxl69290w9p5v9hnwvl4dw9h12xgm1")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "175ls4khqcwyxs6x84l2w7fjxdxw6ymrxjw793kvz21pfdbbwx7w")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i5bx26ln0c4wclnb43b3xj0fs5525141vxkd59zx8sg9ajy089a")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0iji6d00bxhqwvffj6lv2y2a6lmdbq7n17c511an3bc29yh2nqhx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j14b6lh6dxf7m346amv43sckzj8m9pcs1npnq427j24fnp4ng6n")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "187489gfm449n1jz97688fygb1jmrq8w4mw5s9vzm4cr7l5y73f6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "16ndw1ikhwlx5j0nvllb42i1mkva3gxd5qw8gfxndisyvigiz6zb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yjrawwqmzpbdvjcck566im6akjf2qpggvm4r8n3j2bw8mcbx4ap")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bilmsi05n2agziqvf6q6mhwq5yh7x57b0zbf66bcxwc2xw4y51c")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rlpi4hr8qdkxjrp08i2yw958rg3y4rm25qmryycg1d1qxv9q51m")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gxjsmqhx3dn2fs0v2gnx7l4qn1a0ap1fzszy6vqfwba9dn410wh")))
   (package
     (name "smart-answers")
     (version "release_4080")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ac5pdvm7nl9gabb9vgbbnv88321lpr70y56lp5zsjmhnnr1gqlc")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1d7gskdq3dbfk47vlc85z6kmq2kf0iw5zkxdq0k2dj2d99qbmrw3")))
   (package
     (name "static")
     (version "release_2956")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yikb1z1lv74xayyhdcawrj0phddvi44xizbisbrhaimq8rsjh86")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jpm6z4y1r35lg2y0hprmfslc9z0lmdymbaqx4x48y8jbl71z5ad")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gb1k621x62pdjysv15hhi37a2mvjhs1agg9wzyr2xdam71rrjb3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13684")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14ndirnza0kmwypm5v0ppwd00cdmfiaqkql6viz946llrsx8vjnf")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
