   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vchja8g3jx8x5yjndfi27nwrlxacfykcbm3y9v2rlqjr06gaj6v")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hh7sf7nlkw51lvami9pq7d8sacfqmnm80a8ymkaq0f7xhzw86lj")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kq3zfwxw5rxy8akm8ahrph61c8lm81v0x27n8smdyq53hm22ypa")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1id46vd3cigvv7ykc3vf62q6bykcsdhhn54gvsg4cxgqk37gkri4")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1nhdj90vl8plar2r3ndx7lvz44sbjqq4xkl37pcwgbnyhwcqjb08")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13245")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sqpfsfcj0j2js8db4rj98hzc5n700m4hq59xcdqrd7sg7jzns15")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
