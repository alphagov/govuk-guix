   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16n5wzkmhcnbk4sffjp4hhmqnkj8ihwnhqwjmbi57f4yzqqw5fhh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yfxmhfr7b23xmdyzk91iskjh4s12jdm3aq12bc1ccc3lr6xk4cz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11lw3w386p87crf0i937xd7n5grv2gga6rpl7spckl3d018xq1k0")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03x5ddnznwrvzzrjaf7cdvw1qqdm7vv851nvv3ary1rz1i9i5467")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
