   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a8w9l9yc38abiqpi9bp8mcrsllnpf0yjjzifinbw870ff0amwdw")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c38cxbgshsjyzz3f2n85xycv7yzpcdr0p5b75iqk96r1dffdc70")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ib4r9w1yhfampac0rhan890npf98yl7s2a3wlnchbmyik67af7n")))
   (package
     (name "frontend")
     (version "release_2784")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19fziyzr8qdgghg5lvy230gris89fzp4m35alj78i8sdc12niddx")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y5n3kmc58q663y6hacjk3kygc0abncqlpvpakfd7mycmc78g3h8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "15k88rj7vrgkxxq25m4z5wy1a1vyf34pviq293yks3nb7c010afk")))
   (package
     (name "search-admin")
     (version "release_107")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rjhkibar4flcfr1yf0lfdpzyzjli2va0i84q78y4p6f88izp545")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
