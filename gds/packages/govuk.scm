...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fvsbg2yblc7aq42l4rv6cnswvzsjghv91019md14d904vxh2af4")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "12dj62mf7aasb2bxsy7sv9k7gijm18fwlvly0fv28d9gzy57zfj1")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13688")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j03m4prdqi0y7d5kb13i7nlm83psaxs6ghal8wz1fry5ga4yrki")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
