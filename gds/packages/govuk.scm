   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cjfdgcbmn94dk24kr7diqa191h8plj3ga1h46294nwcki277lj3")))
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1lm2p9krn9r6a797awj35n1lsy1rh2dgdckak15w5c0dj6k0p13c")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qy8ylpdgwxnm2vly1x9hwham0q3xhfqpa1a6hf7rgxy2fxdkaim")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13112")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fzyam5p8n7jsrgnc1fwgcrpm53fc7lahbzmqp04798c8nz6g3ww")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
