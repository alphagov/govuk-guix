...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "088nf8ilhxanjd67js9js45aiv7016l4ah8r298imcjfpchijnid")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gbzq8ip4w2rgj1ady24jmgswk7wcxdjmjzmxf4a4365h02yig4r")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "006gmmcnarlwkipf25cyb0hif7sppi94yw3af4n246a1ybijirq4")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rldpybk41h33bm2kmaznvf7q8anm9fmz9w9771g0zisyvp8ly17")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
