...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "04nxsk4f68xw67q56whz4dy4bg5jlylmynr2wkl3cgy7lplfb83k"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pfhipd76z38f3d48xpjv1lgfpdrivgvcyr8wz5v9nhad36sdacl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "13rna408dd69hrwl94m3jvdl0g0dfsqs4yl3p181izj2c4sam2ps")))
   (package
     (name "whitehall")
     (version "release_14862")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pc542j6qs1q9wsp4q5zcqjwdjgv524fj2qkpzb9ms4jd9d5v49b")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
