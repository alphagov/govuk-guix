...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zcf0kcc7db9g2v1vl6j10xz3byswq57nlw8fbypkk4vhhywdcmb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "007dgick795c8bqdb4cjz31va5pzvkavd5hny9imhd1m3zdd3nrg")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qic7b5ndp7fqajkgmclxbx9prh1gfn8gi21qpmzi48igriw58s2")))
   (package
     (name "frontend")
     (version "release_3599")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x3p7fwrxr2bf220chjxfbbkqiq49j0ym7rl5zr66jkk0vkw30qy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "06s3wb6i90s55gpx3bpjapqqznxxccm9c7kk6aivb1zps0apyk50")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rhwaw99jhdzbdc5bhzd368vcdfxxbac9xv7w2vs50yb54y0cark")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
