...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0igfis89sifg89jcamgshdpby6g4vj6fqz5l382fl8s22idnji4z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ikclqz8ici0643j8h0pfwdhk52kwnal2a9v8is2sm37866jrsvy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public policy-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0704n3bif4vn3l838rhzc29yx5psxn0xqri76ghavp2d42vqvgs8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01xd3a1nqnxr1qmri327bzs3n22cgyw8hbqf8xm4v69r9xqbdcnq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r3cn6jxfcf89ahdn5cgs9x8ra1zcfr8m912zfyhgy7p89p8fa42")))
   (package
     (name "publisher")
     (version "release_1990")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f1qqyrld5brqqxjsvfw3x7ldx69ik9drl7s639bfwfpslkvwlps")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mfmlqxhkwn8czn8vavshcmh9wcr8vaj4z7wyixlidcn6rz555r8")))
   (package
     (name "release")
     (version "release_323")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vavd863i77333imj8my5vaksfk927xjyh9nwrn76l4yrbs7gbm4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
