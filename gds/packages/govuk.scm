   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "170hwckg4yx9sgv329pys5gigbafjs6bmdf0dl40s8h38ckxw317")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0768hwni5bxzd4g9lnkg04wskfbif6cdpi2ksrzvz8icg1ixrxl7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "133mxwhwscgh6wlfjkrrizsgysh2f2w909hpg88yyjlk2fa4rwk6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
