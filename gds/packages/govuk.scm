   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pvr8654c4jk8a8l3ln0hqxz3qr0vc20r277nzc96a2ijq4h8vs7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07j31f60j6m80n8c22iwlxblgi8y71r4py4mcs3k2lfjmwi8ic3q")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0glczkxlghgw99cafc0r9mlhbh4w00r9r9n40pysd7mficw6xagm")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hjwdpmj8jkvzivsd3xyjlin08z1mih2fa301a00d196r8gyyglb")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0fh3kyj4fj3gw2in41j17y6an1a35r8dkfs15shd7m1s9ifrg3aq")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1048cwqmsjpimqkd232qq0w30w8qvc1v90bvs4rmdh1m5b1jn4sd")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jda3j3ipv0r1j5ipx05f1cpsm5cfn5d07q888snvi15lvfqqv4z")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13304")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rbk1ah85bxxiqrhna4vzbqp23jlj0hh2xrng64fjjy8z9s7f5dz")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
