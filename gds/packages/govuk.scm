...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0674whx820whyh8fyaclqdwh62j4rsbqsiiigxn5zfmbjnbqgbrl")))
   (package
     (name "collections")
     (version "release_922")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zl5md6paimi0qgnhgl3a5m0rk8haf68s8rl29jr84m2ly9y7m1z")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "14arqmrpmqwb1n2zlb6j0x4xna33rz0y45zlahcm5xx8y1v6hcqy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g8ig0s3fbfwibrvp5664dki1sd20w64r6aj7pfrcq2wnmk9q4ik")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1azs68p04qc5gnsvnsn8kic4d6j60xbcn14an93fiqvw14l6z4sj")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pz8p4jcc75ck09di53c37vqd359dyndp0fa1m8f818vkd54y70h")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "17la8ps18j21ijzbi8400x6lh9ngkcxic4zm63pwmqhvaylc3bn1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nxy45fd003z2bz1by0a09fh4ij27aji8py0p1p7da1q61knm5fd")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1d4a15q3lij9z5fflrbw70s6rz5napbhpdkr15111hkl96znz9yb")))
   (package
     (name "licence-finder")
     (version "release_603")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0plscfv2sfwnpb8x0h34r4jkznwhi86jlza5285w62vfcn7f0yyq")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qy9abxw234zxp973ay8211cafndgh5jib82rkfvl3b57gl0fa41")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kpwwxss38pkqf6jwijak36qdjf40rfw6biqlzac4gkwsbk0a8ad")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2081")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ycqajp0ia5jhmpb2hkrq9999fplpr146frr6398qzjdyxrwsn4m")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rbjdsna4d7wl9nd08pg5jf5v92qp32idz3jipnmms0m7qb3735d"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1awf0hmliphg7l058b8gil7igrwpyi18fm6pkygpzpd5p34n9zgd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "06389b4rs8aq3xgapr4m3fjbblfp3l03hzsavxbyc5xnjjy8abw1")))
   (package
     (name "smart-answers")
     (version "release_4376")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c8dkkfgmpz6fh0c6h901nhi1kvjzzpjw3njnvnvz72v3nbry47z")))
     (build-system rails-build-system)
