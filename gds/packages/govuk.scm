...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0iq58n1clmlb9sd3bj2di9c163n31wj0y1q7znl8h84chwn3jrly")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jc3nwraavvakhd4k8v7yh4arpj7252avdx0pz656sp6ms9nqmvn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bhqa4ckqk76p33qmcm9s284f1x6klnsj28lp6jl52i21my1bii6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03a2ms1rczw6dxx16nrpc8whixg5s9fs7rjh2lz7pfplw3vfjx8d")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
