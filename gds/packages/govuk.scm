   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ml6lky6kgmnq2b3rvfha6fv2gx74q5li73gwh36s3jiqyxbdfdq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gdx7hjx868j8clc6b8g3kag4l9gn3z7rgcilci0awj98dsyhrjv")))
   (package
     (name "content-tagger")
     (version "release_871")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z9kcgcdya3w9q01r1sxxqjgffvy3q9l8sd7p68prfl0fii6yw4q")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "03shy4r0ma98nypssv4nav95q3xld40jkyy7vqfxqz3yzn7zkjb0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b6i9x8wlp49bfdcfcnwr4r4819g21ldvv0icr3gr72mqnpwr2zi")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a3zb3ggdq831l0ixvv3z027vzsdnf6704086vv1paz2xf5ah7q3")))
   (package
     (name "maslow")
     (version "release_344")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04573zbc232j04k6rlaaxmp5qzc50l99bgg2hz3vxph7sf0krd7d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
