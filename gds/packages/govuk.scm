...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "113s76j81ymyr464xbx65hkvwk732cp2b22qxs370ya7fgsdv77z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09lxdwpd7bpimlbyfjf8q8jrxx50rxxik6nc2nkgc0iq31xnynsp")))
     (build-system rails-build-system)
     (arguments
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4631")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19za0m2y5l452c7z297qz28cmj2qkkp9zvzkl2dhxjgq9d38yh3f")))
     (build-system rails-build-system)
