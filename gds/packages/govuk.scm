   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jfasyfg5v9yv2wydgkq0anh6wgg9nb283zc7mnnsrh3n15b6fnb")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1phsq3wag3qwmcyg270h6fhgldpyazb7ab4dwskfirxc5l77hxq2")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q26kx7hqq1wj3fxjmj2bb35dk6zw3j56aigx2bivjqq6fz9ahqs")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15n19jrbfnxdmfjcwwpjp81jcrbdgv6g78jw0m22cm95grz6fxad")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1r4c9w3nz9gpqm1famip74dc3plr0qd29sijgqfxzndq72mpwp9i")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hcxrmym0gnh4dvb1bimhvb7q50hwmyl73m62zl6srdlbpdfsg9h")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hyms5drxw571r43vgfw2b73m609nxk1rsfp4xnwp5dc4mjpyiis")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1649ak83fc8yv9x2b4vjpy65ww7g9k6yjnljlbhh6clazbxcvd22")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3575")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bdpwlkj4ab5x9gx1dvmn0ra9dfhiz88cknm7j116dv7bazyza0q")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2569")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kkrcg63g8j4p85cni97i4qwzaz9iaa9klb7cxh2m0fh2sgpa7h7")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12748")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17pjf3va668jlp65y173gqdixc0aymgvl991rgmhd1vqc906srjq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
