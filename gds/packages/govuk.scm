...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ad3h9cr5q9n31hnbgw6b8wvhzb5k4h25n8y9575nb79f0k31gk4")))
   (package
     (name "collections")
     (version "release_716")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rl8a6ckhsg9nsikyjkxmmaif8hmaq5kz6iwjzl4h2fkn76fm4p5")))
     (build-system rails-build-system)
     (arguments
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1iaavibdiw498rv73sp7zhvm9d2ipc9yr5dbgbrh6gynrqz7q53d")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qy7d4pajinhs1r3i2zvdg1ras3dilq90a0yn010rpxs0rdvr6lk")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
