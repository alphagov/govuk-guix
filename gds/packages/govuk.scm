   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yy19xk2jdynkcz6wmainp8cyvixqsv5g0xchnaks1wysiqi0y7y")))
     (build-system rails-build-system)
...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_2338")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q5qh2ff0hfx3kr57i4lssy1c58w0i75y4r17slff3fzj2n9k153")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0clgiracnc9r80csymc7d2i79nmj4n6s6ciqlljkrmab396nny46")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14859")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "121x4i1s9y3p92ccr7crcc6c6bs2jy8rl3ifd2ywi9a3khx930pi")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
