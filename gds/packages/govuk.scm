...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2803")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "088lc2p912jldk7gsb6zkb069a9ldly26h2hkzk9gpp1s2ksbcns")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m7mddcq7ypd7x8rrwafw6sm349gnx28hl4g8qj9aa7xc6qwqib4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0abf2y1r1iyfj2sy4kk2ajd97qzgq9ddsn6gar3j0m8wl14xggf3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
