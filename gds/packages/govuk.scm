   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "17fxjs65mv1xjm1f3rc1fy716f19nyihxwbds6rfglhd7vl7njmd")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "15rw9pzcp8v8dw2kjlfr3lknhw7a835z236rnijnb1mpj6hcd5f2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07mwas4mpbwvczc2ki72al8q0yjjzrayscx9xdpcn9bq9f50c9gx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j523279jhifm4cgihrh8fias5kb2gq77x1dmimysrz20a28pqa8")))
   (package
     (name "whitehall")
     (version "release_14750")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jzfp84l1r5p4rbbzxq2cg2g0abg25gi3rnxflij9ydb2x8aqydx")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
