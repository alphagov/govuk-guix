...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p98xcnkav1r1dndxh8q4ry4rxks77wing2rvbpcpicv7j6fb58v")))
   (package
     (name "contacts-admin")
     (version "release_598")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wr8s9rrz9c1jydkgakmw342yhqbs0b6z29bqsxxg93s2zvvjlgv")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nc8kzvhqzl77k24spmq73ikj91918f6jw024s3arvsb57snl9fb")))
     (build-system rails-build-system)
     (arguments
