   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yv8rkwzs3dl1r8nz390i6qvnxzlr71a37mkixadk8c3n39z3z0n")))
     (build-system rails-build-system)
     (arguments
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1a5cyzxb4ckav2m2d13qv5sr0l5jcz0l1gfxh5bywqpy7ybrkmzi")))
   (package
     (name "contacts-admin")
     (version "release_744")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f059029z7bm8x79c4a890dsb096qyjhnfah6zpsf7f2w3rhjaj9")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11b2d065y2bij8950v27c7fw2fyb9x5mz5h7kg0r4n1nk8fbkrl3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
