   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fa45r78bbmbp7llgkgnf72yhrccwm7nrhynm0w0h02iwkl4lmcy")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02sg1sfl9hr3hp5pls8kwn7pyihn6rm76c5xmazacw8j6lghsy3r")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xcp854069ryzrvpyqb4264sa9vc64xykfk80jq5kmxinrxiy4ad")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iak2rjzsm6z2rbm76qymgfzpvvmx7d07q2d59ay60ii52w4iq17")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nyilswbwayilplsp0f0a5l771rly3hd4a143h9kq268bdqrk584")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "118gqf2pbpbj67zdqsrzhq4lkc95kgjdn1w7gcq3x7k79y8h233s")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0f52dsqkycc1sa3aws29m0xsr52qfv135hlwk9c8aw7l67pskmfl")))
   (package
     (name "smart-answers")
     (version "release_3909")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f2riagxlg870bv7bznkcmhbwl39f50hajhaha7l10s78mxmzv5b")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1c7z9z07kdkn76wc4pr4nr8d5cn9v51l0i9ga3q50prlpv9fkb95")))
   (package
     (name "whitehall")
     (version "release_13388")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14443h1p2g3gg0hv7gdbbsl1599yl175gf8yzjbvkk0yn2incvnn")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
