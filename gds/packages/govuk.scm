...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0z05f3irblg4l3d2qmj07p1i4hq5qn2rvi97yyjvsjcil5jl4wm9")))
   (package
     (name "calculators")
     (version "release_308")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0173d19mn2k45zbx4jzs9fzf7nm2fi2l9m0gxcalq0wckwn71ji2")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ym2na6vzynlm91l4c08w3c90xbbr63v95b420r44ryzv76bwm2g")))
   (package
     (name "calendars")
     (version "release_530")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h76zia85zfkcn3p4i814c8pzfvfnikqwpzzxs5x2vzxpx38bqqs")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bphcicqzaw6p67q96xamvq68rapb0bv8hmlcr9p3077ynf5pv2l")))
     (build-system rails-build-system)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jf80a51ni1ia9z4f42r5wqnyx821za2n40lpcwcpdvfc2172q3b")))
   (package
     (name "feedback")
     (version "release_442")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08xckn8q1j09dbc9v11d32g5mklz4z9jmq6rqp0zn7lqyln4zhf7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rbs3wcwdrs8g88mnbpbh0iahqwfhp984darq7i5rwbdd1gi9sa5")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jhvfl5xw3yzxfslqsw4g9a9s46wwqr1syx6mpbna7nlhzhmh3x0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0r77w1gs60lnxpzps0cxb2hxmp5v6l6rx5wp02n44h60vw3xgxsf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bg240ar6ikcm4nsw3lj6sq7j2lpqyf01wndqfhfkh7l8dzzpc8i")))
     (build-system rails-build-system)
     (arguments
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1k1vw9ihqjbswcp8yp6akrg1531sxaqikhjvgpn5502n9hpy5vyk")))
   (package
     (name "info-frontend")
     (version "release_165")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cjgsdbg77ipj0q4nrl7c1k5ccpln3cspbpxcrwg9fhg1xcvi6rz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jlimi4ixdfjnriy2csdykmkkkklz3ingy6acbx5amw7pg1rn9ns")))
   (package
     (name "licence-finder")
     (version "release_398")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zia9njr0ch8l7jccqb5d9ysmxcvddxi1x0jhycs9n0cpgfml9iv")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_1979")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lsd589zfacvjp5497ahxhxvw3p5i5givhsz67k61w100kafgni3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ipzqbg6ykbb9z4qqn7dxmynd7l3j6ny0n4387famn1dfjy9v65x")))
   (package
     (name "release")
     (version "release_304")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v6ix88lfk96z839kszwvcz3ywpcyhcgdb2ycpv2ayl28mjl09sm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gi8m17jarsg0l1v07wyqjn7qi78vj5rn5fm0d81kfpvc39d1g5l")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3980")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fs9yqfqxjrjzaf5snyphzivz10qwww733xvzd7w89ahsb1np9bm")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b003d6a61zs9kdxqn6vdzvlcxa466mnmmjlrgrc8n11hg917n87")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13502")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wyxmv1znzirmxiyg2wkw36s9lfg6jncxs4wq5p0q9nsn5wyw6gf")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
