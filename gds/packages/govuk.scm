...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lcgxijx8jcpv4rg84qigd0lxjvx7cax8rccza9xfsw7mascik3y")))
   (package
     (name "calendars")
     (version "release_556")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1czhgwkgmlfykpv53l6lkkgjiw9x9nsb9bd2wh64bxg5qmssiq3x")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1miw8dsiri9j9d5r4253is8zcnbq3m42ll78xgj8937zzljakhb9")))
   (package
     (name "collections")
     (version "release_648")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nq900a0whpk2a09jnhwrj42r46dmhg5b187a3fc20dgf3ga1m30")))
     (build-system rails-build-system)
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xpyz311jr765yxzna20d1qrjdy3cljsabryhbvhghva4pj1fd4l")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hbfflyg4971d458v11csvc1xdlh3l3g7gxqilsdn411q1nzz32n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g2lrji2327wz1lhsk7p7p07lv1rhmxc9zjpml8w6vla4wqny2fj")))
   (package
     (name "feedback")
     (version "release_472")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dr18bhnah536zibj9zb6zbdx72akcsi3srpaypcrndcznhyrq5b")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "17j13lfw312z938z548v46k8gkgg8ncayymb6a087x436djgwal3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01p7xi75xv520589q2rxvw4kn934b39dvaicdk2y9n171zjx27p1")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "0s352r4dzbfjvpj6hasd92kfhv78nznasc4y1y6w95ch9svxgcaw")))
   (package
     (name "imminence")
     (version "release_413")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1izv8fng5kc627irnngqws6vpvgb35azgn933518a2ig0hcci11d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1594481xz1dsb09pcnkvavlknxyf1ijya4h5kvvf5ibb8k604h96")))
   (package
     (name "info-frontend")
     (version "release_192")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wq29axw6076m1pz8f0qg4hvdi17chjq2g1837a4bbyx99ii0330")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ws7fl44c61f8mmax0l6l4k7dajgc5si2gczskhw8bmwzqvc07ms")))
   (package
     (name "licence-finder")
     (version "release_427")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pvfahb9ybxr295bdnh4ikkfvmxwnp7gag9s74akmqra7xifd029")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "11f1jhxjy0f718ha29ff3nih5f7wnfs69qdzpssyvch0zbifaj2z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17ja03i9ws2hf569a35ql1ys88sh47fm3afs7a9vdz5knn4d08gi")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sjw0zsyga6mj5g9cpswd8bh476yby2smf9n10sxydiw2l5wgj04")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06fig841c1n4i1zy3czj5xjvymagvhfzqx7dlxkljrwc7fy1974y")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sv98fyn48zazy5f45fals83aj4ssk98iv05d5raqp9k2g392vi3")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04vb9paixyaan928nncp7knls8sr9jh735aadldawc73mda9mpd3")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
