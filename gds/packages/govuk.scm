   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n5n0xvy2xx3fdy3rgh8acn7p1qrywnx7xnk0kqxpsqkz8asix0x")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sy1ak9z17js31d18d2mhj62wimg1pjqq9wskcicz7p2h5rp1kmq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "072wfamv14h5fzx8z70bnd8gj03z41iylw4i20nl2y8g721xwirv")))
   (package
     (name "whitehall")
     (version "release_12764")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11kzi6fiykbmrx5yrg8wfqrslbq2pjmb11rpr11d8wq3dspjvnql")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
