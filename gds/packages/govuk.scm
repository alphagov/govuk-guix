...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1403k5gg1wpcglfjmwdhnrg1dvf727s63gjawdkrgj1b41y3bc0l")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hyi7hh92ymj2yaz4wws23754y9chbdvc6di49vnsyisfzcb32qr")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14625")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dbmic253hy7zkksi60ipz2pcaj58xcgrznwb83himf334xz1i96")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
