...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g768mays9r2w7hl973xqs5yxr4jhyjplqvxva3ilywdmlywh6ix")))
   (package
     (name "calculators")
     (version "release_411")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "188fqmyn6j2whl2q7mwasg8r0hk1qc3ljz1k5vf7kdydh4vzy2d5")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16wysnnfm0ha1hh14mwpqcjxjnfqgsn2hvc2yal7fy89pfldn5qk")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09gyq7znbwrzvsv8mbglqlffz27xm6i10v79wrkadmbyvl3sn3wb")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hhmzz1r6k5vvcc9xhxs4vc9ipj5p4c5c4pyj3pkmczm3gx7vi58")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hmwq1wmi0fjbnppxkpfznbwkkla0kkcjrqdvsyi6bfsq3yjaif8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sb9ls7cfphm27v0d5yjs0n26ly5c4hx65i5z22bgrfc5p3f3f1j")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02g1pjdvmfh1gkvhk5f4i2f42201aayaqp8q4wgr4l0bgh15zsbk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13839")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0si9zg6ibxxfkgzv2cydsdbmg6948b6ys4x1q13y1ia8h4ag2bdr")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
