   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0aill00x8n0s6fk12phyrwmwh0n01cv6h8cv8zsp977wx4gaw6qy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "147fxl717jcmmk67wg5alblqr8wnl46dxlgwnj0i8965lgsliywx")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n0av37smpjr7nd6zv3y8y4mijzp2kcrz9g75h6k5fg1kyqwp8zx")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v3abbpcpx1s7wrsgl7i418p8a2p1s503dfy2pa4zqw57bhar1p4")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00k848nc8v73kwczy83shzrfs26qvvakxrvkbb8xvan61mzwqc64")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05dg6fsgfwbx9cjksr2kf8x9wy48b0wky4sqz30z7g0pp47diifn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13313")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qb0snawnn3qzj1c3lnbj9y5kv2xf9bhlknz8n0l4dzpjna812xc")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
