...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "01ixb27f6nyhywapa9mbp25phs3crdqqn8qlxd4310023ym7a2wy")))
   (package
     (name "collections")
     (version "release_812")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jcw2azax5w93iw6kw3sphrxq2lbwg903l934zzjq0lkp5cgqzrz")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n0j4h4400cvhg2kdxvllxvwqwq145ffsmibgj39h0gwl1k6znvf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vr4v64mipbkl169iyl5cfkd2nijqlx26fvgrpmf405ra857iv6j")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wr4kdlvc8bhg4ppgrsb6cscxqj473p76rnhyc47sdwf5rv74dgd")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r3h8mqmb0hmjs36farcld3ri6fmmdw0zggxnjkvplc8n6h666lg")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "02mvv1d8wn27q2hxpwq9gxvdrm00jp8m0nylqwzhgvb9dbzwyzkv")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jzbd3zf9n0l7v10346xjb2iflq9x99h5lv00028pq1x75bmabmx")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b9lj16s331c57mg2jyfxy3v5jb0wg0b7si0y74xkdsnmylhs2zm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "07ak9142gbb8rz5wyy21whx51s17lbx8kk4xd9wj3040d5adal6r")))
   (package
     (name "whitehall")
     (version "release_13926")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mq764agbii46m9i492gk0hzhrl6ja4r6kl4bhrd9wxc4d9d36gb")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
