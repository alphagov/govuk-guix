...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1a8gyck0174xdm529y8cfj2hqmfbdkziv21ysf6lfibaald0ppi0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0znf176wwfhrphkrkyg79hlcc88m96awx0b3iqn8h5yx23cn26ss")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cra3va0wgak75rw51f609yhczrz756j94mfyv79w4fi1ygb2dfp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10bcxgmxbz7817qca4fh0b0mlb7ndw1as1xz88jpns380f0x9ss3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "02bl6x67fj9h76whpv11wwnqb3n0b05gviwhsnqpp7sxlwshrpci")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cwg7rkqpjm6dkmwggsv1xwqlb3c1gwvc7fb4jy51zbhqga3z9zr")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x383zygl7g4pa4077i6njb4py5jniyayxzzvrqcmzf5lr1y6sk5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "042zdm49rlkk4zv6rfpracf362id0yp7d3705fh5vbvvik8si8nd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05vclskk0prdi1nn4fggjllqg329c35gwj0zd2qqgz3z8gn16ghj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p4m5x9wf877r1wbdgnx3gchj93zvkmj1klr6fdlzlwcyv01zbcg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jw9104dyfjhix36zy11b6qsr8yaq2nb7vqvrbfsjgmmkx2cv8n5")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vb6ffq0vxhbbk5wzx9c52banlfi22jg5ip1vxdbdbsqijab70al")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "05fv0ilv9qc2gj6z4q78v44simwzggpwvnbq1gr6h4nc3ylzw72a")))
   (package
     (name "transition")
     (version "release_803")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hq0633121z3hdl04ch9ayd7ljiknh3xvb103jhg7n7vs3l5rq78")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
