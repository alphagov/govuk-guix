...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vnq58jjwcij16018clqrv8kl8779vg5s2ay532amwl13fjx4h26")))
   (package
     (name "calculators")
     (version "release_675")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18zfhvjgyaikvr47xj39xnrhr6g6a96p0afzqp7kdh6lj1lwcb6z")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "105d0qd6v40lvp66g1id5f8cfn0a80m9bzws6mj4cp3mpn1wmxni")))
   (package
     (name "calendars")
     (version "release_898")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bf5gxnqwrk5si6n7a7c2n8216005i56dikz0y14bch8kgcv10kr")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i7nnw8h2ngm0x6hiqh0j8fldn5wcm10abkpll6f5z0n0lnhvx7j")))
     (build-system rails-build-system)
     (arguments
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0r0631v2s4459s6z7h8a7ic2nwnbr3iqxfsax2dqfy8jh1b1lcki")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "05ffzaxwmrz4vg87k9k69q7nm0ws9jxljfyqfj1xqrqfx7b43jm1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10d27m01x8f7vw92gqirvgxsaia9mmi52jmxkmy9l20wisafg6k7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "11rp6z89wqmcccagnl6jfp7z3178lw1z3622pz6wv8vdliw1pxjh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r8bl5ikrzx2xsdksja1i87xws58wsznvn3qfzcjrj5d45i6frfi")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nhlasa4zrfff4ys6my5wx8014l84x02ld7ab98i3cfqs4fw2jn4")))
   (package
     (name "smart-answers")
     (version "release_4638")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08ja2q6vds5bjw3j2xhbvazrvwxxk0im000nvyg8jsd1lhs79d2c")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bpsmfpl1h9p579ffmmxbz93ahz475r7mnyrjjzc5gj2yyj4zham")))
   (package
     (name "static")
     (version "release_3450")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a9vyyfkp6mqfmnk98hhg45r5lqmw54803gyfxzla4l47b7icz42")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
