  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1ndi81v7b3cjy51jrjnd8dqm50qbxri3bwd10rxm308nprdsng9v")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mq129np2ij9q6p1h7r98ankrqy2pia236hifzpwym7kyyx6rcaj")))
   (package
     (name "whitehall")
     (version "release_13438")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gqqbxmg0j9m5ycwd8j8bvva48d8qxndbwhzp5642a1415nxnjdl")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
