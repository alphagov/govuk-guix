   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05svfpsdbip9x3zk934sijkikxvngf9rycygp8xck5icsni8jz2j")))
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n78x55i07w5yfd8vwmzzj9xbgz3lcd87lki1qfjcrf2lpqip9p4")))
   (package
     (name "content-store")
     (version "release_788")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1631zm5ri7jvsmmkxq45z2wlslw3gr0qb8sjr77fz0b621a9x4qa")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1spbv8h1p86arxhsckyxxn7dbip6v3bsjx0ss0cz0a93dl1mbsh1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
