...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hikswyc0g7qbizqypq950qdpn3a9lll04vy4xkbiq1gxgb0qzq1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04wffhkb5whcb653qvgaysrxc1sq3pcdb0akmnc5jds8mdyr1snw")))
     (build-system rails-build-system)
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j4w0ivrbl1ypqn3fjyz6b8slcvbwaxlv8nm26hlyqrlzr19assb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10mcphgf09vaw3286fqykn3d73ynxpxa3h4bk7al1yxzhj4bn0dr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "10prcz2d3km51c3pdpp1vrhv53nbrx0nlf5wps5p020yppbc4wsl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07hla0pgfhc1hbb3c12i5nx4fz1b8ppaj61jf4wrls5ajqgzkyc8")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jw7flgagh4l9gp3ncyyxqmha7f90rjpd8qw0zci1zr25ww2rvnn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
