   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g03km8mp899b9740m43c3i12ijb6i24z15yfrdwmmsmkz775p69")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "10kdzipd4jplgv577qmbsr0z4acbzxfjbh68l84g9i80xcrvni8m")))
   (package
     (name "content-store")
     (version "release_704")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01rm6ydc82khfbs1gp0f6qc2c4wid9m8nnx9jbp117n123cnidqa")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qgv2xhd03irinc3qdinj8cxzs7x61r1ja0l9bk6r3c4az8v0n10")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p39nwxjv6z5rcby8d0xd296a93jlfd4y6fyca6lz3a6xg153bfd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00a6l5jam7phxj3irjj16ij0pswrbayv4cspzqbwj8zi3rrbikmj")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "16d2s4d30l08y8x7xhwqddr3lk4jnn2264ag7s4xh6xg0bn4v9ys")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g88vm5qp9xqjamxrgpsq0f3yriqwihj50n2kx1ir91y6ga7b45c")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n0972zaycvlm6m17fw6f03cshdv15l8wxbfq1zb6x2bp6nl0b0s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "05q3ab7m8rysmv61gsaw13i2w90k0zg4nhn4cfmgsspn1zs764f7")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0l0646a70n7bv2l13d2cv84r4w274iihm46harici3943kznr2pq")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x8hqfyqam17g3675464zkj01b28n2lpyl2ysaivp9vjqakbnhxn")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lza4g8qx7rqwhbk5k4pwm2jm70fmrv2p4js3hrfckr3hj0kl50j"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gyv14zzd91f8y2rgpxga813xx990i3nv24p7d0krxhmipqashca")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3834")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mb54008imy4ndrlxx2bqjvdps38zk5dxr68qd3jcg6i8g9xwkdz")))
     (build-system rails-build-system)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yk39jbm20dcnvrdnwjry36v4slg4pmzsj7nc20rrwwcn5ckj4w9"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10zkpg0l39xwy90w1klhhdmyckcwh6x8f54phqvr1j9cw4a7cwlp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yl01nq8vgdz88ahkw4iinln8xkwf3ngv68bh9ayn6yg599mi5d3")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cn87n7r0ir387m3yakwqsnpp4fqr97rhsm5f715mjcqdjajb1c4")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kjya7n8ycb0k1lg1qnjhalnbcmzkm17ayz4xx438i9ms433k8fg")))
   (package
     (name "transition")
     (version "release_830")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gh2kb4sxx1swkw51czd53v6cib9lmy2jq54vna7797b3kvkh9yd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x3d95xrr0k5zwnk0csdj9s9cll0lv81nii6hq55ag5h5xabfyba")))
   (package
     (name "whitehall")
     (version "release_13219")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bqvrx1kv3fnq6j9f8vhg5isw7s5vfwnfdyckyk0bzvq9rapnq8b")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
