...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nns00mx7i9lpw7y6bsazjp0vmi0srajqvrfn1h7r3ixcvqk863r")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rgqb1dyjal36mndwmj33rrv29fc3iqrj2v52yhgx0bxpbb0p1dp")))
     (build-system rails-build-system)
     (native-inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h3fg71iv1dh0zpvhqsng7vsvsc94gkdk75kn6crq09xbppq1cbc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1svbv0ycxmg85qq9c5lhf3zx6yhhglrd74dr7848lpx5yr8j2p2p")))
     (build-system rails-build-system)
     (arguments
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2078")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05188d9c249a2m1mpv2zn1sp9i10rzndpvdsnlx8mj9lm5l6kwnn")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
