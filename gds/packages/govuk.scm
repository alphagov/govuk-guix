...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dhbicmrf0s8j1cd8yvika19shizsy2gvb4rd99fwg2py34p94fx")))
   (package
     (name "calculators")
     (version "release_470")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jinqbf064wqwca0793a8lkh869wx7arfi1wrmkjni6j2naqw2k2")))
     (build-system rails-build-system)
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "167hb50pgws217r2y5yrvglbdidjy2rbiv8bbydc0ydabgv9mz2i")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yfn55pijbj783nkb2ddl5m6abcils7bh6zxi2np8qsfzpvhhxjn")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1y13m0v3zp0477x6rdx6w8w5gj0is8g9x7bj1n7ckdh66x11vmnk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wzsk60sd9llyvyhqj7b689brqbkhlkskd643s47aaw6v0x03ll4")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0drq10vdr7il6d6syqz6b86h9c52mkfryybwx4kjfy99z93z9asa")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p10hmdh4m6c59jfbl079n9zd22rc2cccczbilj61v9qs7fqszp3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cpkw7hw8dmlz3hvfb801qyn3hmp432mkffazfgzncypiq75p45m")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "14njmyslipfjwyjcx5kb746dy7vqkqiy8hbcsf4a46wlmwrnd6sk")))
   (package
     (name "feedback")
     (version "release_641")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "038i8g5ai1nm41632v4b2dfwl9mqn4k3rfdgz4w2j0hfzqpazww4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wa54yg24nqm1i8p63y438cx66zj71ig7m50n2zrzgbs30xlvc4l")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bjwlwmm1qgnh6ypswxv09z5qm5wxqjabsxl1mq3zvif7qzsls2s")))
   (package
     (name "info-frontend")
     (version "release_332")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03qma6wys6zd2igvr7hnswp23n2mf8hgy92vqx3bhkag5jwwxj5j")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j2sc1b055zaf2i61a23pq6wx9hbxdva6layv62x7zz8gy0f2zlm")))
   (package
     (name "licence-finder")
     (version "release_562")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zjvky9irl3rpbkx09nsrhs1zbzyz0ajqidc2bvivg0fl20pz33s")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1d1jv01zgkswg4mfndafxyn34i9lsfz1cg758q1lrnm4hwniibjk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vd94xq391ksqfjsykzwii6is3c8kyphxjr1351mz30f6p6bp510")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l9gd6vmn94nv27g44fn2ghi45vlz0jxsi8f13906jxxynbhkmhq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h97lnipbhs9f4lnhi4kidlv7nqqkdbh6vwbwgamzkhpbz0z7620")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
