...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18jpvr51k0bnhlj7f2fd7y18dck6jszky6wdlw4rh89fjb1vy4ll")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03c5vriw8ahf2ccpjjrrpf5s4x1gryhg47fd9s5lnk44bbp7brgv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q7bc2b1x50pmrhl7k3p1lpgrrc4sml810w72zx61lm3z21mxqap")))
   (package
     (name "publishing-api")
     (version "release_998")
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0jvrkwia9fixsysa4cybhl2d7n40mdsyf8l55hglb4465vxbm4rd")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "099bv6smi86q3hbb5vq428njaxsnamh19vkfkglmdi8prlv3i03a")))
   (package
     (name "static")
     (version "release_2662")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zpg152aypjrbd5dl4wx79vrynwii6kkmny6i30b3jjsa2qrrm97")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
