...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2760")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10slcia24b1azv3vqfxr6jmc2j1bwasbp3rvn036psskr1gdb7ga")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zsnrfg46q3ifgcfs7gjgjp6vchdxmsp73ss5baivz3p1zlxjsdc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3786")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kqkwsll0dkrgqas4lkm49njn1wpv60l04i6dwajpmi3jwbx4waq")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
