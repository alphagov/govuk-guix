   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1plk75jjc9qv4nbic7amf0l6q86w2yj9c9s513frzjycr1mk6p1l")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z0rlhgyb8dwnr3wr0qksgsyglhk3vaw4ijckynqpz722y204s2p")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3839")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kq74mcdqa3qaxvwg3yfkwjy0p7ax69x6792mn6s5p0axfw0mm3v")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10nh1ppf46xi7cfgfllx9790jkm2chxfb3dic2qkd34qnapkd3np")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
