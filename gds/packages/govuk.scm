...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wvps1kspvq2mqvm6fbrnl13s3p9wa2p3m0vic0z84mm9x7a5qz2")))
   (package
     (name "collections")
     (version "release_897")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11slq4a9zr1rnn64minyxp3sq34xj9hkc4r31bldgnhkqn1h27wc")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wnnzr9728fv4d3n3walbgczkjrmfgykax99nhpc0p223f2679p6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rqah9z7lxx3iw6h846iy052xms2iiw16g8a756wf25y45q3hjnw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sjpv1a2960gw7camvzzdwdh6plm1w3zw0j5cjs6pfj5i91fsq1w")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "074320xwki4xb4czpiadyr3d5v43qkf55lp0l24ims94phd2ac14")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w7i03dh4z19dz69vah53krnp810p79n0h19l3gfbsgxa57jj0a5")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "051y3arw4q8p5slbzn2g0dvp8ahq7dx4fk8vdjafj7cyn2hnh3nn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06dyl608zxb1jhsf65x3aawaccxda43dqqxr6n1804wak2cl3kj1")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14073")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1282pr1dxfh11scnby0nn2zl0mzcmh0j9wyqjjnif9f19572zq1h")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
