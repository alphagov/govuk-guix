   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wymmjh99p12icvr3z1zyjk1iwxcgrs0dyjhk83h4c533nca5q8q")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "14kg8l6vlysh5q51kdm6c10sc4mia6v9ljgx91k1lyb2dnqm31mw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s1rc1389ikbsvapm0siazi0wdjamd1nkrcp9zm69dk5m88vpghp")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0an0m70jqnbj8n3107c947bybk6jnk3r9kp01kcjdhvrdjb2ahd5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04y1qc7rrmwss5mb4qnyvzjk9xkh400xa042yb1h6pqzl5np0qgy")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xkz0vs8h2fjkd1qy2v59xxvanrm6zrym41a2wbsd78gwpsyzjr5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mnad2a7l9ljdiwpy04zmbjcr10khapvj38lnmiz2hhkgkpi1pxs")))
   (package
     (name "info-frontend")
     (version "release_305")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m2jrx0ypzbl06q48v84y40zcd3g86hzcig09n7w28s9rgscwhml")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
