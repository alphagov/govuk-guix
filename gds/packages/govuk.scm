...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1y1kh5yz1dc4l4rp9n7hp094cp3csdh0bfm9k0asbwaf0n07x8fi")))
   (package
     (name "calculators")
     (version "release_208")
     (source
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1z54vgmmlh9b9wabqbsjxnb21chbc8rs1p1261c6cmxd1g58yfpf")))
   (package
     (name "calendars")
     (version "release_432")
     (source
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dl099mc2m3cgl868mgkxbsxgm9fj5qhn3a2rjk33n2hfsd534vm")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1npn9185z5a6ns8439ji8a0qqxy85k7hg108h3d5bg9csvbinksm")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dmlrddva4xli77m8hrqn885srz4fhgnxgc4z2lvc79fa35rj57d")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p2bmjl9m4286zzv5rnhjjjrwaidphzxihnsnkha5rxnilb88ksk")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "17iz3c3dh5xfm2cpl8wzh4dzicw8ybxfiv509ahxf5713b30s6ib")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xx9574by1mmj3plngp6g7m5k207q6jhns0l8n2b2hhvkr04fmck")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08lkgqy4yq6ka4qaq450agmp95n9wqxaxbxx5xb7gd2i7cmlv0qy")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hs4drkzh9jcywvnq8gk6a119ky74s219572j59mi31493ss4nca"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05is2m7gb6f23x79ig0bhiff2fwapzcbii3x4xl5vxy2blfjilrk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xfshxjwfbldiy247qppi4pmnkcfhijrc4jyynxz0mxx51lirm9f")))
   (package
     (name "whitehall")
     (version "release_13101")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gj2wzzcwcscais8j6kagvj4yi1rc77x9029vkxrckc85mp4yx6i")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
