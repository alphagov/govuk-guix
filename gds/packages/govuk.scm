   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z5cf0rk6zgp9nyq240sd65g9k280av6b5lyh7pcgw4hd51l6w1m")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1acklq57rm2yl89x6rqq3fnpr6477ilr9z9b9s41qlkkyxcxjmz7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2571")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i9vm6iyjw6ws80iw3j3ka0l9cjfly3z07lsqhpshg64dychm8vk")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12751")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13zv3wi8mxlkqxkfngpl7hh3ipssc81ph7bmp07gcakjag1791d3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
