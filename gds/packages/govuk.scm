   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wzq0i9b926ijqzcg1l2c9r0jd4hjd4k1jqp1f8a9ymzd6l2f6kd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g8s483g6qa64zrbzbzw66acpfir761xgixh9axh59ymigp47sk7")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09z6gs53c2zcpl67x3qzc9yrbimdg7r7b80bncjhj0dlidb2vmf9")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13075")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r2cl35x6dmyjb9nnwbnpws13hhbp9hq086cc8ql6xain0s98s78")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
