   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gy3mlckj0fgncsk1zn3a6i31gxxz0gv2pzlpkh1c8i89pfri82p")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3862")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k13vrg6rz9wi7a9mlmqaybrvz5rsiqr415vpjmd0drvi5d1479l")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lg39s92f9mkpln15cdqy7gb5fass20y9la57w43nflg8p2v73bx")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
