...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ds5wfppsnng0l39jvn5jg05rix08dngxsldvqxar2pq37zlirzn")))
   (package
     (name "content-tagger")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jf3gfwyis2a55mfvw89yf1bbv9a7qqg0nkjpnvhvran6i15sjm7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cdasizkqk0q6vvb12903ksmwfwgq1mf4fimxg43bkq3bc3f49i7")))
   (package
     (name "feedback")
     (version "release_884")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00xisfdh28fbi8bks532wd08635jl2av8pd7c79w88hp00snjf9i")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
