   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07anqcnmnp6z3nc2zj8hb26szc82ha2sxc2al8xy5rvqiz1b19rw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p2vy9pq9q7s8w50si7n6pqawvzk9xd34x053ahqliv3j931p0dl")))
   (package
     (name "feedback")
     (version "release_562")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r865hixbs5s36r9k4lcng1fks3d859p47p7h4qbpwm662ach1ca")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1r0ixgdbfwpngwapymsp9kf54vi7a8i8w0w426brycjwxzc5xdhw")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "09p7jg72i6yv86r4glx6nq7f9j7svy7hi51bw6sa9wply25p0mc6")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "19rwgx1xd9m423p59pkznz0qgjxrq8n1yavx762fch84si5yr8wr")))
   (package
     (name "static")
     (version "release_3013")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17ydr78ybyj0sa7561hd9wdr98czv2ai7a1n335bsd1259122j0l")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
