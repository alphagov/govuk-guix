   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15nxgfv14zvfr24q03s4mk5i6g8vflmz8zrfrmc54idbzwspmprf")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0q61ylm26iw3jypf71cmyjs5f7fhy1g3cj9qd5z37xqp9kcl08hm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xljsh7s09iwl8znqh3f9blyrlsq2mp1scmix45l633n3vsw4cjs")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
