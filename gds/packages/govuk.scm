...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j55mja5cmgwil2v72c9pf4cxwlgi0d5lxwz42nccp3c6p8k52xp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fj9b22shx9ja8nmdk2c7hvr6slplzfv6rxjyyxhm97s355h006z")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1i6yxr1dmkjsfm38q5yadfp5n49r0vi29wmirl3kcvb9fqrqqm9i")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10qzrck5k7azh58sf92vf0q1ik6bsxnha7ih0qxcx7m0wc307ss3")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4336")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01ib7gc8jss4qnjhrj88ygpl8chlzswxw1hp1rws2mqzkv9l9wgz")))
     (build-system rails-build-system)
