   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hwyy2g061ssb9dvhf89prlfsqvkcz701nk20kbksx7k4apldmq0")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z16spylp4s1l7lx7p6v11fi3yjq92r189hyf1h197h52xwmdjlh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hrch5bbv75n87j8l4qi2vkcsimdg7nifq0vfr93irrgbjppi8n4")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0na2ij5xx0k4i94hv6j2zqc57r2jgvaqc0yslmgp5iy4ilr2xjcj")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rasq9jhalk16kw8xjpcwqbghka7vrrsrhd08ram1zlcpp269kd7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "174h143b60fnpkaksbqc1pc7dy4gny182h5khw4lq582crcy0k9a")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ajil8vzip0x054d06pwzg9dw7lk5vaqbx3rx5rhizb9368f7ybp")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gh0w10n7wyk1d4q7bsgg2v8fj5k51bhadh3lq3c3mid2gnr0snd")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sm5ysqglxllwdjfpfv1psmfvs4fsa3qrfw2bvgfqwpmxybq2806")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2735")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ahs8n88w66dszsrzlbzahsm4db90pmhkdcbfxgnmmxg345ymmv7")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "148daxnikshz5pgz5p78frpk8m9a7v8gw15zq3ha8ms8c7id905q")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wvfr9msc0s4n10qaf9azag49619jb87gpifi8qi5d0v6fpxp2nb")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j61ykvqngcb7bkh6az1i3s7r6x62ryyx7d7nbk2j7icksjwmj6h")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s7ivmn0x399v6kjhwk0gs6jgsb5m89bi171gkg04506hzap6vc2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3764")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l86gcj7icx1vmzk5vrj69v5bgy0d18wsssd0f1m24zc4l79ycbh")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2698")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02sml64nm5rb9zv1ky76cszl165macn13brk3kc3bv2l2bqlzdjd")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jw788lwncfmcqpwfds25zgnnbcckchy6hkfy7pvavsg2s1ir525")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13053")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03w1yj5xdqbqssb5r6nrl2da7yhjvylv8ds4fwwwjs1m2brm577h")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
