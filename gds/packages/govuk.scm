   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wql6ks9zkn4zf865dh9ncjp8gpnzmm5jbzzfk1ilyqzicwmz39d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v5pbryij9vf74x5j700w6djs06bqx4qybz5pjjm8sx9m7zgdzw8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rcb7l6py27iqv0pdl5xy2xyr7rs0girb4mwyb7dqwmg2x519ync")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18v6nns6mkn722hrsnl6gcx9zbq0j8zdmzh76ddxvw0s0dzxb66p")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x6cnpb7w2m3azzgvpiy1klx243iv7ljglnzmjqzi2h7pv2yzj9l")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g3c19s2bingg7sjjyrykazw0zk2rm0qp799hnrydgmsig1s5sqj")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v8biwz11v04afzb10w52il0wjqqjxglxmcbgqpb22b1cfgf6nc1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fgq3x3ma0743zhwl6anp7da0y3lb4429w6w98nawradgpscjvf2")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xg7dqnxhq7bwirxrqikcfd3nn141ip50rkwi0j2bgc4j3fgj2sl")))
   (package
     (name "search-api")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b4jx027j97y3n5m2c1qi44vdrcv5p3w9hbwwf7z9hn0zksgnf8m")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fzqlbwqn0svwxhpw4vh9cf46xqqqr59l0l884q10krvapnjdwsk"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qg9c8mayk8wz05qhhh2azhkgp00ljln4zzx3bzgrx0xjdp05bp1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pj3fvwf7if6z8mf61b9bsbyxwwcwjix83h6mwxdb3jf5g1in6mn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i6l51c70adddglwz02mwph96jhlnc04dbws5piz9h6v1rvyhklc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14294")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xwsxlyi9z5qxq7fkg5v57kibr82r5vpfc3yi3vb2vpa65cqhask")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
