...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1apwm91ps21fnpc2vg5zj2rjy1xn8mkp5ahl0ji5xddnf9f63li3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sv62qpqqjni9cly9rc3z1d9rvm18hzqm8c30h96yj4br6qz171x")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "069177qn5q1y1h9fxkqq3kic7rh3508xj4pxyf5rwdbch8srxfxb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1kzl2l17vhbs2lsrn7z2yrliv2hbr07jkx0cb3wr1xlix9h1hqhz")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0yf0y9nh1ks156mkml3idjvff20ycnghx8g4m7c16xnc3sxgf25m")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3633")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02smanz8k4i0xhbax4123330zdvdjljkkfsjv0qcn1ds770nfxl2")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12848")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jaik9v56781wkf6r2fzidsxyc6f9fs6200b3d1y4dmjr2hyy991")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
