...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2554")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14n9ww178sdcc2vv8iw1prg853fs97qaz2c3s918v7jwl5lyllwb")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12732")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d22dlqza43s00swnzki6n60aqgp5yjailn822igqmncy5b0xyjl")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
