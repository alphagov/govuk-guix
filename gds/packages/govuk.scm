   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1md5v01x4d9d1d7qdfa9dh5j9qxsxb7xzmxqlvd9l60m8f0msg36")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "131fg3kb7ag7wc2rln5fp87ggx24gwgq2l6s5zkmycgvqrm0ckmp")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zsfmbjq7nj8d48dbm48h9cddpgsfjbd970vq0wqid8r4bx5bq08")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2703")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kcxd717lncvxmdq21cx1baajn3lfvmdvx6kjlfz9axzxcmp295l")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
