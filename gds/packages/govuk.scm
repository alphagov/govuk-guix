   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gfnw3lkqnrdvd632b51swfs8zyi5xnpall10dy09pbz0qd1iqvy")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q7mpxzkhzw97i6mv21c6fq517s41j5lf54j1zj74masckqsb4qv")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hh0yc1jbgsgrf5dz2d6ccjrvjlx61hsshqafz6gr4snjxxa14rp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3857")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mgw3mbjn3wf2s14hh84py8aignhazmqqd306xvgwvk79mhkcyc3")))
     (build-system rails-build-system)
