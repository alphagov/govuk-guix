...
(define-public bouncer
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jz8qh2nz6vnlcdgwr9csv8c8xj12h71rxrnya1nfrlbxgr7ig98")))
   (package
     (name "bouncer")
     (version "release_250")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15amaz3ln9s1v15mgqfia68lzzlpxmfqxya2h847v172hjfajq73")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f))
...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f0sf08nlrc3spz9vmz5fmagyyk7qwqm50bp4hwg22wfixwq4as1")))
   (package
     (name "calculators")
     (version "release_469")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mlr9a4pajwlkdrp9a4qs3hg311rn01mdnj8sv73vfkr86yswl2p")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1aqg67a9k5p2s9n0ahv6ymnwjw52jxyarrm1sg54siv7h5v54v9r")))
   (package
     (name "calendars")
     (version "release_705")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lsfg1szgqz0gzjc2fwwwcf35x0lbphcd44njwv812k704bcwarc")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "120ikzpx1sdn284qn6jjlxql170l7w1qzxnrqmv4cmvizzxg8d8s")))
   (package
     (name "collections")
     (version "release_864")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sbmrrvdyngcry654xyb501jgwyhp4fpf73xlfszdil1z6q4qsmh")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zx82psh7rv40shxyac2qpg5n42w5fgm7llm36zn5k2xn4mrdxyz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08gvmyigf60953592jhy7bq9xl1ybmswkn21pa9x7zc7ap62jk0k")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "07ylvigd1vbznazkm2zxflim06azbdaiaplvihh52p3kjfzmm4ax")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y43cn5mz5yzfg4sgyiavj5fb1mam74zkhxny19d7kp40irhk05f")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fvvcp6qmpimrywk2b584nqaz6a777dm4f9srmgbr8bcnrqkmhbr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "076xw8xfv6qb3gbrc4h0lavlscs4z9ca9chgj4paayg71vladmaw")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nfqmwx5fds127ifzd4cdmgqy5l53syjz5xcpl71x09845jzwbps")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gib6wdxry6fm6ir8gl7zpz1xccxvbq3838mnnwx42qrkqrr8f1x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14ldn6pahlaqnkvr21s0pdgdrlmn3jyk2n1vczxm56mlg0qipvai")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dgpnmcy9nb61y3vrz4876fsqs3qj93vnvbjvpqp83vpwc56qx5x")))
   (package
     (name "feedback")
     (version "release_640")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p810dxx29vbyvhp5gjsfmw5qsapkisvbnqhq5blbbbkhi1jsk8k")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18gmp9a0vb39d269chbhndjy7hz7iq5afzzhdk24gs1nz43qf80z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13dlfb5rb8rkvwqph8aqpwr1dznj6advm497g0g665wxi6azbikf")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p994hdgadbzhnsina7g1z2k6mzqng5i0045s36nlcszzy1q5kaz")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x2pvh0zm6d55iny1r4rzn5z600m6wmz4q4qa42620gwalbrz8kx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g4a5lqpva79xj23b3w70x19g5dgpiyl46kcfa5abnm9cn8imy6z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ai85m99fvdgb23zvnf0aj715fy1zjyggv6v59jmbqxnaamcnckh")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xqm5qvj52js6hyfk8jvl53dv2dlppwdzvq97nwfdzs05c59npmj")))
   (package
     (name "info-frontend")
     (version "release_330")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gqqyh2y9nqnbpcayi5fw4xvx9ckzsw2navcm3vgrfhdlf4r8nq4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "04s5vwbbn7dlcnm9plim3plazhbnk4lj30gn2z6kfdfzlnrx95wj")))
   (package
     (name "licence-finder")
     (version "release_560")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zfyal0vv1ndl1paahh6f60g3qn8vddprfk3h50mcjh289fma2r9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "17fbafvbzgp6jxl8gw9dk4bzz44x907r448cs503kpivvcd80128")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04187gqd200v2kjmhy5rmmcp5q9z13w0kvj4yj1nwsv4wpcr2lc0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "19bxi8aszcn6hpdgz1q5sj0klpiphhhrw396xmvihpm8gg0424xp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19dvfyx7dwzq6nbkky31di3sygwqzdv8ws17lzn5x6jxy63zjwp2")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "10l1v658lqbqdqkq4w6xy3f672z3w7av5ry6gpdzvz7nw6lfkrad")))
   (package
     (name "smart-answers")
     (version "release_4312")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09p6c876a9q3xpca2lbrv13i0f94hv2rm6dza413l0l2aixvmhpq")))
     (build-system rails-build-system)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vmk211p77zlizvcwv0nms7nr0hvb4f5bl0qv5wglnhics7b32wm"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ffzsn7h0y4v7k1f172kjgbzbllgs98qrxg382fk1fd3jj3x7vcw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nxjmn3lmiwcprdn9473rqif8f5rf86sr0s122w4q5nh6089galy")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1aqas73hn1bf0fmyg9zd4b3yblpjflsdv8i7rsjzv8gyp0n7b998")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14006")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qgw4sv6qa0irwvv3pnwkmci59zz6wmi3sdp0b6in6fzsrhs0l6n")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
