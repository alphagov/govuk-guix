...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dlm41hzzwpq0n99kmjwgng1slba2maixa78p6ic1lwqnlqdrxw7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lgcpfp764spxh9dj76h3c22rskxslm7jq6281fklnlmig4z3is3")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "07hpzfjsm50jvq30fcig539nlpfbh3z0692hzaz2q3is5sjj66mz")))
   (package
     (name "frontend")
     (version "release_2994")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hvz1bdbdfcxnh0k502ds8lrj1mmzg1l9vsl3f1p083sap9szq31")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yq6g36xd2zx4a60vqa5lfxsr9i546ny6wm4735gczn1hz93qxmg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jiybcrc4ri7nm82g2rncr9azfc8ai3jcnv9f7z2ib7g05kp7ldq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
