...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "15yidrfh9yaz0mbip3d1jx0m2cc8jrcx0fvf7kwphhy7hl7vw1cb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bynf2agw37j6fz7x4yz6wwcfn8q6xhavy7ardlkq4b6bxdw4l9b")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fr6y9pr3g3bi46m2rx3j96l1dsc8k3z0wh5adq64p67sdyxagcy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0abm9ch8y8316l9g1gzrshzqgjfcqh8s3nn8jjzr3yqmxr8midan")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rcwdaa0jlxsfmmz89m9md3ivbdhq2f1jxpmvajmpnckjhldbwbf")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
