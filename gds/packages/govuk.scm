...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m1sh5mfwvmgycjf007dps7wanqyxl93mkjimqkscyac1hwwf89y")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15pa7zcj1sac5iyz13x7i9hcrvw5khz974j50az9i1lfj4nwp5i9")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12786")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mrjg74fy3s2ycxzdf2g488w6h63mwqbvlvwn53agq0p6czq1yv3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
