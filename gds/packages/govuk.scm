...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rfkrq05kgsr8r5zzing4ffxxr7hqfbb4palfg6ldhmbwdg2f976")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mdsz811h9hr6xlpywzby1g02qs1g4qay8fcfhz9wai7v87fj387")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ny7w286s722j6m5k6vn41s4rpn7g3ns54lcrs16gawg1sxfmr3z")))
     (build-system rails-build-system)
     (arguments
