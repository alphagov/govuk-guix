...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "04dd4cd76165lrvbw0nf0728ws9cp02a417r5vnfza90nfcch54p")))
   (package
     (name "asset-manager")
     (version "release_203")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gdqqn5gb6yy8mcs88q86q6lx0hpaqp2z7y9hxppjm7smbxq7c0g")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l1l1rxw5q9hwyrypbbclg7lkmkwfgbs04m19dlkyfvkp1ixb147")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
