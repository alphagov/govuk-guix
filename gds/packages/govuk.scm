...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "06w6rpvsly6v7zk3rvy9yinfxbkhzjyrcdi403zlalpc895qf73z")))
   (package
     (name "calendars")
     (version "release_916")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wrv0g9gl4mfxdmxjh1r486yf8imdkljlad8ap5ji14ra574jfd2")))
     (build-system rails-build-system)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "04z2nl448scs886f5ql0xj20apg75dld6l4js00qr63vw8vs59ja")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rjsly8rsd0wyyysr4pvlwmfbqwdjnf6g21zm9cb7kbl8in5hm8z")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4704")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g81aarpp92jrgnc57apf7ccyj66ysrmqmzg1wbdrlks022vwj73")))
     (build-system rails-build-system)
