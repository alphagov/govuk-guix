...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d6m1kr6a3xizmyf310zskvk0b9bmdvxig6lq92g49sangz37jb1")))
   (package
     (name "calculators")
     (version "release_225")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bwk132wmn8qgisv02ad6wqz1sqlm6hz57520fp1cg4wipv6f00q")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "06hvx9y9ygn4h972iqldfrb1i83s725lpxgycjzgmcswjkggzjjq")))
   (package
     (name "calendars")
     (version "release_449")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "172igciqdqnpprm0fpnlb1q99a20zni8wsn4i7lwn5prq60w74w0")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wmva1wcgz4y5zla9s3b9f15kvbbjmjwlirdf2fa1msfksyar0k4")))
     (build-system rails-build-system)
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s9787wsqwjil71y7mcavlpq0sk6ry13vjkaq9n5dh4v7ryjra9z")))
   (package
     (name "maslow")
     (version "release_227")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l97vnzbixzzr0rhn6k1j38y81p0cmc6c9s338c6plfv9a7wh5wz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mkbj7xp2cq100ilpx0affs1gys9df3wgx05h6g5x7x386frb3ls")))
   (package
     (name "smart-answers")
     (version "release_3826")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zspwadi6mn5k0al9hc301g1nixvpf3axf3k2lhwn19l1yaxdir8")))
     (build-system rails-build-system)
