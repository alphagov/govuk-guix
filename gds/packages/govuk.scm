   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j9xs0zl5ps7wngiidzvpsaiv2jgifd3zi70nb89qn6xhfkcrpyr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n0j3cv2dvbhh32dlxppadngsg4ngx82gr2l5xm1lazvvb0n5r82")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1aqkp57vdw1ddmxl2nga6br0fhgav5wf64s620jsgcgidw9r6gcj")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xmk79ql6a5gq743yd2gp30m5wn63ml9w029s0gay7559z4vhbi5")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3078")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nwz333qdnj4nnj56kqzc9dwh8avb7j135aj7wav863wmzcjcbc7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
