...
(define-public authenticating-proxy
  (package-with-bundler
   (bundle-package
    (hash (base32 "05qfv42p12qx16ziym4n1f91jlbldv3z2xhky1hizkmm2rqdrnms")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12k1gv8vi3h15qmif6r17zp40vqjkcpcb34hxlyhbw94kpah74g4")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qr50hxby6pl2mm2abylxl9ppa50s13dlm277ma4izya05sq5wws")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f))
...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sj4fnix8d5lkgg5y2by782817nws4h49zax2i98wmqljh694b89")))
   (package
     (name "calculators")
     (version "release_745")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a9q02i9mia06q0y7c17j78gxhhxlfawg6v6wl1gzs52mmm55msx")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "07wbm0kpzbz6j8xpafqiw0mg77y53icbkgk292aii1xadsycnknh")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jwp904dkms8r66hm4g4a5hfkn1r4vgxcc1i6d75dnf1jh81hbrx")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lvchgg5b0nyx4zpw3nyvf34k0pb0r0rfdmvihfa6kv1x94lnfj7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xmdjkavjvfldjkk10fxj8xh7gqkcra9wkpmq8i9kj7nkb3ycdbc")))
     (build-system rails-build-system)
     (arguments
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1whyj4brk2nbvpihyzmdvlsm15wbr48257yb68b875j9vmp8ajnb")))
   (package
     (name "contacts-admin")
     (version "release_745")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rg17w1pb719mn1n6pda740rdwhqqfa8r5l5zz09gnbq4khr92vg")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gs7fjyya1lykdg2954xsvrifizl1jldnac7vik8aa2b240v4yfs")))
     (build-system rails-build-system)
     (native-inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jcgp84n3riirqwj108ml8yl71097pdipg2wgw6cz2wdfivkz85z")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bjj86j2icxdd4cw9mrzhdck3higmixdj1hnx5gsfkmlmjn80cj8")))
   (package
     (name "content-publisher")
     (version "release_1877")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12qskp45z06xcf8s6m9z85yl3w1j5lq44cwhrfrv06m8cyyfi6d6")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fqa1crmb5mm3i260hifcbaqzxnwl1ga8h6ii94q6wpv0l5vxsvn")))
   (package
     (name "content-tagger")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j8jkiwknkqi4aydgnflbljybzirijx7ij3v7wqj88wylw1fxp74")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gn5qdpnpczwxq6ki28ij6sy31izyiab2pycvfvnj5pqpfkx69bq")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "082mfimbm478ax80gpiyf2illiy17n3wbkwanvcg9cxlwvmynxp3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0whfn6zl86akahcap8c99fxzkgz0bnsymgvvsb038vwxx81yywdp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wy3d85mcbwa6m0jcvcsymfksscwy19088b99s7zi2nnaywhs61m")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ls6xabfh6pakx056rhdmyq68yv74hggyh1zgxanbj951r2sirb8")))
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k0q3n31mfhxnrz206ka04mj7c00jcdfnp5nir1m8jsg1wh84psl")))
   (package
     (name "feedback")
     (version "release_883")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ihbzl97bma0d3b9wnhmp9crm7jgjamx6k9q1wfhz11xlvrdgw8n")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "140nr6wk58nf7ikj0mgpwphrkxxfkcxp6p22s8aprdzv4kvc926c")))
   (package
     (name "finder-frontend")
     (version "release_1856")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h7pwbx3a0ry6p8d2sml9gaclwxgzzjqav3j5gdfykdrlj2x6rzq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0aw0nppp31p176l94d68pg6p446kdk7m0ia2qaasc6087hlk7x03")))
   (package
     (name "frontend")
     (version "release_3617")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "148ssg688kj25hi69am2gry1fyr5dyp324bhfmz0sfcgg4hyjjm6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "09ayjcc6lmqpdzcy448ml0v55z7sab6cp96vfhqzw042c6k3ykg9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "197cnzdpghc0mmav3nc5pmgw38s8ylvjs1fn1x8hwhp1vr0410k0")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j80am9xr55i6fr1xhv9yw0490gsxdf6k0hkyzwk6cbsglplcqyw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01sn4zvivz9qk9f5ibapqjh1l27b182cza0qxg031c4i7kcqqpbj")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17l0v5hhlc526dswgw0l20jmqfglaspkqm3drrd1y0iyrvr7sp1n")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f))
     (synopsis "")
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qr696fs4p8r1x20m5z0gi6cc4fpvs0dn6w9hlm6kz1w7smhyci3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0srkqaazbvk6c7j9hvr0q9lvmniqb0898d816s4pkh2x2ih56xzl")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "05rq28bmphvw9jm6ncby4z6m3lask61kkv5cwkr9fh3id3cl7hid")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wazi9qrp77zrk8bydrqh3dy74vr1n62fp1x97x6y6jj0gbf5yi2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "052g5mrzyhiw9n3cws6wan0qk5p41bldz19a97m6h1q8f0apa7hf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "16znn6vrz9zfy3afawsla5dg8pvx15jgj47nrpfa864cqwz8nmni")))
   (package
     (name "maslow")
     (version "release_562")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yizd4jaj1zcr4ddp40x1r2ws3830bkgl6m61rcgyfc9g3n7zrg3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "08nlh4k4a0i8zwlfh1hxjfhk05xk4jhrhys04ykhkw33192bkcg8")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hn87yqmiifqi1pm7046vnbn6p9049yhjxaxvalcsjj58az0d1lw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cdfxyj5jz9z9my8ld8wwmps7jn0fw9983f9fyaf1hgg0n3165h7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rhvi8k74bmwia2g9d3lcvd3hdrigglwl2amgfyk9csas6zidplr")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1478bcqbq6g4chjypgs64bvwcpi8fi9ibr10diz9z8q73zd1nfpc")))
   (package
     (name "search-admin")
     (version "release_415")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v2l42pszyqkvqbk65v7rw445xbc2pl4sgq03031l136lhynrmaj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2583")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18zbahsxib9h6zizbf52gwjzr1bpw4rldyz8kmw0v23djkkkyscy")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f
        #:phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mnrr18a695wi97jp6ac5sjpqyns6qwrvr78d6r9v2jjh3hqhnb7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k005mfsfzil4ib6wivw8v7smffcvp1hr4jv95arcri4in43fcf6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "06ap0bqw1yw066y47k40qav2xsl61509iy6xdyvj6snya0m4zl0c")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qijnijlqjihykwiapc6ryhvdylw3v6dmy72wklqksx7w7r689sa")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0f91gk2vkd8gs66n6p24fw7md97xz6ys00l4i8yrvvviwflwynjy")))
   (package
     (name "signon")
     (version "release_1505")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "113krzvn4fhpshy42ag64vmvmlx2fab5s9d5357d7wbgkbapg72z")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4906")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d7q8dhxv784qd730d3dr8ms016hsryl54qsy2f4m9a5qbkcxcsk")))
     (build-system rails-build-system)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mkm7v79fy84irjj5wg3kfik388dq3h5pc027vhd5lv67gihgsmg"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rq86nszz96is8yqfyp93gwwq6i9nbia4jqn5gc9p8blp6jm14il")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ifdkq2yaildcqfpbp7hfrgfwqf6zqmm7x9r5x3phcm6xhghw045")))
   (package
     (name "static")
     (version "release_3562")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mkmvjnm5gpjnxva98486b8sxy8v9f9md4cf0gpafbxihhibq3sy")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "04p79837n0gp2a1k77h28856ifdvphp99dggsjg2yn4gss0016g7")))
   (package
     (name "support")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rahbl34v5r2rixdnrfjn9wk35zhba1ip6s8p8bsmk647fall42h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "12grdbfzc6xgmd5zmymn20imf999l132bmz74aqx3q7jyls9xray")))
   (package
     (name "support-api")
     (version "release_436")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yg581zqy3x3nnj6z2lb8050ny4x6ch7j369i0j4rji7h2wsjzyi")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03sj2n4b60dccqcm020z6bqdx8p1y5sqrjv54bw8jl5skvjn178h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mrfbmlkcqxrxc84x869mc9n5wxq9azdn4rmi6dlr7w5ilq5x18s")))
   (package
     (name "whitehall")
     (version "release_14861")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "199qcg2h06xg307r0i2qwzbrr40p9apdz5b5y0hq4pc348j73vlb")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
