...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dwzrbpgyzpadab5hn2kqy2dm5rvmc1bhv6v0avcawlnfcjhn72h")))
   (package
     (name "calendars")
     (version "release_643")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ijgs6i8g6xn9vikfdh68gs548zdwgm7aij7qybshvlhwar9rxkd")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lkjk5hghj22ld6zb4j907bpdyjhlvydz75axw0n23amnfdikhqc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18dv6ax4jqdyinc1klxwqxkrq9bhm0b9fxx3anzn960p2rxv5m3j")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
