...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4918")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j1zcbjbybajzdrld6sfapmm4lyycrzbnmydzc9ipkj4ia14fbha")))
     (build-system rails-build-system)
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j4ijyim2r29nfid8pkbi9chz7arrdyd7yl6sb7vs42v25ngl7zs")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07nzxpvli5rfnd7sjyv05d6fbqkigr45ga4lcxv3rgbi48qjk2sb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14867")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qijz74fmp2lvqi2ks9l54i0yp9q7y73x6rwk2kj0rr8rpwal73g")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
