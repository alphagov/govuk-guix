...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h0z9j9m573q5gqk7d2ylh9bncyvxqh23nvq2zyz9955qxr5caar")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d6zxgbri4ccjps8wfyzyysargzw1md3cq8y084liq6ib2n64ylk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bvzvxm9mf5nxd880rd6fanlcnxac277hw2qbdwhvzbfhp9h0d63")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xv7n0hfcgsdslswv28j093rpq7v7l8993hwlqy42m41rpqpyhri")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public link-checker-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1i68ylnkh3i0vs7jwca2hp7rwalwnzhss01p8dpiknyrs743p8zn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kqag83qjl42n40nmyx4hyrp16z12cvjlfm63iv5l116rb3frh2v")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1y6fy6caxag70ggk9i7yhbi6ws5y0fi9mdgjh75jrk97vfs477sj")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "07nhzvm1fg0db43y8hifag5pdilc0kg41yyswhvi0xyzc4d9lhy8")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
