...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f076ch6cxnrsxp7spvfs2msjl4hyb0g4fpfc2mvdvc6xcgf6xql")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ndx20m870ngrfijvfwwrlydvyxx4mhjxx8l2kgx923yb27wq6kq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "11l1fknh61j4h5043idlm0m1nzm1z2ddpwf2pvhialkbk1nfm2x7")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2214")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13sbcgz629mgrr9pp1h2gxkdm303hv119fs5r7l55gnkgpb1jcs3")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
