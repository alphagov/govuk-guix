...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "01jmhxsmaqlys5h2l7sqv9jpid7mhbf94kfafmaaqbv4n6xf83q4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19amwzh6zwxw4al6lrah09z7jg200dm1ss56ls1j3ycfv0c6ggm8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13334")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y0i3rbb8lsw0s8vmrpfvr42524fs43x5i3dz2da4li9f0b3hfp3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
