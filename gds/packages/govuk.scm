   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ck7pdm8kd90chskgznz166635i2s3zmlax1fgyz0jnjyqgjb8wx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2721")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1marrmy85s0ksxmr1sflb13mvaqc0k8vzk95d16k7l09fagcsnqb")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "00i5q029lwvx3bz46llr8k2bn0qhrlkhxh387h11fg8zdgn756a0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "184jkskgf3bb9s7ifrp8plhk78fsgj0svxhmhz0xzxh72d4qsxcm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kzh0v2f4s6n2ync0cfl9vg33la7s5y1knps1hwlhlmirikqca5w")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12961")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rjc6gizk54n0a2gng6a9aw9s553zd4q18p54yvkp51b94fib3mi")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
