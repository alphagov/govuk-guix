   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y5zgm4pzgv85wmxkvy4rz1g9idirdj6yrqk48s3isdzp009z3xc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1y63apknbywi9dxwhhdr7gp6jagd8bkzzmip5diqbfj9a5ra859s")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0galdjwkfmz216w78ga64dk0v0fmhykhx0w925cdswlq3bm9ndk7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3677")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13zsy6vsqsin4zw861qwkli5wpgsccsfacpwjzbkv87hk8jjh512")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
