...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0s9mlxwqac21hn03j2nqgxfw5x00n3d6c8n9ah309626vq8dv3aa")))
   (package
     (name "frontend")
     (version "release_3516")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ahc0j7kqp3l54zx733kh1p3c5ifw57id29px082dy5ypn9li670")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1b9aazw3q6vf4bjsqsw0s2vibz4xijcmxs7g1lkm30jlrr2dl71r")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mcrcxw4knl161naxmw4a5wlfd9mzp8kqkfsh40az8087z8f3spg")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
