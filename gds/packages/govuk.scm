   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q71zc7s6vrndyqsjrzixzr4idfmkn28yvqkinva8662pnyal8d7")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19vii5ha5gz53yjllqhxnbinj0142492yq1s6r8hariyfw08wmlk")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k0qk0r7p5749phzfqw86xnxw38ar0i53maqk8d8wqcrns5biyib")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12f435c06nfhvdvx75jqswpqsvy6qgah8dj8v7y1k0qnyh48x1ym")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p0csw1pvb5bin9lqlkwj8kqb5i9q16pjfd3hrrhlwyldyj9xpyh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pwsjr9ccqhx6vbdzqic06v700i4p189l0r1vn223raaai3hwwc1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pff6192hnxvq955wa68mbyyiklp99x1p6iq487k930xh6yznslg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1apa0bx0q8rc85am1bxc6iwzs0dq0vy582fb75rllxwazj98rq4b")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ch6bb5vq7jw2jh7walrsvfxwligyjl46y89hp2vnn2rbr7f5w1r")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0js44jyw82ahaamyhfa07jf5abx7lmjjqrsbah8vnxyrjxq44g07")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vqsz6vwyk6lv5xk6pp4vh3mwsfxh8sbhh5xrvzm299awaw3h836")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13g2h7p3xs6ccc0a04zdnjaa5p252vn8dzyj8afi7jwfb80y06lr")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public rummager
  (package-with-bundler
   ...
   (package
     (name "rummager")
     (version "release_1908")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vlrvs3xp0m6k2q21d9jfk7zz5g1iipyqa5rsfbmd1xqxyb0mbzz")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w7wcss1as36y1m4pmrld7zk6pdrwcl8xv333bqf337349z7q0sw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_3039")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00xypsz11w0j71v5rnkra7njyx5sixym5kxwvnfkc8xspymiszax")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
