...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4882")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pr5l4sdgn8raal4y960rvx0kmlfjwc7ys9bkixv0mby6wn0qkmn")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14851")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fm0d89xgb0jlck7jk0ga2v3w11x6zadp7vw43n220ri6ca0ak1j")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
