   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01c0rc9wlasa4dln0rn93dsx85ndvv2cdmwvang0m9gyanv0j4d3")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00mlmx1wx4456y9ax8lsw72ds3p1l051jphnlria48p033zmn1c9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11b05wm4w3310x2zslk6jbdr8p0hfvcvcnx0iw8q6ibhr7h85vzr")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13111")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nflykwhvgflsdnmq1rkpbpr3fkgbjvpi2h0lw8pv34c08a728h9")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
