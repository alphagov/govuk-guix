   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hmdmyxzk4axicpmbw9ws05xd55wmlijc9nn7gyi3k7v3rc5gl9w")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xsh9pf5qa7rh56l14x90i9dh2z51xfcv03mca7y1bjb5wc833zw")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13698")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vi0xi52cda1n1c9rqk9hsxq07imfnb1bf8m840r66anf89cnshc")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
