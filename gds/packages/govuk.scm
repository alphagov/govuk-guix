   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04mb75n6ai6ah2j66c1ynkxvv6xr5s2ibgbl7ybm6bw1krr3hwiw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "136d55kaq4iwpjfgy9vm4sgp7clq4idl715y4lgrqzgk4l7564zm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02pjj1pcghqma6airda2vspp9wix7q4sa4ckf6vkna0a28qiaknf")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a4czdllx1pqpadci6mfga63rxym0vzzzma7pv7b26b4nr0lvnj7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4111")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q3pmrsdbbnnfi41ha5my9469sp3xm9kgzcrixg9vx5pi9mlzrhv")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "193nfidg6a9m3mynsc96qc27pggs49pxy05d6lalbkvbx3zabpwy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
