...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hav01d8wfyvqjzp7s5njailsvvw8mcfjm0djzyq5xk2s7v6jkfw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "018cpas88263ac4zgf5fw7qir272ibvnsplq2h5v8yfdnrd91865")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1irm7qblj7d0p5a61v5zjrcz26hy1fklxiam7wxgkb993xmpxslx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "084c4pdxbsxy17jfs5zdz4jrzadj84jxvshl4cacxjhmw8y2a1c0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
