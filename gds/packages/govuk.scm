...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sndjig5by0vzw1gdkgvlvc7p95sfmslnm83pplix0nn30d0q8y1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ipxkf2g28r4kvcyckppm87vp9svvd38qvkxrc5260hmp215rsb8")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gr3rg22w6r6csgvs9iy7nhnd7clywrrif3fw0lkl4inzj44jpb7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
