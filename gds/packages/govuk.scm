...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0si3wgvgyn4xvxdks5vala10rf4il76zl5gpajh420zqvc9nz1fp")))
   (package
     (name "frontend")
     (version "release_3275")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f4a1a1cd37s8yr5rq3zcslpxaa0lc4hqqxp92y02w28a0i6jfvx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publishing-api
  (package-with-bundler
   ...
   (package
     (name "publishing-api")
     (version "release_1514")
     (source
      (github-archive
       #:repository "publishing-api"
       #:commit-ish version
       #:hash (base32 "1nb5vwyh40w7j3k935djbblmxhzij28nscmg5pbn7bqx6fk9vnjn")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "15w5i17rcd1157xhq1gb106xa6yrdf1xvlp7a94fgqr2m39ybvsb")))
   (package
     (name "search-api")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r9f4b2hr0pbjjs53s9wp0xvc1hfiabr46h8qndcbgn3c10bsa6p")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cycdw80yba88bnfllv8mp3ra2x8140kfjvss3illh4p61dmljn4"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ahi6n6vm8mnmxshpnydyh2v7ysibw7f3szqjkgjz3xvnl1xgrzx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
