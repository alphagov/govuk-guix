...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "14nna4qx9wkd83268an38249vd61q51ia90hqz122fink8rdb10s")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ri4bdkfw7fmsw8ahpr96y3j8jnrmajfcwsdsqc1691vnrin93sc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jinifz1ig8ds3hb2axdb8rskdrxqkxz6w1kgmdr6pdyfvwls1fv")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hrdjan789dizqkz79qj9j3c7rcfxa85kzqx8ynd4p14gm1h0s00")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pkwbr95yy1sa1gqsnz2jsc6hnyg7zkwjgicvn0ka2mx0g0l2j76")))
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gs1ry3mkh6lqn87ia330l5mcs4hzgr3vcnmqmznwdrnr5a3v7d7")))
   (package
     (name "feedback")
     (version "release_393")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hkqnrz8698w7ylhiv7j41dn4jxf22ng6y5n7jk7ry55chczj1w7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bqbbrvrsny624q6w5ra5kxwsv09z94rhk59jq5l2jqg5p9mzxxq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "064dy37fsdpap16x9615gi2ilp5lwl95igj9bs5229alzdgkl6l8")))
   (package
     (name "smart-answers")
     (version "release_3899")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jfg251cib703pbcvzx9ka4ix4cjv42rnfwwxpc1d7xpadz16kbz")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fh4x2y5zns19wr8d9i17r37x3281mphsvckkfyn5ly6bspgpa8q")))
   (package
     (name "whitehall")
     (version "release_13367")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11h2jdavabqkh5ci9j81r7j6h5h1yl6rqywyxi155m7xd7dv7462")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
