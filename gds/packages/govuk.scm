...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p3synfcmq3ik7za524a3mcpbb5bjxjqvxkwca9dsvi6a7ih505a")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g11hs4g37bb8prhf35kpw5dxcvlik5rv606527ml019napb7rm8")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nn51a0mzla90i9li76b4qrxn3l9b5bvlab8kj61xg7w4hp6pcmq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nlrpjb2zycwj2mgizcm139466gkxm1sc95shlcwj6hd3iknry44")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0blrp87arckx9blpfxl5vcbr7xbwqkldp5g2zjakpq3mnxmby7vg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13901")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fd8khx6xi5s6wj0ycrhfn38wv4aa5i1li8md8mr96r8pk2dqy20")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
