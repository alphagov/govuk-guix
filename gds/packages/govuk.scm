...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hs2g4n21vc4bxl3pq2ar7yihacz7rrfidl7mnwdjimc1q67y0v4")))
   (package
     (name "asset-manager")
     (version "release_448")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "093hasgy2cx0zfyymax98554w813b5pp0di286r3s0axbrqmlcmh")))
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pk8m76sb5jdssaja3xaxn6im7qidrjmyd5s8jqpfzl2nppnzlb1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06r0nqngk3nwysy5wrflkx8cl2y20b061fh0vyhkzsh6z96b7i50")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1n4pg4kj9zxyrczcgwid4qpw8sz0f9ag5x4hdh55l4ghsb20h3pm")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0iqkilbwzngdprnzjfqa23fv82mdbav8gw676i9fspkm9wf3lzdv")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xybnpdm0yq2qsc31w8f4cxyhdw6vxdgxlzjagbqx7kvi3k02hyr")))
   (package
     (name "transition")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nx5m0fr881rcaysa30iwb7wgf4p03kbs858fc3z9mrb2q83qcy9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yy2hgsz36k7s2ccsaf1ybcghj0lpbx4pxz7iqx972gkqqiq00i0")))
   (package
     (name "whitehall")
     (version "release_14634")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jl2kipxzdwf7s4rm1z0q05rz1474adhq18sb5qjn6cdycbxgcj0")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
