...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "11pkpqxl66zaa17c8rz35nci7iqhniglngzzwj1m0dy9w9hz7cb2")))
   (package
     (name "collections")
     (version "release_618")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rjm6nnb9xyliz4wlll6z3gsmiy0n1sk3hwavhq3nd68v6pj0k7q")))
     (build-system rails-build-system)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lygmpmx9hs3kz9jfvn9kv7lqhc9wmkmqdh3azkhhj8gngl5kxsn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0drw0gczqzm9vrmnpijz90ljr8zh1ddrcscx6zgk633qrwm92br2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sjd5q3yrm01iqwhwvxa3ng1z5ym1387f9nmvysmixa1gfp39224")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p2781gbzzp8mxp3kqdq8hv6385xxlhxdlckyaj6msldshdv5rz6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hd9m5sa2viip5dm4wj0km7011c2x69djq8cmkikiifg39qpk91q")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jzk852rjscb1ybzvcmhg73fzm65ryl5q7w7yfp262f760yv3gf8")))
     (build-system rails-build-system)
     (arguments
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4014")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "106rz68z9pdkmlmqk3jkrs70hw88azinzz84p7zdl70jkkagcx1k")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h8a1jkha6wf410wqi7kb8fmr9kcbpvbawxj9ylfd481kpdjrmca")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "157jwnmqc6v93xahnl8xhyhq023qnb8sl4fljkkdf0bh0mh5kdxg")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
