   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1maldxygkwqyq9xmah6gsdvkc4yl3jbzqq2w6iih2xj10cr52iml")))
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hsrlwn9g49jr9z05f77dd1s1g4n8m446nahg486zbgdv32skfgi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0my5gksg7vbqphpgwdiwkrp84x4lhiaihmrwwxj3p31zjyh6nxlj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yn83xknim37pfycrgszkn29qzwhqymkqy0iz98k72dcdj15ifcg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jsqgl3clwa85a67r4h5pb0qj6a6kzhgqj6l4cskxqy9qhr0hwly")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "18f711jad3vai3jk8wvgrw2il4h30kmpi7amsppb9kj87b7b5jpz")))
   (package
     (name "feedback")
     (version "release_342")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j7izwv2xylqyphyk23bikb69sqw0wm29gl8g38jnrbbn1m27hnc")))
     (build-system rails-build-system)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0ir7hgqjx9q3r0w45702nb93rlgr95fr6q9bkdb70sm5j55q3xkf")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13126")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l91inbwb7dwrx303kxxik0m86klhwlaky729i9gyb6j47qgbd6z")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
