...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qm7hqg3bksfkc47dbwpz5yw2gzhgp795zjkmpbd8jwzm3mlgnmc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jz56d4dx4jw0jkn8mg0bk4ck3hd4s6ada2zb3giz4qg0a6bpqsa")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n8qbzpzvjxrm6k5pm27mc8yxdzxp79qggfhlcyhxbwlyqkmsi3b")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xfsjf1xgv0cd3fwpasxgc3ycdwr7wwff1xnz2igrwg8pjdk3bxm")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
