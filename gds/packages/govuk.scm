   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jmj19i7vwhrfwl3q58002gvwmzdwpr0z434yx4r1j5s4nyh6586")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "00bwlfplkgv8m6f4x6z2cbf2q3xfjrn793ax1qa3lvdg82rv0l58")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r7qjcyxylwi1sbyklsz1g8wda8yxxbcw8b4pkbpbj5yg27kcp0m")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
