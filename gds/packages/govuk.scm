   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wni0j54gzz7zjqlqh9jb6zywxpvaqxn4y6bb0n7cqkjgdks8zix")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lhqiby734kwvvx2al94asdyawfkh3nh8l8agbk8fwcimpnd6hrq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13240")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gv6fkpcckv4k1qlfiz680w07l0l1idn3hfmsz54y7paqvhsav51")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
