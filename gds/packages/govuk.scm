   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lk5mf2mca0wih8hw0n8nbppm3l4yh2jg13a99ancdzln5dgi6b0")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10g3h6h1fgzqhbi72hgrl5wzmk3s9mqjmg42z3am8rdy0nqhxxv0")))
     (build-system rails-build-system)
     (arguments
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1va2xgf03y2pkhcp6i46jxcqsgv5q68x160rc6qqjn4vmmxcz1gz")))
   (package
     (name "smart-answers")
     (version "release_4684")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18yfkvmi9y2ynkfkid7wsbb93ib0670pg628h8awmpnrn1gn9kmp")))
     (build-system rails-build-system)
