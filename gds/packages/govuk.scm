...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "018c42y1ab81if5wlyb33cn4hpnlj2kwpy8vl9kph4qag597y6km")))
   (package
     (name "collections")
     (version "release_490")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nwzhskzifvb4sx5wb53p3wnlx946y59bmh3klm3k6frxsw7b5hx")))
     (build-system rails-build-system)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h6r5ppa1b282v05k1wvlkl69n4v373zbw5gj2bvb28iw8ka3h5g")))
   (package
     (name "licence-finder")
     (version "release_368")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09ql5irbsyji57bjff2yi9p8imm88fsgf6nwfrgn63wy2w535dbg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
