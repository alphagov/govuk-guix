...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lklmacyp6gvqirpy0sczcs16zc7bnfa5j329mbhaxg7924l8js0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m6j366vbprpk35krirh4kibb50cdh6z5cy9kfd7488fvxzwdg76")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n2b0fpfgbyfp2nclp5yhpazgllhrv6gk3v50prchnh5mdh96h60")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rxd0w8aqiy5yhbn21crk9vxvfmmwrvvkl8aanlvnp8csb8srmqb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "007cy7nk6g2wh9ka0h77a2bpd7la5npfwawpm8km555ymi2qwify")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nq6dbf0vnghbkq9r90snf757j10lvmclp7qxxkw4n4bniqdvva0")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "168sy538vaid23iq68lw1r07blbkh3jsn03j8izis1wsp04kgg3a")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0i34by9ql0mzxmnl0df75rzx2vb1dc69hc0fdnz3b0sw0nq8ddzc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fz41b0aq9yvdjszdc2ym4mw2s8js6fb4653wrzbz8a3nip6yfr2")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vh8zwj2834lsvx5km4rd7sq6s4y8qfddwfjaycg9hlq91jr3dwp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cvl54pxh9l5dbi2hx3d3kamv4b109zmivhwfhaswy20janq62nh")))
   (package
     (name "search-api")
     (version "release_2351")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qx3zhzgs423jyxjj0rz5y93q4m2fvc28c8v0cvpdpq8ngswjb76")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l3xljp97absiy5x4lgr041p6qskp4ccwlbc020n346i3x2qd1zr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d8wl5iv295ncd48gilffibakxhpcw8q65xcsjaap62glnqyziyv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
