...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "11q0j475fx7r7h63n8gqw54jl2vx8xp5j805rff22bgbwwam06gi")))
   (package
     (name "collections")
     (version "release_505")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cda23s7mdflzrxji9gmypx8dqy5mqf6kg1bm7s6avb1ghm81fw7")))
     (build-system rails-build-system)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3945")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09pyjfmcph6fl4gf9phmzsmnp8i7b42gwwqkl3l1iq4nfxyl6hpw")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13430")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r439hzmic84nbnfpa6266izjy9jasbnv57h2xf1xi4x4ys11haq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
