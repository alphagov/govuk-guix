...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0f2ibp7rh5m5syhnslrsypg4zcsjl18gv56l58rmxrkmjva6k77w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z3alhn4hxr9jqa659hl0ad4lnagf1wb9wnzvka1npcbmz6ii9d7")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13170")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ab2kdm43n32apkxn6x7a6gby75z134hx529gp6i38dq5yz33flk")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
