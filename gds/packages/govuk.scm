...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1iq5qb6gwdirsa4cya8skxb8hly9cpwdjvbsjp82a7pz89igfx4s")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gahaq2jr33r694g54llk2zwqr9wv81nijl45lgl5vqc1qxikdz5")))
     (build-system rails-build-system)
     (arguments
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n6n804rjcz8svzzn99l9d8771qzh6q19r4ijx13iz7myjqkfapm")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yqbnhwg3jv5ns4ah15ikngfp78ypk379wdadpr9zw3v5pcqdsgf")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
