...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xdnx17ar6bczp63ism5fzqlc80kf6c14zn6r8jj5466qdp47ff9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p0kkn9a07411nkzwbv07rawdjir3vlxh4njx6xlqlmbk54z84zd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k0qyxahwyhj3v392ji0vjla458gz8acmvk9ghaf02bgfr2szd22")))
   (package
     (name "content-tagger")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sq9hmmzihwp57fpl2l98dygyi319j3nj6zx1lyv1xb19pdrqqjh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "03nhx0iaym1b52qd4gfbjbz0yc701qvzn0fiwr5ffjds3nbrvmdy")))
   (package
     (name "release")
     (version "release_565")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ij5w6ic25fnylyn264n6b0hrv6nnbxa7xmf09lz6k1na9mv9s9b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
