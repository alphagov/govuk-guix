...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hgknwnyl9168ac4x0y1inc8lk10ayzb9vhzj6xg3cy1ydyaqw2m")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jb7rb2425d4s54myzb4ws661dmz931b1b9slj74bra84s4wisvy")))
     (build-system rails-build-system)
     (arguments
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fbc8r97fgrk7vd1lqxf48xszqkgjn217p8gi51024ya7p3v9rwb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x89ck1g5bqp116jwgdixv8hmnvx53nzb8ak7rh26icv2r5kx3qz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
