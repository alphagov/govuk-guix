   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ra85qm1s4q8vjzpfrrwjqgsbyg1c9krfnl84sc4rnyrqyfbc3z9")))
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0idxz1m1mibwbv4pmfwjx36a60nkp3157pca4f7p7lb2qkmqhmrr")))
   (package
     (name "contacts-admin")
     (version "release_458")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fs4pz0vdahfdwwqlcxg6jj8jmxpbfb3q5fdhcajngd38jym95n2")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rw212q1wmig3x0k8y6y9cpwi2grhv9v28m8qxm2ma5bypkicdsi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q74g63qzzw2jiia4aqfh62ab3gijfzbq0bfinjym9mmnp165q8j")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ys80np5k0kd4ayj01mmxgdmj8wjkz5yr14ir2mz39dkgpyxynd0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cm6lihfdzskh40h57vmnkvrcmh1c6zgy39dy3sqas7a6dvdbiaj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hbqn5g97grvm7qpp7xyh7b1in6dgyaxzs58qkyhd7gp12lbpml2")))
     (build-system rails-build-system)
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bpv0wnx4rhmgksd84v9qra2pfjp0vf080p1gs06ax0sfazafdiz")))
   (package
     (name "content-tagger")
     (version "release_795")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p6sppn6g9caqbk10y7yi3dc9cyc6ca20fjznsczi6qljpyrfypc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g5bm7y46k4drfb02y3my9vlls327x7npglk7pj7k0zm4rn8r6pi")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mmygw0n32frspx4z057a7m1hf3s2d76xd85a3lb61vl08gx6zvv")))
   (package
     (name "feedback")
     (version "release_437")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vsh8hd2cwk4wl300ly1i1s1f3wah81wlcrm4and3y866h7n276c")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "15s3cjbjkrqrgb2vq22nr73rxyc5351nnjll2hvm6aja1djinrlb")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08s30pi9yklb4kd4rqjff41cgh4p5knvq42sq108vbf1ywx8msiw")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1a2hgps4138jb0dlhhbx6bh2ixcni4zqbkcgn0yf5vlp3rmr3cjy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10rw083m5j132c80pchgjzr40xlp91bbsp2s6llrswqi6ccfi2bf")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1crvghkycksvrzrzg33kzyb1hn0qij80vpjxvn337d95nrfqhfhf")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yjnv1zssgq361lnfqzn3f5z3jd2ml6r6f2g12i2pd3ymj1xpfrx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xfdcs55gzgmj5m9nsvia3446qwxcdqyg912dynmfal1wx7vpn4c")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09qkr481rfkjb90wlhypnmznni4i427xr2qjwzd91v5pxnsnwcl2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3974")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17r31bacmbcdy8362x7vhnks12h2gg4rvycasal88k0ag2i77xng")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10qwmjh9vr69yxjwqvrvy01q8lyd29sfii7fbcfrqmlpgv2ihz4j")))
     (build-system rails-build-system)
     (arguments
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xlhvsg8va4r2k0gqa9qvk898zjr187hpyx6k7kyxy4pngrkiy7m")))
   (package
     (name "support-api")
     (version "release_193")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zxykdx0sl80n9n19qrhrqyvn9h5f3kli064k5y8lwywlmxj29k7")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13494")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qb87kkf4ql0nsg0gljmy68axv63d0vkj2f7zi6gzhhxmyisqb4d")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
