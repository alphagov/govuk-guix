   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jzj7a3yjxcn6afvi5409sg0hrv8d7xb1827j3iv56ykafms0lqf")))
     (build-system rails-build-system)
     (arguments
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3399")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cxj9gwa2n5ab8r303c2m0ywm78bfj6hjfk1az0lgc3vxl8zfw41")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14439")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bjlq1faiya04hw7gnj4xwbgxrnh0xzsi4d94a5khilqggypm4ra")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
