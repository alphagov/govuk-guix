...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "012wy2cfsq8rivpmb63w47h02j4maw4awmgclsly44cqqmapvf5w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f9mxli4ic492w918yzm3w72w93f27yk2265f7hi0xdmybwmw384")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hrbqm2ya1iqq699s3rqsx5y2fr25abq2gz6fcnxl52i5nv3as2m")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
