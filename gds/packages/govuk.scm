...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gxqbljsncm9dax5v6ij48swcdldnf5g3r6d48zjzrgaqwxz4ap4")))
   (package
     (name "collections")
     (version "release_770")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qh5lmnhc7cam6xdzzyk01zl68sn48p56imf8cxp0m9qxb66q437")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p2dbnp5a2d4mk3h4jpxsj6kzvqy3x0p84j6fa2xz1fxxgac2cam")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0c7gd620vwwd2h2sybnfqvg7yz61cdz5pb67larzzx4hn3qhm9y6")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fqxhkj09fdg9q9cgr2mhsi6asiqh2dq9kvmfi96x0kmi3mnbwld")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
