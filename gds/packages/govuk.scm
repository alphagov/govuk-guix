   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z94nsh59wng2d6m8ghvxdpnmg8zwl4b7i177zraz76kr5548bfa")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ngi980xzcj05b9mdvsyx9pplcrcpck9z9cd0j7xq3bx886xkp57")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "06qj95yw55si5jrg7kjsimjh8q2gj14j1z77j5ws9y00l4jhkac4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m9qw6250137rkaii7fr0mqqls7ahwaka4hzg5amjvnjb0mpm7hq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "000i39051balkldj74rviawacdqyfs17ni2kizg4mjwarpn2lsgb")))
   (package
     (name "content-tagger")
     (version "release_467")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0anjg98c64sva49936nxa0z41f8f35x1976h4kgnna8kpxj46nia")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w1vhka9rl2mlcdy493c440q1l9cqsl1fxppy08ikw4ky72zwzh7")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dgykz74xmmglyn225spyq1i9bfp2218mbhn2rh9jzakhyi9q2dd")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1b5xigscyk2nn517x14knmddr9wx6apv495r4yrvk0qg4jhkwr6m")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x96r30c32aaawlk8lss5zjmqz55bwgj3s7xhg09z5d3f0ncdc2b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rvcqprbvxmjzfd1v7l0zagqiy2grm1nl0x8bk7r5s3r45l82rp8")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0nwsicw9ini7px08mln2sr7iwr11sw3bi0w194sjzmcfwkqj946d")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bl0ck63bk2wvk9zpbjshyci4zx81d7c4m5mna88s8l4j455scwj")))
     (build-system rails-build-system)
     (inputs
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3679")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rsc7dwp79fgw7bm88hd6s0v9giy1nd09wdfs49l0mkkfgpvj49m")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bgispaq231liiryyawb78za38cz1bgzyvjcrj645byb130gzr7f")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2629")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m5d2xk9blq2pv3ry05q1i39fnxc1xvrfgkzr5p1s81f2nzxp0hs")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06jp7s2755i0x466j813p459hp153h3aif3fz790yjhl9380f5sd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12890")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hydh3gkmbb3in7g6qy6ncw6wdnzm2wwak3sawzcmgi9k4nr1fcn")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
