...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d0d8na8jc52ipl069avvz3df72fanqq822c3b85fr9bw8ijfl6s")))
   (package
     (name "calculators")
     (version "release_297")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n74jddb3kyz7kl1p5xxv8kgy2n4lqjhih20nmii2g441v47v3i4")))
     (build-system rails-build-system)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vssx5jp0b6m0w1rzp887fn3hk2wb9ba0b1z552rcimv2nwdrcbm")))
   (package
     (name "info-frontend")
     (version "release_156")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "057lg8m2hwxv34nvrdlbz77s5wajwy0hfbds70fzw4ma9vbyyzsh")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public policy-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1b2wkdidf5bm034zy66pph8g9znr2b1kfxc9kvknm121941jcwl0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sp8jpk4mys7fam6in8z8zk21p1d80qvxf0n2jqphh0w0bg76cp3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lsgzb27apq7dapc8m1d9bqng18qvazkb53gvvssrh6x7bvd2sz4")))
   (package
     (name "search-admin")
     (version "release_173")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jsmzbiap2iv3kkw9dy1ssfcs42n18sfb62f7dkckm5z003b55mp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vyfn2w8jkm1q8pvyvdfwwd8s8wyy6j1q6464a397qgid9fi08aj"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09glam9pfs1gxzy3dsvph98rgnnpm8v6s34n7xjkxa3iryznrxni")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
