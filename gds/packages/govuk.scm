...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "127p4v1c7wbypar477n6rxhjiv956jvyr44vclh89j8n01mm8ra8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "187yvvbyz0gbys433mkdk5bid2gh34fg7rqfmjsdps3g293ghqjh")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qpz7vjpf3q7gx01n7m4jhxcprx888m14l852ashnzy8bqrnzm56")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kimm8vawbszqcapc7rcj8h4xb23iav21wrzlfgk3j6y26gxnhsq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
