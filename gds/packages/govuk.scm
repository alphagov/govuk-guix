...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mqyhg9qgyam6xb295ry9xm7g29yszhd75pgq9izk2bw41pbzdr8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x343v9n4yagvhk3qhpigyhafb52x3143x6vjj9466hqv8nvzmf1")))
     (build-system rails-build-system)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4245")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01xmrri6z8jm7sl0hksm5rlxfvhixxrqrxp6nr3ci169ipqdndss")))
     (build-system rails-build-system)
