...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "02k85l4rsyyh9ykjaq63255r4fg15162rk9qcpq78by6i8nr8kih")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ggcsxa5ki3hmfcjiivl9p4lvc8my9lbk353z68n2fx0kb69kvs5")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0limciqg29n7qrwi8shpgg10dv4wj5avb2lzfjw7a19dj9x2sdfp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zzcwz6p6nagwiaxz3lmhhabii9b7ds3aic6nbg5n4hgi6887zvx")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hn5jrpvppcz304y0l0bibqfgzxr8qs3ag9ashcvjhbf9sa7ji9m")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ig0l24jnzfsy0mkwkmp26z5nxcpnp54xz66r4bjwjf289bkyg9k")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gcphj69f0a5490633i04z1y732688crm9k9621lma21syn17hga")))
   (package
     (name "maslow")
     (version "release_488")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y73qfmiqcs33ry9hidlmv5ndsj5qcvfy3a1x91s5m2xh9x29ghz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
