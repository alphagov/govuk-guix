   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0aa4h77md9cc2hln9av85wp09204mi5rzxjssk8mnq4hvdzfghrf")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g7r5xj6az5dq505r0gp2v8lvx20w1lv8mr8ns331zlqqszb953x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18zyxh0vwbyjvbz3rck1mb31bliqb99fl4ishg2xp72y3yzx65py")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "01d725zhdzrb8g6crs17546fm52fhvs7lbf3r0dbr65r8kvjh9ag")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vfbq0rkb6qf14dg2sms2psbi8fzrvmwy7my6d3whhdii2zw3q57")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
