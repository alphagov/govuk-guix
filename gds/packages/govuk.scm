   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17f6c6s1gp20qjwan5bqj3a3ndq8y3smqmh0qcdsy33ykhdbm4yw")))
...
(define-public authenticating-proxy
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bn266y9z59w07cxmmmjhbdh3l6gayszz1r0d00jyr9vzwlrbddk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1al0nnynmwl7d6b921b7ngiz6cvpghh3rrvcz4iijy32a4vgzkn1")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a7ra7d9b2qfbfsj475js1d4ri5x0af72ra65gjiyy6nq5dsh2rm")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16qyjcwjscfmp976wm8mp0l9zmjqj4cbsh87zl28vl0dxbqhn9ci")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1025sssvfkf2nvmi3q8r9h1y9i84cshvq5s998aiizlkcb696lqc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pz3ha86gymk7dzi2ndnhkbmap3c0qh159dzmk29w4dsfbk57vj2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1psfgj8zxbc9nh4s6pl19j7k4hn6kjf0zr1b739bylj2dwyhmfl0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "08zg4mvk7iwa7cqb7zzi2jnvq1dpg8p2299p3nfa6r92xsc6bppp")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1avvzn695ymfxvjn5gnv9j2zc0202vlhl8sz05war5pnwq4j3f5m")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xm9bla7wirciypcvfq7lxwbcb1668j214qqp1da9zh54gn4zm02")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13283")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0as0dqd1i879qrlgy9yq2v0w1cicqy8d6aa2yirllkygfy6wbxxp")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
