   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12k3y4isg31cjpxfazgynza0dr15nbcnxg56m043fafpnwj8g5gl")))
...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "094cn96ccfgrij53mhlwmf1bh9myzjiwavp8jl5j0nglb5fwkf34")))
   (package
     (name "calculators")
     (version "release_244")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0br4khimi6szlpszx0li1v7ilig05q9izl84d2ysn42bwpdf2za3")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "10mdxsznssdcny03zrff16j5iwchkp4cswp07lgnjrlx2w85nvdq")))
   (package
     (name "collections")
     (version "release_455")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hh4mkc0s6x15qsqsyk38jp0isi4a4b5ahjv8q344l8ghdlbaap6")))
     (build-system rails-build-system)
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dkc7djcr22cdg7z2mb15k7vsy2j0xjjhavz35lwn29xfyhh3cla")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l3xa5w2bd4vxsndbj6gkx6rgxvnh22b0lylh4j865ns9rc0m41c")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x930swnvvp14jbcdy0zymwa46c4fpvb4365wr2p00yyg3v7rqlr")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hr29dxqmfyqifgnnhaygl0gcc2qzajf3b788bs7b2ivvrcjfm31")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
