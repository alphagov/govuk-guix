...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1y49ij2x5w3ld6lsh77pm8pqgcdm10wcj4il9g6bzsa97w7yhqwn")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1nahaqi06fd0c4ydiq6mnpxc9vijp8pixcn3ram9nnfsza073b9z")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nwjy6zlgpnclnx0ac3gnn7kd3x2649isgh1xb3bc5fy3fzfa264")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14541")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19bz4adr97yjp8vcjsswdka2cg9pxbcbpgsqfm368yzvq066jb6r")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
