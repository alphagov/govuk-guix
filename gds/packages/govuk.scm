...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n63lc8b5qspnpw68b6f2bbwy2sdl72ag59hzf5hn8fymjlly4c5")))
   (package
     (name "content-publisher")
     (version "release_1516")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ky0g02kawa67ggl9qp6w44ww4i2bzk4jwkcq9va60z5klpr0dj9")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14495")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "198rvyhs3pzp5wisc5r58rr464ciigahv77zf9s3sb7in852w9b8")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
