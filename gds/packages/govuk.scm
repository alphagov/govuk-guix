...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "051c21v5yzxjci3g4p4n43qcl4p10bl3adzrs0fv4xb25fnf7c2r")))
   (package
     (name "calendars")
     (version "release_459")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s75jjy8lad67ak6pkn45h4z15yyhsyh37pfs7scicrq9airwyc9")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13271")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gi5hysrn3avag16i35b4p5q2szc19xw6mm06vg3p8q29vh9c7qa")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
