   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0krk8vihpbpxd012k917ppwrf0m8bzsb54ykiffj22d71k1bc4kw")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2578")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "066vf16whz09rkic3a6j30fbbj5mwsp5aayhndsxych7rriiij65")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12772")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "097azg6kx5v84c25j2ckjps947l89vrz8nhgj1hgdkq0h5b05d58")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
