...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4476")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17vkls2qan65w27v7sgrz9wfya7y6b1kmgc9sqik8xq390hsw717")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14298")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jg5bphmpb4xj2l2micrkb5sh2bvgs7zimgysji4zgbx9aimpx21")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
