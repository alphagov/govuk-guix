   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l87jndlp5qz0knzzx72anaj1pw2bbgz96pb06faii0l5n45jrka")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gh2m7c2cqvs84c9sqxx0m3xl9ia0a4sdq5dbr1nqdf04g3izvj4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jpxxrfw7gmjyxrf3dvjkbspkzwwd0aixry39xx75jbamybq8xcd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b9cyci4q3b2lmrmkwl8smiy52chgw2sz370przd06kk3qbkdx69")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c0i8xbfpzj36hv3m9dy3h60xhcr9xbidcxrjqrr9f9qnxa0sqv7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public policy-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zys1019dvl8q3ng8zmdkszgaqz59mpvjdq2vnn1cmg155xfpr8a")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "189fn2n5cfmv1cmxp1gvbrq69ya3yxma1v8sv1yp1m28zg97cd1r")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vn9pfpxba41q49hizvyq180zc567bhp4bvi91fvg9ai3ywqm9b3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02xfw3viz5czqq2ra7dl52dn7qzk54vfdh9sqfska8wksnllvwq6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
