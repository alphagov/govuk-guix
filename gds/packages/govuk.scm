...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fv9lv91l97dfff49h60hngdqmpxp9xpkp36x73kvc52khvhyvzs")))
   (package
     (name "collections")
     (version "release_335")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nkzqrl3ahw77r2lvzvdsipjwddss3rqd7dqikks3p8wxrr3s509")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "05d59dg1b6g0y156dfj3m6lxqjxpkviisr8nghd524p7ffcwfxng")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sg91ak0zkg1wh9nn9nh48cmn2z22n6wl039nqqwp9z1i920vmgd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kylcfb55bq4hhx28g387prg16kln6z2j5xm2jh4xrrmky96f4b2")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1njasng87d45jyp5krmaw22vdw26njw20j6gvs56dvp3wdlnhc6n")))
   (package
     (name "content-tagger")
     (version "release_443")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j95j2fki154xbsn5dfabq857b091sbwfjnc45kc31z3mid374y2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hin6hlsdzhijxaijca08848c1r2yj4f11pql0fv54df2jkz2sg5")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "03h422qhp7fnpsrrj43310yhs4gc0g7ykp6gkil94rkmmknnbshw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y9r7m7vd6gp5bnqf6kfwnvp8p74s24mp61g2341ly2ymzrfcs3c")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "13inf9niwwd82q45ksw7fh9i83g5gjihnx698zrnd3ipman6wxkx")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "08dfadiwx0r4d0jxx4n6rrydqalhhfpmfc0fqzzka7wgski4n5kp")))
   (package
     (name "info-frontend")
     (version "release_76")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12ghq3i4sbgxx2j5xp3adliravywvz1jhhhndi4wk2715n86xshz")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xr40xqj2skwrqz5pgh72ppgygyr2qpvp6l2aj2x83kkmk1qqzpd")))
   (package
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fr0502pa53mi61v2528z7n0vaf1597v2s8m5q52hyrbjn39v7ig")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "031lg5mlnkab6aas2cw6jbsx9m872m6c8p88ai41l5yw4yv84kaz")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wl116nqap5qklm1pz7acdzg7xyb046mblm7qnqpz4cqzwafmgz9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "05k1p8h9cwc4cjzi9rn88nb9349qn62gr2nwd98ypa9g5kbnvgpf")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19b2xd25vwg6nc65hd73xv4dl1mwsv60h9jyvvyn6qiaph078p9c")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "128jg3b621qrn1cq63g92sk71nmkn6q1db8rhc86ncs4i4jkkwd7")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j1kjkmfsjf0q3c956dvg0j2x3kx0d15pm84aq8dgvx3zmhlk5bx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3638")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vhi6ycfd3iwykpdyzhdlff2bhdas1sfvjign0sfs4060h9gxyiw")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p70k8zy8wb7fv3s9q5mdm2dq0hv19mvg854n2vc344pyfdf8r0l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2607")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ay5qxhin8nmsnlmnammzg6lndq6f201sgnllpr314h9yj6giw40")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18738czqk1pzfr57c5am1fjhnrwqzlzp62iicsl9bc87n54nl03i")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (inputs
      `(;; hostname is needed by the redis-lock gem
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "11agks9i1szrnyz08130lgkvrg10kdqcisdn11dvqwkghhf66ki7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0smbf05wc28d3961lnrid26wgwjx7ca7il1bv472cwv8vdgs9qqk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j6i19vgchb8wi4x7x3m6inwlhk5fg6zrpx1b9pgndlyvbjncw42")))
   (package
     (name "whitehall")
     (version "release_12853")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12rj9b6ibjcw69q9m7fasi8cyah3js9bys1mg0h3liah5s5xvz4b")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
