...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "02hqzswpj3898j6n13jy5d3p54q87xml6mqid2dqwqls9w1jbwqi")))
   (package
     (name "calendars")
     (version "release_552")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x95k7866drgvb6wqc20jmh6hyqz5m1q9dgwrhykik6zdgnyc9m3")))
     (build-system rails-build-system)
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1z3np3qng7v4f2mi9md1gbqxhfpiyj4a73yc8i4nq8j07mh5hbfn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x9qridnivcyapcrxxkc3l3s4qsmpmibcwdv783gr9b0qpkhwzl2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
