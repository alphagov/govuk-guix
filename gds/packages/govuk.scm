...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jfbvyxpwnr5apvqds0kqjjksagd1zw06181mhm3y6970vv51b3n")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06llri7fbgnzrvjrpfq9c97z2c1vaa4x54k91inr106grny0ls4a")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ybpva61r5fjf23q7am5prbhz75k4inbiiywg4i0bqism9l25gww")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rmm3fkpbpps87zfkpmkivl0qyshk1nglizgjzrk5dvh5pcmjgyq")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hk7adh0bpz1f77894z0kxd8qb9nhmrzy42048qlsl7val648yd3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jyiq5ib6zwv8l9zccj7xbg15i268ar0biqs5ligyg12x24wz2fz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04j9s9q6ich62kamyk3aapbh5n8848izf96qri4isa6xwlsz9wzn")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vfclcn5wi7cbbv8kmgppz63z9mvhjh5g069c84y24zj37ghvp5j")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "17jvh0sqhlqg1zrkhjl5dvf6nqg6bspgrd2saha9xzbq32g3sahp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ahpdfq6ikhicvglbpwqw9l0535spqyaagi9ykm77d4530qwr41h")))
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "082r5q0xf5m5x2ypjglrl05cj4rz1fqlfmw4rdhly6kaghqqnyk5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "137w464qnicq2kqkkaknq0v72b8l0s45nlnspwjdhaisp997z9fd")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3076")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1im2nd4mwizif3976cwq9fbcpih4r7z7vavc7nxgnbx60c949mi5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1m6daxrsvb38fa5slv9n7d655s0cplsfinzbing118j12pwfmxzx")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jb9i5x9cxzjhs4f770z9liagv60a23wrlwrcsxwpcx12chvzc28")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x80vmqbfk29nryn2wkk2fjwzzz04iyr6cg6pdz2fyz0vqczamd7")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "03iac9kb85np5whjwg0b2wjzgknvgzk9ps7nsy88zz773pyvm8w3")))
   (package
     (name "imminence")
     (version "release_484")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "149wg7ninhigy2yi8bvgma22mrcaaifjkckmndass3cpak0ipxy3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ssbc0y46z716z9nk9yc32qmvkwgbq4fzy8b8vxmdy9naniy8r9m")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10yr5jyr44bx6g9yxxrawzahk9fqsz5bdgzl3k4q7xhka5j522zc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zjpqbq5zn9pdm61wzzxrfvp7fnqcmac28n45pfk5v5zl64lbw1w")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0jmcilmxly48kldqzqai5yf0b352jpw0jqkdxv4mkj3lz6sp41c5")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public rummager
  (package-with-bundler
   ...
   (package
     (name "rummager")
     (version "release_1924")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yza979dmdqp8brzmybgpvn5if8cagzaal2lp7nkd3jwn1smn4kd")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "08whbcsmmjvw9p2307blbrrlnx3jqi0b7y7m4hp35ggy11gfj9mb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16nm6rmdmaqpyzclx7yzd3h7l7qgph5isvx0i5fzj9dgl3abp4wh")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "14lpcx24f8q9yi6h4ayl0krf6zpghs6r3zhv5n49qqnbba3gcpcz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06m5990b8faj7lqa7f1wngq4pcp4zn5b1dkrwlkqigdjmkhxs79h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h2jlp00iavla0r63g768qxi3gxj71sqzw9y1as1arbdg1j7czrd"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05yl9f42rzswgkacrz8hwbrcbjim8kb1a58i84zax9bh2p1x7gl9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pvbs0byrxh378hn8a09bzdy93zbrjpjw1512v352naz3fvm9qdr")))
   (package
     (name "smart-answers")
     (version "release_4237")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "041wimawdr5lykn25jdwvd5hx5kickz5g44lmpr4f9lzlxdvb99w")))
     (build-system rails-build-system)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bx8da6gdjmwalb4khfw1hhr49mvw17m6ddg1f9rwxl0q1ip976i"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dfw0g9f5dixm1f493l6c02r7c1bxjjb8s53pi578cj37q5bqnh9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03ajmcr2fmsc1628fmj7q4kcacx3ql7s09l8wxpi18g3k5vwc00y")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "17sz7zdv7cj4xxy90rk3hkj6p0h0v1x2d20azkwxcqkf7yn3mqy2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s8zkm603avr0izx15b4iqlzjhxnznm8s1fzn19cjvbj3y5mcbw0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
