...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1km84qicblnxjbmn0668lzasixr8s1frqih54sjmgzcicc3kp7s8")))
   (package
     (name "asset-manager")
     (version "release_431")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q40w660ym1qzq487lqhilajci8hj76m96285hd1v9lkh5gk037v")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "088053b18xhwf1814amx5jfdrrjq8bmb31nm959j86mjgmqin1fd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0s9yyb511yz3c21glkzm7dajn28jjd4dwbh662pmdawgkibpwj6l")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pbmnzkckkcdwxf7qk5zpw2d3f64x1gn7ww5r4m8x5l7asqkb6pw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1659")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "122zny9h70m3lrs3vpy688fxlqpnhwl1njcq7ajagmxpxa4mmzr8")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k8mf70cix0f3i5ifib8n0k0ga5vvxy56bxw2ryj1k4n7n96r40w")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x1mhksmwgm3gpfzcmjkz6k0r7vna4wilw7jbc6x1mpf2rh73naj")))
   (package
     (name "search-api")
     (version "release_2408")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q3zwajpgiil5gfqyhb22pmk1sc79d7g0ffyb2755invzxhhp6y6")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "12q2cyrcmvcdmcv9qgghjx49xrjz7f14zy06a8wnm5azia0z1n5c")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06ishx32lf3vds4xf6qylay214hk4imbhbbnwxrf302pxvilzy6k")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
