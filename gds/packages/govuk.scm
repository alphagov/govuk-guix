   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zlgbm55mg0kr7pf9q40ij355n3k2cjdnp8xqlws1qng058b8zaw")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05z90gn76b8gw8v23c9w8pw1spp6q0ff4gmlkl6kh0a4v41iqz6g")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13232")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m9a48qgx2b8nq64d00q20m3k5kdpgfdcfzy5xzjwmiqhrs3jdq0")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
