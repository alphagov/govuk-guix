   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08kcdz5lwrc25aysvhhxahpjp6pa2p4lmc5y44jpcc949wqza4m2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bncpkgn4qzq3ncsgismd7qyhp8pxx9ifvddr7bfdasgg1xwx98z")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2621")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jflirqy87893jhib1cshxyfqbf1rs991cjcs0ks1ss0rlp0nfcz")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12881")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kgxp8dkjncydjvq85ma25gchw4lqzjmdnhm8jr35yv7jwfyskff")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
