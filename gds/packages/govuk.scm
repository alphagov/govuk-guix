...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0il0nrxl8a3k4nqp22qs7kyfk6qh75n1mxwfl1vb7dmj46r02k1f")))
   (package
     (name "publisher")
     (version "release_2018")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hx43kgs2is1zignq56y46kaxvsp6xaafn51sjhv9a1aqi1p65x5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "114jcs2l5fibqb5sfk7pwbjw14j9z483mr8jr6blb4n2yi90iyw3")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qhqq28rc4cgkzj709rv3q6249zynpsff6jw0azmn8nxcjwibfb7")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
