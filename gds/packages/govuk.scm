   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g009df67jwvqmjnvd9c2pmnq1vhdn04nm4j0za424hm37d62jk1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xjm3lhs6h7nrmn393b4yqwy51h9yz50vyd2n9252q6140bp63q7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qnl5ass4ckjfbzwpq0w48k3zpxcydbpfdikqrikpj90ybchcf19")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license license:expat)
