   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18q2nw6jid620p2zbfmzqx08ww5308bkgysl07ac1rhq4lndi8yq")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16a6al3fp6b9c2laliqfz475glxc8bjdpr2hxgalbrm1v3cp0y1d")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12822")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ma1g7j65wdhzcbpzabbm63nfffglr7a7hp5m3spnrgkrj5ign89")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
