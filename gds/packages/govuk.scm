...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0r7fq4c376b69bjq7gzhzm1kjkikyr6fjc0iaim235y2s40aqzd3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pbp02qliw624517bysfkjwkbfsh7wbqx2mbb2qnsr7mfw5b3cia")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d96isafqvs8ysav5qgl3l6zj5pah671y1j0fj5v54zkl319crla")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "15qqf4nhpyfkp1kqqx4z2xhaahb2bl802l4vbvhy4i9zwvs1j6n0")))
   (package
     (name "static")
     (version "release_2562")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00x3mgarz2xchcvl5n12w9hsjdpnmp3snzhyvhk58rislsvi32fp")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
