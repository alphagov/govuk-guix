...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "14ngahfnqp6hff9whmp62r28x3bqxggw28ih72yh4v3q8jf8p37r")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d42zff7a0chxiyly658bvzqmv5y95zjyfv2zfws6h5azi9aymlh")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p62cy30mpyzjcr0bgravrb0v6fbgrb51qg51iwml1fpal8fyk0j")))
   (package
     (name "whitehall")
     (version "release_14075")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f7a8j2c1x2izrvkh4qgamf1vnb8pvln1dhiv32vqssgbhqqx1lg")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
