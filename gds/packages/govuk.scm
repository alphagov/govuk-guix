   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11l8qxvnqjn622qv45hsyj8nygfjr4nzsdzf91qkx5yy5ivxp4rv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1la3sh5219mgvs2f7zmdxbi4kxpjy6x9g6yabjyafl4rpk9rv48c")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "12w6ss22nkln80zy5z4mwp1njq18gk37cd2g9l7i82f749703rss")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mdyw4qxwwvndhdjal4yfifr0ypgv4ydihkzrbw1x7rc1zzy3b0a")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1w80dyixmij7pkay4irmx9jwfy3yki89av2317i4gj5wrn9ffmr1")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m2qajmvijipiaa8k3i70d0qahpqwngaq4nwlwf51sffr7xb7in2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ix8vi8lr8iv5bzlm8hr7v3rfa2siwrddfsh0nx5d8pkx91b0rdp")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rdd4cikvy29avjazsxfmlbjmvkdnj2zjp8mjkmr5m7yikq9dprq")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pfa6hc65k08047wsjn6qyxyf6fk049g18g941acjasdxp175v2j")))
   (package
     (name "smart-answers")
     (version "release_4210")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lsmdwda6s3risl9q0y5gm30kmc9igznpsxzh6xq1xs770ngwrsw")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vjnnrm3ngdqx8i9rv00rmhdjq9dp3gss6972lxvpjzllrk4p6y9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bwcafrqrcgia4r79kiqprbh7s341hwz9qmabgnh3b4awiyswr04")))
   (package
     (name "support-api")
     (version "release_247")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xgc5kf1xd6facsdkqfgbgmf7vag5nvhf8bs24bl7h2ag3887vbf")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
