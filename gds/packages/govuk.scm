...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h7fl517zfxsaymck5xg7zmz9rfw5qk8bicn3kin0p3zra5q9wm3")))
   (package
     (name "calculators")
     (version "release_388")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19dlxzizx2z30404nfmza7bny5mf2x840187gk62hm0x3r7m98bg")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qmm6qi7ki29cdxzbzgbsk3xfffqfil2c7iydbx4gn5zvnwbxlpm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "060ngl3m5qdnqcs5vjq9jhi6g6wrm7xfxsbrg38gjygaz91ybhsf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06sgm4cdavqhzlrfbl8ag6skc7v35fgr6n4mg0kkpa55my5vxaj0")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "04z7lx7zn9crzzrldpvlalpcj9vh0pq33mvx5997r6cw6936xvh4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gngmbaxrippbjdaaklz3s67497lxkznxdv9358c3bj8g9ymy5k0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "01gb8ig9g6nhl1ans95iai2cz1apkni6wx8spbcdb3cp33apmj6b")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gcdjwqxlp9fnr5lrcph5xr403zlingrg5idrxd6rvv4apywn567")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
