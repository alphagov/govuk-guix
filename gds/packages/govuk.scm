   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hdrb1ipw8dvwhy4wfh96b66dpyhb9z1ygh888b12s51yyzrh9jn")))
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0azh4z2nffin9lqymqkray36p027cgvp8xfmpkild29dvy9af2d0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i6myx55r45kc1vfc3vna5rlniysq6g3zhv2kfgms09vph4wxj5h")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13gkq7zs7kwma43c7pbbn0p9zz81glpj0xyd3hbcjjf7xvkcpnwk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "15bf6rjr0c8bf2l0q2h25vs6y3dxdp6wj4az83m36fa2n1lqq90j")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lbvjralmjdk859p14am7n5sl44a6vmn8m3l3zjfljkhrrqbdxqy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qyk3pbqf3qv5zai1fhs7sm1pqghxbig789nz20kdj1c9cx910y8")))
   (package
     (name "whitehall")
     (version "release_13199")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13ip879frn0fya12zkbbs24j64lsl9mg2pricmzfmk3b0jcqk6m2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
