...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rv8n8xz4nkhlygy6jazhwqd2xbz802475md7kjj0dqy7jy5n22y")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12sbv05ikhprrrxzj2a1b38v5lszz876mq8757lyxkf1n11zlqx0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license license:expat)
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qn3pbp2mxwpbsdfxai5499azqv938hmcdwxkx69iy9mi06nxixg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gd8bzbiqz1rhqpm4amnh70dlf0np8rrz94c01d28n335axm9gr9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
