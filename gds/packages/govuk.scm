   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ahk5n3z1zaw6qavlc901n3a3k3b12g02c8gwjz63w9f5m6z1j94")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r9p270qaxh851a265lyjzld4h6ry1jm1y37vzaz5lwpjncl5cpn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fjikzg53liis90k3703z42ksbgwlh0yknam6q5il68as1iql270")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qalhdz4x0as16w020qzl52w05b5izw01xql61a8nmwqqa08zg26")))
   (package
     (name "maslow")
     (version "release_356")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dfi86gnz6bnp5xvfd97hy28px7s96jph9fcmk16k4danfqvf28v")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
