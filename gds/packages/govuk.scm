   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mxlg2f9q6lv76wayp3yxgksyqnf6i8f7qz05pqwrfs4ag5mwq8q")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dihm030vb7p3lcpysxnshf9x8ra8fxwn7xnncm4ma47dl35ab9z")))
   (package
     (name "licence-finder")
     (version "release_716")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a65hygxlrw2kw9cs8rk1jkb2gqb81cd0awv84gcz8kzwnrzx7rz")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
