   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n4dldsv4aiwis5bsibypbd1vxr67m376kfrid46r1518azicli9")))
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qnr8xp0vpmm2qzy8fwahwhrzmddnjnfg1smhmpzpm8sqn4zbbz5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xgifkr4k60fb4lj41xybh0vs02qyh59xf7iwkd7b5y7rfnyrmsq")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1691827m73vl4qgdsxbynq6dhzss7687s8i31hf5ngzkshmzlmwj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
