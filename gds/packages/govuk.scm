   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v77frysvmk2cr2hfliwv7qc7ymnnzqmwg2ffbzkncv4cihd9gxw")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ia2xxzm1z1dibvi5hzbzni7wvj1pf179ybc48qxzx72k4pwc93r")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08bs2mlrf7rz9kwyhz01lx9nzv975xmi0qpr6v9vyicsl5b7hs0i")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h0i4dhgmckara15k2150r6pqb4h2sra7ynq0k6hzxy17zdszhla")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hdh7pyc1pm2q64nqgbias116j9bfkv14kfsd4ldxpzrk48ip6g0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zabwm09j4hgg48j4flc5715ayqglqjzxmf4zw5a4vs5pc8n2ykp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p5y6nhs5rg7v6qkm15ghwxlclcyfs45jg9f9c3ia0r5xys6yzrs")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "174vyrz9dync519zvb0z39ckzq4w2j1843v2q2mz5cm3clq7p855")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0100bkdid0wrlcirw1wpbvalychppik6slgv2vjjd3g62h49y9zi")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0iccd0vdr9ky1c6nsq9hgdma0yyy5k8481sgh87j8ia5q5dzm7a9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01hdz6mq6r6pcncs2pfxmkvi8wv6p5zq2wkgn1lxdkli3rbm89hc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14181")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ng7f5yf74sldca891505pq6gc255vi3r2q1zgkrjfjzdwpfbn3a")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
