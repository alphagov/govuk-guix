...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q3nfrzs36416lhlpdkzfb5mihq3ac6cz5w6j3arrj30ywawjwna")))
   (package
     (name "calculators")
     (version "release_662")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1223fr0a0akv92k00djfp83jhry3b5zsbp022iqs7xx4xjs59wzp")))
     (build-system rails-build-system)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hm07zv5fpl550whg2pqiq9fidfpvyxx1skl6rpra2268fpb65lw")))
   (package
     (name "info-frontend")
     (version "release_490")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vcyml8c292m869hhjjrp05g46rag2ay4fw1mqkdl6xzwygy40xp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
