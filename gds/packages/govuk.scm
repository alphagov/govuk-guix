   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12fmwhs9zvygz2vzmj2y0cvg4ylvy2s8vdfd11135l9mh6wlml4v")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "031fgjfqdzvcil295cws0vhzrj6a9p1jmgjkw242i26gl96gdrxg")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3822")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zlvz2synfqrxa8vn00i9xhs7ig2zh8rx3xic5iyl49pfl17x9cg")))
     (build-system rails-build-system)
