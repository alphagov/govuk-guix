   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v693cd6hwcy405c2nacpysvpsrg086qfhv09k14nf73izkmba6s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0j64wpzy6av0x8qj6lgvzp09jb19ka23wwx5sfn4naxyhp8gxj0r")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mh7p5pagxnanx3wbz6c9ch9k81ar5pldcghqp0hri00jz5xhlcx")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "054mz3ndmbyvz5gd8nwb29fr20iivyj0bq4azzzar298qp2cczd7")))
   (package
     (name "whitehall")
     (version "release_12735")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dgq5jrpq2ag424jx26y75sqs3qd3hpg1qbrnyhyj63dz6fd57rr")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
