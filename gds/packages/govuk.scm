   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1makr43i82kv7k8ffxy94hal1g2hs90s68xyi5c3jcmnnfba3jw1")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z631wzfpcd6308ribs76p5xp1pdcb45x7ss772y8k2xymlxlafb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0anc94km9qm370lqhps6l4985v0ydy3723ippxlf8v1mmfy4rgkx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b4ql6jks1k6yyrqqryrnxn13g63pip2iqn6snsvhs82khpgn161")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "12qjqqvpj0495j7rf9xj7ywsiz43dfnq6m5603pn8r88nbvdrydg")))
   (package
     (name "smart-answers")
     (version "release_4033")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v9fyj4nn6ajjhcs6bb5882s2p95skbd70bjhrwnxnjyq7gysd4k")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13612")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07gz6sw0rnyrc32dyn94vyz6bb13q6dnl8yg3djaghl34yrn58px")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
