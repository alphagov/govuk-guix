...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0z9dc6ifxhrxrg6vwjhf6hwqy8pvn0vp2vkcynx8vil3s79cdzxh")))
   (package
     (name "feedback")
     (version "release_690")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i2sc9900vhmj0p7l1ync7bmcyp3qhcw7xi5pydzb5r6d0w929kz")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ijgrlvzkhi47lrw0fv3wj6v3ynibvm8h5f5ch1fr6byssq583wl")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "160jmg8rp9801xh5vnjgxp8m6c77fa7qf78xla77wa08s1qr53vw")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f58wq9plv0q754xjd82pkidxxzal2d5cqr2nzcryfdq0yzk4sp3")))
   (package
     (name "release")
     (version "release_452")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k7dis2nsh5ms1aylgnpqas1cb3mr87wf96lym26hxj7awj88zw3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vib77nymqdv6rimfvmb3v5majxzaw8abqp2q2w9iydkrqkgv18a"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cb0a6bw6psl9hdmng3qbmlpwsd71qvbfgnc1dcjk0d1s45wlfdv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pcpzb4zlqmrk8qmjqn81636lyrs6qi66kgv6nhir7s86skaiyb5")))
   (package
     (name "smart-answers")
     (version "release_4377")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qh74cw9c3h4avxh6h2lvr5zzr1j6a0hphjjvpb89vlfxzn2wq57")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fildxjqbmvnhdzzffzzhnfmhzdvj0isbynb11fa0m7sr038gdha")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dycx20q03ykfw1mwqnkj55car92lmb1li5mz5djhrghh5mwzw4w")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
