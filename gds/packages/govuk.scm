   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16gn42hy40am1lxz54g1jsxh6jf2zbnjx0wk1jsq77zs7q9d8hkn")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "17100a5i4wykqr7l6i9mhm6z28qimz2zk8ggz6dkwmzb6qlfdjwf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16ab4fyy8xchrly6286vgkj0yi89mmb0bjxn6mx4gpdv673z6yws")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xqfq69agsz7smhxqrx5pqc12vxdj7r0hc5dvnvdnk5inb4y9v1r")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
