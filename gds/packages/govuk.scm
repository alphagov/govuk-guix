   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xmr789ca4i7izw6d5nh64w6zzdgg5ajyill0ajagwlg1zsar4h4")))
     (build-system rails-build-system)
     (arguments
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jw1xgmwd70qmf21ah3jafsh5p96nxcayhvhwpw525iakd5w277z")))
   (package
     (name "search-admin")
     (version "release_218")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07qadhzp9r42di06pb72z8f0pni17rjfyn7pibj58apx0nl5qzmv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nx2nrngmzfb28smqz8bmhjkgadvva1vg3y2graqvn0la4cgq1yh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10wnnpsvilczrbzgnba4s6wqfh5828aazapvzl3wh8r2hyrmn1ma")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "00bglxbh70j9ifmrd76y032c8l9ca1gr3bfay8j5vjxxq51vnlkb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kdy70jjfdkrvclmxffjpkl37x1p1vf926b0wds43hyrk42x99vg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
