   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03hja7y3k0gyi27d99dv5m7xf37hjhlbhagnwc74sfkm9s9s56m1")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02qkgv8q388m4yll6wfg60z81nj4v3nbpcaviysdm1kj3wyxyr71")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10gma2cz3xdhwf5wq30282cg9nhbipgb7zsd94sp23jnz1q5za9r")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "02z6b5vxdyfacfw7jd4akbzflz59x8al33y11124s4v3lxqak47f")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mx49zbqgi3ii1yvxxiq2z69iw4a90mhk3psn10286na5nid54nq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
