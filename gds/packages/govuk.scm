   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rbg7097m3iajkqvfmlry1a9a45ys77pwxnmqjpm8dl3adn2sa6y")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rfxmlafgaxhswfyhpwsphz7ilr5q9nh0s8gp49xhwlmhbayv0ha")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lgcrndz95h9wc2n6c0k8ij197g4vp4c41n62bdaizp43a9kffmm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0425dd7gfwmr45zpxfngwqacq6wc6q4knb68l0anwfmcjvagzd4g")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v4iqrkpf7fvqa8ppjgm4j9p1gl4z1mjphmglsacssm8x5hxj1n0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1nymdjq5ddyqbw0wi86wx5azbrwhq17sn6iq2dr9z1x1lfs3wwr1")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public rummager
  (package-with-bundler
   ...
   (package
     (name "rummager")
     (version "release_1827")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v0yql1f9vp8fd03sk5gk9hpl0z4ycdysabxnbg31akdbwl2cwn6")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "010zq7byrb46m2d0akj8274lba5wh4my0zm4f4irffr5jc039nwd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rjrx3n2kfhjwsx6ihii42vrrjlqwliqjhd4sh5v9h9kq1s80j25")))
   (package
     (name "transition")
     (version "release_863")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jdr5mcwsp3s86nx9wzlwfb1i27i25ljvswjxaci8l2dc2qjc46d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13846")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qyp9c6d0vv1kv8l00m83ac6wi3i0p5xqv90c3mxkdqgy64d8x71")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
