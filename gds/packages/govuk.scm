...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "12r07fdwjcb6gdmy73f2mlvc09sfrz2j7wjqwsmgjs33sjikxj3f")))
   (package
     (name "content-tagger")
     (version "release_839")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "148rmd6zbcwaa0bhm0biw6pi5m2q9b0rl9sgsh38yww3i6889bga")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rh51rv1i90k8sb6ziqa1zk3xgp18qx6x8k7cqv6hcpf752h5iir")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w25nhld9iwbi3dl0x35dhvfxi65jirifqxjbvdnjlfmz9ibkl47")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
