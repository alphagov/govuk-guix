...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kdcdv8gwbqqzbwr3g4b0lzy76glfg7522pv456phdrc9qij50jg")))
   (package
     (name "calculators")
     (version "release_685")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1064hp83kav1c8gqypplzxxbdx5gh1adkawg21m8gpwb1mfimrv4")))
     (build-system rails-build-system)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "16zmgdadg1vzgq78va4y0y0kjlwv3dj6d52jdyncbkbgl5waqwbk")))
   (package
     (name "feedback")
     (version "release_839")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n1nk08gdfbvjj1c13y0c4xbr169937vi2qrddng3f6aph9v30jp")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h9dah9lghxcwc22d5rp25c4j0772jk3wwhdmlfc1ligk36c4px3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05kgga2i86v9rc9abk4z3rsm0yp5hi5zj3lq4alyl2aa76np61bs")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g5lgbb8lj79pzz60i6gh4drs8rf0dhymkqrkidb1c60v3l70yg7")))
   (package
     (name "release")
     (version "release_608")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07fzci3x5dcd6zj1vmchwmg19r7vqyc0mi2g04k0myidgw3wdg4z")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
