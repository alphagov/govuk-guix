   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "177r6g2da9nnvxnwfmbk3sc1s66dfy7sxxlxq7yci5a4rwd55yv8")))
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xqxpfabfv3s8kzdlzf55w2gm1v7phm29bkfvwqw1lrdcp7xabjh")))
   (package
     (name "collections")
     (version "release_352")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dj8l79yzac1shq81l6dv5dqbkrzl1qzakgbknwnx9y0l94mfl7i")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "02iaaijbpj33f8wrnyby9zmlr2g1pwr423lycl1qymvcz1vv5b7c")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06a9zgmhp3yd4w997s8wq6q90njgjbylg3p4n4pkhll76hjkx87y")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bild5lrqhia52a72z6grfjjv6302wjh112rj97hb51gavbj0qdh")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07j3nf39v7lar36aba0dfirx1z4si6xkqiiq38l5v0r2idv2ik2f")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06m6g7nhkqqkr5mrbz64kdysi238iq1y2xfxy7swi3808aqk2xsq")))
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2718")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "149gq88ldn9ldbmkarzj9wh8rvd5x47s08i1g60ysn7xmxa2kx72")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "11ak3zilajz6hgsh78csnjrcab2kpxs9drkppimj8x4kfb7iqahj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06h8qqdj54fc0vgx4q95fmijc3hx28bz3mp95dhxrqfviirvq7sa")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1md5bfvnxiw5987y3j3wfyih5585d8xyb3hr3wjgk5w1l7q2692x")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j8qz5drs69l4yv7nq09mdkr12cxf7lqjpv4n2smjis7717n7a8f")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lnrbr7l2w7laarcs279c07ldccyr9rf0x6vkvvn4vzpg6w6l96q")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0gpsfrd9la01bxmxxfjlzbcl30cxxcwbd2j5vcvsl330jnzgg3hz")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "07rwjdicbiirg8x0m5d7k8agd6xq5hgjkhmhd3vbz7xpzhlhsgkj")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xqz82fwgmddknx81gf45rkznp41az5kakb76czl9g2nfs2mzcla")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3723")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1snb2lmdvpprm5g3bsp5kr4rz8y56w6xbp94vn6zxm3gryhqyjd0")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g0jba7ljdgm500pkm1c2552hzb77khy1wp73dd0rppqa7nhs956")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2645")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19ybbryzxl6zpj4fiqjljdjdzxs6d2dddl4hya42v4ah5v4pyv51")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12954")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qyl8fsx9s38fb98h6zzdw0adwa1abcvcmy10frs4hm7qk3nzd61")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
