...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0i6a6hkxmzldvkz516mxk4b0qs9bi3smnydy46wfsdlbp9iacmp1")))
   (package
     (name "collections")
     (version "release_862")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l1svz83yf04rgf6kd5zxrqlagfb3azj5nqs6yhlr5qkpvnm0644")))
     (build-system rails-build-system)
     (arguments
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "01snxk7y1cmw3qd3srfc4vld8np1nx0vb9ihx3cz9138r6giv9w7")))
   (package
     (name "feedback")
     (version "release_638")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zyfs2zhcwcbw6srgvkd7s7g8qjdjrjby10kqln65lvigy2zdjh2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
