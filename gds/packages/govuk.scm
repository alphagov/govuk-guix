...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mn85c6fjrxl3cx62h5995mz3a1wilckmvdfv6mfr7xa9qzw7vq5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19jq32vl4kjmrgsq96a3b62xqf50aqdbjsdkvzq14xl0hvfis48j")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gz75zk3849symwxhg6hpirn6dskwaf6asydnlvyr6z5zs47dbq5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13772")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09mjgrs727a05hzmc00znzmldjbcqifwf98dlw79rgb22qyjwydl")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
