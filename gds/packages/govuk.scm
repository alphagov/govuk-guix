...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "11ag5gqycpz6g7vg9nd4nz8nfm603vlbxqh1gqynj3an3mlc80w7")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hpc519r1apgv83dmy7i24iszqf3g4bashnqn4yfwsn30bs36jqs")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14855")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x4vmxfw4x61b014i3ain5qly6pp3n21ycl35p5j6pdya664lq9c")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
