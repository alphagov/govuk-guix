   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1id39aa11l12dqbb6h0q5zf8pa68md95drcyn3krjzjr2lkjr562")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01raxhm5wrc6m8hv2hp7lidq5kb4s6ky5i9hpng4f62wma2gqg4v")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kxba59vrix4fhhl90698qcxcp378ya57n2br67bns4h9vjfxnm1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bk8nkap1ihwwbjic45nzapwk7vhna7jk64mwn9w4rip0lnfbf7i")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "08x9sx1i19xn75y7y1665mkcf3ajrfmib4hd5wkvgh8rfwzrcksa")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06nbhwv69z5ychv49rpbmpbsjaap1riz92wg6q8x07qrh6yxyp23")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xkwlp9d550s9irjd3dh6hxdjsx7kpkisvp8y94w0kdqsrqamiv8")))
     (build-system rails-build-system)
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r7xlvic43qcmlsyzcgp2jg873x3bnwgx8czx7893y8nsc61waap")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1acdx617lbgz83824bkj0h9qigfinl7g4p3a5pdc2yka49kssji5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h1fxkv2rnxa8i578s3k3kqwm8bz9hqsi379gha76ql816q64a74")))
   (package
     (name "feedback")
     (version "release_576")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lbh8x9ny0jhd7nsd7nbx16r3g5lfyy0rrpdi3764hj4yy41psnk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g6zg1cjjxl806xm70d6yj1awwq9rwr6cm8m0wlgmsbnzkyrwyrg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01y60cncflyk4yzmvnq3cgbbvzjdxmr4w4s6m39hg1qfbzxfvgk4")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fknqy666zr5nh6rxf4zyz11qp6zwwkb15f64vms0rvfj29rh4sm")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1273pq3cyvyw0732qgxmwhg4clmdgsc5hhi46z0lx88vq92asvm3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yys29qw9mdv1ysiwrmn74489h6r5b0mn9j2xwmfgpiv5v2bggp1")))
   (package
     (name "licence-finder")
     (version "release_511")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bybg3rf476l6rqxdgphibf8vdbrp47zghj1816g0zbldz324vyf")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1cy88zpbm5azjvx4zrvcpiabq0ppg8qdywhx5m7g4lz0ap43l7cq")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "145n8ws80h16ya6g6lkgjv4l3phmpy5gdjry5ldgljrl835547w1")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1v4yah183av61hfzs4vdjh9x6d4i9xl51jnaw4ikpqp48y1rn1in")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08nfz70823b71acz0d85ikbphs7m63532j0lnhlr56i2y18a69ry")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dqfcmc51p6yhf67fn7ngvxyyydjl5v0b45ps8hyv6gjcy1p020h")))
   (package
     (name "smart-answers")
     (version "release_4182")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yma3s36g1dcc37skb6nk4n13czl8san6wzjgn08a90rqd5sljz5")))
     (build-system rails-build-system)
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qp5vr0jg8cg47z9fah8ggsbpp6jw0shxkn14mxyywgs609v2888")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hgfx8zxa3l7p6avjimfbm367cypca8l12hps4k45jvb012239qb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13894")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ar4q2rkp7q762gqncfwj6sanz4q5qa25m2n8yd0kf0axly5lz2i")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
