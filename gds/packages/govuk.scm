   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zi0v1cw583n10jzdhqwmrj0jx9m2zrvds3f1p56hv0hkcpgqwk2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09y8saf25zk80anrx1qkd757vcl3nnfksq4g37a59agq89z3gray")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07dw0chk6smir4c0xq2nyvgz3plcyjfha5fj91lrgi4fq7g8p8xp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13015")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "134r89whmzdp1sxqm9kvgvlvqbrfajmzvyjgw4qxskxicc0knfdc")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
