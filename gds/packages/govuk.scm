   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yjsxwyaz3l3bwmh3ykspfdcbl178xsgd679hk3a2f22bfj9fh6m")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1snxzncg5b7mlfvz0ffkwypc6r9jjvpj1ya50b50svmbbh6afixc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10nx26rq7dhshcwa42bs2xhsmkb2x5x21zr1bd2l3y2k5jl49nq3")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
