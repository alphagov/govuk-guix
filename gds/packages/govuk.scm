   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10avfnbgar7hkqrryi7dv6f9f3070pbs1j87lwl5d9bfxlh0drda")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1814f32mxsigpz7ls3l994ipdnbjkdbcixsk83x57zbkrw2pn4b6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vjiwdxkgclr6w6zlgdsznlaqm8cg8zcwva4fmp4ffmldc3yrc5s")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06znvbnhavn352rzy7xgwdazr6rpgdxbiavaaskqvvqx1bq7d3x5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lf5f41k7llrl4hfdmlc2nnr2gixr4lzdrv6az6k9g6s2k08szwr")))
   (package
     (name "whitehall")
     (version "release_13663")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hnlkbmgknny4np6y0p4vpb09mf5zmnsvrdb6d7v8h0z7gv7f9cw")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
