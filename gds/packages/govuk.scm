...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "19pa74fzavnwadg00pd4r91m4pfknky8cka9rzaby3yx4rjj540k")))
   (package
     (name "calculators")
     (version "release_383")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1whj8vr8ssa0157h4ky8fwxxidida2srzhqfk37m0q6kfzfk4vr6")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "00q3yy79g5fjcln8g0aasrc6ds1bkz3df848j810lwpqvw6xpkjh")))
   (package
     (name "calendars")
     (version "release_597")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sv8rhmihag9arkfs10i87x6bncsakym9zwffxc3zay1bmyw48yc")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sj66sf09cg8lq8zgmgfkcsiznw3bnww73yklp2igrd9vznq75lx")))
   (package
     (name "collections")
     (version "release_712")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zikh798kv3n7ffrcvff7j76hcynfpd567m13s6jq2kw892zk2a8")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16nzx4pyziwx2gwd7s70jcnc8p3pw26cld73g91rylyg5wk5jzjf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h6891ii4ziz30afjb50khscasvzr7nv9ipr85lxwximz5wgjk00")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0slzll5d54p7z5f6warvvv3chrlh1v0g5ncd0d3zm6kp6c4gy5wd")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0525mkr4sg6gjnynnc2qgy3bwws0x8i1pi0q79dz5l6kmjg3cim2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zcj1h3kgggmva5qyjxfsbd5j51fxqiww07l1j3cgvn86ag2wzkk")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mk9s44zgla37dv90hba116pr620pkypmv8a849i6917andhaqii")))
   (package
     (name "smart-answers")
     (version "release_4109")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ynj1mfsgkigr6y4fm28g1s41hmsr628nw4jp71zf9nvr2j30qlq")))
     (build-system rails-build-system)
