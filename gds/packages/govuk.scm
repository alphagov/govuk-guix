...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qyks20kwz5a13m1gq0apbc8cvlvgi9qghpl086gprhyrczrvflj")))
   (package
     (name "calculators")
     (version "release_758")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14zd581j0gk75yd44kyd4vldqqy5l9dg0jhacg3hwkrq6fj3s6qm")))
     (build-system rails-build-system)
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xznkhar0macmij7h4kh039xp9szv6jcvi7kqnhw0a2b035l7b4k")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ly4mbszgaz3r259001sjdbnbppj4bpx5ylv9v994nk6c4aygam8")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s5labq6bk89jfxc3lphq6lf0vj9qvpqg0wjk0qxmn4mwfgq5vp0")))
   (package
     (name "feedback")
     (version "release_907")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fhajjw2kjjdanh7ysz6zm3bkgjngrmqvvp4fd2m4l2f5jw2p8hg")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h7kfh9cls5rakdzf7n49p3sniyg8zv05hh37hi2nhgj5dlk806h")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16flqqmm1ppg62h24m5zgdfv0kry8q6wsg42haircn23lx6a8aqg")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ni4iwmynqx8qasbxs6ahxmrvgq610x1vh8x8dss6h4b8b6wx7x3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "052k47l05b809yyapm01vj5kk4c7l8h6lwcy4cg59nw8gzsbhwc0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "13r9iz4aw50f1ypcz2g7gnip3m1gvgiwr9zli15168c4xpd2msjw")))
    (build-system gnu-build-system)
    (native-inputs
     `(("go" ,go)))
    (arguments
