   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1903j80ywhxxgispvkj42264gar1210s0gz40qbjzn06na43n3sm")))
     (build-system rails-build-system)
     (arguments
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "12xaw0blqlr2p6n54r3k7kdxvcgsiv28nq31chm3k53dfqpb60f1")))
   (package
     (name "feedback")
     (version "release_686")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vh5gjc3sjd1v82nnh8jlk80v53kf72mc53gzhpgkxlxy4khjrp4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
