...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "07iic71fz906sqxkbqd2v2xr1j7r8vbihq3990h22pffncp8344g")))
   (package
     (name "calendars")
     (version "release_516")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hn10vsgdgrapispvq3jy9wb75s7hir1n74d7y9n4nqhi9p4blc2")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a8h9rqsbrmf1g3a2hd8fcmr2jklzxzy93ppiyb6jx4fgrq8xf2c")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yn8rg3jqa38anqm32zdbgylahzsbx2sf81jwpiyn6ivfjz3i0gg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c4bfblynaib67gygjk3wihvchgzdm3i11k8b1wscfz4yfkqfpxz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cqm7840v8kg267wg2lhf47p7bbq7hlilcdhb8cyy9ki2z1s66bw"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ji7iwppgzl94sfck517w2bj04rqfykc47cvgzkzaa32ydf5f6ic")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
