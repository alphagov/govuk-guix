   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mlagaqz8hlqcz5qhh5an61bwdf4jir4s2x6kh4adj212h4hf0jf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mnpbjp18pwm8z8cpqg51h9wqkxmvipkcr7zmdg0334225xh9sxy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "013skx9kp3npx6asn95q2h0q39r5ahhnqzijpvwzpb6kmlhy8i3z")))
   (package
     (name "release")
     (version "release_363")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gnma91y9ra6ki87gmg0kyg9lagrbs0aaza4ddlbyibbb4dfd7k2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
