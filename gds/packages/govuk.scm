...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0y69bn4gwlb8pp5i40303914ckrij18km2b8nkfpkaqsc1k2pjxr")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a20xdyqm9l099rmlx46jrig8r9cmja9cfpzwwaic6i5p7imdnjs")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "17x5ndb52fad559cs99hbvdvm8wy8a61f254nmh5jnx6m8g949kb")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ayli69z8b310hkwzgd7a62dwwyqibz6gf7aymbsdl38bdzdlh9c")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
