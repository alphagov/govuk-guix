   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18yr4m41nwslbz5xm8m96p8g1945qlfynyc95r74gzh0fa7rizg3")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "123r9yvy9327qh3rbgm5qkbjd8nsfxslbss4fkvh5xc3qak3447h")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p7zbqpalwygnjcyqkg193bagmch93075pa9vxv1v7r4pjd7fmvi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gfjzxrchc66scmj3jai2yxlnbka681x6xfwj9s5zwigkdk03bd7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bgzf22r8r8mnj3wzfica2zpxzlnqjx7skphl502d14bjf0b7ck1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yj0rhigvp7hbgv7zsapmfms8ndm5mmk098vkvds8ykbwl0la18d")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15d2bj1rirwvjl3id9vf2licapsvzwkr99f1va48pyc72g4scf94")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qx069f5mxhr0fm8bw6mm07w6lkmwly68vygn2iv60d0lal0z4pg")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b37iq248hygn58kd4w7dmfpvnjwnnn1a456yy1xn1c4hpbv4pw9")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
