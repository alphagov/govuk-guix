   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15k83gkhwpshq4apsb8szgfylsdc91y87dff81y2k3rkqqz3srbg")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v7n7pdb7zaah30791xrpzs90y23w7lzhxwgpbk3xwgw3ad4rfcs")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1axdsdjzb7c4wknwwk7rfvn91d3m31602dw0wvvhzb6w7d98zjj0")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nrdg2zrx2hhk9g21l3hvq2z3ssgs3nysi9f0673p0d03azj72w0")))
   (package
     (name "whitehall")
     (version "release_14474")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lzw1gzpk2ac8lz0admbg04i8nqg3l8dqlh8n0x9syll4j1ypxfr")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
