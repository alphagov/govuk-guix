...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1giw6d6ifs2565xw36fin1gq69bq3qazs082kk6l4svbx94z7lp0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r2jmrfqswcgdmpqsp6mr5hqhhpppw756rqqgwvcrdf4zfwyczai")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1643z0ba48dksakzn5fi88kynzzssqkx0pqjldl3833qs6cm757m")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cvnrdirg48ww0b0gi9669npgyrxxppxv4lf0nwj4kgd7w5d3zyj")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nl2rclxg24yqcj5kam05lp431wdc3g6xq5qk6zpyimwxmd91md1")))
   (package
     (name "publisher")
     (version "release_2315")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04bv3fjn8v7az8bk7w5im9my7z7kjrwkly45m4vq8c3zq3l9bhmd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "11q1qqfznad0991n2wv864b9xql8cdll5h3gaspd1yhz76rpjjbc")))
   (package
     (name "whitehall")
     (version "release_14810")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0837kdga5h8gmkwi9ynzznfqg43c8p10rzcnbkzwvqfmhfv02ibq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
