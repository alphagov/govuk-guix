   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rx12mlgfzkhibcqm26pnnmh6xd0fdr01zjilyb81aj3awry0qb2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xyyh7zv3623d9cdh9p0yapdl3fzs551qgm284yxrzd02iybg4jj")))
   (package
     (name "frontend")
     (version "release_2939")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nhd48jcn61m6znxd0hr6i20a39f8drqv6kb3msfrg4fcl9bydwh")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
