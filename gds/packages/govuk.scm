   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12bj7whkz1mqd1lckh2wc2z0j0rw2wkszbs3ym3d0ql2jxqbcx02")))
     (build-system rails-build-system)
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "07v3kmp9wjbrvxrrf6qfn5yicz85n4fbqvdpl006l3j1vkvfgl94")))
   (package
     (name "imminence")
     (version "release_568")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d2ap72xqbi4a75v3rxkmi00sfxw7fpgkvhwb8bpa9q4v4wy0568")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1c4lgnrf6bx8074mv4990jjilkpm8jcadvfrrrq99qqnx7rk4d1n")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h6jpa4y92b4hjs3x1yvl50f1f9dkp6ipf00lnajqxjvsg26q7sv")))
   (package
     (name "transition")
     (version "release_991")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j2najp7d8d8xjrjkrm5bh0m42majfvzv592ljlaakrnhprblbcw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
