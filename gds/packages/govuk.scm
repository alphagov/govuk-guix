...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yz7sclzsijk4ms8d96r8avmr3qya595g2zvyq82fbr3b2avql90")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09yqz8kpliiw2y1hjvqfg2nk71l1n064iab9wpvnbcr8mhxn6rpz")))
     (build-system rails-build-system)
     (arguments
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4707")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sdrr4w8l9ahn68p8hzvbb7agk2kfldys23cg18ymfvzydf3ypb4")))
     (build-system rails-build-system)
