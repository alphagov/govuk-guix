   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "181k2dijzq1hi68qyqvs1h1m7npqhsvrlkkh3rmcrlkkf5jw6jy0")))
     (build-system rails-build-system)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nz8j3a1lf23bffb2zqs7y3r9i1hk0c3pxijf6h3i42p2z82v6r2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x14x9ydqm86ls8l4vv3rfmp4yvzyhnwa9ivk147wb7r00zzcv42")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14078")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gwcvjacpbszpx2hcflqam6qqxcmxq9prqayyz4w3m0w37n3j3mw")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
