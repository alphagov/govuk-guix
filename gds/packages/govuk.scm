...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fhgpdlvgbw7hqwjrbkgb5qagm1mx10mxbn62q80jzyw875ij2kd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00b7yqfhn213r1zk36b5az37p0pr492wjqdrr9901gsja56c5p76")))
     (build-system rails-build-system)
     (arguments
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0c69rshjy2c0pf97b0f18dxvbm1rcl14m778d0zcjg3ij3zjlla0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dg0rqh0n0y31vvgnzckri07vgqwxfzbhhnvhgs9syq87f8iy471")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
