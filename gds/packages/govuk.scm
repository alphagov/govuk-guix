...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "058g8hc4v80bymdzsq1g92pp9vql4n57pv8nk4k53n6lha105m2n")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g1dv9jxb1qv6smmc8g0c6z695brs4d9k2i90zpywm1py5g9yjg0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0s7ypi7j22jzvdiklm3qm50lz5xz5jmhrqgwgjcp0dl68av362m0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qw4rwwq0qyc7yvvhdilz9a6cmf64kbqdjl7vlnsr2g8w7y53rjg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rakpjy352lzzw88i5xdnma0z8anhays6bdgc21lhjirq0lb1q00")))
   (package
     (name "feedback")
     (version "release_530")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ga1w35q2ivc2mhqr9l4q5b5n5bnspnfmhcnbxgbbdyykd0gaxwk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cll392bcbqp3zmvw5pv2ccs307mm54cj3mhkpq8rfdyxazfffvq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18435mibp6jwxi0v5kjg1127pdvns5xb58kw0f7ax3yw8bg1jf8d")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03qi7asm28gi1dcv8pi50vp1qipc4nm3gb9jrfz6wvf4qi352b8a")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yai83wxxh4a4h438faicj1zj9n0gsxqkzbzx571jvfw05pgfmzf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x31yjzzvjjhwjr76hpc61d4lfx5rhzwmjwm8m6ysz1brcpcdzy1")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "16x72y6xr2q4mxf9df203zixm29wpr4ysr52mk2siybsim6v0x96")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k326qlkcpihm20pskmajzlmkr9bxkj5mvrvmiizsli504c5hffm")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bl0lzdqzm0b2ir3071jmb8hf2z13wvlaqf4c1gxjqxwb6dyw4zk")))
   (package
     (name "whitehall")
     (version "release_13748")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vkimmkws3mcyxlha2vd7cfwadxs6a03jj3x5nyz1r4n54hf17ri")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
