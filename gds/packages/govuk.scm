   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "108f3jkbf6jhsicf572vfihrz1m0bxhsjv7p13nwyigvyz9av8vp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0bcgw1irlw9nqy77799ks7amjiv1kmiw8yvdp4m2qb9dwkcq55qx")))
    (build-system gnu-build-system)
    (native-inputs
     `(("go" ,go)))
    (arguments
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12941")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vsk2649i737xva4ld7vrlksldbbn6y5fcxm6329991b5481j30i")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
