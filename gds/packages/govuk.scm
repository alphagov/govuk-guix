...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mwcdwlap9am839nxv9r4wzwdqmdq7fva2sidd4lyl659x0cli5h")))
   (package
     (name "calculators")
     (version "release_314")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m15k5nybq192hj430ddz4kdxd90dl7mpyvi080zl9bz4dsd4v0m")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rkml14rryg6rb06k0gwi00ki52pjdrm3mqc7rfhdzhb9xxcia04")))
   (package
     (name "calendars")
     (version "release_536")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y7m3f7ibh9rvbc5wnbfabp5mkz8h9yi31l5167pq3sr7p2dj5w0")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cha35p39m8q49lddfflg1fz248wwcx0i506vpzv3zglwnrnhhvk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0swavpydrxg1dahjyh7q644vpqxbxsbvxm8aqnickigr2kifs4s9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l3rnqbwbx2nk284wnmka79r75k7z8wgzv249csgxl0wj4qavgkm")))
   (package
     (name "feedback")
     (version "release_449")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j35svhcin9brwyy846dpi753s185sqkn82435034wlis2xhv2sy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yly13731rb6id46l2wpz39nxdjqdvq026ydscakqw5lznpz13r3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16cb1w808p516ag6qlj4arhkzl76r5pblyqriz274wrx7cmp4ska")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wifrynvdslgfl89linha2nslbawm2iz4lm9srva31mxv754wibq")))
     (build-system rails-build-system)
     (arguments
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "12kxlb7jpsam8pxwrfzhkrhwx2x11r5c9w9h5rav9bf5fjngr4cz")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "16y11lxhpii8f94pv31yxhd9lndk5vvsrjkijdx6l9lljcrw9q59")))
   (package
     (name "imminence")
     (version "release_399")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0znr16hxc9z1x4x17slflcqi0wvcka6ma0zk9jwvqwq3zcin5079")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cm3rdfmyfc77727b8gq84yphyhq0g14h4haznsac5yg2k333ijv")))
   (package
     (name "info-frontend")
     (version "release_172")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j5pps4czpg90j6p30s1syq5xig871jrh8n937gf8sd6lykn85ws")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "19crcspjpjd8pdc111y75drvxh2zjrldcs9kwb36ynhvqdn1zamp")))
   (package
     (name "licence-finder")
     (version "release_403")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lab14347qj7fs7qi1mf1xmxm8djccgpkqzgj2lb1c565q3axjb4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gipll8lrc756l73rkrxw2hmnqriagklwm4p8bsx7zpzyjhjh3i3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lqjcg4yj98b00lk2hbzx4hz0fqalrr9cid1z1nb19nxa3c86bg0")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "189gc4mszlc83dnjwrjhpmk0i7xi3wdjry0pdpym3jwrsqjl3n2i")))
   (package
     (name "maslow")
     (version "release_295")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "036wz6x5basv6v5kmy7b2pap2ayccq39aczpj6hyfms5lzl1jb5x")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "01sadgvsxylwv99f5k6l94cxz0as5yl8b0zd3yyq9fgyj3jivy5j")))
   (package
     (name "publisher")
     (version "release_1982")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10b6m4xil9pxc7ic8bdfjwjs5m0lqxw5n9lh1b2j4ypgan5rlbqf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vzya1zb7z39d00lj6jlcc2n61dcxfl0lkchvx0rpky3bll7x3y3")))
   (package
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1blh4ab1wgdax54jq9p7xci5cwlvnahy43x17q94xvdjd4xy0m4c")))
   (package
     (name "smart-answers")
     (version "release_3989")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bbp5gcvv79j8q9rahffaxmsl5c1qq86ghii2srgggmvch49n4q6")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "179jg33wnrfp91qhx2bf3zy2761jazfg0bmnpnknvgciajjp9i3k")))
   (package
     (name "whitehall")
     (version "release_13512")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pkynlb3xv5gh1199964nfqyf86lxnr1x75v8vqkhi1r6s851fi8")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
