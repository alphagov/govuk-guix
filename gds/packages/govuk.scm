   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "189ysx2mjbwzaxksh06nm4xhd22l5sp2gacpf5nwr2nv58x2jbjb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "108n4g06ymjgnkcsbmlv22nl7lsc48z95z5l1hznlgmsfhrad7a0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s2lj8nw97blczb4nkr4r7dsn8i5i8702lv4v5fdalm2z4f72x7l")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "16d1s9b8gh77xvpi3yzcjh1j6jxjallb4vhjk3sry9h9k2wqh8y0")))
   (package
     (name "info-frontend")
     (version "release_370")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l7qynrrg5pfhcc0vg9s8h9qfmvbj297r7h8swd532mdrw8p34dn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "005qfjrbf11hv0nv9zs0ww8hlz5l4sni8b8ixqjlbj6ip67xb3yw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y0v5zqzjyp0szdd74byqmpp6mikv90bir60zc4y5bjy3wn66mwk")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
