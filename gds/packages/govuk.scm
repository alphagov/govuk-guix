...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3611")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02mpfwd3a25jlwz0c2s8apd6pv0vfpz37f3hqxkjsxxn959lrjg0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4877")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zwbp6zvyg36n64j3mp1693zm1jazign5ryqx17lsmzcggvpdh1f")))
     (build-system rails-build-system)
