   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fzqccnmaa174d7mcc6r8fxba48jljjqar7vxbrmaxpwxydcq6gg")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09q9f4vy07gjcallh89snfhshy4013h2md66c8934nbj40bmyhm3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17gkb0fm8yi9i4h2mbimx57115qvnny7dm7chfl9dzzzlvanz9zi")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k7ck6yibbnx7d6kpdg1ak98ssv0bd8b7m2m2338b5wgb8fmrrym")))
   (package
     (name "transition")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1020z75siy5g2l9j6yjf82l0fz4d3q58j7c52b6rd14hspbh55gg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qcz6vdpwsbvhvxdf5139ggygkapdrm0lx5g13q1jzk3ka8f61xc")))
   (package
     (name "whitehall")
     (version "release_14645")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v2nz80xjas817sbqlr7fcmh9xi5k51zrajdmizqkdhrpdwdgnni")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
