...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mp27h6zn2cgs9s91wvcrzy7m7713b0i7l0qbpxh344znjf0vy5j")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jlqcbqrjik84jr3yjr1iasqwfcww5i4n2pxprjc5cdwxpbn1knc")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4818")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cdlw5jdvvy5z89xrj8izkv5d0x2zg6yr5npc9znwz8rm3ism1m3")))
     (build-system rails-build-system)
