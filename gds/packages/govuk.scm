...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "0slph2fa2i3qp4lsb1l9fqj1vzpk92jlyi2mf2nnl56sziv0ihkx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ww63rgjh1s7r7nr7ki502rmjc2bg75iry8ydjbx00z99znzc7m2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "160lyw8wbp5sn3zdahgjmvpcvxlj1ifc2iyyiwml0fi94lmm8sf8")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0c5c72zvbiqcm80zhxl3iay3ff825pgww7wzxx71pliqrfg61lv1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06bki7krfpfz05inrdx8anw12iwq72vm2zqq4r4lxs29jrhrv6yl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zkp1ykj6jvdhxfx9143vdk1i8y5a0p93cjq2kpni6cgha5bkmbh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1njsk3wrsh2phqpbrnwhv15v14xavnm6zdm0xp5252wa8cljlf4n")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0r3xsplwh47d5scikgrk059jd1ndaffrr8n1hras6f2qxy1sa4f7")))
   (package
     (name "feedback")
     (version "release_563")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rz3c6c75w1jrihc8qrdfx8k7zz5ms2iirp77gi9zrlxbshnzk1k")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1qx3adldzvv1asphxxin35c6jkyyrr9cvp0hk59h47ckj3dr5mlx")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "10akp0s6wslg2dapw7cf056q5rma1093m58iwdq4n8s5bjq6w2bg")))
   (package
     (name "licence-finder")
     (version "release_501")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ldj3pv57bdgl4fqgfjkslxh0wm1xv9mv4x18amcrpx9g4yyz3wq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "01i3hvmqvj572y4cffqqvn6l9wjxc2d3rxwziz0brranymqfc52r"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i5f77c2ahikq6g5r956p0s35snficmbfmxrm3wkwi4a7n6n9dbm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1phk104ca1ralx8x233xv14zrjy8z21ynjg0w50aklmasqlmd9ws")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10yqb7rwnk1srbr7fm5ih0zcdrr328s2ic2ancw1nf8s5rp1lbs5")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ayq3nxf9m8wgjawhh62swnqvzc8vwr74ww6khsslwksy0bd6x37")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qzgn0xw9yjr4k4p9fbs9mqd46fj17r0sgp7cx79qbsdf7a9hjyh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xd9860va1a9g18zljaqy68bxya41dh6l107xlwgjwbr8pr1l57c")))
   (package
     (name "whitehall")
     (version "release_13853")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bpf2b3bl388gby7j9x5xdc1kw36dip309zpzp2d1h5ckgbns548")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
