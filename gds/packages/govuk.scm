   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lz3zri0r6019h1900sl12651jfdvhwgv2v99l74n3ykwvjbmzn3")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0br2qacwp7fx3vp9gsab05s5lndpjd17n57bgdymrn02masihz37")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1idh7six4kz0b91kqlha6vs5w96siggq89zp87wcv5f7q0l7q8zf")))
   (package
     (name "transition")
     (version "release_864")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fbwhpy0k1gdsg6ixk940np2srh35s3v5y8cwjnsywnrjdj1fs41")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
