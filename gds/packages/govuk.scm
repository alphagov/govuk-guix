...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kma2dqp4lp3l5fk0la3nqp6pj4p513bazwvdqi8hdyl3359vga2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jls3dmc0prxlnv0rn8qdijdxlsg961101bj0jy3kicivyfnkvvd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13792")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k6b7izn031kc4pa578f33zcw1vi055p4cp70f8yvb9vhwfxby3x")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
