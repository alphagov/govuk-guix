...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2885")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bnlpib59fj13w1rnywrjl7h0055g0lys48yvmw49xmliidjilvx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13456")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vadqaahix5xkdid1rzyinmyz4mlbqp0ascyq8ivsisvxzv07x25")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
