...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "09bgfqy1r1jwlynxraz11nyz16bmzdkjqhvk9sf5xk806zx1rwyi")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "126jhf7nfbz55hyk6gcgsdpb3ikyaa9ay7x4a2ycwlcr393m2p7z")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nrwka2csqdg4bn4935dlqnnad0n7ykk3vkkq74h00sid8l5z3mn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "101jvsa011papfn4y1l7v3mjy527mzhangpm94w2mjzxqcq36sh4")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zkawfjz42ifv5jmm430z9bard0wfa02yvw1i00q1ys92r56n9fp")))
   (package
     (name "info-frontend")
     (version "release_424")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nsvp2b3fb6mbglvaimghwizmidxlllr6f2865vnlxvyr62wmgdj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xjk4y3l7c7wkpqpc050vah20vlxvb42hisi4vh23qwfwh2535mp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11yx84ijgkfsp3q66azv2dbhlixdicx6jqyn7n4f0fngn4z5qrvr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jrkjjq0l46j6zy506pxl66vyw0282v72rc7wzq6vnxwy3vmy1s6")))
   (package
     (name "search-api")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13gxg6ljz64fl7ka8pw2z3sm12bh3yc3dsh33zm8m0v7dybl6bp0")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "00h985x6izxvw9hnrkzaybvwgxhply29sl6jyw6n1yj2rz6skcc9")))
   (package
     (name "support-api")
     (version "release_336")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jnn45c3lhn6iqg41ifcmmmsqa3xlc114v6d3mwqwgdnij8qp5a8")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ix1i0bnbkssd609r9ya50jj5a56s0abxavqww4hlx350zis72yj")))
   (package
     (name "transition")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hjssca5dwcc67csngmgmrprw22mkwdh5k906x9kgh1fi1ml3280")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
