...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0z6fgs9135606g0k428alzf4xibybd91bbynwlp3811rrw1zkv29")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h9r9d13pbdbj6i7lha7ybm87xp030zqwzjc0j8c8hms1924xjg2")))
     (build-system rails-build-system)
     (arguments
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1afkrz1zxfr3dliw11clqf50dg821mskh8g4mx3rzp6s0a0m8z23")))
   (package
     (name "info-frontend")
     (version "release_292")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gfwhj5011zilnwp1jmgvmivc9ds7jq1x6bbvz0afz287ljclhpc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "10k7d5g5sf64c4r0ha5d4dwvmgx35giknagh79a64s30gjpnmlnw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a9j07iagxzkacv63fhi70cizzcpagsnwk8lqhbm6cz3r5h3k5i9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
