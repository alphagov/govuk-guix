   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w08z5w90d3gjzvla98mkj5l2p63xvyikacxfml2dp1d4zqbi26r")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "051gv302l08yr73iywymrnk03vrbj0ymbjbkfj5nbyp8nlb27vr5")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vkcd666lvj3mz0f06f03m5p2xsss8sf9y9p6g0sagpy378kfknb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13362")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r6052p2clb3di48vmai784hmvc8fzwki25icv66yy9gaf23kpl3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
