   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ib8pq3p5msqjjnvyl79l9vngq24pihi8gpg8b6w36hp28r5ygnn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0k34h3239f4vnkwr3dy83m61b013gg5v747v34kajv4lzhnd78m8")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02c50wl24hw76l5njn083xx3jfgy4shx77gyq236v28qh0kgafmy")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qv7rqslk65c0h0wxbcclq0hlgq4wpanj88r5nsql8gprh0wn453")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bznszvakirqsn827fpj09y0w0wqrsr0lbnzwd8rwhqdgv5wd024")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yjbpm5radh670apck3y46pzibjfcl65b1cb37mldfp1jvbhz86w")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2594")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10j4ss47mfmwh6cg7bphv2ws6qr50pv8zs0r9k4j5wmrqm4k3kx1")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12819")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "073s6dl7h75x7xmw502ykjrlhdllixfgl8i1smacwg6gkfch0qll")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
