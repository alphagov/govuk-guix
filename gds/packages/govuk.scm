   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ixv0rpbwqpgif0yqq64gx4kzyqwz1fy53a9ngyf8ip4shf4cxif")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public finder-frontend
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1883")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13bxbx0qlzz9zrz9czr3wmw7w21ihzgj1ipxwbb3z89p1qj23l8b")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3645")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01yqlh2dkaq8g2xnf6ivl2shwlb7xbx76xpw63l1rwmiz569damh")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1520")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0820qz94yjx93sc6baaxxlamhjvf9pbj8z5jjfj6nv486913j4mx")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dafbxg236f5ni7fzkpk00ip47pgrx1scp68hbwb3axvrm7qwsrs")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06jsrm5x0wbsqd2zf903381af82rbygdpbp1gd2dhwzdw30fp171")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07yhhdxgzrkmrbhqkk998zfm7gxycmnbjw0qbd5v7d74sdr3s2r1")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wmhnq7hfp8p2hp1dkwf2bb3r5brk6vlvymmb0f4xxvrg0058psa")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
