   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lf91f63b4xp3hgz2zkv84ssxgcvs1v8nay7w1w97clsn0vzvkyh")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10qqy1l0d5d07jn2x4hisc4fm4k768kxkfpx9bfmk3s1aymykfmp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1smbrmqj08pnzfna0s99yc1w29mz6v1ddwz4zm5n9qb42krzgrik")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2696")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16rvz2zm25qpd0p7dh5jkqk8r27kmijgf4y0wq7kn252297l6mkj")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
