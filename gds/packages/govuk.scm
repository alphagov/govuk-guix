...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d107flrajkgczw866fkbxlk37vni3nmhqhqhvswqy4cwq0cfqsv")))
   (package
     (name "maslow")
     (version "release_272")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j5fzrjl0qalyfrij7z1fxnsr7xmm9hqy6mkfqnn9fdybvhbg501")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3923")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11br6dba2nqm5wlrljsfzb3zmqqyzj0qnxnl9p08m1gydg4nawaw")))
     (build-system rails-build-system)
