...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3621")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jzip8p17j86kvqab34yhn0vlw2pmj7942z1vxqjn3803y5iwabp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1w2lgb0gkycr6w05g1clndcxw2j2s8g635vf5mf7ald1df3kvkvb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06yid3yacswiwh6gchn2pmmxarz0pgxj8nqk2bjgq3isjacy0hy9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "06kcbfwwlh1w2mnrar3lsw2968hc658lv9hhyjn9qimg8izjql97")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w33ypkkax3c975dzbq4ll5p6nf7i9fqwrcfpip993p80kaxs2jn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "13izm5g9jjb073vc8jl9qjf9d7r3lnjgb68dj68qb0gajkhwz70i")))
   (package
     (name "whitehall")
     (version "release_14866")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lajbr2kwlw3sxkyc7zsbxl1v83fqf2dj39spj9sscafi2p21r9h")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
