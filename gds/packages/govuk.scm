...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jibv4d86cbqkql6jkx33nhsnpfirx3r1wcapmj282yd73mq8hyh")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b298isbswayl3i5xlv3khpvnwgypsqvl1zyim0j1zaw6b0675ax")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0khpadhsipvy7ylyd1ivkn399zkbnn9nf0x1412dz6y20spanjs2")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cj1bya531k6h7v36bzr0pvxsfdhpayygd38xgxwa648x8fvs9cd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1di894byyb4z8z1qpv9938anc5b6rnmvg4408psks7xzl3zcc5ls")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
