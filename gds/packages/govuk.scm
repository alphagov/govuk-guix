...
(define-public content-publisher
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1716")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zsrwvfbs9l5wlsxblvvykniy1hlhmlyc00la3hv5s08lmz4l7j4")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0byv71a7wl5s64a9a2apwabjvqglj8ry4x3y5m0bl6fy8q1rjh8n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4622")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lv2j1cwcd7f51cignh1d0gbwnjwbh3gy5xl57bh9zv2gdk42y6f")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14647")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jk2hjmwrdi4f8rck008bnwlj51pgik6nhk960cca5gjqzyf9l19")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
