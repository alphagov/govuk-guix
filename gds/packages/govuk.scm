...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lblbwrywnk9i45aypd69wm0r325a2wbw261pgdiq2f060xmn245")))
   (package
     (name "calculators")
     (version "release_363")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07xkjshwq66j2955dwpg16j0s624gbma7azpna2mzmjsn22av0b5")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l45pp79m1ibn41pgsqbg41vhrx365bb2xpz217lms9qc51n0k5i")))
   (package
     (name "calendars")
     (version "release_585")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q84cnz4zl578sq2wa6a1k3ws35n33p7k6n7rj81vpdnazxplw0n")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19lsc04mr0w8dzx6vcb9pj6x9y5qr94nbrsgn38qs13ybng2rl15")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "15bckv839q7vw2vmb8zhgvbjc3a986rraabrigcz04z11ak6409y")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03c6rdkj5lmwqbivi4g03pfqawgzdj4i4yd3vg1fp69k113l1c5x")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p3ypbmwi8gxq2zn9n9m0wwrvgq4hy92rng0209fyxssq4jf8k5z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11bk7pc36365nbw33mhv57kr36sxnb3hw7spgnh88yaxh9qyy20y")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q2sg9g5yl10pmgbaf2b59g8lm22860nyxwv6dg4m2d5bal8s261")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0s0xq0bwmw5c9jk0pk6q2fbnn5qm5vq8z9ln47dblz767fmvhnv4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18w4sy3hs94i6q183ccjvjsa9kjhympnrq3q5xc2d93jz201z1cm")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "04k7vp0pkrxrfkzkvw282cq827wbgjrbvrpwn5s4mbj6fjb8g4x3")))
   (package
     (name "content-tagger")
     (version "release_849")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wxjl4ciadgsrd9gk5ls5vz3mkj284ag6v0v3c880smv410g0qr2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0774kzdv2zbvcy504lmyb57cgf9hf3cskaj9fc0gmhc2vwyivmxi")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "04lx2aia4pmwmbpfjmgrksshcz5jyz3q9352804n0fvnk11m9xfb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19dw7al470nginq9b49fhn6a615y0i5476pq8lfpwbfz54dxpk0z")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r7wxr82h2b3v469mb321p937fwsd17sfsf92fbc9p63gniascvy")))
   (package
     (name "feedback")
     (version "release_505")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j2hnvi34mkybigvg364m7prbrj19q7sc3x5wn4ha2a24ivanh2z")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0s3kd4z8a2xvpgb70676p19q2nrxz1yk5rnlll3gxhm0c6w5dh6z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11l8i2wd2fw1cagaycfr8rdsfmkhbwamdnzhpbn70syhbxwy1py5")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h3k0lcimh87k96crxgc3953y51f5iiwd1ghxivglpf18bhkpn0b")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02140n8pn5s39m38v5hbhscs96xn7rhm262vl8v228jbjrjr3wln")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g5k916w70mpv7vx152sz1srp0780yjdkx42ghyf5n6557xbvhcg")))
   (package
     (name "imminence")
     (version "release_442")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "080wa0mp29j10ai0sxbwji8db13xd40ah06bc0gqj6yvp3rfrn8d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zjgc19ysynlqpsp0862x1dqxfk3ylkv3mi77i1djmm6b6dqy25q")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wh59z4kn7sj5xwv4bz6jldmnjh72ikfnzcx6l6d9g2ska3qx985")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pvpzdbz26wvy7s9sn9g2spw7a50wbvcvfahfw26jn386hy935lg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public policy-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "198dk9wcnjiywj3863jcdyz8lbjn47klsavyh2b0860nf8hp08y3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fkmzn9kl3zsy8xfnvxjixlb0v9anyk9ddl68kqqij7yya3dfg0l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1cri9bcdkji2f3bfpgrkbycdcp9l0m9a94badlavzan7w7lh0hma")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0iwdpzhgkzhjpimslb39gqb7l1pglzfm9hjrmznmraqmyprphwkd"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l3zn9knwmvic3l6fggl2fn8b5xw3xm0pri1vj7a2svrnipd6n7r")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1a6pp2nc31zs13zb4acamwpx6r5lh72vxi80rqfz13dnh1q37g2j")))
   (package
     (name "smart-answers")
     (version "release_4088")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lhac3xnch6kw5wd4070086z79y6fcf3ary77i57ljzxsnkaj9gz")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nn86x0wb665dj4yg8rsra6cmdhapjh4y956512rhmjby9n45152")))
   (package
     (name "static")
     (version "release_2961")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dxzdfvj3q21040r666j5rm88adrryib7hi7x3hqn67kg0v9bl85")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k9fq55z1pzmhjrp4hprffx4f80w30ck9l8g0pmi4ky46x6sj12n")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vqlh7vzw4b8xhblwb9c3lcrsb2jhv3km22ajpi12y29fr2nz7d1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0286qwfvrsyac6f1wsp389iwlz6a34zv6dbvn9gy9x9npm1wc5gc")))
   (package
     (name "whitehall")
     (version "release_13696")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12fzl6waqfd7vwl6bnlhx491k8rlsk3d742xq8a9kyblba2xxq6s")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
