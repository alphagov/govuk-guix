   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13p2bv1p07dw55w8j6zj4absyx57a889akybrl8sra61s6m08h72")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "06b8ry5annw99c32jygb2wfx8z7gw7mr6kvag0bi2xn4944rcs69")))
   (package
     (name "whitehall")
     (version "release_14660")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03r4agjzsg2czccw480hsiqkgwqrxcl55lyh044xd298scbk5bkv")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
