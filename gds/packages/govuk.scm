   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lwm5nbyg8i8jnb1my2v0sc0ikhhh089s2f06yfq03ha042zaig8")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cbynz2r8lvn37zqqz60qa68ysblvqykssvwcj7iqs44r8xaz5cr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "169xzida5ls8ndphjl39iwx86cl09pmrz2ay1l34a7jyfma0rvl4")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pdxzy537adhc77a8j1a8dx82ny3vczgzvf8kz1j4f6hq3hyi5w4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1di8r0hfy4f7yh7mh18hmwh6yd7551frbaspx6yl6abhc5xmkw14")))
     (build-system rails-build-system)
     (native-inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z2cmaklwy22kqi4h869qga42k8wksc7bdvlmb8zrr21klnqbpk9")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1c7rx5b8xhhisqz47anln683q0rhk4pf4cpjg9rs747cb7qpzf3b")))
   (package
     (name "info-frontend")
     (version "release_559")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "085pafxin7h31vvlwlnl9qzw0q7f602d5rn2m3lnc3anjn1n15xd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q945m9pgz4pq1x5xmcrml1mi4qzncyc6m7naycqxbw9mdnngdlr")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kzjgidapyq67yzhpcwh4h2qvpi25lcykagqkh9r09sg432mms8f")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "1y2bjms16lppydx99is5qiffsx6pp7ld7a8899kpp8dkn4amb1q7")))
   (package
     (name "release")
     (version "release_677")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h8cb6gvbkzb8kcc593s5sr02lrxamcnqwdfx6gsbk0b9mzc683p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09my86alggvvprzdy6lx8fz97agllnp8zj5k5qq3jwvbw5pjlga6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14909")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i18r2bjm9rnnddqrf4c3ij64law3yh5p0jxqg786fzfy451fkr2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
