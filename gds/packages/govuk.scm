   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x6mf4pbkwd25yjb0qxkafwlprcp2c5k0f01gy7bh1qlllcl3mck")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2602")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vxdfdafpz92l3529c4iiz7mw6ws40f3jjvzrdxcyw7fpcd61hcg")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12826")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04rgk3r157qrvk67785rvn4hzfdkc6zrmwx7gw78f959cb6i19bq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
