   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jxnk00ipakmmlbm78bf1h4siwfrcff9gxvjwmk8zy03p8dapsds")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gr29m8256mkiw9k67092rc68kb6kqy86dwf2l3klzdf6v3ar21k")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x6bm31spd67nz50m57mcyl2r7z9j52ag6b09gwqn2cjg2k2391l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0abfnlg36qkm5dibk04ngpnqay2vpmx20g1rqvmkzb2avx40hxxp")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
