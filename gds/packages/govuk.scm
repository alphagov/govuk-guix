   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ivrdllg2vp85b7db1vlwzdbywx3a1rrw1ghb2rm5bciaklifp97")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bsc0bah418gvhpxm0w1j2m02aqza0fqsk8fpyprawfifkmxrjya")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a704mzs66446ba1v8jsrdf0nc41m5x57cbl3fg21icyc0x22zwa")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11cf18qpcr8580idcg3am1vikjbi1s5856ysjw7hk66smrpr9b3y")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
