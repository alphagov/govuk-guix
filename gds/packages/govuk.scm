...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wd5jhfs519qzpn54cnzb2gvxri2z6xa47dl4pgd5z1xh0j7wmgz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wnj05v7waby9acld933cpc91y03gbaf6d7wxvqk4shc893jhziv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qrpnwfl6j1006ywcabvzbm4ibhq2x8jb3qdmr1pb2piyym8jagr")))
   (package
     (name "whitehall")
     (version "release_14836")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0s7z6dirlrnghdmd9ilfhkd588dgkrl39a1r4nlqs040ql2drlbz")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
