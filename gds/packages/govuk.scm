   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "187gv07j46jjkdrw7xxmdhc81j6jmry76q26af1jdzfvc91j6c1k")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1sis80w5kj3x7xgw12ki8nnk79vd7v8dy9n94lyj88bz7x91z100")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3720")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04d4z0v6dvhq1nh8k3hc6hdrnzg7sfk2mvfp8z1fs8d3qipinywr")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12952")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ky95rzv7zpdpyhl0himxg2l3mjjxjy5r3300vqanfy1rp579d9i")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
