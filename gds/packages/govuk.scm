...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xpxgqw759kvfkgifrhc16hgbx39hy4rz3r1qvzc8hr9k71bw81v")))
   (package
     (name "asset-manager")
     (version "release_485")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fdp2lbqxlyzjywba898f9gmiac6cv27ldl8w480knqq3s91ln4v")))
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dd8lhn7l8s0qd8ll0qjnllqqsqmqmbmq48sxvnghr4pqb9jn9g5")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pmdg5mpyxg4b8m6wcf73vckh2ajv0hf0v3mxz6i0xmz39pki0wd")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0266zj7hcd1dqjd5l3bm2bnj02rrhhgxxn9amx1006gxjd81g1y2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j4airj2cml9lhsvacax64v1mqva6xdjhy73xqi64dpdnwgnmhll")))
     (build-system rails-build-system)
     (arguments
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ypbrk96g0grg70f143p4p0igjx23l52abpqamjjdklv5sjajc2f")))
   (package
     (name "contacts-admin")
     (version "release_740")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i0vr0v697w5zbf4dqx39mvzl953irn7i9p7gyr7xvplh59ayxri")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r3y4gc8r2f4lgk1xhd0zw41hv4w4nax2znm36hk0sv4xgc7p1dy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "139x0pbksr5aqbi6pqh77kz42wawd14z7bj9ynch5y8qll1hb8cs")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "00rxi0wv3w3brra92d9w8kmgszxihqrmx2ml1f0l48sb1ix1ms9y")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n5h35zp45p3jj2f662xz4npyyp5n0z14g16cr1xnf9iy28dvkcp")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "11b57c5yba0w2l8b372kam84gzdiqa9b1z41q386zj5y8hv9yhdb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y52hzbap77qr4q8bzzj7ng7lzrky61gdxaky89id5n89mxvmhns")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bk0k7mdc3zsxgf8mc4ra0cb909lxs851hy2fjz8421cdzjlj6sd")))
   (package
     (name "feedback")
     (version "release_879")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "152x7r8nifp12yw91a0mh181dd53ylvkzkqzihlyca65sbwkr968")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1v1kbbjw3wisyg114q027s7p9wwr939d4808dzzlmywaf69k8sd5")))
   (package
     (name "finder-frontend")
     (version "release_1832")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dvn7j54792730gc6253vryk288bddsp1lsla5j4pm457jblciq5")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x2whgrg5d8qcwhbxmdaxdax0lggskln1n4lz4wghd012yj2l4f2")))
   (package
     (name "frontend")
     (version "release_3598")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n9ac93ildblds2ffaykpxb8ncip2kxm9smaxva40cfw4k4726d5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "19f6k9yk2wgbv318dhf0j3i6ahw1d1yjc5gpdpn51adzravva3rh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01d0x40gngssf7pp6ya4ryccvgg63sqsidgmrpngb7mcs6bya8fd")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zdy4spnawr3rj8yl6jiy8bqg9kf2abszxqds108hkv2gkra40br")))
   (package
     (name "licence-finder")
     (version "release_789")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pjf9fxzp0vxxr1dqfj9k0dwg5lmf5qsj8xr3sxhs3nvg4w2s1f8")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qprv3w6j42a410wgyfqv26pqmpc8dbxqbz0x27247gqn8z6mfsn")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1790wwv5pslradzw41x4zchplc7l0kmavjhyrzg1qjyizppvf2rz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mxfcm93h1h7hai2s7frwxrsyw35gs2grg97kzd6qxyf3fmwvhvj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rwj7l8cqwvyi62l14wy20km0m1gbhgf7048ir31601hw8csbjz6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fag8fqp65liawizjv98c1fzppm3lz4flam56wj8jyhszigxqz6l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k71n7knz6k2pvgf9v3m0xxqpnz2jqr1r385lnlf5ybg0xpxy6j7")))
   (package
     (name "maslow")
     (version "release_557")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i6bswsfr2f9a0qjr29fyp1km413s5h65p1rnzpxdq1vyyxaazv9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_2322")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y0rzda3xym4d5ns1i4yahlvxh4fpxfjqgi9dn490wsci0668ris")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0aaxvagvra0j4qkjrabp8zh65f2h5ygxqs0sib2d6bnwznc7a8kr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2564")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "030dy4lsfkc7mf35jljvlwy32ljphk0idph56x40kcypvpbpv65l")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f
        #:phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "05bb5b4p9295yfk021pqh1d7wa0h40ix3cph0mai8yp6l80svhca")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jhkj54b0kp8kbrdffrkkkyvzip00mnflqpjb6vy7xgsnbbj0gpq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jf34bfjyxkxcxvhwbqsn3q684ljp69k6k1f5g90jwavs4gy1mrm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16ihh2hsaifim7y04sanhlqyd8mzycd5daw489ycwn7vqvs56vva")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11ycbk9djmdmcvzvhz75fyny08gxf087230658j89ah6m9qqs706")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pcdk4b99wzgx2gxawjmyf1h1b9iqmchrwgidc3i5nmjg7zdfcqq")))
   (package
     (name "smart-answers")
     (version "release_4837")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bb43ick3px4jx2z8l26vb87rhf31kkdygq2sc79vbbilxl9n4wb")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s7hz5fssqys76fg95md8n0pdf9aqh83mdj43m8wmx9pm2nwkw35")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03v28yfj0sz3xzx4hi3bcjwim6ns9scfdr2spbfj2iry23arabal")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f5q497bk5r9z1c5gp5kqzj7169xq6j25d08ry1ifiilhmma5fn5")))
   (package
     (name "support-api")
     (version "release_432")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c02yydk7rnr9nh5j310pjz1jdnq4nrq8awm76d55fkyxn5vpsb7")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ly08vh8cxv623vbccdjjrbacxp7zwfi5vjv6g6i1rn5hhg7a8hd")))
   (package
     (name "whitehall")
     (version "release_14834")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yhadzqizd4fanrp3vjf0p0k3vywpxfhkiwa80wxbc16rdkkbic8")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
