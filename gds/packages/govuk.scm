...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3657")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gp8zfvm1hvf52s66jgyhh7ajwyjf7s2nk4939z6a7np009g9a93")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12866")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y2m9qni950sjllplvmcqhldcwwa41jrvqkwlb372ypzn7wmlx3q")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
