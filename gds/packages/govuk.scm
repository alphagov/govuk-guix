...
(define-public bouncer
  (package-with-bundler
   (bundle-package
    (hash (base32 "1y6nns0qhg6hz7k7h9g439rvnmbxngznzp0amr3bfrr6m3qidfrb")))
   (package
     (name "bouncer")
     (version "release_218")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a3nmxi2h2dhdxh2mh2vaax5f6cd50n2hm67z32wh475k4biyzf1")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q980lmy65zsxgrgyxvb785dy2nl58ffyfh8k89h9b9nsvbyx6ma")))
     (build-system rails-build-system)
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rggs6ggxif3r2nkgb120p9q44csjgpwhiw7mlxbp1j0zfgi0ydp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "155s0fc1hp62a636r6h7r83dgxmv17bv93sdc63mm5qqq5s09l9d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g97r9mf3bwnd2zxwhvb4nn517jqaih35kgzyha4crdc0wl079nn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "16rp9yfmbp9gwafa99ldi7nijf33limwnxbwzdajsy6akjsbwx30")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wq5v9j9i5d2n3psmgvwq2wnqnb0ybs9y10s7gmqm19ljkhk7sqh")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01hpr9nsqx4swynhmry5clwp5b2d3d9gx33dhq7s923s186mkp2r")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d19a42niywgnbwbm60gnf15i78234chgyp3a21k5vmpq1lwa1r9")))
   (package
     (name "frontend")
     (version "release_2783")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ww2r1v28dyyrmr3bnwwfm29gkmryf304kvncxciwrl9sw9xbrh7")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "16ymvhi77zdxg0k7382v39a4xfwlzkl9bh50r7arh33a5hg4my79")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p76gnhcm7kdlisrd9ksy1qjy28l3qnhij258pn97a868b4iynmd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0zhjq0vykp73iyhsm5zpsd6bjpd54n0lk6jgnqwinn1b2nn8r5ax")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dc8qynasjgwcm4jmrh2dvmp5m0fp32aygxby6vhza0src80z1ms")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rkyd4819n3pi0ja1x613780wm0ix0gklh426mqpwy27p1wpjlyr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1n8xyx7vadqqfz0ydyvphr48cla86jq4nklmynlkkk2vjaqk7cbp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y2b082gajhrwxxn1lh8k1zz5xswx8qqxlhiih8myz01kyizjab9")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0085rc1j5m9m26w6l0m74nclbmx3yr0kammmrchxzgkj23gxccrb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1gsxc2zsbmqs93iiqw15hsgsa7as11x8arcfyxlp4ng25sdwhkf3")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k3vdcgq2a84f1kv04cck2c625vs7sjf6aj6afbjmycmjbbdyl4x")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jzpci2bw8512fk173myzcarff21xxb4lhgpglhb6mqn1i1id50d")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hqhb2vm7s7rnc03x5avp506phbdwnrbnk5bkav4p08rwgvv39pc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19cjv88cv00d8xh8xgrmr68hs8hyfxl1yiz0rnanmimmczfsa9dc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wy4lyavjmp9sd6cnmf4aa6cpwyvgs53xk4k0rqjdzv9pja1375k")))
   (package
     (name "transition")
     (version "release_807")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m96cf9a8dc97whs44marjjjjjl2yiavm7l58yh53l80vqsqfjyx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zmfpliiid1bkr4q6sfqcmmxaspl4cd7wzlxd6kqvdanagki7czl")))
   (package
     (name "whitehall")
     (version "release_13145")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05rrg2mv1wymmij42q9s4kf0r2f460a2zv1qz50d45c79n60a0ql")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
