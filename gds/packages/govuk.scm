...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gmhrqpn8m6pzdsq0k1wd398gpyg6gxwafgiw8857jrxfk47pp0s")))
   (package
     (name "calendars")
     (version "release_599")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hd4cv0hgz0mack54bzgd6bifwg7k52karg9ahbkfshqjq7pk4d9")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g7hm0rvqphlcqa3x4lw6h222rw736anq7cxs31ih977dsx6g0c4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fblfd8cpgaxkyj36bphc3vx263602vgdnlyby8bmqd97f9q4lza")))
   (package
     (name "contacts-admin")
     (version "release_504")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0916p9lsn445rs9p49pj1hbk88cljmmzva5fsjj15r1xxf1b3q5y")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ylgsqrkpcai0csbf94lvpqqlqwqk4d7g1y04kq024dd44f75vb3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mngc7xzxvl87r9q0hpkg1b9xv9f8x8ngfz6xnlv82r3lpv72c4d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r5ggs9f9m0p070c0a8ka0xxzglh0cf7s04hk41k4m4pw3p95m2x")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pkpk6xh04ia7nn4wkr1pksrspnsyzwp0dfa1xk90wcy12swdfkq")))
   (package
     (name "feedback")
     (version "release_524")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mmhz8kw8p7gm3cvlbkjsksdpldx9941054n9j4l4ck746lbvh44")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "00m8dk0yvay3r2dy6lnmhn9pgkflc6crndhn27bayb19z6fk8ky0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z3hrwddpy05c7d8xjjawal78qchva1my6959n4cm88ai69pvsn5")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d4y20pfa7swwrqknfry1ravg12wnlc5a3ikzw6ac5ax9lz0hihp")))
   (package
     (name "info-frontend")
     (version "release_233")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a2ixq799zk59430ywc4mjp2q1xrd6w77qpzd8qaaxqbzlk4mbgv")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0npwhvc8z1y6p8qa507gngplqrpwh334ik5d8s9vpsx25qb3h2br")))
   (package
     (name "maslow")
     (version "release_333")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m7hb89d5rjwmm5wl9izjkbyh2lgrhm2jpmc1kr5bi2la69h5z0r")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bbs55myd77svfbcinglwj69wdq0krw8j1vxin83727h5kp1ylmj")))
   (package
     (name "release")
     (version "release_365")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rn2140iq7zssi2x7cr0r6yaylr4l4zwwan632qjmg44qfa5bmaz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rwwpah2948qjklpy2srz0bq8wbwzz7akwfgpl23kfwm82xx4wqm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nzy568zwc7l7vs8zrfbbanrz72wllhn9il4gypds7j5nd0w00p4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yxvx9kpmm2izqq08xha1hldh2q0wl0c7xmqspwgasgsk9qnx5c5"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06m4d0qqin78rc5msmbv2f4cywh0dkz20b93i8p55y8f1c6sgjj2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gx2fg0wnvadh12ihdb65yp60w9inwshnfbsxa3cmid1ayj7pjr9"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lvsw5py4snz6qyxbj7cdbg0dp0rf4417gcpmk1h34a9lgyf8d1g")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "17c42syzx9jpmf3fhwp769rn5rh532kp1yi7a2dvpywx8jhi16xn")))
   (package
     (name "support")
     (version "release_729")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jmm01yrgcs7sg8p3b2klzpv5myq51pgpmbfgwpd41wbjdcxjqcg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
