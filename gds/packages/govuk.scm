   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1slhn3xbqzyw8mlq9x4z75igdv9da0ynijiwyxqq1z8qcp01cs0k")))
     (build-system rails-build-system)
     (arguments
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dgs1vdyib5yyzij459rxklq7x0624qyjrqqiz4nvm43353rqm5q")))
   (package
     (name "search-admin")
     (version "release_363")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fk7p0zn41sdxdsqdz2n5yqyskx0908k6nmzc995vbjgiwmm811j")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
