...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "18w3lz3jizjc85ipk4sggbqpw4273qbmsyl1hg6962aac07id0r9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13i3c38qnmknvbxzhxb0gbgnkmm0fqjqn32p7ydijgl8m3gzlbja")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "1a09kl4xc7vys6flszpbbc5ib6pq23aqc17sczsyv0j807qd6kxa")))
   (package
     (name "imminence")
     (version "release_483")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fyhjmicyghi46n2padwr9dwsqjz8mwhjh2g00sbdl496m06j93y")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0aw1cg2dllqs79gp0f5idwd3sapj1r3cnmmnwf6xaqda4463dy1h")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1jvl5v6hc6mghl7yr091qhv6jaj8pasvq1mjy2jn5npvw98kcbdh")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
