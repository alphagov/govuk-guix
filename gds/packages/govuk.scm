   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0skg9zh74j2w8chn15ip0yf1wva28nbgkh5xxc85279xn6qrlcq3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17swdvdlcsv9g545z4vmq6nd4a5illn4z25bn5m85z5f046nrxax")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0zbjwh6qf7ki4aifvvpspbpjh8ikgyddf4yjyrrm083b3792mbvd")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k7i89k3f6h3b1ydnx4zwsj7zsmhy7vdlkh4lnbymvlh2g62na1i")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12769")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bm1l78fbgkf9frj38hi8pg2mkd8hq8r4mg3mg5hcvyim8qcvpxm")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
