...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3519")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yn2valkhjpp3alwflv8k2n3s5s972bk4bcbmdnidwkgn7vg76iz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "03svimwfk5pmwxdrhk575az9d37qmjgkbk37xm7lbphpap5idg7w")))
   (package
     (name "smart-answers")
     (version "release_4672")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gr3bfcxrqvnqqnnfr8ld9ql19m0pdfn0kr4p3663z17hypbq7xa")))
     (build-system rails-build-system)
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0iwyhmw8w5bvzr6smgx28kz9hj5ml4l5hnh5wk4asv49xi6m96pm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08ynhqnmxlypn1905yy4a3c20sl0fwzwd10v07ixx3ig61nxzchf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "081palxdjy2rm1my8i4bqazmvb4zllrs0rlv887c9l9dffl2sqs3")))
   (package
     (name "whitehall")
     (version "release_14693")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g76g7grca1f26xrplncsdibjgdyrq0pfa6vlj9c7lkwk2ki35ss")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
