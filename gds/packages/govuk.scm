   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19czcgw0mqcn7bvia2pfymlzrpwfzaak6h5p5f6vkxavsvspp0jk")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k6r5qmyxf3yps262rd2dpminkkazdd287swnyz8i8qxpp0pryyb")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14192")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ysc385dn94p7lcl4jhhcc37l2gqkxxdp9s8vyh14pqfbibynsjv")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
