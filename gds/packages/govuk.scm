...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1k5abvbgbswxrn4vnsnz796wpgbrnwjrpb6v10x1wkvqbn4ba5sq")))
   (package
     (name "collections")
     (version "release_758")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ramvv3lghwcqfhp9fvwx317mbfls8gwa80md86j225fjqdd63il")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13848")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ghl5i3qbgwyd1gjrfzwb6m2fa0m2dnsf5wjxhvkyz8m8lip7jwl")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
