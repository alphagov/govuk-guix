...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0glmmg3b5mp0a6vggbyapnb4ba1jsh75sfannv2jdms5smlnabv9")))
   (package
     (name "info-frontend")
     (version "release_166")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16lnqczr2icddclhx3mfk9lrxj3iivv9p26jdsr28viwvvz4nnz4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13503")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kxsx699z248n2h74wzq5fhzpdladf3nppmyd62wnmz15mlmp8dz")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
