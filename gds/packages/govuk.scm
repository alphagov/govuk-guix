   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x8ckdakgybhavkv5rwvnzvm0l8c2v24lm72vcgj5p9rp8pay0b6")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1hpxf7p99a2yn90yqkijc3rgqmi0dj9b9v7iaimn7823g6h664rw")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13852")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03rdkcnf3jigifcdji70dn9n7abgg314mw87xqgkjmi22n8qnxmm")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
