   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qjzi5yvkllgb2381zz6xb7snh4qlwijvggyxw2w61h7l33flinq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17wr3fd8mwf1xybb56gp5i44jbzvq22vaqpfbnv5ylzck23avkfg")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ikc23r6lv2c44yh6rc5cigbg25rs4w140lfqy6m25nk848j5200")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19yxvdm9zxcs7qr4bx3g4cil0cmqsylq2bys4rn0myrn3c4b3dsw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1y1q7rm0qyn3cdb7rfsfsxl0sl7mfrdr2qq9nzkrl4kd690bq4y2")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
