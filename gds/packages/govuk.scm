...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1faw92jycmyqc3k8776kikg75plf7jyv5mn6d9qhqyxmf41zpxd2")))
   (package
     (name "asset-manager")
     (version "release_333")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14h7b4h4z9n96vb594r07a9qgid1lhkrafciqmw1vc4s8yy43i2j")))
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1n6h7llyvvflqr5jpdcr62ly0dbzhpl4wl10bg3r938p64kzxgjl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ghdzikpn107apxl9n3mnsjkdxfgdbc8whpifrabnzxw9wjvnj7n")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0da4i86sz0xbalffhychllxcvrn60g63wgpl6jjmm74slwm4hbvm")))
   (package
     (name "contacts-admin")
     (version "release_524")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1whp4r0k88jia3l428y6dj8i0fdjwxlaxajnzw4vhln2ihxwj40j")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gx4x8insmypwfdpq2cgk5gk9dqyxhc38agn7m0xs2xgbax4c058")))
     (build-system rails-build-system)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j01x49wm509vdbq52zarlxccbhhz2kpljlr43q7z15gqkd24404")))
   (package
     (name "feedback")
     (version "release_559")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jj3sscbyfxqw603lf2vsv5skqd4pmidfjv8npb8y2m9n2qxi5jd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "0618hx7d25ic6gpgi0jd42f8qskqf17160ps1106vzvv3vrvzmjb")))
   (package
     (name "imminence")
     (version "release_466")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "123yhlnjs2j3gwv3kzr0029zjh53b5p19kl1pj57z64zy2f8fx7l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "01khw639mrpp2ji42h8h7lrnk7gfigqgxr326vxrn1mv0ajwkppc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03r3jdqswh6ramikpnl154mcd5s72jfbcygghq4nz57msljqz1k9")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dxy4h0vf63l3i43zgmq6jy3zj5dvr7dp4v9ly11r7pa0k2rzvv5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0smknagnpfr3dnb7jmhddsbkk7x63g208kxwyiglddm77924a84i")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1y54d22vhrh9w338hmm35j5m91jjzk16cfvj6f5xcgpg55p4bakx"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fi88lp071zhq4byd6lfpg2chb0w0hwglpg9r9hylpv2mbh1yjxl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "10zayfccdnyblglm1j42d7zx0hyphazl8driszpn6mnkmz9xmgj6")))
   (package
     (name "smart-answers")
     (version "release_4158")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lhw50zpla36vz6dxg66yy594c98ch2n4ig3z3py4y29dwakmfg4")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nma959nz932va5awm9g4bmwi33lvkk9hxqz1s6dgyx9l9vbqprl")))
   (package
     (name "static")
     (version "release_3010")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zk89i2r1cgnlnbn412zqg4060wlha59jgw9pkw3bsixx44q5688")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bdivgwq6mqldp6w1q6c1a4rg5mn687gidi7l0837ndkxs1y1pca")))
   (package
     (name "support")
     (version "release_747")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x2rx6v8b4q5322sybcplqpaz9p9f40l6j3gbazwzf5ycjmb5pz9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "020gbh34ivbzlcn0n3dpdnc7lczm5k15vmbh0hmkzmisvkx35c3k")))
   (package
     (name "whitehall")
     (version "release_13841")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17vdac4jj4zppq3q7fc68l015impwln2kk729hm3fdi24dwa9rb9")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
