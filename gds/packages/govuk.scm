   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07plb9b142jps0ky4ypfjn3f8rnhzzjbhngf6y2jhq45h1771m22")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00ssbk5zx8nlcygddg6rapkzlxhacwbv161qw4xk9lc666gwx1xx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12856")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0km7h74vsqdk4r3sbgx7ab15sw364n90d0108v2x46qf3bxd6nhs")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
