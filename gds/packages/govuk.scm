   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13hmq3z9wi2br58dvqzwy083lg5xl9fqm8gga3747hw43lnbihxc")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zqjjcdp9085ydbaqg19ly3r8zb29g1rzwk5h92ggdnmvf0acsjh")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h9lvpjz2vvrg715fcw3c831sk4yjm0a8qrbvl297xvs8vjfpgwi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w8246pry4vm50s9knxcm892d1l6mvrzq8iq2w5fpfii1nl39avz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "100dfp05r7mhyp7hahwkbi9p5ndmz8sijly2jlcnk2gf93qa73dv")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "072g82pik6xfj7b9ca69ccw3pd17fskwyzamw08gnbfw7k8g36hz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13124")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09gi3cyjav8b94bhpf8qfdi049bg72rqblvpcc7c8ad4lwabvxpc")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
