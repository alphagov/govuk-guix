...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yirzmrnr48k5xgd4mvda02gb6a9a2a81v4apwlywjvp3mx2wlg4")))
   (package
     (name "search-admin")
     (version "release_411")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gzfpkfw5r0scmvn98rdy9y6r94p53ycj0kr2n77kb0js1pa9jyv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sa6bnvxp2nlrzgmlzaik03hiwfkphhg2nv18lpmmg9nr9vdwr0n")))
   (package
     (name "search-api")
     (version "release_2572")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "027wh47nr40nb690irrzsilbcx7y3vif5vv9r3zmid08f8bfy9qp")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f
        #:phases
