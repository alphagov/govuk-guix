...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "14adb1dyhz5vsckpp5zpyrp6s0nvy037xiac3ybbsdk1i8nd86hq")))
   (package
     (name "contacts-admin")
     (version "release_672")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g2zj9d0jc7fy00lhnbq0wcjpaxywayrk215lrmysr5bv21r8q2z")))
     (build-system rails-build-system)
     (inputs
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1218dlhnj15j85bjvha5i4kjj3fhd3cw5l2dcpb6qh7ffcda0jjx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fqkfavswh6w3gblv8212azwjs7zcm0i6p6jsdq4qqlrhl7f8arw")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1icvdpj9nxzilxwk2xzjjby6k2lilkig3mnbk8fjcq2zqzxnb5q1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11spg5vix0wf8pq5jr760w4drs6ninkhqyh0dxrvlpi8s01rmffn")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h07badhrdaab1jq45sykni4f7ihbc17qf3xb8pwzm1m4ihk2wa5")))
   (package
     (name "smart-answers")
     (version "release_4554")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lmx96qnmmvpps00y1fws8zkwgavh0kg7485ww2f2ffg4bflp6kx")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xz9s9s05v4yba2pdas0anr3aplrxmbvii0g88rs6jck466341yx")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ll9013znhcmy90w478871vhyjimwk5d94w8csn11nl7ngyiwwmp")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
