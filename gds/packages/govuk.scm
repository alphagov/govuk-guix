...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xqcbh6zdq54rb77n88iv9zaf5j2kzbi1grbksqd5fxrsnzzz0kl")))
   (package
     (name "calculators")
     (version "release_737")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jmzc2c0xwypf0l97xxds0m6ww8zlnns29xz3achzvs04n1yxfiw")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pb5phsj6s1nrhcc7cg54j2bvwlc7dz2q0ssj2zgqhbrmk2x29hx")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z4a48swnlywj2d35lrs843ywcws0h0p3aiywlwrvzzz51v91ka8")))
     (build-system rails-build-system)
     (arguments
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "09h7rpnsxlbp9hd5ylj8zmgrl3iap8jppg6qlhd2q8vi7n984i3m")))
   (package
     (name "frontend")
     (version "release_3597")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h11p2kcnv3dh1plvcdlw6bcp9pl82yfvcfjh5f5yq2wi184gs9p")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "07ibnbfb37swp2q27zhcd0jplpwnslrrh6jfxzqb7f4jzsw9i0vs")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fj34inml6475v89v4fzmsphqn0z1lqcd6hs2hzk3y5zgfsgjllz")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4832")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "125zkxwv3h4201qpilibhnkqr5nc93xijsyw8z7lyw2qk5nf6xbd")))
     (build-system rails-build-system)
