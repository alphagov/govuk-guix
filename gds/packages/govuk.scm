   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1py8lj826fqi80935rdxl5dxwgj7h1287934qx3pi9hcm7rx9xfl")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p1br3k43gh0l17kvhzyjf7gbbjhfmlwk9d413dabdd2w424c5p1")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nwjfxwhflcz6bzfly4z75qq2jifqhywi7c3ch5yqb6p90lailsf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12831")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w0bfaivf6qw1rv0c0k66qf3jmlp7p70ddv463l1isz7sqfnqg53")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
