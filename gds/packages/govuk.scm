...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dd2yjhpp7m5c8llhcksn4dd0gcdaiaighads2rj0qc07ifss6n3")))
   (package
     (name "content-tagger")
     (version "release_969")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17xyr7vgi1sr8gdwhwcldff3vbznzxdapnb4n6c5q3wg6zd779d4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0566f5ndn50rjb5yq8cqy5y222ni8z8wd760rvf8v0mrdww18m11")))
   (package
     (name "whitehall")
     (version "release_14124")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "182qcwi2jn0zn9vjf5rjrrf32bn9psz2fmxiv6rljhcsssb8ya12")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
