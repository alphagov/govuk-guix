   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13cg77r7h1kpkdjfwcl41hzn9b9wq6sn6gm93yy5irms72x1yw3s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0f4jdczkh475c28m05nb7vrj709py10rqdv7s66l7kgmcad8zjqa")))
   (package
     (name "publishing-api")
     (version "release_997")
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1w9h1hffskgwgwyb2c0zfryix38lfqxhsg6hi4sgmr0iklgas3i0")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fkb7fbzmwfz8j1abfvbbidjvpafx4k15l8mv5bccgjimv9lichi")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nxpvswrj6czgfdsn12d74jj7jmmz5dpfdvszakq2gbphfhy8i8x"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x4kk8jj072x36a92qkj3ifjqi814yfksqhn332yx41ch5scfb9h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3737")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10zvsrqzwiwc1xzzj5zg9m6izq03fzz5mzhb6d8lahjb9s4lxwsz")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "12lapx3bankkjzzf9rip22ay0zvv9ryjh01nv56dq3kg2c2kazlw")))
   (package
     (name "static")
     (version "release_2661")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03l544glr9axy27c0337dgs46r43c0k7xkhap0s42bqxribm24ky")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12978")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18mdryl1cg66adxhnc48z29d395n2mprrjffz7zfgdvjfrirs042")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
