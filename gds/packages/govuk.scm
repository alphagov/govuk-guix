...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4809")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04vw2q8by7cab843dgwf1bzdsqp23fjpryb5f66fbhzc4fwf2ycl")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14818")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v0j2m9ybm0w4vx36xbdwmqzp10x0fjdihgvjcqkg7m1w0ip7zxv")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
