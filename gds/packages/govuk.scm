   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hdwfdsg5zb3rhs15fvf86c0j605fan3gjrb5mlc821gdwyhhqrc")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "111ihmnv6jjxsbkdfasgw26g9pl42bf0nza0hzxmc0423cip3a70")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mxw6xdx48za3nb3ciblbyxnjpgiq069qbir0wm99iqhadvw8075")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13062")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sa3qk9gapxzqw7hy623lqsaca36p9000d65idcng708k0axihxh")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
