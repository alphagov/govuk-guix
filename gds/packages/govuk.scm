...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "1n5r05wc9w4f8b5163idckbgdvmzydr8lrcab5xf19k9izqqack8")))
   (package
     (name "maslow")
     (version "release_276")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yk4vn4fwb407syq96bpdpyl0a45zficr5hwbsfncvqhhmwm8gcs")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sr3dscp79k6la9f42gif290ak1nxkb3jid8rkdvqj1bamyjgv6w")))
   (package
     (name "support")
     (version "release_667")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05if1v50ca5a0pnkglj8fk07rcf8r7gjz58jdvyb8s40058vy4hk")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f3j22xsd7lrpcqia0v39s3fj73v4lamgwrasaq3vq0r22ifyaim")))
   (package
     (name "whitehall")
     (version "release_13416")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l86zcn2yhifhdyz9q61idsv4cm9irm6vwaygv6xm1xfkndcir5b")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
