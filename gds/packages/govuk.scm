...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "09aw4bxmr8wm86z9hy41idl9rszapkingmmjyiff1d23c89x7kg0")))
   (package
     (name "content-store")
     (version "release_882")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zc6m6vn5ld0sz03h6n56gwwqvd1hb2imqd6xz1vqpiggi432kg4")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xy5xqghmd19ra7cyl1ldsn7fi2b30lldly8ify5laqsf7rq244q")))
   (package
     (name "whitehall")
     (version "release_14119")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1imla3gh1gqrk16jh8zb7v308z2r6d13nqyxaxygs27y4sncjwbb")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
