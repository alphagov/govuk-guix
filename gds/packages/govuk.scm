...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x8r770r550870q79y1rg4bgrm693q4wfvw4q5c6dzdy2i4673a8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lwc6krsq027sr6r9k84c4h88i50nv1bqa6d7bdfd9dz499h5qwq")))
     (build-system rails-build-system)
     (arguments
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3418")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jlqrm961qmhz4sj4xq275h0gilrcw0q2apsayrhd0z3pxyq6h2f")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2403")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16wjmsksidzgzw24i6j5hdzvmdkljl54hlycsjp3jbxckf8nadk5")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dmh3h62yhq5dych53caylqfml4ldp3f298fc5p3zkn6m6nn4wap")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15gicarv9iwlxbpjdm9afmsw09zr687aybh382damskflbyh5hfq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "143f7pcabhcaqnnghzr8gldkv8vcbqls6k13rqrfz15zzkfn38dx")))
   (package
     (name "whitehall")
     (version "release_14487")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kqb0flpqvv0mmdiwk4hdgjyvmsx9ap68ycvmqra28pkf7z3y17z")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
