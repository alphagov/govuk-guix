...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3605")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fyxp8g13nchzvispfbczjchqngv7c58mi3km6h12f75p9gq34m5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g1d7s94xmflaa0r304yay63nx4awx7gcy7405mfkzq7fgx8af68")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4866")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cr4n1144a8law2n4ngxy943p1x7d9jvi57av3d14w0fsn788847")))
     (build-system rails-build-system)
