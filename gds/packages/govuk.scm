   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00jgmm2y6j5vvhbnqmcpwrshnda5nqj000ypm5nnr7yd21zrvbcp")))
     (build-system rails-build-system)
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a3xzkbja94wjw1mi3hmqnvhkzfbxpmbycsxj0va25yfqx8gbppp")))
   (package
     (name "contacts-admin")
     (version "release_350")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ngxqbdbm1zw9gvy5x16lpld48rwfhi5699819lks0iw9228s1i5")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "06v6d788dv72mfzz0ksx3x50vn29pdsinrbf4a2bjd29mnb1rqxk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z36w64fnd82p1192fdznmp5i18a64jmzhpi4rxcy2wfypdwaq2n")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0my22bap8gcc6fn6jfbr4hwqlccx7fqxd36rr0qj8nqcscwqa8b0")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wg0mzkzd75b5l05lc8aalg2dwi76d52fskzl28azhy4f7pb8s6h")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gm584q1z0rdlq0m9xqwqlyzm92a7xrvp0yp09k40p6k8gj3nlfg")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gxf2q4fybhsfzfqhqi06500wxjmx5r665b6fps3bcw3i23w886n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0z8izfg6xxmlcy43fqxc8drlvpbkmphl1gx4cpgciqwbbxp2bl35")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h31imy27f9cwdik3libgcjiv3b4389dr3dqn4v3mva3xnsa0l5k")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xvwri486hsrgnc0p5zvavvzj4y6k94f56cb3kb4zjhh85y2380k")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14b5wnlvflqzja3bn5w4rscjgb9ylwnk573ckkd1h3d56rz093ya")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "098nlzs8vsrmm78ilmajqw06hilgxvb9580ggck8c6xbgm6bfirm")))
   (package
     (name "imminence")
     (version "release_315")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wq6hrxvzkw4p4hd8kwj0gf85lyg37lg8caqcnz3labhg6hd5l03")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1316ysv267834q31y0ji3630lp183hid893g87nh6djmvgp4j007")))
   (package
     (name "licence-finder")
     (version "release_280")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "166gawm4615ibp8283zidi2c0228q6iwz427bn936h79x4a0w1wv")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0434cj4h3hvy16knp01c3ncvgxkv11imy4kp5031agmb7yzxiap3")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15b11f7873jakyi0fdfv4ck4cyla3mvm7hw9k1r9jkcqdszrjah2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "09rhh180dy3myg0wvy1x5p7vc240m93zh4w08v12rr5i4c38fmc8")))
   (package
     (name "publishing-api")
     (version "release_888")
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0dzjjfzsgafb8x00c7zsi2pgj1f77gcykv5q1n6d5wgv4bp06y6q")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b3i6q37spgwlj7m28wmj8vs3vlr3b7npnsypm7dk5pl4vqbwp6d")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "021sy6aprwd40216yi0ks902bs6cqybzrfyq8mb3fhihv1w4li9h")))
   (package
     (name "search-admin")
     (version "release_95")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0445qv6n13ai4hcw9wylmdjvikf5rdn3vkbf5v7mz090jkndyzp0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rxdyvgl1bilzkv0aq05bgsmn91yfrh8kb12v2d6g1rb97ifn97x")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08p3jmbcwjbl4l63pw5wdpq57dbpn5ipgidb82w1fcp96bf0z013")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qjjzn06lqpkkbgx5p55ymgncx59z63ljxivjjncv6ndssay5dfv")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r1299wlpsd4ihly1arh0k4ib3wzsyliafj076kyw7a6b8kbnfha")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0s3xrihqfjnz566lrrj83hdm8q6x8ac28sknmbybh5pvvxa8m6vj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12775")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1606rp10d0n260203xgixwwqala1ija6ld0z0qcwiwn4g90n2zz6")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
