...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "09js0jvdcrnapc6pzai9fnk96jgd9fb63fhlvckyndl9km9ql664")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14ii010hyp8ibcxrz4xc93gbza8hhpsl57iy912ispl0ibxw406k")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license license:expat)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04gd7cwh8ddqcqxzbx0zm0a4yxik0fh5scri97dn9yw3m3q9dsm8")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1bxfvnhxx6iw0b4ib77336g1vvkc1hjkc4vm73m6195dd7rlwck2")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4045")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lrv8yxa931k5l2jqzy9bfmkgxsfza18bz0yqa538n4b3ngrf5zg")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13638")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09min2aybhjdnqhj8ad42q6g4539vsj44gbkf46p1f8mnks0lffn")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
