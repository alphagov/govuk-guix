   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18q1hpszbcx1kkn2fwxar2pdicchqvs7hj8511p3awazjn2p6hwp")))
     (build-system rails-build-system)
     (arguments
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0s5jb5hj1bgkjjd0lsyvxlqmqg37i1c193ik7ksi6hs760mf6m0k")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bypnw8apxn59xb9ydzvvp7bynvqnh3503f4bx3hyql133vh2kr6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
