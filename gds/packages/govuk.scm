   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ypk5mb62p8r5xv0c76dgnxg3889lz6imxk5siph852p9gr7ci27")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "01mbig4cs4fwmaxbrf67j44svmsv0100a7ix9cmaljrqn58713gv")))
   (package
     (name "content-tagger")
     (version "release_854")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sw5gzm8br13zv7y31x6n0fi0p0bjwf3crpka2nrzjivpzy23qid")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public router-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "10yipwl0c73qgbzkj64zfvbcf1qkiyp8zn14kzd6kmapllg05r4j")))
   (package
     (name "router-api")
     (version "release_183")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m11p2ll60gmbbdbi8vis8j8107gy5zp229d7l2z0azg1cp4a2sv")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1az97xs0qjjx8wmjmvdil0q1p9ln182h7gkjnzyymjh992dghphf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "085vh2ihgib9dnmhfrza2mvp5kzr8lfxax4zd77dvrkp58apwzld")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
