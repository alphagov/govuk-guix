   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0az7r53wkzc5njn1f41bqb7v52xnqsb6xv7ikzn6125crxy0ww2p")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0avgymy9byd7ibr6905v14iifsv71m9ll1xqfcr22df23s0inf85")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3887")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zj26vpv11nl88mlidbh4gh8d9zf7g1x0ixpfmazxkj8f5p8bf96")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13341")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dgxhln06bh46hifg0hsqf1q76azjgn5015gyjvmrl3r7wc4gr1i")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
