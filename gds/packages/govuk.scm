   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c1knqkr6yh9riz3scdbdj4j55vijlnn0im36rgrgkyp5hlpv8cn")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ax33zhgnyk4xib970qg9a77cpwx5sp1ynib9i28qfzq1i4w797x")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13859")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01m894qi3d64803804kfrflwmg662y9g021557iyd1v4l4q4ml7k")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
