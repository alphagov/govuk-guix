   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k7y4p9fbd2kn5hb0bnx892j6bkdifqq23n6qb6dd38g5iwsxfm4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1q7gxmpa3rwdhkqvh106829ravb3g9a8ry65pr98bhjd2if7ybqn")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "19knmvyr3yali98yir9lyigcwgvr3sngkyx68v3xglxw6d72ib9b")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
