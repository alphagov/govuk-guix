...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nwvsp5v3kcqj7r5hzj7i315l9pwn01s9ishdd1y886l3cqqs2l2")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n5rnl3gxcknlqm1a7v4b3ycj355r5zd9na9r3in2x5bl95l4dbx")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16drda3znwjlad3kya0y7gx216yjl1jkx2bgc2s15v9ymgmqlc39")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xhlybrn9j31zhscnxvyvzkrp97vfpmqmvkjwsyfs6v0q0d4brkq")))
   (package
     (name "frontend")
     (version "release_3421")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "070p8q12lpxg9kh7ss5x7z9y4mnrf6466vxpr7b5zr84zijy6f5g")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4566")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vmh99km09lmsngzvnhvcjfaaw7sxfpfdwb2rvpdww7y4pzy21zi")))
     (build-system rails-build-system)
