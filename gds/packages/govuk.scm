   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zcbxnawjyni7ld2jad7ng8drhalg1rr3s3rqcg507vj6yw08mp4")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0s56kvk30p5grra05hi9flx35hpcqg9p0b9znwg00sxy0rrv6zdh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14d73chg403glwyjnn72pnaqbdjzjda881zyyfmdq3ylx44c9ifl")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ywyvyin0azvw4h7pj5w48ckqa48smkjqnrlxyppzf18c6n1izar")))
   (package
     (name "whitehall")
     (version "release_12918")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cvljq4v24v8fxsr1r2syn9044mx38cpf2ifkqvxjaqnq2s8z1zg")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
