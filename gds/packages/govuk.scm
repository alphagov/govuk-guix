   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z8qj5ywkkyfsldn0x9cxpmvdr93rzp3g87hq9gcij65xjj9pir3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lvl7jk49rjw84nn6lpamwkff4di3vk7pxc8kywyxxji2gj6jpqs")))
   (package
     (name "smart-answers")
     (version "release_3838")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ga1sg4r55aabs58pn7yy6vyyk61vr5jrib9ixnhvwi3wm38jwf4")))
     (build-system rails-build-system)
