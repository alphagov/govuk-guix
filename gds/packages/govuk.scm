   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "078nszp6s5bvq5dmsk8iw6gcy31qbpzgpyyag1kddrqmij8svyd4")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ibif7xb7kv31amyncijq27pcxhdf0528p3hjydq5sg89p3ir4m0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sh0pzwl335mrpa3gkhwqzbnh2by3wramhay5kc9y1ff266y66f9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0f5dhwjz2d1smw0c3cly49njhl58spwzd6cwgqc8y30s2v50lnh6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01lg828pdhlibd0ama0fz5z34mszbi7bghz62768pcfjjh0zypwf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "17dw2xicvl55nms6wvj49ww8n6gy3dpjkxd1q1y55kryzz9n31wk")))
   (package
     (name "feedback")
     (version "release_745")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rjkc7pz31mrsg3y6i4b5f256h0flnq5gmpxcfpxdv72sn5l5rhz")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "06fv6nd2ifpaq6rn3d8s9sypapv406vy53067kf0r6kh09bp2ylp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wn7aam1nz4767v6z0vyk21yxx6za69q7gq47hfgdgq80x6ay34c")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b4zha18bqc694pn01543zrw9i651pimamsvvdmwyqw4gw1vcf20")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
