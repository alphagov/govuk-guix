...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d509ad0b2mx6rz1sqniaansmqp4h96g82fykwg0plggkyizx7sk")))
   (package
     (name "calculators")
     (version "release_491")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04fq6lq2dc81awdfvya13id3z2i16qnmv3vkyv18cn93vjh0m7ga")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "19nfpdqz0a7rg6gabl1i2f18l40n0fsvpcvwxzlci65glf6pmri1")))
   (package
     (name "collections")
     (version "release_891")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bhajlmc93a0fw3y08qjpp66k07w5awxar66yp2md8998irb01z9")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0510gmcmi6aqiralsy4fwwcwpyrsmrl5c2wvmrm9gjabhhd1qrjc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hp6yrajqh7pdc9gf26m8z7kmpxbczlzs37v6bj6kg6lj6ayi2nd")))
     (build-system rails-build-system)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sypk77k4alc0y8rsrsvsssyzm6jihbqvddgy3092mygdj5dnira")))
   (package
     (name "feedback")
     (version "release_666")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sdswzwpwv2z8mjrzj4vx1zq8hkk6aipxbwr997iar8zjxk0g3nq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "07955ijn15km32q892px8dflb6qc266hhwl0lhshq9b3mrqvwmvj")))
   (package
     (name "info-frontend")
     (version "release_354")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k4dv61n15dp3hj7s3nl9bd0s5sq2pb22i2vmw6f3f5zmnwim8sl")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "00s68gidcf2aaxanm7slgrg0dfrysqr07kyjzqcalrm5jxi2fb9m")))
   (package
     (name "licence-finder")
     (version "release_584")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c3vjh2phxggcmn7fc8mhckzh3vp1d4mxgfw3b9qffsn2bfy3c7s")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "05d1c8h0yfxm8xhwy47lrlvr4sag7qwwqai47r8dafpzq25n6khw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a349k9hk472k7b43a6c6pafzqi9annpxmxdfh0hjyaq3xrx3c7i")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ykicr60kygrwl2qz1gcsc2babhmzyavqgbiwvcbijk8pyn73kgm"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ckzqvdd8nk0j7iw9vws5m3k8nqr9m8l1dqql280k7fl19ba0wvh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
