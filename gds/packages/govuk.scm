   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mnj1933z9zxqimh0qjsqcf2sbhn37wiyxbpwn410cmyf8v563g6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pf3czazfarj3q3rqqhgkarcf6vlim2ww8p2g4pdy4cy657bcl1r")))
   (package
     (name "whitehall")
     (version "release_14478")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cwqynvq3rl7f1cfi5n168p1n9n9dbgfhxqr9xp6qjm238y5ix8g")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
