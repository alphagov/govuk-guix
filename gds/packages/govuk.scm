   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jfb1nc4xm27gp3a9j5y7xk5n96cqqshdi4zmqagfxpqj5sjdxi9")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04000dc57szns78yffh7mhpifhrv3qz51rdj4m52mcpzd7j9j6j0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h4bq9jvmw5friq9kg1i16y03rl7hi2fqz44408f8bfx6jlpj5ya")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qvd2hf8lwxwn33w3i3k1dxj6zny7m1s3xjjvwfbrbk5xbz337x3")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12737")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fwwz96wm0wv14ycpwbib79281xxasngydlxz4lybccgnjilbxhv")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
