...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "09az3r62qhd82nslfrn5q0ycf7yd6qlx1h3qqjxhkzp0crpwwjw7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a1qz9fd1x5ag5gwbpzhgq24d7gvz7vmh43q2ds7vd0xsmdf2gk5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license license:expat)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19r254z99bswc8jx2xid3m0wp6ddjd7x9jxkj8v4hd2javxgznrh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13632")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06xhgs0kvckcxyv43qb388vm4fjphmyv0x14ajklpax5n9bf23ph")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
