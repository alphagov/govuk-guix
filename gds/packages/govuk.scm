   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c60zzh7ikxmv497hd425f8zljbsfs4b3bb8vckfld9ky15sr96q")))
     (build-system rails-build-system)
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "19r368v2qk1f9q389p7q4h10chycqd4ak9iz8lvq2qq9dxf0m413")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zb6nfsy69200ai7q4skwcxkcy025a6n149w12jig2iq37rhia4m")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2762")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0csz250n42sz2k9fajk4bh28s5qbpn2b41xqxm9a9alxhi2bwng8")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00hf38ixd18hg75pi7iw537q919msn9ddgxlby9dkfdlbsxpigzy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "17360br93fha3iw234x0i3kgl0rqam6hfqkrh9maqailarss3hxk")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14aj2y7w78p3xd0f7g9r7318x17wm4ihy9g1ii9x4ffy6a7i3grp")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n2w32z2ira9vpjry2zk0zq549azcibsjlc4ij2ini5jdv8shda6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jkr161ldf4mvj4bdsxjf724kwx07nwmjckh64dpnrs3ssci0gwk")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13082")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vhxgjd9a8vg1g1a7sj05yvhqawda31zklw96rfnhxxwam2dazx5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
