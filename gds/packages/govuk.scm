   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k5jxy3amcaadd20qf22c3fx64yrgvvmsf36llls980bjrar3i83")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0671zsdplvwwi2pg1gb8m76n48hhzbkxli9a2b18a6k50ywmkmpp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fg30baddzjpnzv51aqypjcm1lwdqb7r34fl5xnxms2y2q6sbp5q")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qzjgagcwhqs8b7xhpw0s9mxpgcngd6y9wky2liq60jr0akziffn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jwkrqjyj3kj1smik20xq0lscppdqjmny21izk9cqi67r4s1fpfv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "052gjfr7b6lr29ifgwb4bs7bsl6svscc42gzd2m7cgyjfhwf4crf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jhz05lh6xnkdsb1jq90gizawg88vk5jnkia70grbva2pq0pk3bv")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nka2yz5iwnh9v2wcj4l68gc90l2i4dvvyjb4my73wz6426br2jl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mkxvcm19vmmbicw6alxcyby0pr0pnn23p5rnrlvzkznl9pgxjlg")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "10xbk5jq48xiybf3km8qzlzn9kdn9lsbmxpsr19ijq2wbijs4cjx")))
   (package
     (name "maslow")
     (version "release_366")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13dsx1d9jz5jzifjvwjwsfgv2dxlgwksla6g46f8jvc1nk6vrjxr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lriyziz3jck9r4brzq2gys0ij17s4bch749j8c6lsnm912niyjf")))
   (package
     (name "smart-answers")
     (version "release_4194")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09l0k63mscinmzhlc8d8289p7qvzs1c2zp6qvxh276ajvxdbmly4")))
     (build-system rails-build-system)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "09bd4l77vbvqgn6yff6yzdmz69wcyfjq96zk0xncfw9mmamad5i4"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05yimfvzjl84x0j1kmpirs8xayl6qg795r3w7vgvh875s3xk05cr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "174bsmsicp2k4vhqrszkx8jxczihmjskw2fcrl8hd1mh75vwq0h8")))
   (package
     (name "whitehall")
     (version "release_13906")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14ia2gdw5xk84bcashgji9im673mhczvvwsbvigka2iafhwz3dq8")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
