...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0likk3jahi92sq9v6d6q6kq36qlcdh7nbgnsjsy173np8wd5kify")))
   (package
     (name "collections")
     (version "release_808")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pb6q46mrf4pk3n55vhbjdfsvy5g20i9azb3yz2j3kg3l2srjfp2")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lm9bz7lhw8kp8id98pkcmn3v0prakgm570vhzbv6dvpm5l4dp41")))
   (package
     (name "whitehall")
     (version "release_13920")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v6y2c9q7qywb8xfwpi5zdym85bd5bkignf3w2ahbwzyaby0w9dx")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
