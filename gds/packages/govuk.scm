...
(define-public content-publisher
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1872")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vivna74imffdnzxgqzapi6r8cp485npl0syiyamrb0dchn6ycyz")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ymspnz9zgr9ww8rlzq770l2889rrdbv7g9zxb0h1x55cf8fljbf")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1w2hbq78v1szawwbpi0j9hpvysaiqv4iqlzc7flqyv852087spqd")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4893")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gha148rrpr5vzmv2zanjqw4bs2cv8b40c5wx0wl84kjgiqizlz0")))
     (build-system rails-build-system)
