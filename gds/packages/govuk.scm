   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bsy0cv08fbmsqkwa49h9zdgwb1whb3dbsnff3hbddvphfg2kb9m")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1icbf1bzzizzbx3by6p2iklrvka0c9yaw77gh735hdwamcbajwia")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1rlgs88gy89zk8lgww0w159av1i3cdkhkycidk6ppawvflvn03jd")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3752")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11maw5z93rd03vaqw134nf1nj89lc9wxiq8s00hqn4ck4fqxh6ha")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fma997rsjqqlf3pbqx2xa8y46cwyng6hgdih7bkblnwgr418bc7")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13026")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07gygyqjc4knvvk2vsx7i77myzswy31qp6xsc557wvd1s7gv4x5h")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
