...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xq89f9rp585r53zcyazmyzkf06f8c28jbnms5kiyv4j1yls1mk8")))
   (package
     (name "transition")
     (version "release_808")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0s6z7dyq40agav3n0kngw8flcikfxrgi2jhcyz74h9kjk3r6lmyj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13146")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fx2y1va16hn3djhzqybh7qp8hyl81qk7xrxz1shyvld90bnk48p")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
