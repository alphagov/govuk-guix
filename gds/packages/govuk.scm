...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "01lgx7i7afflwacl3fwa5pkima604ycgvkc6y3xgqd6v81zpl0qw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05v2q2jnhdrn67f8yrkgmx3wxrmvia4x7gpwmlwaax7d9zz5hyqd")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "00i4kp2ac6d2amc9cjvp5cvs4ip5sfwsb0sm22nrrwnfmvdlgywb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bipf3n68ir22jyzqdmyhg270vdkwkh4xz3m6q335y6qlfyz22qd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14067")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "165mvnsp7f5fb3dzglal4f59s5x554p8z6ya9n6n3fpxlwlwvk48")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
