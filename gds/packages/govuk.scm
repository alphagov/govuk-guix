...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zadrrl5hr1ay0qf5fq61kr57im1cvzlw7ps5nwmgnj6kr95x35y")))
   (package
     (name "calculators")
     (version "release_396")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lxjy0gb6n3jzsmfl6liqnkf92cy7zadqlxcnaralr3asay8npig")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1schikrq133ghsa8c3xh98286ciar3sghqmz2axsr2mdg9n0a72s")))
   (package
     (name "calendars")
     (version "release_613")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wkmr6gg5z97p0mkv4g71pk0llysx7frw5axbl20cf1fldlp21ad")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15ilacqx59f0r272l6b7bp3y6b2i6gmxbi7x70519lnm5jyq8jwq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vyl7b7w69hlfac9kzc1gpg29p51zkmw78i7k5kvc5jsxjfhryqs")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09066zsd039z0x5yjxkg3pfy8g0w3zkr4rh7hdw9ks8ggvd3j8xw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sxf19fvzq87h5waix79w4far2bf8dycbpzlrzd0q47gc0bw1jmw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15gz7l0gs36kcs8i20gxli4d4jnmpmw396nq5bmbm9g6s83p78ib")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xjfd6gg28imljm6a68rbggivwl3568c66lf52w9v23bk0yhakzh")))
   (package
     (name "feedback")
     (version "release_539")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11070jammk34ns0h0rpym2kprzvzxafc9jwkqffb8jf7lzfcbirz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ykmi65j3k9jqfx6q5dg7ya74g02c3x4ps74bci86mdsjks9lks9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08n2c60d6m5wgvnb2swhi6hyzgifngnxxk082pk1yakpa1g92x2b")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rw6x4mbq7f5j7hw87ajhyrinf239wwvm60n8zanvacq1dmjv439")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v0p2a2jzj92yp4kig9wrksb67p2qrs99j95dkgdv6gpby02a2vs")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qbzya2kw2l6xjx577m5gk5dvljnxskvq52b6lb17q7nrz7w1kv5")))
   (package
     (name "info-frontend")
     (version "release_247")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r9ag8y3x8fyl0nk26q73r80bxl18cb9hd2i7z14xbd5qp7ya5l8")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r6ak0jdb5d5vxakqcamw1mvx9p9dfqwli39wrnf6hzi1vfgaljj")))
   (package
     (name "licence-finder")
     (version "release_484")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19cr4wdqhixp03ngcfhvsfv5kz4f6zf2jggxshpv890666bwnsvy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1z4ffxwpzd5g09z6afx6nza27lbf0fi7106vssynik6wgqvvxaja")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12hzx9mzx8blc196hh5dk8yi3sdw6npcbg9bzaf53iqxhcdgzma4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x5gk3rclnny29cd11g8lzwx9ssk96z6p1kdcq1by3596g9zfn8n")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pkag1jymp7lgz7gjpqg5a44dwd86fhdfaq258qh0c3pkygbw3jy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d794x4v80yxw379l6amh62kdlnqccph7gqyjpkdj5qzlq87ar3v")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "118c1m68ybmzk80sj7fqrx67qqm856xc7zk24cwbcfy8l4x62x79"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15d25xfx0x1062jkkhbk4v36bf0drzak4qdm5y9c613w8hdm32jd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ik87ma75x0ccqx0n7h71aqp9ywk7r8s1mq6klyw6hkd58faifh9")))
   (package
     (name "smart-answers")
     (version "release_4127")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ly42gw18lyalds6hjhj6rz19v5mmv5p83x6k286iakhykc7wd0c")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "10mci2ffrnpqjzngfxsavjpycd253a9da89qsrpi7wapa2av3gzn")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03cxh4hh1qbpbhy63ish01bpcc6fa462vf9ihwf3xv9i1nzbmhlx")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zbgi7z84qzyb9cskn6hvqapdc6yh8p8lajdrbirsk1cd4aa6iaj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mr7lrmm6y9xid7s32rdlb1ld9shvw7xsw0mxjd9fygsh7sl6s5j")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1678lw36rmlbshcmprl7fn6rr4ixwca33b2icjpp0p3ca0ldhpby")))
   (package
     (name "whitehall")
     (version "release_13766")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dprbkcda95imhq505ik6swdf1r5rnv5hdh994vi1wc1r0bppcpv")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
