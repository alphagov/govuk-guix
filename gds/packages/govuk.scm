...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "16cc0a42pyb8pdgnwmcd1m7pcwvb53jjfqacbx49ms1mdlcb0dwk")))
   (package
     (name "collections")
     (version "release_796")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01r5y1w8qf57q1fjmjq4wz6mk4s40m8419bypy1wm1sasa695pca")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bhs4fvvdpmf3i7pl114dcanlkc4j67hl3sfhcbs6hgz7r4h555v")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11hvl3l1653g52mp1p8admk0y7yy9x23ca1bqhirj8qy98ajm33b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l6qnb2dmq8lzywkri2hhrjac292p1yjs6lzazgs5qlfxp8z4xda")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "07vkllcqhk2bmlm4jdy6a6wmhy7mmd0wax2z34y001b966jkxr57")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g94pdqcqcpigc61yn0d7za4p6qzb6q5rdr5dz6i55pjysmf5j94")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fpb070qpnx7w30xfxwzq6ibsd2zkif2zz2h0122r3yg9z492fnb")))
   (package
     (name "smart-answers")
     (version "release_4203")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hyjvdblyxf9dwwnn7yxvx3870hkzkk8n9lmvgz5j298ndrcwpxy")))
     (build-system rails-build-system)
