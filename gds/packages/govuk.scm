   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04h70x96vbxg3z4k4rwcbcpnvyivcbp672fb1mr3qqw0yxsb2m0m")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1majkcfr3ydkplz7gnhm3m1sqsmzbsvzh8cglzjnfd93a8cscf0h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y64j086xf6wf4agb617wjnlcx4nspbk0qhd4nvzwq9phgf5pjbc")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "177f9pm5gzs0xc8vixhp9mrn7gdgxv2xmxlxi9ym70l70ixybxz4")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "09y4ymvh2p2n1cnm0w4vjclfnc15jrb5xbiiib0dxh7j2l93rx49")))
    (build-system gnu-build-system)
    (native-inputs
     `(("go" ,go)))
    (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ijv78wz75p4swfllxjy0i7bv5i5394414ipcbww44wbxaik11h1")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3587")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15gqngga2iq4gygakaklqrcyp7fw63qp5w41fj35y86fhibdd4pd")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15q8ir07na11jxdq3swf8cjdb5g1as7vjkgl1z9s3w6df4bld7as")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12783")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kdqmga676930155kars7k8ccn4ijmyi0jfz88n7266571lzj16d")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
