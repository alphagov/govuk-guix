...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bkmlsg0sxqfn05qkqyqbl132g57wjflln2c178kz99xs8rvgx8g")))
   (package
     (name "content-store")
     (version "release_690")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0adnmcs9hxwnpw16qc0al4sjw3agfh8y6rs8m10y1hvmqxdfxc1j")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "198idprfsplaii54i50pn8zq7nva1r086kf1i0kd5vdikxsmid00")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m31nhzz303g5q2wbqdlhl4z7adlqzkzlxsnsshr23c3xxbkk9y9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
