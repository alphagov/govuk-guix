   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k1vl6l8s59ffwhw0mlakx649lakdclvhjackbkllpp4ak934fm0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qy2danf7lkbwd3jiklnzgilwdy87bffff3r7jzh0nlfb8rbpbyw")))
   (package
     (name "whitehall")
     (version "release_13181")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rxj5j1pldbrmvl9mb0b1137x8zmcd5sjwc2a9fzxbhr2gi1iv5z")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
