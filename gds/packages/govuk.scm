...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fh8wccqrxq58qkvf8mmsacc9dafj6ywh9p4i3hqn2g6ym281hy5")))
   (package
     (name "calculators")
     (version "release_401")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14djxaa5f0h3ypn68d714r11lbdp3rwwh6c2imvcr5mqj22pa3m4")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qsji1n03rjg0x37mmy9l89lpxy7c0fbbbhh5dlpi9l6xpxi0fli")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13pwqck4pychnflm3dj88yqandz6qrl9v2iy53969x89p091vhnc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00wh4xzj0qyxc3yhq4kxi1mpljcxv5z02n97aip1w1md1ykfays1")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15401i487266zgdmav0m04n5v954fibl5dbyf60zicsyaliri36f")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j9cbklzdr4mzvci3xr3mw1bfaavhs2cfdzlb9vy0vrrz969igf4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1crkb530cam5df3vhf6pv6nc4j2sbwa2pr9sncq2lgbkq8m1klvb")))
   (package
     (name "feedback")
     (version "release_548")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fdavz1xmvqzqpb6kb2p89an9y7la3rs7q5ldh263glqbpyhnckc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1752m76cxfnknhygbf6vfph3mv6yl445qnl87fpwf3xm9pfhhawi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nc6wqbmkpik6vx7jkf4i3z4vzfb8akzya33smkvwd1jia6mf6wh")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jfln4jm24a78sclci2hiahsgxjqly1wwj15925sa7v9in4jcmlp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15bfh5jynamz5djzcjs0zgkk3lykbf8ki6nii4yr8r3qb1p8v66m")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kww3cgxmb44m1xyaydy9x8gc5kavxg3qsb04mz0px8z7drxm5p7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05fchihpwijwvmy84dk0sw1m1rf5w13n6ixz7x0jb91cy348f2iw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "04vy3ysibr3g358awr8yxmyx1gy459jkfk4pgijnn8hpsk8f98nd")))
   (package
     (name "whitehall")
     (version "release_13796")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00rf5s63gvanwbxmdr72zijgsai74c0mhs8hm0ap0cm4xivzk5p3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
