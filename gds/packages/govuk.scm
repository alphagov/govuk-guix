   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lqnbq3qm7z4m37l659azzysigy121s9p2d8yg8ci5v67zf56h2x")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ksvq57f5wqd58d39v0vcaiw6f92ir56jwwiflpvzlib598ns1xp")))
   (package
     (name "calendars")
     (version "release_909")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1298rmc7yl6pwnm9acs048dy0bvd5771cpsv0cvdhc6haxfd9lgx")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pan4kv89hfpnf8imygyqawfdd5ghpv9iaf8axb3gfajk5zdp2c0")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h45d0byk427xh2v610llxq49ak7bmyqqaj99l188ka1ljkpbpz9")))
     (build-system rails-build-system)
     (arguments
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "05544l9vj4hb7wclffy1jia1mih9jgmpmkwrhk3nk0ln4m9awqw1")))
   (package
     (name "feedback")
     (version "release_836")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pma36yq87pah96rxc8vf2lvcxnc144p0xlf4jkw49rd7mcdvr69")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xi7wafvfx6hrcxsh7xyxpphcz1c1zbkzh1ksa8q5nf2z6dw508v")))
   (package
     (name "smart-answers")
     (version "release_4665")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z95nmhfksfdn4qvsq63d06zj1vl08d5m2y1y3s5cjpw2d2ld84g")))
     (build-system rails-build-system)
