   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rppxdvip4fkjfmr0nxvhvialkc7ig8mjf7p0snpdyx7x0i1xvnf")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ppjkvwq09qgd2xaavj4plzsb8v2sg3iagva2i4fshbprk8zmsr9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "09zpgsb2xld5yk2nxg9a25d6bdbr8vfrx8b54pnqvi9c3fa5pz7d")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c4v6q2blxvhnsy8i14vqgb0xjh4m6gnif9nbzzmfw10myyvs7wr")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
