...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "086r15hb0dlz9il01cw2l80x97pg7813ns0rl0jb4sbamqdhc1gy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wis1fbpg11jdldsi8vdfps6887x942p9ligjc7sxkww2j3bi1zb")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cpf19pazvnjx2fsi7hz70xa5czalw0v7vcj39lrqywbfz86j6qc")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public publishing-api
  (package-with-bundler
   ...
   (package
     (name "publishing-api")
     (version "release_1515")
     (source
      (github-archive
       #:repository "publishing-api"
       #:commit-ish version
       #:hash (base32 "1im4spq5hkngawymdwqmkc9v4021bd3xjbsjvf4aqa51rh346867")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
