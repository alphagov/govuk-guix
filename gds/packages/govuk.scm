  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "05qnnm54z9kdzpn1bixr3926fafczbhma64mbfc6fxzkm3cvzwvb")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g9r1zqxszp347lkali534dz071chxyak2485yriizyd8wkf0y13")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1khgrpkhj0vkj23ik3llapqm6h0wkdxp23mi4ksm7qaxdqv9wshq")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01j7z5v1s99g91vvgrzz0vrfr0a8kgkss054vzhrjmp7rf3j34qd")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12767")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11d6i45px4xhrxwinhwyxznkf6d77q09smrhnxhh0anv0ax11pzw")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
