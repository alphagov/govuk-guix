   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lq906fav3zbsx4hpfjbafpja2idns1vw3bb226ilv0q2dx4jajc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1vnyz77a3q7fgzsbccygf9120cdyysqi40amc676ghj4z62zd825")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "17q1y2gszpfyvqpa4ixy339ncxxwm93jw9v25ffrqqmjix8y1fp8"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ka66wx5gf86bgxdabyp0sdp1p0qwdhjv9p4rf0mc8gw5053k7jh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13556")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pvsmf2drbxc2yklzbw7s30y1pc0cnb0m364bplq64kixgpf9kh5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
