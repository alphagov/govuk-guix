   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qjxhrwy8y3vr83ingnqh2gqx5qg7slz4yxck7q6q06yz3isgpnb")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mx74xx491bdzb2dm14dcb24k3fgnnyp3lz1ya22m5jb735zxkib")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2688")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v8n8f979x7sf3h5kazpd03klj1f9f353y7dwv4cwavc59m2r476")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13019")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xb52j9km7kblf9mjhgz61jq41wsqqzg797sscy7dvqf3fx6ix7g")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
