...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "03y8m4wcwbphfhfndy2c7mx6fk1aca58mkcm47mqdabx6hwlfi49")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g3s74d58ab7kpw1zbfzqjfn1m1lmcrq7v7nb4w6mb2m68mwlsxw")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17s4vhh5d2m3yqf08knziny8k9kqlhfbn7lx4wa1ndzxg97f1vcx")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2230")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gmdcwfkpg158vgjd5ynqrbdia8gk1ng99f23l4abi8n5z0zw4gj")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
