   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14by5qsndv24hn6znncdw5dk64smr44if7zjn9bjaq3487dak34q")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1valfhblb5l7a0rbb8yna88frlchn18qcqrblnqn9xmpc7ksiw03")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12739")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c7lsibaxzp2k9xwx68fshnq655z0208h85xq89amzk1dwvny2c3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
