...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "11x2fd3i8fcy74fja0q04gz5x8qjkjr7y8k1bj2z2mbql198jswa")))
   (package
     (name "calculators")
     (version "release_688")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pz4wy933q1lvyx6yds5mqvwx80gpai7vzww18vgjczgasj5rwid")))
     (build-system rails-build-system)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1in5nx87j1gbgwr19v62f0nk6mxkc7874y857pwplys76334z0yc")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w7xb9zss129hgvzb83fdpa42jl9wlzbg7xfxsfr6lggpqxffc27")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wgixcq1nr5r0w7f6hk3a3by4apszqa867hazjfa0yl2z3ks5k3y")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hqspabzmf1kh2icjz5c5xvrzxiq9idx944ak8vqmwz1gq5v75gk")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "14fjb1xgpg5xvajar0wrcrsqc441r3jwgphdnvdwll1w443xg9q7")))
   (package
     (name "smart-answers")
     (version "release_4699")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nkll7lzhddj0i3sznm2naxb9d3m3mpycqkh6smlw6z2kndbg1w4")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14701")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "107vf7di6jh63jb8rh3iajiyypdm6r5g0b9884nzdn1dxqf10hfj")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
