   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mda2hhi2i3b6fb0xnjl90kc3s04x9ghzg08cwqa83mx2liapmjq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1chdxka155c79csvrpv0mr9mcp3iz0m2gnrivvk9gmmz0k78fl5w")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3635")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fza6qjjaww9249hgn1d7fh0bwh9npc666kighpvd5kpwakjpclg")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12850")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yy45rxc0mdx43y5401fhgyaw24pda88wn9a6wafjchz582qjm8z")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
