   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18i7izziwmhig0ds2bm2q87a8sf65rrjydna5c25jvd94qgjlyys")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "190mpi28s19wms5bnaav3fs69g8qjrvz9ccjsghqln7zhq58df2h")))
   (package
     (name "content-tagger")
     (version "release_496")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "165w50nk80qmqwphrbddm8vikzc7xm83gladh0834mxbxqixsbj4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dabx7xamim71gdr5v0ikskmyki3wk50jqbn4hzip8vkbfxk1vvm")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11w584d498p43j5i050d0g1v5d818bb96qj7sc7krr9ppncwx8b2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public router-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1aqfknbh4c62qnqqi07vn5s8vhh49pbpggvilvnfixcdkffv6mjn")))
   (package
     (name "router-api")
     (version "release_121")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fl1n1j91zryji3xm230m8yq400mzbi9rzmlhmaklvf337li1v9y")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gj6sf92abcl2s8xhxln7b5wzx12j5h751qq96nyaf6nrlbwf3jh")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2656")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ay195afyc24y6vr79id8a61qf6k19brw8q0cj5v5vnma4mrryzl")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12972")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04aqw9k56ih0kj2d0zdamql9x3f6lgmni7asbj31q10pah5vb6bj")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
