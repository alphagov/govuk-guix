   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lqmkd49c0p8gcrwlay6y3kcpnz6nqq5vgiganq2is43v590bxpf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a5fl0p316v5nadq62q24k43bgjcaqlf5hfdcral671fl7qlvkmj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cyqmc90xrqjqb1nkl310q2mk093fwy87c2zq1lvd2pfxv6xr252")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
