...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wwwhh6jaqbkmmil5n678ymbighxqlllavzlfw0q5aqaz3har2a0")))
   (package
     (name "collections")
     (version "release_896")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q0q8180njdn12nh807ssi2rh1ggv71x431vcq98q9sfli5jc2ch")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z4ljvym1sbvj311i0z6flx2pg23biq80p15i3691gi41pb0h7jv")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fifzx2i31s39hx4j57ahvlxwdzdk87sblxbwlizxvygsi99b41v")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "05x16pbjxxg1hk7ypdm200ia8yph8ndmrn4690f2dy0427l269bb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lyw64bgh5yfmkkl44ld8srs2vzd6i2vladc0i5xqsg0s30p7sca")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
