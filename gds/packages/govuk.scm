   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iia46m0a2hfj858znbg0py56rnb64yi3wwhz9kn3j5k8wprbm6p")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "17pannhljly5zy7y81yfnxfhpgd5lpyfd0yrv0xnh76s5vssf4hl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r6pcpa8pdd8zs32l8aai4yfhfnnkj5g01glcpb12hpzwyyc9wdy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "0176hnndh3dgsyz3h6pqzyrsk6m6l15i1yv3aqd82wll74knc6l8")))
   (package
     (name "transition")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04scplpv6zbbaaqw9r318hb3dkyv983sy8w4knjvp3zgy6p33flv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
