...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hvvhjy8ad6885z344rx71mchhixg8wg7yxzc1bsq4i0kna46nxa")))
   (package
     (name "calendars")
     (version "release_680")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19ik264bz4i9s2iz3h4dkhbdn6ndrdiz6shrscfj001wp9gx4qi5")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h2gqj7x3q7dh4n80jlwcva5a6f43gzaswld0612j1ij1yq103x0")))
   (package
     (name "collections")
     (version "release_828")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0s5x6aaxc41xqdbv42w3n9qj6d5xxa6kgi2fwjgnnfcp65xbnny9")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h4iw09dxb2vf9qqf0pmwq843m0bn3jy43jsjmy9v73z0ka73r8z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sy3x9q8r957yz9x4friy2hrhqn5chr63k1ax9m221wv40r7ipv5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d5dx8d3mwrs876dmrmwmd58jsl8pkdsjvb6lin67m89x2y3866b")))
   (package
     (name "content-store")
     (version "release_834")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1371xhslj3nq08h23wscm1idwzbqyd9zk770rkqid4q5l9n3sl8q")))
     (build-system rails-build-system)
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "080mh0k4cszybb4kd0dm6ipm663d6aypjiq5r0y22w3fjas7s988")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xknfr55ckvpgyc01qaws8mzd01db9xv9g9wdv5qjdy3b0m0fvk3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0i9h3jlj3w7ba44a53c2q4yclkpaaxzzyggpiscwjb8p14gk1qh6")))
   (package
     (name "feedback")
     (version "release_611")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rqqcniamk7v2m5ggvx6mvay1jzvpni8zdkzj2shcdqqb4bgbkzc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dgml3sf3i3bdd86lj0zd6qk1jmr1f56rzv4csn37icmc2d1if52")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bpgz0nshnfbfmyzya6chvhbqvnb2mv68w3mg7iil9118dpm2md7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "055r07acv3ys1kjzgjs4a62gyz4g3g6av53ny7gklsi1b3r8a0sv")))
   (package
     (name "imminence")
     (version "release_488")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s2cz7zcfd79n83296653nmckq93wc649h9bjz749nrgli4zb25y")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1knpfpk43j806bs5rks87w3is7qw5i9r90hv10fl1sqjs3vjcmwl")))
   (package
     (name "info-frontend")
     (version "release_306")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12a6g1c7grbr7hlzkqh53q00k0al4vdy3xrw8wqdpz5b4bhsb30q")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public link-checker-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "037r0704i0rmdfpkg3pkp2pgin2lwq9ws3hxsd4v5wqxlr2dg26z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17sfwwbajalpbqs8lyhh5z19ybyp5nwacc8m492xz5y0n1b0g2ni")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f))
     (synopsis "")
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0flrh6qab43w1cqlvfrfb1pwkyirn6fysgp4cnbsbfq7jc3p3nwx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15dhbgrqjjfask7s1djwqjalvcacrgpyshgphkq0qw4i1abjali3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kk4v0n64rl3m0a7h9haj2q2nl6g09b8adbr6rd9iicfcai6fn6i")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "139zm8i707cv30wkp2aj6cnc8gyw77r3fzidzsx91ny163bymip7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public router-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xrgr56jkq7q7nkjhdm9gmbyh7xhz059h02z16caikcbf1d2d3dk")))
   (package
     (name "router-api")
     (version "release_201")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03lg0x0qyr46ikzi2s6306wqfx85hv09nzc8fhzrq8qn6vjxvsqm")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k8qxyhfcz4h88znl3ad857hiwsbgl81a12dha03gwms0hw4cp02"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xgpgs8p30vzc1sprg597njxq9qdh0z5frlnwflnyylamparfz0y")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1klhw1biw2pmc93cybgmm2a89nzbdysfjv10cxjq5nx05bq12qjv")))
   (package
     (name "smart-answers")
     (version "release_4242")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r63bdyq7k95hpzs10y6wm401pnxr6l3mjy743ac839zylq4vp5h")))
     (build-system rails-build-system)
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rz0kvjr74x29hk6rlzj81i99l30n36fak0d82v5apa3imqy4wp1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rny85ndk8vxdfzrhl018rjwlfzm6s1wwmwlvqszjqxcppr73isy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d3l8jxy6abdnyxdnvybjzhzy714s72jr6x1gh4srfamksl49inf")))
   (package
     (name "whitehall")
     (version "release_13947")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mh42nkcgwzmspgbcjs133y39ppz1db2gf3xavjqr8cpm1lyz95l")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
