   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wyhdjnhdzwidbjwwwkvpk3b3hnyn4amysakbk8pklmjdjmwk4bj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1phpjbni7x200ij6fj9nhclnx0zz4zppv21irlimlixx0vmzb5qr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00gcdy8jnlk16aqml3fprfss5i4r3yakq2x2h5fwrwj8x8d1ggr6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zjwyg2v36cfv3r75fx5ifr2akcyp23q85nnh07dig29mka9cys7")))
   (package
     (name "maslow")
     (version "release_260")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lbrzfj25ggfjpkzi294ylr77zfnjpb7xnzgdc6i07v39zhkpdkl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
