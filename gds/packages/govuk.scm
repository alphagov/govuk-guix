...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "12dyjzkbwv6g30qrm31n4npqvsbs7w940zqj8qp73pliy5kpwr55")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hq1c2hzpli9kqbrifr412lg1s9cs0vbx2r3k3fypv91bz1sj6a3")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "14792p5ir3di2hwqg2pmyw7hkwisx75d8zc7ddv657qh749h0v4y")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dipn6mccmh1qws1qr73wm7gffi4gbimpmycvz3jiyxbhq6ibbvg")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "018l5zb1c1z87gbd7m50z734p2a7har904x77r6imkmfr24ygiw6")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gvf0zn2sa1z8cavz41pbwz1az06ipy2x0z7ln79mygjksxhnyib")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00jyxqzk6f8awbbgxppfn6snyaqi0hwhn5nzzd2lfqbph6c06fyl")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "132maagmjk6gpmhbvl1n7015c664h49mpkds4mklx59h05d4mlws")))
   (package
     (name "frontend")
     (version "release_3567")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h3z8nqpv0x9ll5hjpzl0fdm0hxwlkjg85hb7wlj0pbap4vlgpkf")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h0w1yhxcgw6ykdd5mp2r566jrp1z8168g8sfyzbzhf9299iv0cb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13hd9i2ic8crm5afwgwjimm34wsgndh0yrak82iipaxjz761ldxn")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kpwc804zkmd7nhaybp3npz0zc7nrh1bq4h4n5zlj19d22994cfn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vznnipi6r6b54sc0xwcwv9hcjf0aapg4k5jjynny4bvi2sijw06")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bgrn22i25pvrj0yvs1b38lnbrazvns32cv5w13prc145p3x56px")))
   (package
     (name "release")
     (version "release_636")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "035rzqq6zk3gm2mg6bbwc4l7z1v6009qza8m8iv3qdlyrp942v0m")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "01zwk52bck10v05frj54kcz23ky9wixj9q9n66vkab36x3wf8ara")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lq84zgh1ma538wmilszg8gn2yhbl8z1w6rw7lwwg99pyjkyf5jl")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bgmn8w02v06aiicnlgns51nc7ch724ls3rpy1dwhqib44rwlc4a")))
   (package
     (name "smart-answers")
     (version "release_4774")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s5xy2zhj4crl1v7a90v3dmczgxkzk22wfv48waxc850k04k842k")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vnswbibz1qi52ii3kmvr0p0578y4dm94ln4000knsrvm9z0csq0")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d308r5z02vzsp64hmykw5sln3hvc48gybmkll3hxagcg682w4nn")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "12n1ij5jiz4ls3m8af1pg9dga2f9ms5zr8g04qi6fxsymhxgl0j4")))
   (package
     (name "whitehall")
     (version "release_14766")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f6655699b28xiqnz4yzgy7jc4bzb5nyphh067ljg6wkz9ijs71r")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
