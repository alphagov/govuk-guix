...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0i7p6sgcgazjzxlcbyi3cqabwbv31r0akqyp94y8ymmwx5j1xybs")))
   (package
     (name "smart-answers")
     (version "release_3885")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gnxand0xanrpwppn0l9xb4lk0r11azkkxxzv2529csn0l94p49f")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13339")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "097yzs2ijyzdq6nsgfdl67w8pbjkk2n2pffa8fwbz41sji1ip6nj")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
