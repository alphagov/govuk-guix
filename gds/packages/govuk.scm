   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a9mx9g057kvwg3zia6pkd8xl760jmxrzgf8g85b2927d29frdaa")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k3md1wjsymwjmny78mjbpkbxpjssk5ax49qia8gh6hdq7z1mnap")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lxlb6mdf15k0j62lqam875y1sf8i6kgpkf2179zfmmpkplx8wk5")))
   (package
     (name "whitehall")
     (version "release_12762")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0864qwlyd1acv8hk4b01c13v10r29ibk78zpw0l0zwkqpjfi0qx4")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
