...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rsm1akh0537lx8fzs4qraynxl0zqrn9c57f50jlxi11kiqw3163")))
   (package
     (name "collections")
     (version "release_772")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10yn1ham0rdpsxrnpjqmqcj4fc2lhjd7ns8d0zhrck53fp33y5v6")))
     (build-system rails-build-system)
     (arguments
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "14j3k8kp5j1dv8m6a5jr62c3ijhn7piy0rimdrnggapraygq891d")))
   (package
     (name "contacts-admin")
     (version "release_534")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k26bp9ih65y7a4hg1zb9jw9dkkwlvnkgx0wp1mnrjj3c3xl5b7g")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hpzw0vlc9j0p3nvbjyl2bg2wx7lpkdbcfpp5lbyyznbnrxz33iy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k48smkzbb4cjigprxxadlrxnia80jg34zlmwy7m98a5mnlbk9yy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rwsdhl0r6cx80m6lz1y11vpqj18l02miqi3pg2vz9yj59ic6h6q")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i1x9n7hb0z1c6civzg0z3hs96d8najqwbp0v16hd4wsz1gcbn83")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xb4f9h8mkx9m994vbas27w6fg7adfsvygs454x7v7flp6f0wp21")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "03zaw4pbyc3fkjpm70gjsnpkzf4rjn2k46w3s9g2ik98px15qcqp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sman1la22vg2j9d90z4d34g3m3madvxzidw2ff54yzlz42p4jaz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12yjz9jnz3if849p90527qp6b8ylfwbip3raj58995x5p31fwx86")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "15awf5k6kb48xp2v7yqf19nrj1ypl75cqj83yqqlkbjajjw5gh1m")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nj297kqjwfjwwmiq5h1ph1cwnha888ya53ynbifiwsrzyyzwi3v")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wvxlmn07nnm0xh5rjx0n1kicga6zc8kg22spy230ld7dc01ia4k")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1461rndl96a6g3xk85vmfnqbjgr2ay1dr5spkdyrga5l488imxza")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0sgkiq6nnmm8333rkklq6dc8xmn83k8qvh2yr5859h3f7ih9zmqr")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nz3rg4j2lr8jm4g4q51zpbd6hnmpyh7qplhp8qgwi1qwszdq20h")))
   (package
     (name "info-frontend")
     (version "release_279")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mizmca2gsspk21c34bf1bbacx7h45fwb5kn3sba8fk0kmn99rbg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l909qlxzw0wsbddnkpcv1k9iq07qq459gvwxinrq7zb78h27w5s")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04bpp977w3jp7c4cd0nay80lnrw1nyajz0b7ci3kqd22a11lkayr")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13admjwc7607v1b9wfcplycazx77pyqyxsmi7k1hnrmhwnhd3cvx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "004q2n7g756d33n157v3nc1x8hki1vdjn9c65bfwh7wr2hrbj02z")))
   (package
     (name "whitehall")
     (version "release_13887")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0idkf0prk4nvqs0rx92zkj48clr8q9jzjcyb7qzjvg5wkbqk2yni")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
