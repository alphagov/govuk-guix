   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mjxrvm5dwwb3nhillyj9qlq2m0grsx1p8wdzyfszdgdi6n5jmz9")))
     (build-system rails-build-system)
     (arguments
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zixm81d6lslnsgmx03riwx8pyxhqdns9d9insba89njyd478z76")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1br6yx57ik9j1wkai6c86qpgpb63l0hfa858jdwfc9afdynjzrpm")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4200")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wra0p0chnqafjxqjbfhzgirdrlmb4l7swnbdc7wrg388jrc7aw4")))
     (build-system rails-build-system)
