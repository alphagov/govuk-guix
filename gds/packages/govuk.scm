   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j1vi8i8hik4hn2bgrd7sb891z4amw04ywaa1xk6x6qzz580z8mz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rax3bxdjrv93lxs78z3ycdpq534jzk2ffskxw9fhxbspcby1vcq")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ll5h5xsbq1n4sy3k3cpqq54pmgrw94zpii99zyn4056jazv0a8y")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13120")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "170ybj3sr4napasi385afssiwg40kawdw90gxc025zhrbm9pfa1q")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
