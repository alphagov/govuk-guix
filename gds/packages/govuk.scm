...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "103zfjgpnz1xszx8nzzb7ah8rii6pp81v6g7fljjq7fqcjgxw8yj")))
   (package
     (name "calculators")
     (version "release_625")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fy817qxf5a1x9pcjdbf7qqgvfhyz5wsdz4waxm90jyqmpsa71jw")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1n5znrnf18s22hvklarwpyr3dsgh0zs7459102niwrc5373rwm13")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06cfk5z29j3rrsrbr7aighgv94gf1hfsz9mrq3sh03rhl5c3pml4")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q5p4rcxygbmm4qvlharm3jvf30w13dnr51nx48x3qyiz0yk081d")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yh615hw9pdz1ppr4sq1lnk2l1h25y8977ic4q36p63aly0i9ljg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bk4l1y6six88yazs3q1wi4vippj4063wlajxn8l0zhmi1v24364")))
     (build-system rails-build-system)
     (arguments
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3419")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13g7b9q5nh0idd5df37q48yxaql7z3nk575ykp08bn0yb6f1yhc0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nrzvyi2y0z5syrcy43w0ifvbirk2944zjwjpv9f9aqn60blhyzy")))
   (package
     (name "smart-answers")
     (version "release_4565")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q17w55g79hgzsh2gbr6j7b2msv3qvgzqxmmvkisrazq3w928q1g")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0blz4byrn03p41f6g0jxnja9fcrbmg4n5jh1jda4jj00aa4c0gdx")))
   (package
     (name "whitehall")
     (version "release_14491")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17a0xh98myjg7m0jwqlp6sfivcx4wvh1a0s67bw5cc1gib282rl1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
