   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vi8xrs2i6x9q3jpjd04m4yx4zdcsm7dsnvf69qq5swnpjflm28b")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "16n0rm6wz5ipjascahjlf3mn1bdkn22gic88gria4f8kdih53r90")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ijysjgs3baikplya2ldnk3rdhpf88mq7nsigcx6212xhnzzxqzm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0p31yv8l10vbdxigzgqh8nv3mmkp3c8y1c7cj1mq0ng31pmqavaz")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_5008")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12ql2aj4g0ajw2g8fpr2r1cwhjrls3p40laspfnzjzsfkdd0kpb4")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bhyy8k4rrad9i6iv1y17b0nj7ibcjc5r1a10xhd99ymc4mw518g")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14899")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06iv6jh1mbaq8zvnkjxmp3m4bnwphszpkkn41w09c1j7i1aan2c4")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
