   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0za91aip8xwh9adm0gxqwc3lph6ffpb2iqckja49irvs9sszh6c6")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l7090xrx5q9dvs3isypmwjph7jx70pzk67yynfsax202mkjv4nr")))
   (package
     (name "whitehall")
     (version "release_14721")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kx1pfs37cvalkbrak4wpf2d5crzy8g81yq9v32c1ai48iamsyk5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
