...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "17adlm3k34qqrvdswl7bw264hxslq4qyz9l5bfl005jfwjnkp9yr")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qgssz24qj8d62adxshlmwf48am5l2zg74wllrypkns69nk1dx68")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xi2fwdbg2cfm20qvvcbbf1560mslx3fgr9y2g78g3q0hblcr7yn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ibsb6p8g2a796b3pdcbk0cxbqxr2v3rv4fdpbi46bsg58mv89l4")))
     (build-system rails-build-system)
     (arguments
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0parjl9nflk1n5b3fx0ni0cbqygp0k69pg4c5jkqgglvn9gvva2s")))
   (package
     (name "contacts-admin")
     (version "release_737")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xfvchs0hxhvxn46yj0ghclkav0jn0sbhy9p82alg253fhv2ach5")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yvsinkqrmq4dyyc8n51flyy604v1v3jfld2qsanx5zzda39h77f")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yv4gprvi7a2v4h99km0b635pksxj0d0vbpdd8a3pvyj2f5r7d8q")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ypww84123cphr2x5qgjrlw61higjk2dn5mji3gw7rqzffzn2hlw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02d23r2ws4q8247xy3118a3rakqrmk32ivwam83q756w7a78csxd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p1bnvzf5d9d00d1d8a4a09fjyjid06nfljblc04j0lwxdq6jxzg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p70qbpy4c0sr4xa57ba8psgvy8609rc8s535z63jwx2m6y2435g")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0726fbm3aan0mnqvyw14wb0zkqvgmxyapajnvwspr5iiszc96aai")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zd17z83yyyqbgrw836mzrs0z5min51vnwpmasqlykvwbm221za4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sqf4dxnh65xkncm7hzp2gma35z7ns25kviga48kql8hc1x4j4yb")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "19xl2nyr253gdzp7l1zs1kyi66sx67l9iw7w5df0bv9xqdm4azbq")))
   (package
     (name "frontend")
     (version "release_3594")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0653jala632d7y6pa4bn430f040lp7755slwz7kl8z58qdzij1mh")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bqy3lw03h5sqilnzvb2vvdinw3y4cmyqyldc86f50nhlj2xp307")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p6jwbfv1mzp2h7b324l2yh9bc4fwvz7m08bkf7zqasjdbvd0z9s")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hnd4m4cm1i7pkw6lm70cdh8v09i0ci9z8rcv6z701j4hgvg7ymk")))
   (package
     (name "info-frontend")
     (version "release_534")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ixjpx093lh7qa4jnxi2pdjwrx4mj2fbrm8s7834d3nx8axgpzv9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gndnvbbi6lnwyavap803vhph1v44ym8kg1mcig893kjvs1ps4ly")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r27pvjgyk6cz478a5ixw3rjcaghvxpi2hzbbxpg1vl6dbaln118")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hf7ijvm0x5my985a2jm3r5j63y975iycmhmj4aw1b20z9c0l3za")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j1hkjrzjb16wmz131hia1bpbyl4g82zs2zlbzjlnmhddl2x6aw8")))
   (package
     (name "maslow")
     (version "release_553")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qsav6d5xdmkagk5gy21cib45wj6cvkihrla2zg8q2m5g7yphfl2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0py4g7ah0v1ri28inhdpczc7xmcggmi7k1yrmn45c3s5g2bk4cyc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4816")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pqr07931hq17cxh7iv3ws5v7621hyl27pcd9biya0qnx0r8awxk")))
     (build-system rails-build-system)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1my4fvpl19ip8l393dcrdqgslldn7d38x39wd6hkbxci8g8rn8g9"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05w1sccn3g3n6wbswwzy2888gjg3mcryhqc6kg1q9dwjzp58jm8l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v6jxjij0gbd7isjpjaz3zi1ydqy0y7ja2h0nx7i7ijylzdqngmg")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a38prf52sdh91fvz56zl3divihj0cy3wqswcarw0gqxb6f4siyd")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cjwrn14r1sdld9l5j0rjg313zk8yvmvylg95g7s4m1y1651686w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02jgy7dcj3270xc8kjc77m53wq8kn0h2k45j11hz8ysa9vnmg7ir")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "174xc21v5f00p5gbl9arv4v6f3dbcnc8zbmd7f0am73ybcdjpkss")))
   (package
     (name "whitehall")
     (version "release_14824")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1din5rg1c5dv1pl7ri7fna62nykjl1wrb0h0fya9ypqljm2rjcga")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
