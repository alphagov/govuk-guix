   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b072yhxb8pxinv42iqm58dmlfp5rdh5gbxfym80vrc9185ckxq1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a6bli6cay80lv1ggjq4cq1xhnb4qkyq357bdn97fy1dziara833")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14183")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0by917y4bwwnv0kq4gd6cqng3mgcrhw5rhik2nvdjjzkl4fn7mac")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
