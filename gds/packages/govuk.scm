   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c66cmsgzqyzvrsi7k28qiqyi60x4qla4p7wab0j8advchdi6yyb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xn2r66rlc3bhr889w81bbh6fhzmhvf94sgbp971bkxspygy1d75")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "02ry63lin63nbfja23h2d3cl9067z89s6sxqwjphsb35iy8vfn98")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y4qvpjvgb9h3cz8hakajz9v57wdcc8nkvbmjywwg55hnqvm0j31")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pjbkxk1xmmm721qzglsk5adyrjjg9ajrsvk4dq9accsn90g8fcc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "000gyjr32whfz73wd29bmrq2ch1iqcwb74167ym0rvp2gsi4x885")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "04jlq36svfbkfyqf07ffvrbsr5y9giw3fq6cn04s0y87zqadgf1v")))
   (package
     (name "frontend")
     (version "release_2865")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04ii7vbhl9ar8i31s1frw74khix9bkqg4542c1z39w7ifbh7gmm3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "19zjnk6pgavhpx4ln3zcy6q1y31lyhxbfqcsv9anp2r1szasf7dg")))
   (package
     (name "search-admin")
     (version "release_157")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j13g4j8qdxi0j8h3bmbzv4lp9ddfsydwbk952z2i4h9lqrb55jw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g3ndcc100smfpaz7j20yg00if3jw3qi9hd5wp8a6r9773b8qqpd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
