   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i1ykwwzzwm9xsryl4kq1wa5h21lpzpjvdkffa5a1ixqmnj3d4nl")))
     (build-system rails-build-system)
     (arguments
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "07gj49pfgczvszmh41q1klagxgbn8j6y84gvfi15rmzkkyzfawfi")))
   (package
     (name "release")
     (version "release_408")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b2pbl5qvkr243lmgfxdx43s27zw8n8ixp4xy8gyznj57rg5mv5q")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
