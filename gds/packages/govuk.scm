...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n0frnbfgknr9ygki5impacdzg92ksy9x8rjzfddizaqhkzxc2nb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14ab162iqyvrshk4kz1xi9dmsmq0jc2b8r1jqvb7q3c7d1m7d98h")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h308fkkimcljsif8lyqni4cs6ndy6843pzznpzg84h18q2zmf9v")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q8fspvfncch8d2wiswjmwnmjssy4wwb1fbynyha5k319dic7lri")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "094sc8bqmv0clxdya8qavfglbm9bdnwkj3byklh3nspsmwccs5sf")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1y43627p9c8xyqy7nsvbdfagk2g2cll5yx335a4rrr273pmdpilm")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "18q6h39wzm126pd71py80hywirxb8kxzfmcrjbpz4rbqqbcb7l0j")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00384xbvwyxmawfw66sxf2dqhmn8hm7ipbd73knxbgynlgarviz9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zx3wrjqwv2r9d9ajzbkvgpcs9s81523gj4a5dk4bnilwx0w4qx8"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pr328jxwbamii5msj4jma9rrvwsy2jqys7r5jfc8mnb1kagx45d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kfr16syjpqarkpjqhlx4hf85hjiw2zhj3dxr64lw5j3g2hjzxdd")))
   (package
     (name "whitehall")
     (version "release_14755")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v0s429ayn2497mga5sfmkhzvm5iyxx6mx7m3dg36hg15lbr7lla")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
