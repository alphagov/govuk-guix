...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qf9s22r87gppl4b7f5h08v9fqh89jab1ihpjm5cmcaf3dvknhzs")))
   (package
     (name "calendars")
     (version "release_617")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15cmfjh82k9my5mjk7v4l0xzbfx30p86xn0pghf45p06pyz59qc0")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wa3d8gywz1pz1ksbh58c1f1i0hi51dffdfrz6wzbplf63n5nmnm")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k3v8s2gib2lswia76l8mc49y9jxn32jk70fjjmj5a3qc2mn5cbi")))
   (package
     (name "info-frontend")
     (version "release_252")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0za4m6gw013pf91k3wxmdadvnill7z8l7mpgz75g22zzwvf36y6n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "06rhwsp93bf2dkbbfdlrpf6x7kf5bx5pciv3pfsdssbf5frasjdn")))
   (package
     (name "smart-answers")
     (version "release_4131")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08chakxns1mp3wsxbnk8swk6lscpnm51kdlxvlm3x6m1bhryjxfs")))
     (build-system rails-build-system)
