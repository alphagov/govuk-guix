...
(define-public bouncer
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wfm4dxp8pa71cx1z53pbs4zv0qr1njvka8xh1jn680zwx84nb34")))
   (package
     (name "bouncer")
     (version "release_241")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03c1vr25df6pvashyl893braksd52z3fbmd7xxq8x4rbrdk2x0xc")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f))
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "16psp8a27gcjsnaw45hy56n9vdwdkwdwclg5zlkk4ksm02wxr0h0")))
   (package
     (name "collections")
     (version "release_800")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bahz8sxn3fnkgvzf42b19y00zlhq8dm73djsjlzi9sznngf35z0")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "03hjbmf5xa6rzgmf5ygyrj3vdrm1n7kis224d6pgx25a1gd3k3hg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0naq0sx94lmdwvy6b5vha5p92c176wzpa1m1wkz9dkn81lsfqwwz")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zjgm26171zv6d0r74mq9xkvg2zrnv6ymkphhzinsm7zqgbxwi2v")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0akgcgh97ph20pp0w8wkdy524yv8kwrj1jan906zny91s4rrd7q7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f94f57s6q448d4n6f7ksjv72jxvr8jj84s2h3f9hl87bcw48n00")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yh6gb4iylcnx2kgm1x5s1fas70fynkh7h0n7am7i3na3hphb1dm")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f))
     (synopsis "")
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sq859ixwqx38arfw7csq69rkcxmzqzlybxhmh10464x3v2pmwn2")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "14z6h6nggr6n6fhsqxprgqy7masgiwdxmd1nivarjf0b1kmw1fll")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l5q0a3xcbf24a6788wkfdzc5jvjaz29b8jfjs2rj474mwjkl24z"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d31jw4ayq6zb669mfw87vc6xm3mmn1yazhwml7s4hcjcw9lwrpi")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1y1pxyq8y2q3m2svf4lw52lq4205i8k2jjn7126hsxmsrbdgyblx")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kg0bvf9l7sjgjvz6y62kp59gzrwqiy5pblbrq248cygmwiml4wn")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13914")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0irhb0x2q3xx4gxrfkkspccmh19ka2zhqhcv9gxwb08i1jlizbd2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
