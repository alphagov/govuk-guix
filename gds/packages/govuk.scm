   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15xzw0rjsynqs2q8863lzpbs25rjkhw6g74n2hqp4np3h591n1jj")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ry2ma8k83c5i53immmb590x5cdc5wyj515f4zxsn0mgzkya3nnq")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jkc0xx6cf2d1yvqqws82254ah36p4z0wh4mn713cpa3x1gwv3zh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bjzwmicq6r7c0jr0gx433g6abqi1sy7a0vkzq7p86qwzcpxnz61")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18nsxcyq50wnlmb767lzyss181h11fldvh8ajbbha7sz60pmqmxr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bsc03y2q9qs67mnvbhv6sznrbj9fsak2hqjawj3wdpjbsjq96cw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w5s41m65lgwwbk3mkz31288gijc5y19a8s1l6zj4ds247d1i262")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13407")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y8f4gbz00z8yyj3zwk0bdfzizpb02c7m5ladxsv4mjqngj2mgly")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
