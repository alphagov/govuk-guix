   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p9xwrpbmzjmmxdkszb391hd6baw1zsk1wf2npzd3asiyl9svs3l")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bg1qdn04zh265r20adb85qpcfq8fv2pjfx3wxvbz9wbagkc1mwg")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1f9y3017iydvy2z733l8ghdrgpyrynb5smdfwcjyynfv51nq7l7v")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13047")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kkxscz8xmqwzvask22ssr93px07jcjvdskzac00idgqz7dlgqng")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
