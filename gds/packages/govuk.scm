...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wi3bx4hsfwjb0w778i4cq2wqf21x6h5x28fivmh04qj47myigbd")))
   (package
     (name "content-tagger")
     (version "release_613")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qbxj386kiimry71jjjn46fci518xnlv5185dnidjn67bq564rcr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0q6qjbnsy1vqj7ja8npc42zxm6n11rxy5dssjahhp5gdhps9k89w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xn9dcdn41vrmrxbi22bmsrf475nc8waaq2p7i2wg1gh8r7rlg2a")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h82rypxsvg2gkxvbsnnn9f3bm76551cc59smxk072s02bx21gbm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "05dcwd9xrxw89fsdy6ba5yxc7rdfda85yd4r7jnr48vbwfljn4vs")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1900jgzcg8ih2virfbdbi7fhb7g80rs8vg4j3zpbq9svg39fjl5f")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
