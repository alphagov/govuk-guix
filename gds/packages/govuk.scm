   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hlrmx9fifyszmji5pdpx2ziq4l6m27fivv06ghr14mf2cxr8wgk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_5018")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "193lnnwvh0cal15w4ndb3syx70lgy8hk35b3a9az8bpy4wk2vgdi")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "12j3c6js9sfdz3m7f8fnc7w81iwsd88nyjkr3i327g3924xdkbcn")))
   (package
     (name "whitehall")
     (version "release_14908")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p9sk4acdcpnqkw87cd7an2a3p3ifwhd3q7x8hfphclxm5riyddy")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
