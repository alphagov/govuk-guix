...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1780ir0ws3w99kn1693202byn4826763iv6wmyyd01xb7qcdi23j")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x7ql15pq57kdwi32a5c0ls5l8hm68zrf0f0mgnpddrbarjykzxz")))
     (build-system rails-build-system)
     (arguments
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4464")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01shs0hvxwdwibi5pzy02m8s8fc5z0hf1nyz9b4q0b0m7k2g0b7q")))
     (build-system rails-build-system)
