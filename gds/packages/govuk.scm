...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x5z6fn5bd0xfvpd7wjhm5zklsyz2k2imanb9yc1p5rf4gya0aps")))
   (package
     (name "calendars")
     (version "release_649")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "168y931lrm7psi6qdq0d88hsqxbbbqipcv6qkxsfcg497cz43yi0")))
     (build-system rails-build-system)
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0y890vsyypcy97impn0mwb053axjcwsagr5v5rhynxijn95zmrpf")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0aam4xbr9is0ydrl7ijs9s5vvznz1x81hh24ca14dx8792a5jpvx")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
