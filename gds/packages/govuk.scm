   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06kas7fbac9ai79yfhxz9gisk4psrp2syrqls2yqjqrlak90xnfg")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zq4rxrfznxbmp50n54cc49p0ssrjnsmaqwync12zsmmwp1vaxnw")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1678836yx08vvpkvsfrvnyf4cj3338mygdfgzwwni1jwwfhmam9p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14860")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z49xzfbk45ic0mppzgxb6m3hcqdgvh67spq49xh9g59im9b3hrq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
