...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3941")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06l18iwcndvr8158ml22sbkk4pgmhp6b1nh073qklxf401m3a09a")))
     (build-system rails-build-system)
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "11brf1b0c89nvqfypwl00cfi2v1gmdw1wx045p4f70sx3mnj4lvb")))
   (package
     (name "support")
     (version "release_672")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "070ml925dlfmx0s6r6l6bfy6vxxl9bb8ckanaldbqjvw7fch8k86")))
     (build-system rails-build-system)
     (arguments
