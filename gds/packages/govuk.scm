...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cyb3gbdz8hjw59fcrd96sy8g500sfakbgwkf0fkvijk6i9xk79j")))
   (package
     (name "collections")
     (version "release_892")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0793x5ximdksyrjjjbxfcnj90z9d25z9lyaj9nk7zm4bsrzywd13")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ncw574cxqn2ar16q49sdpnw14kz1m8fcqg7g07dk4s93lyirr5g")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1b1lgaqz84fhwzpnabzqyibsw7ark8rfc0v1zz0m1wbg1xqn7prh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wwrmvlg482i9xi602b695jfgkpykl2ywd0gnzj4znh16afjlx5x")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14065")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19jlnhv15v1x2p45w6hab70fi9lgbv6kl406824csp8pbywkyzgw")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
