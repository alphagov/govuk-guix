...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "153dh4hmvxdh5sa4micczhkjpc7hgqmag27v7pra3li1ipgsc5w3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iy2b70bxnc7i7jph8mdplp9c9mq74vvfzdb51qn1fcajgws6kwp")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "14xfwqbk69ij53i7pzgy3y83i8g6di1kh0xxjwhmfa561h4acwza")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17mgshz4cr4dby3disxqsr4i1lrylwsbvkvayy1dmq1ryz8y9vbp")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lwjs4mb4jvvyyg0ybgnis5mmmnsf155v7varvxd86kcxzhhpd83")))
   (package
     (name "imminence")
     (version "release_656")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00n655aiimvjnq5b81h2c12f8ibfcx1wkvdrsv6mgmfci4ly03wr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "00fm7mqw26l6dp0wmmvfqcl59mz2hv813zi3nz1ipjyqgfysnmhz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mndwdc4xyh97cyd0fwjs0sryxa2lwg9q4mw7y492qjsb2mrfbw1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4907")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06ia3k22izqwlqn50gvpf3wjn1fvjkz2p0524c71wdkr468wamkk")))
     (build-system rails-build-system)
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zrfm0drx6yzw5f8m9pcmvbp9yn5as786db8ail90291v6fc5zgv")))
   (package
     (name "transition")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ipx6rj40334pbgq8dnyql8gdgjlk99rm7g1fd3y1kvpd1c6773w")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
