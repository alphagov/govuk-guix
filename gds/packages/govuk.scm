...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hp7dpj23v09bkf40lnxv75q61c73kvy2qadkph41hp7dzw2i38m")))
   (package
     (name "contacts-admin")
     (version "release_604")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11bxn4dvaa3238jppz7hldg92s1yyhsyfhni0ka4q6gh008gj7qm")))
     (build-system rails-build-system)
     (inputs
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2123")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a0d2rqic3idpg0j11k30alr7pnwprwd7hjimmrnjckdf0zaggfj")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14186")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z8d8m4ky9anm7jv6dq7zbkwymbs05ibp1gi4y3lz7h1b715bbns")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
