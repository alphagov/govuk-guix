   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w1j4yz7rq5lkr0rm2mjgp2c6f7x63cimjglvnpii9zcjhynkvkq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wdhi9l5la77y41ffyby2afb0rx2qx92d8zibyhirc587zsks884")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2652")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1993zf7mc3q6fyw2gm4zdj77lmmqvcw1bqj362dhh9xpqz6d93yf")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
