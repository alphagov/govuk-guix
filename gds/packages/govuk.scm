   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h2jxc3xfi5vxb7zdbvj5cirdsrhlyvgn5fs6b0slzrdx5hws3g6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lgasrnm3ipnd178v9z9d3ymk9fgqqa6xgxd82zp7550s05mjnq5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jaygrqyazq6d1yknhzz0k13h8shb4dgfs31w0m333wls97amc09")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ky6km4lf7disrapgl8h7b55blh48vn439fbngc2lns79jh2zzv0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
