...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hxvgnxcv79pvwzssi4r2zmdw4sf2sgj97frini005yz86j2b369")))
   (package
     (name "contacts-admin")
     (version "release_389")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v2cr7jq357fz7n7sa9565h6kb2rnk4mnwvzb4ni61pvzgvn1039")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09kky5vxjl3727r3saf562hrvrm9q84bwc8iyjyvraj2q2w4y3g3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "014dxxcfw2v3472pfcvlp32vqql67kqwanfjlfv2dwvmijj8j2kn")))
   (package
     (name "imminence")
     (version "release_334")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07xs0p97zclz8dycnz5d4xvq59vmrhkc78hn5p2kw7iq720jcy4c")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1c4k3ligvk5f91z4hfigf7510mailkniw3ljcycygm0rwwx4vrg2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d0sgp59mcgja8ck52s71nsi1xqp3r5dhd0a9pcpldh7j5rcmb44")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1bg0n36k9566g7lryp373hcxhfrjzj8dkf7dyxm3nxl19sm5x8ng")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1378f5wj0hz6syiaphx77z01gsiqgcsj4k1if8970zgylp69dn9w")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k2xpnmi47lfdaws8fi5s222jq67f731i4dk1v3dqis1p5sxsb2z")))
   (package
     (name "search-admin")
     (version "release_132")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r3f3dwm6wp81wpkfldd3vvldgl0wxdv2yh2537ivqnqj7xq9wvr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bmrjvhf9cq9f82hwyb2401jz0hxa29amxgvmdgfyifpgqim3yzx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sprw73k0rpv570mmcdq1a89jlqds45rjdjhzmjg03zr20pmym5d")))
   (package
     (name "whitehall")
     (version "release_13226")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ri7n2mrs5x2hcznh3d26vd1i0byy78dh7q4lcppygpcvwy4lncq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
