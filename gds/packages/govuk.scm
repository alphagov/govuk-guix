...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3616")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cy3gmxq7n53rlvp5jclhdlplv1nzns7wn58y90gw920m1y44lq7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p5a71slfk463kiqql5mbyzdz41bkyy5ziia41ghzb3wq8c5ip0k")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4904")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w595qrdnqsxqdhipwxa2pc25cnprjfaww6b0grgymx809p32c10")))
     (build-system rails-build-system)
