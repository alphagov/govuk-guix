   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01iyi3pmg7vl1h194l5dr69jrxqgl7avysmmbfb64d3sn5hjzzy3")))
     (build-system rails-build-system)
     (arguments
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nkay0w0cpg42bg5775fa7knmqandgwiiv5vi38shl0x3lkg5qch")))
   (package
     (name "search-api")
     (version "release_2412")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04jqxg1z2p014krgpcadazi068l4sik56jmbk7d9q4c81gy9gw6h")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19br3rs5c9ak54x25fnyc8pmz0z213d2vn3flxsi42q9ppps9z8l")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14498")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jfgf001idqw97iz5p88ir3c7wrsy9r9z6nf81750mjg67yd43lq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
