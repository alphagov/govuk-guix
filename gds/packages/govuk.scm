...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2694")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l3j821zfqr43l791dszlysgvdlxhscsr809hh6fkdxvpgfdaayj")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13050")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "005j466l0lk8y23yidixdx3h10iid38d5v8nlmjnspfwxrcwd4km")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
