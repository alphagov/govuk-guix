...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f20n0lj1hw516sccpbhfxzjxj0ihbm383p8la8iycqp3l0xbwjx")))
   (package
     (name "collections")
     (version "release_855")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nfl5g61f3h4chjxkr3h3v49dks922g35zzvw4faqb5hsccq2sd0")))
     (build-system rails-build-system)
     (arguments
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0b6wvhs3gw4s2594jz6dv1f122f6z2mvkx0sp3cwv11qdc386fyw")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rkqx3kmgbh0i8v0lycqnr8yih8f37ckck6qzkzcqxvcriv2f71w")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
