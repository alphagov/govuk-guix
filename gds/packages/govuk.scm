...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "187ylfn3ibncnyi6g1lk1435ldp7a3m8ic5pxshf3r616fmjnd5j")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17hvjxaigfs5zgsf5nfqhc8ghahr3ndfg2bz84l7w46f8gj27nqc")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "19ig3ckd5a71dfws2pmcm9dy05l3xdkjmp6hh182apag5k0b0hny")))
   (package
     (name "signon")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zjjn7h54jdg3767jv0b6y12vlpys2mivfih3a1q5gnsp0q4l201")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "12q43h1vvda3qv4vj12m0ihhmwivfbhgw0grdrvh6745vvdqqhbb")))
   (package
     (name "whitehall")
     (version "release_14829")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fl9qk252gra6qdsjqw9c7hqmm1phw4yvvkcyqr34c16v7gfrpni")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
