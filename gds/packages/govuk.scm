   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v0grq7yy1nj1za7nczrd9hcc1ngkdfyvbqswmffg3yxkhr3nqxa")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "07xyxrnbjyfr5cp7idah4dlsaw3pxjqxahx0mbmv58wwa4vg7062")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00q52br950pm22hv510gyfgn9w9pidraz4wad8hllksmxipzg23p")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2684")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y1k1gic5qqk94p90mrjmggax2qip33434rvnq7sqf6426lr6q7s")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
