   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jpj8hvjz9famgdp4lk8ywhsvm2s7gmzi1vi809x0fdqf3dq37c5")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1650rznnq6bag7j97xzcyg84i35pvbp54fbikw9jlz9nr4pngndv")))
   (package
     (name "whitehall")
     (version "release_13928")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kil0rgmcsp3z05pa68rlrp4vkvg5zldanl2zym81bgwjlkicrj0")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
