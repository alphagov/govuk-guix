   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qn4qjfc4z262rr3rmyw43k24c91wa2qi4v6pchwyfsm35pqakm6")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10jc1h4gygl22k2q0arlczry93hx11sqf7xws0mc8xhv6a6slbqg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qvkni4sm3b3pclpkmv8rlw4pivm7q84s09dvqddyxqlm8b063ww")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15kbcxy9b5qhpg6dh4v4ybj31qmhd4h82x58bnzbfvjcwqnm6pbg")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c0v7n2yksqnvxkdd22ipb69vklpin90k7b4w5glhk5awkqxxy5j")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14428")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kb7c50gllhzv1spwjycljpjiagln8mhaabd98rg3s9sgw2lwbgv")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
