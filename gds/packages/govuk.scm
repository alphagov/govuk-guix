...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hb3dbnhh6igd8d2sq79lq4ai5rnm1q2viixk7lcy65sbc6xybwz")))
   (package
     (name "contacts-admin")
     (version "release_532")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "012lh1i8nvqjqzlchgvkn6p1lyib1z8026b34m96vr2sd8ncdxpk")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cynk26l1wnd57qyh6pzcjaxch4vq21b7d2qm2vfxrgk102v1hyc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bm782fpj7j9wd94zjyz0s9xjb9qvggfxy28whmvy87bk8mbixzl")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19bpshrd5znyrpaqyhlh8iz6xm016shgx78kvfhd4y5zlg3sqia7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p4whyczyc54m9n0msh2vk3knr9b4a6h820g551c5zl8pdkjlxbf")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08nyjs1c5jddh8x1jmw3b5n5cxp59brmmmi30cxqr79rf2c0aqql")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
