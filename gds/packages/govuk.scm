...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jxzsh0y7rgpbcnx4ncq4vj74306raldsishldrldhr0vph1z0n4")))
   (package
     (name "collections")
     (version "release_446")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "147npgs9iiw5bwjr08c6dj2h01qsrx27x0qzapf3x85g1zpb1mzl")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16vvip45hi9pw8ydbmssasrngykjdlpdap2lyqh1bjzlbgc8n2qn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q9wzk1pcmx3v62p7zkciam3hk6f04agyiil9sp93q40w941pxxn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fw8mv4dswv39y9c38bn4bn30b7vi0d0v29h6vmacqzbsyhd0qwd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "04nyism8f9rrziv2nh1z7i2y5r8x2dq4m289xi328qiq2ian0m4f")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p2pcvgf2bj4qs1hy7hi1cjmgq6c7lcgda7zpa8zvvb44cqqjxnq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kmbc9iay61vkrxj3ymmdar8liw94vayh5b7jiyx49dhp76fzkwp")))
   (package
     (name "smart-answers")
     (version "release_3860")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14932vyv7hb8f94qr2rw0d1w0jhb32zk7a8qmdwbp6zl46z1nyjk")))
     (build-system rails-build-system)
