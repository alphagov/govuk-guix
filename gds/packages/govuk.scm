   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1090qx1ggbd45pdqc8d9hxsyqy89vzczmzjicd01qyxnljc06377")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jcgfrdpgna53xw24pbaf8c7qgp3x6fhs3w3sl72ynvls8vb44i2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qm7nv3rijjwqayknsfp14265yhmin2cwrdc3daaz922psvk40yx")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hdbx4lg0q9mz3fl776fm9qzwqi3iwqwcwkwhlmcj2sw1i1q8dkn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fyzrv2y7kb1hgj6mnwczmjivahfh6gkyfachfmfcw4209iqxwyi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0674z48wdbziv8syfkfz0dd23svjg23r3zw2f8wyqrngzdry902c")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pr9775hb0z8gk99rl9iqkhbz4z7fhi4d5i6mx9cbcnv3sybmrjn")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08q9izlaph5jma8fnki1l1wmjj9ffcn4vixmag253cv73x3lndi3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zw3l3vza47lz3r5b5js0h6dzrqv8170hq3rps4pzdiiba1805gh")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05x5czwk6adl2x6f41inlm2bc1r4knl47mqf147nh0ihm9bbxliz")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13265")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a5ksyvrcdm3k80ax76vvlcjyzhm7av0jwbsrqc9l0wddzc1m2gl")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
