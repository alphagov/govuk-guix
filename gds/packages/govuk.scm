   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "185b047idfcd6d168bwiwx0dwxnsbkmqb70idqp4grs2mhjpbnwl")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yzs070z2v8bq2mgxdn28svhs6cj7sxbs7zipk909x6ba3dbcbxw")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_2323")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02ly0j6bjsly3s8bv5y5yvcj4w8p31dhkipbi4s5hf8p4k2b35n4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
