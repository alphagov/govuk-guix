...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1k1v07dp55zvsq5zwjj2nkqvisdcrc9k54vbi1pi4hvr5iw9np0x")))
   (package
     (name "contacts-admin")
     (version "release_599")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fspgwb3wb48443xnfqqb3f49gy704nbr5zirhw55ddd6ghqxba9")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c8mczbjakh29i5z2wg3h3x9imhq0vbzwjgjrqbydka0z1f6j02c")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2117")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i74s5di6vk187b5r8j4cs81xk6l61gn2a60m8caybjiwpk37bv5")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18d13mzdmala4phyvvplkcgvaikwdlpd0wkk6z2602l7vp63w7w5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
