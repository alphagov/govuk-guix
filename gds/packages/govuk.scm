   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c2cy8hqvfdc9k5yzv46wf81bfsnbrk2kf0f5w530g6qzp7lzyrc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ygvc12q6by6scrxd0rcj6bj7lwxz3bahypilvl3xsxz3j7i001d"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16n3mdqpxs8wwplnfiqxy5j1v4lh2qn640d7m77371hm6paxi9qi")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rdnpnhxwcld00ix7b787ssix70r6skffnlfdr0fyyspdrlzzn27"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gcjjml356p52af91kr1805cy88fdi5swxwj5hjbg8h45lmna4g1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13152")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11ds54llp70c3ngzjgi9g2i2zgs87na7ba08n97dknda0vvhpvm6")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
