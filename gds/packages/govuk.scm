...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "08hrqcb0iwq7s0g1qnirsq0ldkzsc4x7v8bpig9s4hinnpjaa4mh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w0yy8l51l4h4n0akyggz118sxp2rjfbf031y0llid5289py4hmm")))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13256")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kifv7xyd3z58kxl1zspg09pyg3gwsvy5y54saxm765b2m31hna9")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
