   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zam1a52gdbzxl230jxk1c9fv1a07wg7g0qwkkmlgiw8q8dpqg6s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "128rknrnpqyqiiwzsjxsi1arv913qkms2gm6dsy6y2a5wbl24chb")))
   (package
     (name "content-store")
     (version "release_804")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lljiv61fx6b985blr7hkmm1chisg8v01qhl5pihbspwixwd387j")))
     (build-system rails-build-system)
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "0b62wnjdzkb6s50vq2jdf8nf8iahc232px1np8qgix6aqdx25mli")))
   (package
     (name "imminence")
     (version "release_461")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cwqygl6aamvfg25njfmkaafk58i36gbn8r3f5snwqkwm5ay30sx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rrwk15ba19grpf98gdcc4czik3qadnxjwvvsx4pgig17r91v5h3")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wgmh79v3qjmvxdmr2x677blm0h5107afi9vppdxp903d7gbk9j6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "11vq0ibfkscfj1kyphrs2i0mm1ka1wmyrdlld67yqx2wska7c3vd")))
   (package
     (name "search-admin")
     (version "release_208")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z63m2qricb1mq7jyiqz6n22xqzwqbi7mkmz8kn2rqwan5v22fws")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "091z3sh5hgkh0awwm60cs603xc7v9rqhr8kgxmpssm8ls5bci4b4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05qp54c03nxkrj4kyayy24pixghh4gz3fvl2980y5faiflmp1ikr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "07sx7c62rb9pdiciqkj1s91kky9gfgjvwnhldi4p3yvf1b3i1866")))
   (package
     (name "support-api")
     (version "release_232")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04qjxr3dc8d2fm84f3i6pymhaccf4q9mzadzzfnlxrxkbaj7di0z")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v38h5jkybkm1bqbr30pvrpdi10p2d8p2dqhkdpspw8858j6v5b1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a3cs9dhql8klbyab8nzy1cxg8b54fdml4cw7j2wappmshc0jjg0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
