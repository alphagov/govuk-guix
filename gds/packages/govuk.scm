   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "11q0q2in5h8vqj4bflyhrzlb78ws9i4rxyir7az7nzsravdnp0sg")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p2xydwi6gxqsyzh78fcbc43k331kvmy1z3ca9faymjmz04cra7p")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3697")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a9rqz6sli4kb94r6vmpmfz8vkr7lcnr5ayi8wz3fxazf8ywvmnv")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12927")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04c3bn8qa3jq0z866hkn6r9mi8y52hby425k2v256g4m5zlwz3wj")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
