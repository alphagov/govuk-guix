...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mc7chwg9a51jlk752yv5pfmdd2rivfjh7qkx8q6n982ix5wd4lk")))
   (package
     (name "licence-finder")
     (version "release_312")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ds7w8ja8gv6b23dy44nqps44b6nb3a6zavb7gmjpn9r6vwbind0")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kp762yl1zd6rm6sx11blzpk9kijppmyg9wc4d31nq3n1a4jzypf")))
   (package
     (name "support")
     (version "release_619")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cdsqammyf8cjmhaaggyzlm519ib7ykfa367594yr549w0qihw22")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
