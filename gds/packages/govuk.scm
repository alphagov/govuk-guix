...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1d760pafgzv8ln3gx2fjsv1vigyhbx1dcci2k31hf2s67hha4gz2")))
   (package
     (name "asset-manager")
     (version "release_103")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lpcm5xsyz4zg9pbkrs88w5r17gkv2437yy95kds67kmricw74gd")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1da1gzxkq4r3dys8rlqzvxr60mwdvy5is92kwifkpy3v3x5m0k0l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qzr2j989hzq5abnw5dd7jh0jqj5jdiy190yk4m8wwnra6abz336")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v3vpd0v6g9md9134b5i5azw452nl4h9n2726mmzzn5pzcg6qv3j")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0araa43k6f1kh597ypbrq8g68lz82gibc0xllqk9prn9k13fjn19")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xv2fpvz0pkw43cg56nczl13anlh867k2q1sf6ba7wfdxr00xjzs")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mcbfdqya98b92z9vwi3178jk5hg43c71w95l0gkvi88bmqcz8m3")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1pcil189vc2xhiyfkwi9cjzqbibbkgd6l57rzfflqw80p1fkcyla")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "174kssv077v1b9zz0yhmczrd4slbkx79cmlbw879g1lackqfv0mp")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3682")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nqwds5si3a160iz6f3h0yma8p9by12bbfmvzh99vyaaz7q5fyn6")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2631")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g9i4bb0xr724ac7llfi3k4z08c5jvzhykampqq5ji5xa0nzwlns")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kflvvmyg9ck2iyy8kcmiwchhb26f8fx8j9vhjqlygnq7p78lscn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12892")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vdzv7brxlcs4arjq5xz5cwpbilq1m0ggfpj7cj556qgack0dfp5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
