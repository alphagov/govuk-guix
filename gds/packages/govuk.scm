   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y9c94miyxnfx6xj6phyc6raq6w3ddd9m7vs17bcindr01lj0afc")))
     (build-system rails-build-system)
     (arguments
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1plhyvy1184d83liiplgj9rv6pz852zsanw32c3dnibavhlzsw94")))
   (package
     (name "licence-finder")
     (version "release_734")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n6kb8asbgkbyg6slhjdz4sclm54nslfnmpy13c8q7mx98gybrbp")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4664")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1phvl026pqkzrlhsj21xjmnpfama4qqr0g8mbamlancl37qmsdxw")))
     (build-system rails-build-system)
