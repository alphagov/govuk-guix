...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bdpim0bkvqraqcp5r9ggs92c3jm7wd30qhbvc6969rpji35cshp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fmvijfghjyinsmw58sa9bs6mjsykgkz5z5bv2aiyzf849kp3sqn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j88zlk3ps4ziyhx6apc5a5cjjbzwfbfcchbw0cba3flchgc2g60")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1548r66pnaw9lpx0nli57gl16h2mgfa2cl2l9gdi98na7gah7k1r")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2706")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mwmc06ngs2i20rg8hl2zabnjaq4zrwjynkaz0nyljij1jcxyjmc")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13069")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gvw0lag9m2b1avx8sdn5pv4zhnc8cbdm1870qjbj16wl8zncxvv")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
