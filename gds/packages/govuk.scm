   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qf9i6d78wp6ml2v6vkqwwj8rk2alp9v5p3hv2j5xydkhll83zr3")))
     (build-system rails-build-system)
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cdasvfwhpvhr36qga8hi3ms4697a5lhbj4kpzz7hpsl56w0d76h")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "022qgf39pn6amza56p0jml25r6k9gvipkgaxnshrn8cmq29ykhhm")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g6z8as9s8cy9dsm88b2v6y0abdcrgnyg8nabdxs0m5fwqk9f8ng")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0z4rgq5vsg8yjwp16m863jl0p10d57gmac9a6h8nsdxcvfmnqzgp")))
   (package
     (name "whitehall")
     (version "release_13138")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "096rh8frcazw885rzc4l2srpd7pqcqplqanyihr9asck6v21fi0x")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
