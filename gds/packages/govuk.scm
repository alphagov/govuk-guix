...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mm52byd8y15jvz2w6gp4z9vjxvj4gk6syzh7wysxcqwkxywz8gn")))
   (package
     (name "asset-manager")
     (version "release_238")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ckfpjmwxayy4fk2ycjcwlmw8v7ba6jxbq8bs2z7ljx31wk5cpw5")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w5fp1z1aqcrsgzi7nx0kf4r0h1z48n9dhy7f8sg772652a8hqa2")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hqpi9862vyv3bq9wrwlfif7dya3irkkc4ig56rp3bivflclaqrd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g5vpx05zf792gprkx6ybf4dmr6r3ip16cdlbm1pia1r1gh8074a")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13hynva47q44hkqha2mifkz2m06pwc385ii8ybycmpjy2f1pzdhs")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1asw5h121xqagx94dxqiyqzaxxqmj41xfn7n2v5spc94ccd3n48j")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "020s73gqidz2lv0ij9sl1c7ajk9zykvqq5x7vw60car51yz90y2l")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14l8cxps6ghfm05c04fspm4ibdn7lfmpkqr4m58cxw5xw6gq4rxa")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1i79298ashmljgf9gm5q1vj37pn3ghmg6khq5a8glnnll2wr1cya")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "04b6i67p739ryyir9vrcamnld5w14kmaqvjb4fh4g6nhy587df44")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0b2cnsg153v8p70hq81jcqd4f4kinx0b2kh889g48kjv08wf5j8s")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f4xg0ldg2f5vf67myfji989iwi1i2ybpnmi8nngrcvvw1n3hcz8")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1andln4kl66bqkjrfr2rhhbx7b0sc3maw7p6znzxfs329as6v9sf")))
   (package
     (name "smart-answers")
     (version "release_3841")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15fyypddx9jjqmiq1cdvgjjym25bh0pp4q0b8gjr0v2snkia27sj")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "093sh2ha2pmmhdldvypdxj5fn4xf0vw9x3wqz7mzh9nxs07851nm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1aaaskrr9h4i066ymhvvr8nrzlh5ggx8a17csbicl5xbk9wd27v7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ac45f874fyrb0zhil4yyslxahi2banq8h6la2md5v5pzsr4y7jb")))
   (package
     (name "whitehall")
     (version "release_13246")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00k7rsygfidagpvfxrhybs198q2dqbdijc9f9qq3y505yic0bg9b")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
