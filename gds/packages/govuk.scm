   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bf8kzp2w8fij6bd4d8m64d0vyiqvifdd3znxvica9w23kqz8sqf")))
     (build-system rails-build-system)
     (arguments
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "072ph1vqvba4kjmwi6df27r0h7a1wwfdyyr19cghp8b8q549jrvy")))
   (package
     (name "frontend")
     (version "release_3523")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18z64h3sq44yzd8m9d1lk2y1zvnrvf0sipm28nnwwg9np9vkm9qp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
