...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "07xy3ikgyxa49j1s380l6r87m5kqpark3z5p10r3pg888m812wqm")))
   (package
     (name "calculators")
     (version "release_671")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13w832xsgd2cxv36ddwajzi0c8183gzsqvyhyyypavr8dn4ki2ma")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ypynw91aifhi70cv5n52l6prk01zwbk8f4dqn5bpz2pjqw7bbq1")))
   (package
     (name "calendars")
     (version "release_895")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xkfmzn33w81ihmns71bkk9g6b80xcw7kkbn7pgczfmq1pkd23aj")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jj00bqskql14bijyd7li9x2a9ra2s6mkixr7l8n0rj9m0knss2y")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1maxiwyba0awaw97qjfadkhpbd07kqqdq7s2rb112g6y6zhpps8l")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jcwawav2bli3kns74j23yh88f1wzsdqcysk8j644hvc01zqrkh6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09g3dwibng0qz3araf94llhrmqkbnfsmazwrsn49kqri21va5582")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "158vcjx4ys0hxfgh6qbzqikx2xjcrwwiksimazizp8plxvkzl7a7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nxgk15gngsjx3954dwy57586jn0dvaf8ws3dbxiqcvn60fki7j5")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gz2bg5mh487bwszbdahn01hv7idb4cxraalyhldnd7ssm1l0iwl")))
   (package
     (name "content-store")
     (version "release_994")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07mnigsa16lc83hwkcak1p485p7a8zhllq3fa0vdswis6jgzn44w")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cy864n1hgyz3mn6yf85fp9xj71b6xf2ij7df3q7id6w5l58ihas")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j5swqprkqgch0y44rcpr1mcky22ps5ydp4l86ih9qc1qcxxz81z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c19n39z8qyzaccnznvmbxjw3vp90h8mb77zvwmirj4rp9gfmicl")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vc22gqqq9diam5k66zr19r7qa4m36pq07szlkzqsqyaajmr456f")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a03ai8wgayk7xhvy6d08dci034dg400y693zyjra7pq4svvfydr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "10cv0bi7wrvdl63ibaiqyyxr2pp5sf8g5m2px9h6mgwn351y32i0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v8hy49kylrzsnivpk9qa947js53nif00h6aiy9wx6a9w7z6ba6j")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public link-checker-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m7k66yh9mnbh61pbahxfwgj2w9gaqp6c6qr60niw7f700chjn9j")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19nq9af1xp5nl7k4y7ph2zjq3i5jkbdgcyn1m69lqlgz6hwizgjz")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f))
     (synopsis "")
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "013lga8fkxpgcpdrjirmq49v41c07hn7j2bfywljabm0vmfp8hdj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07n24y2a093g5aqdwa6fpnnfiprj64h34cs2jnd1hg7n3zpa54xs")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nxagpg0v7mz9raljshcavqbsl6ba92qwckxkjfiwjdhrhqna2xk")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1hy44a6gia0qz1vmqqjmmbcf9dclqyly5xb4s6zhxknxsmvs1v9r")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jddkga66szkbigpx6d2a17zy88x1a837qcdb4zp7nlbcm43yrj4")))
   (package
     (name "search-admin")
     (version "release_360")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0143gx8drcl82wgc9c1b6b35b0qd2xcssy73crvkz5qzrcmhnrsp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "14r2pmc72y22pi9yix5fgaa03wq9jjfgwkc1szs2nn2gc6h6zbx5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00cc9rk0vcwnqglps4n8in4bnysgwy87b7xdj22lw0d2d9431a84")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xqa3zfj2qkg4hvq2g3lzqxnzki47w06wx457frya93qcqlq30l4")))
   (package
     (name "smart-answers")
     (version "release_4626")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08hiw51db9d09wv37bphqyjj6z78al8l3qqxqajnqfla6yqlnc4c")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "13scnxks49ckpv9n8w3pvyd49pfv75jrrmk7f297gbw3zs46vmb3")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17wianv1hl4h0w031dvr0a746bxy8kkqzwb3jnbwm9d2m016zwj4")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1axv5rhisfi536rkwryrya7p5gwgm5bd681801xkz1gj4wjk49ii")))
   (package
     (name "support")
     (version "release_967")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bsm7chc0sr6cljhljig2dipvznn3627mwc5p1ixfpvhyzm364ki")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14652")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xqwx6c8zvfvd2ajr42znldk90krg4gd254rmlc3qnq3a0gjlzsn")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
