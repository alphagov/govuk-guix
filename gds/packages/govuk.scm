...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q9bspm8rcacg337kr3pxf6q5laha4nszli1nxljfq4083fprhg9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lwvvvfl7k0bn9kqbkfv4qnsnzm1j39f4368hya3zwwm6a0jrip5")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k183mz6r2321zl5m3ksc0196wjcqiid9nbqy5lzkrlpnhvp3cmz")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2417")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16alw81rpfqs9jwda9x8634xfxgh2ln61w77smj4zkni8zfppg5v")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
