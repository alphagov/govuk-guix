...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "09cilv3jb7iqnxfglhsp95k1cl2ccc55hm9jrxi04vdap51fnckp")))
   (package
     (name "calculators")
     (version "release_295")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yizhy8k8sqbkv3vyrn2f0q7jwj8gfkh19n1nb5hmbiq3iqp83r9")))
     (build-system rails-build-system)
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1z4qph74m2mbmaplmvp9yq4jij3v2616z084fpvvflrhyrdvl66n")))
   (package
     (name "contacts-admin")
     (version "release_448")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hyjs2qi2jjrm2fbf8a30l6al7n5xswl824qzpnba4xq6lxylbm0")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10z92m4qq7j4pw2zycjw02b61849y432d1nq61pa9avqv494gl40")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
