...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "054hh0y93mpkp1zxnsnsdni32zdgyr0msnc48752m26ify53is2v")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fs6hvh617qasc3v5zp8n3v8msk4wbs2l94jd7wp1if3wq6lz1lh")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xzjany8qn1yjayn2ry9d23adahnlldf0apy0gmlszjqxx4393rf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15kbzd6dv2jr72mfv8226innkbxyczrryqf07i052bw3bdry9s5l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
