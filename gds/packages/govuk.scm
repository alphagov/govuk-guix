   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14if66am25kfz7p7l0g4f5182yy2gjs1xfccynfnmgmijh11p86s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1gk90rx96sx7iv2vz4q6d83i6bckjd63389p7m50plw4gbirfblc")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09198cxjqmnjk7mak568rrwfsb86g40x9ad6s0ljp8d91ysnpmwb")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bydw0bklb90dnag1vazx13fqcx5ghna68237znx8b8ga64vj7mk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0sfc3vn4w4mnnigc1qar2gfca0lkq6sfc6pc5pixqb0qzm697bg6")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bzrj5kyga7f2191i9y69x2x23aj1ih6yi3zqqywyp26hsrw2xn2")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qryvpdv021d7mi250p9cs0b8a536s7b0pcnx3kji8v3z2mz2x9h")))
     (build-system rails-build-system)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3659")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1anxv51pcg0g0jlhzywbabrsdmjxlzz7ivcxz6m98d92zwavdca5")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2610")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fxflfh16dgjagsyi8q3fk1kmf2cbrgfisw04wyr6ak0awnwb640")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12867")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k67fsajzc2vjlwvpa9ild7casphpy9v81pzy8rfm5dmr7ldljs2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
