   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r0blg8psmgs55g431kslqajl9qjn5s3myn3py5j4ac19rfff8zg")))
     (build-system rails-build-system)
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hlbd6yi3r82lh4lr1qk243958g30n9n5r40mdln0fjgagwhgyy2")))
   (package
     (name "content-tagger")
     (version "release_617")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15n6af36sk5z19k0x6i4xh5i4m937ymrbmzmxia6h1bnbajkvv7s")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2773")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f381534k1y1hqk5r1j43agmm4z1rkbmm9rmiszr5a87y188qwdp")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
