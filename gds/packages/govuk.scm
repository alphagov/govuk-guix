...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xv2g2d01r2fgpvxcv6zwk3snwq1fwvja7106fx5pkk15bv3jgqh")))
   (package
     (name "calculators")
     (version "release_676")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bcp1v26c828lc90ca1v67bgvy4nl1n0azcyar76vpy1jxw7i9ng")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q1v58rc17rgsj1krjrda08p9gcxf4522jsl79b7rljpviq414z9")))
   (package
     (name "content-publisher")
     (version "release_1737")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15vfmn7fm9jvp7n3b33p2r1fycmsy3ds7i9phmnhcvpzasi5xdxd")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0w6rriz8zi13w5zgrab64p6n5ppvqm7xdmc94vf7bm40jagzdqah")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08f9ldv6pppxqb7777ma8gbbixa3hgs2iq0jkz175q3ybkcs457n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "13bz6p9slscn7kam8aw4yksgyiaaxfhlpkqdfgglw83dy1plbywz")))
   (package
     (name "frontend")
     (version "release_3505")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19llsagyibargpx69sprdxzjpq8bdsk3jylh2n8sampz164r47dr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cygrizb5qgyr2varxrvs6dh04s02jh4h8kginfgh30calhad2vn")))
   (package
     (name "licence-finder")
     (version "release_725")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hj0nsz1gg2yfvyz9fn3djn1s5rk4ylzqk89h5xcf79n789gz23i")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hfcac51rmpvzksp3f0aprjcf7hpw06al06clq4hglcackv01n7x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1555x4h6ij6rardcd25rmlj44ha37hmq18c7jsw61gk8r4sc5dan")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lyn9c2dl57ba6gsaril8wk8a8hhkizkdcgqnc39z6f2kvn46zmx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "120r28s8dxlsrayn8msyj16yvzh3mdgi7s45yx7rvz7ns1yhbdx0")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hadm536dw8qxjddid44rpgdzqizpkrkppdw7p12nh3jnziii5xq")))
   (package
     (name "signon")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05jqapm7g0vcvx3smd27adbncnwjyj7nqxr1fv3q7z4h068pskwc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "14ma0whhis099mhg5nf12b6vk7y3yz70z0wij07pxnf30j21vxaa")))
   (package
     (name "smart-answers")
     (version "release_4644")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mdrss62yvpka74ri8kz2i1gwqqlqvbqpdqcnr98cizij1cmzhrj")))
     (build-system rails-build-system)
