   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05sv33nbqfcnn5dnzzr9675fl9ib6df0nljb2wmvj1a8dmzr14vy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fzzmld3phyy55pmwrjllcg106q9rmci78sm8qgymzavw7kz0g5s")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "042752ddi2n765f4rx6m46zvdnpd8dgv2cdsigk6dpnc0gdw81bb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bgd9fm20mjkagg6niplz6g5fs6x8cil1lhpdqam4hf582dbd8nx")))
   (package
     (name "imminence")
     (version "release_331")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pwn5y9sjg5bgkwyz0az960j6wskxpmm2i5fqwl1fqg03q0p9asq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "09zzm419wc9xxdhganzyi9m6wh7gnlhjrz51xr7n80p034s061ix")))
   (package
     (name "maslow")
     (version "release_229")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gw62c3f8dnm0yldfwigb7l9dzsig39bsx9d0a29h733lgjla75j")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_1894")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nrgh1d1jzpn2ih206mixl87z7jb5p6kdjy6j5bx9fxvmsm5c9z0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v9v8jzgz5mvzah4zq4grzazjkcm5avnjda3idfvrj05wa15vmni")))
     (build-system rails-build-system)
