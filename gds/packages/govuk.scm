   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i8yf265wx1r3n92shapfxh73rzxvg0vsddaqzpyn0knmadfizxr")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mm5cyjjndlyrhlsgs66smxpx6kq8phsx6gdbmd1lz7rw62pv1qp")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yj73rj2dfhhzzi0w06n56i96gmi1p68nwqyac77srwsi3rr05wj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1040647mll8g2g0lx81nbz26fpw2dkwwk04ja0lgbz64xxjgs2yl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "07j41qz9jrnd7j0bzaqcy1lzc0xqc65x7h0yrayf5x4iik1znajb")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14gxd4wdznmn9mhqprr8kyslmfjy861indvj5hv40fbhppxbpd8j")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wmhn3jv6wbndgp1c59ri57knvf5aj2715jl0wiscc4ydz1zmdic")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "09ihn4ar72cy2h7lvafyfrskva87mb783c49cxgh9cw8mx6j54ms")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1acjvr856xb0l8dfzhnwvjs09x8kh2g7067fbcrzvdv009s4rxrs")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qr1lz8jq4favfam0k75kqimhqj8ay6rxlxbyrcdfa0g46qm4fs2")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l1rsq52fc6yyd9ggr2aglm6194yqg981f9raqg69g4i31akcdr1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0krhgkmdb6y13kj6nkikijv3dirzd7qv9vp24rf7nvpqig2adx4n")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zbwxjmymm305h7zl5ar5qlvcy48fh585fy93jr8vd9z7mi08s1l")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qbchzkawmdi043igjj3fsb2qjvpacjm7i7lgichxdrrvylv389f")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l4ny6vasxgx04fg1larv7khvbgmhb52wq86xiqn1j83s9jiiw7n")))
   (package
     (name "whitehall")
     (version "release_12760")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pfs8m9by8rivvxgxxfc3k6ls9ja68c3irpn3qss0v3s3wnar9yb")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
