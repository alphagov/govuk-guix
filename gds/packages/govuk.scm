...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "02bbc5l2ml9rl8givlyzc91yhak24lapk3lha5fyflk2rv3bi13v")))
   (package
     (name "collections")
     (version "release_598")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dx5f0ryrkhij54b5ng163q8x705xh0jzchp9mvxpqz0s2dm5w7d")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nzxl0c7645asqsx1ma32bfiyiy906hn68w0xb22chm46abrnqdm")))
     (build-system rails-build-system)
