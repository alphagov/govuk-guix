   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xnhd4s47pj010i371nhf98wqzi9mbjb5vjjapcfc38fhiv085v6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00qds9mhqkl8slab1qp59blp6ln8jyqalxmn16qnq23c05ch1ic6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lx3m22cr9glp2wq48y4ccqdvlfajwnqygafpmd7p3ki5vlxck74")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12ws2pwn1dd05qdvj9p0knq739lrfy309w431152jg47mgjiiy34")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4097")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "100cqf58rpsb71w9ypmh9ysmr80716jsfgrm4r8f4y814yrq6m9h")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13715")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v4anhig5mqjj4q90qbd0gfs8db7r916w3bqlvlk52ahq99irs0k")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
