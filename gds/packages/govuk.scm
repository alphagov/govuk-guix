...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pgdccw1bjz7wsjqzh04dccx47zmliqdvvjv200305q0xdpmrq1r")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vw7na6lppm7ifz5lvasfiy6vcii8wmy5a4ia0b47h064nkai8xz")))
     (build-system rails-build-system)
     (native-inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zxk42ydi7yvfm614dwhanjv5ha6skmc91x5fvkdb2y29x32qw5h")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nvbi9y5rwzlqjkr5sjk2fspi7q7hw66y347wn1iv4h0bhh0skx4")))
   (package
     (name "whitehall")
     (version "release_14125")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a2p738bvszq1vb6h3jkv9xhw3sl55gz3q2b39ivbpy4dz66chms")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
