...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1iy3vdnr5md6gw4zb1icdvx1nz1gmd7nyxsm2q3bkkyrkcsg09g7")))
   (package
     (name "asset-manager")
     (version "release_148")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hzxg9fgvzmyjzynbz5cjff828nrls5mxr4ya1dbqzmkn0958vnm")))
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wzxr9zv7c31ryp8r597lny40x0gfxdr0yq3ak3s0cbz7smd1dzl")))
   (package
     (name "collections")
     (version "release_368")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rl4zqcb7fnad3bika8n3i67y2s8av3daxxrw7daxk3334n17rdn")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bvk666gsaqm0x44lphhqdvizn8g9fwkbq897dn5nn78c4p1rjwb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vxqfa3025n0gbi614sw82w6b8vmhajp4fajjm999yd526wn60ry")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h9grbprvi1fj1dw1wbri59778jvbncwv8d5hyh5d7jf14hahllc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "17nqigrhgdja3j15gl4iigjnw1w5n4k8mf2ym1247g3z575w09sp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d6qpr4gpb6ys4z61v6ldfjkq21l6n8hhmfcx6rbd76x5wmf41bm")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2732")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "144ijp2c15n6mlq5w2zf6971zsgp1aa7cfmvqn4ynrgx73bxpr19")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p9c09h1zvb8vbzqzfllxqs3960par0b07ldwyp8fkigpln3xkb0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0in6rgnwxg6avb4q37xmdgaczfzcv76cq6kqq8ki0pdr2gfah5zi")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "11nx0aiv5r8n86hi9cfhdxwfla225lisxi7hihh0acnzmylpff9v")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15rd98k8706xxm4za4gmcssw6xar329rnrq3f1kmnpwkv9bg6jpa")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mkdlb8ardvy5cvrm2g4j6l9217hdrfbvzpspjsj0587ii27pryj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3751")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04blc34wwrnaalrlwcxn3c7n6wjmgfgzc8nvm0prp3vf6jyd9xxk")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1v8wdcx9f31z8l28mw0lmksq9k6a7sjflp0gxn5qlhqrrpaadpy8")))
   (package
     (name "static")
     (version "release_2685")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sqxfiqx8lbis4cnax80mvqijy2bl85vcw2mzdijqa8jlaqs8pwl")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13012")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fj2kkwfw9za21qqp0dcpsvi6rv1xpjymad5b1bwxmcl11vgvvms")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
