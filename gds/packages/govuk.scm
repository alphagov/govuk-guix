...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2635")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05r5h2cnjxs14dygnphm5594rw8fd0a9bk9ms6glh55nhl8msdxi")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12899")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zzrfnr1h0hvgdnh3h0s2f3jm7mz3ln5zq31kg2y4fh41lyk7n3v")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
