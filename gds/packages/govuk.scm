...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dk8hk8qgps4vsx611jl0kzg6yvsq9rca03dagvf0z63m0b198qf")))
   (package
     (name "calculators")
     (version "release_716")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ijri91hivvsiw28jn8nzydzlfpbmrx9cn3c6kawhcpiaddikhgg")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "047ch31ij1zs7c5y28j9cmxs3fxa0fmcpnhmg9jcc10kc4hxxxgv")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lxvphwf49wlhgmgzxy2q4s9fx6bll0dg2r9lgbh9xh215vz30s4")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jp6ia308l8jbsywqv8274w012s8xxnaj6fd01yzcn4i69m413cp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cccjf9dxmg631wz274b5iwpms9s7vl8php6gb7rfw39x4n2a8am")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qjq2ysv0zmqxz2aljq3a4c2i7lvdd8mjha037gp36xj2phhfi0s")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06rm1lkk4774980k9g0fan9pyqllbky0n4hzfm4nkncdzfy590y9")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rrb0905131kjny0m9d2w0rfg1mva0dqr6jymacbv6rcmb52ppy7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0av7dliq6cikfjznvxkwpv7raz99g5hz2d2l6810z1snzkdqpdyd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vlyyxfzama9rgs00743n862lfb7rv59810mxfvjllmsdcajg6f9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06bg26idd6fwddckckmincjp0jg4b4g4sixrs96619d604d4194a")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x7vscwnxidrhikf83lq6ynv1rbi6sqjl75g4qpr6q2dmilac9ks")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dv84c1xsbdqzb9s5psxmj511prffh6dqws36jjkys6mq8r36891")))
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "03x6ny93sc1n48b324s21dg1r4s66lkcmxzz1i06vy03vh9a0by0")))
   (package
     (name "feedback")
     (version "release_860")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1igc9yk0is7jkh0l4x24xp1dq7yxq3xbq6v78w0b9fycbsw9ss62")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qx7ibyj97hacr9fcqpskl1w38x2ffb8yqjww0ckavkvy18b2zql")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1spmn0an5f5j6baxnavgnvqmqvi6938b6sjpcm6g4n580wqr554j")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dvx33c1x2a2krw6j8xq1k1q5ri11sxj42rja4alghzzjhwc7s8p")))
   (package
     (name "frontend")
     (version "release_3561")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "165mfv1si6qajsykc9vddwy7wfxx8p6x78g8c93q3fnq0mqlnjmc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "046qkcl9cxwrvllp6pjfncv2ikb1y9zyk6hym34csd06kpb416p3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10qhbq3na134kycq9gfffl1j1rxpbj3v7bk9lc5dcc1j09d8ajaa")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d3ngbijajzg06334bxpy1wsg2sjkbk4f1gzfx9plry3f4kjpnbv")))
   (package
     (name "info-frontend")
     (version "release_519")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00kijhl6x30h5z7x0zx56gwl8bb1smy2x97cghk3r1h8yr6r4n0b")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public link-checker-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "07q17pqi4q7w96hv88gqli7vh5l678nday7cck7pld1l0sazbxwl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04ip61camyvqk7c3m9bqgcxydvlr17m1kp8wnb34dcq9k223phfd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f))
     (synopsis "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wpr2lnh7m86386q1hhq9hk0cgr52j9fg27z5mnxwln6nsr078pz")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rz6p9pw8lvvlwrvi5h55yhz6020f80lhcgfcki77gskaklkxbbm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nlqpdvynjmqhbx1h70bmd7yg5gkp1yhimz9nxw9cqzmpsaxbdr5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hy9grs3646g3qz5n3i5y8zmzjmm3vv2giip0msxmcaz9zcdvrdl")))
   (package
     (name "release")
     (version "release_633")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gfdp754n20j5978m4811p26h91g6sn49kjlyj3krd0gfpfr5sfc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hqpklj1wrw97gy3wsbp4hcapwgjfzn7ssd5y4n3y0w8p1kyrdp2")))
   (package
     (name "search-admin")
     (version "release_395")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m5xz86kac2nxp172ra90ri7kyzqyc4nlfrw1p689jq92qphbszl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gvccswgx9apq5rh59x65jx80mxzzb0ars2whpya215s628hizyg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bcw5z1jphiq369z79g6m1nq742b2aizs4vkyxd4j6mh5b67bb98")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gmp5hkc57bzh3fq1di6b4pzqv061mm0n8qd6bcpx3fklqiymf85")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i0xgnvbnlzh6vljhjlw4nv87a8nvmpkv86afhjpknw68m9yp5mj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1aq3xd7mk6vm3w99wfxlhr62pf091ihdwf7k88vmk6aid9gcmsf3")))
   (package
     (name "signon")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0czghgrmxh00snvsi41cy531xp3z9a14ds3al9zw8f5limz60arl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cn4dpqzwk65lbs5hbcbfyfgj0n78pfgpjdnji0d6jihl2g0iigf")))
   (package
     (name "smart-answers")
     (version "release_4768")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ipjla5gsibipq3sy5apcs0x0w7fslwlfmm777nqz62l2501dlmf")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1id900619hq8wgwdi0xnfkqk6b64bq0c3ag8xj0k628j1dcvaddz")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pxj3jkh86xqqzgi06b41ic0iri0m9yz5y1n0lhmlr5wxz2318k2")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "133z6nka80izgnjvbw04xk6bxsq1q1ics6xaf74i1rhma5y15i7f")))
   (package
     (name "transition")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wkkxj4ks17l0kfr356agxvwwdfrz4g6gzqamdn693v6g3f0y9yq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0abbgicsvn7ynj7f3i51z0q06qjpw1yjbpll8a7747wfs9nf7li9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ix9wsy973qwxp6mf071rwnp4530hc6x5zryrawihzng9bxpxflv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p7v7kzpxm42zilynnzby1xcr65l3l4pw2sm0hgf9rf4c2jp9sjy")))
   (package
     (name "whitehall")
     (version "release_14760")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ixapm29a8f3a32hw5f5541yj5ilfsa10dm2412nhh7wa8zf7v6s")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
