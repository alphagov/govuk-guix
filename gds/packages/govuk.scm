   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lgq9qp6yhqm5206ys4ah5asj9b4ams0ps24vg3ki50fkfawrq1l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1l8ga9mrc0zgcv3wfba6pnxg1r3sdjnswwy77irzxrxxxnn17sli")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12784")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v1za9hywrinpklqlcqi8zighm4s8nan66fwzx164scidxk9md34")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
