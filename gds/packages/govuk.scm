   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kv6sq3sz6j695jkbdwcj98dv753g6dyi991b12jc5iln4m9k1q1")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d36175rv3l4rjrb6kn57x8ahhgz6jgvli0v3q45d5v0r3ki5w24")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b3sfrmfsypb6fznk6nkmw3d00gkvi2qncrbf4f1wp76kfnnmf2w")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ly7p8ipd9v5dq847rbhkihbvp01dx7nkv0nswqlbndhz51nsmfd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "17yiqfs14nancxr51pk5c30bx65sl3dnc7jqph0rpsmffc23ybh4")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2693")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j9as4kbm07g00csh6yyx3jcrwh8lmxsqzgvaqqs313kv35fkja3")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13037")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vc49i5ic8y4s8q02mlq2k162sg9wavqlqf4gxfqz9lznwn9p00n")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
