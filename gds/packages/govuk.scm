   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jp81b329c7q3wpiw69jxdkrx0yhccdr37h03g4wzcwhck767jk8")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "1i251sm2jq8vvdan025580dki5xq0s7z3vgc6019p4danm75l0h5")))
   (package
     (name "maslow")
     (version "release_269")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xlgw7rpbp3qw2ilf9w1pdm5wl8dlnimvg9xdb1k5x2vljf7qgyp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1plba5nbx3skzvlq3i3g749spagq0x2pljryx320fipgd822w52b")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "069rzbs0smr2syv6q9ch5kgz9xa1cn8jvwxy4ml19cqa6lhxpfk9")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
