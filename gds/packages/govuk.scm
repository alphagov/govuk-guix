   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cf5n66drhvgrgsrw4x603blgwnd4l4gqqgxc6hj2blwc9i1fk5f")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "07955hj0kbacrzdb9lv744s5x1yblll63mmdrg5myhaln66ng0vx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04i9k04brpixaznkahvjvs872mhxcqwvr6phdm8y69q11mrm9glw")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l42qa57sh1mrcphqrvdks1a7ij4k523z3lycw205c9cxsi6dr9f")))
   (package
     (name "maslow")
     (version "release_544")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12b4v4da3frx66a8lr8hrdigj9an7ajjgj4aklapw7hz43jm318p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
