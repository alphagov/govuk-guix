...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l8grv6vhxkn5r9xvdfy108kzpp4vl777kham9gh7bhab7cr1i7l")))
   (package
     (name "calendars")
     (version "release_574")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wla4yap9k002v9vnzrgdmphb6zj0ysw274bccai7fzyi5jg4ssh")))
     (build-system rails-build-system)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pbzgf85h4jvv20kcnmr0bb6fz1c3jyrm6byjw5qmz4whnklcxiv")))
   (package
     (name "feedback")
     (version "release_494")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16jvks00cg3pbpymhqbmcnn8w2cga9mq41xmvpi5b0lf4x8c34z7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
