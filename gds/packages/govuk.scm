...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bn1f1y5b6amxmb12lqlzibjmjaiszg9w35w45rqvidsqj19ybdv")))
   (package
     (name "calendars")
     (version "release_493")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10l6haiaycryr77fpdwlczyaidgcprbj7v45ghd7h9fbvzbz9v6z")))
     (build-system rails-build-system)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3908")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09r2mwly4dfsjrawkd48lwhlz2vjas6zfzncaw51gcsll7bczig3")))
     (build-system rails-build-system)
