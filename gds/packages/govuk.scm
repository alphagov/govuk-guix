...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0590vvd6133jb7rgqv3p50f2g4ij2hdghi0s4bgam50zhhwzs8br")))
   (package
     (name "content-tagger")
     (version "release_416")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h4dm7mdsmc9hm7jgfv9c0ppszh0vn4l0vrr7npd1ysjiak3qcdl")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19jadq4nd2z13haxzfinpsv15vw57xglklxzxdz19bsw3v359ks0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q350zmwvkhfqvzbanr94b27s4bd1phmfvsn3anjcf352mk3q4g2")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "018v48vd9286k6lvxbmqva7dl02qd4mxn0c6h89cz8nwg2sq3587")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2598")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i7yi4pgzsc2861jis054bxck1gj1wg6nci5rwnd38ahqhz9js3f")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
