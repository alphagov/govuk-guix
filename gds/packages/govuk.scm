...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_1978")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j9614gnl0fj9z2s2brpkmmvrn6av8vr24lx8wc8pqvqb0viizcq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13501")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dg978529hcn7cynv6vg2gk6b5hvr64x22gkl9ckfd38zmrbw1il")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
