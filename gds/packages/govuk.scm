   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zhwkargh6g767vnjp9m2nbz2s6q5sffaqp4mqsfg9z7gl72vqrh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ymhqbq2z8b1ms0jranjhr6kkmwcxjm8i3da9nw3zamhzdjxlvhc")))
   (package
     (name "content-tagger")
     (version "release_625")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b986j2bya555jsf3b0pg5f356m2sm5783aks5qcv970l54ylgm4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p41qqqzkb1r4a4jsc1y83kaf12k4iin4rz8x3jd36wh0hghrh3d")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "054friz0d6kmd1pg9mwcg8svkkspzkxl7cml8cf6dv4brz26fjkm")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c5vzb307qvp1jzmra4zfq17gziqf8ii4m8r0y3vxrmkk038hymc")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
