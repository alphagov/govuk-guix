...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1i3d42k7766inaiqhcskcy9lpdyh3n90yd3r5lq6fdxmcyhs4jq6")))
   (package
     (name "collections")
     (version "release_773")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vsfliy5hbzn6ikcy7vrmrjrykfc4wcp36l0kbx144wyg0g4bb77")))
     (build-system rails-build-system)
     (arguments
...
(define-public rummager
  (package-with-bundler
   ...
   (package
     (name "rummager")
     (version "release_1867")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13wkg2dd0x27ikspppnc8q7wvbzfwijfv8v93yazbr3a6k5r3jsp")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
