...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "182f6hfln7d8bvsbzsh4yrw51djz320pr4d1g58n1n4pjbri4520")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nl98blfg0wr4fys2r14x5sbwdwn4wzg9rxbjkx9vqzivhfr24ka")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4838")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "085c4kdwxv5m99pkva3pzw31pqp9a6rgqw84x9k63m3svxihjy61")))
     (build-system rails-build-system)
