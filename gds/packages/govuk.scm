   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cgc7scvm8gn00skwvb16g0db9js9zps0p735jny34hmphm8mm8z")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nh9lg8abzmj0rcn2m7020jwdm6y4bkc264lhxyav8v404jmx2ir")))
   (package
     (name "whitehall")
     (version "release_14540")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11d7cvhigmh4lnsjglr39ia5nnpxkpb4brhc17si6h2ls5ph8j77")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
