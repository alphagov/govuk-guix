...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v4c14z9m50yaynr7xqksj99rynhwxc8wd8m0z5jyamici8a5cya")))
   (package
     (name "calculators")
     (version "release_562")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11b8g18yzhs06wsakapy49v9v8bdzjp7knmdsfsj3w95a1ba7703")))
     (build-system rails-build-system)
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mwwj0s9flkwg7bngf40fcf8vpab1ribfbs8ablz7980g2f070yq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cw80fpj35rzpa14vcx8x9c5nbz89xy5ylbyr11jl83xdc48mgkv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gb2bq8asja376iwyiddcw8gf0skhjlv30ds5xiga4j4aw1sliws")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dj6iz24qaqlj993y76zgp7ava1xdpbxj4ckq66kh5k1s9xzchym")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ahqw3w9j9wji5hb38dvyj79wak6fbpbil45hh5cph4c5qqv6wr4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0377is2h1nk4p6h9dglj5adbqbg7yblz1qb01ikd1plsd0kyyxq6")))
     (build-system rails-build-system)
     (arguments
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j4rkinfdfb9r8ddn452908135f4gqfzwnbrxifgqr3h81gcjb5k")))
   (package
     (name "feedback")
     (version "release_752")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z97462599616cvhrxw4r9hqs50sl0k4mrgjya6jm9n0hsfhjlm6")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cz6w4nkkal8lryzzs534fxj40iv3c1zapzrb7jq365fx08mk9in")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mpqnv2b6z8fq878hd52bhfx2x256sq90n9f1dwcsfz74jqd4d21")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0809fjniqs543m0n670gyxdfipgy2khf2q4n4ax99nfmszr4jv13")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y141yn7xwdkn92amqakn7gpfjw0cpbpy7pc5pyib5qnnpvalz66")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qb1qrjbxhcvjf6k51yq1ffpd14z2rsrrnqxsc1gj6jlak8pmjly")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w0m0bfhb5h9b8hqn89plkj6jy0zfd4jgzm7q9xqgkl1k3ar025g")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "083xwy2ly1py6w6xcd3k16ax4233cxd3bbhr5p4qpfwsqik92s2i")))
   (package
     (name "smart-answers")
     (version "release_4473")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zhnnpyrk58cpa3flr0d459zph5g9zyl6rd8vfv5asv3mfd1a05k")))
     (build-system rails-build-system)
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "14ppwdqqs7rqazc1rn3l5arqag9xzfwysvv43fldis2zg40y66fi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19v84sgbkj7mq3n5f8dijy8hl0b323xjcw3yhvnglhz1cbzggxj9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
