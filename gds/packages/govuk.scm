...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "16d25yp8ccyv1zblkdwfvvg7937mysyyklvwn7ma9ph3jpalwgz3")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18r50p145h376gmmv8jiywyknrls73sjnj6ng1r0gfi1n3m8hhhz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dh8qis2vdv12pjch2k8pxpc2xalxb3ivsnzdq95xx2dkq7r4fgk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1aac63nkxfcwxfq39cqhl6gca2xsbhfpxy6ki96pvqwv00x9zx96")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dyccxya2gidfv24jh917g6y30yw60csr0j6r09as8si6pyjq25d"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cviwl25r7mx9vx9w32lnpiq9wffvs0k7486vy2fdygm8kkz44if")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0756zhzfdz96hsxpw61lzny5x71vg3j8437fqhl4pf2clyzlsn52")))
   (package
     (name "whitehall")
     (version "release_13307")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kqxzx958nn26rgw9mbs1bhqb5gch4wp145k00wx0gvr67gz63rd")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
