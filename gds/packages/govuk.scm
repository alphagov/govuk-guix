...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "01bgffwjj8cr5cqn8628wycb9a39hkvlbzxg591bh5rvk7i7h4h0")))
   (package
     (name "calendars")
     (version "release_748")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cq281wni6xhakjjng74dyly3v0shj0igl7x0sg5cjm0krv1rm3w")))
     (build-system rails-build-system)
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "12byxpinfn51fsh8x0l58m9n4d865x8x6yjcpak4v0imd6xirmbx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1brs1x4gixajv0f49brkirqvjv9sqdg1jlclcp7lgswhm29y8a1p")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zzqgsg8137889mc0d8q9yryj1i1gxagryx5gmrmlppyn73hwd32")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19bsppq709bp107mrzcqmj5b9wzvvrpafklgrqpqz2i97fn357j0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bi4gy9gnb5a2i9nxyg83nf8farvjbdsbf5v5fqvqmzxzxhf4rmx")))
   (package
     (name "feedback")
     (version "release_689")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jkrcdjg128v08gnv35gbvhcdq4pdagvzbpkn2plbqw5l2v02lax")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ifr6x2153rdz2y4fqpirqr6xmdzrk28a88gsfnlmjda5zzr09ri")))
   (package
     (name "info-frontend")
     (version "release_369")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nanyk267lsm57kg5dvwx9d0pawwqrhl01si6g6h2zzak5wcpr5z")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ja44sv5gc7barj6w756izlasnlp3zfkrw5bspccj2006psm7if3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0aafcfj3rzr3zwsfj8xshxjmf83cv365z70k5ad9dmbdhhhiar8l")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gwz7dfkm4g5j3fq5zqrs7krh278h6yqb3wf1r7v5kgzy3h2qjxa")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "159q6251mv2568gsk2nbvpymbs3bwh5xa78ifv3x6a4wggpii4am")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
