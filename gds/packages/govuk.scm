...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0m360m3i8597w75wf8y1z2kip11pb223cnhpfizxprll633hb9c5")))
   (package
     (name "calendars")
     (version "release_923")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b87i4hfcycy70jvvwsvbv0acd47rb1hhw07mz4an4a2ik1wkbi9")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l66pl6f8kchd86dv87vin4jm63wsxy6p3fbygvazg1gg4xkz2nq")))
   (package
     (name "whitehall")
     (version "release_14719")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k68k67ps11w5hk09j8rlsf20bmaxhydixqd9q350gc3j37g8yfw")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
