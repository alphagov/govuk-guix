...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s5a5ky94qps5s9yy9jy3s051h8dc5g4zbvrhd0zc0fnvxkviil7")))
   (package
     (name "calculators")
     (version "release_301")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x2ah9fp2lyz136cs6wwjnp74sa6c543vi7yjpar2ywwqlkh3vpz")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mnd3d667gnai58dxdaz015vcaijcclkkgjqa1zdxgqm71h8zhmr")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13dkngsgl3hvjfx9f9wp54a00h2nn1pm477fp2hg0qk32vrvxzp9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f8bssb8nnj7d8ymgd5jl6jmgqfm37vdyla70hf7761gqrby94pj")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yyrbqm2h4vy5ji9klf9liqizlqpyz31ng5g8drhmd1444ypdz2q")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17hn242kcrhg5q5mc031cfrp1mrfr06amczhrqmg5ip6ak0ww0c9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "04akij8jf8y2gjiiyir478rxw8rlkjbzrn9lsz7h4j9krrydb1mi")))
   (package
     (name "feedback")
     (version "release_427")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14py994bwcj622xdssz6j8vxxlicqkirfwlhylpmddc6ibcc8lhw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cnr8bi94nd0syiwxnqz60x81hi2x8g9vqs0q0ck0zh789l9r7m1")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10bhv08r0hjgkjsn4hh4jvgw18nd7qsp3qnf2kymkx6a0drvwf23")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0c674jbynjwq6mx5nmsqycl3zhs2hcy4wxqnac2sgsmhz0kmz5wr")))
   (package
     (name "licence-finder")
     (version "release_388")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hx6dc85pmfxdr7sd22dps39250ssm6jz3b135r617xi63p6aj6s")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dl0hbda07zlgi17f4lzfxn65krv84qr625c0dmb7hjm4nbwqp34")))
   (package
     (name "smart-answers")
     (version "release_3965")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "065bswi03kr9mnym51k0mgyag9pq3gg34mh62c0y91hsw4m1p4jm")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2875")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10mjdxjgcxi3jp0ps8idamsgwkzafliwzamxpq4dv2i4ws8cr9xb")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jkdhby8860gn215k462ngn8bj1jqhwyikfx079k5c5sk75i2qr2")))
   (package
     (name "whitehall")
     (version "release_13474")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nark72s8n7wfh6yj3p3y0cqyzw1hjyjwxihm7qwvh3dxp8ihfna")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
