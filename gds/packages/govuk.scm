   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k1vgfn5drl5wmii5hvhm83zn7zi9fhq72aal4ixrzbrj5mm42fd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3955")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00fx6przyaqs8b4dkqwyp187zz3k34492j562lk8k3k4qz2hc5qs")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2867")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qjrami0n0ng1r6dnh96m757zwr19hs5gnzwfpkxnhcjzfay06w8")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
