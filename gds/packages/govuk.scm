   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xcv7lihxfr7cjjgcalpqps1ldif86hpfy61f37ig1apdqnv7v5i")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bsav64ypk2mv4bmnvhyvbm2laqlmz99zb5qg6rv2ak4avmjdlg0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bd4h96x3hw14pxxk7m79m3ck7758iqzv0qpccjgzw90gc3j6bd0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dlfgb02kzqs2kkv3jx8jy00m6i8ar93xx0dpnic7nkjy7z7mw5c")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j3j80cwdxsgzl609idb1vbly587x1v65nks38i7kdsl3zgzjc6y")))
   (package
     (name "feedback")
     (version "release_573")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qzp342myp1rb6hqz10ykifhijkfhkd0dp5x4dc8ql1ngzigp0ly")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dc56vq6477f7i03qjaz4m0jbcw21q4z4mxjh57lg86npy8wgynd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cdmzrxdfvsk8qhx0yy16z7src7j43dy775520bb9n3xqm4gkk8w")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0b336w66f3p2f4rjph9z99mxrvkn79jhkck53shq7mmg3cigbcra")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f69xh5ng74r53r5kcf0lgbmfgkfvc7h9qcybz76w1vqljf1j88r")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1npwyhfc0ra66v68y5a35vhm7p60c7m27kdxlj7j142n2wx5zzjz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1khw76v44qs94i5nwy715y60p56rmcaylk5nvhnmgxi5wyixl6wv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1k08vxz40hfi2xr4gpax3y3nf5i42f9fr0p41b6nf5ch6mwbgbpl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "099gr0y0j21ayzlmjzi941clwh5l9q1fwfkjfah6zk55x3mrhggh")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0b64pk3c1a5szvd2g5ch5b0x0f8jsln62n3yslgn9909wwl58za6")))
   (package
     (name "info-frontend")
     (version "release_275")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r06j8f017nzi5nykxvv6ni4m598shmj8mchr9lgk6rbdf0smdlr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bmr95smhigxxszrnqxqyjvd243c916p58v72d5da2csi0h99xcx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qy466pf2r9g4q1c50rbb8fzz69r0s0ry0by53nbfb2vhyssag6r")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sqx99sgs962w1v1ylk2kswc3m5d3ml4qw3mzncpl6g8899n03fa")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12lgdpl5ncl0rl4j2bncqwadc01c4r5dmgwhf1a8v60x7jm05jyj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0kjlh9sndymxr61d3v4ppw46cz3gq1bxiq4pv8bj2marrjfnm0gi")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mski8wkwy1c5xsxn2sa1lvbwkp7nf1mm6js030f047yqs3cld52")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s2y0w60v4c160rngq86cwjcmjibndaypm5r7i8yy2xyhimj7m4f")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lky3yqiw7v74mxmcfq5saaqc13amg6z4qx2main9nl797k5pq97")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1286xmgbcm33dc6cc1ihx5fdffq8y1w5qvry909f3jbp5a6mqz4p")))
   (package
     (name "smart-answers")
     (version "release_4172")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15688h79hsix3f2q0pbpp3qg74wgnfsb4y4wdnfqb0ywyf2icqs0")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s8nmdvh4lz7jz2vz52ngs0vrn22ibjshjrb6s9a3mhxp53m6b19")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bc9qjp94gpsjnx7686xh4gl7y22k1ar4xisvrhldnwy492i819a")))
   (package
     (name "support")
     (version "release_755")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iz4gkrz2ihch6kjbz4gj8g0v1n8sh019clpwafrvicxbvl2a9mi")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zndzzna1izvrkldj53h9xbalpkmgfid16aabk3flg80z6ix4fa1")))
   (package
     (name "support-api")
     (version "release_237")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qppb9dh4v3hypb30l0vv2p83r1l823rsz4lag0n559wixw94jcf")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
