...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2490")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gg14l88kc5rz6idpilcby849ngwscgcrd6a4mfqf4v6idh86q24")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4636")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13dp6p5mpwyx0qxmkm6dg6sylg576qra6lzacqn1l31gk7jkgz9k")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zb22apzrxjgnfa0kx9p0pc3dvsdlzg6620ph8z5c5152wysdixz")))
   (package
     (name "whitehall")
     (version "release_14659")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ycci09mh8i4ksymzmiqznfbp7xk38b5nrp98715p06hpi35b4w0")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
