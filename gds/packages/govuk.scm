   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zxpa55lmk3n3vlqp7s31qjr0kz53kwycngdxjyp9nb53xhqs1va")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jlljisnzmcz68g6jv3d032lh2249lsshnx71yrspaz6nx1indv8")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4857")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18v9acapwsf40r9m0w97wz9df0ayhyjly2zym6ig6gbzlxcyc087")))
     (build-system rails-build-system)
