   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gsa84zl4cg0y23s9bak9yxfdw3d2vh93x3v55w35vn2sq30dbnm")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bsa8rixhgbzi092ykcxsbn2b34365wynql9z0vca8cp6gmfwiir")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15p2nysjgm7pds22yy2iwjk5hr1fqisakjx9f0vcqfzmz0mb2vhb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10b3cqgahp8v84qzk6rbzw1ng3lr71ifbi95j9knzhklqz0qwaqd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
