   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cvi6shaq65dzp49g15glfk6lbrgixnnjw0cp2100jv4hkf8y4v6")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rhqslj3wr698bl1s2d9s7byv3pslyrx5jg2198mc7i752pk7hbb")))
     (build-system rails-build-system)
     (arguments
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "12xs1bcg8nvv5x0fc9985yznc8f0sdbjspldkk329a88yr3dhc05"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1snd07y6grx2gqmkxym45iqgcms66kxcmmrpkzv4nbccdmbfwnap")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k7q02i2hj7cdqx8qqisv6f313mqqmzhlgqmwmzjk8f4kywci117")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rzh64yix747i8vpgnliafghz85z50k585lh512zxzinb5wmwq4d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
