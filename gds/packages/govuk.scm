   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l7mpq4psi198kbkgjg1njqfmvx5sjkm58nkn4nd5d6j1carav6r")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ss4jrw5vgsys5s7n3vpfadj7scl8hnvs8nksbq01896x377pvmr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "19mx5dna13dpaykbgxj2skhd8yjnll29lbbfginixi99pdw2kx4x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05aj4yy4nlfv6rhvy8aqgy5jp94prr68svinlnwqbjhgdqrb63hz")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12bzxgp063kk592fvrwsn01afqiqdla3ybq6bpch6328zwv5w25x")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cf4hcl6w50ls5cva1s9rqvba1xyddxqyvdr4mwbr41sfyb5wmfq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pzy2hid1pis0lj38a1q8yxzblma0psz0xn4xkd5rnz8wzwv00f3")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0yixiz000cp9hzydahksh00727wxc7m9zq1m6caw2iwwzfqf9fz7")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qvzzwqqph94mqxsv4lkdhdlawrknqa7vhzjkm1mqd7p6w7fjrgw")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "061hsi3zhlbvjc05sy9q73p1n1hqxh495ygzd7087mz7803k4y38")))
   (package
     (name "whitehall")
     (version "release_14194")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n3n5s3rxr4f9x7p9swdzkwc3y82zpf07m82rq0hakcm3l124l56")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
