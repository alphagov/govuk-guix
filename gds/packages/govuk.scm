   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fizab7pv3a82ygj1jxim1ffam5mw66jj3k7m6wi3yp299w74678")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xn80gnyc01ivlbwfyza90wd1l68yfr8mnaq6jjj9r78yg80cici")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "097rjw08696bj4cil4yyn3a494cmzymyp1ib6rbrx7jmbw6s2k98")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "16wjrqfwi87p4hdagd2d9rlnwg7hwwqyl0l2xbk1aaxbis8l3p78")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w3daqlnsgk9gazzmz38arpd4hgwx2a1arljybdnz4nng0shxrlp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zm4cf09wq1saxk9h1lp9yggh99y9zmfmgrsbi5g16kfxdsin6bc")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vz2nr5zmlanzps4k2s2b1rk2ic71l2z376c05lxpmr2zqx1mmyr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l1721gqjy7jrxczwx3wwfv2b6sry89v7awqn4vqfg9pcl61nycy")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0k8063fanhqni1clz82krg7g2a33kdfcha7p50b5q0sg3zdyjgvy")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4075")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1slz6x0kk4iyl12ga7vnni13bz98cal6y4mi5vcc32imck8gdwvh")))
     (build-system rails-build-system)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ckqrpjp09vg619madhw765d2z9mdkw2hs0i102kb0wf82h15jmg"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v6kp10l4pq5c6fz1mmnq8mq7qvsyvk7711qs4pi14jlv733ywvk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v58g6vivq2y340dlm3z45x6jzazag98lrbgyv34fy7f4i8y239j")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08g0959z9246c70911fi93slnrr97nqyc6xasc494cl8dd17jmvf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13678")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1srq996wr4ycc9r4wpbz89q7gxxn10whziamapb4yfplmk7m4kc5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
