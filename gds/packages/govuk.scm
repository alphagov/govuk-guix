...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kk9yibmmm48by7qcc4rflc7fd0qgxk9yn6qrzpd353jvmxqs5hl")))
   (package
     (name "calculators")
     (version "release_326")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r2g2r6n3rdjb17xn2d8pwzjnhdhmzk1l0w07q14mnxxn29bz42y")))
     (build-system rails-build-system)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lddiz76kpls2080949rw3v9bal8wccrm83n5mpzysdd2xp5s0s6")))
   (package
     (name "feedback")
     (version "release_461")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xssw8pahrx6ja1287y1vj4hq9mrjlchw5cm2s5083fxxbzlcl49")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13568")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16zv2liqcbvifkfj689i3qpmx2kglwdickzwgw0rkmcxxv0k5p26")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
