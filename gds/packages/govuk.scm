...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0isdhcm6h14lw4y322mga8792ph8l4ksvpzcnrfia96q2f8mdxqd")))
   (package
     (name "calculators")
     (version "release_324")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mb2pxpyz3f1z96mn2957fx8ky8489cqw05732b0g1j991gf78ms")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18qdlwvs9f1b9gz66bsk68kyhm4wap5zkbjlcpvagxydzin95p8m")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01v4578pimwjj8f1frdz0bf6hxl7x4czxbnl2pqqv6y1m4yka8mk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qrxp3j9g2pl1hbxam4qni9qwnf4n3rlbg9wqaa874s3jpy4h6ap")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hfl4l6qcjbjwvlsi1g9m13i2fi9jbs759p918rhhpxcp6187bjn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bra0s6wq1xffgib55kplpbjq0vwjgdlrkwa5xyvlyr4qpabk1xa")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ccfykzcvi6ipnhc5grkjidwkzry009zzrygd63chcksbpf8za4f")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yx9cy0gvp1xs70lwqn5i3g0bxzw31pmadhpy6ykj3zawqzfcvjm")))
   (package
     (name "info-frontend")
     (version "release_181")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0clg78qj6rdia1z8bqlx87pvjcknlxf6iisdl7wzz3yxmbkdfmwq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a22lrjny4zjh5mfdb0lhc4ajg8byhs6m4bkz9xgsif5w5jxk3s2")))
   (package
     (name "licence-finder")
     (version "release_416")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f7cl7gl4hyb0j66ni9h6vkd7g5hcf532k7pfm8y7ijmp538hsrz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jmqcxylk4pvv9x4wzlsyj1myxnf1n440hsq3429gl4rrh9h15qx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kdq6zzvj9ld1j2y0xnlmnzys7lg9g9vv9i0llikch4nwmnd9iyb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17asmya1fdvvd4dbk7l0q3yrib61xi7fr641yilfwfpm2ji2kw8z")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13562")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18g8kmadvvrbpxg73dpgwb63d8i8x00r76sxf7gghrsvyq0ivw1s")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
