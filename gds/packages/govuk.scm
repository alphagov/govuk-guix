...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hmf4d63yazqvjwj4crqaq2zzp56dyvsl3xyd2friin7n7iyznqy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1klbki6y1lplds9wwxhg1ymhk0frnlfi2ks635xqfhhpv171hv5s")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ghjygl4qqv144d14dw7ns0b50m5jsmkzqggvjdx7nllq8n7f3yc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zs6ap06kdbg0y6p0d95ya06kr8535bri8gg0mq2zq01frcyxap9")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h0bqhck2v46vrdyawly735mycnb440b7smcwfgrchkssbfybsys")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sn2rw3372ajxg3lsnhd05i7bmp1fj0w1xvfs189x8d14sy223ss")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "046vk47s3p9lh7g41f99fg2xz30rm81k2301d1d5281xb6pygqvr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0m8cqxsa3vx0r88cdhi4rk3rsiygzjdjp6xp20kb01gjdbr1kq1i")))
   (package
     (name "smart-answers")
     (version "release_4138")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kaii5vnqr258h9l4lk5xf72410criy3fr0y8arf5j73hxa4jw82")))
     (build-system rails-build-system)
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p5dxxlzn6qn11asa3yj1z08h76vkh0czmaf240ffqlys5nq11p9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z33q5a1x38gwbjddam20qsl38dzzqv2s2dxlilnmd4hpkaszz36")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1a3wn86d4hdyhnfg3nnfw8sv5n4g1hsiw595nr2vdadprx8v0fyw")))
   (package
     (name "whitehall")
     (version "release_13804")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l75x21l38w8jx77ggpipd5yshwvk3yqnr886h6p7fz7y3dab40m")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
