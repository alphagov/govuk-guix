   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12xdr5k2j2dms3rbh43rzylp6i1ixn4id3hiswmd89xb7bgl279y")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0akna3wig7jghc0d6cwp1ccd2vnh1xagf5xnb7s5mk8camgnippf")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hqcpz7fjl2rrhlrk57rz1dhhm117zk07lny8zsf7cdy4yaczsn5")))
   (package
     (name "feedback")
     (version "release_329")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xp0nl8vnb87jm6gwms9aw8ralcghaz7qy9wynbjcd63z6lsjsak")))
     (build-system rails-build-system)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2748")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10k7x37kbny38s9sdavvwip9rs3cri8h5sdp51jcdkl55mw4nwf3")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hil2ji8h255w54fn891a849nn177f7g7jh75jdhkxv3pzaqi7xb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yz1qf3cqg74bijxxcda20ry5inyyj043042qz2m1w3cr5z1ai3w")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2710")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1np20b51nl42cg8hjbbxgbd799q27h4vnzg4jr2nrjj6yfn7284a")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
