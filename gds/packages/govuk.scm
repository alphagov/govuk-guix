...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0q754s8plmlw452iwbfjz5p83gxhvvxx3vvgn171ir1kfnrxmhd3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kx3p35k69h9k1a6bvhgxdz4nfxxzy5ipx08cfvyjx780wryjjbw")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fwywqiqzspp2ybakrdy6dn1ja723b4x114h15nvrkha6k4psdk8")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
