   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kqjcq46zhy86b1778placy7w3711qrx0scdiy6i899jp29nkgz4")))
     (build-system rails-build-system)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "09b93jaff27q1rlmrr30x3j6zr79si1f0chffyx2mwg9ccisfsqg")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13559")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14g2cnq5l424651c5l74hkbsxmn2350pz8ybgbx6gghkfzy1rp61")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
