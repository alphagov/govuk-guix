...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yhszdaw8y5rx9i7xvg5n6krwzz8kdqalc42ndp2vadql26iwzc3")))
   (package
     (name "imminence")
     (version "release_663")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0213v3gkm1m88p3p9lyfnrdrhh17qbqx07yq7bf1lqzdiyp35s59")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vsbndjay5p73qcmxv21p6y2dw0ay5y4ql0gggby57m21fsg4cky")))
   (package
     (name "search-admin")
     (version "release_427")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "019f58kk96srqba384ncgc1cnxzjhqanzmg7q9s9d8wv53qhcrcw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
