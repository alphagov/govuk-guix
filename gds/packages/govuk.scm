   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1px5lh8c97wj456x9c0zbj0szq8sgrx1khnq6k4prp716mnvzff7")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17v3afzjz6jyci3f1dxgvq3wd1id8z11rks10c6rfq2w2z5p4pc2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "084j4hqpj1wd9i4bm6rfdq8jvpg0ig88zmiiayjsbwhwfdl9wh97")))
   (package
     (name "content-tagger")
     (version "release_473")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0s0i5n2frdvyf3mzgcy17bh2nb76wpgf4dia5lrp4l8bn9fssr0g")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sgakcdidv8phd7m8sdic4nvxysvxvz07zc61dbn5c97cqzihh8b")))
     (build-system rails-build-system)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jmg93vyiqcacq1c8abi0qkba5vz0va24r377d2xkfbrvlnp293q")))
   (package
     (name "frontend")
     (version "release_2714")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nnlpn2qdnibspxix5bbs0lkjmm1r1i52rynfp26db9s91dy0hgl")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dqip8xgjdvvj0yfsnbrfd3300lbvxvrfbrnnwfmc6w90gnnxcr1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1niknw3b92y14nz3654caw70d1z3b52r3nqgvmmskj3d4fa64xbv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0v5cw04zg6dxlnv6wpnjigl1vbgx00dkfwix79hgn11rv85gnxc4")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vl62kl2nb1g7vnglixqrh1vf600g29vfgbc6j38fcf90jp2sk9i")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0zspgqn9kh9bydgjp73z34mrk113v2r00hq4k585529i196l9290")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p16ccqzrfyi29992gbsnx9qxifb5hhwsvbr5wh95w1d5ham6isa")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jqf4gxyixxnjlrp0887pbx0zavcw1rhmikhc06mwqm6kcpy4ik6")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3696")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "065vvilpy7k0n7cvs9mqkbr3zffmindw17s83fw7pcgs8ppp2q1b")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2640")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07iqn27krk4am1h81nw8a3i39rrk547sb67rn60qwvb2gcjnsn5j")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "07c85gj8nmfq8v16gkms1166qazc5r2gq0di1x38mh9alkc80njm")))
   (package
     (name "whitehall")
     (version "release_12919")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wn0lzypp40aj4p7yvifzdj2li1938i3c85d59mdbz85gx20y7r1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
