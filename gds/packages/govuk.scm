...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dm53md2x90592rkp61n9gjfjbfvn8b5hfsy5mi1mqxazkz0s9md")))
   (package
     (name "contacts-admin")
     (version "release_379")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04ssqj9af7qc09gl3c6mh9wr314p6hnqlpxv6qhj3jyaammz3y5j")))
     (build-system rails-build-system)
     (inputs
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s5h2ivz71axbnzhbhvcqqjw9cpwzljf3va2y3byrgfmxssshh0b")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dg1wdz8mlfi0j6cfsli1w7m354jz5v56glnnhhqgvw3b6klya1d")))
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h349wyw3v9mdi7fmva25bgfcrbmgsm7qda7izr2nggmvnp55wvf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18jndhkl3svv9f13p6j33fbld2l0phhchf7sf9nyd9ydv3x0bkvr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q7qsdz15nl3z9pzs1al6zw8mc4p3fgz1n6z5sfrjx2w7izqd0f6")))
   (package
     (name "licence-finder")
     (version "release_313")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vfkfk0lrqmvy274xki99a8q65l5yqjmrkpz5zbgyi1ljq17k11p")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0i6sgy7xyla9dyqp42kmlwz5rgh4akss2i8ikd5dkcxsi04pwg7p")))
   (package
     (name "maslow")
     (version "release_222")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w3fxcrc8cqna79n7sn1gpsnrlr6kla61bcrkzcdnzhmymi7jsrd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vnfmjy87hhlzpjzjjvcis1ajy86yiprsl5gpkycy8ganmkxzis7")))
   (package
     (name "smart-answers")
     (version "release_3813")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zhb28qmjxjyhsl55x4n8xixdgrjnx6rdc7d1cg8viryv9j7nhji")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h6w4qdz46z4m8zd8x7lfg8p98dl8h8kpiwgnrpgqhjxjhmvz741")))
   (package
     (name "support")
     (version "release_620")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k9ncxllzwgvs3ahwqvcr671lfaidm42gvkiha6nsjcd2536g8q0")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
