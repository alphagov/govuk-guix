...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fxwaiiccifsy2irbd16pdrj9fl7a7wxhx0hkcwcizlihjfk24ai")))
   (package
     (name "content-tagger")
     (version "release_583")
     (source
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "15svlvmf6lgv4gawwq57sbznk6lzzywvg9s1jr7q8810jbspki8r")))
   (package
     (name "whitehall")
     (version "release_13102")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bqxpba96fz9alk202kj61y6v38c4z2j9z2fxkyncy2rqgq3dlwf")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
