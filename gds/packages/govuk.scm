...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "16sr6f4h0l134b4zr09j9f41naw0clc3d293q118p64bfmy18hiv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pw4wavzc7aa9mcqhp9gh7qfpvd4rga3xpxa8b5rdkbfib5yyhnv")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0skbri4dp6yfl52is09ikicf2b9n4ff1aby46888rzqa2k2ij18b")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "148d5m4pf3g0hn9vmvz3h1skd4ab3kq1n2vzxmsykjhnra4g1bfh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
