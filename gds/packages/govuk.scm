...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kn0xzgmgjbrk4phz988dqw8jijafz64simdd019j0q88p7x5kjc")))
   (package
     (name "collections")
     (version "release_358")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11yg4pqxx6kr7jgq9yma35csy25ic6970vc9g584ckv4ss4hifli")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ayxylbh4wsz1nzjxv0n1v6ffymmrpzgjdgs3dwkaqfy8jqgdsyk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
