   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a6nbi9cd4l35ivn9394fshf4l6l82409rw0dvzz96kcpfr03g6s")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l8cgkb6z5jkhhwxs0dnfcwigfm7acsib0k1yzlcqwgx41mnqffb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13807")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d2qk9psjj4bxn6vsx90czyzmd2i6ifb63amx5cdfq53l1pqzn9j")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
