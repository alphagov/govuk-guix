...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vj2hv61f3janrxh1xqjq4z4vpig8m2rhl93iq6n8rjjgfjjfjal")))
   (package
     (name "calculators")
     (version "release_636")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xm3hpv485l1ib65bi68f87vym69r90xv93fm9rp9ig47sczir8n")))
     (build-system rails-build-system)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qgzmwhhr8kdipvb60n7z38pc149v7f729fnr7inws56gf8v2z1y")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09afmpfwcysix4nyvvghm6h0qim6zkgi2wd5ba18mrq4an3bfgki")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "02fpca9fi33jxqyl77pwa07cj9g3wg0nn3kvziad7dcdd5vrd7yh"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18nqkmyn7zdgrplyws5zrs3wcwqr6p12crp45nq8y9a5wqfnb9cc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
