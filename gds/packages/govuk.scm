...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0z2hzk97k22h1p51vy741lr87ifc6vb0j7iy7d87iaalfi03isb3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g86ld6bgd7av4v7hw8dgm136c5cr94bl5zhxyi6armk6jcdz708")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17s0bh1lsgimpzyjqd54cbz98x9asn8wj0f7kpw37sn7405lid0i")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03vqrpb59irdpv0nndj7pgi17lvghnksv8svzy7m7cvlh2n8nj2x")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0awirqsdsqmk55mr0n66y7qfhaxlpwzlavkwf6q7wp4s503cqnki")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14002")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vwgqf7z8kghsfsy4i95x9sxxrba06zazajx47fh8nh6clb2dgv2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
