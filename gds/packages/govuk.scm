   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pmby5wr6z1yir4z6sbdg8j1gznp4mmydy7vriimx6x1789p5r5f")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wrdn8xqz48zn8jjdq7kvriiql5m9a62yn2y2x2jxvr9lcl0k8dg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w3llf9a2k8g25fgfp638a9nibrd7icgsz1n949z5s7bsvllhp3f")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jwk1rvxkv4l1x7fxkxrsyicjgzycygn6pmyxcw7wmzv27pbkpdi")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1byklr5nbpjwdqfbk1ylxi26k70v37fl7d0xkqxrm4sg0l06g1yd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mr4c5qc1pdw41zkdhjc9ygz8mydm60av4l1wlvy36w88f0b28fp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sfn27hxp8b7pq3h8mndhz00316qj0rw49b1akqk2h9f1h24jr9i")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "147pxr90i9ajm1h53sda4lm1ihr1lwkgqaswvw5s384kl5pn3pzx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0py50fdsg7lx0bsq5p9czb4ydlgbr8khr31mffhcg3sqg1cv1mmq")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03kp1yxc6y6cpy2px8i6xlmy8l93baa5r3zrgx7l1ad73h28ghf7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ph7i33hixxnqq3fcg39ipi6cgi4f42hns5qlll0ccrclg6ygfaf")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "15xyxvpkynix8li2n1i7afijwcn7h25q55nd1p2gylfyrcnhvnh9")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3821")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04v6rgw621xiq5fgqpaxdyvf9y5v5qwg7s7fs4r9l5p3rxz9y700")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2754")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kr1rs56iym3l4z0f4kx7gd4gb0sincw97g3bx9a7k8ar3d0ydmn")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13193")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xgad7zrb3s80b6r0172c46kjij9plh4zb1hf0f1rfvj0xhzavm9")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
