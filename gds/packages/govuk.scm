   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08196vqmsacr34vgzxf0nyl9kffwixyd06mvsx882bfghr2kjdnx")))
     (build-system rails-build-system)
     (arguments
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wsmgkvnqsg9lkrravlp869pd81b3xvplxqs42ywqm93ml4wlzk8")))
   (package
     (name "release")
     (version "release_586")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nbl45dpvxni4fs8pn4gh9adxz7yd4qz6dkjz2s3hdmyb8wjh6w0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ib8mikbyss4y6dldynsi3p551w2rjz37ajk3nb2qha45yycn2h8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jw565rkx0d0axc2bvkvh3vrh140h24izy716vpxg7ig2bys9wx2")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "03qi8pj9baw662v4hmkjmfqv89f15aszhr92hprmvn9kmkwdpj27")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kkyw6ggn59wksymxmvrirz1qv89im6jrn3r697k09iams5slsbf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14624")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05f4f050wifa7cpsb9bk7l95wg4bhclk6hdc4crvn12y7vp8niir")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
