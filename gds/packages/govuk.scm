   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "042cafv25zrr4g4y5l6yp11m4xyf18jl3n71a91cxb4lzsljl1v3")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15qwwblqklns5nf8xlbsx4kxqrvpigklxwvbb19vs9x93xb4nij9")))
     (build-system rails-build-system)
     (arguments
...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "06jgx7044jvn9lc18jjmr5mhyflv5iz3bc1hkj069028f6sw1382")))
   (package
     (name "calculators")
     (version "release_560")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nlq7i7q68g7jl6bf7y2lxyv8xz5xsiv4rq2h1s5dihing8i11vy")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1n27h7czqphwglcrh8xfjncpfs9n4931bx6p3cgdzj5914p6kqgp")))
   (package
     (name "calendars")
     (version "release_800")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05iphfis7px0xcv2j45kaxx0kks7lfci4r2q9kf86pkasr2j0cip")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "09508qp0gb0hhxfaax2a1rakqs67ydmxx4m38ia33q52vk74l0b1")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kv0gqh1c8xws828bwx0w3x09nj9i7fvnmvnaksnc2dhdgp7pjdz")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x4m8hkfwrxb5380w2cgxqaq4q22h2h8w3wkfqizdzxp8j8a0krg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "15mdv9bgcp1ppxqxhmclbd04sajsbh68iwmv6wj7x2fpdch3h1i4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11a44dqn57ssb8zxnx5rr8k16c6k2rgw8vgcx5nifinl6mvax1lh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "00p6gxgwa0cqczv6474jy7slirdbgms1q178dsfqlhki47ynv19q")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "108j080dfgimwg5asiii7d421njwmnz6bykghzh7csjcrbk7sp74")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "143c5fcd6frcl98s6v794y5vgnpdn4lhfdnv7467sgyzzz9ds2xq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15p3hr06b7i73xfd8dwhdbndm8lis4zhg6kik52s7aflh4m3jqsj")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mdaidx4rkbrcwxrhpywygzi3l0ydz7bimfnfrj1xhmzg3l95yzi")))
     (build-system rails-build-system)
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sw9rnk93qi1w2d5zql8s7gm41nyfm9qj3bqc01dzlkq1902bm86")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kk6lwb5rcmg7p3b5hrk7lqdazacy0bwiyxvbjrphrsqszdysgmb")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gy17av8avvjh36kpj5phgnkgx9m079m2q2pz5acgjnpbsxkj8pc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ykdm2hvp538m2mygvh7b94s43ab3wxi8cir8fylnszdwdnd2rx3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lgf0p6z0pq5vdzs1jwp6x129l7kcy80spd4xc38b6q9f8v7lgpl")))
   (package
     (name "feedback")
     (version "release_751")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08k3rl5x31i9pmhgy0hvaivfkz9b8gjbsma4sa3lhl9saif67m8i")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vqi9nnnq2r9ipnq5x945fapah76jvkppk5ixmsv67frrckisi63")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i9qcc4hdmn7l6xwb2n5bbf4q84qn21q95gk3960sn7pr277fpy2")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yf60hkr1cfzls504s4fhsfaq8wskhaxxpflgfh2azx07dgccvx7")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s4wlscwyw2b2mfcvx0m53vzmgpipqgx23is1wlqqymqwl64bl65")))
   (package
     (name "imminence")
     (version "release_569")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11nk29ma91qcdma168arn54d4gqdwp9vb33ii1993icd6lbx1p8v")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sh9kgkipk7y4kjmb8xbfq8ijyrhbxh569dwhgzbgdhgrvsqwbry")))
   (package
     (name "info-frontend")
     (version "release_421")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j8maz2mpqgqp96bg58vpb9nq8j4y74c2h6ssbdy2cs53q3rm7pw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qlsa7p4pddrhw32qvxk6n1lch89g6m3s0s0ay8sjqxh06h687zi")))
   (package
     (name "licence-finder")
     (version "release_649")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h3pz9ybbbbd6jhwimsc6jk7ybfdvjiy80xrd08vcyx64q0qf49r")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "17qna4937ddrpj14qs86c5lqqvqc976x7n5ymrk07y7gv3zz6pj6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kaxrpkw42d6vf1g5m3znchf2y6v5jd91518psf1lvn84wcaph7k")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "18hm9r626mw12bjs1a469afid5s19r8hga8vbizzb8hhga3d6r6z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j6xir8ni83m60ipq4h8z56i93dadnlsicibpild936qx4amsbl3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "14shvfh70mpdlnn5vv84i7k3ispxnci1654f6crsc751nbd980vc")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jdsxd65ji2d02733mazc3avf6mjsv29q0hmqxv9rvznq7kd4kcl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1mk9nqb8db4yw831xaihvilpcwazxh6fkqxvf83w1hg84hg6i9xx")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qvfh1fsiy7s2aq5wwlzfmr02cblhjgrcrp4rr4mv4h08rq26ybd")))
   (package
     (name "release")
     (version "release_508")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1na145c7p3kzmkbz2c4nclyflifr49zaqhsls498nm0gld1c87q8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "12937w2q4h8lqfmxy9cpwpa7101vckdc1sirxp2wsak1xr4r9i0h")))
   (package
     (name "search-api")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dl0s2hyyi6nvk2bnximkk2917hdbyh82n7bqw8z9lihivxni3c2")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jjbxpnirj0b797jirkfxg1l6fgh7i0bfgc38an5kp87bjh1i8cr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z80zmg9bgn9lvr6kn0f8dkcv3cscr84hl9mw57dy9s377pi5jqm")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wjf2i93ylsx9w80k3k7m1n7lm7kqgcfx03pyf5l43kg97qi90j2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bjipivadh1vk9zhhq39by1ywvlsx36w609ddz0nza16ar7qf5db")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xalpwxbbxki96x5ridqnif8k2sd78qm14rll1rvhqfypbbx26v2")))
   (package
     (name "smart-answers")
     (version "release_4472")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08bkzq0wjswkgbnw8c8ng9ls0886qgy1151fdcvi0kmlsmzg2saz")))
     (build-system rails-build-system)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dfb0h9x4wv09pad1gbf5ir4nfpc3hhvxim4z02vvkzlwiisg1qf"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qbmprrdwbilspxp1hyqy939rcihyprzskjq4l939rnsizcra1pm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "096wsy4vdgavxnfn9zjgh4j9aadlifjdh72p3s5f99izzr5na9rc")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l5pb9vr1ivswwl2n1cnws440w66lkjjcvl6r81jc6kf6m7c6izk")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jhinjyvc4kc8nscd7py4akc9vg5zc1s4hb2v62jwrwhs368dj54")))
   (package
     (name "support")
     (version "release_896")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ndrv1clmavfnq9cv1ncvddyh3f8nsix01qg755m8sy8r999ygsz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jgpxgixzpnk03gxlxa0nrrvw0whlhrhw8zxrcj3hzwl801gb1sb")))
   (package
     (name "transition")
     (version "release_993")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gwdspikbqhm0fyg2142r820gbk2slk32yc3j261vvpfnhjpj3m4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "02j9f7i9yfj2lpf2z0kmj0axn0ndb5si271jj52702ccmyjz9qsc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dapxwyagdnz3yybvpl1r9c1mwkj9ihb8d5vrgj24jw9fvg3hhjc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14295")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "128lgxsm0kf9v6w856ibdxj0lrqwh1kkgi4xang0431bkjrz92y1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
