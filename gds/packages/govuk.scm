...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "15x1f0innr37npjv3kbdlzbhwjhlgs1wqwk12g16nrgb1lhiv0m9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d92wqwz6cjs1cwhvydb7ahpdmv4i39fbp3ql3z6zk4naqi1746b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fa0y2n7svy20z50klfj0rbqqk4700xhwlzzds28wbfxf0yw2avb")))
   (package
     (name "content-tagger")
     (version "release_896")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "023qgmmhahwcll2fq81cd21yd967gl5jcccb96lxhldm9frfwqxl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yvw28zqcwnl8p04abzdajjlgbkj4bs1fdd6v5ccvhk96451r5rk")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hmvj5wvsnridm3jwscgg81qjsxlngyyx0yldv93f838arfxg6k0")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j2f61nj23mb427v1splwyi1irlcqwpyilxfkjx39lbdxlm1hd87")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p5fj0p3bw00z0r8ij8l5asxdph7lnh4s1p943zbm8hhp2a7dvhk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1n5yqpcf80whv8ksgr0qzxry9nk6kmwywn8awd5c0dlw5w57by8s")))
   (package
     (name "support")
     (version "release_785")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rp8cd1rap6gr4dl3cb55rx3y0ff8h8hgggr47b5m9dnyqvy0sc2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nl27zq8iwmggl7shi3m45lyp4v46gynwl3zc07v67gp30g5j2mk")))
   (package
     (name "support-api")
     (version "release_252")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "007ylxarw4i600mp5cr0q0jh6r2vb0gif8wyi4qxr48rakwsf7zv")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
