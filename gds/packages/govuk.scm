   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i1dgwnjvya12izmyafx8viash6lz1r7wvnb4g8bwsbk52am90x5")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j12xh4v8azl4z966ysf2gkdfiaah4dzqdal4vbwwf23jisfl2vi")))
     (build-system rails-build-system)
     (arguments
...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ba26sjl6n6k34jjjjr99j031isma29bf05356mvlxdvq8qs17in")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "092r8vq52ids6nm403w37sv1pckdrn7ymprqlvka6xwyhikjj4g8")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ld3ip7wz6zjjisp8n3dim94kwj7bz0hnfbf8n6kpl1mqwdxvbh1")))
   (package
     (name "whitehall")
     (version "release_14799")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "166d9sbibki0ikb7yn8cyfnmblsgpqm7jkxsrhriwl3a8787yvsi")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
