...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0c1wwhdhz9zxxbbzmgr6aljff6ld31mq2xnhxlbjry6b3f55d8r0")))
   (package
     (name "finder-frontend")
     (version "release_1837")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p4rywfz14202zhr026l7f7lhkrjliqwn7vr4snabn90hsc5dkwh")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bgphmylwiy93lziikg2a8p2m8zmjq61bpvy4mf6bvjf7xz1bnb1")))
   (package
     (name "smart-answers")
     (version "release_4844")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02bjh935iz046fb2gsjs7l18s5qysx8pv6s9mv79ci676qrvwnj4")))
     (build-system rails-build-system)
