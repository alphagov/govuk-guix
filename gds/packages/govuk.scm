   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "052p2x35sngx1jyghsy6wqw1cnavr7hbcy3hm80a69wlza37q6vf")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "10y5xrwwg0rc1d7jhr6fwjxnk7g3mqnbamrd87il9gqbq44qc6h3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rmbgkcy9vfc1qida89p4h7hy6514s851ks9pk6r2g9j9pyz4hhh")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gv6zqxcg8c652jiya2zavpnyw81civm3qwff7c30k1fyqv424xw")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yaydyfz65sfhzbfzv2va9hk67p2r0h68rmlpb7225cafmr5ky7w")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vwnb0i15kdb7x33d5azk651w136kybf8g87s4nxpdvqd36z8axr")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0qzm3fbq4fmjysarsjcval7yg9qyg1pz96f1hvj5q69arx7bhpjy")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "094zp2x1pvrgvmjgbg0l5r1cb6i3wh6mbqiwzvzgfa8yxjfrjwsi"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ds6pjq4llpkrhv8xwc5ilkdc0zkdwppd3m3rc9d7jkmw6arm8rp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
