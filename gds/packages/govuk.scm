   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "111r70xhy2zz469qg35bci4sxmi7v0igdf5mzaprzccy5lkxxcpv")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1860")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y1kk5bzf08yl67xpvzswy4phjv8fzh359n6p6c5mz8rkvrsfsgr")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rcyvz261zci985vvfrwk1w9vza9b73hksii5ml7r0cs6v653458")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
