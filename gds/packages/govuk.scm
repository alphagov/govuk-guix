...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0aqaj2k48mvjpkpz951wy9zkpf8lq33fmpgvkff7bhifyfjmbhii")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fmjsmahxvndjqsvqvni94sxjwy723456sczncr07h0i8lkwv23m")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mrsi8hw2grb56dl4c2f0vvvmk19d12gg59ciid64k1m91jbn254"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10aji3n2ra7q34zznbhbgfzbkvmrs5kpca5h4i804myjqqsdpxk5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
