...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "18ynr094rjrprl4gxls6rpyfz6ash40hs5iajdf9999xsg8f6j37")))
   (package
     (name "contacts-admin")
     (version "release_407")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kqb7j4zmcyran4hpr57s4al29pwxnabj77lfz9w59wk55qlb994")))
     (build-system rails-build-system)
     (inputs
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pl89kp783g3pg39y9cvwcziba8wf96i1rzf3f64n0jhgzykdvsj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19d7gaqyvfp5rjyfdp5bya8wa4x1cdya2yqlwfxgsfv5y931frhc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0b9mycqmqfxg8grxqf99jrf3wrd5r6cq8dyfyjh08bsprx4pkrlb")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0iw8b54yfzmxxkgskykkj5cgih5dcn8zp9cbdsiiv14fpl869lsz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ww8srdb62d1yryzy5r1pcxkwxv3jsmck4dkysc6wlgq1i61j8jm")))
   (package
     (name "imminence")
     (version "release_349")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yx2c2lgdklvphf87ly4zj88f55ls0f7jcs3vf10pl4ca2zxc9jk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0la4zzfqxifc18yp2pjhisqfxj2vwzmf44xmqnzfm940h5rh2hbi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cvxqjhmhvrmvb1k1nim1yrraxmx6v1z2g31fbrji3751j7wa20q")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r3bck18l4xy639d6873fdxan04yrw88gjchi82fif7vkpllbn1c")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "11617fl30q8295230p0gxgasw7ldk5mws9c0h1vlhsw7v90adqsg")))
   (package
     (name "support-api")
     (version "release_166")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lszqrkfsrj7mi9rnpapn84lfbjwz8p7jakzn9vs1x0q00ih077g")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
