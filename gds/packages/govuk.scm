...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "15ca6b82hwzlpk7zkq0g3gx51hakhqysxc4v71zj93iapn6h533k")))
   (package
     (name "calculators")
     (version "release_269")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kf7l65mf7b25q9r6hhraln8i714jwbbsapz0vwlk9kb034qs022")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "19j4gdnv2qa6fp6dh65dckjh4wd13h89sds0n7ca8ffh5y6caxiw")))
   (package
     (name "calendars")
     (version "release_496")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11jfyjaf88klpwmmidyc6gy5wyambxqi35x1aznq2pcz705y3mj6")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bzqvv89pr3kacjw3xjmggj6qiddlbc8krxpbw7pb39mk0lx60kx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
