   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sdnppqncs813bbxag6f7bh3gv2zz20q9jf6bpqlym0lhc8116in")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1akp9zqz17lv8miv1ygqq66nssnz9j6hnkagh0vyn5gn6c7gj0h6")))
     (build-system rails-build-system)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m5ghvwdhyy5jlmzjiql6sxrs0jr5amcaxkfcz1pdx8c6wiyxq0q")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z3szbqf0x3i5mdqx94qj7y1ihr7rpkqhqivfl5vz0g0i3hhym90")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06ihhi0w07v03cnq621vvwmx5mdqsbdpqk12pfb5z1lrr75gn006")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13094")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1067dh0w3fl5ci7abwm7zpiz1vs9l5qmqwpid7gqf29inzls62l2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
