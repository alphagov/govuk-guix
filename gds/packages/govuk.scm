...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ja0821szz33id0s53x1slnq3p4xb66n5phh9p2r4rszmm5163iq")))
   (package
     (name "content-tagger")
     (version "release_616")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06zsp5pxa97h6fqpw6qmr0smdri0v2nn9vwda9k7f9b9zx3iha82")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public policy-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "156s4zipp4ccs4j6rkv9abwg89pngicsr42nkjmj6xm3m0dc33r9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z5xkdmv8im0imc2zks2fwdsf0sv7dmm5k6iwpp1gbgnrnd4jm1q")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
