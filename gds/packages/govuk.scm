   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07cwr6yb75ynp2lsa7s176nhykrj7j1v8im8fz6xfr2ggnbhc6g4")))
     (build-system rails-build-system)
     (arguments
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "119faj8wxcccgc9916z5wf4wiqrpm63wb40h0jj1a42jzpbpbrk8")))
   (package
     (name "smart-answers")
     (version "release_4482")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17wmcn6qkqxq4xkkcimmkm6qgni8f276glbjkg0rw5mmx0gnvnm1")))
     (build-system rails-build-system)
