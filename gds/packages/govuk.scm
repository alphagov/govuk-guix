...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "05v64bi9di7dlnjc7z15p2q3f4i3a0h2rl4bagkd14zzc46h4zz1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11lr2y0hn0srwfzqxfb8vxxm6lrlycj69s6lg74s0lknwc148b4b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ici330sfinkvh4vz4l4rphwhqg7cza1j7yh5cigp5551fq66qfp")))
   (package
     (name "whitehall")
     (version "release_14081")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yyk1wq4kw38cgbcaanhfqbzkjnqy71vppfccdlw9z1khpgqw616")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
