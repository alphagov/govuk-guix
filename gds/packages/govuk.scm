...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "03bvag97apya1m7wj1nr6pqfgay2nbf79prf28mzklan8z5npld0")))
   (package
     (name "feedback")
     (version "release_511")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01y61iayacadnnns18lc7pffx84d924ycm9imlcbbsyzg912x865")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fmvf9n2v1bv8kc80c84fmjanfdchzx2b61bi5a2qac2njb2xjn5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b84rq04ks7nczmi4ijzlx849q7n72mg5na2ngzxsx3i2gdjvh17")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "12wd93kfvjdl80ng5bq9ab53nj7j4xq3zmw6f9b3d2r9sjf2smxz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11klwiw6zhmkr24nxx9fni7svcsnx1qzfvninx8nw92pyzn6680p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0axj1h9d6xnlnnncyc9xz435iiyamg9prc0ndh3v5pzvbsik4xff")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13zzr87yrx35gqs7zbns4lq4489n8m1x50rnj1k94n7i55i9y45s")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dm6kpdrysaxm06pmi7h392a2m63q2vh4nag9as8xps81adkmsf3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bd709x5jrbr1ai22iihq8z1yjw2hynmcy19bq7zsiiqd7gyikgs")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
