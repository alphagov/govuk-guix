   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0snnjixv0l900jbfidd0l8mkj1zi2kqirimya66q1cgnhi4w2j9h")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gznrwd4ac6x8k00fns99hnmi0w1m220gxv8l2b9ga3x3nsyg35r")))
   (package
     (name "content-store")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iz2l5gcalrvk8lfcr03acvqas2qi2gdvff8i8npb7phqv1smvr4")))
     (build-system rails-build-system)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1iyhgakiwgrp34fk1qvqxxb3xig1bvzhp372znlm60w5qdhzwx6k")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yrfg13zvgfbsh7ma7i493rvp6kf8p7nb3jyh4476g37xibymcdv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14850")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b2hx98hdl7c0fsbcjyaivi5mlpj5g108nllq6lprx1r135rdabn")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
