...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "00h3axijqr8rqc72267fqm8fdimfgphxla2p8zcspil812bv4my2")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09zq683n0xj3xkszjf5jlngi2pssv0rnrf5vm5rmm5cpcm23vz3f")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "161cfjmvligh2hb0562qdvj4j1013wm0vy8q6cdsirjslngk28y5")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_5002")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hz91qib1ffvrg6i8yxbia7mkdwj5xhl1cq0f2vsnh3rlzgl88yh")))
     (build-system rails-build-system)
