   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kyq0sbsa15yyqhf4rr0mcm6vgsrpn26a241b8yskpsh2qy5n9yj")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1988zigryk80hnc3hwh14gzh4a641gslmxbmlq1f2r2hv4gby069")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09g11xiasbpb7fl6rf9v1cas4xjjs7jj1vx1ab0l5p40napg4w51")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3842")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rb8hacxxg3mn1n0g2fsrs38vagnx69pjx9djxnqynyv1701g0hd")))
     (build-system rails-build-system)
