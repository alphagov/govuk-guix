   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gcr6i8p0xgz7qkh4gx8ra1h40ns8lkahs1pqckm4h24nl48r0ah")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "05j05nvs69nm0zyp21rhnsimnrd8gf7ncx8rim3qi1ia3ys125c8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q4l32khd65n8cqjz1qza411insh39fkhsqjbmknq511w8x01vzz")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "179ahd25xx5cqvx09y186b2mwzm8l4zjl3sxp2h329lcgj961w36")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dlj89kf4w1wb8qm33zcwmb0lmsvfy7zk1yvkib3sdhpbqz250am")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nfhba608rrbnpf96sg984am7fp000y2843mmxrpmvgb9nby8ca5")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1izxmp688bxpymzd6cv0d48hk211jvlmfqbfpm79zl93y1asrq2w")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g45nfjwyakv61z1pr6m0cxzqxm7dcd9ng4hyj34a5cpfkcn63a0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g6bxq6rz6907j4cc3bk4jr21svhiy9w6zx2zwnzzglwzmp3yxi7")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "160xnysp4c8zvhy5w0f00z056v12z1vgpyxj1yn0wijahy8r85mg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12c5sgn8r5scc52j82n88pmz0i7d24sii25fvxdhzz4lmiw1yxy9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1brw6a4krlrvprr86ks19wdrhx2pbrwmnwv8g35j0jmy101hr2gy"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "065ksr997cvmk2qfpycchz97mni4l3hw8khfs9gl4lpx2l4ig6bk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
