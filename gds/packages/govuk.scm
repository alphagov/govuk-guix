   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1922hl9krjs6mjl0h4kyl7n0csyfmcfylc21sizgxizlfha3nay3")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "08h3dfmcydsa6rvz2phc0xalsb5c7dg017c4jhf18d88ah294wwm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ypfl2lhkh9m02fgsx3najnh1x6rlf6fnww5n7bn7sqncwjaqhs2")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qmz5wvmprfq6d1nm1wsinyrsb7gsdz9ax0d4q811llzhw35x7qh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m61v0ssncyzwngm2x6jr5n0g4pqc7s795l1swsywk5j1l1cgx1c")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vmc3i9n5bwp1dhnq0pp1xs0q1i14kdqiyxnpwg3x5d6689w2p6i")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h2v58gphm2qy3i8p1kyy60v459vcb9qk2yrdapavm7zpd0np5m7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w4p244dzgqv4wdqpi5hm85qrad2fadhnlf05wl62gxsxbi2ip28")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18dwinqamrs9rhs5k2vadr440jj6lx9j8rd5mszwsy3ds57vg6yh")))
   (package
     (name "frontend")
     (version "release_3620")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0crrdi8ljwg8ax40d8gg8vzl5cyiwd1alwhl6ijj70kbv5mzs4kv")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nx687lambc8wfxw73ic00y3yxd4lrjk3csnra3k08jma02jcgns")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kkw2jwmlij66h2fn065yfpi8vy6369ymlgarzhc6r4jffzg4v01")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "03dasr8i83z655swyczvxhfaj8rlw5g3i316wm91piq0bkqh17f8")))
   (package
     (name "info-frontend")
     (version "release_545")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y53n90irxgmx4n637nlvfvpx4s5ngxxcag34dqyrkgwk66jd8qc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1v93r3yqnc5d5blxdpp9h3favbgshn16c97ap64s8sjvykjpfhhn")))
   (package
     (name "licence-finder")
     (version "release_798")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pgck3bd00ca5s0mbmdza8hxkqpv7f7dxsna0lhg73h7bsrdqydy")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "08vvwi3fl7xnyyscmyvdinjkn1lik36iyf5gyz6jg4v0y6mim1hq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1377za1shlj6x6vsyc15cyifh32iigwnicnx0siyf3wji8miv6xb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "188d6jd78dradhzy3f5qb91qz14w47l11hyw54l7zxjjww7w60df")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nhgcf4cp1rh1jix62ka3cnc4q9pjm2bz1khyk99qjy4svyg6lpy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2586")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w2a60mg8qdvifldwk2j5kjmq74isyfjifgl3j9yd165yx3fr42g")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f
        #:phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0admic1m3s5s2rrhbnwrxi070gqc46f0lfxlkycq1iwyrah7x4kg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ik3m28k738vb3sgjajz4gg9z9qwi0yiyg6203hyvp75gbqg7pcm")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g1djhfs2rpsvw93hq1z5zp4bsdadra0yvacs8w0a9nfxp7vybsf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mamlpq8061cr50wabh2g1zq1nqw4dl9433r3p53a7jcgbzlwdaw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1isfkcmvnmvh4b5bxldz0msz34919kjg1nl3kl6p2phildwqrm6f")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4914")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d7m55xdyaykd06kxapqmxylzhxg0k4jrppqd3021f5pl7hszyjl")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_3565")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16pb8wnanibv2i0i76lzl9am5bf0dhmyla4yqpfaq3hwwz963w0k")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1py55vlplcksgdsn9aafznzz16vhmkwyrx4ci2bpav8k0sbvhzgb")))
   (package
     (name "support")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y82ssrkj5bkdhkwyy8d8bfijjqi2dx0vdxwpvdms3dk5jzzzqd4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14864")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h6bf2k4kil6f5q8x9kg7jx6lf0wp1xqa595bgksh8xgcd2xxk7g")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
