...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "02bma3xhl16mflhczhi8qq212z1pz7ya5crbiazk411k1wynis7m")))
   (package
     (name "collections")
     (version "release_859")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h5d2x41srdq3k0x2k5pzmw54b9h1ynqylh92s10k8kkszzwq9k7")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v5h2ka4b4qnc039pfawvr9brzm73wwnykrjcijan44fh1f5ypp3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z86vhiyk7wc87hls84zs53r6kcns4cin6d33vicnpsq6xy1v3db")))
     (build-system rails-build-system)
     (arguments
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1j9r9agknk7nj4a6w6b933bra54r6y7y43bx14wg6idwj5mf0lpl")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0adjv7s6bx6jkfaz8ycmhxzcxa1wrw6npkg1v6dz90ni4v6cwqhp")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
