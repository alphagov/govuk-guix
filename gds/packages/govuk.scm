...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jdhaq63rg2r5p1qz20qrjkp7a2a2cq1qnyv9ghxma5rp1sifk31")))
   (package
     (name "asset-manager")
     (version "release_376")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h4b1w3kw4816xq2z1f4h0l6yaz1qrmz81pvzgxshz0lkig2025w")))
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0z8xznrsmm9nhgwqkh7wcb67j88nf9ph0bfjmy5vr814c1qbh6bc")))
   (package
     (name "collections")
     (version "release_899")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09kx44xgqfcb5ja49xa03hz3a90hsflwkzayxy6674nl2b5jw95z")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kl1ar5cbi5ynn1sn0k2myld09gn2xd1rwlflkjpgl2ywsjcf7gb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j7l6rjc5dwdhp6qgslk9hsc7iziqaia1zra7v77kay5srbsk6cc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bkz9f2w5h9sl493ic7s4sia4lnl2mv97b4yfv1wdkkkkwapz95r")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "02hji2vhbfzfxdlfligv8w8r7jxpingq34q81f1v9927705v6zdw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0apj5r9942bxk2y043xw70d3070jn3yw9l0nalvw9sdfa83h2smq")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ldp4gx8spr36iizyimapfwwqp7n51a7n7k30r2lkk2p10g1sg6r")))
   (package
     (name "content-store")
     (version "release_873")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j4nw828ianfmsy8ya4bbryaqfp4kd2s0knn46wzjaxggjldmnva")))
     (build-system rails-build-system)
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vwhn2ril57g3mlbsd26fj2agqz79csm7f3sr89j5j8sqnz2gp06")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lx25q265mk2xpmfclxywawhvkjbd3l31rkilxdpva0pnh94rd0r")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qvjavc0pa56g1fzrqzpl727w5hd2lwwxk3vh00jy8v61lkl68g2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "128kgny52x4fqvp8gssxd1fm83l38z76g66znfjjzdwqr85sigwf")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "1a8c3cji69ggl53wm17abl5h7ccg804450z4yg9ndy6hj0ay4cc3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lci080a12233bd5js9iix6yfjdpgaz5dfmra1jnzsvbybz10q39")))
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k9mw6zn9y0073m77pi3j3qmkgxd3k92hnaf5mpmxjfrzgy9lwwl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17z4mg343nilcv1kdxia7fv7n078gx1hd9nva70l1whbnq5pirk0")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "03dwd2a2axzgb1g4q6df2za3yik2xs1j8510r4q206qfd4m2syar")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h48x7k9ix5ng7c3kml7l0hhlp1iqm4j3c2hb2q2rv5v9sh2jqqv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ap0qiyvswx4xgrhlqs7nqwkpzzw4dkrks3c6d4lscsjhncymc43")))
   (package
     (name "imminence")
     (version "release_519")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g0sphm4cpnfvwxc0rgclifv0b9qw5f8is1fqlm8wk6w0nwcsdda")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h399qpg0msmj77k5wkzjfw27pzjnyf4l5lx56z2pg39dmh8dpvw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0agl5gfcb0gqmz96v4f0qshkhy8rmh0qkxd63yc8jrqcyasqvrfa")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "159nslf8kw6a9qiyfh5p4m1j78dknlqjyv2hfd9qm3pls6azwvmc")))
   (package
     (name "search-admin")
     (version "release_261")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15mhk70q5d25ksrjs6521fni4fd2bhk90jyvbiyin7y0nsrbk4qq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xsbdnyfqxls1hkzzkkzgllqgaiv768grw6s98lrgyrl7awa0cgk")))
   (package
     (name "search-api")
     (version "release_2034")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xwshv15f1lwmx3wychbwyd0jlwn90qi5nc8pkw9ww83yklmhq7h")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "02nc61mfh7s1vakkcp6b51cqxg4cc4spjq6v44p63v3j3czafksn")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a1np3sz9fb0hhc3d063wgwmi3g1c46f3vlpw8lpapcx8v6mqj5j")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "12w6ff8agqs948g5rawcfy4khxp5xss897q2zxi0s6w14jivx7cc")))
   (package
     (name "whitehall")
     (version "release_14074")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h2pbnm8f3vq4hb8anvbjlcyq5rz81jsdbfwwwgxq4p0v6vdgskh")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
