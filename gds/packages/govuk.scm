...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s7vyysaw52bpwnm0kpjb027y6lk3mi998ziir1x7vbxjhixc3p5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x0ms675r1cg5x5rd0z56ffz85q9ph7yz1v5lzv0wmsxsz6liv7z")))
     (build-system rails-build-system)
     (arguments
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2442")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "193vlgmyfblz8q48bni4mk8cyn62db9sg789zv63nr00sikkj22d")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l129372m6l4w3i7x11fix5ihjmlg59kk0jhw8qz0vi4zd21i8k0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0iqixhr20bhbn1nja5qfib12crs3icgz1d8hxf6v7f4kkavdrdsf")))
   (package
     (name "whitehall")
     (version "release_14546")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cs8cl1dsv4xwjhicbypq8djbkhmfwa6g9nxwplfaprprxiis1xm")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
