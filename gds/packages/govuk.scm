   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15b4cxynn6vz9ysxkvnclhf9ss0hxgr3ygpgxy0rbkmsadh87l44")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nh49mzsfv0dy58v3m2mc14a8h6nh0w66myfz6mgpc74ah544n8y")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yi67al3xicn5rvm1wms53bhdvljkklijx0hfm64czg3c6qxhdkw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jjcnw5pqmk6gwhfx9w6rzwp68l3xs9pnyiq3ncxcr1c4717aqqg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1ymf36fsq0697g8ahav07x9f04mh0amqdkmj98shz0hba4yanrw6")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xc1nnyzj0k2fgnrchpa72y7hmy42zm84g7dks13wrv3ys86mq1n")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dzl07swq6hwxnxkw2ck5pgakvy9r14yksma32qc01xyjk1ixymz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "12gwqp23s2xx34lsmw061nb01a738q5wx753dxlpzd82hn2w7fyd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0shjvnv4vzjaxpljach21f1b5x5jhggbaqzq610r7i2z7c0shz46")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h1jmc6wawv23fv21dgv0rjmmddm4kazd3p1wzh4aivis3iki3az")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fy0rlj7f467j0h2fii189npagr5k46mmiw3cbac935qg57xfh2i")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "04jazn5z0w6gacqz4law6jsan32yn2rzq6y7y2bklj21cncr7rcv")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cwsisffh6p0cy8ii59zjdhgfs21g5m40ys0kc86mdblvqjjfk21")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0w422p17q35j3hkh9js1njvzfn682jj83j2nzcrhwnc5vaxmx9lc")))
   (package
     (name "static")
     (version "release_2757")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06qki2sdwz0vqpidn7a18cdyqk7yfk9ja9vl3g0pkvgn18lxqglb")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cj5fahcmcm1s5dfjgav28axnl3if9rk9k9w8p2c1i4cb685svw4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "143s67c5cdkr7d8cnyynjhmjqvi72yppp5p1lf4580qx0maz1y0n")))
   (package
     (name "whitehall")
     (version "release_13207")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w4idff8i1a0ybqlz8r4c377djlm9sgrmsbb9bij9ds90vw7kmc2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
