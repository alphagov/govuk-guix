   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s06pkdc05cdakn41a4alx18hivljkfng7kfcl07r054s5my8bvh")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09rk86hcav0pr78ra5a0p3m88jshbajn0279npl8c22p8s5dribk")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12738")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lxkc6y2jlhd3ry9gb3ssrw6yrvggi5fngbr9jijxv9pas55phai")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
