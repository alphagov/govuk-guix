...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ky390cn5h17xvh1nimb78aw1bi0lnx6cqc9wi10ki7arkf6d4an")))
   (package
     (name "content-store")
     (version "release_775")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "121qzzri8ki7xbw2phyd4lv5r6i84xfxkl9wr1c1ais39w75vpkc")))
     (build-system rails-build-system)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0q24yq6fx33v70r15d1dcnfsnsk50rqzqc6dng87xzkq51vbl1rd")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1psgfdskcql3v5ji3p1ygz85j6jki4rw7dw5ib8gnhd7wha9b2ck")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1mq4li17dwvrqmkjfizl6kzw5qpp92kfgj1i77bzcsxqbz895qr2")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sr1i3hijrfkzzhfk5629dxz4b54z29sfmpxyyb3ilv6bprz9qn9")))
   (package
     (name "release")
     (version "release_329")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vm87n774gi1wfg29pm5h3517bvc65faagpb8j9rw9a0crv92h0a")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l7dhnlh6fmcayagkq45kyv2i7mbyyv0247qrgybzql7h04xzk46"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kwxmwilsw6rn1r3sgh3slpmk4nn8f2ghhwh57knbp08c9v4xrga")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4017")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1clchrjrznshgv37sj5g6x9das5c1j106c9awpwyhsh5bhwbpkb7")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13581")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zmz2pfj1d2qy47j1z1vzdis4prcbrdhpkh78xzn4kk2a34073sv")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
