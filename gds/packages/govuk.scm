...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fflvj96405ch1jglbb4avgqmr3p8lw497papllnczay0mn767gq")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09l4lvhmp8v4kwmm41kl0x2p9jxmkjahvnayxh3bwigd42b76x5f")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j2hqb3whr33jh8zids7ppaayrvb3rlm5gpydmcnikcld75jdn1k")))
     (build-system rails-build-system)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hqr0qn66nqwr4f0gw3fpla39x8zzbnsxski9rx2qyp88q8jnn1h")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x7vkyax3zy0mlbr0zm2rs218vbwq58dyiibd1sq03apg35xk0r5")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
