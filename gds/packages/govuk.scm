...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "15hbz55bkbfjpgb4y647h24m53z1z4hfd0lcrcb8hbwpd07xryqf")))
   (package
     (name "collections")
     (version "release_682")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hmp5cywcpwggczl4rjdwc4vb41lw1zzsrwifx9pp8qgwk8wxca3")))
     (build-system rails-build-system)
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h2spp3ha1lby6krgjhmdbiyswcrs57745ibfg4ym19i85nbg93k")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dpnf1wmx37a46hb3nps44skypbnz4mav4bzlh8wjqqqgsdyal8m")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xh1ln6h3kf36jllssqzp88w3prgpwj0cm63y5hh0a8f1f924d4d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "089q127lr0fpqwy28h1c2vrajlilf91hvqgnimyk60w12zj2gn9x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wm8vwj9zlv6gg6pi6w54519f1zsi697fqgqgjl85dd2mjbv2sg3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1748xfz29d8vrvcsvnwllj2ibf8slm0adfbkpvbdkhl23djp9rb9")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bf1hb62hh9ivq9hanm80hqqicn259ni51jyqmg02m7b86gf185j")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i4hp480394ghl74hg72i4d8n0gcysz569z068q0km3qzixhj904")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "123v9d657bmjk91jpzpkd0vpd6y4d9idch5ciqyk675ldvdnrkls")))
     (build-system rails-build-system)
     (arguments
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "164ivy5m0ixf48jwdi3kqgq00ssksskdryg0lm6mz30g68mw1ags")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a7nndww5q3rlpmzai2yjrrm303sp2izdrzzrsv8y5bid5gwrzmd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4066")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bmvv7i9kj2qlb22vqqn7wc03jf0mgy7030aqivam6dcv21v1xj5")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ysxzmqh6kkam2cac7v0b3pjg8f9m51n43737snw6k0l13r1y4gx")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d5jyr08d0xslrn30jjcd86685pqrbm8sbzivn13jzpz9p99g2n9")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "07h44ab9gfphqbkgflz0f5qvw0vngi4q4d68ycawibcr7477mb39")))
   (package
     (name "whitehall")
     (version "release_13671")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05s7nb0f9rxnmm451y9c41wa0jr8kl1i5frkzfn3b1m9z885p93d")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
