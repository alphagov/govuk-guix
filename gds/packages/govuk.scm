   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03yxcrynv9a9iqzbljk21v9ak4jpkp91msq8yvlz5zkfvwr7bkw4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m0nvbkhsvawssf4lciqr9yivwfdnbryvf27iva8cckzvmzd4lhw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13785")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fan02azbfmy6393likbncb7m0lc2mrva886valsr25nk291hc2v")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
