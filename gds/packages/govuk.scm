...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4395")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mhbj8d6ci2s5dbclafbb8lk3gq1z39gd7i3f2a2bxn45kagjz08")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14154")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q3b8ybadhpbn629a4khhfhxb74v544923s97l4a4whrm8bcsq04")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
