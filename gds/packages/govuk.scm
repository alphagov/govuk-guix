...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xg13vrp0dghxjhv9x1hbfac0q3vkl3midynjndm9v0v06s95zm7")))
   (package
     (name "collections")
     (version "release_939")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hksxz3g7yy7gcn4zajk78chgmawldxhjrqshi1c2xb2iiy8dwfz")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yzjgar895dbfyv8gzxfvcf3wa6d2g85b8211d8prsbikmxzw8km")))
   (package
     (name "whitehall")
     (version "release_14153")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04wjw0jx0w38yxba7v2hyixmzn2wsgjfdflhw9xfjrmn360pl77g")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
