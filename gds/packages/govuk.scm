   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wxf2ig3m27avv309pgzxv691d1a90y4y992bbzwdbldi8x4kd0a")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "02yk47rni0fv7g490cmrnvpfyf86x3m8wklm7gykrmnrq1y0sdp2")))
   (package
     (name "smart-answers")
     (version "release_4096")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11f9waaiylvmq3hijj8jlm6cq84w33a1y2jh8h54hkp73izcggp3")))
     (build-system rails-build-system)
