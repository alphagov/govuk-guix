...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dayai7vhcjgyplamlic60kfhkhrrwadxavx6rgypq252q298cqw")))
   (package
     (name "calculators")
     (version "release_287")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cm5hnqswbprb6vrs0909s065xki33nwyfa7rymmjjxjn5qgck0p")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "047l9nd6mmdf4nnvghiffazzbb740ccig4j08w46pypgz6y3ny46")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yykniaxs51dv9qkcsgax5afgdin3n4cikyd8hd9abq37x8i9pw7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "052d4kqzbs0n1vc6zkrbaphwra8x2czgf7kmigp8jbwzcf40y343")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17g76isfidgnsf07cqqsj08yr53xig0g6vd6hd12d91acr3wdzka")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
