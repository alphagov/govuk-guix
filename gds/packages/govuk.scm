   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ns8280a33ig02cb1j76zz1kg8517bs8wb1p417d9537rqn8b0rz")))
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sppnq9i9gqm9prrr6032w6zv2v8x6nv8lnyzdjib1dxg7zk1rrd")))
   (package
     (name "collections")
     (version "release_443")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fab1sf8mbshkgdqj4hg38smbfc9pncnxx9dpmm0ar8sbhvgpr8x")))
     (build-system rails-build-system)
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qkgqmhv02mbx8higc6y2pd06m3k2102b18mhin25zfvxnikb0fy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xq2v34kvnypzkpf1vyhli76733g3rx0vk807yf0dlpvs6rb7cys")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lb806b5ivibq5j26w1xxbsgvcsn6bcd7zp3cld74zdls9l5v9xv")))
   (package
     (name "content-tagger")
     (version "release_694")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ilw43pf366gcy92k5aws0zr54yc5rwnzqw8y18qf8l38pv353v7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f3afqwbagy6z9nwmgk4s2s94ldckx3kfpdamdm39bpjs6y0mfp0")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nkjbpnlhhcmivy0qc1p73l6bamq49naw5n22s1vgnak9k7d117x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hxablmfn3sjkdqkfpwpm239znfcw5gj5wr9gb7y0s7ch4j6iy78")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3853")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kn5g2ppdj60039r9yb3r5yj4dpm6cp6j7yaqdhl3hlq5x9kn85b")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wfhgz2yrddq159bdxagz74gwvbj793zxilc9injzbbp6xhmc6xk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11j1508n19b57f135qxjahnbw1ayx3shas3dvv46axdfffqn1ipp")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mf1sr58rb86vjh15jkqrsy9bvlf3mgqlzj8dfvpmh18wvp16k97")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ybbp4wrc2ld7vik7ysryyqlpxsk8am7szxzgsqzvkazg705vvgl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0r3rrkdwifryhlsvrxni2cn7pvlb8k9kygqslrzc8bva6i2rlv5d")))
   (package
     (name "whitehall")
     (version "release_13261")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dsjica8jaxwmrkdmpkqjyd4fnbfls9bmgb7zny0wywg8vcr1cy8")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
