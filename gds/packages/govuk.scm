   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h95yggk10mpg32sl0ak9rnrv1x0rnvqwzfww54vkjh9l64h9ya4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18qjych033j6wynblgf0w5sz3nyqpfcvkaw06hpxkcmaq216z9im")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rxmj2dxs59iwy0f4amihx25fpnd54zvv1b6phfd06iwz64xs57l")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04snsvbp1a95cizvihnxksr1p5fvsd2y9gycjgd9625wrvdr0hmc")))
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0b2bhm4iwvcgkmzg3l97zzsk2wzh7y6mciv9q821z6zpinhn03qp")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13jbcgw1s2jybrxvrzjq8rg8scarml4f7v4807gf9svgv8ghr97l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0926xgqw7yisncfg7cnfrjgrsj2s3yjkrnpq1ks5h7wxm9ijn03a")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bi3zkqxil9kwidjxsni3lwaq98f6dl9wqgh51xlzh21kbqspdk8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3759")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h8wg3ck381fa56k9wkpkdlwak7g4ic7nwdygl45g2hm3qsi4pzp")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
