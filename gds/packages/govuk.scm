   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0skdbsa89f7b426kdqljn06sa2jajaa6m0fmmvq7cj4pjyjnx0dl")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bp24igpcd9b837zk9cq48z26hnbqkjh8xl0x1b17pvc6y92f597")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wwngw0xnghaaklvbx3355d34094z9r3v5946kg0l5c59p6cxj3q")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g715gfippimn7ncrxza9v55dnxbinlzn1i5qymbrr3mqfrdwb4y")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qch6glmrz30a99kyi6zjl636c517y20s18ijcbkg1h662nkp487")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vbvyyjc1hqgxq0aklqcqiy2kasm4yx2ybh5k9rrv6rlcjdk9jlm")))
   (package
     (name "info-frontend")
     (version "release_329")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jl3gic0fb3n13cjck1zy222q374z6dxmkdqg6nrxwljpfbxalsb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0spnxnrrxp0s3kw6i165fgkac75mazmk96vwvsbii0kwxq63d0h3")))
   (package
     (name "licence-finder")
     (version "release_559")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1669hsrynqnc94d6lav84saf4jdjgrivrg21yj4srxmldwpgywyc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1z5rc1bzq4hzf8dr1ls9ig8rz9gpbppvjc2k5khc4324yrgn6lwv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19lip434g900299hl0mm2z345p394b7dnkzpc01490lzyyj6v2jq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
