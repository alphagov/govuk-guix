   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a53c02870wz2k2m4hhz5pnzb4p8al6iaavwa58m9idcrilsqs5r")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1blipgnp0nkcixxwa4kj7ajf91ggh6f4cg3bhs65lf3j098kbd9g")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mqwspywa4sz8l9gv58mxzjxmjjvsa4hfqy94547rs58x5n7l6bj")))
     (build-system rails-build-system)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2730")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mcqxh0kcjr4f8ffbxw1hs6r6n7mhdff6dvdc51d5zgnmlw9jg1a")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3745")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "144ndg741vyz0y6c1izj5z1hzidishrx0g9s459jfhxrnx0iqc2k")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2676")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jv9kxisqmx3z52ym3vv8fnnjpw78sz76mad7331fw9p29n6zffd")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13003")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dgnhwb57bhnc7hbfmryz7ialpfxch0fan2bcsy9xa3p391d9yjz")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
