   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hqv4283a80fa7307xvyvgyaxz2lcj5wz1vcfn5dy1klrpcc16hg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0rma20vrcwrxcza0idspi26xafpmp1c426swv2mbs957w9n849d0")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12937")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m6fs8l4xggmcsmwfam7q37qlcpcss63lz2dq08z9qz6salvy56y")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
