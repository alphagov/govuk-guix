   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i3s34vawjqizj1vf6s9m9shjmbp1iqj51qh8nnyjnipfmbfpv99")))
     (build-system rails-build-system)
     (arguments
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sy815hsidmic7m73jib3mvqdb2ibmvg6hvdaz14qjh7xis6vwn7")))
   (package
     (name "publisher")
     (version "release_2330")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1848hjiainvm93jvvi1k3z2cbsj6dbsvf8glblkf82w2zikmnkqq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
