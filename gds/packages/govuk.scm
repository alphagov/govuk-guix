...
(define-public authenticating-proxy
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g1k4jn9skpfh7g4qpj998lr4a2bvz6585xg98i0gzyv1pwjcjla")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11hvsx0zqv8nffdchlksswvc878d8ns815pjmhy40c1qm4m97vsv")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "09dh54b27i6h9iincshnj9g2133l2fr953h8n9n7xrq2vc06m1c3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "114fwkkvmfs41gy3lz1wgdlb9mp9b2s18g845jdgq1bid8didisa")))
     (build-system rails-build-system)
     (arguments
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "03nh9m5pzk29fd3fbip0pxdw5a8p8hjxx9xvmxksrv008i1zgirl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07f1vqk933dcss9ryw6ppkqv6x028fpnyy5mrxpdvqig75zppanc")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1d9n9wq3vxddfdl5cya845f75i1yvjxxjlnh6jqd7rdfx3vi9gd5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ssbydr1ippkxv3qv1i2fmf6lpwlf2fzbkbc3xmi1gm8cmbq3zrn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
