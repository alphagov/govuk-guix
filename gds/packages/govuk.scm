...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d9fnj9zqxi1awmvadrdsmqlljr8k185fy90qn82bv7nbw2vb0fi")))
   (package
     (name "calendars")
     (version "release_675")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hxln417m1rjn2bm6f8vqyp1y96n1p43mcqmrnsbs1w5zfzdb0lf")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a6757qspmmd33ymap3hd8sz78mjldvj5af3s58fac88266cc1wm")))
   (package
     (name "collections")
     (version "release_814")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rhhfn3qm7q7rqq2864v99y7fsnbsam98rfxlmnf54yl1r125g3l")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07zfdxy81pxd4z3fgph038fh5cr51i63qd9mkvjl6xahmi28jw7y")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "186568vfmvx66i34la38g5miw3pgxc0rh3g9wpnz6zwnh6dg8z5p")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r1xf9gyrh993g3mf1fbg56fi6ryv4mcg9nnrrrjxs0k70w3yl2z")))
     (build-system rails-build-system)
     (arguments
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qcm2xmh9swh4gp6lsw2jyyrwvwjh74m322hb5qp2wklq0w5dfrf")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11nyhbwfvl6y5r02k40b8i5m6al3ws5a5qh8dmprnsxjxxhd2swb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1imwm0r56h8qydw3kplsqqna7pkib05dzjyr3sssglnffjgawzyy")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1gg7dvxy3lbdl2hlh2k9qrhbsi5ngxb781l18k64qpka6f4456jn")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4222")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0044yslyadw08ifx158phx706rpnbb6svq5knkn20b2xis38q5cz")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13931")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ik7z8vx741plb4saqy60iclisdhvlr2n13ya8bg0zqf3mv4biv2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
