...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h7h5c112i9dcg4wijbfwcx4kh1k678c4i4d4ppqk0pc4wqwhdqq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k2ppj3zjgc4j6dmagw6ddx6bhi6491cm27sjmi7d3z3hpnmwq2y")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s4gpk6r36n06ad4q42czgs8dyb04irns3m1wh7z2i455w9a87fp")))
   (package
     (name "smart-answers")
     (version "release_4666")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12ji5qazjcrqr3z00rslzapvmhm5pqqjiw71c8nwpnvfzl73gz3q")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "031213d24c45h996if43yjx9wx8rq7vpnm1zw4d7kvh7rz5xdnvr")))
   (package
     (name "whitehall")
     (version "release_14690")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15v5k25kfks9mi142k0nj0mhy9kvvhackf7q4x1lyld32ma3b537")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
