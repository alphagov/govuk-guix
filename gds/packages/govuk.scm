...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bcicyzkw3s163a6hg3x18szpn345xa3kwrnaqn3ny9xrhw6kyg3")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1caixy2wpxz2dravy8m2q7j3gjvfzszcx5wzqckm6x7m7xyf13yc")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x10lvzgdx08dywxb4jfy8lq8x1nksxyf389l97pnkbaap3sc2pr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rv7llvhpjfqn0f10ymhvl21rp3rknn3q00mxfx24q5fbqmn237d")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fgvgjlwcj0xzgzdbbmrwxlc3dgzfl18b8vdpipjvjxq7fn26zxl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rp4v8zj7c56d92arg1xjppac6yzqldycs7a7848qd30ff5pz0mm")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "13hfg0gwlxdns8fvzxsaf5s0hdx774dz692da5bhfxcj3rb342qn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qka6090v95gpfm4cqa8fk8ry8kf7c34fx915715gnvfkc4l0fm1")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vjkmcngya3ap7a6awppyb7r81wdvqrayh3qymml8xpd0r50jdv9")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m4ypipxml2imrqsmcsmsj5v6k6b4x1wa68dwwdhspxwrds815n2")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kjiacq2si3ac06zsnq31inmkbx5vg0l1z3divfz39p31ksarj5i")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jvb8si6fd7izrwnpbw4gsb6m28wsjd48wlrnzwydjcjslbga48a")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "055p1m7sn57kkw91i7572qq80xz18b4kics12a5xf16zgp3azppq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0m94047dlanbwh65n5n4dxbh9w1vh3pd0w1ap8030xbvxcwnakqy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06pgqfrjmxznsyqyi82rjjv7wapzrgxvbx5ryyz213xvw2z55016")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "1z7in3aisv69jsgzylizdxadiqz8y5zd68iran360412a33z96b2")))
   (package
     (name "imminence")
     (version "release_648")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08g6a3zby0h1yr44a34nlymf8gx9sqbgbc1l5wm80dsz1ahz8rv4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1iliw30xln4jln9b3y92f1lnziy6jp7339zjak2y8snakxwbx6q8")))
   (package
     (name "info-frontend")
     (version "release_531")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02dd135ndjrq0qsq7cr8n95p5pci3hy57vscd8hxz0ipmaqnjs3g")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public link-checker-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "00vm5fnvb2bpwfvbh3mx0qivh4hch4h1x4l6nzs5dk8cd9n9cz92")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mcryq4lm5a17y8a3pd3pmsvrr4d892qcdqmqgqiaqcky0hpa27g")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f))
     (synopsis "")
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bkizxbwbr9jfxxzm1sv266xhlq1rzb93wvqxdmsjska9x99li16")))
   (package
     (name "search-admin")
     (version "release_401")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nvydkqmrvzni6d7fz7anqkgc2gp4mswb3rdn0a9fj6sjb8vwxss")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "19higyh7pbqwdvwbsyp5kr8930nl1ss6jhx852dlwx2d1n09241s")))
   (package
     (name "search-api")
     (version "release_2558")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a7wc80yv7zkg6y1apy0nppa47j78kxj7d0hvwni9lbvam407a90")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cl82v2820mgsgdv7syxp49n7na0szn6rqjzfjkmxkvj8f3960qq")))
   (package
     (name "smart-answers")
     (version "release_4801")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "196sh79q4cbsgjv3lmcnb8imrxzwba4ghffkn2hndz6s199vcsyv")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fvz3nzislr6gzyi8qh5ixdz5r73h0hs7apra6jrmg5liyr67236")))
   (package
     (name "whitehall")
     (version "release_14812")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lqjivdkf3l4id10mzrg4laxvi44x41wamwdczz2lirv6jp9i8kr")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
