...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hz62ayyshwwrpp9xa6j1ff74ndk9av1kpqlnzax3vlnn75cl8l1")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17mrw9plcspx915szwn8cvndcvy8gm24xzn9x7wwhzb2wswcakb1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13971")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q649ccc7v9dx3yypwn72jxhkg8sjrvdw3c0w41mkjh39akl5aax")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
