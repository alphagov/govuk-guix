   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ha7i6anbhdmkcypy1n9dp7ql6g560fjyl25vrb4vyhqab9zkrw6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rz4nxsg479j7xvmjw7dpkys78574avgzfg0iwwpkciwigsyhixn")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b7mcbsyzl3a4ngn5q9ans6mjly68bw1dwzcnrqq0w30644fwjzh")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "18fqbfccyz0wyzwfwsqcwdnx9zpwyx3v6m4id940gnbvs7yd109c")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j7xnmly2s0wga3d9q1515cw5lm2f81147zxp23j99d0nzwx43wi")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
