...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dzp7ssxpn3iqa33j97apqjix5nj1blc4mh16h8ziyz46il5ncql")))
   (package
     (name "collections")
     (version "release_414")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15y463v90ni2lk0v19591q52cbig6zzhmfy610hlcj0hqkk296a3")))
     (build-system rails-build-system)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q296zk7z77hcrljj0rdv2m3hmh91v2yis9r290q2665jmzfac11")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mci4d9mwi7myf5qi3yh3fmnvlpk7qfvm3gdbmhpf2fql7ixp8v4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "02sglzfm1krl6d95sd0lfscz4cl7hkpn16wgkv8zhhqygiaf119d")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x4k3c7a7y5cwmjcqx9w18ppvybmw4mklk4pjkb3liqbrgz89xqn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g8f64zl886s4jbnd83xmv5waw01dq9vmkjclmd4cpp827kn82n2")))
   (package
     (name "info-frontend")
     (version "release_88")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1575m7k3wyiz662wh0qsyhb7p44q1wikr8gfw2vfs00k973xxbcl")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "02j9s7qdkbbx46aw0mdxc6m6px1j76hcjildmldgvv47rc3pfqif")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
