...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "03jhp59m3ab6iqy7xk0g09w3w8lb681d4m969xai9h7268g977af")))
   (package
     (name "content-tagger")
     (version "release_656")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ipfyxg3k6mjixczy64wqv06ijbll3930pb74vrbamfmaab00s31")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bfqjp2dqajyvxmdlyb58mpdwvgfka76lpgg64i2in0kw0ca52im")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11wvls37k8bajg0r6hf945qhpm5dgc0d4by28i5f3sr9fi5zbsfz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public policy-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "15aa8k49kfrzj1kbj2li1kj7z9afdjfzzpbp6gsrx1jby19wh40l")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lakv35228fhja9p54ylyb4kaz9a36d0278ahl6yz0y9s2z77hcj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j469m0mxh5n4c31m8xbvgzyrhs2kz5rqvhx335lfy2rxf4zva4m")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0agmi0dznqqz5l21gilgfvm6rllvn8s9l1ql0k0x34k3imzzr9hn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dkydv95fk4sb1764p7hphyf5waw4yzd5sm7z6nmb1p2sw5b9lwg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l3554kqb58i9nw6jsrk59bxsxpsfqgm2ibr0s7wac66m0fqc6fj")))
   (package
     (name "transition")
     (version "release_820")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a7311anpkfvcw7ac44ag7zz30zhhdmjxcj54lhgmgw1xh010rsw")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
