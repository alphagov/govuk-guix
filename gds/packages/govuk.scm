   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i9fawfaw7wjryg9sdzhrcmq19hiar32j067wd533cv9fb8f98rr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wlfnxc6ys75ass2bkmr2y5vn9hwfn9kgpjmva98r1xj794sxik8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13763")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qszvbmdkgjx1gaf5phnfhzhbcl3bxk3yin1lw6n6grxf9wzcpkl")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
