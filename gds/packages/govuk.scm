...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "126pnmzpm70y0h30w2q8fr45bw7lnaflqii00nl8vpks3zk8gn6l")))
   (package
     (name "calendars")
     (version "release_676")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d1iajklg3sx5dcyfsqc78z2jqrgm9i9d1s6k4ldgkj229vf67fc")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cc4gnlyxbk29m2p4rg5s5srljxcksd49njg37kkmcrf9agm859m")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19n29d328lfmh6ymjhkjlkvd6mxwrddzjb3wi68z3d08mc8pr7f7")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p48w7nhbn8515liy3jhaq1ai6i1bf4sb4pgmvhssyslh7jfdjiv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lqjcgvwl2gmyqij2m2fbfazr07g2p9vy3hsdgr3kmlzda63qg90")))
     (build-system rails-build-system)
     (arguments
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "070c5cx5j2n6y7g0q61mi1lfyg9gdmr12vdjqydn62vq05y1jraj")))
   (package
     (name "feedback")
     (version "release_605")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qhi8g1na42fawa6qb1ndhx11ifvsnfj008d1169ifbisy6kr3d7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l9sv11dykja5yiadsrs97rn0w3niydkm3244g2g5ircdly8l8gc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sj25z8x8caj06r4gszv2cxpwwra6r4mckr32qiabvvipmcrkh84")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rr956gcgwqn8acpfaf25yabwc9v7282s9yalg1mg49kwh8bf10b")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1z9qy74n48k5mwfga8215qdqxjf5lp1z5cqvf2skcqcfl5fskprg")))
   (package
     (name "info-frontend")
     (version "release_301")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "072prk1dllqhkb2mr002p0c7zk980v5ba754war344na0rby3pfl")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0afm8jml5c3y9f7nd07n1yvjjlxpr2fvypd39vk92b3zz8yy7i83")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1212x3z1bk68qpf6y01fidb6kzkd69icwjqr2bp86f14nk6p62h7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gn3hmpgrsmpwnzim5ww5hhgwjsyxrzbc41q9ir8rn9jv0hfm8np")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1yf6n4ynjnn1s545vyasby1jxgnf4p2m2r3kbmwfinq3bzldqdi3")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vi80zgw2klma0nb6gf7xjhq492ijikf6ldz9i003r9y06wgakm1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "083k5zffvpkj0jjsg0qy5vv9a1m9z6j16dh895ns38kj7dsxv1g6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p2fch61k3h7q5nss904q94nwf4f9zcfghrj19pkr3aywifmh7k3"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z6pb1qygyyjdyz1fvxzi1alr7vsh09q7wwy2xc99impi2b7p2bj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "139y5gk5y74yr8209kf6izfjxixpgz10k2c3d66mgpq1m7qsys3z")))
   (package
     (name "smart-answers")
     (version "release_4223")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yr1k07lkgppv9lwwmr43gr02s9hcd3dl9386n4gayc05s8hl4p8")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0w5r75cfy6aniycyfhfh70sl5ncjw9wrv0944vyd4hpj7v977zqc")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rrfklicb0r2504x3mi7mfx6d5y98d3xjavzlh2ilkl1v8jn84py")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jpxbgpwz6pl175xvp2k5p0h5rzgqz8srlm4ln0ici25r3d6klkn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l2026qnfazxx74w9sp608cq3gzgnldkfy71rcfzqj5dr5wfc975")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13932")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n9x3hvclhbc2k4wrj2ck30hnpwniwh10lx1qwv4lh69iznyr4sc")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
