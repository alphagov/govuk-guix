   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1abyrxbj52qzwrz286xwvmbpp1r7l5hijq17rx3i85wl3j7qbnvg")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g0lgcmh0shjpb2lqkkrv4wddsr9r79a6qccrc90zmqisvgvskba")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "055v2x1hi2i8j6qn9q344dp6pyakif99pvqhkgj85jhjv6lzpkii")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1pdi6npqkmas77rhh9w7qhkvjaf226z5290l86wi3jkd4bkvl6cg")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1msl5bfm22y827qjd5smgzmn0gmrdk0xvwcra8fb9q25ggcfhcv7")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01r88bli5n8pfh4i23ay4637p547nmcvl43bhmi34ig6c32dvlns")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13158")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h7jkrrxy9w9ngdvyayafq9ac87rlhlcsgiiypdc8bgqca702gxh")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
