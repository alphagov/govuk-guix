   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cs0xpbmky6hbkz441i4j28wcbxyg3www6vmwbhcjzixsrygyw0m")))
     (build-system rails-build-system)
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "139z0npb6s0zx0nrmx28r91yz9z14whbrk00pr4cd0q50gw727xd")))
   (package
     (name "content-tagger")
     (version "release_407")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04fpx5h8a8sxngs99c80vhcqkmfpmrfpxd2z374l1k22sylfy959")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h3bdz1mpifnl3rmm4fyqsdz2l0m8iiqhwx4rq18wrjarv3lzayb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mv3db9xiqd5fxyb9903sc21s1l720nigykwpq2d7j0xbs5q86da")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xziph6snlx0v3lksg7pya7b3if2s2lkqd8kk753qd7k8wsl2ika")))
   (package
     (name "static")
     (version "release_2573")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zmf7bj6vdv4kdfh35bn3h4fdd9dfj70f10lwdxy4ia5mrnhbkh2")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lh8lqagix1y2vap3s5dslw9cgxcnbla1fx2kc2l38njdgg8wx8s")))
   (package
     (name "whitehall")
     (version "release_12756")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b5gqnipg82l1izack0i901siyy7bm2asb9fqaf67x0vfa6qql2b")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
