   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h8vksa2g1x8ki8r2z6271skmmvc6cm2qshncmrm0achsa6hvgvn")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y97abvdriqpzh2gfpaaiz43lw17wyi5xvlklyqzhpvhrz51hhcc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0imh7b7xdaip4jyw0jcd5yl73zm3zh4x51nv70w7ss8hjd2g4gw6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13799")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gy1mdvs3k0k8ya0i6z3cnvpn0zq9h1n2b0zprzab5v2j5vi3jjp")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
