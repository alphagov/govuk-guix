...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r3d3n14yck0z853b4fdpzjixq04crqxlkwk69l45jv7spmyg95g")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jbx1w6x9v03m0ynj3dh1nn5dl3137gvlr2dxq99czxhyk4sw926")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cr1jwx911fk7bcczl45jbss2nk9g05ym2knrl32k2dbvvjhg97d")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "00rdisycfzkkrkma4kvwy243dnsahrhfmaw90k1xkpxnv47i5xgj")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
