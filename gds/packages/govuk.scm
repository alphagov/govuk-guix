   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00r30kv77va4ypcyk15bncpnbnwid42zli7cycb5wn4yrf2i5a6f")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0igvnmh2g7kcy5na59l4sa5jnf8b6hs25dylvnilcm3dg9bkzsc5")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14496")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j3ax31hdiibyfqc0n3k8hzg1hqyc688sc8q63hsr6brkv4n78xf")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
