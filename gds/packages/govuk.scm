   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c2can05ldjdn4zl0wab13blfv8226jm4rn60cc5y26nrjsqk6sc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gvpqdb549hg18ybbp3d4saps9rv9a3myg24rifdj0hx78s4659l")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02nx9i2yc30x8cyrxglhkznjdms10z8c23qq72ji483jx6hg3a2l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0jjrl2p6pbm2g5kc56q0qd9lgp1b54nqbwjvv64ffplp68hkyrix")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xmq1dvjp37jl70wixyjijakm3j6p328p8k23765lzr6ig50qaby")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13116")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02ijx14xkzjw7v1757wlks4ah9h9ncrix77242y6xp4b30prx2yi")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
