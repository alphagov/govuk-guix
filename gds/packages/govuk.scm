...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3647")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ynypabjx80n428hxfbbdhcily5d9079090208kkjjfiy1fhffx7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "04hxv3mb7shnsmix640sfj4bll8lp6rcfk3zsir1qrjipq8w8068")))
   (package
     (name "release")
     (version "release_674")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05hqni5rzk531p62yal16m5cn5h3zfig15cnayjhl9p5zfywag8c")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
