...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ghmhbpbqw5i1jcaxxza2laijwqvszxvdnd53a4hdfdgykg2vnb9")))
   (package
     (name "collections")
     (version "release_341")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f271zqw2mv7s1zddw1dgyz4n3nppzfhc9f2ljaaz7mh9xlf8gd1")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11i8v1r68lsrgx81vap58i40rbir7r16hffw9fck3z4rvbrz7jrc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08dwpm9f7rlqlaa92brhz7kw011x10zvs325r62d3wrzmpzpcp19")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1nbj9iw70ss373j10jb7zz4v1nsi45jc5dqkwz6fbr8rrdhb9i55")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06rkg3qz1lrs8gx6lx84qiip74hkl7hjyvcnr1dpvcqhlslkm5qq")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z08x8lazyjrl312alf9w7b9h6m88j4rfz4459lwy166s2cq7nd2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2608")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vavvillvl0jc17lafnq7k06ldapifj9y4m1hr7fqb27dyn2j45f")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12857")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hbd8ylf2fh6z5z4pm2msyl3fxm474pz4xgryr8575xpskp1s0ql")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
