   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01ym31k92m1irfgmsx4nxw2h95336ayi9xibxwndhx6vc4czrdyp")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0szglr8pjdxmnagh4jd514ibjdavvhfyy9c1f9q261rrc2qpapxk")))
     (build-system rails-build-system)
     (arguments
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1nxyy5rm47fd37xxnfbc9xma4gkljw650qnb81qgx9bvh20f05sg")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_5016")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wvrqsj3vfarqnpi5s3w2zvby4g9dj0p0cafyh461jxzmf3gz2k6")))
     (build-system rails-build-system)
