   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dq5nsqhpld8m94w1m1rlfwwgjpqqm5ri5fy07l545c914jjydnb")))
     (build-system rails-build-system)
     (arguments
...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wiwpypnqiy4yb2sk70lbb7vfkfrm60vr3qxnqynnxqklgvpfqvi")))
   (package
     (name "calculators")
     (version "release_565")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b9y63alk5f38qx95kxbx87cvgrn5zabn6ksg2qkfh3yqr0hhfig")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "00xqa8hgxryaw8gd54jlc5ikgdpxx52mvqvgnbn6y78a3li513pj")))
   (package
     (name "calendars")
     (version "release_803")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nl0g7d18bqh5n71pbagxkiy6kwl4ln9qcx0i8rn16nx0lkpzbab")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "17cyny757rf6zcrbkn7px4d7xwadwkc2yw6c8v515xxr0mbkl3nx")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kiyn7i8hdg8scjvpxbwsaabha8r0jqqk87bydya9vwz7ykvvic5")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hb588d7y9qffb1q7i1lcasgw30rcsr2jc4r221zcl856wgna9kf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j352wiqrwznccz7jwliibgq85nzpjqls3a8cg052rxr9addqvym")))
   (package
     (name "contacts-admin")
     (version "release_635")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0456bg2l8lya1ay2p3hf5gfxri28b317djxbrqzsyjzxsbsff26c")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "1msjh6r6axc9g89k9jiynlf94q74mlg92ds4fm7k42fhjp64bb8p")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13aww40xm229rch9zv2cb0mbrhmfiaflwgaxgmh8g6cynpc449ll")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a5yyjffqbvz1092j954hyygb3lmcbpggy4cvgirc5xc74ycgcfg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r7h1w35240q8rrk18sd0l4pzv9j0p7dsb309fc334csf47gsihx")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x0ydlkc98mm5ix841ily5xjxjbviy9xqnqjalzql1jhrpypf36m")))
   (package
     (name "content-tagger")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m9ycd93fxjax5iz87ijq1zn7asqa6rf61g51mnwk3kx8833wbyc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gwpyf356qjywsks052m6rs5aq8fpfv7kmbyg4xg6n1dq9kwcy66")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14n0ilihppjzhg90r8y1g7wr2rm7863pkv3ra67qf3y6paljz73b")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "11smc931mjh2xmpv3zpfmxw751lgjmb21wv6a9rf0ap1k0jbv3v2")))
   (package
     (name "feedback")
     (version "release_755")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rv54pygpf4wpnh0y4r99l1nx2xhpy418l1v4gp2mxfla2a6qx3w")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0skbrvmakvxaj5k6818lvcg7ygkkqks07nw9gnrp5v3lv3jrcr6h")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0br2p13nzyr1k5anzh2i8kc2vk1g01rxa7y022fzzb9992vw9v1n")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xq23gdr3ka1p64ynsnrlc115rshpii1690vzh99fplavxxlwpk4")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lmfdq8m1jy3smmn2h9d0wzfzp1qpb6mawgfzl6hms446z8f7yrs")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q38l95kki5mbz4yyhhpwb3igl6r5dbpmffsr8vx201m9r5rzn66")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n8yn0090fddb3c4rj5dmyf154j8rrivzzl6qjcnv1il97ywdn8i")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "00yiiysv2q1wafsci6dnl8bc440xfb86i7mz9sz4sd2m003c361b")))
   (package
     (name "licence-finder")
     (version "release_652")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fs5y4cl8fsf7h91x3zjkjc2w25c2adiqrafhmr3vj4p6ihd0gp8")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1amjhyfcb6yfpy8rz2vxz8sjkmjl2n2qf1kd73wpk07sfrs170ip")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xf7nhbypw1x1jkdl91r58wwfla5qym7di5vpzkmwcnq8m7js11h")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dvprkm66c4mmshjx68csiaian7kmd5y0jvg3wj8m4frsgnc7ccz")))
   (package
     (name "search-api")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v5j9qj6rsskcidlg4a6j26rsrq53779dgxlxbn76npbynwi8wgc")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "04krhx6wqbdi1b8dkrx6w0jq26sjdlrnydmpanrvl98d1b5zcbmd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02p6ql38v0ifzfzhhb384jsdg24dn7whdxx2m6m3phbydn9r3mk5")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4479")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p4p8bqlyh6yv3p8743ixv82p5qrrfpsyiy7xbggrhkafix4ivgz")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_3279")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cslr98zyaw59g9x25zd33alb3vnkhp0fz4bfrvnznvamnvqj3mr")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "135m6lyfg1rglh8f3pgdzx75jhmanh4h5pbpg4n29qrs9rw79sj8")))
   (package
     (name "support")
     (version "release_898")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lrkymx2f54wwllbzncnvyr13ri0w1a5n7ycvwx9q0zhv6knbagd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1w41wrfhf9idgfm7jfib16qhf34fykg03rwjs3z40f45knc6s7x2")))
   (package
     (name "transition")
     (version "release_997")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rg5y8a5xhcb9n3ijlw7n616msz36hmisn4ad32951a9rnbrxrc7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14301")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dbh5hal4pcdnjry6sgd5kqm7gj21y7rmzchf9xfsc99j2f45v0d")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
