   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lw1w32lrblh5wpdm2vmza5w4sq43ib5wr7jx8gk1x1yanlqb9li")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bhvpx2ga032ikvjri01212k5sgbgyi4c18i20dnn6d6xwamd4ap")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15izz1dk809sc8bixnzas9g5qjz23fgmm9f6hdc5h99x51rw26rk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12xcwg9njivdcrkhca41ywriqgvdjd8rdy1hx7j8zm2p0dy41kbn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f3knjlvw6052b3yvbdx1c1rq5x1zidw55vsr1zw3wj57mfjq7bm")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13410")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "052mzqc8qfpll65ib65lyhv30cf0imwsb258f5zsw6xhnj64vziq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
