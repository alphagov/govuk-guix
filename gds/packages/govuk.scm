...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "15rhw9gshda4699f7mc8bin35drr9f8db3s95a7n19xdh3i66n6g")))
   (package
     (name "calendars")
     (version "release_896")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mf052haf8qih9waqwz2g98hw8ah7wqnblc9ly4wbhvg899ix45m")))
     (build-system rails-build-system)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0la67jk3zmbkvi45hp6pknimn718ranabaj4r8klxcnrqjp5lca5")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w0vwqvrf17jv4j4rp5w5a5qanpszzxdglsmzlmzsa9i4pr9ayrp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l3yg6sg1002pp0pv4fm639m0ymjdzwh2zlqn4q0m256yk1a7bfl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0aai36750rxpzmxli52s0bsirz6ykyjrbw1gz10bnrl8m4gxagry")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ljc03nnanh7z3km2h330svwn6nv1plrqv97a2p61f1ndqjxv1v6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06xn3c1yfpd8mzhz2scnkpp66iadkdgyri4b4414xl3y2z6q7f7d")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15ia86a0skdnjcbpfzl77y7micjk644pjvpmiwcv6byhf32qf5b7")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
