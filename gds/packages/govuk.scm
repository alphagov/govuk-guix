   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v1lkx6223l5bwz7gbk349plqkd88lyr37c87y9nndz7cxqqk5ni")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sn47jwazvbkwj6nfdjkbp53p40va30ag6mxbqrm0znxz6x8sy0n")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4890")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j76bw2qa6i0xplrg6jd232nzrqpkh2rg8rzzy41sqlq53wiqhx4")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14856")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k2x5wrlscy5xhjy7f4wymw1mrylzv70dk4fvspg7i06bzy8xh6p")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
