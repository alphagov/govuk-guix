...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1d9jhxxnix108ragbis9rcw2avsj4q2hvwmpjqkg33280ng68nlm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rlbs9w43h1k73wjkh20va0dxs26sy8k38sbwa1ihlsxhqq3vh74")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1w4jlijxz9djr5yq2q1s8fd0zhhs6lpf13nchpdqqp8pf8jlml1b")))
   (package
     (name "frontend")
     (version "release_3593")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lw5jp41gy5538m1mi9gs93r9f5dk4cyyh0isg2djk02n3ffsngx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0134zbf1nfkrhb5hm4ghmrpi5kmddg0z2ysp7917y2c1zzdf1r9h")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ni7j4mqikjb21mk29rm3v5j8z612i2swh99z3rp3hikw8r79viv")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
