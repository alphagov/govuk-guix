...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1igqg64f0wxp7z4r6rrqq5b851g2q8gsy00g3305a4s8ly3b6cx3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nvbxh8lbpfv762z8r795n30k5k2zzhhm8gfqjmqn543zk7f2cw5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wx9zr7v1r82qrbad6qyf1r7vjj6741cx4qj135x1yql9ffkarcx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1abgbhg3q8zs9fk0rb0axxhb9gl9pjd196k96kq76gkzimkm7c5k")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m58k8359m88qvk5rjri8yh4rrr09kjny20wgcldxmrkkp16qkfz")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1aj7c4c51fa17sf1pmcn6k2wxv99d109xd6c5qaqspaamr100b89")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13669")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xc8yccmi6jmwfbl2s1dsqfsynvhsxdwkwbfc3dl2n77yx4vylm4")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
