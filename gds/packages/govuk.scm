...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "14h95i17475ms1wwcnv4qwbbd07chfc8xv13l2574yhipmwfl89f")))
   (package
     (name "asset-manager")
     (version "release_342")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jzcxxkmir9gq1ldc79h1dqh18l7l9qigifv6rjaicinxnig6x9l")))
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fif059axqkn8vssc8ybd7l8ma7a5s7pvs71zvcy9xf7i2fvs6v5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11yh34rg2pir9f1r81w0k03782hi6hlk8rdykb882cvr2ilvha6w")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jw6hdf4l7i0w20n1j8jypf6zaszg03g0sxyj86m94pwwf6af71r")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "138chh6i2g3dgyxb86gch4bxdjibjrivq5dnnhf3dpz2h69bnwlx")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1arg2708db727vid8plgcpapd7jjz8ddmgxviygxi8p48mmpj2kq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ij80v3gh6rs96wa83337b0lq48h17h5xxc0pmjhbixa1nabkgf8")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "003sphi1697ixbrdd5p7vbj7fjl83ahyjxsqz5py9r8qygrx5xdk")))
   (package
     (name "release")
     (version "release_398")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lvlwcblmy9cl4591l2fr21c2kjqmimjhkj0bkhb9mpv60q066jl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yyhgfhlbxwqkyzhvg50sw292brzambvaz7q990x1mpbr35nb80x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0imvvl1v2pmhwqkrj695q7v29inyxpkfx0qhfjnzc14p7n640n88")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4186")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1clq06wb99pkw2s85fw15nbqglv5p81kklpp725bh7w88wsxh9aa")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rfvp48ca39jmzgrnirplflyq3bjnxbn8k6pxhjhm101hyp3sdpg")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "027n71ih078h3299vxrw8vz1sigfmgn78rgspkbb3ig35mj2kqg0")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "0f38mclndxzyc1p1ygbrsgrrpl7nqzj91sbvc5irdi26nvzmvpdw")))
   (package
     (name "support")
     (version "release_764")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xg99h5c0rfcfildsn8k4xlyykhlyj0r61q3h0v7d8lf6802n533")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
