   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lcsg1y92f2ja4dapp50nnqxl6hvz0kid36gn4ykhjp9dsgc7vnf")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r9zs4k644daq33p8skyqxyfhlg7nl0pf7cyk95bnhwmzcw07d9q")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f3zm7x4qhcq1zsxyip4zffs0pqns8vlzsnw8xw8qqm7cv2f98ds")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bh289jflzszdihiq70jq9jkch64p0f08qxi8lbgxs2bpv349zkn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kp00pahds4kzldhai3l04kadmig082g17nai1d3ss979cz4sg5f"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17hlyq1937vk63r3y74hfj9x6fsc440ii71mwb6zp8hihvmb9r4p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ssm63wrg1444j7prjgyvrff0rad6jzw31cmsbndvc7c2iybnw79")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iixkkm29kgcych1y6bi9fl8vvl74dbjc7rv0b4d7rikk0hrijll")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
