   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "074q21gnymxgzkjpzp5m0fbqs9882n31yd5b57bwqvvhv29pjgv6")))
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "13m439xrzlijv5gy12hkdq2jjy6rvk1kvfg7xjz5k0apfnx63qll")))
   (package
     (name "collections")
     (version "release_357")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12gk5wigjay2vvvv8xknr7fc2yv45mczrj1r16m4ffpy2h7gshmz")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lb82866pz0495yhc1qy0hamsn3vn77hp5pqz4wadw3avwg7m1f1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1aimk72p4ybr7nigcdlcijh13li8fkmy79yhnvs8a181v4c38bx6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bkvlpcwichcrjh631nibkac4x934f1cmhrd3l3zap445n4syhmq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sj3hczvymmr7svjn6ih67306cjsia35vhkx4x74dxjq9ribc35r")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2719")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nmr2skypxcbrdn2a5jsvqskv3mccl7v5n925bf7hkm7h6v86bp9")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ibmp5ihaphrz1aq7zjwyhx742l0piza78ljc9y6d2xlxjvskwk7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0sqw750m2yf16f8xsxi2j91mqy0m1wd3z1zb6z8spj9drjbdrb8d")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k624v3hmp5p7gr55c1g7qvk8l6gp05a24g5r3prj50yvfafsgpk")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pisal6k1as08bkxnk68j0b90dk7yq2r0p33yhwp9d2csvmp4wg9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3726")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p33c0ssbfzzvwa5ganwr1i6vs78anvl1rknm5i2kwppcydlbzbh")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2651")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i6p04scqg5j18dinc8rgkfiklahdda88v3n07vlrbdiax8sqh0p")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12958")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y6j2cq3qa5glcsiap6yllipjl17rh6vkjywyr76qs7wl6gv1cny")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
