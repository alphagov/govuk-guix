...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ymixi1msvd8aj5m9170f4w5scr6wac06a6llgasbr53413v0d7x")))
   (package
     (name "calculators")
     (version "release_689")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0swgyzimbyd59nbnz530d01rzi8zpc1fnz6bfl5sp0hrv1javamb")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c6xrz0gk8a0asir81ibhzq6f86m71jll03qdkjpffdqhrafvfzz")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "03cpqvlp9lrp1sqh9pzyz6nlsakq1ynz6r58i4snw66x0jskppd9")))
   (package
     (name "smart-answers")
     (version "release_4703")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nikapqq2n5h57qjs20h5fi2fkx4rfkmivrnqwn7f9pza2vvljvg")))
     (build-system rails-build-system)
