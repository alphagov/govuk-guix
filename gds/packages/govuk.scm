...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1aw4i3a9xna4yyrpipn5ag9amqn15d20900ips28gcamdj161bdh")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n91rsa83r0ljpqqxns7y6g1vf45bljbfs76n8nbzyrh5kj67k2x")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "01h627i710jsv1ww63spxz6a886lzb1g3k22i1nkzgz5m1p16nza")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qn59wwzg6r15mffj40n9kmj37y9cv6zbh9fwrs7nhhav95458qm")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0skdkbdnabdccdgn4w1fj21vjx36chfyc5zsbh981zvrlr2gn9z2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1inys39hfp86lxlrmpb6w726bz4mv591fjnjl8f8vymii7bj978g")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mbwi5nf8i2vi1y4n60rfcrm12326j4rfgp321b0xdb9xqm8q2qf")))
   (package
     (name "content-tagger")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nkjsz60ab9zlgx2vcga25spp6vdkgpvivq3qpa8c7a2v2w36y4g")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18x0hmp7j6ab9zy32si25zix0fk18zy7m51j72365pvkc4ma3nr5")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3618")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rnjkd88402ykbhrbxnhmm8vkh0qx9ff596mbvwxbr50i7vkx8zh")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mfhjan5yc4qqw11084q89isggqa3mcb9mzmzrp5z7fal7dz1vah")))
   (package
     (name "imminence")
     (version "release_655")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hcc9gdxy9wfigb0j555wqb9vfvawngwiz3v567njmsg0kp0ci7b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lhxz7rk58zblhs0mafxi4cyp0h4va7dncjk7h8y4izg9im5is9w")))
   (package
     (name "release")
     (version "release_655")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hddyf1h37wlpmxx4xkmhxflsrzmvmy0ncl9cr0xxkqligzi7wbg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public router-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pddzczkjfp7kqfjrzjd7mbcpw568qb6s990v1dpa9r9g8qglhgl")))
   (package
     (name "router-api")
     (version "release_315")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ix1hi5z64w7iy6drvhy3iisgqdc4pw8hh1rj9jdnafvsgyb1qwi")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fgkwsqbn3jdgla4wqv4rvfaalmyb0zg5xpzl9zbkn37fllv4slh")))
   (package
     (name "transition")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "152xr808lh6yy0vsrfp4jl7fp6kq0z629xmfmi2hnwiydw02knag")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
