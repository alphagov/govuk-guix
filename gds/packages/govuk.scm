...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0z88gbvclk8bbkr80y7z11src6r89kx2ij3whyc4s4w2fqg6vhwn")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cggj226bslnjvd5lbkb52c46mhkgx0inmhb6x75nwxv86vl845f")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "07n354249qnkvzr3mibrxvdhiqfcrgfxslcah6acivq6vz2h2ssc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1byrpx7i60696i6lli7xc3f4va54j1ixdivvybsdw4c6m7ib58b5")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xfqrz5imk7q6zfp16y21305lk52y751q0rjgcpdwj5klay2j3q5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bchf6bpq1l2rxldv0zaz86l972ffg6f24bq9kp46l105ld3i61z")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "05iiw5kaw795jww3k6iq9sgffyq7qvd34k7py7d1gai1vmqf1bq7")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17wwg7h37b35n70ynhyim3zav8b50dql39mgalkxd65kmi540z6n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vbdzvsi3ckcivwxlsr70hdpgi1ddmvgigvin53nl46hlng5q3y7")))
   (package
     (name "licence-finder")
     (version "release_679")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qbbh8vb5xqbssd52c59r7slwxkda4nv8yl83ddz0d0489gkkjrz")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ll2z121jchlr17lwz303yz9rlcf80112l1rybzm4zs4c18hi58w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fm3pf87fk5cf51n7j3ghis1bii6jna0q7016hgmbqsz7zwwkpnx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "07aqkkd2dbfd36vrn5ca94lj45pf61n3bc6zg2x26idkwv1yzrbw")))
   (package
     (name "search-api")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1428cf89908l80g9dixpkgn15ianfdkal8sn09mspigvwamg4sc4")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "07304dfbqa0pmmbljalp0anzbmyad1k14bwh9mwwx6pqh1zblz8p")))
   (package
     (name "smart-answers")
     (version "release_4546")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1si66v9a5nxidglbff0pri9r3rxc1xbg8c9w7zlhdhx1xl82i7kf")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nd798d5lsgh50r7mfsfmj83a01pkp25zk1pf41iwmbgkxqiw4yz")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jxl5liw0z8kx7djar795qc1yc2qahlhypy0knd7y2bjcb9lbn09")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
