   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mnaq0l5bzxi4h82ry3yd6kkkkypxhbcj2nkr6cyx9g4imhxzb9y")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h5p3c5fcfapg6k3lc2ckjnalg47wc8im0qy9q5ygi13a1m8q1b1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1vvqxw7pndp87743jggsx3ad79hdcpkvbrdncfqwv4laa4ry26zq")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01znzwm22xshzqkms5fdpsxn5n987f99839fixpj4kpyq61xk75s")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x89pz7cxlx7d76zvih2a7a7qzpxc83nbcl0pnr1xmgl9m8f449k")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rqyx8hajif76flhyp1225csk9l6hsnqbk8z6fvhngg825z9l22j")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pg929hfqx7l0mvw8sgh0616jln5y8dd5klsaax9ky18fkhisbdl")))
   (package
     (name "whitehall")
     (version "release_12797")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ijm5g6bdb26n1l2ygmm6n4r7im95s4rbvng4fmsq46v0bm6k4di")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
