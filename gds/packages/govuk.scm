...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pw875f6qm3xkb5izwkbl8mnwq5fv0gvfy8lzm5xxmky90fim27x")))
   (package
     (name "collections")
     (version "release_734")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05i6z5gnxd09rrqfqfp0r75wdmx1z1ihkqr7syqaijq6hgbhmdc1")))
     (build-system rails-build-system)
     (arguments
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r79p2cm92a178cq832q7gjiidkmxqy6h2g7dh5lvvgr6y2w5drq")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ng9gvlcbwwsqknpxk7mj613l3y46wnx2ydlzrkzbs2b1yrdm6i6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rbwzg6c1xs4hxzlvxwl13m9k0ahn2lqdchvgk2gk9892nyijpl8")))
   (package
     (name "licence-finder")
     (version "release_487")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b1vz904k5xj5iaxpdy3nhc80ccf29ss1zwd1lb3z5asak7d0rqw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gk299a5rc5igmf70q88pfnmqqfk1xxdw6n0p2s3jr5k0vlwi67c"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hxv6k8b2fynsnfzrpa2gwl7sj87kfmndvvdfmi455vyi79acnj1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
