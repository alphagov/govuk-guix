...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zcpnq4mw998v9iw3m7im9fkzklpfhmh0j4gxkbfrgkp8idvqyvl")))
   (package
     (name "content-tagger")
     (version "release_623")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06crpfxi4qi8qgrbf2i2253dmnggvfjf36r08lyh6n7qxz07bjgh")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1zhd59hbkm14y61ga364lmrwff9mlaa2nvmgsw6vsbqssjaf6dwf")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
