   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k2c6g8wqiw1xq4kvixx9m5smp5mlqi1dlxgdy0gr36d1w6a60zw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cgwq7z2s3cdig4q9dm2cc7kmzw3iiicb79nl3ss7s3h92djgj3a")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0qh9c2bax35gldsjhf7qchjbvn59i1czxkw4w6hp2rr3bkvpf7r8")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1am62scij1n56fhw68lq9slgqnf901z8m9jx9krf3bdl03cvvdwp")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07fw2v64c5bk4g76k6qsv98m0d7ryjjz6g596nwfy56g1v5h8xzs")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12789")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10bcqxx5lisvscf2cgqihq9b5fmcdccsgn68r0kb4s2cf30k5na2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
