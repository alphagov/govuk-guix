   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v4kw5m8w7xr9d8pbs7w7sqld94svmvg0lvgcawdmi4di9lnvh11")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17y70jpcwv5dbs7k4hqp60j27r28yphl6q8250lqig0bd9wk3b8z")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14182")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0aiazpm0ayk19gy6j4s3idx8s5z1j2ma9wxnz6clc8d04im8gag2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
