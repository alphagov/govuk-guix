...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_1950")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s7yv715xxj37xs40kyvs9r6xah3798ns7ia7xr5mzzmaa0056yn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13425")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "051iafh2mcisflxbn14mhimyq8hy5fww9ng0r68dv4fmnfjmwnvw")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
