   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lqcfz0m34la3v8pj4wc44m7zz38w40xbhyaja6z2lqii0gi947j")))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "031smxrzv4r8n4gpalcqw02s8gcrvik0yqwjr1a2ryjc2xq2spk8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ncdkw5yaylwbiyx1bv769gcmjpg5dwg2s51v4gkz9wb8lpnx6nv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f0hr66yvsc8hfh7az28dwyprpr2k3b4ang2fm8y8c6lzpiqh8hc")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
