   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h44wfx7qszhi473a5615j50799w873d0d4qjr1y3chhiplhwhn7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jkjbq2x3q7vjx4d4mn16k7hwd34rvp3lnc1s5r04z36ixjqp6j9")))
   (package
     (name "content-store")
     (version "release_657")
     (source
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a2zpsnjrp794zx4jx0nhgk6hf76mj5c0bnj49vgq8pfsdvc5nld")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h3q5xzq01pgabq699d5rw9kdhnah91ydc7v73x2nwk33xdiml1q")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2666")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n73644hrlsnn8kfkpghab1ymrxbcy7vh44rbdwcmkj85lmr4744")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xlr0rw493fwliv6gr2qj7r6169539z1zi8by450nxybn5qc2nnn")))
   (package
     (name "support")
     (version "release_593")
     (source
