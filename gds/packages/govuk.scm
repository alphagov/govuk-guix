...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0smvkl8pkbj5jwcagq8k9cpsr4d20pqnkbphhl1pwh4gfa5583an")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hlpfyilsns4xm03b9rf2wkl96n3gadx601fv3d8wnplg3jjwx1n")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "079zfxj2ffsznd0pxc8x4j2652vg76gsw7ijn8y5w63sfihqqcj9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rwhkkagw51s8gcxhrz4ggs6fzqnixc6433rifpbg9v9gh8aan1n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fjvp2kbkwyk6s8973c7v170c2bj1p59cyasvfbz822s04vmgwgr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vqgnk0pi32cgmgx0gn6ccrppk5lm69mahg10ygm3jhk1m34pmzd")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
