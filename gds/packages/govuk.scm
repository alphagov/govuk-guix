...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kdfqf4f4jw02dd2wl4bma8l488m9xi49cmmxr81dfcklszb6rsi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rc8ax3y9xzk53zz9kxj8zmxhnhbhvk6n9a3r8d18rr1lqzbg5bq")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wnxcr8sfplw48pd1bg4sxdyr77qqvcaqcjf7w4psqkj6qr9kijp")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "184zfrja8pdfy5b2vwggk9skifmpqk83hbnr226w1hg128xhhqkz")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l5kms8p8h36sdbavnl56y3340klrbbpsqn9fw94idn8yj7j8jyq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18bkix76m093ibi5l2ssv716iizinm6ypkfpq0yn28bzip15ylnl")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0qx5ynqav3fqcgpbihh50xjcvnbvv7rpr7g4gj4aarfyhblzkmyw")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4406")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12xfkr3fcc6y7wrp7ankp32s7naf19km3x4z89l20qvx3y97ypjk")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lxvinlyhjbnh73p4rpkslyblfzn2www02v09abja0cp8c8zfiyn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14175")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gix89qh1hi45w8l6gh562am3d23qrpwd56wvp4fw6xy9kb5wvn5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
