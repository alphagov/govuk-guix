   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jb9wdbfrpv13c0h02rsa6ngffx3dprh1bn2pd50jmrly6kcaaky")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0329d3hj3d1il1j8knl12chivf9w49ypr03ginh37dabsbbfhfaw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ayppwgy5g927agkbz0xy15scakk4a8gy8awjln6cgnf6q7l2dhk")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1337mqhw5523zzci58bvxsyfw4mf5fm8csirp22bkgfnchbc4r51")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z3xkccv31k9bnpbpf5cchawy6l4hxg8bzknd405fpnwcpq5xp28")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03syfvrw1f3nx961bnkyg5f5kxbpssgwck4y5w17i4ka9axsaqw0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4313")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bj6id65ki6mcjlv42d6arlxgdkcfi730lcwiahbspx83hl1wvgb")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ih1q65ci82cnpbvs5cnn2gbxrb4lsg0c2wzyiwi92j5xpz3xjv4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_3095")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02mgypalkiq7zybsz4jgnyk9j3kmf1p7srs9vafdp9pvllhspvi2")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
