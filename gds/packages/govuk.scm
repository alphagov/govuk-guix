...
(define-public authenticating-proxy
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pfx7aj8mbw64z5ja4qgw75gwh3klxhbrgijklvywgyirczm3g1f")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b2ls37k37r6znbmfff91crhb29w8y9hplfk6iq16jg4qkbn10nr")))
     (build-system rails-build-system)
     (arguments
...
(define-public bouncer
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x60ggzhn5yw9c5ivlm59vplfa4csglrg1mjpm3xw2rpk5fjr9yz")))
   (package
     (name "bouncer")
     (version "release_272")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dr78kr106jscawbbqv6dq020q0ic29acbgblv76y9vp26rh6wnk")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f))
...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rz9m2nqvx92xp7qcxlcvi0vxpmf67yqc0basllpa4p07vabd9zp")))
   (package
     (name "calculators")
     (version "release_558")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18jkkbkm3rnzx88m0qjy5phwpgwc2rhm9w1sgz9daachh3wv2rzs")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xc4abx34yx4cr7zfkyjcyay85mjkwnak05f40jmzbv26lapi5c0")))
     (build-system rails-build-system)
     (arguments
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sgmb77gyfa4w4w7y72h3cwi6i82cn5y87hz8nr4hmny9szvibb7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07wksy9yxnaxky5mylr86bizpj8x6rlbncsjx0r0xbs3cl1zlbck")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m1mvhkay171na39bqhyijlp4ykwh91m6s40vja74hfa5vc0bpcq")))
   (package
     (name "contacts-admin")
     (version "release_633")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15jd9zfxafixq9nr12lmyg6grp16qzy3db14p6jgv8pqlcy5kcyh")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "17q8a7yzkyg3ii0j0dzpa3xl816342x9d64liih0abcwsafwpilr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ys9qx7y20qgx33dqy5mg59j32wbvvmhkp9fnvm9cpfqs11psbdn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rgz1fjfiz2ygflpgc5yw58jiq85dv4fhbqkkf8dm01ln5p399s6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kkd1i98ppd9wh0vc02xj1brz4f0h7gpgaqkhs5iqhakmndyva8m")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1c6a28v6fzm0kwm6h5chmyrx4p9bavxqsb38d0ywy9kkrj7j7qdn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gh4ycg2mfrfjlk6zqg1d5fxfbjpr8jz4bi0iyr3ccq6sb3s9j01")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1iwlvqqfz075g3sj0yizlbwa8phdi2qlgdrmcgbaxcajpr2h0xhr")))
   (package
     (name "content-tagger")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a9ppif405wylni5f9n8zq94924kxn8rm3abh2md8g4rlplwkzy1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hkikbfysxvx0427sk1njkdssb7jrqqi9rcgrdimqjf408bddg7j")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "059ck6y3xyjz0pbi2q69d0js12b7k9271h7hy4fwhhi4mnzaqc7x")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zlga36g6jywxxn4drkyznr6yq9n1m42zk1i4hhp2ls1pn66fvm7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11bbfmard7fflgxa8ajid029sl9ka8cg9k0pqbhks4dvvnysgpg4")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nzkl456plrb34xr98da0753swv0llw1hd7l0qbr6bhppc4ysqml")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iyixhkypqhllcp74lzvi3spxlmqh1k7m4cmjri5rkrsqxgds0cv")))
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nf6j4yfmbv2y88j9nhavnfmw39iz20fhl4cswna5yrmc0dga421")))
   (package
     (name "feedback")
     (version "release_746")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jvmvjdx2i6kj8dd0h9xvj30jlwy7i3iiy4w7lx3lymfjvv6981i")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b8xjll2zlnan91hxc45vc6lwl3cpbijq8j8fkf47h8p939hkxa3")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hrk3bw4q5xs7mw8z429ga5i9nxd7wlq4iq8gf1znr5s25jzqkvq")))
   (package
     (name "frontend")
     (version "release_3269")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16i41fadrn989wrbxwmagvd69na39mj1hifmz8d2ldxff5d04h61")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "0q2gv297wmwsh3f7c9wj5xvbda0500c1xjibc5phgz710vd30537")))
   (package
     (name "imminence")
     (version "release_566")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08i7gqx412q24vay0m2rsig6dka071345yzxxcm21vr2s2zvyd0y")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "12k3ib93jkd7xfn5skrvrdr1dvn09kxhz0zjnqih1rfsb9xb2hpv")))
   (package
     (name "info-frontend")
     (version "release_419")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m81nif9vl7xhs2cw8q4k4wchgd5n6k1g7b7cnssc90zxxwn9xy8")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1k74jwczf8q7h2is9jav0jlkqy6823ml5cjwymhjcr4l03izrs7f")))
   (package
     (name "licence-finder")
     (version "release_643")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wj2a54s10am5yl3i1gm2iqm5l7pslh8gkc2mgxsy0niqa1w1iy6")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0y08mvrajwn2rnzfrpss64s9i8m732lxzr1593iaggzbazk38pg2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q8a5bha0r7hs4b4a13k3h0cklham4lds2lkiy5ijzr57jw39fq1")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x75v3fnznvjz86kxvwkcicg60pahmcrq59c90x77k989vm6ybdf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f6gidl158bl1x0ji917avjq7kip8c6xnvh5wzmmk54skfac8m4a")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kmc7j4j89qknmkq9sk3mvpwgaj71kly1ddlf68i9azm70fd9dnm")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0h7wg450d20ahd57kv9wy87m163w70xl54m0prj2nwkwj82hdpxk")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "079189s9fvlnl9l4zklhmvvsl9xvxkvic03zv3b46p3ibglqq9fp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public router-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0si7sa67qd1rfwg7l2sp0pm2xpgzwvbci7s68i99vayd8s7xv55y")))
   (package
     (name "router-api")
     (version "release_246")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m0m9qfq0ij5cgfg9q65pfq69r34c0fnad9j70m8xia7pkb3nadf")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "046kf0v8swslpd3zzi3xfz663yf1cyw2gnkw1r6kr54d56ck7shd")))
   (package
     (name "search-admin")
     (version "release_299")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gnranwavl11v992m6j4mag567fsxdgx1a87qc4hi1wmkck5xn43")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "10hj3283rzw2k315hh244hqr443qxlz0f9krzr4ir8y02zy2hfb7")))
   (package
     (name "search-api")
     (version "release_2208")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f9rz37vyj1n18z67wfzgndvf455qapqxpcqkywvbybdkvidx8i4")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h5w8sw5hmy9nkayrjqsglcrnv7gh3hlrcgxiffsj5mjhzzqm5w5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ppv6v246ap3bbiyx56bn8h37cvp1f5xf2rsxcnjj7hi2yp328y5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1am0awk28gn3h8pmvjpq93ajkdrgwbd3zws431b9nmhqsda1g8xd")))
   (package
     (name "smart-answers")
     (version "release_4467")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dnzhk6cf1pkjy78097lnm7ijlzybldf9wkx4qc5bc8q3wljry7a")))
     (build-system rails-build-system)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "16ddx3wnm6zzbzknq6vwlnybhxy4rnlwsmj8x2gf9p7n21rh3grk"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0f16qpc04sgp52my2p5d8yg7cd55xp37r39jcz024kw7lf8sbrb1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dskg94p32v42ljpmzyvda1byqhaskalgd2b605iavw3rls8nkpi")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x8pl4dd0hw4jvr4rdanraw55rifzwb0bpdzvf52h4llspgadw2s")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1whxy2r71y263dczr2cv65rxk37ak4ab8rxk3cfmkivygvpd7j6v")))
   (package
     (name "support")
     (version "release_892")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bi547a8bl021qr735xiqvzwgn7w12507h2d8vgbkjyv2ydx5bhp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ihdgplm3g8q7kiblxlniw00z2sv02f4ldjcxbnpp4znz9llqnrl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1all3fz0fr8aqwlvpmxcc3z2vsyv1n31lw5dj8dsbs9gk22mkqk4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0idwdgrqx85vfky94npsfgvc5vh190ssqq181nh3ghz9cjpsbx4d")))
   (package
     (name "whitehall")
     (version "release_14292")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y1652fbvz6drn52vlp804p9kq6bkdhnjl03hcmnligvrfi2z0px")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
