   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l04fnb6zkj9jd40ik3k2ahaf29r5g7ql99p5ip9gh807ydl3zf6")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zjxs5cdc71fgp13ia5ickh9y0iq5hbf17lj4fhp6ybgicbl6701")))
   (package
     (name "whitehall")
     (version "release_13923")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04sdvlz8afil9xzayrxycnrlrym8j4rjyd7340nk81hz1fsi7qzd")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
