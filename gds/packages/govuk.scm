   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1banmaixq8sb1i6kdsx7qcki08gyk5byb0nhchhrcjcxhc8yxjd0")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12qwbklnfhhr96b87nzxc2bsfrp0sv2wq3yasjx142qzwnld6iyl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1vqvxqpw3spg847x6zzzpim4r9nmgzcdin18mvmb94b0rqr4qpxm")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
