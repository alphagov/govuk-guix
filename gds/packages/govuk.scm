...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f5yql5gxr299fg3cq9k2b8z3rhhka50ap4wp9m07w2n5328r2cx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l4k819xk21vv0c4xqc2rmh5mxvyhbyihjjv2j4891gsfqqrrwli")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18mvpshkcgnp40sdx35qnwcyk2m32ywfx0v79pbd503fhs0q8w8v")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license license:expat)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gls4q6krkkch78cxwch5qvyxq7kdkh28nbdj7dlhshjdi4gbqi8")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4043")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00siv0wg46bx4qn6s7gsipndvcpnsi0bpmmr0s9q6xpzq2b0crwr")))
     (build-system rails-build-system)
