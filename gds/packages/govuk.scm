...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vcrq5dkb4fx6mbglpj2103frdcr7n5671dmf6hmlacpq1jqwg82")))
   (package
     (name "calculators")
     (version "release_731")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b1vjcgynl4bggyk78bd9x7wvlqz8g4k7j1ya21wbmrws401a6wl")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dnd62hgd1g4qa8adsw27zmgxqcphz2lz4qfq2h9sajilbmvihfq")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ibgmhfnavq49jrid1vcghgjjpid4cgrr7cc0vang9q85vl5gj1c")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m9bvqaxmhn1l4c33698396j67npslzdfa64cbs49hwy45qq73gv")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1k4l9939smng64f6kjj6ibnar9a19r2had4vfw9nzbdjd9kll499")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y9f5mzn2kdcjs5w4xdk5ki6xskqfk9clwzcaby43z7ny4k8hhry")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nbjnx8rfl711462ah6xb6y0hm87870h4whl5j5k5i4ya19x6j98")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02a614l94m00y37kw4j77nplypij8v9fzikc53ab1l0hhhszz6ly")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k2hdbsgy22nkii2bh8g7xx8acqh7vgyfbpnf4llpqaa3pqqx6i2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nylhmk7a9sdm2fjmaakf6hx528cwgqi0kcvxlp45bx5ysqrmj37")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s28j8rdx4ymqvclfswwl2hb2ki198hqq8n005c45ms7p56q3xsk")))
   (package
     (name "licence-finder")
     (version "release_781")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bmf3yaa3hg4j4gi5vy06kizryams2y1bwfln7jv5fpd2fpl6ps3")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j3zlq2vbpka19kzpgc845w6n7301p27jcmx7bhzia0b8m0b5kjp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1shh84myzkwr1djhc7x29bzs0jlmbyjlsp6fi6ka0dm452ns6365")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18i51534rwsc0aprh895xn17zbv88fdr9zphiwsszff5sqjblgkw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1flmwca1vzpah53w2vlmlgjkbx774lxlw29wmzksjiawfkczv117")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "110qd75vs2vhrgbhr8rpmvdfw95dx2h4xil3kh8i33fz30xyf28j")))
   (package
     (name "smart-answers")
     (version "release_4807")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mb0bcyz7nxir5rjw77gx7c2r8k7yvgxckbc28w4a3gxfjpnyqhd")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s5c8h477jwaznqxx923j6ajpani6si0yqqkxvn4shnkrw1pagf0")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01s7xgshkr9ar7gcac2fvqs4s42dppxic8arqp35wm10dlxjhlmn")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14815")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06h64pyyzbb1hrdivp8ybdxz3vfydv9a86vqkli6jibcgfp3kcx8")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
