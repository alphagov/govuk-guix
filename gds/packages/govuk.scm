   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mk5wj97vd9ywqbvqavn8ncbv9awlmvrm91nay3ggzabllqha2vs")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00642qr29jzmv12slg9wmhgbbmv7k4xwh56d76a7hpll0r7hs71a")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nxnxflnk33ci907gq2wgbbbl58pqjfgzc6hcza97gaygr1w72ni")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ayy27lgs5995d1kxl9lrj5n35cjbbbg09r32xlf3jrglf8mi7gx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pyffqm98cqan5wq2v5vddvsc88lhd85jn8qd419dxfzhi4cbh53")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hd10bm2aw9i68bbry4qk08r21wvql27yn7jbfwhffyp700b41iz")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l9arvqqy3mmsaqf1msyryq2z7sbnmgipfbyyd9jsn7gik606bzq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kj1fpshf4c61v9dkgazxwmxjzmnwwqv3618k16f9n82892h99wp")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1h4wnyigs22rlwl8xr5bgr0f4bgaipaqz24lrr3v877ynkj0nnz6")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "054w88cjfzad11gm3np1s54yjvdsbsa0h4lllk3g4yp2nmlhm1nr")))
   (package
     (name "info-frontend")
     (version "release_389")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02wd19wv3h2gb4212g0iz27b40wna6pnd12py41sawwm713cg1qn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0za9pi21fpm9rmbyps9adf3dldy46c9xq3y1fkalhl0hzb4l3znq")))
   (package
     (name "whitehall")
     (version "release_14176")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lk1n5xxbll7g4khwrqr2pvw2lk777ysamxr8j5k1wry22fdygdd")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
