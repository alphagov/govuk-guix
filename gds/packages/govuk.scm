   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iczkp7nksk93w6z1hbz118fiv1h8kd08syw9vgkcd9dsmbc056p")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04flw1a0yn52960r5b5y6q1fyhxrrm4l033zsgfl72ffnd2afsax")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pnxf5wpaxmfwpgkl68h6qnnxbmpn63l06livn3sx8w2l4ydhd79")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13167")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nimncy1j8i4995i6035lm9556vqmqh8p662l965936wrnyn7770")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
