   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18vascx6sqfbqr79n1vgmfqzjx06jkyrh268l5xs1x7achj9fg4f")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3702")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ndpwn046np8dx7svgvkk6m3ci0v3kw55bivlqb7rn492psb6qdg")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12929")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "023djpp0r2fq8s1z0lk9dp8h51cg0299s2nrg56h75vvjyarca1v")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
