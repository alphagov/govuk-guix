   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ipvkd7qn7iq16y5ypa4zh3qy7fhszw0bp2s9yc1rmgafsp3mn99")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wb3n2pzxxwjg6swls9rbv36ssm9w1413aws1bq6fkxsjnrivv1w")))
   (package
     (name "whitehall")
     (version "release_14289")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gzxpdd0mxh9zcpdmvdd1g6zm3hf9rvw8mwg1lyvqv9swibg4wg2")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
