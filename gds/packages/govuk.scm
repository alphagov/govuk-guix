...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r9rhzdjffghmbl9h5bpz3vc9m5bvdnrysb0875idxx8smhs1j4x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dlzma05046bjrqmkr4ln0aj6cwmdyysh6nwswijhyk8flz8vm1l")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hzbdmhrvzb4hm74z5rh8376q694k62fgfif30q449bzg1gggf2c")))
   (package
     (name "content-store")
     (version "release_892")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0isfmis7vvb6wc4w1gyzzjiz72hcy3hgwgmh43l9dl4mslikssrc")))
     (build-system rails-build-system)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "05niyywdkcdwsaycsq9in56474pyrm5c2w2694j8ib5zmkhkjp8q")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06f5i705f6bsfdyn70m8xppg83xclinm76q4jrs0b5z5habrqji6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bdrc5zzmp8mm62s4vgz8ra3cfi8367dfhys9nx3a6d58x8ar2j3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jkqgpb8wp8ghkkk6asjkimdcs9pjdgc77nasbpmh6ix138crhqi")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
