   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1z4q9l8hdbz76h089yp5xninff3j6f3nrbz8v3mk4dcw4x88ax95")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1rqnmps646c24fnpimzbpfq74pmqyfgkzmaz2n43al354j7c3jcq")))
    (build-system gnu-build-system)
    (native-inputs
     `(("go" ,go)))
    (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pnjpvvmiclcy6zg5c78sfrd4b64dq3in5mdp8hw2ap0bkvkxbph")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3711")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14c14bkzq0nfp06ahvm0qaknnsl1c7zgbzy6k09727rif8614j9k")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
