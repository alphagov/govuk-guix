...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qnjdmw6wp9292sma14vjy17kj9vazh6xbilnfr2rfz57rajwm5a")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03k4dpbydar8sv0l1vmc4rb5713mbfb38ayjwpimwj6yphcy1sq6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0c4sd834gdgvaf0z1q74q1szk3w100fqdzz86d8bmcp4cpivlzhw")))
   (package
     (name "frontend")
     (version "release_3035")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0izszw48k4b22z3w34cwnznwqwa9gnccnqmzkc5k7m0l2889xsa2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "13s3b3bwlchljn1k5pij1qz0r2sdd7xqyzysv7kavj2qqf3j8x0r")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ma6snhzj33ccp71aizkblbnfqx6pdndj6d62gdpf97vqrl00cq4")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mw36jfkla3h8232k97hbbh06q5zp3mqfi697a2xqp86yhj2ndwa")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xly1zyxrainncyn8swwfwa9syxjrryvgqvglr2jiniqpd8gm9zw")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qfd33aqlf8w54q1w632wxcqxwxw7jk3mbp5kiv87ykah32brkcg"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r4dszjnxj5mwknb43jaav0k39yrdcqar5nmds9xzlsc86rhy69v")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "000mafvx0vx1ss5iq7b8fwx4pr8gs93vhfcssc92ibl553927pc2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zwaavwbh07xx7spxkwinfwd9932nl1xma9v57qf2mziz9wasv1b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13875")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wr1q29sy5c52pnbnagmz7rz8lqhbvpnvznjzp7slfk6wdva3b5r")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
