   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yf1r9dswicq4jqw1j90kmgdcksijsz28703yigqcy5r5dd3kh1j")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0va0hyfjny8lh62c1n9h65dmh6s1bn7dc282jy8xkzpczzallnpw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "135dfxqkfp52cz62z4gb46q3rijsg9g93mk3jkc3vqxm5940icf5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x8jcbsymi44cj4zv6djavx8q40hwlwl9zkk030amwq32q7fqjzw")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h170yqq4q8qfd1i70fw7b8mml5ll8nm5w1qzki9vrazkqw2d2af")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "07g7a2wkmr6rzlmk3m8f9j2xf0wwvcnmckj08dim86qqs56nxn2s")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "00i406vg96vhvrn2c0dqydk996nhvnjcv66w6ayl8c5ch8dla2dm"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00ji27zrnmfwlr8rs0wn5zpinlrfq3rgglyscf15ldlnm1xaqpg8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4135")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lvnblb5j91jq85ns8qk2xaqiylc30z44wdxqwfcd07cf55rz9rl")))
     (build-system rails-build-system)
