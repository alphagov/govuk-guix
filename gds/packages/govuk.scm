   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19c6xa4wa3abz5rgwc548ahvg5hyqsr9yxplsra4cg0zdrswmyvc")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "05xdnnghqwgjp17nx22a0hx7578ihw9ngad7jxm17c3y5zsb1nlc")))
   (package
     (name "publisher")
     (version "release_2329")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fhv2zb598379pls46laqja8wwwpw5nbc9wan6px23xdzc3c5dds")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "15025bw99cybc77vqnn24qf09r5pc6bwrdgskd9ybfwg60ix8dxc")))
   (package
     (name "smart-answers")
     (version "release_4853")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qd2m4xvxyndfl0lrigwi4awy8rd3fq0bx2kpic66s3is64xi04i")))
     (build-system rails-build-system)
