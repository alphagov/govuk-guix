   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05hzipbn3fgyycr2mjvjhab3mfpv2sacc2k04r60ipd64fkahq02")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11gmfd40ycm8fiv3m6n28ahsdg43wdc61dkbblbax93xgbwih1cz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license license:expat)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07czg8zvnh79wbclb79l9vzjrfr8xi45zagba2yqb243h2bg4mzd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v2izlc2dka49rx16smy4mjz37jg1av2sh21k6cdpl5ivk2rwi71")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "016ajy4prwin1di4sibq5a0c8nv6xwmaqrfv0wl8x0gfm8x6dba1")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0pddfl4xsrbxky904xjp0pxslgiifl9h664vwz6wb9m8i2s43yi2")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4044")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "079n65l10bkm9lkyscfafzyijcl7n1mzw4sx5cz092b3na7r134c")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kk020196x35jp8vps0r31r6bjxmfw7l9v9sb6x5wwp2834j47jv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13636")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jxnmkv8rijhsp47d26cxphj40r1qx2h2svhkx7vmr688l7m3mvq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
