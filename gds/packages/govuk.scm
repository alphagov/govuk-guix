...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "139hc5pjzcy496x2slm2k5vpzqyzh65azylzjgh83gpwdzdpjvlg")))
   (package
     (name "calculators")
     (version "release_615")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jzdbkbs5cmjd53yw49ajqwa0l1qsqp8gg7qz1sw97xmx8pbygmp")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bdjq8rl7chrqgskzi2aa38nhcgw35a06jfr22x4gb387d0dagni")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16knkfnp4aiyk2mvagzfkmz4s9s055v5s201qaixd3qrxli5izj5")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01ik3g0k99lk64k8szqmbahcx6xk7js37bpyf3ilysd1shywdz4i")))
     (build-system rails-build-system)
     (arguments
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x5kp8ylq5izxgdqkl2xr25fhzf1nslbvhfwq2pvj6gca80faxdh")))
   (package
     (name "feedback")
     (version "release_791")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gpqs219wniwbwks2nrd22f2rrz5xdgadjjm8bn14kyc465sfs3i")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14bip6l21ngvi18irm4s9029idc9pwh9f2hx90amlzxwd461iicr")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ndmsgp2g70zyhv8fwnp64348xxdagkxwvxsqqw49qqkiaib8vdv")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0asvrdyjxz99mxv7d2kkzpnwsp8iqfpv88p7ds0hb70df3nbdyha")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mwn8s64fwgqlqqz6d71v8zkn8jdzh13qqk6imlg8dsabx6wn9xf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jljcqgnq25sq0wsjnlsk94bmrh69sj2abp2x2mh34lry1qj0lrf")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mk40y03mgr2a5czvhwcps7iqifrvqra4l91w213sgjip7v41sbg")))
   (package
     (name "licence-finder")
     (version "release_681")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00jm81rprxdb225ppzqpqaj888v3vpwjlafc4d0j0p82fnyypciy")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "085y82fbjjk183n75vxy24hqffb5m5hjn8wgj34rzjxxg435sia9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2361")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vva01p75lplry58q9hgbh9nw77pzckkghqyvdgm37kr3h8sldpg")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pz8fp0d57smfhdvbhc5bmdr6c062f2m2ygi5h3masldbjg8wjq8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n51yq6kwkwxlalyrxr40p5h7k5ycmrrl1mhdg9rm9jb56ym34pg")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4552")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1si1ypcg532mcqmhfflv576ys6ic2ab11xz8im56yvxvym5h5npg")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fzzqda11lwbkm06flcvn3q8wsxfkj8jv48gyz1sm9qr2bph90jp")))
   (package
     (name "static")
     (version "release_3352")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rqynqzwqh7zff67nvfcslxyncplccvd06imlwnbm0jwkh033rf2")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l2bbnkszz2cpgbpylrrlbv5rv2qbjyrlalm2wpbvmkqwfgq7nwj")))
   (package
     (name "whitehall")
     (version "release_14437")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "166dq8s7ys99b9h7va7r6nc1wgiazfprr0npbjd7lfir9jzkwh0v")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
