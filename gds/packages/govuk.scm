...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1d4w17ky8wjplki7vp4wmh2w06jbkvisqmb3v816yz2gjkvxbxb4")))
   (package
     (name "smart-answers")
     (version "release_4627")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p93x7bmi7bzjf7kfbgg2ng3hlzjyxxnx862bf1i4556l7pb3mz5")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14653")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wjq1q52l4py57dwby2ynaw7sfmlj436xkxf55dy9757k3gqwxjx")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
