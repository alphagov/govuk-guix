...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yasixa5rlc2g620khd78l904488y8flkchw4p91kx2kjsr0k0zv")))
   (package
     (name "calendars")
     (version "release_772")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rz2h4bz6b4wy1c0wkz9bh3lviqlqyszw5saqb2qx1shns0s4ryq")))
     (build-system rails-build-system)
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "17vb0rvk94hlz8nzkjc6jd4nsls6d6fnf86fndbcb314xvl53mzy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qmb0ypaiywkbnvkdwm7j33fbk14s1dl8h2jiy8h6ic4nlhjggg4")))
     (build-system rails-build-system)
     (native-inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l29yy2n1vbhqdx4hil3gzml8iv1ip6ikbgzf8hn6d5ln97i9zfd")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "12awqhk3kf1da6xhnyv5sz8azgcz276s2zxw78ax8f04dal40fq4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ga4k0kkxmsd2zrjn364mghyh9j2rn1fa7yq6rq793p565hwpizf")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1a0kfhxcki85gzyal4ps8mz2mq2askkg3gx19ia1hxv8m8pfilsw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1prvqg2vclznrmgrzvrjf6318x41ir30rhlm4mcxq5rhvskvzyyf")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1v84n1xp2dwhyv637ws63vjfbx2ybdk5chkj07pm0gsjlrc6jsh2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16923ydjng0ajf7qfc3vvvslv2m90i14q1lvirdlrplp59v87a6z")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zj7q24a5j0awaawchzxli3qk4vb4i0hnm3wr4dh9s2yg4gdg4s5"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1px0j8fvq59fqyx5wkm4518x88qg2xmn2k0qf46mi5rvnp7nvvqf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p7iywh0y1pa4i5356lmb06wnzk7dfyrlr21vla93zjks2m12jx6")))
   (package
     (name "smart-answers")
     (version "release_4414")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14sk176r6sx4hhaiw6w92qzawvzwxbfx7dj2vwpp2271c5h0q4bc")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nh45zn5g9c291fdl51b5vbl8j1ghnxcc5vfn2693023x9q8mq6l")))
   (package
     (name "static")
     (version "release_3183")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g4975acjn10fvxk90x97vykxcrjvlm6l5vshyfq3ymz8qbphiyi")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
