...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jahzf2slgs1blx9babhjw8y3nm1rhwavn0k8kq1xr3i393lh1hm")))
   (package
     (name "calculators")
     (version "release_416")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07p1ixafcqcs2dn27ybn177crnam08crshcr711rr4zfsimqa1c8")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q7bpyz04pxgf2f8v90a3mdak507hhhp630nv40hh4rpjibrvp71")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h8qlfxrpzvcnmqvpc6i0v8y7d2v1mj7h6nqyi738x0bd8g986nk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "06g4708y1yg2fry15g0p90mvz6frnm3nang5f6hsf6xlycy1z2n0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "067smnqjmba3vnmqiabw1ndzfmrb7qrk06a120nv9cnm4lkzqjjj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1221gsaff2xnmpr5frjn566h6pnrxhzvw97lncbj0yg25y2y39p6")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dp4ywackriqd4s2yz11gi0wn2pgiyansh59vrvx28p3xfm8drlg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06snfhgbpxfwdz38xghwkpjm8vfz8g9np0f5f9kqbx5y197xfsnv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yq0y6m63ijy0fbna327qxprk936hbas931zplhdhjpaqsvklfjy")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14minl8hfcggvd2qz9zlwlwdbx8qvghp0nzcvvsqxi17v0lx2nzi")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "17mhvlf8dfy2hz6k71ysqaahr9cvssvd22i0vknjz3cf7mfq6vv7")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "031sp7rkfls0nrrx2r23js0cmw44in4fpys1hi552dgzry3digfw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gd18qdhhiwws8r5gcd7pi01shr75rnbsqgc62ppp0pqbhwlfbqi")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1883gf411c229zqz5rkqy4lys4d5hfhyw2q7n2jdxpg0xlqm4cx5")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15dygcpm5frjasmwaxbgls5rng08lci0gnb6m18xajb2sbk2r0xq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wfkkv67zg06268pirscl1ckjwrjbv228361x0nzybknwp4i2ia8")))
   (package
     (name "whitehall")
     (version "release_13865")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09fxvhhqb9i9bm5x0apr3sj6l4rw2f97am1bdfbhcb35np69fyv1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
