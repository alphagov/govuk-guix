   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11lsmknk3q9rz8zz2xc41xfc1np2rq5la5f17mabjcf5x3y4xkim")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rmifzkknhksv3l90vinq7vl9mdpd50mwayqpral4ixrs33n7dmw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1884")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rq0kls6zj0nsff9xrv21z6mi2j8jvhfrzw6ci107nxm2pxhjg6g")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3648")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0alhn1czlqayifp81g7p6alzrh7zz4hv6njxjk0x8ss92yla1d40")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13msf6g9dpq1nsqysgi7avjdm4s1k57k4vkvx6i3v8z6flskq9ai")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14905")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0phq3jf8cs1h0pk1xwwqqwwnksf4fqcim3pngs6m0fmzkg6grvf3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
