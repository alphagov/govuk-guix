   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mjycw1yjbj04pgm212naax0chr645b7821k2m82kb2vwpddjbx1")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02rv68yvyzk6nw4zfqr9kgwl82n65cprfmzkygc8yihrv2cjh5sm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13480")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dgxy3msn9vyz6kgaz601p5k4i67dqfkzwk6y2f7z7kw1r7kn0wc")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
