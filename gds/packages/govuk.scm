   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lkyb5dlmcbjzm70xbmw7482jya7zcwwfibvn3v65iayxvrrn2vx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1iivfinfdvgfq6gng8lhdjwf360kyg3r2gpc9kd0pic98m92zxmq")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2619")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w4hshgyi6vwa3s5rr0fvzd19vgpivzkr3v84bfil4b7jgklwscj")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
