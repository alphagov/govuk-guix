   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "114qi4prz0agy8bp5vyr07vhyfqnj7ndxz34k8drdmky6bw9r7rz")))
     (build-system rails-build-system)
     (arguments
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "12ddja538a46s3x4arbqw2i8lynl25gp2rq3s7sqa9whspby74jm")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qibyq1y45zn0rqy0mjnqvfhnmgr5m5j8gfg7gq1dd3d2kjnc0wp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
