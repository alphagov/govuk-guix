   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00gibq69v3d1x0037kcds7b1rk20k6pbjphckk5ls2qpk5q6bxfh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0y7qkk1bs3b5jgcz0ijj79i9r5snwjc0nmwj35iqhdrlwg5jzak7")))
   (package
     (name "smart-answers")
     (version "release_4091")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h6ip5vacmsc0b6wvqi3q37sahlqj62h3p9dhaig70s03s2h094w")))
     (build-system rails-build-system)
