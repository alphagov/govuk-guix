   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "070v3xqpdi3f62dq3whg988l7lx9i6pd00g2bil3rmazwik6m91d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1amlg91qm7jyj9nw9l9g2ld368dys709gqpm4c103rm1qjxlw1aw")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13878")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qpsakc96ir5hl76xyr0kbvkg1avfkgkvfmrs326dqzhc25a2xpn")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
