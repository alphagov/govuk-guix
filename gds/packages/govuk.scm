...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4915")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09ydid1rb48yylkdppkm41daba4risjmfph0hh18y58gcyqb8v7f")))
     (build-system rails-build-system)
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "07lw61d9pyvf1khj6vbj6p1wi5rlm3wcf6aadym6ynq4qnayyrj9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12ys16z7pzrsd8gydgc7dig2yxf9xis24l9i9yk13s5p884z168s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
