...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "04gvyhw991gr127lf9yqx79wl3ry622kgzy0m12fi7xvi5rgpzdx")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15i44dpdj1da2imydf6jn2ckbwrym6ir2hr2qgkm9rsicl9hf4p9")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14180")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fhv5m3wkw640i0i9wh2yah2gm0jg0i1wb3cjnh342nwnb90rpf0")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
