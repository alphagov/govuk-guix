...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x5sxzgx36jjqk9v9aii3gxpa1p05v4q5gvaxkxih0zv93raxzd0")))
   (package
     (name "smart-answers")
     (version "release_4772")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14gbvx85xyl0ydxwcss1v1lfpqkyhyn30bciyk2j70rycs4vk4lr")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x98ycljhmw094dmvn8370f0zg3hhnrczrlyhpryqhpzl8anjhzm")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zm7xlg6n6kcaa2wkjgcawj9gjxgn38rn295l36z00cz90ms43bg")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
