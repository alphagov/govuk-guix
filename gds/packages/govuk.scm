...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "05m4dz8xnwk220pggj9har4y2qwvys1w34vvm4mhg1zdadkxyb8v")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dnhmn85bc4qy9sy0vpc8mx0j9hcmxcgd6wmlmrr5kjj5bmgwwx9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ij0bfv41aj3kbd1ic86bad7f9avjngcrap2dhz28nk5yhsjdwb1")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
