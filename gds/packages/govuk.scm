...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1iyysrqh8qz6qrxsnp0qdzh49754x238ammc9ancq1q3pipq6b3p")))
   (package
     (name "calendars")
     (version "release_460")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "139d268ys0smqgky3salg115zccbd8qnxwb9ya15c2vx6axgz1kl")))
     (build-system rails-build-system)
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "13a3f0v8hfcb2gmq4y8422k40yd8vsz3xs7k6m8apdmcydhd2mg3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rzfgrrkmyvc331c579spkwgmhf9zx46wkvfxsnw7fl4zaskjrv4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "11c7vibykwlyaaqfqr6jrfx5vcmgrc9pnx29sv3grk7nb6kbra42")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mqg29pag2qkxwnbl7mc4d9bjkjllrl1dr0w868ibk6nakiz79a6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a12g7d36h58n4z2fcwp16c26a4hhzifdjdb31gd0llivj251iza")))
   (package
     (name "content-tagger")
     (version "release_702")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19d4l385mwl34h8kdyq8k3x6xkvdzxqs1wxds62wlapsv41i9b3b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1aaml9j8rgb15lfispv8mhd1gqf0gw8p220ph4y9ql69gw1xh15d")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jgnk4apzsrfa8j4zjpiqnmchl7ryc396kycjlkbld37nbsbfygl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09v35hzikfcfx2lq92crr1gcwba7rz0x4lmj7pwlbcpy4r54zf46")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2819")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08l7wrrydk3q6b8y9hrp2mphv7g88dsxysaqlwihw16a2xgb6liq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "033ahvsj7p7a6ylhpw8jkgmzm1mfd3j7yrj1yk01wa81gm52mk1k")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vky1nsmqgx2bjhsv59w4axc2m8272684vi36xv6ckdhb7q5jfd8")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "01h8y7fbq58b6krq0f714ch7mn4jaizsd3q1r3yx1m7789y6dz3d")))
   (package
     (name "publisher")
     (version "release_1907")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dd0aap5fl3vmsvrpcspfyaglvq1z0vwp6aal2d351m08khcyagz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "118yjdwhpfifn9g5ayrk4k3y6r8hsmhrl2ybw6js0ls9ns8kfwas")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mn6sx0w31axc5bqsvnb52zq5k8rw60hq5y5pxs620c781lyw47v")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01xh7bnfinzvkmfzx98pp7a57amh4cdgi2bxz9dfgidw25w39b7a")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nyj6isxiczmij5gww5pd28g4psbdqspwda09pcczln5h65igmlc")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13275")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ihdn7vnil4h24znsiz707bsnqvw3cm1zny8kkmwmz3gs1141msy")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
