...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3604")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l9ynggciaji32kzjavs6ynvwx6q29qsrv0wrv578w57jpnlqwsr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c98d3wkxi1515a4x3zzlmnscg6i98lycm0fi4i94jk2sadmgnz3")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4865")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l033vaqnl545cn8zsj7hfvpjdb5pvhq6ch44h0kiabm8rv05lms")))
     (build-system rails-build-system)
