...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "14mgmyqa95kh4inx6sskx48x39apqqlwb30iwhn04npry272ndi8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09zgi1xvsahfqyp4axpwpnd8fhaavszxrmx1gryzgg408lvxrs4j")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "18va03ph4h239dyn0zxsdf3swksd72dbbfmq4n60r5z5nsi704lx")))
   (package
     (name "static")
     (version "release_3126")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d34n7h6b9frczbpdp0ck183znygmxqc3mgdkal8sykmdfx30h8i")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
