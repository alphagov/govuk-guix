   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h4yn4p6znfiwmi30xwaa1p360hik3fnll4avyx57xql2r0prhyc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qhjbba9rn9d64izknbjfkzy7h2d4vwzdfbizck0zb9acd3rjf3g")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1q10iabznwk3nnf73wzc3a46665855wi9kabrwkw7aybp6n6qkvd")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a1pbzq8khxzlgj216j7ihdbblh70sdmjyqk7ksdkdcgyhx8ccsk")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
