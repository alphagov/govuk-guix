   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07gsv8s1ppa68ydjzw5421npqb3yzdqa1py0amkaf9cmzfh7wvfx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cj8a0zhcn74ga2mzap0sbav3p423hk007acq6dc77ppf6i8cc2x")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19lm7bflmhisms95lgav23r0xxgiwsrhjbcrxbp7dk078839a435")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15y3hxh5mwh63na16bv652z7l3frdp78kfaiy954m1k8d6whzbjd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pp4h8m5b5vvl13786a4ng8vhxj0z79rbjf1hm6crcjd3l1y10fk")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13183")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bfn23218bq2q0nhlm14zk4xi1g5nd5737ddk8qs1730sny4wldm")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
