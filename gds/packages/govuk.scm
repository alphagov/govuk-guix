   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0diw481g05fdv1qbkig0qyliar2jzvab7pgs1acf6xlxmml3lhda")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rf92lyfiw50cwfq4dajriay4ld1s83b26x4asgkdrazy4mh06af")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4895")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jx7nl271p48275rwjllwhbfqcnbgxn5a8n90hnvsq240gagdars")))
     (build-system rails-build-system)
