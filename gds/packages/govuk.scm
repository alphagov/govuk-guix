...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "18dfkzvif04s6kncbbijq63k79241j68xyz5avm3z5n1a1wd07d4")))
   (package
     (name "calculators")
     (version "release_329")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c4xn4pc86py2llvnva7pghn676jrm35g9r7k01f6l2a20pfvl0h")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ri4kmrd3dkvvc1z55b92m1sn9hwl9184v3l4vaasq9r0v1604ng")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wls50jynxnayhda8q5nmcdbvz2zi51bmkcbpw1zcafvyn51rv40")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1226bimdgfla53hh4fkcdhqii4xg873zq4m0kgk7pn2sgghah4v5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nrjhfcaih39rxmcjb4k2p814czpsq4vj0kdi2m060jqbiadx4fk")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1j029a41xi6zfi74aamm2ya10ailm1fl4fblwn8bml63ih3p1r1p")))
   (package
     (name "feedback")
     (version "release_464")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19kqjp274cwjqv84v59hd5vabqp6wpg33ish4sl6kl2rn99ncdx6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1v6vqpknbn4qq42v700n8f9190s86qck8jl51zp4hmk75hj7qiny")))
   (package
     (name "licence-finder")
     (version "release_421")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "159nwciy7ysp9v9h2lzlq6s53pp1nxmv5y8wvs2sscl1kfsyb3fw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kzqzkwi9v8fc5439s87icfw5z88i55lwmij846ajvqssv69655p")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02n6m41izfji8q083r1jsfgc971pi4j0hawk9rf0i0gax8vvx0fz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0b7g3ns1lichaxcniriha9bd00sz0adkdl8hxgdhw5k1mghs5naz")))
   (package
     (name "whitehall")
     (version "release_13576")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wi6nkwcwywqdiawmswf6jcwql228lxvh0nradlbnpc5dcr7f5md")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
