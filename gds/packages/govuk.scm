...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "13c4qhr0d6nyasjs1fvym7pvnkd81r5hlwbyf8vscalgjf5ch0cr")))
   (package
     (name "collections")
     (version "release_730")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09saq48b2639rcsdjp3lhvh3pwhq3fc1qskxm7614580hph64bpz")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "126rmywrg0yc2wqwnjj5w6j98q7wb9vh9wrpw8r92xzhy3q6crfi")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "102kb8hkybq4w8cs2h9dpdin405b9xql2fl6sdivv22byn0f4n5w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kqaj9jx2z4690rvmybhpq3rxl260gpj2nym4dhyw9q03fxp89ip")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i0i5s2dngq4vmpxcflzihjv5y54wx4za5rb3wm3pizbmx317wqp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13760")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17pwi2w5a08frirmsgx8nh7v7ci49vnxazn76png4316v1gxkznq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
