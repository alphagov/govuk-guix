   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1arplxz11aqpgfssjqi48ywv57a9nncgqggl61m5xf3cmjyznx6x")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sjgyfmbi7fzbcgz8xdc6wanmc6zzwpq9g7ahbb6xc29clf6r698")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_3044")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hj824f3c546liwdx886nxiipfj1303l0ridqrdi0fdwrs52bz20")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
