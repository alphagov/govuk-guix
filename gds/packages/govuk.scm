...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "09p61pcfny00x2qysg7jc7gx8gh72j73240x1nx4nxkc32aj0pdd")))
   (package
     (name "calendars")
     (version "release_640")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wqcxi6yg0q0yd9wlf6x8pqjmrhrc088jqmsd04hlzv03qmcil22")))
     (build-system rails-build-system)
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jpw4mg0ayyshg626665imghn69mv2h9pf3fvgb7xsj7yd55rg3c")))
   (package
     (name "contacts-admin")
     (version "release_528")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15373a26k6s8p9liyaj549f09ad5i6s61vyqi7wrbymn05x49lp5")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "14jfh4yzxvd6k9rw59p2wm9j3rclkzd707v8i28bbiqmbs3nk1rn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "163bfk8ma4hk7cniilwyh0frbys2khxzp9knp4rjqsr99906mbxf")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cfmlka8cpr0fprpv8rgf68j4kwdydijknb0dz22dggcx8kl4di6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18lz1py7zaa80flmnni4zl8w7a2xmyhz05hdyldf0g9vnj493b99")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "104b0cphpn62lqp048gavs7qsglczcx9fbacfbnl7avxz2vfswrw")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jp0npnya8h3rlvln024q148r5hlxjyhadrgwsr8i4ml3kf8nh85")))
   (package
     (name "feedback")
     (version "release_569")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cfvarn8lxyk6n6h9a0jmzf87a9pwnr8c2wrfh29pndk02726pml")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mpkyblqca6lf9a0cscnvj775sbyx40bx5hifxcz7gqx1pni6dik")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yj2aqqkcfsl8c2igzvgc2gp6fxcadcy0qpp67a7pz718mycfvqd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01pcal3hngkx7p14qa9i8m8b4lrh9cn0wrb447ph393d8w775x6x")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13l89wfz286qni7vr1vdbzkrzm99bcpcj47f89ksf2ksg3sb9a18")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "07d0hnjgm93wn7canbpiac5kj7qp7gap30bkchixybbsj0vqagg3")))
   (package
     (name "release")
     (version "release_391")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14l8862dhrb29i8gibahcv34cj2fjrp5448cghqpfv4mzr00zpcg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13l7c7lkb5bl8j3rsl1ih7ls0dhp9wqrks5w1ln7jj1bk9abgj2h")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d4l5723ar5q6s765hbkfacm2sjfslcrrxsf577n257xlayhi92z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09cfnr9771sfasn7x4kpmijqv88r6lk12cab8fkrhc3yiw98dzf4")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "17rhmbwb2bpjgi85svnjg8rj23phqbwh8f1fxjg4z97w6rm20vpx"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13iwbbqwscmpkcbbm2lgf21ara504wxsa86fpzw0zaxhw714hk7i")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1inhr9k4iq6id98jg9b4v9dxy5vsf1rvj1h4xgjsl0v8aki2wyg9")))
   (package
     (name "smart-answers")
     (version "release_4168")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08yyzjxmvk55c300455g2n35qv10bsflhdsnqlbi1j5n43lcfwfh")))
     (build-system rails-build-system)
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "017r527h08w6lm48hzs7fd2mkf0rarwbhl65ss57yqhzf6c071a8")))
   (package
     (name "transition")
     (version "release_874")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06ns28zyaf56rgaxr94v1qckccidb232r048c5f2j7ljwww2drxk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
