...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "14asaabrxc10di07wg9ssjkdal6h6y2d2kfq6yw7dl1mnmyhgihg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pqdsy4flcmvfp874ny7k7cd5ch08fq1ahv5z34609m15y61q63a")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wsvwknjyl1wb6qgscjg9lff88g2njjrl65ql34v92ncyfya5ag6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hm2z34gkx3qadi4wpn1kzw0jxvwm0mm2ar514kn3ri57wr1kp8x")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
