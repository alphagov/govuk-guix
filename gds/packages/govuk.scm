   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ak6bxg479kjv7nc3n7i602z6ghbqr5qcyl0d4hv22c7ghjzlcyy")))
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "14irczpkwxasjn1074zy4hb7kx8w10wmj6ikqcs3ls7pprx2badg")))
   (package
     (name "contacts-admin")
     (version "release_452")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n9vx2xqvp7w3wg47pgmp63a5mw1h4vc5ia6m0zng6q5lsn05aiv")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x9mqxj275vgdbb97ghiy27imxqn4vdhkbb57inmfik551ayd0w9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x164sbfr2irzifddpl24qi364s23imylqim26y85iciki1gdd0q")))
   (package
     (name "feedback")
     (version "release_430")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "140lc3844hcdgggbri8xc1074c1kb4w0xiyx2n6dy8jafdf12yby")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "09f9mq7pwy80yab0891c8zznyfg3ww0h34z339k2nfyv5jcdl86i")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qfml37jpamizbzvi6f6jzdyq3qqwpgkdsy62g3ks7jm1d8n3skq")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1mlcwkbmsy084ypqxaspnspa1vpnknrydkzv1q1bbhsn1vvp63g0")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3968")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15pcq547c85g641bxjkz7mf4z4ypshhhivdi9rwrlg42y8di17lc")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rp45sc4v53wj6j03d5rm6a87xgap6qi9nxbs271fakwl7wgb2g3")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sw6lbq1dyf66pzjwvhljd0nzx6mfgzby21nh1m183hx181knabi")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "10k134pvd330l6rv39ks7dnbp8iq3w5cs7ax05gbfjg07ak860n7")))
   (package
     (name "whitehall")
     (version "release_13484")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10ncq8qqbqgms0kgibri5bi6q040pasqfz5dzq03i435n7nyy4qg")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
