...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0aal7yprm72vg4xcpbhw1vi5az9hkai188qfypll4n7x83z3rman")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wfizp4b8wjqi220szmjw6k6avs7mim95yxf3nx8g4hpn5wj7kzq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nvaf3zb4khcd7jjl2gc0gy2ka3y4i78rmvyflikaqjqri6y4hfm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dwywhs5br7rpfjnxav4r6px7375a8fbyii2a1gyapg98pcna1jp")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yhdrh1v476hx3pgsj9aghd0s5qicm4vinfkl9hb5p7dc78apjss")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cljg0v1s9mvh03rcfgzvwlcc06pc41qpwhwbgcvyi5h6nrvrj3j")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_3043")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17bkimr0jqdakynwsds6kxprvxjg6lkjgkk1k7a5y9r1crd2h97w")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
