   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bhb9sjnysnbm7gav5nn4wq647s4k3iwb6c3q30g3shafm0751vf")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gvx1zlwylp798wyddzhssnmyrqgh9gsxnzw6xajnp8z8f4bf3dj")))
   (package
     (name "transition")
     (version "release_805")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qq908nz71p7qw2vs0j2xmp5y8zsf0lhiaxs8p73wq5kz4nf1fc6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
