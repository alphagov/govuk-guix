   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0133qyx64dbqs22rk8c9skg83kawgwgkbxh4vy08c7j2f1945q2a")))
     (build-system rails-build-system)
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ypk7hg220p0glqlwmzg0frr3gh2r9yymazwv980v3kzc2xy01z9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z1vj43m7a70vzdbglwdkcapc0pd8slajkzzlb55y218s9appgzd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07vfzn1mbpchwwl2rz8q1mzr4kbjzv4isy4qs8d6nrdr9bml2qdn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zjqld7ajrprcczb9m4sslyiiiczp2cvj4q9fkg9pxsyfrjdgfyq")))
     (build-system rails-build-system)
     (arguments
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "02jla9bdyfgp63g40clpf4k1nbv3w431nq3id6j1czjl63s6sqal")))
   (package
     (name "licence-finder")
     (version "release_440")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18wq8qwgpgdvrj539x5x7xpa1lmivxfahc8zjl0nkiy7s2ydbnjb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mw09dqzhszy20sz6bv402kmcj4h9adfps3s7zscqd9r81h72rqj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c3bi1706s1gh8ym7ixbx7c5lvpx860dwwlllb29f1dkks2m4xr3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "05nv05x1pp2k2rpggrxhyxbq5yjp0wwm5n066vc731vvyhg3ak8y")))
   (package
     (name "whitehall")
     (version "release_13649")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x7mgvlfhzlzh7y37dlhl3hfalyz8i2i2zna58rkwwjsj28x3kl0")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
