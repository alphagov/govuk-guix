   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hdldkp41byv4jcswmm1n2s35c16h6aqgl2yly0w1xvq1i2vr8gq")))
     (build-system rails-build-system)
     (arguments
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "13lnq0q65kjxxwfark5j9ak7dk864ibm3s70hrl1hp1iskmq27d1"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "025q3wpjc16k4shz9gdbmwfg5v1ljh75ac8s1ahysbzjgpnlfrp7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14004")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "036g1x8ipbwwsrnhz6nz2cjzqhgi22qd1ka7iygg0p6kj06r3jds")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
