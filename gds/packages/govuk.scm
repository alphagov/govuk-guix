...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gff23dhffkhlk5xzpfz66pvhp3vlz5q76nnw0iwywm81883r7a6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n0lj1icm3w9q8632a6npmfm4wav9g36qzx43gw833pk5jza2dra")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "12rkksjmrmqpk1zyw1qwz0gji2514jwiww5v4z9m1wp0rpgqbvpx")))
   (package
     (name "info-frontend")
     (version "release_390")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zccnl2xd8dqkzsn0vvdam916899gwnsrz95qmfds4d12cs6dr5l")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x3bfwjn2s0jv4m0sfcq4ahf5nhlbdhgdsw8g42vdhqfh46mi60h")))
   (package
     (name "whitehall")
     (version "release_14179")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06hjbyhm7jw1ii67pj9gicha1ma63yjw9c8vpj4fx275aw5lp7yw")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
