   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cxcn8bgvas7rb1an07n7ybmrw7jpvmys19i6fdwhhwma74972sa")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fn6wjl29nwqn834ywnhz9gqi2jfrb3ck8ss6i2r11m8dhrlil8a")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06f10pcrn4fcq7s5v2894c4dvkdd19nqmikkg6fpgnsbc9fvzw3r")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license license:expat)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "080kd889z93bcssks65zll2f46hsq8v8w0y0csgh6n6yb6y8mhgh")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_2005")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "127lryg1rag0g0mpswqlcxs7sla27mqds4ynavzk78sghw20f7m9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h2jk1mn2rzhwnaz14v02cl2rhzd3qs91xfm1pk7myw4w8hvxjm0")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0xjnlmf3k03hs1l5gfy1qrhy6rg25ls41g6ygyw981qvr50vnxjg")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13635")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sifk30jdvq698nyr08jw7ml6ji26s4bv84szicb79lqg5ahwrml")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
