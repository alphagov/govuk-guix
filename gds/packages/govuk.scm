   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jyvhyccbpfn5kf4xrdnkx4rfws284i6gnhkmds7by97zgcgdj8w")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "04yp8bk3463v8gc95v81b9y50scv5aln3gdi7j3d0w3i80apwf61")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00a1glzay4w8z047sibh7fr3cbzw4fb3dfffwbwslyd31jwypkc8")))
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "00rdlf6a8s8lakz86g520qaqj43yq3nv79iq9fwx1rwh97vy8ayh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ih2ipvzrc6qngfs6alpfa6a6yma7vganzwl955vwdsy0vhgvfbr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
