...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cqvpaczp6mfckcdrslhkjvc4ssbq75qi9ci4g4f4wic3921bc0b")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sqi16ahj2lsaz3pkw879lsfy6i9z2rli25bnj4zc8ia2w0n9bfb")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dvdl50axibfylf5d9hnmykapx7qzl261kynv0r01bdxr3g7l308")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xmigxb04a2fgzcjpfxkhym5g5w7nisrva4iwirk63h60a1ysy5k")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d7d4bnyifmpm34w1x128w9rqsc4s80r49ysx1vs1bps3vwvldlg")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "146wc94gsj4x56mlmcc5h2ighccm24x34s8qynddsfky3min0n8y")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "05m7fkqsw2451blsx5lm6b29bp2m1j1h0j6kiyhhm85z3br324vs")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v9vkiaaqybg4dsj4jh0mh5a7zsrsiapgf1gi168ynjc176ib11c"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xz7nsq4h8pmrsa164al4jzcihvgca09b8ynvf3790k8jma5xddb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4144")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bdj6dxb7glqkh8lw0gk79cs5j3rw3f0z2cyv625qnnr983rmb8q")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1d9wgyzj7l0z8jz3hq1l80vfndpd3m6jxz8y82jmzj57358rgikh")))
   (package
     (name "whitehall")
     (version "release_13813")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cnbhixqwagbip2c3f5iyk2hys7n6p0jaqnd5278vvcx5jymzfga")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
