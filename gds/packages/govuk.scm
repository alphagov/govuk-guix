...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f7603xnbysy2blnzil25dcq3kyb7hvr8a33hj7k089wi70g19h1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zwpbb2rhkgi5iry1vkllzybw85zha4k6qykh84d8832cdcnswz1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4198")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cj7yfpw9pndpmc21jrdj2h3i44lmqss4hcr2m6c70m9x7kyvbsm")))
     (build-system rails-build-system)
