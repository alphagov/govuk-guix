   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11np9bfffhishg0ssqzzky1cwbya99nixkgshs3682gjfwjbp7mf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hhkqc4w86a8qcgqvm95s6ws9z881alcw21kvai8n3v5nqackck2")))
   (package
     (name "content-store")
     (version "release_672")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i8z2hy4l2a9m1ic1blz6i6y6i3cqm4cjj1ca7p0146ff56syzd7")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k5ra0blb2z9fx0mb132sci0fsb280vfvb4fis1361yhjq0ffx95")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1kd231kx1k6jp8hgb052y27k8g2k9xw552jvycg878yrz9nfmj82")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qawifmcw9885nns21ynbgzcjh5qvrq2pnm55rf94g8mnmkaisps")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "110hi4jyzqkyxllf2q2rlml5d4gfbs3z7glssqj424mnkykwbvnq")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vxy7cx94p1dw2dz4d9a9405zqk485zhsfjg2k988x65dpzdqpx1")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3794")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n9m4vihh4jykc6izxyp8pk7p230y6l3mr3r63af1y7nx8myvsj6")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08ffl13liiy3d714qs7yh2cav0pm147hcsy36hy65b4812fw5bw9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13113")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19cygrfbyl68wbn2kwk1yhim6a8694vn755fim5bmlfwfcfhyx27")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
