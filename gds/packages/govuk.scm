   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vhv8bsqzpvq1svhh3n52px55yaawz3kxlsashgd4hfgjww2qyw0")))
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dkxqzbad7qz3x47v4y9a7n306krhi8vz9792jlmfa5ix8wsy9x6")))
   (package
     (name "content-tagger")
     (version "release_745")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vagr2d13ba94fvavnhm2vhfsq3acmkchynd4ssi7y8gb643bwgn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19mbhfvfw7nj1smf01gxbr215rvvy0lq7dq88md7asxh696vd4v5")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xscw0z0aa6gqnniak4ds8zbhhzmj97qf8zgfg0gw81xq2hhsm1k")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
