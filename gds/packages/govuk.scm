...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "136cgajl37lvs5by6kaqviq76jp6l0j16k535mwxxs4lk28c0ksj")))
   (package
     (name "collections")
     (version "release_652")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07hhdsrhwiycphjp0mzjmqmj8i34q2npc3c665zn6k4qv57w6a4z")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12sy3jfmnrnfbw6brmyrabf6v11gs72qn92s1y7dpmq1ki25jnc3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ix4vgjs9hzag89x4hm8hdc7pm8yyd1nwfj8c251502sp0xgkjyr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z6aanjbwkbx52972fq2ckbsjahmx5xqxry3n1ssfdj6wkk1i1qn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license license:expat)
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0q7s7nq3fljs8wbm56g4rrih0l4bjdinma27irf6im22kwn4j9m7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hp3yjx225chgdlddb9kh4mvhjzxk3lm0xyyy4pzk8avn028zkij")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "122ss173jxg539xgvdfdy37faayh2lxhk3dgw2i3m5v3j15zm923")))
   (package
     (name "feedback")
     (version "release_474")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zj8awi8p7q68k6qa5zv2i1k4nxv1xi723cicgr3m987vc8j04k2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yj5mvlc7r19imi2r7pb8644hlbq0zjfzxqnqvkl63zdcbc3d9fj")))
   (package
     (name "frontend")
     (version "release_2940")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ym6qc7ciag7mncy2jq69c445669lnglcd4512411n6mnraryqny")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "158bmgb30y5cgqx0pqljhcwkjwhyh70v97kn6438kmvv2820xqi6")))
   (package
     (name "info-frontend")
     (version "release_194")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17vay4qzfmadd0r5xrqinn5y7fvyc1pgrg4wf4f8b3ry2glvd8iy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "067bgl2cm1lzak5iw8a9hsry401b4kpcaqijlkf3jhdli94gag65")))
   (package
     (name "licence-finder")
     (version "release_429")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0926c2h1lyjzkmd7cmi3fmgnzdsxwj5i0zki1hmpww3y0fllif9w")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "10giq36px61flwzhlzwz5kdsj7vzaq2srxpxs912nzdsm3lk56kp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vy3f9kxcw0q5qq2ix1hswkqfkmw7mqs0m7w7xsf7w3lmr91nws7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "01ws8fbqy84hmsr1wh21pc2n0afplaigg2yrrvxs8463y4x919n4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hi2k7jnqsaydz4h3maraicrdncrbhzh06bfg4gzsrn5q9jq4hkj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lrsr0vx8jjpbryhzkl893682fykm71l292irlygy8ggmzy9r7bp")))
   (package
     (name "smart-answers")
     (version "release_4032")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01fkfg7vzdz6zyjamp78q2lqan0w5k7rr0xvw6x0igf0w10frnrp")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1w4vhdqm31pr0pc8rqkp4xy1s26i4ca8svgjjqlmnvmjkgk3hzl4")))
   (package
     (name "static")
     (version "release_2926")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08cvr1xfqmslkapjb6k68llm6i0hcx8jgvkk6fc6327y7rnh77dw")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0515f7izi7ynlwf55psi4r6331bwil7mbym2bix31g622rs8m1i7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0npyf4k1mxrpi4kq375b8wznncyd48rx9fn4myr5npdwrrfcbwnv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13611")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dwh023zxhdig4idkj3yq26gljn5c4swlq65rg8pwkcswp40qh04")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
