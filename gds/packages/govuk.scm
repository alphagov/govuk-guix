...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1apzfl2wfan9vprp5wjas7a27wjy2jsxb5fn7wxb7yj7nbavndf7")))
   (package
     (name "collections")
     (version "release_902")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wq8i40755wn3bjrlnhhjv59lw4i4qjxpbn2rl0l7y9vmkvnfng6")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yklppjvq5fffkz8k4z3xjv80hgsln6b8cld96zgzrky4s1gwaam")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gp00n5h2yw447as79pi5kihmw6gvsgfw9lsd5dg303jch3vvcg0")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gmi46y89q55hgwwp1nxx8snvqgvc43b11w54m10q1ba79iaa121")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nhignyfgbx94hzx4r1sxhg6qhqxfklbbnqgxwgg44nmpwada5w5")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "11zvgjl4y7337x2w6f900r3r4mv6hly6sya2nj5p34n94yqljabh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05vhyfkbh544i73b1nvcrc0jd8m3d7y73rqx8ldy8vkbbg2gv1r2")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xxdgfa36h7aar11vnsp5aypx9mdd4n0d5p34v588wsw0bgzw1wa")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2037")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x5msl0vql1g4mx302x2kv14z6xhqdvrv436jvq6my4w9z14p3gy")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
