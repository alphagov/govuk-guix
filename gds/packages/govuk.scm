   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kyizghfksr4gvzsrwm4qzyfmd525kgcd0ngx40hflgjyndwnbfk")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mbnywigjaz6hcvvsyk4l02xkp65j5c8wmvrag2bms46s61dyjd1")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mjrj5s6ny7pn06zkq0p3w2nqabj5xqyzgykm762sklxf5fxhvv1")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13815")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d2nrgyxkiyamqlxwnll7s3z35xxdv1zwixnzbnzg2v2205r2czf")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
