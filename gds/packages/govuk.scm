   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bmbp4r3ygwn643a3ybydi8jhxbyd6kyy5cgx4prppsn7mhh5hf0")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06kjh2r9zdkpkjhjp5yv3xhdzvhm0klpn5s9nhpn4231cn6y3v4s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1577vav6lmgr7lqxajvp3xpljncggpvsj0czvwsnsiv5wiljs9pz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vymm82rlrxq5qrpzq0zqsdfv1qrc4wkjwdzr6vs7gwwr9rrwgq6")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ysm7nzs6qjfsq7bz6w3vz2wbx8c65zyay4cfwkaq14cfr8zkvmj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08796lv1ncm2vfzsjkwwi7mp7h81v55y8qgaz5kr01bjczcy8jah")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pn87z30q45khlbjqz1grr08k4dncx1s3s2j07y90rj1j3gir35x")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rg0jqs7s0yzm4jr42n5sxv8vrj4sxdrllsh2v3ymvz8iwz2h7id")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2639")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "070d36c2gjbfrf3brqz4fnzbpqiwsr5fd1d918qa8n16pn49b5di")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d3cjidl30pykhq78zwjpwdzx5b1dk7796bdbj9wk6a1zw530xwf")))
   (package
     (name "whitehall")
     (version "release_12912")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03bcd5nfhyn1x3l5hz6gqkjz3z5fvxkmd6261g88yv7fh9d49svc")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
