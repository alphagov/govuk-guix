   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z5cl7lw61wg918p8i6b7kks4bialkywc2jb9qqqbahqyrzkv58b")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bpgj9gb4x66y3kvg6yan0vcni8aphhdmv5kl479rghjib21vkys")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2650")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02zqn216lzrjddmgdmkv4hwv9cqdy3hl1c9q10a4jivs2cmdpfkz")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
