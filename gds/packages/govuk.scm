   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zlgzd6gqvw1p49q1c9bhi7my78z2vb1krq6m6x3bjwgry422zq0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jnshavnisi8jx1qmhf94bxb1fbgv9c37l3gwn1bpnbadwcfrigf")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0az18dm3n9bvbn8a1vlndy7pcb8nngv316k8hdqc51yfgiiqh95m")))
   (package
     (name "info-frontend")
     (version "release_77")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14zr3803j5valxxvas0siwg7hhkyqbmy6ws1l7xm3cgpnmb5569v")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1igd05mqcdspwmqf7y5x42zczxbvkw3z8r4vxkrxr226qfiivc4z")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3644")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p0fny9vmfg7avxk7zgr3bdf08hgw964rnm2zggd4w8s8l279yi2")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2609")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v8r4mj32vk9llnvf14ypvpy530rg0gr34sgx316xwg1g6rj199k")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12862")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1paqhw6xzxnsx3wxwfdk9aqiaz8ahpnhjwamwbgba47h02wz5xfv")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
