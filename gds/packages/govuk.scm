   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gsw75iyd9d78mdx19bxflp4hmjqf6qrpg4405c78mrk784nrbd8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "091ihxhn82sxdw3qaakggm5kjsplqvi2rj0c1qqn9figvsna4i0v")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b5zrjbv2xdhyy2kyh1fdn19572p7zhfiq26783fnzyvk06pb1qn")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0shkq6q27s8c567xpkx3dnjvq114yxhv5kizhpw9lyd77j82cwgg")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xfk9c59m10gd27wr4b2ksp84v70d9x6r2fx9v5qjidjmq84ryms")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2215")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06q52s2csy5gzsy3mc988r372acpzr5mzmz8qx0qrz3dfg8ykbwd")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
