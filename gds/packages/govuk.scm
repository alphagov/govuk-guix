   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ypyc067si6q0ad34nh01c3r8nxcc75z119mi9lrs1rlhd65lhx3")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lr1pa6w17hz96b2dbckwyzsl9b56093wixlvpw9w9dil5c89p1i")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jh1s3lpazbpm6asmq7mrhh1dk04jsx8mjxgvn15d70c7xvq5iag")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "07d786fvn4lr11b70y67iz6psl79fr4x9zysyv23w89lcz2rkma3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0szr6pxjwvx2cgxrqr2hw3hknwl5swfi6pvkn39yk2vd2xmxn7c8")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "06in9paw34qhgwq3i34a6mlyrfq7apvhhaf2j7kqkzra6rplr8qv")))
   (package
     (name "support")
     (version "release_766")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16yk91azfz7n8xlarhgdqa0lyc4v4rfiwvm5vkhx1r3834b4h9yz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "188h13ppnprj0jprdpfhj6dvbshp0fd2apnhf2iwk92swmmrw0lk")))
   (package
     (name "support-api")
     (version "release_242")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0npq2gypcaa50sic3jxskw25vcjnz1bbr7arb0vhh4a5n7l2885s")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13899")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sns465ayna8fnb28l0n71xzc29j8h96b9l06jg9kyv919wh2h23")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
