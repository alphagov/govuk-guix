   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vy9wcl6ky0x4w449cvxbk2ra1fpz19dlcvwj25y72jwjbqcn4dn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r7mbgwva5q2xs74ghj55k6jcxq80isrd6crsxcyy0vc66hzgigp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a8agwbsvgipbnvnvjjvkz7yk4wwslp17ix3xvym4a1f744z1gnw")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
