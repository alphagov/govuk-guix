...
(define-public bouncer
  (package-with-bundler
   (bundle-package
    (hash (base32 "18b0m0bhfvfnid92mr0hhk0w845585zgvfxxh65i7nybsd6igxg3")))
   (package
     (name "bouncer")
     (version "release_214")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vlc26lqz7k3cj5mxwhxcj3zr7sm7hj4z383lph9jck8b338ipcf")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a7ai413dxky90z8jbj9r3dcqinhrhdng3lzwaslgwf4vkk8mz6k")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q8fvhvjj0r2iby4wm4dkm61q85kdbknbja713zhgvihc8bmym5k")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cx6hfv3mys0agmp4fv4dfg45jpqqp5ddcj2gd66169zynwfm74d")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dxja1iw43dqmy7b5b6lwjpmmqx5j7k89cpvhzlww6qzp5s5gpa8")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g8vynz2sgwmv3srckvkfw13xlrsc2gq537kn9d5hlkrd7kbkg1w")))
   (package
     (name "transition")
     (version "release_799")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zsv8l9q0xa8xi54q0qb1scv7f38km1b2niibfmhcfvsrmn5rd05")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
