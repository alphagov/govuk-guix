   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y7awizvz4w6yzy2a65ph563dq8pxgv6x8kqry8v8fmyqj928jmf")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2840")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q1sd22hwh264i9g9zpgzf4i97bx7k9bbd7qljhh11k66d63j04m")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2811")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10p2i49h1gml78izw5scj2nzrr6k6vgvrh4cpyvhrsw17idhfigb")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
