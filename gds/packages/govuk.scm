...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vi1rzii040flk3wl2azpnq569azwjqaw6vg65ic5n93574biam2")))
   (package
     (name "feedback")
     (version "release_538")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00n2gmz91q691s6rca49h8mxp10zxj6nvgmpsnh0vz0s6yhb7644")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13764")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cq5m9gkajhfszk5iwd3dzvpnvc89h384vllmhaiy7757jcw3qs7")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
