...
(define-public authenticating-proxy
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sajq7rcxz0idicsd9lmqbf55n5ah0slxx5a8daz351bhw17n2ss")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xkzdcfmyafhpy900qnzrwxwpxszf3kgpi2x4kh4x1jm4j53yd8g")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kg8xpm7jg0pvx6r2kg81axdw08l1r8icz4hkp4zj0hj7ljz637z")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zb8xzp5mndd367vc1sqlw1pamawaxa7agyjmq559b6ng9agyq47")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z99425y1yxbmhnfglddxc5k3b1gdydvypi67iyxqgln8g3h5r63")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mkginmgk4xcf1r90dvx6kjsw6dz5lldyzmg062n5wzha5ydziiw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mgppl6db6z9qp7f6gjcyixw619d0pprlxcpdq0clpb0s0cysil2")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h3z5w0xip308dj2pmlzb17vsl5sfy3n9a5rm92i95qpgjii7bma")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3837")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i06i7mzfv7wzlgg8n94yghd73f268lybh3nwz336zpl4da0j5yl")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d390sf34bc4l50h36508faqq2na1al8731562bhz06hpzgg7fm2")))
   (package
     (name "whitehall")
     (version "release_13233")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pis8pmnk8nr0cpsr7lc28313dpqz5ljc38li0nq1iaah6782fsr")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
