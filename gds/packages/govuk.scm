   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10amyjkr37i5wh2gshq8p1nnl0k6dkb6hscd5yi7cc5qq2z5i854")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "12x5r1m003dwmks087k0lsb95fldj75549cqpvm6gpvqyz8pd6fj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bx5bsk3ljvms12flbjsk4b9qn3iy7f6a90dajmwnfv35j0hpfax")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0liqywn4p66lk3fbn8vah5pm5hbqy1vhn9vyrpnkfbyhk4jhi5pr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
