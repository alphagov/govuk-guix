...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kdkmyd4brimzzsgl71wyjk2w4mjiw0gdrk2080ilb96nkb7l5lh")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nn02jhz6hrf54098sgf85vx97kd48pbn9qsp0nhrzj3cykxr9qr")))
     (build-system rails-build-system)
     (arguments
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qkf1sj477nhapm7jy8cw9yyqr2mnd21y8b26z0c3jmb2ahl6633")))
   (package
     (name "info-frontend")
     (version "release_525")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pwisg7fcpw9cfqias811hafm92746rismcg0jzav63aqk66wqjj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qcblzysfignv9cgb3v054iw01pinb7x10pnmws2d3qvvlmq11bf")))
   (package
     (name "release")
     (version "release_638")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1llis6v0pwnvjdh1y997kxxsq9nh01rd4673apwsw8l7l9gaalc4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dq1br46ngzjk072vilwwd5gph0jd7rn9vqmcv9yzapzrj3bwf4y"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00lylwrq8jwks36cmj3j7fmpmpf9lpkb193jqzv471lry71qbfal")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "1k56nwdaji842mj2x89xfdf2wlqsc31bv8a65r1xna6zkd7ckz0h")))
   (package
     (name "transition")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0giwn2j6dqx2jfbdx8cygpx6ivc5v0ih3bhchh9jd90qh1qsd5q3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
