...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yprc8lq175237v9g71d5yhj6sz3h1mlyl02bb0v8nvy3lcyc1jq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01bazs7l6fpz7i7rx003qqhm97bw58lxc3hanwk8i8yy4kh69y6d")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1q69pjhwvm3z213j5rx6glc2kcsm6r28z14wivg0l3jznk17vsr8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14485ry8ndn6z3b5ldg8cxjqgg63j8qksfdbp6dfayj6i2h68s3x")))
     (build-system rails-build-system)
     (arguments
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qq2v30mszz2qi9smiipba9kl11ir50429hp9ghs8cbbzphmpmkn")))
   (package
     (name "licence-finder")
     (version "release_736")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jzxmjk7wc5zpqmsfshjk8kfimlirla62i7jpigggbamxrzxpmp2")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0i508qqv45pka9i0kl12k73j65vp7kkwvax84lrk4iikmlkiyscv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y7lbg0xga4k6z0fddw45yjjhbh82plvw5b0acmvq2frcnyydds6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
