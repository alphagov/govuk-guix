...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x9dbjklayaizymc8dcrd1ixns20mhr2daka488hpmvis68gwjjd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h7vsq3j1zpgzfnq0rqzvljnf2rp26r5xji9im9bdi0q5adi138z")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1adc30vfj4hwxhr1wlb9vf6m23pgbb8nrmb8h4vzb090bbhhf669")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2634")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ahriiy4ifslm5m7vc9z81g7x37frzkjvny9j91vpqrkd9jvcw94")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
