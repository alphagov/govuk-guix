   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1533vrn99p4wx52sqd3gri4wx1fvy5zr7ii3xnr917jriryw4g93")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1646fvfnaf68wzc0fyfq2lxn66zkr5s95bhm82pbahphviaqj0d3")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05qd9a23j6wlhm58ijfx3hwx5f5pqdnb6gim8icixzqynrn847jz")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15y1wi5ywwds1sw7y9mrh1fykffalpkffj36a8024p19i51hb0mg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
