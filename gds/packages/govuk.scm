...
(define-public content-publisher
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1528")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12qqrkyny6zy4993ds7diplr24hwi7q9gfannql1yr5gsid2x0va")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "181lw910s5dmb3gzcamlwaj37jhjmv4hgdq09g4bqfmsqccgv42a")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0dmmif7rbyik4rc3qy0ngrbpd7krkgapxa3ryijqnyym8kg2pxwy")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
