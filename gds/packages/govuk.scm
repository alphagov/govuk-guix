...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vkcs6hr81mmfzhm9lq0hm32mplnm1qy30ah9l2q8cl4kxi2n0jm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01frmd7rwn30p9s4g8ip9wdr517n23ikmcfpcabmzk6pky6x5ifq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ncirpqvyqkmbbjhg2m1pqb6ddxasvimr123asy6vapi9f3d1s8f")))
   (package
     (name "frontend")
     (version "release_2852")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fr80l59g0i7fl6dv7r6m429vdrk95paxy031yz5wqfh68whm18l")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ls63i2va5q18wnn66bcyxdvz692jn65zlsf0bgvpclqq08363pf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ylipdczvpfk1ckckznayg55h5yb7a0aq42xmwp0609p26p0rhan")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
