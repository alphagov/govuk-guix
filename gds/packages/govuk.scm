   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16b79szycs0j3b9a6smhkgrv6jy0qlg6yv1mcjrqy215isihsqy3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "123d5bdl0f6c99jyrkj58pqfdd7mbr4y1lsknlkns19b0k52rqv6")))
   (package
     (name "frontend")
     (version "release_2960")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1881sgj14yszagxnyz1jjz145jn9i85kymwvd4lfzqmd0jmbnqks")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kywr6q6lh1bfklpa7kcv84f1nn7qb8h1qwnynr3fwg74zfmw5p8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w6is4m6acy24jx8f4kn2rgpnfvcsyanqiy40kppq7ziamljvj6f")))
     (build-system rails-build-system)
     (arguments
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1xih47lhx3g68qdvblkgb6i08nvvlaks53n6pz0745zdp8q32qqj")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dbsbqjs7idm7n501f79sgiymfvdy35d1vjgd1mzxhpxsrv756yj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19jraiiagdkhnhby4aiz86qwqrrjw0nxyq39ydzmy4apcvqkx94f")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "18zpjjzvd0hy3lp6k92h281a9m8c39x3zlxz5chyg43v0pb3lxgn")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n7c40xnnszy1riq6pm46m54k2r5kx6nqnf7b882nn7ahwdxfpwa")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r664ykxd0p5v6f3f037rwxc0rdcqh97yh2a6ld9lw2jwa893y94")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18v7bvhxw0z6ylahwz1arw1y1mf14q8r11hkbqn7syf35r6x9xcc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4063")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v6g1zlgfifcmjzmdgz7lyz26sby5k8mwxs2z7hsvq2lvf8grac9")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1769gjb8py734i8qgwblh2nb2ld8jsswag9phmvy4z3rhp5w5sa2")))
   (package
     (name "whitehall")
     (version "release_13665")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kqnb2zh0jhf0w9ylcm64f5gqxm9wdacnbnycli3ylm8d9vmr680")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
