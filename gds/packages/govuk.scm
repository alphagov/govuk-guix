   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l9ij6y9951czf5ih5ja7w6v432zsi031fjbiryhzlw42azr40va")))
     (build-system rails-build-system)
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "03sdlq8ncr754mqj5005hc7w0yxmrpil56hb0y2yx54pn3ig5qp8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rqv5h0dqs9j9grckrg982jbhs30jv37nkh5mljdl5wd84nribpr")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hi4jkrg5nyvbq3181fq6ya8jncz3r4n1ra333hkl5f1p16pyfn4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zm9r47ny1r4sswbzfs4znrqwwmid4bs9vjcb17d66fr642imj2j")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18m075df0j8kqnlidyi550rz1c8d2860pqds2pskxwrns8nggwxp")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "004kyk3lavd4rkqm8k0w635mpfcqy8l53ffg997m9dpyxlfav24z")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dni2nvhx0jgznw57svs0396fvi40qkp3k6mzzaqmv0b604mhixj")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0qdjx46n4wij6ikcy8kj7dmd4wp48dic5dk7gpi320hd4js48n92")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
