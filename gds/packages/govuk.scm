   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1la1xa430i1zg45xk5gmjvfwqym0qpk9nkyrg22n9mfhazbsyraq")))
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vsfqrn8fwnaxzwk10z9h0617pi565iafgpl7c0d3vrfdy5jhl9g")))
   (package
     (name "whitehall")
     (version "release_13238")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00cz3aap5w00zfg00rq5ywva01ayykm3wkl1y22zbxa5lh5gcarq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
