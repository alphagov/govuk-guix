   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b7cm22021f8qwqvyv6iyzishiqgcfm1mrxz905asf3mas42zxjw")))
     (build-system rails-build-system)
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "1aip6nzci6dp955kfclmg4yvarqfkr6yf4q28ykkhkl7skcvll93")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "158zk8xlv851pc2kd6y39s9zanry5xnhgmzvjxsd22b3gbpdl6qh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jk4z8vsgkiy3kkxmfdwpwn2h3r8rlf855ylkh4nvyl8x0fm3acz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06109105i2s2lkimx3yf4aprvyp354ahfzagwc1iljppm4ixg7nv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_1952")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ma9m3xc04lr49z7kkxb1cbm6wnvzgidvhg4w5h3amx1q9r3f3ap")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pcvi75b96x5l8jhl9ghrrl52ac0zwsw30z527sp518ipvbx91iy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "16l2qb7fr5v1rzi3nvp8mr5qi02q6my0k5ib45l9lcb0lckpnyd2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03i4b9ylbjniv7cb1njaykwljbh1fx7f97q8p8myd6rwscv4zz3r")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3943")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "016j1jzps9lg5ccy19ac7by4g3iwl6drpd8zmi9ym0gf6r40s0jg")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jg6iipjzfzk2pabwv6gcw3pqsvn5sahxllw2hfivira4kf5f89l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13428")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01ibih3vivy0ymnw161b0ybxp9fkq845i2bakxdqb7jk8j8z9775")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
