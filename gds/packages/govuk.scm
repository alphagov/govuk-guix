   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rhqd1i29zdy7ihc8jwhlnpsji7g071k8gb64hwdq8ylqjsak4nq")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0slp7r3jrmqpgqqf3krq9f2nlxbbgvzd43frv0dhkmjsyqazssld")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2742")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hgcd9jxqk7si4flv90ijgv8hpnfidnvcrp5zxi8gm1lirjhm2bz")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qa6ny41qnrmip2mdpxnnxbq48hz020cifhazh2kjasw4blps1py")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13064")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q5as3fz1dfansj3hchxhz48w6i7bda7gnffcyrnyb5yl60fgz8w")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
