   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wcri4pnqzzyjjkppj9avlq80wdgzd3qc949krlvcn50qznd8m7f")))
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s6620w075nda7f8a7a964k4nnw67b48jrs5cgamviy6wm3bsd6c")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nnwx2f1w20z9llk96sri12s6iaqwnnbjcqbbc953bvyrzvrm31h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ygppjfgp6vp6z2b2ba37fy9v9mzhrd7b1q89lkp4qp0fnf1dprb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cwc31m2l1p5mpmypipbj0lbmwf5i75kbfdli4wj99ph2k6av4vi")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zcw96b7sk7gd188dn5xvny9xymnvw9b9ccbpfdbgbhr70zyzjbv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a8i1ljw78jb4zc4qjgmpf517j2q9crk2k4skj8f902qi8yw3pv5")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
