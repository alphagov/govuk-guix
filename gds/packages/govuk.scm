   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r1dj1zc1nryhihav99qi6f77c6272a724mbm7cal75zic1n4pp0")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15xky8188137lcjlrgx0bps81lqxg5mbzswv9nvwa73ggw1rya6b")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10yq0flnmhlvf70fapnc1yijyya39pjjk1cnlvhr2g42wzac31zf")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rc65mvz1rb6r72cgjylm2kdab0r1k5bcpyfw5q1rhwxf3cic35x")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l7msyva0s8nsg09fg07d81h0k0h9v2r882vx5bj7gp7lvwc7vhp")))
   (package
     (name "publisher")
     (version "release_2327")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05dkq3brqvsn6s5hnflla0i0d7a2fv0drikb4a5xf1g9583wzx63")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4850")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01sgdf07nys7syamp57xq8b76y5yqy3f315fj72hcdh3rj2vyjp2")))
     (build-system rails-build-system)
