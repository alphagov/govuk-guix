   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cmg9j37sa8cvhmyz4r35li3p159krw4yc163w03r22i8nymshv1")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dfaj6yqswndw447ga7xqiy0512ygjrjvknfvp7lcvb68wrdnd3n")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16vnnq6m039vlz7z5j6r61pkrl7m6hxbxlgr6803c13m96b3rgmc")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
