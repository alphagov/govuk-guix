   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b000q8921rrgx6mkpy1gwjw1dq0q1a6jnj7n5lhknjn5s75i8xw")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dzaipnk1qrdm6lqlyvcv8lrc79v9xzgdggfis9pa0mmvabfpnd8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rf5fl7arb3pfl61x6n7aypm8905xqhmisdggkq452kyxnvw0ssx")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cbshcswm70f2zvvlm5pl8n10br521j7hify6z9h3gw8ax11chgb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vgdq8y9m2kv0kqix96ymf51nw99h0bsipcrgi9cpdf9vxddxja2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lflbw4jsgkhmxg4slmdia46kwqjnqjghqhs4hyx851pj799khlw")))
   (package
     (name "feedback")
     (version "release_829")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bis1qcmx11065zrwiq4v2kyfs5npl1lva78i6qwrsx7195fqk8d")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "04h3y2v8mr4gzgn4sjd2qw3wv7vasg3kfz18j9vjnl3s07bb9rgf")))
   (package
     (name "licence-finder")
     (version "release_724")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0brnxdh84fvj03jd8vaxvfq9ggbl3zj5r52f3bj9y1fyqhkav3ch")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cpw232bayk2p37ynjbws6wnyzxgn7kvzb531d7bn0pdx3hxrp3l")))
   (package
     (name "release")
     (version "release_596")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b1jxb3b45xiy5bw1f4mmx8ygi83gsyxm9rzsyn6s22ahk57243k")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kffkf9jrp7l9rh3g1h4h3llslw8i4i36zddbpfmhs522zi772fy")))
   (package
     (name "signon")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01hd29xiqpvrz6mjfskqkc4ch8h3rdp36n6m8s3s385p978i7qy6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kasfkvkr619v54dfx85y79a2wd2wmzyf6dsf4plwfxhp6b39cpv"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1llnssdbncpqxxbmwvcq012jndlfjh6zvj5zk0v1cbhmhcgqlqgb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
