   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iy31gq560lyh6zmp53dj5b7nq5qg7xhblw7n7v0k7323v3sf1h5")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hd9574nbdgvyw1bw3zrbblsjz3wl8g1rbdws0ixw19i1ka96fzr")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s4ji8vpp79zb8lz2m50aclmdv7hnz6hkl9ndffq5ccfgsaydanf")))
   (package
     (name "whitehall")
     (version "release_13797")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qaazv05ypwn3p67i63n9fjg8z5g2iiij0l20yvhbvgl7klrmfk1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
