   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18npjkz2ymlvycw19vhydd85fwznrdiqx9753z3j90nrnspagyzh")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sjgby559lvd0z0jfr578fs7jfijbirrf96jbwi22wczn6chkxyx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11w9h68brv339z24d5zw3bjdndq9wljl59w4mb05rpifjf6vw284")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wzir7svkv6sxiqlsvgfx0j24xp0g7892mqb1x7z3c10c2rgnh8d")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lqlirwzqx66rj2bcsz07jccilsgw4c8i0mhgikgchn3p8w7i7s4")))
   (package
     (name "frontend")
     (version "release_2765")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h93dwhc4mvq9q28hybyp37m4wc23mqii1rb65nxpyjfkjz119q9")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gy606dpfxmygr6pyi8kgrmdv2lkjzqc02axkymi57vvasbc5dzx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "193vsrrdwv276k3nigp3cxdpvg0yn852c3qhxj3w306icpb06h3b")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3788")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0whw3s8kj6lfz7k295y7r6r07ng2n62rfw6h8wzxmj2s17vzbj26")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13088")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0aq1mw4s5k5wpl272xhsnnfxdcc6qhd041745qg3q4i5ijqbwwvk")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
