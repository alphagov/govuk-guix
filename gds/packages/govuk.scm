...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "13j39rfikj1ml9ksqqhxmpa2cabk5yfiqvx4mk7vwa3cfdag9v7d")))
   (package
     (name "collections")
     (version "release_473")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kx5xiya8l9g7xy3vkaknwhqhdhl0bcayhcjf9wn8cxs1s2bibqj")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "140wnnb1d6syavib4zwdvfjjg189xcrdx601y93gibr0gp9y8ad0")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mmk1zd8w2czxkxmnrvxq8dr9nmhy99ww4kgb73c08vf3ss33br1")))
   (package
     (name "frontend")
     (version "release_2860")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1paiqwkciaih2vcv0r2r2rhm1f2725xlmv9aawxyih62kmnhvgyn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0h704qf94q0bph8xb5a10s6jd65xi2hwcl7qn783hnvv50v0gnpl")))
   (package
     (name "licence-finder")
     (version "release_359")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r46r85ppfikvx5k2ns8kh7kxxf26bg1nj74paka3is9g34j9xxw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r7p11v12fbkd73s7z44qip0psv60jvvy4hznp5f22n3mh9ymccy")))
   (package
     (name "search-admin")
     (version "release_154")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y89ij4hlna1is5awlz3d1yhy20yg7di0rpqrh6q1yk4r8cwvslq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "17y2n1lzimi97bi2sb0r3ylrbn5y3py07xx5gqnfgsc7fv9rldpf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "157zb079w5v6is3661j24qycgb067sr2pd5nfq1y4wcmcxhlpk27")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kii6qzx1c3i40jxw2hbk0p4m93dr99hy1ziglwdvmqzdd7lhyj7")))
   (package
     (name "whitehall")
     (version "release_13380")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10fdfsdvc8d0x3x51dcx3yn05avxz0rhzv4kk0slj4zq9dw2hyyl")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
