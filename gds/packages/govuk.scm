...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "053lm5kvsv8h25p1m06mba51478a7n8q1axjlhhfsfr2fcv6rqq5")))
   (package
     (name "content-store")
     (version "release_891")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bykdwsg0wzyjkdfpn6ibdnjm3x4vgw69c5c15qg0a7ksbvfg8a3")))
     (build-system rails-build-system)
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1k20jmx24qj673j1pfni49yjxhsxjans0fglcklj206a2c408lm5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vks45kqwbq6fxd1hv1qdh22xlvrb0fh04vv75fpbcanfld5ar4r")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0x9snjl3wdsyvks798hab74q4pcahlczvz0i09n6klw0938ci70b")))
   (package
     (name "feedback")
     (version "release_704")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02kia1mjqvk973l2n99zdjbflqwxhyw2i9xy9jv4r621sz0s9a6m")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
