   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1scklx8gm8kq2kmsdsd3ij9w2dfnqa8i8pkll9r31lp7qhv9qmh5")))
     (build-system rails-build-system)
     (arguments
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qwk2679ficj9f451mbfvcvwkdjn3b5krlwvss4xrw7csvbf4s10")))
   (package
     (name "contacts-admin")
     (version "release_498")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06l699wzc0yq342k68ahvkhn7icibjij1xw185im9py7ailqyq2p")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sj4x8wf7dhb81qrw4n1bf9h4y1f1lxylk5l8w2kp36y19w42103")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d3nsg9yy6k0npgkb4azajqnhkc53gspfpyvr9vrbgybxnc63w8f")))
   (package
     (name "content-store")
     (version "release_794")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p2nw30hw52ln63zlh5d0a08zv7llfi72ra8s14b6v7q8dmqhxsj")))
     (build-system rails-build-system)
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lpm002h77v52rmkk6cjlwdd0zwxd3knmcmd1kwry11s4ypy7d2n")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nbh6w6swlvh635ny2jjfgy08g8fkgwna3v02912a7rqf56dv0xw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qcbh5wms75i93q16vyv1p8674lbngy3bfxm53hlf797jyrv04kb")))
   (package
     (name "feedback")
     (version "release_512")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0s3m8zj1kssqapg5n7a6g1yn5y58fcifygj3gin3hhd2zjzpa30z")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a9hyng5zwwx09069krsq978yf9c7z2xaj1cpsszpgaq746cqqjw")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18hs9c6cy16nxw921ivrpsm5b01vcgq28d3qzflh10s1d9yql8gf")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ak4sdw82cxq3782rqaks1d54vy7sb9fh9lahhg5ihbgrwvm2f3b")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "172sibl4wa19fxq33h72nisacc72y7v5amnp4swahivaz0dazd6w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xa3k8r63g7pp12valjj2qglhzxbblg3y87p67n26q5dxihn8wib")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d5agykp16v88mdkn7kccvqjlidi8s897v4p7xfv44l5qcj0wyf7")))
   (package
     (name "licence-finder")
     (version "release_460")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07kkrdld43v33k0gwn133iwa6fgai80xa1kr3fqrqavb09gr1x48")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zdbbp4v0yk9shw346cnb081iv7lmvf8r0ci6jr0nn1pq4s3shaq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "086a6qqn0p2n5c9wllqphl511wgbcqdr84fz40l60fwx06lyvig8")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "17571qpjhpxirslphl7dn6y0h3winrl6yw301l2plxvz3kzdw3g7")))
   (package
     (name "smart-answers")
     (version "release_4093")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d332bfs5pqkgh52cxrd9n0pzfym536dfzydbwy7b4w67xj6981g")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1iall7my99bsx3wl6zg012i5ra35f39y1w6yhf9zd8y1xdwnmq2y")))
   (package
     (name "static")
     (version "release_2967")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dyyp9qidnr3z832mi202nqccddl26h0c4danzp3hhszrrqlhq47")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0f7vmbcv70a2ky532zi1szkiy7f83nz8pllr5kwh3lxb3rl4x57p")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17lsg4fbc3l0gdqdaiayd5c6my1rzmbgr7pn58a0g89qrcglnr53")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "19wyj5i762zwv6p9crmgbvwvl1lrq48wms1v6w8qwx1vs758h3zg")))
   (package
     (name "whitehall")
     (version "release_13705")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00jk6al7c47m4va0mzmic06341zd7idy690j945s8adhqr32wrc0")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
