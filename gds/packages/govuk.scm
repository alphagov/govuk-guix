   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "106nxjy2hxqvl0nadfrqh30zbiyx4sabpp17qcvilmi1rlf9zl4a")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "067baxanwx18cs3zalaqmcsfbzwd51kn1shd2slm5g3vlgc5m82j")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "137ja21ijrca588ilrqq8f03sjby6azlv81a5f1hi88nw3x3yayh")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13541")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v6c4bdf7g6j4hay0jl214dldr4fgkqq86kff7vlnn5ym98jgys5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
