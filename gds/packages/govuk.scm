...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nilazvsccfddx2klg15nd5dy3y3s7gl3hvlw66isi0rblcb79q0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12byr4bgllmp55378r5sd7fpkb9m2js0rx9zm155awl3pnnxyih7")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dlp43m00zk9r9aghy0mrnprgmmg6vi3xwhcd7dnfz5iyaq8pa7x")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0lmp63wkq0dwswvzy9i36cwld8adpc7aw1s059wlg9yhck5g6mia")))
     (build-system rails-build-system)
