...
(define-public asset-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1slfysqifzamzr2r0z00zrvv8yydmihy56k9nw58v6zpxmwa6wxi")))
   (package
     (name "asset-manager")
     (version "release_280")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wwnl5g7n11c8akswlp8yik3296p1nyrmi8fraddkz4sxgb9k3c8")))
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yf5g6yqnxam32smf52gwd3kb3mriimpqjjdjm38fhmxv93mahg9")))
   (package
     (name "collections")
     (version "release_489")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l6r3f24qvcgal24m71yhsphigq7qz8lnw0kiazmi1ykjm81qay2")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q7ad3f075hhj2i7q3p3lmbl79rsrvm4sl9hjjhkpz7r3wpg2w9z")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ir186901s4069dpd68av9nv86q3d88ddnw1490hk64ybbrdrgy6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08frrjdgqzshndxwhmc5j73xqxp7c5w6dfjl6r9c5762c5ibp1ik")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "023k6bva788h0rfji5xmmhzm98mdln22a3p8kbq4fglhrskjk62w")))
   (package
     (name "licence-finder")
     (version "release_367")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0abmxyciwy37sw9jgm6l54lziy7in3fwawpmy4ngnrrnf80a4bkp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1280yr0msl25p39lxlbww5q1wdzyb6p6qypm7pdn82zb5864id6x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00rcwysyz2wc4pb598apk0f1n47sq9apcw8zhs76z36481lk57k3")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "12ra7xw5mwwg1b6h6d3k20gl5h9nyzdr5i8y28qwrqclbhi7nhbs")))
   (package
     (name "smart-answers")
     (version "release_3918")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0s3x0sngp5ify8c0n7dl2ai5796a21j2zj81qdwv3zn0fcwzdhgh")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01961qp9m129wl3yz3hkcznjb9cyzncrz340q36g9bz5g0bg697g")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kcddjrkqf44kld67c2l2q8cp5vi0y9i5r9l64cz2ih53i7gjxlm")))
   (package
     (name "whitehall")
     (version "release_13403")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hqqwfj4gymrnx9llkcf7jwrwm8jhim5kgv865w13lqa3wlgwq0b")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
