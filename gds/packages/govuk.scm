...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rms917vc6agfgr238d5mnnic1xfvb8cap9fxdnlg60nrrw8f5x1")))
   (package
     (name "calendars")
     (version "release_664")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d3x10lz47dz2p886swxacq97d60275j6r2a2jjzxkkxj4b0f0mf")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p5fmb0kbw3l49xwy0r13qcmih7ivip02jyhpdra7mxsw5fhnsgd")))
   (package
     (name "collections")
     (version "release_795")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "129z02y5y8zs72ycj2nb1jy3fxnw2j8ymihw546amv8prdahw1yi")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0673fpayc6pwnqslp4jns0ggl6sl99q3v8qpqd2vmkihv9i6x8rs")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gdiw35fhi8c2l8057r070if112a0n8sky3zl6chswl6gmn1jy3w")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n09qnbpk1f2cc2gvq9kyz5gn4qxsrdn4vfghaalmvxv3n8i05q5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vxv2dyy05nvnsam4379swxxqzz9ygz6ff6cglrqfn0lqx8kh67w")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vcgjfrz7cmcaf44br6wwwr15rcf27lqyp2vyqv4gblhci0bjnnz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jq018mqkid766c976316rdfnk4p4d68d985xj5qryqry2jkijqi")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g4gwwz55fmldcwczwz3n96pcprwaz8b20vy70bjfl2gwl7cc70r")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vcixmmy1axkwvbmxpbhsdnlp6hglzi5fi0q0nbwj2gi631p48ph")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v5wclrjgsxhb3nczi2vg0195n4kblryz3lix8gn4diav8s172mm")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05q29j8ci34h3igkmwxb0fxdldhjzkr24mnvnqid3dv5xnr4krln")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "04lif1vdihrp02iz786gxcd1rpwih93365jhnfl3rqavv56y9771")))
   (package
     (name "feedback")
     (version "release_587")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l94m6my2add3h9ncb6zamy1c7gjmdj71mgg5qzfzdysawz5320z")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j4g5kwzhcbpkk8gzhzj7h4w5mjaq9dd1ggz6wf3cvq834cs3nkl")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14yzi5gs8qccq42ix1kvwphmkzdpzspx3nlhzpj714s7dzd5ww8a")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gppfpgb75yj4y02qmhb8i3ak8saa1l8hph9qdfqjsxxk253d1aa")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f6qwmyb1ng8ab8qqaabp6r7lyhikaal632zibxxq2lfbn0ms2sp")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1k5ipdcbjjndw0ddman1p9lzddqfbrgxvnzh8qnrzq5ybizf0y7k")))
   (package
     (name "info-frontend")
     (version "release_293")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a3ashbdshmkavkn59y0gvc17s9j49kp9xbw49snrr0c2jxlsbgp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1649kvlbp0pimld2rninq9jnbijqwfl283d95k38r2hm9y9ybmnn")))
   (package
     (name "licence-finder")
     (version "release_523")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0847vfiydw3v3cp8zvwqdmnyaq59inmbgl15ybdcimbi593gb4yk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "039w5m090ichjz3j2a43q8kn9xg23zgf086zw7rhz7nwb03p7b7c")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k9ff7y0fn5kfg8ddz9895ni4jj1zyy30l9bgw8r4r3wylvwn6dq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nm9l38aswrabfil9k2qh0a427gsy7rckxz3ykz45ykymbpavqaz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "19nxqcnzlg331475h10naad1v5vlbhjm35m3a8lx06naig3dnx9w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03nlnyzxgnp1nqws61zd4i09bh0h8mgr9jczf0c87fs9yzqb6rcq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0wbkn30d734psn2bg2wpygb8h55sbbsy4ixwwcz28v4c43qs086a"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16hz329fyrsm4v2vprjw33p70x18n2lddaass6aa9zk7shcq47nz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m11i16lcffy319fq2syvgsj00faz5cnjhzz0xhyavqk1s82r8b2")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "162x2ss6l88n6sgkzb0kdky9kb0yc0rc1mdxl622j5laa21fqr0z")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rsk7rg3flhfrg7xss9g3pja2l7j3i5hzszfgky15kr934zy7vss")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0krxbdvjvjrklyrq8pq3lxf2ingjyr47hf87br3vf2b7fd9lqki8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lg2l5mmya00y3pv4q9alpviw6ry593g70pq7j0fya9hr2l9cg5r")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yxzh4pn62727a3971vwqc0l8h4y2dx52j6xknmcp5g396ljcfqd")))
   (package
     (name "whitehall")
     (version "release_13909")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08j44795xlp4qgs8rax7y9qfkwqdc058mfanzpsnxzj2srp4jpk5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
