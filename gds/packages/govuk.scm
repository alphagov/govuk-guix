   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kjjbr8b6damg0vvcycfcclbx9b7j37qwq4qdlv2n9aj7m3zb3l3")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ccbdlvk25pkcrrs6iqfclfjjk019j2mz1s7rxkgcjyb5cq4d2vw")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1874")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dzv97zi3k8wks6nga0s41sr3f7n65ixfhjx42ga72za0gbdq70x")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   ...
   (package
     ...
     (version "release_1853")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0akkhfzyl930sx9psbknla843vp4v5x17035nkfav6bdm15k8hl9")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14857")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x3pz6ss3g4h28il1v5vzmmbcxjszl5yfgj80010x2c3i73gxm3q")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
