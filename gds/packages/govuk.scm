   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08dsclbdkplk78addfnrijkaf7npm3z1fz7vcy5xi5mb2ca8r0hf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1bvx0sq3d1ss5l1b6mlqmv06l6p3h28fmzw3hl9vj0bz02zmjgxb")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rpvpck4c6n5p0nps7xw84alfqb03gnv2czxi9k7g9ipxpf595v1")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14v14imlmlxrmy4yp58g7q1hjpkplfv9hx78cx4xvwhscpzdlh3c")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1i468w3anmix0iy1y5a9i5nw4ggq9cg6c5yag2zqm3hwl9f3bbq0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
