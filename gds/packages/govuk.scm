...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0r0rrk3as2b09nc8q7cx1c626ml2pxhafkpr71495snbn8zda4n1")))
   (package
     (name "calculators")
     (version "release_726")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19gm7hv76psiqw8zp3cm5x083z4jbvzk69zkqcr90yaqsgjpplh5")))
     (build-system rails-build-system)
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h5rb8sadgb6zdf7hgkv248n8631l4pbf73ap2rykdvpg71m1cc6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gh974nc9zipvk55w3vax8az7p97g4jfypxy19330d8pfslxa0gp")))
     (build-system rails-build-system)
     (native-inputs
