...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2366")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14fm1h1sxic1p32w1i4zw4p7v3kifrscbzippyd9hb9wn3zin46v")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14441")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ahhwp3nkwi5qzr4zbq1i8vdp0hfsax25sylm9l59x5d9z9agfwl")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
