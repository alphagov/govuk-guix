...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fxg2gijxxxrmv2cgkr2zpvldk87vpg8b64vkx4428kfs6nv7wsj")))
   (package
     (name "calculators")
     (version "release_319")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pclcpjzh9bs8pfq89kcp0lmfw9bzn4nrv2dwmzwxs709r240890")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1asq5y1n60adw17iii9v9wr45qvygpj5gviyiyvscnghir4isabj")))
   (package
     (name "calendars")
     (version "release_541")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wgx2g76f4wvlhvl7j4pxc8sl1cr3kjapv6pn9hnciclhhz06f8g")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0y4x22rzh7mfwzddg9gx15kdnq02k22djqx6bb1jj5d67is12kp3")))
   (package
     (name "collections")
     (version "release_571")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1w4gfvgf8xsrajyjxyh0mhk3x8m3hxzxk6h62gha67hwy2aq67rw")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15dir2bsx8h7zv0mhdsn0wqh2nki8igqhsy47hyzmyvihxa965v2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "02s9bhkya9i26z9m84b7lpp5pskafgp4xppv8qscimbwr0j4gl13")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ywpn617qmwnw7j000szzcg1fvlvy35nninxjcy3nxcvnsm5dsnn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0g4m3rfqcs2ds8pqi9dbrzp6md2k0iyy0dadsg890grshyx1dc3i")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s3y9ykf1p59r2yj6fkl8ys27sinp6wwrdfchfwgsjv4vfb1hq7x")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "04hgfm8rxhns9vcr98cvzpp9z1fpxd275d0nxwqc91v4d1b246n5")))
   (package
     (name "frontend")
     (version "release_2919")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hp8d2s2fnhwwn3qqdmzaa3rl190c7dcdrli11wavdbf7dz8sky3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "00isk5qi2m3ahw43hd53h8k5gq4l3qhyp6qpzj7kyhlr0avgx182")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18jml7y4bczl639gr2xg6fqlbfi615qih1575s0nqjx6l7lfh96d")))
   (package
     (name "info-frontend")
     (version "release_177")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h4rbdzb6aw0ndn2aflldbympjfid3vhmswzw533fbyfkizyyjpm")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nqpfz25kssgbj5njj41rnpnfgirdlgfzn50jc1vzzbyc4k28qb7")))
   (package
     (name "licence-finder")
     (version "release_411")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nwh6xwbv7lfkaf1vm17ydrz6fkg4ianjgvjajx50g13rdhkf1bx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "00wgq490dzipcwwwxlyhcf3wb4gicd21g4nf9a3z5hqxs264ayav")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01v67kvbb5h08vgkcckk9xidvzwkh7gn5k3hwlw5siyznczjz5b8")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0yjfpn2d3mpi6pb6sn23n6jgmc0sgy6jmwnr9fcfr76lv63ldnyi")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0igrk8vdrs2xp1h33wm1m7z528j3bm79c3wnpbfyp9xc9dgwx124")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rz10kzmimsv8z62a7xx58lxm7xyv1ala2pfc4f8404j484kn2m9")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zmpyp6v3cw6z2pysca7gjy2s481ddn0pymrm940v704ax19mdpd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00h0vhwzlpbizvh65zyqnghbwds65wy3nsdi70ss73s8w2bnfbpx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k0wd90wfiiarc8mcqpb7ymksk3yrncbc6ql0r63wzxjxa60g7ri")))
   (package
     (name "smart-answers")
     (version "release_3999")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kiqjzm9argw0az35qm0af9g4zwbz1bs6dz3p11kc8ak2plgm7dl")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dasaqs9q6pfi7v7qmpvz2lrw5pvvz8n7fds9x7i85glgr88jcv0")))
   (package
     (name "whitehall")
     (version "release_13537")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dk86rlpmn3x7fz2dnad8rr0a7jqgmz89682a5fhsg87r453b3mk")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
