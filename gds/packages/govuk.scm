...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1frmnalw7yai5567cyrlz5fwph84chvbiw0rcfj3hb24y78lp0qy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15wcxads0h7ia28944gsw93c1qn18pmvh9iiwz8nfxi4ywm711k0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3889")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rhllyc9j53j1izzg4js9lf1nslf37qdys8hj33isqgy5ac3491c")))
     (build-system rails-build-system)
