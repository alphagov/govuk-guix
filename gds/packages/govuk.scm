...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fn8sflhsfmi20lf06gjfx0g3yffp6hjw9lk4vn4g7akjvfqqnzh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sfysg6m2grkmbynzc9m4p2b0hcr340wiv5sy2n1gzipfm1ypszi")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xvis9afy92188n6irjifz8lsss2av43y0rl2xrr5piarf12fd8b")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j14ak7b006ckxa17xz8gkqnkmvx9bwl5m6chhcm6yvs09zn1ny9")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
