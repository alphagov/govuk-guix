   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y1zl3ymlwnqpv1y0i79ggnxzx5c7qvw56x51li7i2wjpml588bc")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vbm4kb33bn0pk9rwwgcz4g1s4yvpzlcgmah7z2sg8gxzr7ghmhn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3724")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dr78n2isb8xfc6vyvs5bnh41286955zmiawqksnd2lmm8nc2k3p")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12956")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k79bslbwmyn6f0q2n71zqaargbz2i9xifd01dfsr2jckjj6z7y6")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
