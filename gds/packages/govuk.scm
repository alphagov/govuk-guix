   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rqm3gndi3sg5ga8cbja90srp5vzx16bm0lsmy2q1qlr0c0baqqp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l357bkgq6733d7xqc0z7isg8370jnws626cvi0djsv8amrm66rw")))
   (package
     (name "content-store")
     (version "release_737")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r8mavqlss10lwapqjblfd2hbvkpj6zf8bz6gwfcd412lzg4bnvq")))
     (build-system rails-build-system)
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1dbwbac39741nscsix0i7q3a3xpabq3kwlcqxccsfnpq9bcj4bcm")))
   (package
     (name "content-tagger")
     (version "release_747")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xy579dw8d6nl8v4587icbakwazh5m62v5rzw8bbkpmh4xzag5fq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "03y3cdzw24sxcp91ikivkz7w8kjlbn86gnx8jxw6jniwk5b9sf34")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "08wncbbwsiciy71p9wm830180xjp5n6wp07xi770jrcflh5z4lix")))
   (package
     (name "whitehall")
     (version "release_13347")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vmlx9gygsca6iv3n695fhyw6dkq9k8wd9g1cgybvzvbp2w5w30s")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
