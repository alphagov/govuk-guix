...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ixkmsksj2d2rrk6mmkl24sdp461nilcmpdkr85r9jprpp9yakfj")))
   (package
     (name "calculators")
     (version "release_365")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n7fnxcbzhgfxfqqhhi3iqdzpnxymsjb33k70mzyrxr8iwmcvqzd")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "17fc5gqbm3qkawmb3hi78i7nqqr0w71m8frcs92729qiqkp7mnb9")))
   (package
     (name "collections")
     (version "release_694")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dhlw5ilagxyq947cb5ccwhlrslk87x79k5amkwh161fzwfb3z6w")))
     (build-system rails-build-system)
     (arguments
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0q8zk73b9g9hfspfg1mzsxjm2y4l9rfk436xck8nv2yaw88s8rxr")))
   (package
     (name "feedback")
     (version "release_506")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12r7ikncqzrh9l8nanrihrdmxsy07xdnv5fldwjjlzd7b2nb12rp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cb7wzylsdqvypv64x0mhjvv435k1zn4phy0ixgdra633v81nagk")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m8abwva7d035blj48z2bpd5jd0p030fs3wcprj67lq1k4570g6g")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rjm96wfkh83il7vhw01pmv35xvjb7sxc1a575i3ic37svmcq3z4")))
   (package
     (name "info-frontend")
     (version "release_220")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rg20fl5qryn3bhd6di89jqj0xmwpwg9fpgg76jhzfh8vwxzc7ax")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
