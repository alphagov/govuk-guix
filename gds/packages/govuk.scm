...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2593")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1s4hfnqf4ffwjr0b5hg40af6z1yianc6k35j3a5r01nzbg4jfhp5")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12818")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x88d4ddkamfbar6lk7wxx5jw2pyjlbmdg3b4n531qw8cl3qrcza")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
