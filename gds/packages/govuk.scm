   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v4scnzpyxda8b6d7hpy2a9dgc13snqbiaqwa8yjz1ig5l8klqm3")))
     (build-system rails-build-system)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "10sdqpcqzy3xfhrcyz4yahwgf9gnhfzisbz4aw3xmaanzmvg8p4q")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13567")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07b4w4hajwk7qbzq607dwypnkj76ac3jphl6gnhkfpfk8smngkm0")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
