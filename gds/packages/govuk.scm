...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1aj4911fwly13vap5jzxqsnmdhcqnc0i3rzisc9mqcrnjf00mn0x")))
   (package
     (name "collections")
     (version "release_901")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v89i4x870vgcmz5sb1naq0r5zvqkn5vfgnwq7l9k0y9bja2265n")))
     (build-system rails-build-system)
     (arguments
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lwxc8y7y1rd7z06m2rmw8980fyflnlbybsk402rfiw1di2dbph0")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05bjgbqwlnjzfaa5q22mpbd4g7bq8li8p0g7fr8dmhzlmp4fl5x1")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
