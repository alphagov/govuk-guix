   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "035pl73lxc1xcjh2dyaljwslpjazby1mh03av42zyyddq2zi61fr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wzigfsm682rg85myn07pcnsw31kvckcnnp1p1hdgml3x3cq0i4h")))
   (package
     (name "content-store")
     (version "release_687")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12sl92v066b9c8ga16v2jd0qlb0b8vszrn0nnb6kq7ljb9y8mgqg")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0193c4qgisqakrhyvbq6wl1b9pf9nmqxqg27hjjxkndn3qs46nk1")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l31nw26dx6451z4aq2vdj74zzixqmy6r3b3qwq07xmn03nax20k")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10nc95p6ia6p19cygchs8q8r8qywrcc56b2ng37620hviv4r8ivq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
