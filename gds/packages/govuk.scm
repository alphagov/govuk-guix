...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sbnwpradcr297maz162ck08w3ymdacc6jj600arq2nlg49n267p")))
   (package
     (name "release")
     (version "release_657")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "080cn8fxlk8c27h3s6pfmcj2a6qhpigf2ac9kski487r9hrk6f83")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "0acvwskchibjglcflylm994k90yq54rz9q5dyw500x6w2gwqr826")))
   (package
     (name "support")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07xf77y0p664p4w4mpr91r89qswaa2fpaz2is45xzgvm9mf3bmyb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
