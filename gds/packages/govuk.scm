   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yz779ivvqmz71q2w8c0m59ak8znrwgs2gm8mib261qi679cx1yc")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rvpsid735v9c7da16b5hzkn04k9c4wq2b9kzx0lkima8knl451x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xg2m3ksqkbqlsrfahx39ab05jjmi48mic9h3b5lnq1b68n4k7pp")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x6nxw8mwk3pmw9ymc6ql3ck9ndacrq0qhgrvkkjiql8z5gvc8ji")))
   (package
     (name "search-api")
     (version "release_2420")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d89gn9732pbb9a6gc8xsfyglarnbf50d6n5w08czfc11wwvipnp")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "03l6r4knn9krn6146xkikb9dd83m6b0cp6hqkr9k37zpqpq1dvqc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "154gxkdkvl01gl1pp44xmmzprql5sgalgqh1vj5cx9yfd76217pw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1b8f4i9in29q58c69sp7s3piqkmv1g21xrzkrqx854mg6wfj93c5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x6gy9317jrp7v5x8gvyy52l6pzh68l4m4zcdklzywf269vcflv3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
