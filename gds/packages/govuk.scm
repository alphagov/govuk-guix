...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1d7gkl44rnhmpsr1h20lal0i3facwhfc8v5d2gj3xb7i5s251gj2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ycpksvj8ixrni7rpivcy6369hkwxiryvmv5pbzgm6hxf7jqryzg")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wpgyd8m8vmly44cq6kszrqyrq3766zkb3ankg4pisaa9a40pbl5")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0crjq3l6nqfa322qsg1gi7ylhjiwdqgwbia63y0142vcqzj3f2is")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dim0pw990x51230akn8vnj4fhhy4mhq6ymc497n7g7qidb9xx5w")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
