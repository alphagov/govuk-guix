...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f9z4lh8wb0y3z9zzz881a26yvrir22rlbv1nyd7yvlv37ccixjx")))
   (package
     (name "calculators")
     (version "release_343")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zshhbpq6mc94kalg3f6zm1yq2chh0ljcbkgn24b27lh9hnqxpla")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jxi0a3g0z7w0s42crmb8566282w64dxp2w5y184qv8y2bn3xrk9")))
   (package
     (name "calendars")
     (version "release_568")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dbky2z3ghlfbqw4plr665jgnm508d06lyfdg20sab0i8x3d0izv")))
     (build-system rails-build-system)
