   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cawk8kvg3wixpyvwbal35fz5zwymakvxi84i4z8zqss68kww3cs")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "10444cdyb5pzgwn5374zggzmd7g73py6i4rpl7pfwkqygw9iv9lm")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13445")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n59vn7mz2623rmldh09syap0hpaps232xq28h3fd4dcw13mirzz")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
