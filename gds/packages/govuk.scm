   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19w9q8620szfffik232wij85c0v404dac82hwls33hm54zq3r8an")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c8n02rrrs5ldcw2wvbcxdhqw0xxzqln4xmflsvb00zbn0ahylna")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "14p953kzv93lpdlz4nkk4z2m12lidzlknga1gvydzdk3hr53b1by")))
   (package
     (name "frontend")
     (version "release_2781")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x0wpxq846rcs1jr12dmpldnadc2lg5hqcl8vvm9r83bm42434ca")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
