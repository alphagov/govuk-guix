   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14n5hd35hz04kygzhdnmljh63dkzsh8ba7y1bw0fgjg0g8yssraw")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wlhjdc9n9rbi852cw4kjwb3xsj96llg9q827rbf53bv5wbk139b")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3977")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vnbis0gjhzpsniza3ad8f7ld80acxbldy3zx1zbrrcayb76ahpf")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13499")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g4x23w8ssbbvnfqsbv1np3gsiwm921i39kxj2lsyqiimxk0miw5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
