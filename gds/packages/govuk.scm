   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c29dqi0v4k86jxsjbafc470jbdg2v86nysbmb1y2nnj2wz5ag32")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zq5kw0r9w1gbx079mbzh2gj0w23v136ac6bz6wz29zcf16spn5a")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qj6byhgrdrq4r1ig4i59mhc2iayyqxw5h35bcxv5cwbp9viqx51")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m69bbg75q71g15ibmipqbvbfmmk14am2v484n2qr7pg7v2ssv9a")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09rz2ak3nkf9mdfd8y7b2glas7i4p2sqmk8jljs353ncwjx8hk6l")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a5nz54912sm0h3zkxkkvp303crnhnz5z44mbk5yd08v80a9akin")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00rgjss66cba7l0hjh62h5ckvdp7v27knw051ywgy8xy9qkl4kiz")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
