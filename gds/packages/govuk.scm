   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b1vn0s7kgq4j0l79dwaqkvhbkb1mkzsph4nvwjngi6c9ni4b1ka")))
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rf4gcj9qn36cbfdvacxh1chpzza2f6mym1nrkhmlcq59hfqgdk1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zrg10vrpq9gchkdq6k0v09jf4g1k51c6mwkmpy5h7690z760rar")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13ysnc8ywqm8aqaqxf98v88l5l45nmwq8nyrhln76rsqx7gd0m3k")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p35si2szfizhpzjcksjhq825dhjyabjh9xky3wwzrayp65yzbw6")))
   (package
     (name "search-api")
     (version "release_2035")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1chl532y2mnc8r6djx9snx3d7ci7k96yvdqnv0lcqx4lw26irjkm")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
