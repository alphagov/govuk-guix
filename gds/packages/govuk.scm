...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rkam44pa1clnrir29ic31w0s72myg9s3bygv1nyj343027hwhvf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y1280s9ngpspypprjgqwbjfha6ca1n2lrlz7a22knrnw66aikva")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "0w56xl23566kqdv4i2lar1z77b8h1lz7iy7xrj0vfrxm9k7351dm")))
   (package
     (name "content-store")
     (version "release_970")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p4ccvxsiyp4xm1fp93plx73a4wy6x0z1262lib0wk8f690v5dkh")))
     (build-system rails-build-system)
...
(define-public router-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p13pbkh64b2wp2b6hzwfp16biaczypkz5qb0p4g6r9kn9rljl0w")))
   (package
     (name "router-api")
     (version "release_264")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fgn2ykbds3yr4vx213g0s23ky7h1drl587p7g8vmd6r8ywmdn48")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
