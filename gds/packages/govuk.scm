   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cdd544xz4f4mg4q6fi7c3hd8bx60rirzh7qcpwpgj57yifhi2n5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08j8m55cyjj31wl6p4h0bqk62bnxjykmzmkxf5b6rhkvwwhr69cr")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12916")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00zrpkv69831qdl9an19cl9v2xn2l3wk8z16r68xhwh58haq1m1f")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
