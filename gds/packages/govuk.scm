   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hl31wsw6wzsi1ayq38i9hcjdaax0kl7nvrsv204nai74ppzg183")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hjzcf5dksxb5kiaq9zml12a7s7vczwrhzgpr194p8px8hydc1jm")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1agh05iymzxz9skz56vqg3114kjac5gp8z7x0vwcrhbikfzrxscn")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "10h9zqvq25dhgk7v9397gmznf9sq6gxlkf9z4d4v0j8x23vvlwvi")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public rummager
  (package-with-bundler
   ...
   (package
     (name "rummager")
     (version "release_1895")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cvzdaiqwivqv3n46ing8g4280d5rpydyw5mwcv287xvr8vbkmhs")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
