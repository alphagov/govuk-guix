...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0byjvm1zc5fh4rnzw4ab9hk44ci8z8w62jbxhd67xsqgyzph374h")))
   (package
     (name "feedback")
     (version "release_320")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nr5752lnq59pkr4rn91g1rr2agyjkdsr7bmd8hibv146qld9wc3")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0041sb73h07fvipinhm26vnaqwkq693ad73kbl92cdj7dv6a49jm")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
