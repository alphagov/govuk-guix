...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0m4i5rnxz3j6lj76bvgn50hwn5hj08cgww6z4r86map2nzvh4l4w")))
   (package
     (name "calendars")
     (version "release_611")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xg2rpwfqrzgmb9qrnv9yc77jr99w96chlaiypdw6a3nq9pvpsip")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ryiq0vyqi5mhqxql53w1n3xnk7040nym2f03zdl6zvyry8v17z8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1adw5m7i5lqi1hc7x66jycp7v5f3yqvb9m8r4xyk52w4hnp67dhl")))
   (package
     (name "smart-answers")
     (version "release_4125")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p6lynrddxkmi5cdsz6h80yqfkyir15jy635akm1jbbjhg0vfxyb")))
     (build-system rails-build-system)
