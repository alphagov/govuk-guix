...
(define-public authenticating-proxy
  (package-with-bundler
   (bundle-package
    (hash (base32 "1z38brmjxhr9drpccx8wb4qxh8d30sqxz8z7l07dx6l92pfk604r")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fzi9qmh2kkhpmyx6fz90zrf1n43i0rlrx863fxjqv2l611chr8k")))
     (build-system rails-build-system)
     (arguments
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0y7iwp29kl0pdy66k61n3ah3w8qw20zyw23qkyx3w6c1bgyjv072")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0khbqp83nz1r8bv0j60z7whbjki4qgnmw8scbdrg783bhs9lg54d")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
