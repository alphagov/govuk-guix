   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l7gxzjlsjj5h7hr40mq0fqqdb9kyhm0p749f7irwxy8vwhrnd87")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qc2688xixsq7a02sdab7pih7z82y6brnn5bypvrr55k0rcxcsg0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bpaq7girwxr58pxa0dwhqqvawaqdqk8mzlawsdn250l67x9fsm1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "15fk2v28bhqcj91smplqll7cg1yg9yf462svqwc69cvmq7r0sdxy")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yimjspyb3zcpjp2p3c1ipx6nhb22bfl7qqbpbay6ad1x9nsjqlp")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
