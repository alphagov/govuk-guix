   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v79vabhn0s8lwzli7wgngn6jg46fcd3pg223ayyrjq5s28cs2sn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x503sgdh8j9qahw2lsmbfrnnw44drg1w7ib8zhzrb7ab3ppczpw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g8ahwgc8ihbkknf0zwl2akaqwl5qzglln9f8y4kwr9iylvzq3qq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hp3ljl18xlink3jbzg47g97lzvh77wg0bm0irz22700q35nvbbm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
