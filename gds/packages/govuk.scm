...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gs0rai8k00kx1baig7n9rqyl4rai8hb7fzhf7y2r5m6xjdrchll")))
   (package
     (name "calendars")
     (version "release_565")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vrlg5m7pr9mymcc5m8m5ajghxrsjpk0nx5mqxa6xbrl6mkkbgig")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lasnpdlr2y6wykfcn7cqcrzwr13pkdy1gmb47m7b07ifm2rz701")))
   (package
     (name "collections")
     (version "release_668")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0skpcxy9ydhds2g6kj0mz5xbkhz95k1kbfrjd3r5wbqkm7ww56v0")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0km8ypk87w7w4lpnngmblklf7n2r1jpnvz18252ik879bdjzibqx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "11n0xw8pbrfgdvjwwkxcwcnj1caaa15gj02pqxclhk22z8yyh0vf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01wc4l799hcq3zzp2yd2kxq9a2qarfb76j56p27hhnx9s0f360pd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c2yim8k9q416h0ssl11i5bmsdly13q8xag9539dmx0aa57ddb4n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kzczgpg77pwmy3f1r42a2ynw1488jrszqi25d5pw4ys8hhr5fcc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18l1x75sl2hc06m2yl3j9nswr4cxr0277knpfkk7911zanzavvlh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15sm7wy2sg4pds2a8xc2cwcngqcjdh0wx84ahdda27apygjwj936")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "08rydv7pyc8bil842fqgcbgazgfq3pzckdxxshn7h4zksiqvnpzy")))
   (package
     (name "frontend")
     (version "release_2949")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fmd131hj1bm7idb4wawfdd4jb9vhay75ga7g6fd8nxiw9hckvcg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xjlbjx53glra7cf64xgzgx0h47d0px9qf4jd44i50yv3icvim9d")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wd0qafc6wxansfnvhfnmj4c9grsk0ws4js5v2y3ld3m5yvmy2xf")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cw3nxkjm5j14d1ap2f3fhlspf0m03wjqjxqdl2j9grar1krs0pl")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "093w2cgj0lbk81l39m05vc09b1y4kxbs8rv6jcw7pmsa3xfcwnia")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1xldd49giymc02f750kbpvk82j2xqjkqk0zn0grfcwrvfv28bmiz")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1irp5naqggmgl2f50ik62prnp6ykfzs405j1bgpp0n6aiw0xhic9")))
   (package
     (name "static")
     (version "release_2934")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14plazskv1xm28bpjdqsxd4yd3r3h01z6cfbj0yqhh4jf8aq3kmp")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
