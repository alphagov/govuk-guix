...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xg012qk47yrl06jixdjj1pf0lwkiljqm1al5xdb7ibl7h0carif")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h2gd4ykvsbws01pavy0f2kzzfirf3k36i12rz78bp4w2b5djdjj")))
     (build-system rails-build-system)
     (arguments
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dkd470dna6cf5jbqbybhx5qji9lxg513f65zyni77140m0r3h20")))
   (package
     (name "info-frontend")
     (version "release_209")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fkh3rhpwdfgnh6h6pzycmn3g13vavmc0vcxrk6cki39b7j2dmcm")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a35b372mgvl3jhxpgvbyhibb57c96b81cmiin9p282r8538lpdn")))
   (package
     (name "licence-finder")
     (version "release_444")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00jzy3sig39gi88braq4jb6fg83sw39lm252x4p6f564v1f83ywk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
