   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yadbd8qydn9c04shbj50sls0573sdjiib2bb4qgml1dg6lgq5pj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12s81ljyvqfvvp1xllrrhkd3bqmjk26yysx9m4pi3wgzi9y3ylmg")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sbnwpk9nxm5w1n8bzjxhqnf1vadk39rq6y3rsb3v2ay4j73hjx9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
