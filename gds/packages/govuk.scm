...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "14wqq4rql00ngwwfkb7fi02lvw9harqd5zrq0pijqp8xkwl6vrp9")))
   (package
     (name "calculators")
     (version "release_213")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qpxzjswhnkpdgwa5il2qlk59f4klh91i0bkfqvmsaa719sphhhz")))
     (build-system rails-build-system)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cjzpx7bm2ladgw7xa80i3l8dp928w34gnsblb32i6l5bfd67hv6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09kajmvrqbawbjc0j32bgc53b8pfaxskwqr0hy6fdadmqsc0kdqj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "11zm9py49shln6qijswcq1fa8im1xlhrw82vrhpvqa7b81n5311z")))
   (package
     (name "maslow")
     (version "release_211")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k7dag61bfsyk6wvrlgfxs2aj344lrb8rv94kz58b5rbv88jkpdx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p3svh213hw75gr5y8x7i8wj78b1c27d13d1bvlsxai2qjgwwmsy")))
   (package
     (name "search-admin")
     (version "release_111")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c0xghs49kvqirafinw2m5f6q1y489i7xpm9z35mpw80k15xnkly")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
