...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dmc68ppk4m8lih4izq3zvza11si13ljg93rz0nrg93rzn86yjj3")))
   (package
     (name "calendars")
     (version "release_562")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10bl5i70xd5705gz2yy4lx7v8nb4b928bjkrqy46x0yqxh7v1gbn")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fyivwqy0gfhwmbnk5mklcpk1h4k906j17adih5dzi2qm704kw5z")))
   (package
     (name "collections")
     (version "release_660")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fwz120h9ba2dihqidp84a2bg9s8v623z0dw0k0xlpipfdq6j0cd")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b6zkainbi4cbsm2y2z6x9f1xv9aa9sfxkh5sa97hgjb7x1mf0w3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sppnwp4kyf7h23lymhgmv9nc4zc64np7w0b2hxwz8k0wg2j3mmr")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01a3z54plnms44w66lac5h5qkawdwdwr7lvbcg7jvr6gq6rwmk5v")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m6pivvybjwp271s2ylqkaw6mynrpl4q79xdi8l33n9wkn7cm0ik")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nbmc1nz2mpvr6v2zic7fpw88mh9pl4033i9gzni1yqyc68ksm4s")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license license:expat)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nkl1clxc7qy3v6ldszd9ay578wb3siannr15wd78ls4fngk3fj7")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jhxnsmh87m52b3azjryisp0ajags0mciqnfliy3nabqrd22njxp")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qy1ljx1qqvfjp1lbc85ri12k6ha8knc8mcfx9cf723ganpbhiqj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "014y8rw6b7jklncxmp08dg293prpkh9jh1iw376nc2sm4pc91g6m")))
   (package
     (name "feedback")
     (version "release_480")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05yazrmx5830s5c36i81gdmvplb8zxv2nfb0bx23rcb7a43zjlvb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0iv73lq0bmbjigcsfbmmxrb80ki3ywiykal8ksj4xgvhnyx6xgqg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gdvhzdycll6iair57ajwnbr3f6jgrrflqgwbarpy0jx34j8k6kj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "09z7qz7v3342licg6jxv5iqxk52587qnxdplyfnsb6wnqc746mlj")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qkf2dqga9f7gn14xsyfy7hwp69kbv83irx2npz5mgpvm865p74d")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pm9dq5ny20lypcj9zimwhr346fd63695qp20z1zkv84lxcg5s3v")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0scl92jl5j8710mzw423s2lkzpybwsi938qsi8nbgvig1qfxhvix")))
     (build-system rails-build-system)
     (arguments
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0ynqsh7775pfbhjvfsfan0rc6k67jswlw84rnxpgpay58mjgpxny")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0aqnj2vf1pns5psiczvfsj088cy37cs0ff4gxf0i1q9nnq7fvgld")))
   (package
     (name "info-frontend")
     (version "release_197")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0risad0qmsdw94p689vqazz57cds6ihgb3zl3smpq5ddblc0d323")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s5364alc68g20g1z8xj9vps6pbcs6z2338b3fsnpwam8mgr08jg")))
   (package
     (name "licence-finder")
     (version "release_431")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13s7d00h9ym6fzz9hm3qxn0mnck49q90xiggm73l7skq33i0s55k")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "08pwmgy07zw67zjmk8ap7nna4rspcszivn82x5m3d7ibszyg7ixh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fqh7h1h2w1qsdrjj38jb7bcjm9iawm0480sq65cv38dx5vkgpdg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1vwwpqpaavm55ls5j15jr3bvn94jfm1kc4f2nvghxd0bbrik0d5j")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0sxwq7633kp3bnm00kxvaqs5xf3pbc9xhqaic7inw2yh3ys84mks")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03jxw1h7zv6bkacwrm62s84xz9bk0wbi01852h6qn36x6jvgdqh7")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lj3sdnihm4h325kwaza7y5f5bs5p5ljmyzc70vrpw1zan66qpzs")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09f9lpg3zkvqkkzxancpsq75l823n9jp8hhhnb8wwz9g2hax7xkq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b5yrx00iwq5kswhll26na27635c9i3advql6b1r4h75yy0k25lv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g7m9b31rf8238jrw8jlcmm4bw066hzsmnwy9511zkyqprw4j502")))
   (package
     (name "smart-answers")
     (version "release_4041")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sjzhbpj4s4k2783ph3bnqwz74szwa5v27shs9my612knn69k3x9")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04cx9izss96kw429dis6gqqaldqivyvmi152fq47gh7law89zwbp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l1cbashyzysjs0b29n5fb85szn34hq5x1gl71rvysq56fciza88")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hpzg74p735nmax3zas8arn58ghhscklab2f8pf7zwhqnq5iqh5y")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h145b79jh25mpgg0x1hpv0d8xhwzqp4ngxawirk7z2gyr02mvy7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ac39iwzxdxn6ga4pbxd9rirnw2c1kddlszmh3q0g13f9asl1k64")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "013pm5g5mj7kys00ba2sr76rhlzli7g067rwx9q36pm6a5dqb7yp")))
   (package
     (name "whitehall")
     (version "release_13630")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zxngmvk28bi0sg9d4rjgxhxwfspmxcvk48rdjmr18g2cizl0vbp")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
