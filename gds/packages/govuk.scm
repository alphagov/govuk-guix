   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "056mhr4ivkmilx1kwkaaqqhznqv2n1g249ck7hkdp15vgkbqv1rn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "090n1im4kb0fg699ac74s24x4jlsy7b24mcj2hgf3vxblaiy93k3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mwv7wkdfh142q7mkvj26g7nhp42k5pd4hr0804xjvwpb4d8nrjy")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nl3237ls26h09yl0cpfx2jql04qhbbg0xcsv8dn7iripk8f2qrr")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "03kv3h0dl8r72iviw3xdp464risd2xx0cc90ypr9rfwc6vkcch42")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rsmzk06413rknq26sb7a1g3lkg4nlhckzs46hxzajxv990whkmh")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13084")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17silq5fxl3zm52hgyqp5y9zv0p136vf0sb3wvp7v2pk6qjfgy7s")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
