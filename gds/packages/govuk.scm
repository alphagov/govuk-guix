   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pnib2vsl4b41b636fil01qw0h79sh83wyg0pzfqwdacha1wpjpq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0n8wfycw889f80g4x1m6jviadhnxim394435vssdm5yhq8vv398g")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13305")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gh7fig6mdpy0gw9zvw8hhyjyb85z8i91jsfmz3xrqdxxfyp3bim")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
