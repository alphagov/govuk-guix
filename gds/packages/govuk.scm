...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v2c38nkjcmw4xqyk6g7mfdfvac3gy2gqxzl6iwg66s13xr485ch")))
   (package
     (name "calculators")
     (version "release_304")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c7k990hs2gs4nm94qh5jk4lhzgdk96gfjsxdcqimlkc9a14c0az")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "02g39ryq84rdvz2iyjb7ymyhdrfiddr2zkqsix6xvmlb24zg2y6a")))
   (package
     (name "calendars")
     (version "release_524")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c5ypq88lpx49w1axg05kfbdl3p3h0z6zqgq7scjrpq0sypq98fi")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "15pd6kxrsxq12nabngmzs20g5x3m6dw63rvvcgwg2sa76kak44fr")))
   (package
     (name "collections")
     (version "release_528")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kh4gndahg9wfhsm6k5fv6czrvkszb1qx24scp51z4798w39jl7g")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i7zh4lfc2ghq7biarix53pl2hhdx0q2qq577bhjmx0n2fbkx3ny")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "037d7kd0h1r4zzs3rji6vh4w156zi2csrf1wj5x0mikf36gq6a9j")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w0w0f1q26wqrw3wbysqck69w4miy192qf6dx3j08k62zn165crq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dkx7qh7gf9cv9lrsz2nfp1909dvdwvn3ld0rp526csak30xj9p1")))
   (package
     (name "feedback")
     (version "release_435")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x117pq1sr02j5bgq5dn63bnajafcd0k99s2i9ikpwsfql1y2and")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xnrmycl320fcmycwvn8pbfqkvr0zcdl8bsjcdspwzn370n1dz6y")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jz958n57gcgmp4f2czrf04d16qsk0qyfdyaw1pl8cnr4yiwddyy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0y4p8zyzcpfp8z4s6x0ivsjcn1aav1l567jx1ghxj3qq56l2jz6q")))
   (package
     (name "frontend")
     (version "release_2902")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gp25h4y014pn1cbrpc1s3pijrmap7wswagsl79kvbjld97bxjwk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "10pc0vx4ddrdqzpawnssqh8z31976q222msay0srszf66vxi3ada")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k7hhypnhpfzaxpsznawhpfa93vswrl2icjfw6vni2y70q532slr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "065gamkm45zsm9qb6abz5k0d5dyprpd6naqszdblljszm2q3iv50")))
   (package
     (name "info-frontend")
     (version "release_161")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sb2vzp7lvdg5kpdiry0yc6l6b718fa445w9csxaipsnck5a6zpn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p0ahzyy8hmbss5z5pdfm3qv3g7fk17hh6qxskp7rnhpw7lkmj6q")))
   (package
     (name "licence-finder")
     (version "release_392")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17x4hcr30ky94s6mpyl60nzl2lm0n3sjzbcbz3mnmsa67jlps3r7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1n2mv048fm4kfvfqb4kp75by9a94w4ihs6s8992bf6b3faix65aj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jkl53qblp1l5lqs3cgs2pm1azxpslngbwx460j3xmxh89zhqjqd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pc6gl6496xdlwhigv55g3q11v2xf5lnd5jsjr4vrnfynnifk250")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "16k71qwf5wscsadj38wkkf9zkj03fv9j99zf0cmldvh4lh2hv1dv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pkf4p00qiwnr3m4jn2am1r81zd6k55qxd4n4y803nzkqyyq323k")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0raah8mdqkgyjh1c154cy31bj1mw24sljc08nw665k91w3pdzpdg")))
   (package
     (name "smart-answers")
     (version "release_3971")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07kcgjn0i3zbwbg77scw6z6grb9hvqrcb6739rrvl3mk3g4525gx")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ij1v6rrwb92xn7dzr24r7hmfm4brgajxllgsi8igdqi44rs3dk3")))
   (package
     (name "static")
     (version "release_2882")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17m0h3k6v8xlgpfk1xng4v2w8k88gq9y1kmqpnrvyn597qa5x128")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0a2sd1wkr8k59w6kw5246zx2ic0n3078m3chr1rxndybzg3w26di")))
   (package
     (name "whitehall")
     (version "release_13487")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "198kg1s9cijnjazpp9sagrv33pp36lj6zbb1l1wjj9ym61xjq6h6")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
