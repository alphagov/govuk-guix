   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1raiw16f05dxxgwfssjxmsx24gk33p8zjjnwdard2yj7l3r36645")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m3wn1jpv2c1d006llq9qvs3p3ii9n2cjzq7m7i0s5r8kmrrw9lp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3689")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04l8858ih5a1b8swl1nzg551yajsm0mijrl0j15njpyhyzpdj32d")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
