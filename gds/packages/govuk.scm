   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19yb5rzm1r7ar10qqgjvmlf1ml3ab7ii56gi1d49madl5a6kkrcj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2898")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h48xzadl25cq09fy3rpn2m34hpb89x31pdnw4pclkm54kggcdja")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13535")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18q2kpqfsnb9841xs20jflkvar9frcn8gly920rsxjggd1lka95m")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
