   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12nc5fz59kpb7v45wkgajy1iafnyjpcshkgkijw9zqw7k69wypch")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hf248rmb3648zim01v02rz6g7skjar8b9wh6nrg0ds7mhblh48b")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0swrszylxrxvw9hx63y7rbswhd12v6jinxklkgpqh8r4282dii3h")))
     (build-system rails-build-system)
     (native-inputs
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0157paqyszlllfjqbzh05vashphxsfyds3ry11i1xf8mxpga98l4")))
   (package
     (name "maslow")
     (version "release_500")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "063fgv3p56vavhsd28vagl5333apay2whizybij7sngp11p5zp5g")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2436")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "027kvl3rwn1fza0jj8raclbgp64nldqnwyglwdvd74sgg19nc716")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0av5ksg7c993rmdi4k34g8xchd3g6wc46sjssibikza7g6ifirw4")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pi5jhin2kx28jw3a38qkcjipkb6zf3fsznn4fhfgm7qv9j1nq9y")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
