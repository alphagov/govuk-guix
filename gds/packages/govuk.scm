   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0flq2prcqpdx3anslq3h5bgb85car00cdjmxah76wwj3dy7865dz")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "045crrz1j68wprzm8wdwbjkqv6gr6z5cbhhlyn8p2icxbch6izss")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wpsb3k63ijfyfsxjc02ysavcr8sh0wymx8s00255xxdmfznhbl6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15bcc1mg3l9cysc49vgipwgq7a2ndjai932l0r3sv8zcg7izfl9f")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3625")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06v1mnfdlf51syj51xkd2p52i54xfnjja1ma27a7fpv17zankg18")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12840")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "141mr8j5xd0ydkj67i8vf055lww59xxxci5glyj899r7jlix0055")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
