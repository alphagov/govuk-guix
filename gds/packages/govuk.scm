   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1a3sgqnynak77q49wbjr7pjajmz714kkg5jws0m97lgwramyw455")))
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2704")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dp1fip15jfi4h3mgh1scadbxrv0651fx87njpa9mwlyq62zgcl5")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13067")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13l1hc63kpdj33wx4y85ds5xzlvdp1gbafn7j3kxv72pclrb78mm")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
