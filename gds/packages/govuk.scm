...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v67r88jm802g7g53h1yxngingdvc3xdijyksfv61br69zysfx20")))
   (package
     (name "calculators")
     (version "release_717")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k6hsp1qqp09bmp8w5zqnhmz1d0a1ivk2hvv8jhif6k086rrr1zm")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ww2ix1pwship1l7xwrniq5a0vbsmj4y1hvf76pilg3m2y7mnb37")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nibk2mbd4hk1ka4na52cwy5fqb6v3ad9phdh8zby10y5fchn069")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g4vs1pxf0v8krblzk181dlxvjg8001xapgnb1nrw23946wbkacx")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0y0y3rjan7r152hxzna2hkq41jk3s2hz1jnyp7kylna35hj15kd6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02yhacb2wrhpp3y20rjcivscfyggjh0xb8rlichjvr78c7128g1f")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "17ib21462hwz0d94f3v7ml01a9dwzihrvp2qgj1b2zyvj9bwvbbp")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19gzwy8d8kaf2vjs68y8sfmkhv0njvp0jnc99n8a33di94mr1xhg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f4icw8hmkkks4hvlbqpwf9v5lzs6m2p0b368my679v3whskkjsy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04cqh6x162b5409rf829wznh12grky08jjwycx2awdcl2jl36b73")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bg3h6scvndcyma3rv2h3f88sb49cmlkk7lwm4awb6qfw10vj8sg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wfzf0imvg01ppq2lkw3ykjjxf6wzhagi0n14m3n90spjaqnmwrx")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "022wr4mh6z5200cajr5a758fnqx69jj94rzmmbf0j4rx6wsm0y9q")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08l2gmm5klaf1xiy796r17jakh6gxv46cy20i1i06f52ibzclmmq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14762")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1199ikgx1ls070gmjribkc4y4hmclbxdp1ppm1y1m2q7avvnv110")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
