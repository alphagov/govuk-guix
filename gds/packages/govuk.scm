...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "16n6cpmzdby5708mp3mllda4a2p39ha2yzfjfyasl6jr3q13lnzh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nj34j3lp2ylzk1kjhzcc6hdsm9akjlm42r1rhl4inhvbl2yp767")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03qrkcvjf23gm266325lsi0flmhg9086aswqgm88jmamwvl6dahd")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yyl7576j3qjpcpb469mi3skbyjsmvr86z2wxdd1ga0ik4dvlwml")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
