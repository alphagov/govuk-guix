...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1c4kscq09bmsn1bdrwgib5axznrw2fkgmqf2ms1f8i2n10yxisrc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dxbj0m67ah0xzkpvrbam629xp6r0vpw6hrvh9aw3v0r9283z213")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pdzjvdfjxwj68pr1hv96j5w8njh115b1zcvfssfjnsg99pj0972")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r1chr6wsczxlsfvsdx2ywclb5dz802m1k54vchfl78h85hd3005")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ksh4lacdl4gpzsb3ad5wgvq64mbrqa6fdnczfp0jyv52afmj9kx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dqs9dca2w3ds2yc8f71bsabz5kbfbrf3lcf1kphwskpnz3ni7ps")))
   (package
     (name "whitehall")
     (version "release_14751")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hr4blspzzric3vb33f4pv7gfvrjbya935rxsrd2757h59a1lbmw")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
