...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jk4khq5qyfxc4kgvqmxb1yqx6826xlwm1vr43691988vf1d6nxv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1svj732b0kxlz5ka67vbm3l3a2l91q9nsc9r8yfzd220y8hglfjd")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0s8b22w7qxvbkzprbkqnzqbh87ssfl33wd1fg485ngfnq394rb31")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "10qbycnck9hghc0yq8x2xqcx8zgx70bsb5bwvw4fr4x3s7hiiq7q")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
