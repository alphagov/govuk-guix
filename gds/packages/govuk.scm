...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "15d9k636bvk6qfd65gmqsl8zrcm0jfkkb769w2mc38z9bk7kfbr4")))
   (package
     (name "release")
     (version "release_503")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cvc0aw7g0rnh64ibkanvyz6wy43vqz0ddycrwrmb6hb21bxpygy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1imgvsjm8g6k2rnms4f1d6g6c2mmr1mrlvzwn3bw3cayv6gr804a")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dqmkz8ldv9pzx2hz3q8f2v1mf6m9125b24m78aah6fylcrfkszw")))
   (package
     (name "transition")
     (version "release_987")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sbphwrcz77k20d971748y1l9ypszmx417bnddlg68f9x6krhzcq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
