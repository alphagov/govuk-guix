...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cwzlbn2jsxisl0ql4qhqd24j2kgfycmf4amp6vkrsinh562mqqa")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dvy938b75r7881xcf3as0jg793qkxd1zx27zcgz8388a2zqj51n")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b6hfd5vjyz9xylfjq8s99lvm4xhm1llx0k8h0jkpkkp7qh7c8nw")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13273")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ph8a80qp01hyyqj9wd2whxs27psiqsmi9a9smf31j9nlhm057ni")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
