   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "094x69yihmyy70qwax1b7z7z2h5aza4vk5wqddd5c3a504cqyb11")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "17cz00laj18ph42kymn4xgpdjnf7hqycahdicviabn1d9al30il6")))
   (package
     (name "whitehall")
     (version "release_13711")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l7as43g4wym1kx3v34gmnk1ia6picyhgg3l5rxjzrxnd5700qrk")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
