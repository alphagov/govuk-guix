   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f6m3ybrq4sz2w452aiv0fb2crkxga1aw7a40djprh7yfpd4z7rp")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02fxsddi5pgnm1gpx50kcaf2aw4myas24xfqvahapi81jvbspjb6")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bbm11l96wrmhsspba2ipgx1c4vl4qz0b37n899nnr43j5nwbfd4")))
   (package
     (name "feedback")
     (version "release_861")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pr8kxwqg80xw0wsan1s26h4185mzxdgn3f6chd091m6zyki95ri")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xvk9q2q16sg7lnxq48hbwbdfpx66gik605x5dq2rhh26ak8dpql")))
   (package
     (name "info-frontend")
     (version "release_520")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p5yvlzlbign2j6ip35v35riflkprpqn840w7ll226jm486sbk2p")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
