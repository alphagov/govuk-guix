...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fws574m00akxsb0mpffdpxpwv1yj9bqkbsin979jvbplpffw27z")))
   (package
     (name "calculators")
     (version "release_568")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z9yflzmsihm9hrlfa677g2frfp96g81f0pj1472jpy39hmcr21x")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d67vkzsw01f94n9aqbmfb1fnjas5qgx3xj7gzrhfdlpps1lgyzy")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fmiwk2h8bnkc330x746xjhhcmyabmpicf8fs9iw57n1kx60rl2q")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mdik9d9qp0cgdfd1sspnhfvx8afmz5i4cavljf4r5ipakkdsm68")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rhl1d016afyw0ab0rpcdzqr9gjqvbmcsnl3v9cjfisjyahy1pls")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lgys03fcwnryybg97jmvwra3mn89n117ax8h83p2dw79fqs1gwq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hyh2wjmpx0cswyd4cj2s7xk2wxhk7wwzm3zr0mzlr34h8kb9gif")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
