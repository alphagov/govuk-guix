...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "12alx6ajn6skli4qnbjl3b4ikks84y1dsbx7rfcx8w1fyc0dmvs5")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rdq2x31ja320m9ww0hi7p6wi6rfsz5c6xab85rl30r5q8b87q2l")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public short-url-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qazd01jqa1ypmh589ca8hpibn3axls0mzzypf93z31jf6mmza7n")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d7v8hd5si9r4a3a34d59jxz7146371dkbj51psyrdv6s6xfp6x8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
