...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zmr3jd122an6rqg87pm6dbqb3ggl569yhqinp7i6xk23xy5wipx")))
   (package
     (name "calculators")
     (version "release_718")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1laxw4700wvwwqajbpii123792ncmykd6brbmkvv5jgq47s099j2")))
     (build-system rails-build-system)
...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "04ygvjslhslycwxkasrbwr2sbr9gv95gi312ll29szw7j283jayb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sa7c81q7w2qm2bf6maiwwdy2l8z4fhcwrlpq4qvc3dlaigpirg1")))
     (build-system rails-build-system)
     (arguments
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hbw89xysxhirxpc4afi6iixvzxzfsjdzklxksvqp06hp6jz9nh8")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1db5khql88nskb66bgadbinrvxbyi5zyv81nzinlmlc7j8pcim9m")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
