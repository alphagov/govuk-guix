   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ag5mkd1c3ab2j4wnqv2767hkgkl128ql4j2qdpni1m8k24z7nil")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qxc9983a0s26f8l2aybwm3891bwnaf1zr4a8zyf3mqb11f7bd83")))
     (build-system rails-build-system)
     (arguments
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nripgmgwj7fknh6b9pl8361m72jw52zg7zhvgl11wk06rqqvc6h")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14gi62rw72a9il3sqsxcmf7ygy978xrsay1wq49g7jms1fivqac9")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hgp2xs1zhaygw23nqkdd7jlp5dcirm22qkhbxhjwhcp0isajqyv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4005")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wa0likp6zx938mrmbnd8j59sv1ip86dh87pwj6zas2lb0csz7l5")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qp8p3i2mlw0jl4l35k1bxwsvrah87ah1vfcvvj6ggad0d4z9x77")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rfk6ikbgd9b2paq3l0gqpi7mxxaqfwd6nkiq8fd0kpapvzhsjym")))
   (package
     (name "support")
     (version "release_692")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01g5wm19bph3w5mmljrjyg833nrh2wjwyf6mkla2m8a1cz3pfr8q")))
     (build-system rails-build-system)
     (arguments
