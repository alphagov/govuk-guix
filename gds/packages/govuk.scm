   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zcm1lndixi36g77apv5x4iax8fpm5xzzc9xpllf8ay30mlafhnx")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0msf1xw2c59n7yhq43cqf6v8jzbpfj21xfq6yb3kyvjx8gfkp5b2")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z060d3jvxp9gab5s0vxszlhpqdnf5nac5imp7kfd6n51n9fzkl8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cxw8yl023wrn64gngzafbz3jp2xwwz73y9i7ghsi5js504ldhi8")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bsa8al5hgvd3ihhjvxlgmd3mrkkx6p0lcnkd57plzr8588fr42m")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "19kf12i2g804gr6aw3f8clihw91yidia443f1wj0x4q15nvqwnkz")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1p8l7x0hbz5wiciqpsg2air6v01jwqnbrh49255qy5vb27xnkf60")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1p5gmd0cvmss5yw86cq4nsy75xfafcybd1hz4p8lnvkhc74m2hi4")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3755")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mwcamfk4bnxjbrjilj7afwwzdcs9f9cynrl8nc1agmz5bc2ry6m")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2690")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0aljn6jx19nnmv7rly3yzg908025p4hqdln4pk9sq9d34ibypm5q")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13033")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "017dkbri8r1sv8810d8ff56d3zs51qpjs9cyvi5x73laydwidki8")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
