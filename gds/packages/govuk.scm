...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "091iyvkyzapkkr5yakgb576h2ayrcrmlls02l02g0qkc2kic9700")))
   (package
     (name "feedback")
     (version "release_315")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17h5yw4ah41yvhhh8crs8svdd15hs90ccsnjvsr19xapgcqbdgrh")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p031b9xjkdhss2mdl1d3389plkrwmpa5bzlfjlcwjybldlh6xn9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
