...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pdwdm5p34xn4klwvrhy4in00zj85pvnsa91hd4ysb1diqgph52r")))
   (package
     (name "feedback")
     (version "release_750")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bbq2x5akfpyf99zslxddmjyjq51xwz874zq6vhma31wmapm7142")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1w9s1pv9l9svxlymi40h20ngr3gkad3l610gzhqwmn4s6b4i2rgc")))
   (package
     (name "static")
     (version "release_3268")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12a1cmf7jh7dm4j0j4a1g7y4mk8yiz8swplmj53qjwbiy9vap7d7")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
