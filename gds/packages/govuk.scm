   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jdv8xd08wpxv2zjba2js786sr0650alsgly889iqg0i2rrh40pc")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i2zhn51xb26qyyg4153w1msw2kv5faj59sjs8gbjpirdn69dji5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "08dp15w15dc1x76k0a87cgzbpdhi075yg5km5rz7byrv7mh5lnmz")))
   (package
     (name "frontend")
     (version "release_3286")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vnawhhz5s7n3w8w3yw4x3d7d6qxjx3jdr39c3mzl044jcrlnhwy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
