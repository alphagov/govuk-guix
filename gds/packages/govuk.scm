...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "073is1j8smr6yxb43l48gjfhmk9pr43c9xy4q4wh3wpknwqlwypx")))
   (package
     (name "frontend")
     (version "release_2950")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08qmblxlwjqwp8gh7yj1hcd2wz5nnwbcw2rvikrs546nx0cni371")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "14xiyfj3s1dr5bsfkk7pdgjb4n4qwhrs1jblrvnbxjxibl3j7r5b")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xwazxdn3imd3x3kq8a28p31dnz24ify8fcy47rziainqavhmkln")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
