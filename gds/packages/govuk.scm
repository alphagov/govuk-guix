...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2613")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l7chwdhfxvz5b3mrsb0b17gpr86nrdq4wshfsr677ypg35chazq")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12876")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mxkg2yacq5rfiq2g04f7ni8hxyvcsv372nvfcarcs79iib1albi")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
