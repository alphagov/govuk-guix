...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hcz0388h0jrn25g3ji9jfskb588r2ybrs7gkdq7p3wwsqa3h1gl")))
   (package
     (name "collections")
     (version "release_728")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01fcslx5170papq84yza7s9wk4bdchg16cggvaz1132df4yxldcc")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gagv0dv3a3qywaacnkw4vgh781xxndi8y5904pym27bf60bcbal")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "150c9p6x71qpf5r0g5izxb8lrvpcsgx11shr4yrv22b631y6xfig")))
   (package
     (name "static")
     (version "release_2989")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19ly5vp36dd86babrv50359b3i0m491nbbkjyp4vcp4zw9xqian0")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
