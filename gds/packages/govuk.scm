   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "005s65arp6gcmqjfq9vvnq54jxy5ch1hfb277x9mz265k74rc5f8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mdlinccgmw8q365a5fgq5c3cjdi1kvk2dffm4ccy5p5zflqw2vg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11wy29c6is3xrdjwhnsirlsqcgwn1iniqisjfmws7kshfpw111d3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1b1hdyz8ih9f1jdi9b6c0grxjrhhk391d3viyxq5fblcfn5hvvlb")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03qix9j5k3c7xd0h9mclvkmlhhss42bcv1qcbkyiip99vagy7fa7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wkwa9wcirnyxcd15agmpz13xwrwf2i42fjlw2fdkbmlsxsqk53h")))
   (package
     (name "smart-answers")
     (version "release_3957")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06wa4sacxwbwqy0gaswjfdihfvji77575qy8kjndwnih0kwmhdl9")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vgiyiy41dxpjdx2m6gba73454slrqzqjwx1pcg8ccgyqx5q0ywn")))
   (package
     (name "whitehall")
     (version "release_13460")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ang8i2ywx46n1gbwb5fp4gax7px7b62hwfkawf9zx16pfiir901")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
