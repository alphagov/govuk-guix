   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fhz1hf12yy3q6jsl7ian3dv2agvjhw6hfhd975i5il4wvnsz568")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d3rl730vcci9y2bspzk39msa4vyx7d9169klsijfqgsi2fnbf5m")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "06j9nprbacgzs7bla5q25jh4k05z6bzndrm4y9z3f5ksayr2khvh")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ih6743jljdl8d1974q91r6qlgkacr9ijdk9j0i7l9m9yvdq653v")))
   (package
     (name "whitehall")
     (version "release_14490")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gv500ik4frrlmqdc2ak2sfpn3hswdljgalgi78r07y5xh0z2s3m")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
