...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "17hacx107y5k47sngl6vzmz4hgky2dwgcp3azdway099avpmg8xg")))
   (package
     (name "collections")
     (version "release_674")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r53icmfhmqlv05j7rjhxiqzqwspyrqaqjy537zrdszvffqnrjkc")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pqvqhs2vyfinl1n67adsca9gq75p345d1hm4gwjamxwhphvvrn8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1wjzy84i9np2zziw0pyhxs3rq07kyqn3as5zqvpsq0s0hjf7ispw")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0038z8b3n1xf8x3j2z3yj90zv5jbndslgdwmqhdji1zfqpdfr41h")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1r7gkpb9f7a0p1fhi3ad6bv33mdznsm4fdd0kjpm0ig2jmzxwjzl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19jd74kfp5w00iacn18ym1lqhl90vm2lvd3ymsgc62lk7zzbzhxi")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0k5bjg1w3z2k96sqclgr71m0px4vg3j1dl10bw7sqwmim24zpl7s")))
   (package
     (name "feedback")
     (version "release_491")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bn6dj9lksgvigf6w6y9wwq2w1skcr2irp438m4pny6vhcrq3lj6")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0w7ymd8j4cahcl8i30ihj8kpq0s4czqsx76l0342afwqfd09q9yn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zcp12mkhycf88ia78f9cb6sppiyxv1li0jkjnn9xm8qr0v88x8l")))
     (build-system rails-build-system)
     (arguments
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jql026yxymml3vq2g4zvv7cgajnmim3lc7w38khhsm4zm1nbawq")))
   (package
     (name "info-frontend")
     (version "release_207")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "186xqb016540kgqv34hkcrhqagr1jd0gpx6bq8mh3nmzk0762am7")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nm7w14cbw1bznhdgigpsa2xfrm4rjh6kj41jbq8kzfqxm5lg739")))
   (package
     (name "licence-finder")
     (version "release_439")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01yr0cdl7lpjqhya70pbh5bg5cfxv64igkq5k16bax91zyhzmj5n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v6b77ynpg9yw405v763q1mc695pzhara6m57yavm8gkqpcnip04")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g3j3dlhkh3g2kg5w2wz5n38k8rbzrzajkfmpfy9lv2cfwaaii9a")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qkl0kz4drg6zdl4y3g1h5yihgpb1clgics9spsmnqaiw0qar0k4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ils02yx8yi7bsbjx67d8q2x8y0g8mjbiv5dr5z63b3p95q9zd7x")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xg887m4dn01ci7f1wr7fg76k524lxiq2g3miq7y1zm52zcr0i8q")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
