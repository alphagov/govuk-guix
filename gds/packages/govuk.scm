...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3843")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k7i2qjghqknr7vaglvscrp6wd8gw1d90jfrzszdgha3x1ypx0gh")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13252")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02bf7abnr3m0ik7v4j0n5pwi9fqq0gaw2kdv2l8q7vfd1cnfr62r")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
