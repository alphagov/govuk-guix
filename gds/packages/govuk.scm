   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dkb354h1z4mzpqdxwxwfmqyhx5hmmhs01w4fkc8m28m3z7lrmps")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17pkizrf8brqf1zdw3lrzgrbda51bw64znabw9a6mzqx90sqdhgg")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13159")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "132qvny1k7s8w89bw37h277r5k5df6d1fk5hx72kpqblcbq0xwrx")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
