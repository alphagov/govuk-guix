   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gfpnsgxdh4pcypwr9zfpl9pli3jw7sarqjr06yr3hiwwr1whlys")))
     (build-system rails-build-system)
     (arguments
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vhh04wbjfp9pi3ykcf2s1n3aq4dycvh43fk23xaia9i71a4c4iv")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rjaxfl7fqs4k6171mpjl393hqwlxkl1i83mg6fir49q5pfkgsxf")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
