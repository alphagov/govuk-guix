...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1hjgn3lbj3732mfbsrxszdk25iy4zmk8527dz21xzhzyb6lg81ky")))
   (package
     (name "smart-answers")
     (version "release_4163")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14lvalng896bdmgqm8x09piilll8v0fifk072sz987m3msl1zx8v")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13862")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mqs9a3rdbqr1m350qzr3ij40fm4awvj74d7xhnbksnfbbhi6jn3")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
