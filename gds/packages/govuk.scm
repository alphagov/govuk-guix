...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0kzz88jaff3qsfzlpni74d9vcp4izbk92a2r9jmw268259wrkywc")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "04scwc1adbwclgnx1a1zi4hs36p28p4174z1qizxi7mgwqkdk8ks")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4839")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08mhqn862vb0mha3zddbwcg89adbkrvxqf8s53a7vrfxz2dwcf8m")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0197s5cq69xpljzvhc0lkc2s50jd1hrizw7ihzfahkwq1l7b5abq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "000r4ypy51wa5fbn8v2amb5skgdww6x77v4xma22q7g8ffdvky7v")))
   (package
     (name "whitehall")
     (version "release_14835")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0abp6l52gszgjh1qy8abp1r5qi3gbd7gas9k215y94gbris7gilp")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
