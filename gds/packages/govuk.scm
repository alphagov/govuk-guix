   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00cwkdmwnpblk6z3cn9hzqn1w2ync10gznylqfhvjkv8cfgbyxap")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g117mkmghpgd8ic5xx5f05l40ndsg9ga6cvnmkdzbibcrgy2f7q")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bzwkd609jiiqx9q060iqk68fbqkli3rfrrscrh8a1wpjnx8vprb")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
