   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0za0dfq9s0sh3cmga19g6hqqmy0hvk6m3vmydfv53v2y5fxxyl17")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1093gigxg02r7fxjmjq36zayl7n7460rs7rvd8zv9v9pf4fddfvw")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3673")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1apysqc961m1qydxm9crpl47wipyhs37mgf5cfrh5xf23s6mcms1")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2618")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17jlfcv4v0w39rmmwckln75il69rpclgl64ypbpmbklhmxqlc8fx")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
