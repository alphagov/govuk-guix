   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jym8i2ydvybwhdbxrn5ip7n8s8akax125ivl51yf7v4mw1izsv4")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gnjv3c9zv1pby3a5lv39vpprnlhnkwsppcdf6wv5r4iygyqddf9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ss5qaakslfyazda2946blcm5wmxchlfdmx3m8y7y9lr7ybvf10b")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2232")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0895m90sxy16vyh9cddkrdxb5565ypslq28lahnwa0z3x22apkii")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
