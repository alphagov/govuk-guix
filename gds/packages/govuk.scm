...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "14kx0kjw1rm0djpz1mcjsfbw4knh3q2v02pllhz39ykjj35w9nx2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q5dlyv10362fzhrr660vhldd8bwk76nwl85sdapxak6w2cik9iw")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4804")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14s62q5sprzxgs7244pgxplcsnnq4077xp8ngvx4cmlhkmi83irs")))
     (build-system rails-build-system)
