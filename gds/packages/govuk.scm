   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j5np20kjq2wk9jphr5hj43zv2fh22bdallxk58a5xyvsliav7kz")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s4bvlcnhnqgkp5ry2mxfyjh9zsaisi52gi6khs2sbvib2qlrbg6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hsif66hifssy6hr04xdhrdg02n0lr329f3sh4j0284kb09hhi0s")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ivmxlmafpfamhb62qhdbr0krayw0av106mn9b5fymjv0g9c0nk3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jf89dqrvs3qcyz6k4cd8b7fllggilbyl8xvkw1rv789ip0cngdn")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "15r45rky7jlsk1igpjz4c6pc101dyrin3z1s8w9nm66j96w81kwf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z5x25x8r9vq7g8hwpki3ffs5lldrk23gxax7gjwdczd9ldy3sfy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "117zzlmisw3cb7pkmnz67x53zda1cl0m19jmajawhqz4qc4mz68r")))
   (package
     (name "feedback")
     (version "release_609")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b4kajg6a6c1ak76wd5r9jdkbykpssa0qml008zzw1qv8xw7vly2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "11pkh3zxlzm1z7aadbiwwp1sd98bdscpbfld3458qimk82m57nx2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16hz9kpqjfacm19a7jbp8ml9fr4qb3zm82pnq9z1msikvabvzsa2")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "09f2q6wxwh9i0aa4qf5pcan5x4zb3nkq0fwg569gabwn5x42a3kk")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "04sdppdd6l94brgj9jqcph9zfag7jgmihb5y6d0k6a4m697lx965")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public rummager
  (package-with-bundler
   ...
   (package
     (name "rummager")
     (version "release_1914")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pf7kzg1km3ndhs29cj34x2aw412w0y80czml9g09wyb41ilbzvi")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4228")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r0mswj4z35xz6m0d07cq5fkhfmwr23bii6gjjva0js4kgri9qxd")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13940")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06vf0gyinlwsr7zq0rbphqjqklwkivgjvfvna5x9cywrb867dq7a")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
