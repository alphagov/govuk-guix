...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "11q4w22rp53bvm5h2hps8fazp1vfp60f3j7bvh1zydiv61w5v7iv")))
   (package
     (name "calendars")
     (version "release_508")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d4pzw0qjiklkpmxyx2r6lgiib88jignikr3qadbyn76667dkvkl")))
     (build-system rails-build-system)
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ypsksnc297b514fb8qd7z9cs9ly4gaxjiahjbqjd81i1v8h8i15")))
   (package
     (name "contacts-admin")
     (version "release_439")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xmd02rc0pz8flzmpn1jbndncaq68d8h32966f84wwah9i63lkpc")))
     (build-system rails-build-system)
     (inputs
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "06r6jj6br0pjf3i2qqxh6yy5xp125vap2815r1prgpn7psda0bfh")))
   (package
     (name "content-tagger")
     (version "release_778")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "036aqzk67b25a30089jkxckh4yw08a96f5r1ipqm5xg2pa728c9s")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "00mq02llqv7a10jmff9yvxgw7im8vy0h8wmgdkc0hrffwnr7c9h1")))
   (package
     (name "frontend")
     (version "release_2878")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00z2748hq1cqswwg1xmnfygmznbpc96w9vd8by7i0h16y2m3pz35")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1asbdz0mqnl6y23p5na2lb50xwq2pb5p1qpcyfqhjsn7dbgv497f")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19c9p1y78kv6llbm7g1mkw690b1c3lb6adhnh8cr80wvr9pybhq3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "16m7w9p8h19aixv6a2q0k7ivrgpihw9vj3hzqkrmg12x9b7r0p53")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hy87iy6varlqn6nd557wsphshz269jzsd2dama0bardjkdknh90")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gbskh22ls15r4zllc40c6p9zd6v3k77m56rq58khsvzgnav9ycv")))
   (package
     (name "maslow")
     (version "release_278")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c7dswz8giyg5zr4j29qqh230dm5ydl16z1vg0xxqjjgrgqkkqs6")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "12wia37c2sb47ynllmggkcss35s7q4vm1pfsn34kr15kpyhhfsnz")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0fiikvf616jvm8385nd8y2331rhgfr3757vzp7msjyqmykkhfi47")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "050vlid82b1psakpid2g93jdyj59y15wz8slvjs88hyz37ipxk2b")))
   (package
     (name "static")
     (version "release_2855")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wcj4xqb0qfs8baqhnzk0f1m1ksiv3092axg6a058wymbcy7q880")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "0d22n1g0dllh7gb5jxbbkv8y1ylmmzyw4igfpczgjxws3rgfz7wl")))
   (package
     (name "support")
     (version "release_669")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yy230ldaa1j4z692wp4fdp9p1r8f5a5hj0il06ff46d0spj9a1j")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13419")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hdh0s2jaa8mzlx3qjvvscc4sg4v403bbarpsyqxj1rlwkha65jr")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
