...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n47rxikky7bxqsvhg1xq79cixva5q20lwiva2pciasb3wcwdzlb")))
   (package
     (name "calculators")
     (version "release_728")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nfi9389k9ivnqaj99jxcacdd53kq59nhm7innq3h7h5h22q3y9w")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11ym7vfx932ri50j5q4mmmx3c49fhqnj9j87qbc11wjsihhwypr5")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0w8zfrcml9s41aycz3f3h8admpi9ngnfwk0lh7kghfdym1ha6aa9")))
   (package
     (name "release")
     (version "release_643")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18j1q0ip778z4xcr60pc867bx22kxc0xhmanbc9ywipbcpllzhh7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public router-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "16c4aiplh8cd0i7pi2q0rxc9m1bkll4cp709vyxnj49kvaijwy0v")))
   (package
     (name "router-api")
     (version "release_304")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l15mp5jx53b419sdsm96ark3zgsbal22jpd1h1jg5pb9ah05d62")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4797")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01zbxqmymm66g2y1zy8r1yps2yhj5qigxi7n89pi09xm291sh86k")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h77qv39lfbiqjgmb9vjs78ll5iyg0cwa7m81g19rm9vacnq4y1c")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
