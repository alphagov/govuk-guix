   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08w5dvrzwgx943kc06f53jfdgwkgnj5f7087p13nzy7dyjsmh8lq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3754")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1szx9q53kn6alhsbjpwfdykjpxxk3i3bxx4n4i5y3jj8rkbdd9w8")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13030")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b41r0sxcnryddpbgznx9sy10z95gv9rsm7zxqvjbzl3w6rjinm1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
