...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "04abbrzdbmwfcgjcjwpcpxx0blx59vxc1fb86hx1zns8jxbawcs6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10jzqnvjc71a2frpzaib3f9y08g8r6kkj91pqdrdsb3pla236kby")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "02qx09brybjjqm3khm2p3qlpzhbbdgxjgc85zzni8w6592pj0zs8")))
   (package
     (name "licence-finder")
     (version "release_473")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kiwaimpk1nxg4jliryq08wh2hdz4qyl6yfwgv7ks99ia4y3djjs")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1zs6z2hy4z8d7cj1i30glsymwbs0nyazl280f5r2zjgwhgvfy07c")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10m2qm4rnvaw6wpq16n0jl10azhs6b7drfpi26r7qxszxn3dmkpx")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f1yizgwm88z5c4dg41a5i3kyf3qcgjld0713gf29bi5xkjvlm57")))
   (package
     (name "whitehall")
     (version "release_13740")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wsb859wswha8yipa8d9fykvhy8v0m1ij0nvqzrabvxd9k3ki4m5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
