...
(define-public collections-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1h3wz5nhbx64ngrj9apwrsqhhaa2y0bnh2zqpfyiipmz0pp86hxr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vbizwqzqr7r2qiqklk7nawkb8c4b5fp53532h7kj6ylpap3a7b3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03z275yhvc0lxiadphd6qb0m2jv27vpxgj1klyfpkfl7lzfpdp5v")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dn4cn8vrhwh5vdj7qb839liq1wh08fv6ixpax9iyxjjfb5jkp0w")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "04jj8j12h97alpqgm3ybi8g2g0ns4cwypnw6pnpz5bvmvh30kra1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yb33r8rbj4v11512qassvlmlbzanhnmfl66k224jp8wpg5k68vz")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4212")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11x99ihm5xpacm0l5rn6qk9xx7bwsj0b9jp2y4n953b896ivkj0p")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "03ydw9i0rw6rpigvyggi95517g3ymll1svqisr9hivba43v5rmky")))
   (package
     (name "whitehall")
     (version "release_13917")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dr0k1w6yb9bnvddma24ccd31z1x2xrkjl2ar0bj3dxyznd4kfng")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
