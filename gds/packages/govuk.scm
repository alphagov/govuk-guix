   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11iz5gn49grgyjargaz9qvcvngzds2hr8mz8gh9g753z70dvpx4j")))
     (build-system rails-build-system)
     (arguments
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ghjmqprd7rfg4yqbrscghnzxzsd6g012a6vhff8jlmbkpg4yh8a")))
   (package
     (name "smart-answers")
     (version "release_4762")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m7akjpcig49mvn5r61fwc4flavihq88ws3zpq1jxp391hq0rb51")))
     (build-system rails-build-system)
