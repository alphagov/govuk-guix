   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g9a5nc7s7lacx0a3rxbapa24kmdqy8pq3zcsdd5pgw25938w7ln")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1971j2yfvskw4znssqll2j6h2qyfkpvbiq8nqgd6lfshbkcq7gi1")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12955")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a8pxyiys4g950k2f1j85mpq3idik72186lqqln91hh04ygznh6i")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
