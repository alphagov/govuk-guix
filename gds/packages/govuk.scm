...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ddk7jdvm0pc56b85aancar9wjil2k8xbq6sm806356qi2q3rhh7")))
   (package
     (name "collections")
     (version "release_550")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gkyjwy20c1msy2lzz0ygmmj9d79w18h8zadm8yvmdz5ba0b6b7y")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hj30f8f5kidnqadjisbljl5w29zz4hxpgg0d4p0l28gmhfmafha")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l09gw2zcff8rmhn6a93bf721yk751mwja2n6dmpnd5s80dc1myk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1402s6sixkz4p98yk3yd46l8i966w7wbc9b5s011alpann3nxb1i")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qbq3rxigrqkl2pwa14lasdrhcmrmkr3zr3ljk3xg0wg8f60pfm8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09ns5l81vb51rrdp1jf56fj8wxx8h3qvl78136j8dwgwd29x7c61")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "12xwnwcf52n24y4bkwk53bmyzi64k6dgiip7ym1vj38d3vk69d9v")))
   (package
     (name "frontend")
     (version "release_2911")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ak3q27cspcz54hic726nxa5qqhwi9qilllz8hpklk2ja0cmza28")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xavkxmfxb76bdyny1gz676rmj83l2hns51y747z8hmrnvs994lw")))
     (build-system rails-build-system)
     (arguments
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1grj73q4d8qz6hb9is7gc5mcdbq9zwdsb901h9zvzf2inxlyxgcy")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "15ycs2lpc6jrn0kxyfw506k23m1wnhq0wwdy317qbqr5pnc777j9")))
   (package
     (name "licence-finder")
     (version "release_405")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fs78zwv32f9hd9l6ywa5jdhjhrnsyh18s62ip18qm70rnp481mm")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gxgjbqqsyhfzzvlwawyj7lkkfisk4rnsimmzcqgnsgyrj3i7ncq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0wzf8aqsn6f3a4lip6aq5a9ycpmm9230yvy2x4gcpmb4vyl5j7yf")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ivljl73vmakgwm5a05vk23cbqkl5w46ady25qmm5vwbn2amxvgi")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1d83mgac4a7xlrfskgqsxnab44jgq9xwr470syk5qkjqm8a8lhly")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3991")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rs0cby3ddp5rnlm78g7jfsx5gxbsan2icdb42h70ys4dyji1pwd")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rla4qvl49bixz7n1q2x13n1zxw47c5qiq98na30zj5x2w26b56b")))
   (package
     (name "whitehall")
     (version "release_13517")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pr7hd2blj5870chiqzkk5jsn09r31088nalpgaz12nnkh1fh49r")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
