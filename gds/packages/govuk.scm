   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b4qn8qfbw1g1n0z0qaj0cv3wdrql3psxalw8q07niw13ayamx24")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0r3ji8i31hzmzm6xjc9hcxfw9py6272lrbrykcb7bvwbwcw358dy")))
   (package
     (name "whitehall")
     (version "release_13227")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bdr32c5mxwaf8cfdw8ic05ssb0k99iq10d5cpl0n7y8fxs61v96")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
