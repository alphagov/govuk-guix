...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ackavfrhq11dzzyjqxxxjb01h0ilr456w43dyrvxpnnvr7vfkqc"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r24pfbqa3hia5rc85rxib8m1cjybpd9i48al8l1spymks9wk5jb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0lk1scdza7k77zi0q902liqv3yc8gib9bakdlshsjr9xnwgarwil"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l3d74yvjk17cpbnq7497flfskf699dhkk0k10nvmb32dy8vdkfs")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
