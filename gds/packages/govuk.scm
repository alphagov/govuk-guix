...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pxspr8mbxyr89r1km9bydpndhaf3h1lm35xb0x0w3q5nmmw2x46")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0zwz39b321z91vfb1isdw7k5n29hw1y1h6jpj59a059y7yk8xgd1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gr25cja6g94x5jvrs0f36nwfnywar1s8bynx1gm0ic60crqby1m")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "04kp2r3ai21xbgh2lqg2csrmmhnzaakxwfq0i3fd6908d32ygb5c")))
   (package
     (name "content-tagger")
     (version "release_833")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0372d087wxq4k806rmmcqjhyqld6alzhrv7zr7r3zli38rxmkp6f")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0hmvns4xqzd1fd9kqj7yrbp08iwazf5g05izbb9nyl7m2391q7s8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "096b3dj6cn7qr9hpj82v54zy4g20a2lji6g1h95d68nsdi52dwl1")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public policy-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "02r4ppp40ybn9crrmi6n04qnjibnprj1p4mddms2i8sr4pqy193s")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mj97hbknjmd7jpxbxvgdind9n1q4d7pq43j23bc4b7pqclmkkh3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1y2k6b4rjk6dp44n0x7qz7ry2wyan4g58idy768p0k4k0h5v8c53")))
   (package
     (name "support")
     (version "release_707")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z4i0kl5ah1cx1z57ni94z22gnhyrqw1zpf99i7vnpci0jiq74ib")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13644")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0izbyy49kgnm3gbw272qlkn5s0ifcj65xg3236qvgnwy2x6jfprf")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
