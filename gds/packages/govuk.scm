   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vi7f4fcdgfk4j4sw5fyq65x8k0gi10c6yjg89d1r76h8z2279z2")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "026d02sc3imy5kgngw153ps3pa8zn2510jsz9b68vzv6szbnzclf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "145bfhxyc69jir0hnz1yssnrngw0gz9kq0q24ks5kcf5lq3yija6")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12827")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j50lhpjgrcld60q1h0v6l3i2398vf9cawkj7vl883ph82askmrj")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
