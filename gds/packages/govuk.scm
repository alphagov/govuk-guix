...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "11x729hybp5xyh1hvp42pzilcv67psfjlddijhg5zihm0v4kdlld")))
   (package
     (name "calendars")
     (version "release_546")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00wqdp8adr3nfx287wm7hqkbqkgy9x3yydxmvqdbxh48fjpa3bf2")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nfh2xaylb3zcfw5xqrxq2bk202wnr4q0l4pnlrci9xkrhd1niqh")))
   (package
     (name "collections")
     (version "release_600")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rajiixy1h4q9qkmxpb6n3dw4wlvimgl5pmyswpxm3ka8xwxfzfg")))
     (build-system rails-build-system)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1z20kkqmcg7mwg81pqr4dyz9ngxzyfap1v6yvm9bi4xb842l5arh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x0jiwn0jkn6gf1zhcvn4xahmmpdhkwvkbb0krsa5pq55lpp9l4d")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "12nvwfyw0n5m572a698kxcjglzbi5jawmajrji3m2kzazdi68p0z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hpx20cfz46p6nizl1a46qdrh31fk0dcypbg7097jdr37jd17xlw")))
     (build-system rails-build-system)
     (arguments
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "14jvq33nhfn7955iycvl5xsw9dw6mg463hcssj8yg1mdqzxv7qw7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ksswplz15zaw60pqbfsx2npq926b2xdpmnm00wmkkfv9bii0n44")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1jr4vzb0md6zbiswv2k890p1v8ayzww7da48f3x06hqy2p30nmjc")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kkwg913w3cl5x2sx9z7awfhz7pvfy0w40kxfqsljp3mck5xrpx0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ml9anpr60z1gvh5v0h3i1psd8dkm8hzbybmjx0nlsysj6nqkj7h")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "13gnj7q6hq63mdvfsm7xw1q3lw7ypdfw8sz6mnnjzm93fnpdjk44")))
   (package
     (name "smart-answers")
     (version "release_4010")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cxrlrvksw13zc9ffx16ylg5y68j2gs61gwq31pdrwlp16bgwx0c")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1b9y9dhww8vfjil1x7i3gq6zgnp68kp5j0svglyzws2c6wwhhsfb")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ajpa5494q7bzhjv9n9i75jb6akqn4bnrhv6mwmk3ba1dfs7jrdj")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "04c3hs503yxjx9frmg2z4zjr5f0fi7dm8q8rsl2r6q799qm6zyaa")))
   (package
     (name "whitehall")
     (version "release_13566")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zqgh9lb6rz0vq31dpbdkg36xr7pym6d2hjc1ha2qq7pgzq9zydx")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
