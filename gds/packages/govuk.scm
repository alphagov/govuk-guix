   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0cm260f7fw0splgk67bym81rryvh8vdl87xfadzwn81j37vdls69")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "05yagjz257qrbpnpbmpvx79jw6zwkc98zdxyzxafppnkibv557p7")))
   (package
     (name "content-tagger")
     (version "release_624")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xm0mnrydw7dzlmsc1cbnypdgpkgx95rav0kgc5vzlwg3zwi9475")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1miz3rl8synl03bmwsjxvznfwyk19585c5k79bgdfib4f0y0p99a")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1c0zsqxm73jvyl4ks6bldphbqdkw3najlh4fk5x53d37406wls47")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public policy-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1x5965ihyi9p8afwl6rrgn74ag35dvzp3dbxi0l4s3jg6sgaazyy")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fzj0ln6yipcafgizi91p01h07ig0z3gb41qld8649sazlaclq4n")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dyl24c7frdnrg2m45da51kxwa6zz6xiykkw963gd1zq53wag010")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1n8bsz99d8m2h7mxp770gg1afzas7sqmcxvhj98raqk4nhacpl8f")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0c8x36s46si0vjjimh82qb7lp8lklpwbm2d4irhbs9cxjqkfjdjz")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r3p6wqh9199zz5vxfbf0mhsz1mrzi1y3sz87w2c2j07qa2waa37")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13132")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17qqpl5a7k4x9q2lszdpd9ir099561m5qdip1m0ljwyi2xv5crxp")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
