   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "079qfrqmr53mpsd7aayr34lz9szjij97wi6i3izfjr37vv1pqgcp")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1jqpa9wl222zbfvhmlls0f3xx6yfd5ar6900v6ncpqr5d307p0s0")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rfpc3cic3gjcc3h06wrcfsfdagxwz88pkrsnqcw7y55cq2cdr3l")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2686")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r5bmjd62wjd35av8y7grcm0zkrxawqnnb3kfs8nrsq2zca0qa9g")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13013")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "132cl38p3idazqd5va0spmrm40slfbwn0a3nd4xwi6lbn0bhf4p4")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
