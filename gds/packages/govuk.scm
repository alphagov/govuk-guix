   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g4fxdi0m7smqn7i93k90p46k86fkbbf8l7k8qxqj9gc92jxz7b3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1wvsdmrxj8zp2lr7kbjy4pbvjnzxhf6dmi46cfdfp7gvcxw996i4")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2823")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ikmdrscjdcg9rdgyfh0fz90mlinskv7k2k81aawm1zrh0by5g8m")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
