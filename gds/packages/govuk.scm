   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nn0q3kxsdzj3nsxj9rda48fqwbr9dw2h7cgdly0939kbq3qwp3c")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f4cicmc58vgq4h44ci7yc1lsq86i9h5jdalaj7kmr7kfcv7cf96")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13548")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wskql7c7nvwcsz4ksx7bcxn2j17w3h4f2jidg47fld7wj19mh9q")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
