   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1amjxjhcqln5nsndimvf8qf12pyllhb4lwx4ha85qnsnsipdksp5")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "117yix3kwi986r9naxs39yxkds937wn6j8v33znm7nxyb3b79y38")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13942")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l7z8rygnnvi78cvk88nvm5mkzw45br8ym0cid21y4bx9f7qv19h")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
