...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "08y9dqiivnglk7fj5i3rdxbd5yy95jfj2vfwgb4vi2gqi9z2j3ma")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "123r189yfn5sh6889q9hfvpskffpvnq8plz1xdb0dfp3c6vd716j")))
     (build-system rails-build-system)
     (arguments
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "17rjbsrvnvgk6rvkcki1dcmcdg785cd8rvgsaq5bnd34srllsfmc")))
   (package
     (name "support")
     (version "release_893")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jl8g6hkxryimd88f6gmpmiv80b9nbnvby0w4478916lp2jykbvb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
