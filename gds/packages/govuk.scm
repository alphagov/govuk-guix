...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m13psh4bh0xjgc7ijd9j27416j5rvgqc1ijdqr5b977wclzfz8s")))
   (package
     (name "calculators")
     (version "release_373")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n4fsmrw824qxyr487z650fybhx8zr8l79fk0ask4mj2miwy61m4")))
     (build-system rails-build-system)
...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jz5nhi6m480500w97bgwjci7h31kxlzzvksk08zid4j71fkrk4q")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "113p86skxx0jbp218151f84n9llhwrfmq8iz7bdn49n8ja3yyks2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i117570h0jnzv7r615yalzgj6l07pcc694qfbcixvb9vms9d3ng")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zx70hlrapc8y2wsqgbpipxhrzgq84bz0h6z9bv8dii448m9c78g")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
