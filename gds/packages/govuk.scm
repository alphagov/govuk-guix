   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fgpcn720j6x4kpsmqssinnr1pfn4370cj14ji1knlw166di0854")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dbqh1cb9kdas91zpa5y1c5zk6vcq45qcivx4i2y2b4v74479gf4")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_3270")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ns6p9fqcsvxbg10qq5kd4xbm00cfyp7jxlkm5ani4dm3bryv6kd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
