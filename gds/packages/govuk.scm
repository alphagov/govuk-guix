   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06z1rjb91bbjyl6494hhl4dzidf2zv5jcnzx0isk820f9lsbb2j1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1qml7arbfvqxnn1hxr3n1rzh3w68dnbp097w5wfi1v3xb48bfp0l")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wzv7f19yiaq1k6v1d2lar7pqcqy0gpri78g1dp4b1bx19wgmp9i")))
     (build-system rails-build-system)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3669")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "05y7vbxc8b4463hrj1531ri622spfsnhlrbxiavvvafzfsg7dd0a")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12877")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z4dz5z327pi6yri6wjnv04add5b4a2ikpw4px74arsa8drrsv6z")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
