   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19i6r505f2kjhh011p270q7rkf6g6l05qw68w8z4nsiygx85hg4p")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cca7qj774880lplz6jn6d4s920yjmqf7jxj25pfnq4fzijyx7kj")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1p4pg19m21i986nnnbjf7wgs2a437pb4cang73lc1cg4hwn8smjb")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1baazwr164z3bfcd2a5l86gwfri9fgzdbiynw5a2bx9ijp4i8i1l")))
   (package
     (name "whitehall")
     (version "release_14204")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p6gvqgahc1hgci1dy31hw3q5baqicxfap77cl1g3f3ij5yb8cbk")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
