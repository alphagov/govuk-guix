...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ixm7y02xnhb5acp12pjricbna0j6ip3g6xfd5nyhdx1d2si8jf3")))
   (package
     (name "publishing-api")
     (version "release_896")
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0ldgxpbirh8r7sl9advx7x5gvdp3fkgg54bm5yy805k95z2q2cqa")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nm7fcppfj7zv44cxyw4wfy9xkwj9dhp6xbckm5ix09ahl1vn99d")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2584")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vs6qg33vh4cb25d957nqhfcvv92xdy0ikxrp7xpv49jz81vksy2")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
