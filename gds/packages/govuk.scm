   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1k2cmd0dzp8zln2yqkg3a9ybszfd5cgzn4sphvd6clzmnhm07q59")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x1laj3w4p83akidccz6b6adgfq4qi7c90s5b22hsy4yp0qwjcii")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2411")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mx8zv9wsqvzq5ad7v72wxi0adgs9002yaxmdan0gp2l3cjrdclf")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jaizas951q6lc34s2zfmwhxaip4xyi05fdp3sra2rjv0hb4ppjh")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14494")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rb0d5h81ng1avvfhyxa94j5pwi32gz8c026fyyxvk04p7s3n6wb")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
