...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bh2yf3rc9cbawxq8dyvhqz9cs5qff0r97g7k51367wrq08ghwha")))
   (package
     (name "calendars")
     (version "release_637")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11p99ib6cs3qp8gfnwis8860gdb9x3jgpb9iw82h9b83d11s71cv")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1csm82jxcppz9r02fppprba5sncrx079lxac3zmja71d3wlib0pi")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10k7a3vakypfh3kp07g4hi4f4zs0d6i493l6r9cis2hq5xi4684n")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n9k7ppzccip47z8jm2xnmlv7gmcm5rgcjda1wgd6am8g3wp7fvh")))
   (package
     (name "feedback")
     (version "release_566")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wgir77q7jc9sysj90bczgyb3c07gvc2yc3q44d2nsk79axqzn9l")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ihlpclh11ycfqrc3w2hvb4kf0rvrm7bpqnjlq7gx68kjpi90fx7")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zdkgm2i2c3k9fiipc03xn04lvj91mx4kivdicl9p768iy82s9sz")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ry5qpnpbaiv63m3hbcdni41mvvcamxyil55zld81v9v44b1wb89")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f41q21qnsx28bdarkhj6asrq9ds78syygjgg6872a0f2yns6ab0")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06rc7l7xcc25ljxvwsh4kb38px6xjm7qwfx0xw4ajqfdv3wx8ih3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
