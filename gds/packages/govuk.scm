   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0va9rrlrjhspr5j9z11x18ysi67hgcfs8d7hnr0y4jd3wvbn1954")))
...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1igabnv7yym3gm1ncb5n58p98q599rp5z0n9w7w6h7944g98h1bx")))
   (package
     (name "calculators")
     (version "release_249")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wmaqyky6ma5h8pxisaa1rxrjyn03lssay2g3d5fgm19kds8jc2c")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "0c2ssp3gwrws1fqqrfpjywzdfhvin0hqmn9395hsc0j1smf9z1bk")))
   (package
     (name "calendars")
     (version "release_477")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1wfdsrrpyxz9zjkify1rfzanrg1i0k71yiir3kid6aywlcyran4h")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fhm4bshmzwf92pb1fr1i2v7r5kmgnrmlb70fnlj7c4ashkglkx3")))
   (package
     (name "collections")
     (version "release_460")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16yzy12z9d1hbbfrwq87s2zmkishyfn79l6gfhb0glp7in382i7s")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18av3l172g9bn0wvkjal0iz62yx9bkr09lbgs9782fn1k6k254q7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "11fn331m7g3rzf7qdx9i7p8qfcza2kj2jjaf0gbr780j9x12z025")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0594agjxpa7jwlqygbw85w5icrjal6m6vmpsbyqni0hkk0h4lsbk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0iy8zhm3a3n7vhszjdx5kqq4bymzyvlfshls5daq1bl13hx7wfwa")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pgiy0a2ylh8a6g44sj0pybvzac1vwcf4a6hdpfahkcl0ckqxly2")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0l98c24b8x4s28ypkwxhcl7wrf5a29pp8k00q5i8r0as2kk7gz7p")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m67mk6as7x8swspq338i841bbcq586jl2z05l1x68yz6nd2xjzg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "01207vji8898dnhwl1jjqj6k9xkwflbimblh6aplg9cfb7c6lg8y")))
   (package
     (name "feedback")
     (version "release_381")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1lfh4qjh00kq58zl97c1ny3ail034zf4zw9ax6nf8c3z6i58asqf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1c8rfsnd3f29mxlxpi6ix6v6f7rvn0wdb4f5byb1qpg6k54v0fk8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y3sglbj2rji65wl60yqmjfmi2nrjy8vpapkp3yqf24w7l4w0mgw")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yjz2hcwnisaarlri01nvg2qi062jp3sfsd4xrlavghb29gxxkdh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18m9gnvji9j221kq6s118nr41c7kngl6fa2874iiz9s1p0sahha0")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1rg1l8adgwbvynaifyc8861h8mynkwi41p3ij2dxppypvr5dvj0x")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yx9j4a5i2dswyvy65n3rrrnysgjc4zmirlcb5hj9vaq6rf2ggcx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lgsz72d4cw8wpx3j0vzc145s978pycyxhbja5aynww254ww5dqi")))
   (package
     (name "info-frontend")
     (version "release_119")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00ml4p0qrc7310gd3hv8yhg8fa2p19vr1rpc3p2k6p0mvhc4yiiv")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "14g3dqmncl0znw29bddbj4cadz8xqn55f2sa9bnvdj1ggpw1a0wi")))
   (package
     (name "licence-finder")
     (version "release_343")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rhrr9kggd11l2m23mpdh0zvbxvd8rmnxgzsqz74lblyjg2gb2cy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "01wlw897m4im8g2hmqarqw405hd77pd75hhniwppjjp41nlqrpfd")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "122306myssc46jd4xfpcjax4306qi05bypncwnzf9ymlwhva37hz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_1921")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qwgqvzckhdjqk9560qlcvw978pqfsanl7pin2vjv7lvrap12cqy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "14sxqdm1mcpqs89v806zgpzjlmwq0nj63d3aa6vn7pgrwz0a80qg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1m4smzrxwn213nxslj7h3faf2nx0qf72m38ll9jgvvj61hpkr0hs")))
   (package
     (name "smart-answers")
     (version "release_3877")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07ww68yl2vnmm1fkgvcjab4rxlkv1q7w7x1413xihha7nl8l4h6n")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2809")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a0a2svzy8k6wqqsksrgn98ffs2mw37h7rzgqa05mwgi71gc9wkf")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public support-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "03l0c3mv7dq1f41m87y4kn694kix1hn3cms3wdf52ng0igv08na1")))
   (package
     (name "support-api")
     (version "release_169")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01dqgqgyz0sy2ha4i9inyzri1kszznk407ndzf2slpfs3ja1ajd5")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13321")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "076x5gpckjsi312as3p269hg5hgmwgzybcxk6rypa2rkx4g7gniy")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
