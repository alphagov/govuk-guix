...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2359")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00p9fm772mkfarv97pf8y7a52xpnax08z25zhd6lh8sgvdxliwjk")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14435")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11p5phqssfq68r8wyhrzxl6wj58wb1w0qbqknwdsq2i4dw51684z")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
