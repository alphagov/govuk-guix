...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "03h1l3cy67fzs9ngxqwkxp08w82np597sagxbzz8sd93q93rc5by")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dfnv043nsmkbrk0shnxpnn7brlpgzz0z93cxvjngk5h9pawydch")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public transition
  (package-with-bundler
   (bundle-package
    (hash (base32 "14qaz5w32b3g518jm8kg5vkl778a81ng232k1qp9wh14v3m6b8yv")))
   (package
     (name "transition")
     (version "release_995")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kwfk0vvi74z7mapc5vs54q6dard5crx781kw4n5ypjiv12aj70k")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
