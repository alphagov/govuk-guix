   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hbxk9bj3rds7vqi93g3baaxvvn32164nbk1f7wa004r50c230gv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1yc17s7m21akg9p5ffha39vhd1h38z9n5j0608da41w8yiglygk3")))
   (package
     (name "smart-answers")
     (version "release_5017")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1la0q31r10zakxglp02pmr9glbcabvm0v62yjhglw02ld8mrfcz1")))
     (build-system rails-build-system)
