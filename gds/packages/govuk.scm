...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1whzzs6mmknxyqafa9r0mj6c5s12x013kabfgxgi7sgh71j6j07f")))
   (package
     (name "finder-frontend")
     (version "release_1759")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01jcp95lw7267pp0dxdagjh06lh09m29ls179spk3if5fggbw6ar")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0rg8p6qiblzqgdspbma0anvk60hy5hlnx5xa0kjwzsm5prz1bgda")))
   (package
     (name "frontend")
     (version "release_3518")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mq02257y8npypi8jxxqg38cnv88ahgk6jm6w7jqfc97snvkldvs")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4671")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sd98bpwj2hn2cf88bk3ycph8dywas9jggxard7h2wbphrf8m9bp")))
     (build-system rails-build-system)
