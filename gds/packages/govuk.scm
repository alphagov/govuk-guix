...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1z12zg67hsv599qp6vc4imnzyngz35nikssd01wnrdfm2siarp5d")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b5riy51296kmr8fifnzh3kld17r1ic6lybw20sf8d5jr3a83p2k")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12868")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v9d1bwsm5jkb1qsdd5mxkvy7z00x3k82fjg77zha4raa0b6s71b")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
