   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07ncm78mjmi94mvmhigmn7578ci6ip9bsvc1msq02m4pa7dj26y1")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08si0fm8hvim454marbxnqd9lbphjll6mypzb6cmq9knnpifag7z")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "11pbjjhpx7zc42c1mfgfgvah4xgxlzxjxrk6qc190drwl1i5898v")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0815h9a4hz92dg9b97r8jwg4vyliy7zl9gnb336i4jkf8d6nlyc0")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13166")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nw0b0751yl6cncvbfndiv3c3wq4v1hmzizs5azwyg1fyqaxjgbp")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
