...
(define-public bouncer
  (package-with-bundler
   (bundle-package
    (hash (base32 "1sb73r1dnv47ksmzr5pdwig6gpd20iglgvgzchd0dxrrickwc68g")))
   (package
     (name "bouncer")
     (version "release_235")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1m5ql9l86apk3zkan12is0jkki0zll0ibcf2nagw40bhb3xifhvb")))
     (build-system rails-build-system)
     (arguments
      '(#:precompile-rails-assets? #f))
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rngvngs09dw40h15zp15c72z50q1nc89nkxp51cfgn0a7rh6cdf")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03pn36giwm1b2qg9g7xav8wp5x0cya4syd29p4q2fbq98jjdcnjv")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08brwhhbfs0av8nf6v11sv3hf03x9f2fc9r5r8kdv7xxakqsgqgk")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rj0vm7w2cmqvc2j0i54i70sbgwdmvfjh8y48hawd61bainbpdsa")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0j1ixc8fl7r888vi9s191vdkzpfb9f4xcpxbkjvkb85rjf2f5xzs")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4161")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fg7ss4hdhckpaa3pxhzf5hw4kk4ac5xzdr4dlpi7ba07yngaks3")))
     (build-system rails-build-system)
