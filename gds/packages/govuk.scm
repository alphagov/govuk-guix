...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "1v642rqgrw5z1jsk0sgxjlzw5rvwaix4k2730s36hxf47vzflxjv")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h9a1g5hcr9m1nfqa7vkjq1rya2xggh49kr9f1sijw1yl1n17hz7")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0316djxp15nf3dk6ppjxrxbg5rbgvxi5w0bk0wzqv5h1wz8a37vj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w047rr84vxck13kzqym9z32ljds7mbjfi4r8bzs4v80aym0szah")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
