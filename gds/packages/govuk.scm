...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1f1rx6wsndjf6rwyw7g619qzwqq9vb5ad7gxn4gw6v6vdsx0nnab")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18izkbcnr34ywg7rwlhr7dxjadaqxf93xhvnhwia5c8ji16sr1gs")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2963")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ln34bxixc9xrszq4dz2ykaf7j1yqxvgc8illn9d1cz5n6pqj7q6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
