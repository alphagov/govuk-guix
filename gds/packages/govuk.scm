...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vbwfgqfvy3gd91sh53b387aylnm8npprmcpn1g70xzdsmwpwxww")))
   (package
     (name "calculators")
     (version "release_391")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w2hzw5l9bbp8nsc0v2kgd7ryl3zrzqb3ggcqh83hqkwl5fx8rmz")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y95lq7w0sfa1q7qn6lhn3pbr16x5lcb45sd0smandk4acg1mnw8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "19jflg026hnb8r8byl2jwkmrjj8bahgb119217z1myhdbl5rbiz9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0chbnv31sk125wsbdbcff39r6yaq12fvzgf7fz13ryqmcdnjz8dl")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0x64x353r3d4fllwgfgyibwdcn5w6c0vp2818yl15rvcgsijqbh9")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4119")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10pn7gs56dcjyd2inqi3ih8g438k2wxm17w1zvfrbr85bxdg0cfw")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j1hbvc7g3a7kakyf6vjwj106axxgn70nr07xnixh524vv49l6na")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13kdad3k7hxnb41sbj7kf7hml9w8149fg46krrrpdbjsvpnwiz9k")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13753")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1svsq8s1v8rg92ic4gxk7jfnffd88w3gjnna7wvnf4j1pm9r81vq")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
