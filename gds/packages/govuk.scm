...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1iqa27d4w79sfinwa6id5xazwd85hi622b88pvj124l066552ahs")))
   (package
     (name "calculators")
     (version "release_467")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17y4sli4d12nayjkiqkwp4fkyhgqwjh2gxj35i5j7xh00n6f8n81")))
     (build-system rails-build-system)
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0b2y09fqjaf3gygp6davav8dyq25qxv8z4yik288pkbv4p9gjy4d")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nha00hp2xrwj5kahk727k60xvjw95pnagc61ym5kmwq86v9hcd8")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bib8klz1yj3hdr6rbzj2pf6clphj7mrfwirpcil07nxzylls301")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0511rslmxvn9r70g671i2piqhi6q7fqjf41x276daq0spaihahl0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pbv9ilfszn4sw61v6jf95srlpcvhbyqnmrmgvhqczsd8sq8wdzn")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "10jg8j5aavlx1prriz0rjv4pm9l25fhialydff23hh51wi86cv5g")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xq9f7y6jiqzgn86giz8yfyzc694lj1vin9v09p89xlxwm14k3gi")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j7997cxcn6gxswbfsg8j51ggn6d2xh3qzanp8bb9k8jjgqwmzqa")))
   (package
     (name "smart-answers")
     (version "release_4310")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1z0r2i8ixw7bzpqfvgw667f0yjr5aqa31vbr35g7src89k71y8vz")))
     (build-system rails-build-system)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1qdi0q5b4gslbpa6yy71vlm6rs2hly7m3806isc5kn51jmcd5pyw"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jbdnspgfv70rwacbzx9kffiqhn5y13d14x8kqqb7waikx7xpbad")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iv99yp5drh864594i2g5ddmlmldcmcva094dv3hrknia5fb3b8g")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14005")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "042x1n45v5lb5ckhb5z4672nb61bbvqyskgcd52ajxll378nzmvl")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
