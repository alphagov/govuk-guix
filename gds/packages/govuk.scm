   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13m3qid47ww1wk82anqij7micnvqr4zzf3wv8c3hwpz1lcjd2asy")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bs2whv4h82b3yh9y5sp1vy62qa84z8x301gdaab63anfd4k7lhy")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_2152")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xpk98brif2siva1db6gyxjcxjb4d089wh5pk3nxv0skcs5128sa")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4408")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g1z9whz53ywmcsg42fn6g5chmry3fjzyms0m6hjwx24cwqfk09v")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j29lgnvi0jkivdy7z0vci63k6674qbybj757mqlxj69493lzvw2")))
   (package
     (name "whitehall")
     (version "release_14185")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12jnbdm0m9rfnd16j0q8hx8vhsgxiz83a1jamf0qqsp5693l14z5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
