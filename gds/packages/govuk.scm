   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xg4c8i4m0xkz268ym7hnmwk7dpm90cnbfx0nyhcm9f0rrzmlys6")))
     (build-system rails-build-system)
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "15bwlbbs1iw2dmmh3w22p3s2wncyaplwnahkwkqayld5n227zl80")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06lg23dphxyd6lizxjasclv6ym84wq43xcy2q6b2l928ilwk6ga3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13881")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1545srxhjk8515jz1cfcc3s5qv1vdz7gaclxj238qrd73sdglnf4")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
