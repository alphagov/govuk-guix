...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kf32b10pajxi7h9j8d6pvimg060ff14ys51542jdrirv6x0rx43")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18qqzvg9swapsjbrpadphqdfwky6zi123c3bj940123zmmw4s8cr")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "11rbqp4ig8lgqk4wf6f647ik5wv3vwwsj1db1i8wqd6z3j68315b")))
   (package
     (name "feedback")
     (version "release_527")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qp4hz9sx0v8di50akan1v8df2n1f2lcns13r20g80ly6p2xlyn9")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0w41wpv6rzsrc1mpvr4f5nbq7104hcsgrd7m54x0w1z1w28jh033")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1krlrrvxqc5ib53hhim2lhdsg2958zs93a1hwdhr65kijcnnmflq")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "01hxmf4l0p58l185m94rvrjfy2agmi6yvgfadp1a9cvnfrnr7pci")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dlhmr7wqx5qama1ipm7c7mwk7q4j0hf1l4kw1s5dbczia4p4k5i")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p2v4vcfl2flvvjgg836pcj3g8zp1d3cn4wixl6ssj9mcpdshll7")))
   (package
     (name "static")
     (version "release_2980")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11h593md564ymrj58a5hy9kzsj33nzrjwmivxpai4kyvfkcmbvw0")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
