   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ckkv48cq6av1dwr44qnmnmn3sk4vffyc7ghhzh1g49d5j74h1kp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "140q9darmpkq709kqhrv4xs9cv356kw3xx9lql3423qdps9mfg7d")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18arn5a4w1abylg7g2a2k5c1a0sid5dv8sz9z58hhbc2ixbabmvp")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12968")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hgmapzkx81c9rcz9flq06y87lbmk3x259sz5g5s1zfzh7ghdl6c")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
