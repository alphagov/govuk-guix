   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18psqaxysm9zrw3dyba713jf58qzdxnz6iswjql5hv9hb2qhwmfh")))
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "03a126sfrcv8apnaq2a036gdkad4vn698w40lhiqlpaya03km4wf")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13024")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jwfhqb33z6dvcw3q47923m70bxddkp4z0pzshy4dpv28s2hk8nn")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
