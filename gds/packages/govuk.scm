...
(define-public content-audit-tool
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j3naxsqq6zm8f1rglzq48b125x759lgc4k0psagrl9h4wxcawfg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1n5skppyxxxiyl0g2ya2hc7kjfp4fxr8mjq87xd6vvg64dm00hsi")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-data-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p61sdzjdnpmh8vvm9iakzgc2kdn0bgmxfidcl51z7yrw0kr9k1q")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zj7fi7c6yss03mpmbm83s7h331j00dgly7rcp8nd4fasiv34jd8")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "1lzv4djw2k9rgnp4nwdrw4qmbzw75bbnkf1sbgd3hibbs85vcvjp")))
   (package
     (name "release")
     (version "release_478")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00vywfva43hyzcc576yjr3kv56x91qn4agm64jlph3k6wyqpdjqn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0c3kalwi29rlmhdblmiakmwvgr06ky8k40wm9jl5s6d7gjzqw52c")))
   (package
     (name "smart-answers")
     (version "release_4413")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gf816ya59nysp28g5mvi46adkdc9a57d6b9mphdjvmh5r96y8mr")))
     (build-system rails-build-system)
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0my416k0acrqdz5y4lsyc6iwagknnxgxcfhq0nyyf2pgfrn94nn8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vfvswiy07ivjackss1xipij65457f08g8rwv6bdnl9kbb15ljkp")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xf7i01k7av7hwy87bl2v5hfcjsc9hz67ldiachlm4bighvln3vm")))
   (package
     (name "whitehall")
     (version "release_14200")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0nxkgb95ffjll0bhay6lkv6jdgb4py3wfr7068lvy9jzdyhkjma1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
