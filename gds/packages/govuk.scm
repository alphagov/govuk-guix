...
(define-public publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1w4g40qq9yriy9mlca9mx3fdvl7p785rcvkgphhj43pyjn14v66r")))
   (package
     (name "publisher")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n9ygw4l7gbap4n47vnaz7yyfkdrj8cpskqbx6vc5s80m7rxq7p1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "1nd25ad0ah3h26rd5wvm6yknv56w8192fyhx71h2r1ncml5zrrjg")))
   (package
     (name "support")
     (version "release_943")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0waz5al1s6ha0haz18la3vn12yjy1d08lrjvvwhpmplrbcv43c9z")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
