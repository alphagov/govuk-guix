   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0732l8imqbl5h7q0zz9h5ni6kqrafr4b3pbsjybjc6rw9c8avqiq")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2758")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "16fcd6rnvr6jvzpxsjmnzjac8np05rqn7jz7n65v52xynvn957qa")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vzh1wxyvjvcdbz06siddlkw14jipkw5l6xxvawki3bfkp7n04c9")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "19ipi47dxjiz8i57a2zi2rpc32hnj1b0p4swb7xl3m8c8g7fmwzm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13077")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0q1dqsqni16j2llcfjkh54l4gsw7qi343cab4wl2knqdri26lxv5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
