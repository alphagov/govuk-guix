   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1l22wnwqpd1z73x90wc3gfv9jq74bnix5xj54lbw0h0b55r4kd19")))
     (build-system rails-build-system)
     (arguments
...
(define-public hmrc-manuals-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0jvzxa749yk8vvisrljgr6dlbyhf1n8vhk4xla11vs0aj0yjlcwb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g3zn40d05mz6vacvzlr195fhkby11vqsj7vgcphk0kv8yk94zk9")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i041cj018j364v47wkql309wfwrcd215cml3ci5mj2xj4ghb3fa")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
