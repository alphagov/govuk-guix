   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ds5z812pbv2l2mwsv9nv7y6rbfb0f9jhjxkyi361z62vj4lcrcd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qzdpb5avw63rbbxb7dnd2k4sj45r1rmh5a6xn5yzwm2d26js7yk")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0apjnkbf7b4ajsnip3vqkfifxs95ck7lb586k5s1mjxcv9ym4mxy")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "029ay1vyf083jgc1vk34b3vzq6kc1arv4skmr6qnkl2akg27iazr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04528b2q67i1mrh7wnn7r4njjv9jzxs50f2snw4c5mx1pdhdlysh")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public release
  (package-with-bundler
   (bundle-package
    (hash (base32 "0li8jnmyfb5n0yl5l62aslvw5cylp1vx2jzh65k6hpkmnrlz4qvg")))
   (package
     (name "release")
     (version "release_501")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pnmzhrkmgdfrxd74js7z2r90m9rx8f35y9h9qf5i5cgdv4y40bn")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
