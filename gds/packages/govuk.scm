   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11z5fsvmmippzawbli1wc9a941cf1fqxz109g88qn0bggg3d3pms")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-tagger
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cg2nmzpxpvyrb9vjnd72c50b5absrgz1jqzr08nzn1h2ahz2bxg")))
   (package
     (name "content-tagger")
     (version "release_736")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n30krlp5ibbpz0h0pf71fjmk0v0fxhy3mdh5m7gnmifh2006307")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "06zdp6w93gmphv2iryg7qq6b3462q902i8hn8hspwzay91ybm56i")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qhc4gfyvv7bqzyy6zmkaa2bf1ngw3h9m50vkirn5a1dg7qi98xx")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "18iip2kwd2kq8fvmq7kdcsfwarf1xmn1kdb9g6243lkfqbhd3nxz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v0fr1r4imvfj4r19v2d4znqz480q46kfm65mdhpbdnc1kkj7xyc")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "15a6a122q0rjlcknlzpx9wlwx6q2s2y1iyfyg2bv3vfb5cbajffg")))
   (package
     (name "info-frontend")
     (version "release_124")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1r6iv58hlc1izd3dc93m6f59qsa3y5lnphrh1vn7pgc6b0k1jz4s")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2816")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qbm58dxik94sdskm6zdykrrb7grsznx1y6b2m3zf466i4vjsnik")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13332")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zqyzkzj0ln8fh2s3fz3g1wz3k83gmy02dciiqmxclimg9y863f5")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
