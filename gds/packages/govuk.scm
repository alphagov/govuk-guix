   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0v32bgz683j308il53ahigw542nlv3sjf1s045vkhfs09ar3zg0h")))
     (build-system rails-build-system)
     (arguments
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0yy1pix7c6d96g47jwqk9l9b7427l7yzsl51607d3n665cyp5l3n")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00mdijszks331rz9nd17m1pwqb1b8kls21x3nnya3q6z26hflp6f")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qq6ykb1zzaw4dhin0mp5qyhq5zwwvabfsj0nc47bn338b5i3yy9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gv6fmbdndbrc3dy1jzli9sd5gf6l6wwxipnjf948bkrqijxirk1")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1vjwschyjyf4kyfpl5pj565jc0mjbkgw97qsik9jgzgh0iczrqv1")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jphs6mj5jl5ivza618vmmjwg8cirphz0g3pkk14j6lcfqjpv629")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jkr1bak6x414g7kpsxi7js44y1jb93ln93lbbpg3mxgvgz58nyf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0jk84c1hj4dgmy0i3fg257c4nxagmdjf1vbvqr8c89jdlxbqijmx")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
