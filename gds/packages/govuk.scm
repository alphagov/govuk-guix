   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wjip520p9y6g7lcig3sfhshqb3z8861cphlr6a47f5wv83pwjlp")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v1xwpg9pn1p5rbmcr0kal7k2p0lqzch8brbf6hnl27l9cr0xqv3")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13845")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ka33lj5hh21i96h683ipbqi4xh2ghmf9xv07svbrldwhmx3qknj")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
