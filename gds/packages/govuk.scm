   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17xxiimg1d0pnjm5mg1j0rmwpslyj68pybgvrrp0fscagxrjn2pf")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ix4vrzhhnh4fr1krb17xl86cb0i0nkwl3hc851908g68flmnj6r")))
     (build-system rails-build-system)
     (arguments
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0p41kab2ys1111zmjdf3vm91z0h5iwxg4lkd3cy69n37s1fah4j5")))
   (package
     (name "feedback")
     (version "release_754")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gbpd776za5j450ym3bsrzd3vng4rxlacjccjwbjcvmmslqsm7gh")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03qsbkjcnq400vyx7swjji77jd4ivw7bk1fp6r88ps1fp6a05r87")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xv6px6kv2zk0w84qwrm3fgcxqr5faanxxrr1hqviazlkh6lfb9a")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
