  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0q493ri0cqm89ks9fzn1nzdrjxn60llr989jsv5m15hci402as5c")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "10s4aa303mnjqr185vlwkh7dzfckklv9w5ks38mr1dc00fjc60d4")))
   (package
     (name "support")
     (version "release_846")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04i6h6msjjycz8l3697x79r7gyx2igpw57hfzwv31svva1y7hsnb")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
