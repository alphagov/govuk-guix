...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "09amy8bhj7ilmi0ii2zdypnw2vp3ajlncg53bj5k9ggcjj900s2k")))
   (package
     (name "calculators")
     (version "release_736")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zbycxbc033rg13s5545mfqxww8gk5wzniw038mybd2lxz8gf98v")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "021i0pifp1wdlz8kb064xw8nyhjzrvggb21ky38d2awx708gq880")))
   (package
     (name "collections")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zas6pin7cbr4q090r34vhvhaycx658md16jm559ls9mq1hv30nz")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hz1dvb2mg20lz8bgn7c8qk7qn8pyyc7vs82xgx2qwkhax8rdk54")))
     (build-system rails-build-system)
     (arguments
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gfx6l9qzlzqm4wbz8p80namg6lv0j0agghh94fhf90i8x75wdwg")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jk2pb2nnxrgxf6na5qh0kmpbyzykf27rd77471qnfza8qxjhd0q")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g8zm89m1k3hjnfwjf6mavhiivq4yjvaj8cxaz388nzx7mb81v70")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "091dar1wjzs05cwiklna18fyxxhb7d2w104liwrp5km9c8a767jz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0v6mrj0ba0455n10b56ng2kv2imzlpib1nc87pw0wxx66164vn8l")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1djiqllbm80lnfr1g7zivrrbci893js4l035fwnj2hy90yfzka8v")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0fh1gmg48wwkfvw5ss2a8q7anbfnjk9dgf9pg4ywjm53lvaqdpnr")))
   (package
     (name "frontend")
     (version "release_3596")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "056v4ls4zxikh62x4chqng0yggw7r7axj0ndvip9xjgji7mksbg3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1596bk3605v54annrv4dgb1n2iq5wflbszfh40zrbgr3n2l8qh2x")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dd9w6n355r0rxm4y6alzgvrarq7h068wsmyhxllyyll1xmr62gl")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "183v3blz2ay97c28nngpd1vxn90z7a4n0psjgpznxa0wq845qji1")))
   (package
     (name "licence-finder")
     (version "release_787")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qxmywjlnlci84n6mnzwcvvisgwmz6fwpl3gqhphpncr7bgs4ylk")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0zb1gs770qghyy80vmbmd3l1x0lsr7xaqn7nmmnm8ymapaf2z1mj")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dmynvx356pl468sw586rg64iqx8ii5lfwhmxbz8n771sac90rkq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0241k6b3iqxca62cpl30asg6ggx83zvzrqcxlvz1x9px1ngshxmh")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fzbkqjh2jr9xn2qg53b3sxxkhmdmx7sja83ail0as9dc24dlzdf")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nbx45h04ns86k3zghx5rjgbqil5pzliwj3cs26z3my9811hc2kv")))
   (package
     (name "smart-answers")
     (version "release_4829")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qrgq2pwirkx5sidgqhz8qwzq8ypzcivp0qiqahwb5a8wv716fxj")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1w94zb0qzgk9ji88n8157x9j8yvkwsi6j0dqkjzg6yb5pjd7ckq1")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y5vxhmkq2pqldpddh00gkg6ivanrggq28ppar4g8vdi8j0xhisd")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1nf9sjykbxil648w3aa59a1mgbjhccdfpzmffgq1329fvai73jg4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14832")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1v15zn5mrd50aji742b50pcl54a26r279cjrgm2gz36jn326kq7v")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
