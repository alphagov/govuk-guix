   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1006rp29psz7vc6l8gc1ylv77lcd97f22q2k40mzj1hgxgx1cmjd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3642")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dlq6if49h8sxqyiilgs3296wc3cl2bx7allvla8fwzip92h7zly")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12859")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c2j6qd9xcmzisknw5yj96922frkam3xf3i2qwxr6m32sslrcx9j")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
