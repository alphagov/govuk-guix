   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1q767z4vvxkm37ffcc0f4aqchmx0mm19wgxrlvyk5xd8ql41xxay")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ph6rq2l1mlzp0bdbcc30g912wadd3295dzgxnjcliw92s0hl5yp")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2697")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0frf57jwvz7fahvq0v8fgycpxbdzb9sgb40sz54skai75q7g7mxr")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
