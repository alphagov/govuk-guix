...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "030di7mk0xyja6jmnr7wsq7khgkjilspngi9v5a3fyf5k4z70z25")))
   (package
     (name "calculators")
     (version "release_281")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11bf69p1byyibz0v4pkgypfq6g3iwfn4cnxy12x3hv2fsv2a08q4")))
     (build-system rails-build-system)
...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0pxlx66cqy3scq4rwlqxjawbph1m2pwyi9szilrchwql1r5smg4i")))
   (package
     (name "contacts-admin")
     (version "release_440")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1kjf3gns9mqj986ajmkm9gava29xcdx2w76d90m0ysj68vsyvg5s")))
     (build-system rails-build-system)
     (inputs
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0dmbx3ykslqw9n8alaazsixg1gisng06pjq78pijl0c44n0psm9s")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public link-checker-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "13c9gp9950p4y83saz7glcbqjpdyr6w8l7jy1849nlffzqzr30f3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zag54gh774mfzqbi4h217lnvckbbg15vrwpdxvdxigq7aq7kqx8")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public local-links-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0al3x64705z8bv90kk65nk9740m9m71yg29ccwnn63x4j1klpsg9")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "194qi9bx9diihwsyj5ddnmjgk6cyir9flmmbqw1yp4kcdgkf7qar")))
     (build-system rails-build-system)
     (inputs
      `(;; hostname is needed by the redis-lock gem
        ("inetutils" ,inetutils)))
...
(define-public support
  (package-with-bundler
   (bundle-package
    (hash (base32 "0j2sdpld0jaxhcbhkrnx0qr97hwa8s3ir5cpq0yv282qxiyk12q8")))
   (package
     (name "support")
     (version "release_671")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06nfgmb8b20x9yrxs14m2v2yclpym0c92656x8skrihxkhghb9ym")))
     (build-system rails-build-system)
     (arguments
