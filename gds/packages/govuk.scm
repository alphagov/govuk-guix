...
(define-public imminence
  (package-with-bundler
   (bundle-package
    (hash (base32 "0z4a0pm3djh37nhazi69fj0nczylh3m60w7nagissd9cihpyv6ya")))
   (package
     (name "imminence")
     (version "release_424")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1flgy0fq014q0rkn5i6z758k4g7zwlb8waccd805mv4riqigkvm0")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ivb4s7qic0xwi6gjagjj1r8vg6kvxlx0ggvg0xfn8n9nvz38vph")))
   (package
     (name "licence-finder")
     (version "release_442")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c437hflq90indkmr5daywm3w47frz1fwynkr44w9vj5ilakrbmr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
