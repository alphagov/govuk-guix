   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fxsyl9smmw76v2kn6v7pq142kfv5dw8nx1ch0hw8vhn2v6fwqfb")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01i54nidmmvwdjhp158x249lxb526aygwcf13fad2drcabj9yzy7")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0l3zbknbn07vv5nq76czqy7rhn4aqda9ahd7i7ck5qfm2xaynghi")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1g7x06sa6nq7sksgpsn7qpdwa00jbx3rpnq93w2b79bj1112ad71")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bv2c9xn97nprac8aq7lpk6cmlmzs6hggk6ffw7klm6vlj7k85fx")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3731")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09idjm1a1gx6c8bq8vs2fsjis5y88yj29h2cnwym7j0sfi8pivy7")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2654")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ym12yfinsh3wv24hrvywka9289gmad8fxhk64f7xbvq4gchpn3c")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_12964")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06ldy57cfgqm5w8cdpac89w9m0xg9xx0j20p8wywwqbf39klz1cg")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
