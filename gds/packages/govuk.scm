...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "187ifg9gij7l53qzvvyqv44lsn34vf079hcijv7qhrfv4jz9k0sd")))
   (package
     (name "calendars")
     (version "release_672")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10pj44cakpf6mqcyhrdwifmiiiq6nnjxpgfvph1fwg6g8rhrbmml")))
     (build-system rails-build-system)
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nrbpf5lzccdswz8rnlr0h0lazw97fx7vdppf6z6b4qvqx2x597c")))
   (package
     (name "collections")
     (version "release_811")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hmcdfcfhxzblmvnng1vj7vlvp4iifrjv7pk9d8an3vrvck7pkfi")))
     (build-system rails-build-system)
     (arguments
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1s8pniky7mi2kccpd5ip32gz7hl896bfgyp19fk9ww775n5xaks8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "183n266j0dig8j3ddh1sy3p9x389l44f6hpwl5kyd3iz5ky5g8zs")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0dl6kqkcjkkj1rcl04anah4llqznpd4x180z7gww7p67b35amdnk")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01kl4s8q564xq3rh9s1y00jrh39zg0hyiw3f4s63lcfrkfwwpp3h")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1kcdgcr8bpbigb0qcyp5asvyz5sk6hf707jpcr78j1m0qi4pn56z")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0s4wq5kay91qncnyxa5jkv2s3y0hi8clk7iabg8fkmbc07f72mp1")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ss5zp06h2lhi39slvd388s9x8xaqv292wcfrvi2wrlrw5zpbgmp")))
   (package
     (name "info-frontend")
     (version "release_298")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xwzj6b9bls314s17yfhrjqy64z0yzqav22b81dw5jlx882cnybz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
