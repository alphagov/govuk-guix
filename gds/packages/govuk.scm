   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bsp95laa4vw8mqa7njw0hfqh90idjpsd2rqk0c8h6wkh03biikg")))
     (build-system rails-build-system)
     (arguments
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "01mwgzvb7gjc3l0rrr5l0h48mafcpddyajyy5vd4v2535lmpxi76")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gclkj8rq5i25pcxkia24kaw6izbazhhhj3b9ialamidfyrgfdld")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13544")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1x56fci46irlsrbraj1vwg1anaj555k2nqnvi1hysfnhql6xj243")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
