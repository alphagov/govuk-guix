...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "14vzdqqkrgm99hj8mslrwjhps6l5sdssmssjn6v8x7h000nras1p")))
   (package
     (name "calculators")
     (version "release_660")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vl1y8hknmvla7ni8zqgz2if3s48hay6xyhxyvlcgkinxdjjchh2")))
     (build-system rails-build-system)
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1xry81rc1rr603wq7sn5j158jnqsfwpp3wsczr1fvxji35rqvnd6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1idcfvlskfysirzjzrc31havj4n5is5w4vw3cyg4qzy72ydp1x9n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
