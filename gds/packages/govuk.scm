   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0g9zvazpsapqprvv5linyl1dspcwplrwm8wfwswfyhq0y4y6mw61")))
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0g2pwxphz1b7f1vljwsxvzvj7nbvis4arln6ani18kglf3lmhkvw")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1zyf650114kc3gns1wydww67h3n0hpxnjfwiwqv527qmx8876rpg")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
