...
(define-public calculators
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rgm5dpdn9fl1sz6dr5iayk06la5vc20f4lgp2819a1299hpvwsd")))
   (package
     (name "calculators")
     (version "release_267")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k1vbz7diah0k4ls15mlpd7bifs603ikx8w4ny2ikkdzjldxsny1")))
     (build-system rails-build-system)
...
(define-public calendars
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cf76il1gx7njbn97cb5grfpnl06g7dz906jbl2ybk2r0ca1qggv")))
   (package
     (name "calendars")
     (version "release_494")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jnrlkgn3ic3n0lahljk52k3g0ypja10mpifq54hai1yvnfz4r0k")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "035jk2grzww1ksdw1cia0r44dgsnhnzcqh25pz4h82s42ah931is")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f82c56svmckp4lq6mx5gzlx339pc0kdk8hr9yaqmrn11g93mia2")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1aybrgxk8nc130qxwmbq250rsk4q607zy4h1ygbvqh0kpfmwam1k")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0y5mqyjdn7g1mqj1ifafx1d74s8x4174scbdncb2h76dvnxr1clf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vmi2sqzjivvczribbzj92b4y6zg6ni12hjqkn14nk3997ybbfdm")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0gpwxkncascyjprwdhxpdqjxja12b5wlbix1kgbih9j21vkq02m3")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07x310xcysby6f3vmvlh0i1jlkz6zsgk591chnsk3kfj123cr81i")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "00z1966s6jvh4qj3bc4j7jhqrpk4nb3sa7cm59swpaqi0fv3acq6")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g81hnikpi1pczm2hsj2rpq46x6x2rbglc37m4r5w2l2v4aarbbs")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public email-alert-service
  (package-with-bundler
   (bundle-package
    (hash (base32 "09s4ag3icpm1x88d4p0n731wad5zichami92l8daxbqyjxbpz9ls")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0za0y5fnz2jjmdr3sgwnlwfa3i0394va3941bvi1j6a06wl7fq41")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gagamp5k2qr0sfw7xf2c5g6xg8pkhm8q2b1z23gqnxccf2jcgrv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0h50cnvy62zk107ivis9yz2fff2afxbm5rnzzsn1lhkjn1j06hvz")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qm90ybi6kxp49406251vizx1qdfczrqj3nyd3kj58qhxcwazvgd")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0100l47jp0m62acpah8m0nhklb4ykihfc4g00lsn6wd4g39v5dgc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xizlp90xg0z4w737y5vmx2i2483hp0rr7yw7l5ygbw3p7l1av4r")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public maslow
  (package-with-bundler
   (bundle-package
    (hash (base32 "11d46xdwhvzmwvkw2ig808vcip5rakbmyayqibjs2l77l8yql1f1")))
   (package
     (name "maslow")
     (version "release_266")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10da5p97w9y7qp507cksk24dfkb2cjqqms44a8438i0r0k00y4i4")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xs3yy09m82z2czw3md7kdbwfh96m6p2yp6rxdmnamsaldh0k0bs")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rgyrr7a24d90kaavy9b0a01i6y2q1jgn2rhkis67g09af5c1nzy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3910")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00g8rmr2g86gq40ghihs9dmv5hdmnn8zqis4nm2zhgp7rhfrydfr")))
     (build-system rails-build-system)
...
(define-public specialist-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0nbw2v76py2wah479k9mimxlawpwdrzl7mif3ai0bd52gvyw67nm"))
    (without '("development" "test")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04mpcqw562qbqqvw30laxf48a6j2rbdykqa15hm09ps4q5g5jyhl")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gh4jzm8v80nbis8vsgvvkd8a0rnbjlmhig039pj0xxn1wvil8xz")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1j3pqy5ja5nc37lfd9r18kbsrk1w361vjmshal4vlvc2bqw6w1dv")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1625zlj021jb46jnx82lvz19b4qyhr0554fpjjnmil29xbhqhk3g")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jhplc2v7pf9dvlws68vfasiicfw4kyw8rxbxgacml8bx9j5k9ir")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13391")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p0s8c8w439f2wdpkxp98c08xvlbplf3qp4i1rfkcp65svli223h")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
