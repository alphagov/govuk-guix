...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0drqf0sxl2qjccb797a64lf8fw4afmakyy1f9v0g22jc2a808waw")))
   (package
     (name "collections")
     (version "release_663")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17f81jcnla6h2jddnpdjfrgsdsj94fkf9kbbvfyiw7byryjf3m15")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0ragiyrhqq6i34sggjwn5kwc1j8073plg6dx870rxj9sj0wmx3rq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gwzhkncayfwf922ikrl78q0yqf5ihkw69dc0h9qi93shjs9rqzq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ilxvsyca2bz7gwip7kfxq4rw49msd8mlbgwj9z7pf3841vlilfl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00ynskjvjkvl6mhdn4hzxj2wlfraxxyx0s9q7d1g5yy0zwfrd992")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license license:expat)
...
(define-public email-alert-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "03b38908wpff2n4332hfq5vp0yb50h7f2a4y54m7j24k5s3vlsg2")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12kybbspa8r9r9ixpvi6qvwg5vf68a92d4lqm25m5v0sdj94spyj")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1w1ipkl84z9gj8zmcisspjk5764scsz265c2ipjz1yky0fzh04ya")))
   (package
     (name "feedback")
     (version "release_481")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "168rjh7sd2wf2r79jvvmzd8qjv8npi1nbrga4ib8rz6pggidrvrh")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0cgxgr3pppl5f38gfyjlgfrrds68z0g372apndpnqbxsc8kpwp5g")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "157kmpvbw67bxcclywn4drz9si08dk6yhwgyl19jc2qwgg984r9k")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0apfmgdz3707qfg6q3p2nccr1592ab7kpr4wli42ccyf9jc3q7fw")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1h1j6rvnjkm79aw2amgifp03a9z5fg18v57rhcpqvb7s5vqhw2qk")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1khgin6qf5m3rm8y772yfflg9kvxh6mpsagw0lzzhp0dcx65vvjc")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "07hl42iavrf1kglgkvpqilhzd7f7wn9g8lpqxxr9q37l67adixzd")))
     (build-system rails-build-system)
     (arguments
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0l6fg9cd9yr2j516hq1zima87qs89f3jklxm6xckb8j60jxv9bc8")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0viyy4mi76q9870i03a4hak9j2jp6m4xzc35cm24sz0i5jnbm9h8")))
   (package
     (name "info-frontend")
     (version "release_198")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1f4gv2xq9ss58dp8xw5d5cfgcnchdachk5k8m8lw769kazvp4bml")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1bmzbydxl1683bq448j8ivd62f5svbv1ly43nfgf8hnvhyj5jvar")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mhcqxc9lk5aqyp5bl1m7g591x8h3d4wf4p8qwlvhqnkbkd48sgg")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publisher
  (package-with-bundler
   ...
   (package
     (name "publisher")
     (version "release_2004")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01y78aa93hn6zb5fk7b76lbrjwwjbz081wf2akzdixjwhgms6cb5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1pbgw03zmkawp7mqznqk7dnkvbyq6ng9skynyvmwh2jkjk4ysxnz")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0w0hlkl79kn11cvzmy12skn8fq5bg16aifxfnfxr1fj5wginbg1x")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1cjr11i7w8fdp0l2y8b44x034dnvl08gi7dssw55xad3qrxjymix")))
   (package
     (name "smart-answers")
     (version "release_4042")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0k8fp6r1nbh6zk9cgw7aw389vl01f0ajf887s9ljvd6k9d3phs20")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13633")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xb3z954ylfkysssvrgf6dznnad7amc3cfkvhl8ysqbnww7lbjl1")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
