...
(define-public travel-advice-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "0q1rdrqgnpvpw3zqjarrvr12aspi3iw7nll7b4n63y0my48qwaga")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qsy14fjaf6j71lyjrw79rccqr9gif3p6rmw4zgiqjr3clafgkkv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_14814")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17qr301mhb6vqhn32rsb3ik0xwcpxmk1m0szrcg1pk9xar0835sr")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
