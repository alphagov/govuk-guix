   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0z02yjl9zs7j6ilsy08y7l5101pv7n2p0r08wydfp3i1nn43yxag")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0c591gkmvx8b7q1k0qfrkik3sv8whha22bkwlvqzg4hx74q03w7j")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "1xcxk8xz3rp83s6lcsykcmsmv0wyfn1a90vgsw0z2ka3a0b4abbq")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
