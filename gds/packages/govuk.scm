   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "00xl8k9c8hjhd1f6gfczfsikq824dzcccdb7awbajx8jqi3yl4z6")))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1cfwiwqmz00fnphgn1aj8myxnc9w3w9y7ls1904j0bmkfvdmjrqg")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0kb99dx96bsy4ssgmm5wpn8wp1dw3zbjfm40ps8z7m4m6hn0jzhi")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "0bd7l4cp54r9l6pbammvv2nzm31gcmf9ikyv74ic858mw8wgq9zv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1sf2svsnkwdahr5ghi4lk6p0z9rfx2jr8lchf9vxmzd8pdhcariw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1qg1b3hiymp77l5b93zwxg8qqch0nrlc0maj435yz7pajdanjf0g")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15hvir9b37lxfk50cxd9dnkl4njk9xsajy2p10xbmracqn9vki84")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0p02jmxm5q16aczhcpv8vxfhkrlbr2qqai6p5xy3axhwwn0fsmps")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "1n3s1s713bpybm5vnflq01j7vhpbvimlb3dv6sid121dwvmrmrv7")))
   (package
     (name "feedback")
     (version "release_314")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "01ky4j7spb7shkfbdzs7g1b1w80x78w0ajj49d0mj77pkf06zmck")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "13p5vwrqp87vlbf53k1bvjy1y4la1any70463rr6v6s23x53qync")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public frontend
  (package-with-bundler
   ...
   (package
     (name "frontend")
     (version "release_2743")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1b1jjv497j4slq6yf25qs107zrasrhsxyyhfvs0wjjp3y4pcvx3m")))
     (build-system rails-build-system)
     (arguments `(#:ruby ,ruby-2.3))
     (synopsis "")
     (description "")
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fcj6jpy8936vjzm9lhcx5j8h1wj13bgbw2zi8ycsam2hixgrin4")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vkkpz4yf4jjlxq5kknb843wh3x9996xc22v68s8hc09plq714wx")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "17jfhlk9hq66khapz62b0waw4xibv72xi2xdk762qcwqvwf90vgr")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0caby2y7xcbrwf31f1692i1xzc7kfj42sl0zz03jz15li1jm9xwb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1pkp4ngn906dj0s3q2jpjg7jhmfpvy91m9h8ncx3z1hgbx42dyzq")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0wlw10m288a1fmhiviz8gvhnvfnj1am94shnqlsyr0hc7472qqnf")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "078p62f7bwnh309c7jv2mw9iix6sync7ayv6g3fygzz3hr133smr")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "034g7mj5p565r1mpkhqn4qbj3c83cz6xcmpq0q27vy2fsfz98sfa")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3774")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hpm2irjfp50v362amb41xbf27pw66kqf8xn9y9m54f125kgm4qs")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f)) ;; Asset precompilation fails
     (synopsis "")
     (description "")
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_2705")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bfmbfy7a15hsz37w55sn6p3bz7aak7lv72ywm88nilrklsphw2f")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f
                  #:ruby ,ruby-2.3))
     (synopsis "")
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13068")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "09800zmm6d5h5l5mwswp13mlbmh7k4garqfvrbfp4hjrl7d1g4mg")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
