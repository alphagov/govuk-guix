   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1563xfs14xr51s0cari7q42z3r9clksjg3bnjghd3wbrxsrw2qik")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0vnxbz0hni5kvs3kd22ap3x7rqgvl4an19va2bpkds94ddxsi8pf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13864")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mpw611ampcla1pd9kssqk0ww1g7pvc604aq9ac6ig2pbx7ky1mm")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
