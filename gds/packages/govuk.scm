   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17jz3wbvccp0c2rp4xrxgmjz31s3yizrm59r3l19zwlbkm0qd8qn")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c20g23mpbygpyb6jhjgp3jch4snygrccsi8f4pr7iyf6lkmc2gn")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0pwxgx7xmngp1n6mq9m6q7d5flnkykb5x7kcxjm7sap1mnshw9yr")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gzxnf0npqcf7wjzf4b0wwq6fi8rly5i947cm02wb2fgvrq3906h")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1iwwwvsvw82ab3ydx7sj6zpzik5sl0jniq08lcgmmygjknf50hbw")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public content-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1g6lg4pm4pbrxd8sgv0bk189i83749isjnx261nhf4mybf81g4hv")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0n4n6lmjbcay9wq9rmmfmn91ghc1sb26q5fgf0npwvy4f27hzimv")))
     (build-system rails-build-system)
     (arguments
...
(define-public feedback
  (package-with-bundler
   (bundle-package
    (hash (base32 "0q5gzvzpgn6p06vvh783m4dh3qnj8gn9b503p6ccaq1dvc12il99")))
   (package
     (name "feedback")
     (version "release_599")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03macqxk25rvibjj6dr3fy1x68hwzavn5brqhwybm0lzsx53vq27")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1k6xlfgr3ky0nwjphkl3gh4h6gr1aifd4s5m8acgkmjjlm2h9nld")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ancgssi2rdpznwdixk0i7jf9xjpr0xpdb62a3c1fj5wlhbaszyw")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "087vaw4d4zivzzx3yvq3r1hszqbbc0fvp86b17bqg32la1wxyd1j")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public government-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p8pf9mc4myndr44xqi18wb32n91y9br996h5911alliv60ljzwl")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03153ghhq008da62vyc1l8dd75rglpfn82v3152nf7rjsbmg48gv")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public info-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "013v2kbls9lglg44anw7hn6gkj264jvv7cfghbfhjnqsyibmzapn")))
   (package
     (name "info-frontend")
     (version "release_297")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1c4fdm5cpjhja1zc3kq8b8yrx1gzrdz76hljn218q64xk6g7n6qa")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "00dd765dvqwxrl5k2y4ny0y2lxfrn2vx2vcw7j67h5la88857pyh")))
   (package
     (name "licence-finder")
     (version "release_528")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "009fzv7100jlj6ibvkbj2qcaa5q0xc15w07f33wpic5vc3yx2g1n")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xy1c2rgfm5r0b79ybsnd8pwbns4q0z2fid7jz86s0cw1wg0af6w")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
...
(define-public signon
  (package-with-bundler
   (bundle-package
    (hash (base32 "1z95aplfn2hj7j4jb5kvz4rlgjycvg1p85ih82nixa667w67005q"))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ypy31cp5dxr6y12jz1la7v4chf359nkgck3fzs45x5qf0f30bpj")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "11z2wkvhwjp6y02nypswzxm6xc2mfphsg5zkg4vlx9dlf0ir9ssq")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0r1b7j1z0nsl5371kdbvx127rdxp8hkfdjmpxrxs77214jmz8hwc")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13919")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0i7gcvrv182nk9sndrr7013bklhywxsg041n6srkfw75jfh99870")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
