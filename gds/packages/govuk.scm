   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "15vd7841ba8qnfz8av3bdhknf626gbgmdnngx37rm7mifwb8z5p7")))
     (build-system rails-build-system)
     (arguments
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0d8xzkdgzr0144aya3qxnfjffla4flr5l9blwsg8zqgnavl0ja68")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xw5s9kw8fnc6qi8lkias7jgkkrswwaa6539f7gzpwrjj8d1c7cy")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
