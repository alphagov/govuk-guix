...
(define-public content-store
  (package-with-bundler
   (bundle-package
    (hash (base32 "13pdsyql70lg7qrmv91ra9zzf4g1dx7bff3yc8nazbfi2sn0wm1y")))
   (package
     (name "content-store")
     (version "release_671")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1bplcpf37xlsmgmz2w6j6z2mxbd9x45nl5jbyq46vbbdg2690fy3")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
     (synopsis "")
     (description "")
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04s9pk2jkjc0nxjzin65az7f9hkb67nn8wm8v5010n2j0kr5av65")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1rbayib2qli3paz4qc6ckx3j63bq03f24m993aszw0wrjsw7gfn2")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "1d362263wj1p27lsmfhbh0vcc6d1r7i08k9paqk0ir81kb4qhmc8")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public rummager
  (package-with-bundler
   (bundle-package
    (hash (base32 "1mp3bz9bm572l9a7q1zn2ym91jzs28hlmxcv0awkpl7mhzvaafsp")))
   (package
     (name "rummager")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03vpvynf05r52bryqay90d73d41x375ljbnij6sf57975dn3a4fj")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
