   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0sb2x4kv7gryzkfq1m3jiwgjpznipsp277mf9236rcnhiw0w30dh")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ryxpxmgp7820ppfmj4mpdlfqxg086lxsy4qx08m5i1mpg5hi659")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f ;; Asset precompilation fails
        #:phases
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "04g71x5wggj7iwcisaj94lkxpnpkqlrkmbkgndf8d4qn2z192m5r")))
   (package
     (name "publishing-api")
     (version "release_890")
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "14pyf16a6vh0fccx6y9bkm0lszsykp6rprpqhzih337fvndj8pnw")))
     (build-system rails-build-system)
     (arguments `(#:precompile-rails-assets? #f))
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mvvdmn7w6yzdx45yypg669dkm5k3afqbqcsspc6npg298w3193n")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
