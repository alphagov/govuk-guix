...
(define-public contacts-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "0qhf67pkyxbdif1r9rw941irzn9hzv21zp7b81zxwc1makisz9qs")))
   (package
     (name "contacts-admin")
     (version "release_674")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wbh8i31dj5g5anh7j24cy2fnvzsrbvj77mqn0amw9v7iswm0wll")))
     (build-system rails-build-system)
     (inputs
...
(define-public finder-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ml9w17rhp4ahng93bsgicwbwhqqn45gvq9fdrkx7cinqdbyax9w")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g1609hgpg3gwz5i6xy467wgbh2ihqqxx38bzb0x5196sfcmvnfm")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0n65jdsf695q05zncpx443ibdiylmbdc317wc8c33b1r733s3gqb")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04ia8lmzzm7bjxs9pix1yn94ml9fpa67vp35x0gbvjbr19bilg42")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2372")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1ppf0f6a0yr5551z7wdyc9ff20siv0k039n2gg44apjz42fai95v")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1aswsfasx7lj8qq869z1k6mfd8rb7p5yrijaaw3ixyq2480g1v9k")))
   (package
     (name "smart-answers")
     (version "release_4555")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1g2g0w921kywmfqkwfcnl9dwqcgvl38jaf71v5bl9hl671cqznph")))
     (build-system rails-build-system)
