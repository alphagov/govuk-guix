   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0yqwhkbhj915xg57h10cadbbya699q9zq1inj5xa44xgv1pv3fcv")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "12c008bpa2cmkwq88gcpjj4da8ig8wjsc9r7jfc4iwcc6jpvixhn")))
   (package
     (name "whitehall")
     (version "release_13472")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "12ijh9i4ss45xnfv4d0wxyk85p6yijyhhzkvq30z6hg9n33jqgil")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
