   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1hkaw5kc00lrnzzl9hgdns35m2w7mgshvgmzksy1ddnr1j7zwklv")))
     (build-system rails-build-system)
...
(define-public licence-finder
  (package-with-bundler
   (bundle-package
    (hash (base32 "1gwqgq828p5y0b54avih8hi9648hg7hb7rh28bl49pk5gyirhl8p")))
   (package
     (name "licence-finder")
     (version "release_345")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dhv1q6586s7z1qc5b7zr3ghi6r2gmwabbfxc578k5r3rzvgiiw3")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3878")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1mlz3iiagzph65d0rjn938f2bw34i6a2gql728d2r5sgsfb6m9a4")))
     (build-system rails-build-system)
