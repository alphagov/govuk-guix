   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "06hi5ms7lg96a824rlwlal2y3q9y8zqag62qr4j7xnh8m8r86px9")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xcp9zm14zb694072hzc138gw5qv434sakn0av3aknj78i3skvq4")))
   (package
     (name "frontend")
     (version "release_3574")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "18v52icvmzy48wx2lw8sbx515q6lkyp14lkanx8p4qdxy5yhfw1v")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public manuals-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "01g0k08am0w3sakv9v6708b6pdsglf30g7j92rxfvpzzrdxnz2dr")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fgq8s64v7a9m9wziw2dhdiybf5psdqa9hgjs3w0fcrrxqja5p7h")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0fkvmmk67pv2vf8lqrrr2rmzp2nhr0jw2wzwrvpzmn1fkvk74nk3")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
