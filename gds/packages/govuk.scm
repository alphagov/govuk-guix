   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1byy13pqar9cpc7x32vksawbanix8ygwdjnwkbmqn60npbcm1yx1")))
     (build-system rails-build-system)
...
(define-public content-data-admin
  (package-with-bundler
   (bundle-package
    (hash (base32 "1ncl7az7ckwx7wh7w3brhavlx8ny7w1rgw7jdhlgv0fkbqcn01sq")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "02j387waak9rsnzz25dd1vhn373z793fibi8nydb8wqjkiv5m9a4")))
     (build-system rails-build-system)
...
(define-public content-performance-manager
  (package-with-bundler
   (bundle-package
    (hash (base32 "12hmgp9j8r6j9j248hpdxnpzd9ph3vh68nkhaqzf0iccpnsarkwn")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1shwrrfgqkmg00azgzja511qnc234cgyx48zs7ymbfv4s7naqvj5")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0gn4pv14sicz794jz4ci23hpyagcm9jvl19jxgj5wj1rkc7jckxd")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (github-archive
      #:repository name
      #:commit-ish version
      #:hash (base32 "0krfjbha8a3n2yds3ljp39y9pdfhg0rwm5yy6js37g87kmpzb1gz")))
    (build-system gnu-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "12hf9m0bjsj3m82h5www58ajc26bmv0gb60q5hhwilsq40kljw7i")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4146")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xqfkv36fxhrfx7fpscrhmr2lznpwrfmwgyvchjsjwjvb2b2h0bz")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13822")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0qcr8rl1d54gg4mzwnra118jbdj1iyrxk9n9jrwdycj2ph19xm42")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
