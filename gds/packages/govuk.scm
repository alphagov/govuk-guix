...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0vwk87ljvznlzrx2x08qvs3cbwnnjh26i42kz4d6jq58nrf7ck7d")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1dwbbszn0bs3fwibx58y6bxpw1lxf93jgjnjr6n7x595m7b51kd4")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
...
(define-public manuals-publisher
  (package-with-bundler
   (bundle-package
    (hash (base32 "1l12b8s298q9klxphbz94hald6hkcnisk7ky17922hi55nkga1ff")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0ijkkak7ckg7psphfpdwgd7m40cc685zdw6pfgda9dynxnicmm2i")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public search-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "001vs4w1ncdag18f3fg7jrji8rl52di25aj07hc5454mr0dpbmcf")))
   (package
     (name "search-api")
     (version "release_2485")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bw8cfrm3y170wwhw70cpfqv5sfki3spv69k17w75h7dxdj9s5rn")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p4yn8xzaaaq7xga0vdjvbq4brf443dqmpx3nmbfcklwaqjiwbc4")))
   (package
     (name "static")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0mallmi2hgayk0x70mdyy3f6gwwcyy3aaw5fc8rh9z3sypwwi0f6")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
