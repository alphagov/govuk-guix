   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "04p7km4whg7dgqnx6zsqb72cvar1lnwwm3h8gv4w6av1p7576v0g")))
     (build-system rails-build-system)
     (arguments
      '(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0bc55zl9jmwsb2m46ib3pk6w6bp09qr940iw9973x8pjwxsn6vrf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4903")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "170i06mb7yaiqhvivz55qckq2wii94ws448qd1w24p2sh2dfrb14")))
     (build-system rails-build-system)
