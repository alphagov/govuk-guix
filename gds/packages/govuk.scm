   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0abm02hykq3267c7lns60z6cm03k884jp7s6fq54j8spr77d9jkf")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "10rsad1qhclwldwxd5sfbn8fjqlvaj2v2xma4d5gbnx9ln3ca2ln")))
     (build-system rails-build-system)
...
(define-public static
  (package-with-bundler
   ...
   (package
     (name "static")
     (version "release_3277")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0a1g70y93xj21x8hcshl6h3ffm99d3b6pri1fvg1ggd3fvb998nf")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
