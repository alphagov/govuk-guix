...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_3969")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0m9mdkn2plxfgc5p3p8g3xw71h6iq80zv3146wfv7bfynacqa2bg")))
     (build-system rails-build-system)
...
(define-public whitehall
  (package-with-bundler
   ...
   (package
     (name "whitehall")
     (version "release_13485")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0xrajaw13ab7y8k5iyrj1y0virm4mcsshr1cf5zcznasg05k0m8m")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
