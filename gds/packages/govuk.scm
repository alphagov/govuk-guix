   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "17klwc78bwf9nb7hr84zpncpxikp9az0dispkqx9p6ccfl45nads")))
...
(define-public collections
  (package-with-bundler
   (bundle-package
    (hash (base32 "0xbisdv8jwr6lxfyxsriamqh2vvgmdz7lkvx8h5ihpkz1hrz7bhr")))
   (package
     (name "collections")
     (version "release_637")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1jb92x537mf2sd710b0v4lqi42dyc29089kjzsq8gj6lkkvsksvl")))
     (build-system rails-build-system)
...
(define-public email-alert-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "0b370xiwzf9r07qcgnw5pa2yk8jbg46h8g09mbs79vv57axph2ng")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0iz5syz3ic25iy68hdcichid9jygkallikn2qc6icy123whacdzz")))
     (build-system rails-build-system)
     (arguments
      `(#:precompile-rails-assets? #f
        #:phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1yqd029b51l6l4x1azfsvp8jp7jj75pfq9fvhay4bgqzp3jv4saf")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
   ...
   (package
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "0s6ggf1jk2wynmb4pbasim89x2a6gayqiqvxh04c5l59klwyd4qd")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public service-manual-frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "131mlx76q8zggjkwv60r2wnmjz837hj79mkpmnzcfjw929rn17r8")))
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0hxqr84blw3n4n1z6xggcrc4qsdlhdlwryq4k74n5c1yb0abv10w")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public smart-answers
  (package-with-bundler
   ...
   (package
     (name "smart-answers")
     (version "release_4023")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1y92rc59pfys8mwfi30bjh8agsnnzkbaifbb6b0ylqjq6gijwhnd")))
     (build-system rails-build-system)
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1gbbjmr2g0rn1qri5rm37nl2ss91jy80cj44ai67f2sjjblfxcyc")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
...
(define-public static
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jvk2v458ziflfwaq5gj8y2knbhflaznrxv7rr8nwdkz9pq2w3y5")))
   (package
     (name "static")
     (version "release_2918")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1viv8237g93k6v9an21nrd6jnivgakmma34xdn350kfh2z18xlmr")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "1rzdgsm60fdqhwkk76q13j078264g1h5zqb6c6xm3hnha0c54lia")))
   (package
     (name "whitehall")
     (version "release_13589")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0jah8kamy95m51308kzyagf8k548nk8ixac96hrns8qlrlc2chbs")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
