   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0b6vp0f5bdnpzxqwdy1va84qdsj0h5397cg08rw54fgqwkaf68yd")))
     (build-system rails-build-system)
     (arguments
...
(define-public whitehall
  (package-with-bundler
   (bundle-package
    (hash (base32 "0705bsbcdz6zq1cw57ai1lh4cabp8cd5lpmsql9nn07cqqb8amdy")))
   (package
     (name "whitehall")
     (version "release_14849")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1vaykydkw2xxr5i3j7kzsq2biiwwg72rb3sifwpwbq5xv51pc3fs")))
     (build-system rails-build-system)
     (inputs
      `(("node" ,node)
