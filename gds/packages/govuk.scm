   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1xwq2klvw3i1b2ixq3ys0a21sdj0jz8nwq42lgd51ca2zzb0qrf7")))
     (build-system rails-build-system)
     (arguments
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "0mwr5rpa2kpgi8v2dhx5358yzivlwn2y1ncq7pibgsfsass119kq")))
   (package
     (name "frontend")
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0wcn2rjn4aijqfbaxqs4q7rbq3a5q8xmi6braggrzxj0vww880cx")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
