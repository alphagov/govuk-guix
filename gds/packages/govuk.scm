   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1fvshjb77wn7yaskfgvjp2j4nx40wjbdfhcxb0z01wqyqj7xl3bv")))
     (build-system rails-build-system)
     (arguments
      `(#:phases
        (modify-phases %standard-phases
   ...
   (package
     ...
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "08vhfm4klfjkvfc3hyyh3sp7l6bwzk79qm86z1a7lq04xmn3nhdh")))
     (build-system rails-build-system)
     (arguments
      '(;; jasmine-rails seems to get annoyed if it's configuration
        ;; doesn't exist in the spec directory
...
(define-public frontend
  (package-with-bundler
   (bundle-package
    (hash (base32 "1p92wfimzpwa5j2sj25bhf0ndd6yxpv6zr52y39q1f45m587684s")))
   (package
     (name "frontend")
     (version "release_3264")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "0rzz2kvqd5knr3v1fvhjgcmlp1h6b7pfjl155b0lakg90kykcsgr")))
     (build-system rails-build-system)
     (synopsis "")
     (description "")
     (license #f)
...
(define-public publishing-api
  (package-with-bundler
   (bundle-package
    (hash (base32 "1jnc77s72qdyn4idfaf231ny40wm0jsy42pq8zrga2ifdibrhh9s")))
   (package
     (name "publishing-api")
     ...
     (source
      (github-archive
       ...
       #:commit-ish version
       #:hash (base32 "14sf7zgi8yjqaz0hc47sykgl10a9q8fb6bl6cnd1nwdkzzxln7p7")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public search-api
  (package-with-bundler
   ...
   (package
     (name "search-api")
     (version "release_2198")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "1013zygrsgyjsfr6ygz4mgdkrj0srzi3x44j4zmm45vfarhfgqi6")))
     (build-system rails-build-system)
     (arguments '(#:precompile-rails-assets? #f))
...
(define-public smart-answers
  (package-with-bundler
   (bundle-package
    (hash (base32 "1fd3mmjwc5s29vb1imag2l332m58dsz2cyngd61klvw07nkz8gmp")))
   (package
     (name "smart-answers")
     (version "release_4462")
     (source
      (github-archive
       #:repository name
       #:commit-ish version
       #:hash (base32 "03x2qjbaihbylcqw4c1p4v5hf2lpvvlp39zfhyx7d6cll1n11kyf")))
     (build-system rails-build-system)
